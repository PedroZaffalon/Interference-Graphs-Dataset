; ModuleID = '/home/pedro/tcc/exDataset/sample/sample/Cpp.Playground-master/practice/vector_adding_size.ll'
source_filename = "/home/pedro/tcc/exDataset/sample/sample/Cpp.Playground-master/practice/vector_adding_size.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_vector_adding_size.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define void @_Z7AddMoreRSt6vectorIiSaIiEEi(%"class.std::vector"* dereferenceable(24) %0, i32 %1) #0 {
...
define i32 @main() #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  invoke void @_Z7AddMoreRSt6vectorIiSaIiEEi(%"class.std::vector"* dereferenceable(24) %1, i32 124)
          to label %2 unwind label %25

2:                                                ; preds = %0
  invoke void @_Z7AddMoreRSt6vectorIiSaIiEEi(%"class.std::vector"* dereferenceable(24) %1, i32 12)
          to label %3 unwind label %25

3:                                                ; preds = %2
  %4 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* %1) #3
  %5 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEm(%"class.std::basic_ostream"* @_ZSt4cout, i64 %4)
...
8:                                                ; preds = %6
  %9 = invoke dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEE2atEm(%"class.std::vector"* %1, i64 0)
          to label %10 unwind label %25

10:                                               ; preds = %8
  %11 = load i32, i32* %9, align 4
  %12 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %11)
...
15:                                               ; preds = %13
  %16 = invoke dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEE2atEm(%"class.std::vector"* %1, i64 1)
...
25:                                               ; preds = %22, %20, %17, %15, %13, %10, %8, %6, %3, %2, %0
...
29:                                               ; preds = %25
  ...
  %31 = insertvalue { i8*, i32 } %30, i32 %28, 1
  resume { i8*, i32 } %31
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_vector_adding_size.cpp() #0 section ".text.startup" {
