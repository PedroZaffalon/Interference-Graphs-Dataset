; ModuleID = '/home/pedro/tcc/exDataset/sample/sample/spectre-cpp-basics-main/MeetingCodes/Meeting1/trap.ll'
source_filename = "/home/pedro/tcc/exDataset/sample/sample/spectre-cpp-basics-main/MeetingCodes/Meeting1/trap.cpp"
...
; Function Attrs: noinline nounwind uwtable
define double @_Z4leftddd(double %0, double %1, double %2) #4 {
  br label %4

4:                                                ; preds = %10, %3
  %.01 = phi double [ 0.000000e+00, %3 ], [ %9, %10 ]
  %.0 = phi double [ %1, %3 ], [ %11, %10 ]
  %5 = fcmp olt double %.0, %2
  br i1 %5, label %6, label %12

6:                                                ; preds = %4
  %7 = call double @_Z1fd(double %.0) #3
  %8 = fmul double %0, %7
  %9 = fadd double %.01, %8
  br label %10
...
define i32 @main() #6 {
  ...
  %2 = call double @_Z4leftddd(double 0x3DA5FD7FE1796495, double 0.000000e+00, double 1.000000e+00) #3
  ...
  %9 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEd(%"class.std::basic_ostream"* @_ZSt4cout, double %3)
  ...
  %11 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i32 0, i32 0))
  %12 = fsub double %3, 0x400921FB54442D18
