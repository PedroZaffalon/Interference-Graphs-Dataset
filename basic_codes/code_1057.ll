; ModuleID = '/home/pedro/tcc/exDataset/sample/sample/Cpp.Playground-master/practice/vector_inside_class.ll'
source_filename = "/home/pedro/tcc/exDataset/sample/sample/Cpp.Playground-master/practice/vector_inside_class.cpp"
...
%class.SampleClass = type { %"class.std::vector" }
...
$_ZN11SampleClassD2Ev = comdat any
...
@.str = private unnamed_addr constant [8 x i8] c"Item1: \00", align 1
@.str.1 = private unnamed_addr constant [8 x i8] c"Item2: \00", align 1
@.str.2 = private unnamed_addr constant [74 x i8] c"vector::_M_range_check: __n (which is %zu) >= this->size() (which is %zu)\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_vector_inside_class.cpp, i8* null }]

@_ZN11SampleClassC1Ev = alias void (%class.SampleClass*), void (%class.SampleClass*)* @_ZN11SampleClassC2Ev
...
; Function Attrs: noinline uwtable
define void @_ZN11SampleClassC2Ev(%class.SampleClass* %0) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %2 = alloca %"class.std::allocator", align 1
  %3 = getelementptr inbounds %class.SampleClass, %class.SampleClass* %0, i32 0, i32 0
  call void @_ZNSaIiEC2Ev(%"class.std::allocator"* %2) #3
  invoke void @_ZNSt6vectorIiSaIiEEC2EmRKS0_(%"class.std::vector"* %3, i64 2, %"class.std::allocator"* dereferenceable(1) %2)
...
; Function Attrs: noinline uwtable
define void @_ZNK11SampleClass5PrintEv(%class.SampleClass* %0) #0 align 2 {
  %2 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i32 0, i32 0))
  %3 = getelementptr inbounds %class.SampleClass, %class.SampleClass* %0, i32 0, i32 0
  %4 = call dereferenceable(4) i32* @_ZNKSt6vectorIiSaIiEE2atEm(%"class.std::vector"* %3, i64 0)
  %5 = load i32, i32* %4, align 4
  %6 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %2, i32 %5)
  ...
  %8 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i32 0, i32 0))
  %9 = getelementptr inbounds %class.SampleClass, %class.SampleClass* %0, i32 0, i32 0
  %10 = call dereferenceable(4) i32* @_ZNKSt6vectorIiSaIiEE2atEm(%"class.std::vector"* %9, i64 1)
...
define i32 @main() #5 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %1 = alloca %class.SampleClass, align 8
  call void @_ZN11SampleClassC1Ev(%class.SampleClass* %1)
  invoke void @_ZNK11SampleClass5PrintEv(%class.SampleClass* %1)
          to label %2 unwind label %3

2:                                                ; preds = %0
  call void @_ZN11SampleClassD2Ev(%class.SampleClass* %1) #3
  ret i32 0
...
7:                                                ; preds = %3
  ...
  %9 = insertvalue { i8*, i32 } %8, i32 %6, 1
  resume { i8*, i32 } %9
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN11SampleClassD2Ev(%class.SampleClass* %0) unnamed_addr #4 comdat align 2 {
  %2 = getelementptr inbounds %class.SampleClass, %class.SampleClass* %0, i32 0, i32 0
...
5:                                                ; preds = %2
  ...
  call void (i8*, ...) @_ZSt24__throw_out_of_range_fmtPKcz(i8* getelementptr inbounds ([74 x i8], [74 x i8]* @.str.2, i32 0, i32 0), i64 %1, i64 %6) #11
  unreachable
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_vector_inside_class.cpp() #0 section ".text.startup" {
