; ModuleID = '/home/pedro/tcc/exDataset/sample/sample/CPP-master/Lesson9/Observer/DigitalClock.ll'
source_filename = "/home/pedro/tcc/exDataset/sample/sample/CPP-master/Lesson9/Observer/DigitalClock.cpp"
...
@_ZTV12DigitalClock = unnamed_addr constant { [6 x i8*], [5 x i8*] } { [6 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i32, i32, i8*, i64, i8*, i64 }* @_ZTI12DigitalClock to i8*), i8* bitcast (void (%class.DigitalClock*)* @_ZN12DigitalClock4DrawEv to i8*), i8* bitcast (void (%class.DigitalClock*)* @_ZN12DigitalClockD1Ev to i8*), i8* bitcast (void (%class.DigitalClock*)* @_ZN12DigitalClockD0Ev to i8*), i8* bitcast (void (%class.DigitalClock*, %class.Subject*)* @_ZN12DigitalClock6UpdateEP7Subject to i8*)], [5 x i8*] [i8* inttoptr (i64 -8 to i8*), i8* bitcast ({ i8*, i8*, i32, i32, i8*, i64, i8*, i64 }* @_ZTI12DigitalClock to i8*), i8* bitcast (void (%class.DigitalClock*)* @_ZThn8_N12DigitalClockD1Ev to i8*), i8* bitcast (void (%class.DigitalClock*)* @_ZThn8_N12DigitalClockD0Ev to i8*), i8* bitcast (void (%class.DigitalClock*, %class.Subject*)* @_ZThn8_N12DigitalClock6UpdateEP7Subject to i8*)] }, align 8
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@.str = private unnamed_addr constant [18 x i8] c"Digital clock: -[\00", align 1
@.str.1 = private unnamed_addr constant [2 x i8] c":\00", align 1
@.str.2 = private unnamed_addr constant [3 x i8] c"]-\00", align 1
@_ZTVN10__cxxabiv121__vmi_class_type_infoE = external global i8*
@_ZTS12DigitalClock = constant [15 x i8] c"12DigitalClock\00"
...
@_ZTI12DigitalClock = constant { i8*, i8*, i32, i32, i8*, i64, i8*, i64 } { i8* bitcast (i8** getelementptr inbounds (i8*, i8** @_ZTVN10__cxxabiv121__vmi_class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([15 x i8], [15 x i8]* @_ZTS12DigitalClock, i32 0, i32 0), i32 0, i32 2, i8* bitcast ({ i8*, i8* }* @_ZTI6Widget to i8*), i64 2, i8* bitcast ({ i8*, i8* }* @_ZTI8Observer to i8*), i64 2050 }
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_DigitalClock.cpp, i8* null }]

@_ZN12DigitalClockC1EP10ClockTimer = alias void (%class.DigitalClock*, %class.ClockTimer*), void (%class.DigitalClock*, %class.ClockTimer*)* @_ZN12DigitalClockC2EP10ClockTimer
@_ZN12DigitalClockD1Ev = alias void (%class.DigitalClock*), void (%class.DigitalClock*)* @_ZN12DigitalClockD2Ev
...
; Function Attrs: noinline uwtable
define void @_ZN12DigitalClockC2EP10ClockTimer(%class.DigitalClock* %0, %class.ClockTimer* %1) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %3 = bitcast %class.DigitalClock* %0 to %class.Widget*
  call void @_ZN6WidgetC2Ev(%class.Widget* %3) #3
  %4 = bitcast %class.DigitalClock* %0 to i8*
  %5 = getelementptr inbounds i8, i8* %4, i64 8
  %6 = bitcast i8* %5 to %class.Observer*
  call void @_ZN8ObserverC2Ev(%class.Observer* %6)
  %7 = bitcast %class.DigitalClock* %0 to i32 (...)***
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [6 x i8*], [5 x i8*] }, { [6 x i8*], [5 x i8*] }* @_ZTV12DigitalClock, i32 0, inrange i32 0, i32 2) to i32 (...)**), i32 (...)*** %7, align 8
  %8 = bitcast %class.DigitalClock* %0 to i8*
  %9 = getelementptr inbounds i8, i8* %8, i64 8
  %10 = bitcast i8* %9 to i32 (...)***
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [6 x i8*], [5 x i8*] }, { [6 x i8*], [5 x i8*] }* @_ZTV12DigitalClock, i32 0, inrange i32 1, i32 2) to i32 (...)**), i32 (...)*** %10, align 8
  %11 = getelementptr inbounds %class.DigitalClock, %class.DigitalClock* %0, i32 0, i32 2
  store %class.ClockTimer* %1, %class.ClockTimer** %11, align 8
  %12 = getelementptr inbounds %class.DigitalClock, %class.DigitalClock* %0, i32 0, i32 2
  ...
  %19 = bitcast %class.DigitalClock* %0 to i8*
...
23:                                               ; preds = %2
  ...
  %27 = bitcast %class.DigitalClock* %0 to i8*
...
; Function Attrs: noinline nounwind uwtable
define void @_ZN12DigitalClockD2Ev(%class.DigitalClock* %0) unnamed_addr #4 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %2 = bitcast %class.DigitalClock* %0 to i32 (...)***
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [6 x i8*], [5 x i8*] }, { [6 x i8*], [5 x i8*] }* @_ZTV12DigitalClock, i32 0, inrange i32 0, i32 2) to i32 (...)**), i32 (...)*** %2, align 8
  %3 = bitcast %class.DigitalClock* %0 to i8*
  %4 = getelementptr inbounds i8, i8* %3, i64 8
  %5 = bitcast i8* %4 to i32 (...)***
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [6 x i8*], [5 x i8*] }, { [6 x i8*], [5 x i8*] }* @_ZTV12DigitalClock, i32 0, inrange i32 1, i32 2) to i32 (...)**), i32 (...)*** %5, align 8
  %6 = getelementptr inbounds %class.DigitalClock, %class.DigitalClock* %0, i32 0, i32 2
  ...
  %13 = bitcast %class.DigitalClock* %0 to i8*
...
16:                                               ; preds = %1
  %17 = bitcast %class.DigitalClock* %0 to i8*
...
20:                                               ; preds = %1
  ...
  %24 = bitcast %class.DigitalClock* %0 to i8*
...
; Function Attrs: noinline nounwind uwtable
define void @_ZThn8_N12DigitalClockD1Ev(%class.DigitalClock* %0) unnamed_addr #4 align 2 {
  %2 = bitcast %class.DigitalClock* %0 to i8*
  %3 = getelementptr inbounds i8, i8* %2, i64 -8
  %4 = bitcast i8* %3 to %class.DigitalClock*
  tail call void @_ZN12DigitalClockD1Ev(%class.DigitalClock* %4) #3
  ret void
}

; Function Attrs: noinline nounwind uwtable
define void @_ZN12DigitalClockD0Ev(%class.DigitalClock* %0) unnamed_addr #4 align 2 {
  call void @_ZN12DigitalClockD1Ev(%class.DigitalClock* %0) #3
  %2 = bitcast %class.DigitalClock* %0 to i8*
...
; Function Attrs: noinline nounwind uwtable
define void @_ZThn8_N12DigitalClockD0Ev(%class.DigitalClock* %0) unnamed_addr #4 align 2 {
  %2 = bitcast %class.DigitalClock* %0 to i8*
  %3 = getelementptr inbounds i8, i8* %2, i64 -8
  %4 = bitcast i8* %3 to %class.DigitalClock*
  tail call void @_ZN12DigitalClockD0Ev(%class.DigitalClock* %4) #3
  ret void
}

; Function Attrs: noinline uwtable
define void @_ZN12DigitalClock6UpdateEP7Subject(%class.DigitalClock* %0, %class.Subject* %1) unnamed_addr #0 align 2 {
  %3 = getelementptr inbounds %class.DigitalClock, %class.DigitalClock* %0, i32 0, i32 2
...
7:                                                ; preds = %2
  %8 = bitcast %class.DigitalClock* %0 to void (%class.DigitalClock*)***
  %9 = load void (%class.DigitalClock*)**, void (%class.DigitalClock*)*** %8, align 8
  %10 = getelementptr inbounds void (%class.DigitalClock*)*, void (%class.DigitalClock*)** %9, i64 0
  %11 = load void (%class.DigitalClock*)*, void (%class.DigitalClock*)** %10, align 8
  call void %11(%class.DigitalClock* %0)
  br label %12
...
; Function Attrs: noinline uwtable
define void @_ZThn8_N12DigitalClock6UpdateEP7Subject(%class.DigitalClock* %0, %class.Subject* %1) unnamed_addr #0 align 2 {
  %3 = bitcast %class.DigitalClock* %0 to i8*
  %4 = getelementptr inbounds i8, i8* %3, i64 -8
  %5 = bitcast i8* %4 to %class.DigitalClock*
  tail call void @_ZN12DigitalClock6UpdateEP7Subject(%class.DigitalClock* %5, %class.Subject* %1)
  ret void
}

; Function Attrs: noinline uwtable
define void @_ZN12DigitalClock4DrawEv(%class.DigitalClock* %0) unnamed_addr #0 align 2 {
  %2 = getelementptr inbounds %class.DigitalClock, %class.DigitalClock* %0, i32 0, i32 2
  %3 = load %class.ClockTimer*, %class.ClockTimer** %2, align 8
  %4 = call i32 @_ZN10ClockTimer7GetHourEv(%class.ClockTimer* %3)
  %5 = getelementptr inbounds %class.DigitalClock, %class.DigitalClock* %0, i32 0, i32 2
  %6 = load %class.ClockTimer*, %class.ClockTimer** %5, align 8
  %7 = call i32 @_ZN10ClockTimer9GetMinuteEv(%class.ClockTimer* %6)
  %8 = getelementptr inbounds %class.DigitalClock, %class.DigitalClock* %0, i32 0, i32 2
  %9 = load %class.ClockTimer*, %class.ClockTimer** %8, align 8
  %10 = call i32 @_ZN10ClockTimer9GetSecondEv(%class.ClockTimer* %9)
  %11 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i32 0, i32 0))
  ...
  %17 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %16, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i32 0, i32 0))
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_DigitalClock.cpp() #0 section ".text.startup" {
