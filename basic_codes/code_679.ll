; ModuleID = '/home/pedro/tcc/exDataset/listasJandira-master/code_260.ll'
source_filename = "/home/pedro/tcc/exDataset/listasJandira-master/largest_word.c"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

@main.s = private unnamed_addr constant [29 x i8] c"This is, theres way Again...\00", align 16
...
define i32 @main() #0 {
  ...
  %4 = call i32 @largest_word(i8* %3)
  %5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i32 %4)
  ret i32 0
}

; Function Attrs: noinline nounwind uwtable
define i32 @largest_word(i8* %0) #0 {
  %2 = alloca [7 x i8], align 1
  %3 = call i64 @strlen(i8* %0) #4
  %4 = trunc i64 %3 to i32
  %5 = bitcast [7 x i8]* %2 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %5, i8* align 1 getelementptr inbounds ([7 x i8], [7 x i8]* @largest_word.nonwords, i32 0, i32 0), i64 7, i1 false)
  br label %6

6:                                                ; preds = %40, %1
  %.01 = phi i32 [ -1, %1 ], [ %.12, %40 ]
  %.0 = phi i32 [ 0, %1 ], [ %.2, %40 ]
  %7 = icmp slt i32 %.0, %4
