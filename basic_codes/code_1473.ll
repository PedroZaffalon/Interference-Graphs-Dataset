; ModuleID = '/home/pedro/tcc/exDataset/sample/sample/cpp-courses-master/09_lambda/09_01_stateful_functor/09_01_00_stateful_functor.ll'
source_filename = "/home/pedro/tcc/exDataset/sample/sample/cpp-courses-master/09_lambda/09_01_stateful_functor/09_01_00_stateful_functor.cpp"
...
$_ZSt8for_eachIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEE11accumulatorET0_T_S9_S8_ = comdat any

$_ZNSt6vectorIiSaIiEE5beginEv = comdat any

$_ZNSt6vectorIiSaIiEE3endEv = comdat any

$_ZN11accumulatorC2Ev = comdat any
...
$_ZN11accumulatorclEi = comdat any
...
@.ref.tmp = private constant [7 x i32] [i32 5, i32 3, i32 2, i32 7, i32 3, i32 6, i32 4], align 4
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_09_01_00_stateful_functor.cpp, i8* null }]
...
define i32 @main() #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %6 = alloca %struct.accumulator, align 4
  %7 = alloca %struct.accumulator, align 4
  %8 = getelementptr inbounds %"class.std::initializer_list", %"class.std::initializer_list"* %2, i32 0, i32 0
  store i32* getelementptr inbounds ([7 x i32], [7 x i32]* @.ref.tmp, i64 0, i64 0), i32** %8, align 8
  %9 = getelementptr inbounds %"class.std::initializer_list", %"class.std::initializer_list"* %2, i32 0, i32 1
  store i64 7, i64* %9, align 8
  call void @_ZNSaIiEC2Ev(%"class.std::allocator"* %3) #3
  %10 = bitcast %"class.std::initializer_list"* %2 to { i32*, i64 }*
  ...
  invoke void @_ZNSt6vectorIiSaIiEEC2ESt16initializer_listIiERKS0_(%"class.std::vector"* %1, i32* %12, i64 %14, %"class.std::allocator"* dereferenceable(1) %3)
...
15:                                               ; preds = %0
  ...
  %20 = bitcast %struct.accumulator* %6 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 4 %20, i8 0, i64 4, i1 false)
  call void @_ZN11accumulatorC2Ev(%struct.accumulator* %6) #3
  ...
  %25 = getelementptr inbounds %struct.accumulator, %struct.accumulator* %6, i32 0, i32 0
  %26 = load i32, i32* %25, align 4
  %27 = invoke i32 @_ZSt8for_eachIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEE11accumulatorET0_T_S9_S8_(i32* %22, i32* %24, i32 %26)
          to label %28 unwind label %34

28:                                               ; preds = %15
  %29 = getelementptr inbounds %struct.accumulator, %struct.accumulator* %7, i32 0, i32 0
...
38:                                               ; preds = %34, %30
  ...
  %39 = insertvalue { i8*, i32 } undef, i8* %.0, 0
  %40 = insertvalue { i8*, i32 } %39, i32 %.01, 1
  resume { i8*, i32 } %40
}
...
define linkonce_odr void @_ZNSt6vectorIiSaIiEEC2ESt16initializer_listIiERKS0_(%"class.std::vector"* %0, i32* %1, i64 %2, %"class.std::allocator"* dereferenceable(1) %3) unnamed_addr #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %6 = bitcast %"class.std::initializer_list"* %5 to { i32*, i64 }*
  ...
  call void @_ZNSt12_Vector_baseIiSaIiEEC2ERKS0_(%"struct.std::_Vector_base"* %9, %"class.std::allocator"* dereferenceable(1) %3) #3
  %10 = call i32* @_ZNKSt16initializer_listIiE5beginEv(%"class.std::initializer_list"* %5) #3
  %11 = call i32* @_ZNKSt16initializer_listIiE3endEv(%"class.std::initializer_list"* %5) #3
  invoke void @_ZNSt6vectorIiSaIiEE19_M_range_initializeIPKiEEvT_S5_St20forward_iterator_tag(%"class.std::vector"* %0, i32* %10, i32* %11)
...
; Function Attrs: noinline uwtable
define linkonce_odr i32 @_ZSt8for_eachIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEE11accumulatorET0_T_S9_S8_(i32* %0, i32* %1, i32 %2) #0 comdat {
  %4 = alloca %struct.accumulator, align 4
  %5 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  ...
  %10 = getelementptr inbounds %struct.accumulator, %struct.accumulator* %7, i32 0, i32 0
...
13:                                               ; preds = %11
  ...
  call void @_ZN11accumulatorclEi(%struct.accumulator* %7, i32 %15)
  br label %16
...
18:                                               ; preds = %11
  %19 = bitcast %struct.accumulator* %4 to i8*
  %20 = bitcast %struct.accumulator* %7 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %19, i8* align 4 %20, i64 4, i1 false)
  %21 = getelementptr inbounds %struct.accumulator, %struct.accumulator* %4, i32 0, i32 0
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN11accumulatorC2Ev(%struct.accumulator* %0) unnamed_addr #5 comdat align 2 {
  %2 = getelementptr inbounds %struct.accumulator, %struct.accumulator* %0, i32 0, i32 0
...
define linkonce_odr void @_ZNSt12_Vector_baseIiSaIiEEC2ERKS0_(%"struct.std::_Vector_base"* %0, %"class.std::allocator"* dereferenceable(1) %1) unnamed_addr #5 comdat align 2 {
  ...
  call void @_ZNSt12_Vector_baseIiSaIiEE12_Vector_implC2ERKS0_(%"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %3, %"class.std::allocator"* dereferenceable(1) %1) #3
  ret void
}

; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt6vectorIiSaIiEE19_M_range_initializeIPKiEEvT_S5_St20forward_iterator_tag(%"class.std::vector"* %0, i32* %1, i32* %2) #0 comdat align 2 {
  %4 = call i64 @_ZSt8distanceIPKiENSt15iterator_traitsIT_E15difference_typeES3_S3_(i32* %1, i32* %2)
  %5 = bitcast %"class.std::vector"* %0 to %"struct.std::_Vector_base"*
  %6 = call i32* @_ZNSt12_Vector_baseIiSaIiEE11_M_allocateEm(%"struct.std::_Vector_base"* %5, i64 %4)
  ...
  %23 = call dereferenceable(1) %"class.std::allocator"* @_ZNSt12_Vector_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %22) #3
  %24 = call i32* @_ZSt22__uninitialized_copy_aIPKiPiiET0_T_S4_S3_RSaIT1_E(i32* %1, i32* %2, i32* %21, %"class.std::allocator"* dereferenceable(1) %23)
...
; Function Attrs: noinline uwtable
define linkonce_odr i64 @_ZSt8distanceIPKiENSt15iterator_traitsIT_E15difference_typeES3_S3_(i32* %0, i32* %1) #0 comdat {
  ...
  %5 = call i64 @_ZSt10__distanceIPKiENSt15iterator_traitsIT_E15difference_typeES3_S3_St26random_access_iterator_tag(i32* %4, i32* %1)
  ret i64 %5
}
...
; Function Attrs: noinline uwtable
define linkonce_odr i32* @_ZSt22__uninitialized_copy_aIPKiPiiET0_T_S4_S3_RSaIT1_E(i32* %0, i32* %1, i32* %2, %"class.std::allocator"* dereferenceable(1) %3) #0 comdat {
  %5 = call i32* @_ZSt18uninitialized_copyIPKiPiET0_T_S4_S3_(i32* %0, i32* %1, i32* %2)
  ret i32* %5
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64 @_ZSt10__distanceIPKiENSt15iterator_traitsIT_E15difference_typeES3_S3_St26random_access_iterator_tag(i32* %0, i32* %1) #5 comdat {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZSt19__iterator_categoryIPKiENSt15iterator_traitsIT_E17iterator_categoryERKS3_(i32** dereferenceable(8) %0) #5 comdat {
  ret void
}
...
; Function Attrs: noinline uwtable
define linkonce_odr i32* @_ZSt18uninitialized_copyIPKiPiET0_T_S4_S3_(i32* %0, i32* %1, i32* %2) #0 comdat {
  %4 = call i32* @_ZNSt20__uninitialized_copyILb1EE13__uninit_copyIPKiPiEET0_T_S6_S5_(i32* %0, i32* %1, i32* %2)
  ret i32* %4
}

; Function Attrs: noinline uwtable
define linkonce_odr i32* @_ZNSt20__uninitialized_copyILb1EE13__uninit_copyIPKiPiEET0_T_S6_S5_(i32* %0, i32* %1, i32* %2) #0 comdat align 2 {
  %4 = call i32* @_ZSt4copyIPKiPiET0_T_S4_S3_(i32* %0, i32* %1, i32* %2)
  ret i32* %4
}

; Function Attrs: noinline uwtable
define linkonce_odr i32* @_ZSt4copyIPKiPiET0_T_S4_S3_(i32* %0, i32* %1, i32* %2) #0 comdat {
  %4 = call i32* @_ZSt12__miter_baseIPKiET_S2_(i32* %0)
  %5 = call i32* @_ZSt12__miter_baseIPKiET_S2_(i32* %1)
  %6 = call i32* @_ZSt14__copy_move_a2ILb0EPKiPiET1_T0_S4_S3_(i32* %4, i32* %5, i32* %2)
  ret i32* %6
}

; Function Attrs: noinline uwtable
define linkonce_odr i32* @_ZSt14__copy_move_a2ILb0EPKiPiET1_T0_S4_S3_(i32* %0, i32* %1, i32* %2) #0 comdat {
  %4 = call i32* @_ZSt12__niter_baseIPKiET_S2_(i32* %0)
  %5 = call i32* @_ZSt12__niter_baseIPKiET_S2_(i32* %1)
  %6 = call i32* @_ZSt12__niter_baseIPiET_S1_(i32* %2)
  %7 = call i32* @_ZSt13__copy_move_aILb0EPKiPiET1_T0_S4_S3_(i32* %4, i32* %5, i32* %6)
  ret i32* %7
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr i32* @_ZSt12__miter_baseIPKiET_S2_(i32* %0) #5 comdat {
  ret i32* %0
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i32* @_ZSt12__niter_baseIPKiET_S2_(i32* %0) #5 comdat {
  ret i32* %0
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i32* @_ZNSt11__copy_moveILb0ELb1ESt26random_access_iterator_tagE8__copy_mIiEEPT_PKS3_S6_S4_(i32* %0, i32* %1, i32* %2) #5 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN11accumulatorclEi(%struct.accumulator* %0, i32 %1) #5 comdat align 2 {
  %3 = getelementptr inbounds %struct.accumulator, %struct.accumulator* %0, i32 0, i32 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_09_01_00_stateful_functor.cpp() #0 section ".text.startup" {
