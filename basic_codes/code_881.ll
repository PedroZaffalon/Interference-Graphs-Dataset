; ModuleID = '/home/pedro/tcc/exDataset/sample/sample/C-main/demo.ll'
source_filename = "/home/pedro/tcc/exDataset/sample/sample/C-main/demo.c"
...
@.str.36 = private unnamed_addr constant [8 x i8] c"\0AName:\0A\00", align 1
@.str.37 = private unnamed_addr constant [8 x i8] c"\0AHour:\0A\00", align 1
@.str.38 = private unnamed_addr constant [6 x i8] c"%d %d\00", align 1
@.str.39 = private unnamed_addr constant [7 x i8] c"\0ADay:\0A\00", align 1
@.str.40 = private unnamed_addr constant [9 x i8] c"%d %d %d\00", align 1
@.str.41 = private unnamed_addr constant [25 x i8] c"\0ADoctors office number:\0A\00", align 1
@.str.42 = private unnamed_addr constant [9 x i8] c"date.txt\00", align 1
@.str.43 = private unnamed_addr constant [63 x i8] c"Name: %s\0AHour: %d:%d\0ADay: %d/%d/%d\0ADoctor's office number: %d\0A\00", align 1
@.str.44 = private unnamed_addr constant [10 x i8] c"Reason: \0A\00", align 1
@.str.45 = private unnamed_addr constant [39 x i8] c"\0AReason: (at the end press Ctrl + c )\0A\00", align 1
@.str.46 = private unnamed_addr constant [2 x i8] c"r\00", align 1
@.str.47 = private unnamed_addr constant [10 x i8] c"%s %f %f\0A\00", align 1
@.str.48 = private unnamed_addr constant [5 x i8] c".txt\00", align 1
@.str.49 = private unnamed_addr constant [15 x i8] c"\0AHeight (cm):\0A\00", align 1
@.str.50 = private unnamed_addr constant [3 x i8] c"%f\00", align 1
@.str.51 = private unnamed_addr constant [14 x i8] c"\0AMass: (kg):\0A\00", align 1
@.str.52 = private unnamed_addr constant [40 x i8] c"\0A > The body mass index (BMI) is %.4f\0A\0A\00", align 1
@.str.53 = private unnamed_addr constant [29 x i8] c"Temperature: ( C degrees ):\0A\00", align 1
@.str.54 = private unnamed_addr constant [41 x i8] c"\0A > Low body temperature (hypothermia)\0A\0A\00", align 1
@.str.55 = private unnamed_addr constant [32 x i8] c"\0A > High temperature (fever) \0A\0A\00", align 1
@.str.56 = private unnamed_addr constant [25 x i8] c"\0A > Normal temperature\0A\0A\00", align 1
@.str.57 = private unnamed_addr constant [41 x i8] c"Respiratory rate: (Breaths per minute):\0A\00", align 1
@.str.58 = private unnamed_addr constant [50 x i8] c"\0A > Low respiratory rate to a kid under one year\0A\00", align 1
@.str.59 = private unnamed_addr constant [51 x i8] c"\0A > High respiratory rate to a kid under one year\0A\00", align 1
@.str.60 = private unnamed_addr constant [53 x i8] c"\0A > Normal respiratory rate to a kid under one year\0A\00", align 1
@.str.61 = private unnamed_addr constant [50 x i8] c" > Low respiratory rate to a kid under six years\0A\00", align 1
@.str.62 = private unnamed_addr constant [51 x i8] c" > High respiratory rate to a kid under six years\0A\00", align 1
@.str.63 = private unnamed_addr constant [53 x i8] c" > Normal respiratory rate to a kid under six years\0A\00", align 1
@.str.64 = private unnamed_addr constant [34 x i8] c" > Low respiratory rate to a kid\0A\00", align 1
@.str.65 = private unnamed_addr constant [35 x i8] c" > High respiratory rate to a kid\0A\00", align 1
@.str.66 = private unnamed_addr constant [37 x i8] c" > Normal respiratory rate to a kid\0A\00", align 1
@.str.67 = private unnamed_addr constant [37 x i8] c" > Low respiratory rate to an adult\0A\00", align 1
@.str.68 = private unnamed_addr constant [38 x i8] c" > High respiratory rate to an adult\0A\00", align 1
@.str.69 = private unnamed_addr constant [40 x i8] c" > Normal respiratory rate to an adult\0A\00", align 1
@.str.70 = private unnamed_addr constant [39 x i8] c" > Low respiratory rate to an ancient\0A\00", align 1
@.str.71 = private unnamed_addr constant [41 x i8] c" > High respiratory rate to an ancient\0A\0A\00", align 1
@.str.72 = private unnamed_addr constant [43 x i8] c" > Normal respiratory rate to an ancient\0A\0A\00", align 1
@.str.73 = private unnamed_addr constant [72 x i8] c"Blood  pressure: Systolic blood pressure and diastolic  blood pressure\0A\00", align 1
@.str.74 = private unnamed_addr constant [6 x i8] c"%f %f\00", align 1
@.str.75 = private unnamed_addr constant [50 x i8] c"\0A > According to systolic blood pressure: Normal\0A\00", align 1
@.str.76 = private unnamed_addr constant [50 x i8] c" > According to diastolic blood pressure: Normal\0A\00", align 1
@.str.77 = private unnamed_addr constant [56 x i8] c"\0A > According to systolic blood pressure: hypertension\0A\00", align 1
@.str.78 = private unnamed_addr constant [56 x i8] c" > According to diastolic blood pressure: hypertension\0A\00", align 1
@.str.79 = private unnamed_addr constant [63 x i8] c"\0A > According to systolic blood pressure: hypertension type 1\0A\00", align 1
@.str.80 = private unnamed_addr constant [63 x i8] c" > According to diastolic blood pressure: hypertension type 1\0A\00", align 1
@.str.81 = private unnamed_addr constant [63 x i8] c"\0A > According to systolic blood pressure: hypertension type 2\0A\00", align 1
@.str.82 = private unnamed_addr constant [63 x i8] c" > According to diastolic blood pressure: hypertension type 2\0A\00", align 1
@.str.83 = private unnamed_addr constant [33 x i8] c"\0AHeart rate: (beats per minute)\0A\00", align 1
@.str.84 = private unnamed_addr constant [46 x i8] c"\0A > Normal heart rate to a kid under one year\00", align 1
@.str.85 = private unnamed_addr constant [44 x i8] c"\0A > High heart rate to a kid under one year\00", align 1
@.str.86 = private unnamed_addr constant [43 x i8] c"\0A > Low heart rate to a kid under one year\00", align 1
@.str.87 = private unnamed_addr constant [32 x i8] c"\0A > Normal heart rate to a kid\0A\00", align 1
@.str.88 = private unnamed_addr constant [30 x i8] c"\0A > High heart rate to a kid\0A\00", align 1
@.str.89 = private unnamed_addr constant [29 x i8] c"\0A > Low heart rate to a kid\0A\00", align 1
@.str.90 = private unnamed_addr constant [34 x i8] c" > Normal heart rate to an adult\0A\00", align 1
@.str.91 = private unnamed_addr constant [32 x i8] c" > High heart rate to an adult\0A\00", align 1
@.str.92 = private unnamed_addr constant [31 x i8] c" > Low heart rate to an adult\0A\00", align 1
@.str.93 = private unnamed_addr constant [36 x i8] c" > Normal heart rate to an ancient\0A\00", align 1
@.str.94 = private unnamed_addr constant [34 x i8] c" > High heart rate to an ancient\0A\00", align 1
@.str.95 = private unnamed_addr constant [33 x i8] c" > Low heart rate to an ancient\0A\00", align 1
@.str.96 = private unnamed_addr constant [10 x i8] c"Name: %s\0A\00", align 1
@.str.97 = private unnamed_addr constant [14 x i8] c"Height: %.3f\0A\00", align 1
@.str.98 = private unnamed_addr constant [12 x i8] c"Mass: %.3f\0A\00", align 1
@.str.99 = private unnamed_addr constant [23 x i8] c"Body Mass Index: %.3f\0A\00", align 1
@.str.100 = private unnamed_addr constant [19 x i8] c"Temperature: %.3f\0A\00", align 1
@.str.101 = private unnamed_addr constant [22 x i8] c"Respiratory rate: %d\0A\00", align 1
@.str.102 = private unnamed_addr constant [31 x i8] c"Systolic blood pressure: %.3f\0A\00", align 1
@.str.103 = private unnamed_addr constant [32 x i8] c"Diastolic blood pressure: %.3f\0A\00", align 1
@.str.104 = private unnamed_addr constant [19 x i8] c"Heart rate: %.3f\0A\0A\00", align 1
@.str.105 = private unnamed_addr constant [15 x i8] c"Observations:\0A\00", align 1
@.str.106 = private unnamed_addr constant [55 x i8] c"\0AWrite the Observations: (at the end press Ctrl + c )\0A\00", align 1
@.str.107 = private unnamed_addr constant [50 x i8] c"Write the Medicines (at the end press Ctrl + c )\0A\00", align 1
@.str.108 = private unnamed_addr constant [13 x i8] c"\0AMedicines:\0A\00", align 1
@.str.109 = private unnamed_addr constant [47 x i8] c"Do you want to add some disease to statistics\0A\00", align 1
...
24:                                               ; preds = %21, %17
  %25 = sext i8 %5 to i32
  %26 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %2, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.33, i32 0, i32 0), i32 %25)
  br label %27
...
31:                                               ; preds = %3
  %32 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.34, i32 0, i32 0))
  %33 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %2, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.35, i32 0, i32 0))
...
define void @date() #0 {
  ...
  %8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.36, i32 0, i32 0))
  %9 = getelementptr inbounds [100 x i8], [100 x i8]* %1, i32 0, i32 0
  %10 = call i32 @saca(i8* %9)
  %11 = getelementptr inbounds [100 x i8], [100 x i8]* %1, i32 0, i32 0
  %12 = call i32 @saca(i8* %11)
  br label %13

13:                                               ; preds = %28, %0
  %14 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.37, i32 0, i32 0))
  %15 = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.38, i32 0, i32 0), i32* %2, i32* %3)
  br label %16
...
31:                                               ; preds = %52, %30
  %32 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.39, i32 0, i32 0))
  %33 = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.40, i32 0, i32 0), i32* %4, i32* %5, i32* %6)
  br label %34
...
46:                                               ; preds = %43
  ...
  %48 = icmp slt i32 %47, 2021
  br i1 %48, label %52, label %49

49:                                               ; preds = %46
  %50 = load i32, i32* %6, align 4
  %51 = icmp sgt i32 %50, 2032
  br label %52

52:                                               ; preds = %49, %46, %43, %40, %37, %34
  %53 = phi i1 [ true, %46 ], [ true, %43 ], [ true, %40 ], [ true, %37 ], [ true, %34 ], [ %51, %49 ]
  br i1 %53, label %31, label %54

54:                                               ; preds = %52
  %55 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.41, i32 0, i32 0))
  %56 = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i32 0, i32 0), i32* %7)
  %57 = call %struct._IO_FILE* @fopen(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.42, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.12, i32 0, i32 0))
  ...
  %65 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %57, i8* getelementptr inbounds ([63 x i8], [63 x i8]* @.str.43, i32 0, i32 0), i8* %58, i32 %59, i32 %60, i32 %61, i32 %62, i32 %63, i32 %64)
  %66 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %57, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.44, i32 0, i32 0))
  %67 = call i32 @fclose(%struct._IO_FILE* %57)
  %68 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([39 x i8], [39 x i8]* @.str.45, i32 0, i32 0))
  call void @write(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.42, i32 0, i32 0))
  %69 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.35, i32 0, i32 0))
  ret void
}
...
define void @doctor() #0 {
  ...
  %15 = call %struct._IO_FILE* @fopen(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.13, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.46, i32 0, i32 0))
  br label %16

16:                                               ; preds = %29, %0
  %.0 = phi i32 [ -1, %0 ], [ %30, %29 ]
  %17 = getelementptr inbounds [999 x i8], [999 x i8]* %5, i32 0, i32 0
  %18 = call i32 (%struct._IO_FILE*, i8*, ...) @__isoc99_fscanf(%struct._IO_FILE* %15, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.47, i32 0, i32 0), i8* %17, float* %6, float* %7)
  %19 = icmp eq i32 %18, 3
...
31:                                               ; preds = %16
  ...
  %33 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.36, i32 0, i32 0))
  %34 = getelementptr inbounds [999 x i8], [999 x i8]* %1, i32 0, i32 0
  %35 = call i32 @saca(i8* %34)
  %36 = getelementptr inbounds [999 x i8], [999 x i8]* %1, i32 0, i32 0
  %37 = call i32 @saca(i8* %36)
  ...
  %41 = call i8* @strcat(i8* %40, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.48, i32 0, i32 0)) #4
  %42 = getelementptr inbounds [999 x i8], [999 x i8]* %13, i32 0, i32 0
  call void @headerfile(i8* %42)
  %43 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.49, i32 0, i32 0))
  %44 = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.50, i32 0, i32 0), float* %2)
  %45 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.51, i32 0, i32 0))
  %46 = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.50, i32 0, i32 0), float* %3)
  ...
  %59 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.52, i32 0, i32 0), double %58)
  %60 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.53, i32 0, i32 0))
  %61 = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.50, i32 0, i32 0), float* %4)
...
66:                                               ; preds = %31
  %67 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str.54, i32 0, i32 0))
  br label %78
...
73:                                               ; preds = %68
  %74 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.55, i32 0, i32 0))
  br label %77

75:                                               ; preds = %68
  %76 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.56, i32 0, i32 0))
  br label %77
...
78:                                               ; preds = %77, %66
  %79 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str.57, i32 0, i32 0))
...
86:                                               ; preds = %78
  %87 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([50 x i8], [50 x i8]* @.str.58, i32 0, i32 0))
  br label %112
...
94:                                               ; preds = %88
  %95 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([51 x i8], [51 x i8]* @.str.59, i32 0, i32 0))
  br label %111
...
108:                                              ; preds = %102
  %109 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([53 x i8], [53 x i8]* @.str.60, i32 0, i32 0))
  br label %110
...
118:                                              ; preds = %112
  %119 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([50 x i8], [50 x i8]* @.str.61, i32 0, i32 0))
  br label %144
...
126:                                              ; preds = %120
  %127 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([51 x i8], [51 x i8]* @.str.62, i32 0, i32 0))
  br label %143
...
140:                                              ; preds = %134
  %141 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([53 x i8], [53 x i8]* @.str.63, i32 0, i32 0))
  br label %142
...
150:                                              ; preds = %144
  %151 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.64, i32 0, i32 0))
  br label %176
...
158:                                              ; preds = %152
  %159 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.65, i32 0, i32 0))
  br label %175
...
172:                                              ; preds = %166
  %173 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.66, i32 0, i32 0))
  br label %174
...
182:                                              ; preds = %176
  %183 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.67, i32 0, i32 0))
  br label %208
...
190:                                              ; preds = %184
  %191 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.68, i32 0, i32 0))
  br label %207
...
204:                                              ; preds = %198
  %205 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.69, i32 0, i32 0))
  br label %206
...
214:                                              ; preds = %208
  %215 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([39 x i8], [39 x i8]* @.str.70, i32 0, i32 0))
  br label %240
...
222:                                              ; preds = %216
  %223 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str.71, i32 0, i32 0))
  br label %239
...
236:                                              ; preds = %230
  %237 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.72, i32 0, i32 0))
  br label %238
...
240:                                              ; preds = %239, %214
  %241 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([72 x i8], [72 x i8]* @.str.73, i32 0, i32 0))
  %242 = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.74, i32 0, i32 0), float* %9, float* %10)
...
247:                                              ; preds = %240
  %248 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([50 x i8], [50 x i8]* @.str.75, i32 0, i32 0))
  br label %249
...
254:                                              ; preds = %249
  %255 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([50 x i8], [50 x i8]* @.str.76, i32 0, i32 0))
  br label %256
...
266:                                              ; preds = %261
  %267 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([56 x i8], [56 x i8]* @.str.77, i32 0, i32 0))
  br label %268
...
278:                                              ; preds = %273
  %279 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([56 x i8], [56 x i8]* @.str.78, i32 0, i32 0))
  br label %280
...
290:                                              ; preds = %285
  %291 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([63 x i8], [63 x i8]* @.str.79, i32 0, i32 0))
  br label %292
...
302:                                              ; preds = %297
  %303 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([63 x i8], [63 x i8]* @.str.80, i32 0, i32 0))
  br label %304
...
309:                                              ; preds = %304
  %310 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([63 x i8], [63 x i8]* @.str.81, i32 0, i32 0))
  br label %311
...
316:                                              ; preds = %311
  %317 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([63 x i8], [63 x i8]* @.str.82, i32 0, i32 0))
  br label %318

318:                                              ; preds = %316, %311
  %319 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.83, i32 0, i32 0))
  %320 = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.50, i32 0, i32 0), float* %11)
...
330:                                              ; preds = %325
  %331 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([46 x i8], [46 x i8]* @.str.84, i32 0, i32 0))
  br label %332
...
337:                                              ; preds = %332
  %338 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([44 x i8], [44 x i8]* @.str.85, i32 0, i32 0))
  br label %339
...
344:                                              ; preds = %339
  %345 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.86, i32 0, i32 0))
  br label %346
...
356:                                              ; preds = %351
  %357 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.87, i32 0, i32 0))
  br label %358
...
363:                                              ; preds = %358
  %364 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.88, i32 0, i32 0))
  br label %365
...
370:                                              ; preds = %365
  %371 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.89, i32 0, i32 0))
  br label %372
...
382:                                              ; preds = %377
  %383 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.90, i32 0, i32 0))
  br label %384
...
389:                                              ; preds = %384
  %390 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.91, i32 0, i32 0))
  br label %391
...
396:                                              ; preds = %391
  %397 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.92, i32 0, i32 0))
  br label %398
...
408:                                              ; preds = %403
  %409 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.93, i32 0, i32 0))
  br label %410
...
415:                                              ; preds = %410
  %416 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.94, i32 0, i32 0))
  br label %417
...
422:                                              ; preds = %417
  %423 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.95, i32 0, i32 0))
  br label %424
...
424:                                              ; preds = %422, %417
  ...
  %428 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %426, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.96, i32 0, i32 0), i8* %427)
  %429 = load float, float* %2, align 4
  %430 = fpext float %429 to double
  %431 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %426, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.97, i32 0, i32 0), double %430)
  %432 = load float, float* %3, align 4
  %433 = fpext float %432 to double
  %434 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %426, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.98, i32 0, i32 0), double %433)
  %435 = fpext float %55 to double
  %436 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %426, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.99, i32 0, i32 0), double %435)
  %437 = load float, float* %4, align 4
  %438 = fpext float %437 to double
  %439 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %426, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.100, i32 0, i32 0), double %438)
  %440 = load i32, i32* %8, align 4
  %441 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %426, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.101, i32 0, i32 0), i32 %440)
  %442 = load float, float* %9, align 4
  %443 = fpext float %442 to double
  %444 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %426, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.102, i32 0, i32 0), double %443)
  %445 = load float, float* %10, align 4
  %446 = fpext float %445 to double
  %447 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %426, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.103, i32 0, i32 0), double %446)
  %448 = load float, float* %11, align 4
  %449 = fpext float %448 to double
  %450 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %426, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.104, i32 0, i32 0), double %449)
  %451 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %426, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.105, i32 0, i32 0))
  %452 = call i32 @fclose(%struct._IO_FILE* %426)
  %453 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([55 x i8], [55 x i8]* @.str.106, i32 0, i32 0))
  ...
  %456 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([50 x i8], [50 x i8]* @.str.107, i32 0, i32 0))
  ...
  %459 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %458, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.108, i32 0, i32 0))
  ...
  %463 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([47 x i8], [47 x i8]* @.str.109, i32 0, i32 0))
  br label %464

464:                                              ; preds = %476, %424
  %465 = getelementptr inbounds [999 x i8], [999 x i8]* %14, i32 0, i32 0
  %466 = call i32 @saca(i8* %465)
  br label %467
