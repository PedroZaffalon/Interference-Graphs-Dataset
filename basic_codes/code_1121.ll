; ModuleID = '/home/pedro/tcc/exDataset/sample/sample/Practice_of_Programming-master/20200429DP_1/C.ll'
source_filename = "/home/pedro/tcc/exDataset/sample/sample/Practice_of_Programming-master/20200429DP_1/C.KaitouKid.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_C.KaitouKid.cpp, i8* null }]
...
22:                                               ; preds = %13
  %23 = getelementptr inbounds [102 x i32], [102 x i32]* %3, i32 0, i32 0
  %24 = load i32, i32* %2, align 4
  %25 = call i32 @_Z3lisIiEiPKT_i(i32* %23, i32 %24)
  store i32 %25, i32* %4, align 4
  %26 = getelementptr inbounds [102 x i32], [102 x i32]* %3, i32 0, i32 0
  %27 = getelementptr inbounds [102 x i32], [102 x i32]* %3, i32 0, i32 0
  %28 = load i32, i32* %2, align 4
  %29 = sext i32 %28 to i64
  %30 = getelementptr inbounds i32, i32* %27, i64 %29
  call void @_ZSt7reverseIPiEvT_S1_(i32* %26, i32* %30)
  %31 = getelementptr inbounds [102 x i32], [102 x i32]* %3, i32 0, i32 0
  %32 = load i32, i32* %2, align 4
  %33 = call i32 @_Z3lisIiEiPKT_i(i32* %31, i32 %32)
...
; Function Attrs: noinline uwtable
define linkonce_odr i32 @_Z3lisIiEiPKT_i(i32* %0, i32 %1) #0 comdat {
...
23:                                               ; preds = %45, %22
  %.01 = phi i32 [ 0, %22 ], [ %46, %45 ]
  %24 = icmp slt i32 %.01, %.02
...
33:                                               ; preds = %25
  ...
  %40 = call dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* dereferenceable(4) %35, i32* dereferenceable(4) %3)
...
53:                                               ; preds = %51
  ...
  %56 = call dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* dereferenceable(4) %4, i32* dereferenceable(4) %55)
...
60:                                               ; preds = %51
  %61 = icmp eq i32* %11, null
  br i1 %61, label %64, label %62

62:                                               ; preds = %60
  %63 = bitcast i32* %11 to i8*
  call void @_ZdaPv(i8* %63) #10
  br label %64
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_C.KaitouKid.cpp() #0 section ".text.startup" {
