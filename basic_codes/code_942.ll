; ModuleID = '/home/pedro/tcc/exDataset/sample/sample/C-main/cambiaryeliminarenfile/cambiaryeliminarenfile.ll'
source_filename = "/home/pedro/tcc/exDataset/sample/sample/C-main/cambiaryeliminarenfile/cambiaryeliminarenfile.c"
...
@.str.10 = private unnamed_addr constant [11 x i8] c"[Manzana]\0A\00", align 1
@.str.11 = private unnamed_addr constant [8 x i8] c"[Pera]\0A\00", align 1
@.str.12 = private unnamed_addr constant [9 x i8] c"[Mango]\0A\00", align 1
@.str.13 = private unnamed_addr constant [10 x i8] c"[Sandia]\0A\00", align 1
@.str.14 = private unnamed_addr constant [20 x i8] c"Palabra a eiminar?\0A\00", align 1
@.str.15 = private unnamed_addr constant [3 x i8] c"%s\00", align 1
@.str.16 = private unnamed_addr constant [38 x i8] c"Palabra a cambiar? (cambiar, cambio)\0A\00", align 1
...
define i32 @main() #0 {
  ...
  %3 = alloca [100 x i8], align 16
  %4 = call %struct._IO_FILE* @fopen(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.5, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.9, i32 0, i32 0))
  %5 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %4, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.10, i32 0, i32 0))
  %6 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %4, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.11, i32 0, i32 0))
  %7 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %4, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.12, i32 0, i32 0))
  %8 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %4, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.13, i32 0, i32 0))
  %9 = call i32 @fclose(%struct._IO_FILE* %4)
  %10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.14, i32 0, i32 0))
  %11 = getelementptr inbounds [100 x i8], [100 x i8]* %1, i32 0, i32 0
  %12 = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.15, i32 0, i32 0), i8* %11)
  %13 = getelementptr inbounds [100 x i8], [100 x i8]* %1, i32 0, i32 0
  call void @deleted(i8* %13, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.5, i32 0, i32 0))
  %14 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.16, i32 0, i32 0))
  %15 = getelementptr inbounds [100 x i8], [100 x i8]* %2, i32 0, i32 0
  %16 = getelementptr inbounds [100 x i8], [100 x i8]* %3, i32 0, i32 0
  %17 = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.17, i32 0, i32 0), i8* %15, i8* %16)
  %18 = getelementptr inbounds [100 x i8], [100 x i8]* %2, i32 0, i32 0
  %19 = getelementptr inbounds [100 x i8], [100 x i8]* %3, i32 0, i32 0
  call void @changed(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.5, i32 0, i32 0), i8* %18, i8* %19)
  ret i32 0
}
