; ModuleID = '/home/pedro/tcc/exDataset/sample/sample/CPlusPlus-master/Batting_Average.ll'
source_filename = "/home/pedro/tcc/exDataset/sample/sample/CPlusPlus-master/Batting_Average.cpp"
...
@.str = private unnamed_addr constant [17 x i8] c"Batting Average!\00", align 1
@.str.1 = private unnamed_addr constant [50 x i8] c"Enter the number of times the player was at bat: \00", align 1
@_ZSt3cin = external global %"class.std::basic_istream", align 8
@.str.2 = private unnamed_addr constant [34 x i8] c"Enter the number of hits earned: \00", align 1
@.str.3 = private unnamed_addr constant [17 x i8] c"The average is: \00", align 1
@.str.4 = private unnamed_addr constant [6 x i8] c"pause\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_Batting_Average.cpp, i8* null }]
...
define i32 @main() #4 {
  ...
  %6 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([50 x i8], [50 x i8]* @.str.1, i32 0, i32 0))
  ...
  %8 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.2, i32 0, i32 0))
  ...
  %20 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.3, i32 0, i32 0))
  %21 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEd(%"class.std::basic_ostream"* %20, double %13)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_Batting_Average.cpp() #0 section ".text.startup" {
