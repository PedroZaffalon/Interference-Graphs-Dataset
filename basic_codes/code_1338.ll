; ModuleID = '/home/pedro/tcc/exDataset/sample/sample/CPP-Geeksforgeeks-master/Vector_empty_implementation.ll'
source_filename = "/home/pedro/tcc/exDataset/sample/sample/CPP-Geeksforgeeks-master/Vector_empty_implementation.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_Vector_empty_implementation.cpp, i8* null }]
...
define i32 @main() #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %2 = call zeroext i1 @_ZNKSt6vectorIiSaIiEE5emptyEv(%"class.std::vector"* %1) #3
  br i1 %2, label %3, label %10

3:                                                ; preds = %0
  %4 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0))
...
14:                                               ; preds = %6
  %15 = insertvalue { i8*, i32 } undef, i8* %8, 0
  %16 = insertvalue { i8*, i32 } %15, i32 %9, 1
  resume { i8*, i32 } %16
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr zeroext i1 @_ZN9__gnu_cxxeqIPKiSt6vectorIiSaIiEEEEbRKNS_17__normal_iteratorIT_T0_EESB_(%"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %0, %"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %1) #5 comdat {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_Vector_empty_implementation.cpp() #0 section ".text.startup" {
