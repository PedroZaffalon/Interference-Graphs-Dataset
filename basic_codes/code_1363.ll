; ModuleID = '/home/pedro/tcc/exDataset/sample/sample/spectre-cpp-basics-main/MeetingCodes/Meeting2/main.ll'
source_filename = "/home/pedro/tcc/exDataset/sample/sample/spectre-cpp-basics-main/MeetingCodes/Meeting2/main.cpp"
...
define i32 @main() #6 {
  ...
  %2 = call double @_Z4trapPFddEddd(double (double)* @_Z1fd, double 0x3EB0C6F7A0B5ED8D, double 0.000000e+00, double 1.000000e+00) #3
  %3 = fmul double 4.000000e+00, %2
  %4 = fsub double %3, 0x400921FB54442D18
  ...
  %10 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEd(%"class.std::basic_ostream"* %9, double %3)
  ...
  %12 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEd(%"class.std::basic_ostream"* @_ZSt4cout, double %4)
