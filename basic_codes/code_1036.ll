; ModuleID = '/home/pedro/tcc/exDataset/sample/sample/CompetitiveProgramming-master/code/segment_trees/trees_with_arrays.ll'
source_filename = "/home/pedro/tcc/exDataset/sample/sample/CompetitiveProgramming-master/code/segment_trees/trees_with_arrays.cpp"
...
$_ZSt10accumulateIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEmET0_T_S8_S7_ = comdat any
...
@.str = private unnamed_addr constant [16 x i8] c"building took: \00", align 1
@.str.1 = private unnamed_addr constant [7 x i8] c" [sec]\00", align 1
@.str.2 = private unnamed_addr constant [9 x i8] c"sum is: \00", align 1
@.str.3 = private unnamed_addr constant [11 x i8] c"sum took: \00", align 1
@.str.4 = private unnamed_addr constant [26 x i8] c"vector::_M_default_append\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_trees_with_arrays.cpp, i8* null }]
...
define i32 @main() #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %13 = alloca %"struct.std::chrono::duration.0", align 8
  ...
  %17 = getelementptr inbounds %"struct.std::chrono::time_point", %"struct.std::chrono::time_point"* %2, i32 0, i32 0
...
20:                                               ; preds = %0
  ...
  invoke void @_ZNSt6vectorIiSaIiEE6resizeEm(%"class.std::vector"* %1, i64 %24)
...
36:                                               ; preds = %44, %25
  ...
  %.02 = phi i32 [ %35, %25 ], [ %46, %44 ]
  %37 = icmp ne i32 %.02, %23
...
47:                                               ; preds = %143, %141, %139, %137, %135, %133, %131, %127, %125, %118, %103, %101, %99, %97, %95, %93, %91, %86, %71, %55, %38, %20, %0
...
52:                                               ; preds = %64, %51
  %.1 = phi i32 [ %.03, %51 ], [ %65, %64 ]
  %.01 = phi i32 [ 0, %51 ], [ %66, %64 ]
...
86:                                               ; preds = %69
  ...
  %88 = getelementptr inbounds %"struct.std::chrono::time_point", %"struct.std::chrono::time_point"* %6, i32 0, i32 0
  %89 = getelementptr inbounds %"struct.std::chrono::duration", %"struct.std::chrono::duration"* %88, i32 0, i32 0
  store i64 %87, i64* %89, align 8
  %90 = invoke i64 @_ZNSt6chronomiINS_3_V212system_clockENS_8durationIlSt5ratioILl1ELl1000000000EEEES6_EENSt11common_typeIJT0_T1_EE4typeERKNS_10time_pointIT_S8_EERKNSC_ISD_S9_EE(%"struct.std::chrono::time_point"* dereferenceable(8) %6, %"struct.std::chrono::time_point"* dereferenceable(8) %2)
          to label %91 unwind label %47

91:                                               ; preds = %86
  %92 = getelementptr inbounds %"struct.std::chrono::duration", %"struct.std::chrono::duration"* %8, i32 0, i32 0
  store i64 %90, i64* %92, align 8
  invoke void @_ZNSt6chrono8durationIdSt5ratioILl1ELl1EEEC2IlS1_ILl1ELl1000000000EEvEERKNS0_IT_T0_EE(%"struct.std::chrono::duration.0"* %7, %"struct.std::chrono::duration"* dereferenceable(8) %8)
          to label %93 unwind label %47

93:                                               ; preds = %91
  %94 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str, i32 0, i32 0))
          to label %95 unwind label %47

95:                                               ; preds = %93
  %96 = invoke double @_ZNKSt6chrono8durationIdSt5ratioILl1ELl1EEE5countEv(%"struct.std::chrono::duration.0"* %7)
          to label %97 unwind label %47

97:                                               ; preds = %95
  %98 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEd(%"class.std::basic_ostream"* %94, double %96)
          to label %99 unwind label %47

99:                                               ; preds = %97
  %100 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %98, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i32 0, i32 0))
...
103:                                              ; preds = %101
  ...
  %105 = getelementptr inbounds %"struct.std::chrono::time_point", %"struct.std::chrono::time_point"* %9, i32 0, i32 0
  %106 = getelementptr inbounds %"struct.std::chrono::duration", %"struct.std::chrono::duration"* %105, i32 0, i32 0
  store i64 %104, i64* %106, align 8
  %107 = bitcast %"struct.std::chrono::time_point"* %2 to i8*
  %108 = bitcast %"struct.std::chrono::time_point"* %9 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %107, i8* align 8 %108, i64 8, i1 false)
  %109 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector"* %1) #3
  %110 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %10, i32 0, i32 0
  store i32* %109, i32** %110, align 8
  %111 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector"* %1) #3
  ...
  %117 = invoke i64 @_ZSt10accumulateIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEmET0_T_S8_S7_(i32* %114, i32* %116, i64 0)
          to label %118 unwind label %47

118:                                              ; preds = %103
  %119 = call i64 @_ZNSt6chrono3_V212system_clock3nowEv() #3
  %120 = getelementptr inbounds %"struct.std::chrono::time_point", %"struct.std::chrono::time_point"* %12, i32 0, i32 0
  %121 = getelementptr inbounds %"struct.std::chrono::duration", %"struct.std::chrono::duration"* %120, i32 0, i32 0
  store i64 %119, i64* %121, align 8
  %122 = bitcast %"struct.std::chrono::time_point"* %6 to i8*
  %123 = bitcast %"struct.std::chrono::time_point"* %12 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %122, i8* align 8 %123, i64 8, i1 false)
  %124 = invoke i64 @_ZNSt6chronomiINS_3_V212system_clockENS_8durationIlSt5ratioILl1ELl1000000000EEEES6_EENSt11common_typeIJT0_T1_EE4typeERKNS_10time_pointIT_S8_EERKNSC_ISD_S9_EE(%"struct.std::chrono::time_point"* dereferenceable(8) %6, %"struct.std::chrono::time_point"* dereferenceable(8) %2)
          to label %125 unwind label %47

125:                                              ; preds = %118
  %126 = getelementptr inbounds %"struct.std::chrono::duration", %"struct.std::chrono::duration"* %14, i32 0, i32 0
  store i64 %124, i64* %126, align 8
  invoke void @_ZNSt6chrono8durationIdSt5ratioILl1ELl1EEEC2IlS1_ILl1ELl1000000000EEvEERKNS0_IT_T0_EE(%"struct.std::chrono::duration.0"* %13, %"struct.std::chrono::duration"* dereferenceable(8) %14)
          to label %127 unwind label %47

127:                                              ; preds = %125
  %128 = bitcast %"struct.std::chrono::duration.0"* %7 to i8*
  %129 = bitcast %"struct.std::chrono::duration.0"* %13 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %128, i8* align 8 %129, i64 8, i1 false)
  %130 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i32 0, i32 0))
          to label %131 unwind label %47

131:                                              ; preds = %127
  %132 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEm(%"class.std::basic_ostream"* %130, i64 %117)
...
135:                                              ; preds = %133
  %136 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.3, i32 0, i32 0))
          to label %137 unwind label %47

137:                                              ; preds = %135
  %138 = invoke double @_ZNKSt6chrono8durationIdSt5ratioILl1ELl1EEE5countEv(%"struct.std::chrono::duration.0"* %7)
          to label %139 unwind label %47

139:                                              ; preds = %137
  %140 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEd(%"class.std::basic_ostream"* %136, double %138)
          to label %141 unwind label %47

141:                                              ; preds = %139
  %142 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %140, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i32 0, i32 0))
...
146:                                              ; preds = %47
  %147 = insertvalue { i8*, i32 } undef, i8* %49, 0
  %148 = insertvalue { i8*, i32 } %147, i32 %50, 1
  resume { i8*, i32 } %148
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64 @_ZSt10accumulateIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEmET0_T_S8_S7_(i32* %0, i32* %1, i64 %2) #5 comdat {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_trees_with_arrays.cpp() #0 section ".text.startup" {
