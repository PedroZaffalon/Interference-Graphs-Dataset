; ModuleID = '/home/pedro/tcc/exDataset/sample/sample/Cpp.Playground-master/practice/for_loop_binary.ll'
source_filename = "/home/pedro/tcc/exDataset/sample/sample/Cpp.Playground-master/practice/for_loop_binary.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_for_loop_binary.cpp, i8* null }]
...
define i32 @main() #4 {
  %1 = call i32 @_Z3powii(i32 2, i32 2)
  br label %2
...
5:                                                ; preds = %11, %4
  %.01 = phi i32 [ 1, %4 ], [ %12, %11 ]
  %6 = icmp sle i32 %.01, 2
  br i1 %6, label %7, label %13

7:                                                ; preds = %5
  %8 = trunc i8 0 to i1
  %9 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEb(%"class.std::basic_ostream"* @_ZSt4cout, i1 zeroext %8)
...
define i32 @_Z3powii(i32 %0, i32 %1) #5 {
  br label %3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_for_loop_binary.cpp() #0 section ".text.startup" {
