; ModuleID = '/home/pedro/tcc/exDataset/sample/sample/C-main/CalculadoraPolacaInversaConAsignacionesFuncional.ll'
source_filename = "/home/pedro/tcc/exDataset/sample/sample/C-main/CalculadoraPolacaInversaConAsignacionesFuncional.c"
...
@.str.2 = private unnamed_addr constant [20 x i8] c"Asignacion Exitosa\0A\00", align 1
...
2:                                                ; preds = %59, %0
  %.01 = phi i32 [ 0, %0 ], [ %.4, %59 ]
  %.0 = phi double [ 0.000000e+00, %0 ], [ %.2, %59 ]
...
53:                                               ; preds = %51
  %54 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.2, i32 0, i32 0))
  br label %55
...
56:                                               ; preds = %6
  ...
  %58 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.3, i32 0, i32 0), i8* %57)
  br label %59

59:                                               ; preds = %56, %55, %45, %33, %29, %25, %24, %12, %10, %8
  %.4 = phi i32 [ %.01, %56 ], [ %.3, %55 ], [ %.01, %45 ], [ %.01, %33 ], [ %.01, %29 ], [ %.01, %25 ], [ %.12, %24 ], [ %13, %12 ], [ %11, %10 ], [ %9, %8 ]
  %.2 = phi double [ %.0, %56 ], [ %.0, %55 ], [ %.0, %45 ], [ %.0, %33 ], [ %.0, %29 ], [ %.0, %25 ], [ %.1, %24 ], [ %.0, %12 ], [ %.0, %10 ], [ %.0, %8 ]
  br label %2
