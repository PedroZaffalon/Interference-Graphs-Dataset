; ModuleID = '/home/pedro/tcc/exDataset/sample/sample/Practice_of_Programming-master/RealPractices/02/I.ll'
source_filename = "/home/pedro/tcc/exDataset/sample/sample/Practice_of_Programming-master/RealPractices/02/I.BinSrchFunc.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_I.BinSrchFunc.cpp, i8* null }]
...
define double @_Z1fd(double %0) #4 {
  ...
  %4 = fmul double %3, %0
  %5 = fmul double %4, %0
  %6 = fmul double 1.500000e+01, %0
  %7 = fmul double %6, %0
  %8 = fmul double %7, %0
  %9 = fmul double %8, %0
  %10 = fsub double %5, %9
  %11 = fmul double 8.500000e+01, %0
  %12 = fmul double %11, %0
  %13 = fmul double %12, %0
  %14 = fadd double %10, %13
  %15 = fmul double 2.250000e+02, %0
  %16 = fmul double %15, %0
  %17 = fsub double %14, %16
  %18 = fmul double 2.740000e+02, %0
  %19 = fadd double %17, %18
  %20 = fsub double %19, 1.210000e+02
  ret double %20
}
...
2:                                                ; preds = %12, %0
  %.01 = phi double [ 1.500000e+00, %0 ], [ %.12, %12 ]
  %.0 = phi double [ 2.400000e+00, %0 ], [ %.1, %12 ]
  %3 = fsub double %.0, %.01
  %4 = fcmp ogt double %3, 1.000000e-09
  br i1 %4, label %5, label %13

5:                                                ; preds = %2
  %6 = fadd double %.0, %.01
  %7 = fdiv double %6, 2.000000e+00
  %8 = call double @_Z1fd(double %7)
...
12:                                               ; preds = %11, %10
  %.12 = phi double [ %7, %10 ], [ %.01, %11 ]
  %.1 = phi double [ %.0, %10 ], [ %7, %11 ]
  br label %2
...
13:                                               ; preds = %2
  ...
  %20 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEd(%"class.std::basic_ostream"* %19, double %.01)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_I.BinSrchFunc.cpp() #0 section ".text.startup" {
