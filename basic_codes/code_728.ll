; ModuleID = '/home/pedro/tcc/exDataset/sample/sample/C-Course-master/Vector/maior_posicao.ll'
source_filename = "/home/pedro/tcc/exDataset/sample/sample/C-Course-master/Vector/maior_posicao.c"
...
@.str.4 = private unnamed_addr constant [49 x i8] c"MAIOR VALOR = %.1lf\0APOSICAO DO MAIOR VALOR = %d\0A\00", align 1
...
18:                                               ; preds = %8
  %19 = getelementptr inbounds double, double* %7, i64 0
  %20 = load double, double* %19, align 16
  br label %21

21:                                               ; preds = %34, %18
  %.03 = phi double [ %20, %18 ], [ %.14, %34 ]
  %.01 = phi i32 [ 0, %18 ], [ %.12, %34 ]
...
33:                                               ; preds = %29, %24
  %.14 = phi double [ %32, %29 ], [ %.03, %24 ]
  %.12 = phi i32 [ %.1, %29 ], [ %.01, %24 ]
  br label %34
...
36:                                               ; preds = %21
  %37 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([49 x i8], [49 x i8]* @.str.4, i32 0, i32 0), double %.03, i32 %.01)
