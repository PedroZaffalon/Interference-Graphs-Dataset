; ModuleID = '/home/pedro/tcc/exDataset/listasJandira-master/code_391.ll'
source_filename = "/home/pedro/tcc/exDataset/listasJandira-master/find_max.c"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

@main.myarray1 = private unnamed_addr constant [9 x i32] [i32 8, i32 7, i32 5, i32 3, i32 9, i32 10, i32 1, i32 2, i32 4], align 16
@main.myarray2 = private unnamed_addr constant [6 x i32] [i32 9, i32 6, i32 3, i32 1, i32 0, i32 8], align 16
@.str = private unnamed_addr constant [10 x i8] c"max1: %d\0A\00", align 1
@.str.1 = private unnamed_addr constant [10 x i8] c"max2: %d\0A\00", align 1
...
define i32 @main() #0 {
  ...
  %6 = call i32 @find_max(i32* %5, i32 9)
  %7 = getelementptr inbounds [6 x i32], [6 x i32]* %2, i32 0, i32 0
  %8 = call i32 @find_max(i32* %7, i32 6)
