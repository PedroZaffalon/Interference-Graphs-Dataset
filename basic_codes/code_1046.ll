; ModuleID = '/home/pedro/tcc/exDataset/sample/sample/Cpp.Playground-master/tools/convert_class/main.ll'
source_filename = "/home/pedro/tcc/exDataset/sample/sample/Cpp.Playground-master/tools/convert_class/main.cpp"
...
define i32 @main() #5 {
  %1 = alloca %class.ConvertTemp, align 8
  %2 = alloca %class.ConvertTemp, align 8
  %3 = alloca %class.ConvertTemp, align 8
  call void @_ZN11ConvertTempC1Ev(%class.ConvertTemp* %1)
  call void @_ZN11ConvertTempC1Ev(%class.ConvertTemp* %2)
  call void @_ZN11ConvertTempC1Ev(%class.ConvertTemp* %3)
  call void @_Z10fahrenheitdc(double -2.800000e+01, i8 signext 99)
