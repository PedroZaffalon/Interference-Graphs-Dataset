; ModuleID = '/home/pedro/tcc/exDataset/sample/sample/cpp-courses-master/09_lambda/09_02_lambda/09_02_00_Lambda.ll'
source_filename = "/home/pedro/tcc/exDataset/sample/sample/cpp-courses-master/09_lambda/09_02_lambda/09_02_00_Lambda.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_09_02_00_Lambda.cpp, i8* null }]
...
define i32 @main() #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %9 = getelementptr inbounds %"class.std::initializer_list", %"class.std::initializer_list"* %2, i32 0, i32 0
  store i32* getelementptr inbounds ([7 x i32], [7 x i32]* @.ref.tmp, i64 0, i64 0), i32** %9, align 8
  %10 = getelementptr inbounds %"class.std::initializer_list", %"class.std::initializer_list"* %2, i32 0, i32 1
  store i64 7, i64* %10, align 8
  call void @_ZNSaIiEC2Ev(%"class.std::allocator"* %3) #3
  %11 = bitcast %"class.std::initializer_list"* %2 to { i32*, i64 }*
  ...
  invoke void @_ZNSt6vectorIiSaIiEEC2ESt16initializer_listIiERKS0_(%"class.std::vector"* %1, i32* %13, i64 %15, %"class.std::allocator"* dereferenceable(1) %3)
...
16:                                               ; preds = %0
  ...
  %28 = invoke i32* @"_ZSt8for_eachIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEZ4mainE3$_0ET0_T_S9_S8_"(i32* %23, i32* %25, i32* %27)
...
44:                                               ; preds = %40, %36
  %.01 = phi i32 [ %43, %40 ], [ %39, %36 ]
  %.0 = phi i8* [ %42, %40 ], [ %38, %36 ]
  %45 = insertvalue { i8*, i32 } undef, i8* %.0, 0
  %46 = insertvalue { i8*, i32 } %45, i32 %.01, 1
  resume { i8*, i32 } %46
}
...
; Function Attrs: noinline uwtable
define internal i32* @"_ZSt8for_eachIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEZ4mainE3$_0ET0_T_S9_S8_"(i32* %0, i32* %1, i32* %2) #0 {
...
13:                                               ; preds = %11
  ...
  call void @"_ZZ4mainENK3$_0clEi"(%class.anon* %7, i32 %15)
  br label %16
...
18:                                               ; preds = %11
  %19 = bitcast %class.anon* %4 to i8*
  %20 = bitcast %class.anon* %7 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %19, i8* align 8 %20, i64 8, i1 false)
  %21 = getelementptr inbounds %class.anon, %class.anon* %4, i32 0, i32 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_09_02_00_Lambda.cpp() #0 section ".text.startup" {
