; ModuleID = '/home/pedro/tcc/exDataset/sample/sample/spectre-cpp-basics-main/MeetingCodes/Meeting4/Template.ll'
source_filename = "/home/pedro/tcc/exDataset/sample/sample/spectre-cpp-basics-main/MeetingCodes/Meeting4/Template.cpp"
...
$_Z6squareIiET_S0_ = comdat any

$_Z6squareIdET_S0_ = comdat any
...
define i32 @main() #4 {
  %1 = call i32 @_Z6squareIiET_S0_(i32 4)
  ...
  %4 = call double @_Z6squareIdET_S0_(double 4.500000e+00)
...
define linkonce_odr i32 @_Z6squareIiET_S0_(i32 %0) #5 comdat {
  %2 = mul nsw i32 %0, %0
  ret i32 %2
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr double @_Z6squareIdET_S0_(double %0) #5 comdat {
  %2 = fmul double %0, %0
  ret double %2
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_Template.cpp() #0 section ".text.startup" {
