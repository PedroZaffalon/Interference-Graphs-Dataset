; ModuleID = '/home/pedro/tcc/exDataset/sample/sample/Practice_of_Programming-master/20200619EndTerm/6.ll'
source_filename = "/home/pedro/tcc/exDataset/sample/sample/Practice_of_Programming-master/20200619EndTerm/6.cpp"
...
@w = global [1002 x i32] zeroinitializer, align 16
...
define i32 @_Z4getMi(i32 %0) #4 {
  br label %2

2:                                                ; preds = %17, %1
  %.01 = phi i32 [ 0, %1 ], [ %16, %17 ]
  %.0 = phi i32 [ 1, %1 ], [ %18, %17 ]
...
5:                                                ; preds = %2
  %6 = sext i32 %.0 to i64
  %7 = getelementptr inbounds [1002 x i32], [1002 x i32]* @w, i64 0, i64 %6
...
6:                                                ; preds = %3
  ...
  %8 = getelementptr inbounds [1002 x i32], [1002 x i32]* @w, i64 0, i64 %7
...
13:                                               ; preds = %24, %12
  %.02 = phi i32 [ 1, %12 ], [ %.13, %24 ]
  %.0 = phi i32 [ 10000000, %12 ], [ %.1, %24 ]
