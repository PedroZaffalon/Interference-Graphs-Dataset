; ModuleID = '/home/pedro/tcc/exDataset/listasJandira-master/code_188.ll'
source_filename = "/home/pedro/tcc/exDataset/listasJandira-master/display_file_contents.c"
...
4:                                                ; preds = %9, %3
  %5 = call i32 @fgetc(%struct._IO_FILE* %1)
  %6 = trunc i32 %5 to i8
  %7 = sext i8 %6 to i32
  %8 = icmp ne i32 %7, -1
...
12:                                               ; preds = %4
  %13 = call i32 @fclose(%struct._IO_FILE* %1)
  br label %16
