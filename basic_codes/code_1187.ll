; ModuleID = '/home/pedro/tcc/exDataset/sample/sample/Practice_of_Programming-master/RealPractices/02/H.ll'
source_filename = "/home/pedro/tcc/exDataset/sample/sample/Practice_of_Programming-master/RealPractices/02/H.AggresiveCow.cpp"
...
@a = global [100004 x i32] zeroinitializer, align 16
@.str = private unnamed_addr constant [5 x i8] c"%d%d\00", align 1
@.str.1 = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.2 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_H.AggresiveCow.cpp, i8* null }]
...
2:                                                ; preds = %28, %1
  %.03 = phi i32 [ 1, %1 ], [ %29, %28 ]
  %.02 = phi i32 [ 0, %1 ], [ %.01, %28 ]
...
10:                                               ; preds = %7
  ...
  %12 = getelementptr inbounds [100004 x i32], [100004 x i32]* @a, i64 0, i64 %11
  %13 = load i32, i32* %12, align 4
  %14 = sext i32 %.02 to i64
  %15 = getelementptr inbounds [100004 x i32], [100004 x i32]* @a, i64 0, i64 %14
...
5:                                                ; preds = %2
  ...
  %7 = getelementptr inbounds [100004 x i32], [100004 x i32]* @a, i64 0, i64 %6
...
11:                                               ; preds = %2
  ...
  %14 = getelementptr inbounds i32, i32* getelementptr inbounds ([100004 x i32], [100004 x i32]* @a, i32 0, i32 0), i64 %13
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([100004 x i32], [100004 x i32]* @a, i32 0, i32 0), i32* %14)
  %15 = call i32 @_ZNSt14numeric_limitsIiE3maxEv() #3
  br label %16

16:                                               ; preds = %25, %11
  %.02 = phi i32 [ 0, %11 ], [ %.13, %25 ]
  %.0 = phi i32 [ %15, %11 ], [ %.1, %25 ]
  %17 = sub nsw i32 %.0, %.02
...
25:                                               ; preds = %24, %23
  %.13 = phi i32 [ %21, %23 ], [ %.02, %24 ]
  %.1 = phi i32 [ %.0, %23 ], [ %21, %24 ]
  br label %16

26:                                               ; preds = %16
  %27 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i32 0, i32 0), i32 %.02)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_H.AggresiveCow.cpp() #0 section ".text.startup" {
