; ModuleID = '/home/pedro/tcc/exDataset/sample/sample/CPP-Geeksforgeeks-master/shorting_in_c++.ll'
source_filename = "/home/pedro/tcc/exDataset/sample/sample/CPP-Geeksforgeeks-master/shorting_in_c++.cpp"
...
@_ZZ4mainE3arr = private unnamed_addr constant [10 x i32] [i32 1, i32 5, i32 8, i32 9, i32 6, i32 7, i32 3, i32 4, i32 2, i32 0], align 16
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@.str = private unnamed_addr constant [47 x i8] c"\0AArray after sorting using default sort is : \0A\00", align 1
@.str.1 = private unnamed_addr constant [2 x i8] c" \00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_shorting_in_c__.cpp, i8* null }]
...
define i32 @main() #4 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %2, i8* align 16 bitcast ([10 x i32]* @_ZZ4mainE3arr to i8*), i64 40, i1 false)
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* %3, i32* %6)
  %7 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([47 x i8], [47 x i8]* @.str, i32 0, i32 0))
  br label %8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_shorting_in_c__.cpp() #0 section ".text.startup" {
