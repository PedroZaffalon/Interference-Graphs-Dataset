; ModuleID = '/home/pedro/tcc/exDataset/sample/sample/Cpp.Playground-master/practice/decimalToBinary.ll'
source_filename = "/home/pedro/tcc/exDataset/sample/sample/Cpp.Playground-master/practice/decimalToBinary.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_decimalToBinary.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define void @_Z8toBinaryi(i32 %0) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
...
23:                                               ; preds = %5
  %24 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* %2) #3
  %25 = trunc i64 %24 to i32
  br label %26

26:                                               ; preds = %35, %23
  %.0 = phi i32 [ %25, %23 ], [ %36, %35 ]
  %27 = icmp ugt i32 %.0, 0
...
38:                                               ; preds = %12
  %39 = insertvalue { i8*, i32 } undef, i8* %14, 0
  %40 = insertvalue { i8*, i32 } %39, i32 %15, 1
  resume { i8*, i32 } %40
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_decimalToBinary.cpp() #0 section ".text.startup" {
