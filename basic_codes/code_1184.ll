; ModuleID = '/home/pedro/tcc/exDataset/sample/sample/Practice_of_Programming-master/RealPractices/02/E.ll'
source_filename = "/home/pedro/tcc/exDataset/sample/sample/Practice_of_Programming-master/RealPractices/02/E.GCD.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_E.GCD.cpp, i8* null }]
...
define i32 @main() #5 {
  ...
  %7 = call i32 @_Z3gcdii(i32 %5, i32 %6)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_E.GCD.cpp() #0 section ".text.startup" {
