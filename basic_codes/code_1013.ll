; ModuleID = '/home/pedro/tcc/exDataset/sample/sample/C-teaching-master/lab05-producer-consumer/many_prod_one_cons.ll'
source_filename = "/home/pedro/tcc/exDataset/sample/sample/C-teaching-master/lab05-producer-consumer/many_prod_one_cons.c"
...
@.str.7 = private unnamed_addr constant [27 x i8] c"Post on empty_count failed\00", align 1
@.str.8 = private unnamed_addr constant [51 x i8] c"After the last 10 transactions balance is now %d.\0A\00", align 1
...
@.str.14 = private unnamed_addr constant [33 x i8] c"Could not initialize write_mutex\00", align 1
...
13:                                               ; preds = %12
  ...
  %21 = call i32 @sem_post(%union.sem_t* @empty_count) #8
  br label %22
...
24:                                               ; preds = %22
  ...
  %29 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %25, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.7, i32 0, i32 0), i8* %28)
  call void @exit(i32 1) #9
  unreachable
...
37:                                               ; preds = %31
  ...
  %39 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([51 x i8], [51 x i8]* @.str.8, i32 0, i32 0), i32 %38)
  br label %40
...
11:                                               ; preds = %9
  ...
  %16 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %12, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.12, i32 0, i32 0), i8* %15)
  call void @exit(i32 1) #9
  unreachable
...
22:                                               ; preds = %20
  ...
  %27 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %23, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.13, i32 0, i32 0), i8* %26)
  call void @exit(i32 1) #9
  unreachable
...
29:                                               ; preds = %28
  %30 = call i32 @sem_init(%union.sem_t* @write_mutex, i32 0, i32 1) #8
  br label %31
...
33:                                               ; preds = %31
  ...
  %38 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %34, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.14, i32 0, i32 0), i8* %37)
  call void @exit(i32 1) #9
  unreachable
...
41:                                               ; preds = %65, %40
  %.0 = phi i64 [ 0, %40 ], [ %66, %65 ]
  %42 = icmp slt i64 %.0, 3
  br i1 %42, label %43, label %67

43:                                               ; preds = %41
  %44 = inttoptr i64 %.0 to i8*
  %45 = call i32 @pthread_create(i64* %3, %union.pthread_attr_t* null, i8* (i8*)* @performTransactions, i8* %44) #8
  br label %46
...
48:                                               ; preds = %46
  %49 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %50 = call i8* @strerror(i32 %45) #8
  %51 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %49, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.15, i32 0, i32 0), i8* %50)
  call void @exit(i32 1) #9
  unreachable
...
53:                                               ; preds = %52
  ...
  %55 = call i32 @pthread_detach(i64 %54) #8
  br label %56
...
58:                                               ; preds = %56
  ...
  %60 = call i8* @strerror(i32 %55) #8
  %61 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %59, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.16, i32 0, i32 0), i8* %60)
  call void @exit(i32 1) #9
  unreachable
...
67:                                               ; preds = %41
  %68 = call i32 @pthread_create(i64* %4, %union.pthread_attr_t* null, i8* (i8*)* @processTransactions, i8* null) #8
  br label %69
...
71:                                               ; preds = %69
  ...
  %73 = call i8* @strerror(i32 %68) #8
  %74 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %72, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.17, i32 0, i32 0), i8* %73)
  call void @exit(i32 1) #9
  unreachable
...
76:                                               ; preds = %75
  ...
  %78 = call i32 @pthread_detach(i64 %77) #8
  br label %79
...
81:                                               ; preds = %79
  ...
  %83 = call i8* @strerror(i32 %78) #8
  %84 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %82, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.18, i32 0, i32 0), i8* %83)
  call void @exit(i32 1) #9
  unreachable
