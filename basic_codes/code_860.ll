; ModuleID = '/home/pedro/tcc/exDataset/sample/sample/C-Programming-master/141217/filecopy4.ll'
source_filename = "/home/pedro/tcc/exDataset/sample/sample/C-Programming-master/141217/filecopy4.c"
...
4:                                                ; preds = %8, %2
  ...
  %6 = call i8* @fgets(i8* %5, i32 1024, %struct._IO_FILE* %0)
  %7 = icmp ne i8* %6, null
  br i1 %7, label %8, label %11

8:                                                ; preds = %4
  %9 = getelementptr inbounds [1024 x i8], [1024 x i8]* %3, i32 0, i32 0
  %10 = call i32 @fputs(i8* %9, %struct._IO_FILE* %1)
  br label %4
