; ModuleID = '/home/pedro/tcc/exDataset/sample/sample/CompetitiveProgramming-master/code/UpdateArray.ll'
source_filename = "/home/pedro/tcc/exDataset/sample/sample/CompetitiveProgramming-master/code/UpdateArray.cpp"
...
%struct.fenwick_tree = type { %"class.std::vector" }
...
$_ZN12fenwick_treeIlEC2Em = comdat any

$_ZN12fenwick_treeIlE3addEil = comdat any

$_ZN12fenwick_treeIlE3sumEi = comdat any

$_ZN12fenwick_treeIlED2Ev = comdat any
...
@.str = private unnamed_addr constant [7 x i8] c"%u%d%d\00", align 1
@.str.1 = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_UpdateArray.cpp, i8* null }]
...
define i32 @main() #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %4 = alloca %struct.fenwick_tree, align 8
...
10:                                               ; preds = %59, %0
  %.01 = phi i64 [ 0, %0 ], [ %60, %59 ]
  %11 = load i64, i64* %1, align 8
  %12 = icmp ult i64 %.01, %11
  br i1 %12, label %13, label %61

13:                                               ; preds = %10
  %14 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERm(%"class.std::basic_istream"* @_ZSt3cin, i64* dereferenceable(8) %2)
  %15 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERm(%"class.std::basic_istream"* @_ZSt3cin, i64* dereferenceable(8) %3)
  %16 = load i64, i64* %2, align 8
  %17 = add i64 %16, 1
  call void @_ZN12fenwick_treeIlEC2Em(%struct.fenwick_tree* %4, i64 %17)
  br label %18

18:                                               ; preds = %34, %13
  %.02 = phi i64 [ 0, %13 ], [ %35, %34 ]
  %19 = load i64, i64* %3, align 8
  %20 = icmp ult i64 %.02, %19
  br i1 %20, label %21, label %40

21:                                               ; preds = %18
  %22 = invoke i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i32 0, i32 0), i32* %5, i32* %6, i32* %7)
...
23:                                               ; preds = %21
  ...
  invoke void @_ZN12fenwick_treeIlE3addEil(%struct.fenwick_tree* %4, i32 %24, i64 %26)
...
27:                                               ; preds = %23
  ...
  invoke void @_ZN12fenwick_treeIlE3addEil(%struct.fenwick_tree* %4, i32 %29, i64 %32)
...
36:                                               ; preds = %53, %51, %48, %46, %40, %27, %23, %21
  %37 = landingpad { i8*, i32 }
          cleanup
  %38 = extractvalue { i8*, i32 } %37, 0
  %39 = extractvalue { i8*, i32 } %37, 1
  call void @_ZN12fenwick_treeIlED2Ev(%struct.fenwick_tree* %4) #3
  br label %62

40:                                               ; preds = %18
  %41 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERm(%"class.std::basic_istream"* @_ZSt3cin, i64* dereferenceable(8) %8)
...
43:                                               ; preds = %56, %42
  %.0 = phi i64 [ 0, %42 ], [ %57, %56 ]
  %44 = load i64, i64* %8, align 8
  %45 = icmp ult i64 %.0, %44
  br i1 %45, label %46, label %58

46:                                               ; preds = %43
  %47 = invoke i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i32 0, i32 0), i32* %5)
          to label %48 unwind label %36

48:                                               ; preds = %46
  %49 = load i32, i32* %5, align 4
  %50 = invoke i64 @_ZN12fenwick_treeIlE3sumEi(%struct.fenwick_tree* %4, i32 %49)
          to label %51 unwind label %36

51:                                               ; preds = %48
  %52 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEl(%"class.std::basic_ostream"* @_ZSt4cout, i64 %50)
...
62:                                               ; preds = %36
  %63 = insertvalue { i8*, i32 } undef, i8* %38, 0
  %64 = insertvalue { i8*, i32 } %63, i32 %39, 1
  resume { i8*, i32 } %64
}
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZN12fenwick_treeIlEC2Em(%struct.fenwick_tree* %0, i64 %1) unnamed_addr #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %3 = alloca %"class.std::allocator", align 1
  %4 = getelementptr inbounds %struct.fenwick_tree, %struct.fenwick_tree* %0, i32 0, i32 0
  %5 = add i64 %1, 1
  call void @_ZNSaIlEC2Ev(%"class.std::allocator"* %3) #3
  invoke void @_ZNSt6vectorIlSaIlEEC2EmRKS0_(%"class.std::vector"* %4, i64 %5, %"class.std::allocator"* dereferenceable(1) %3)
...
define linkonce_odr void @_ZN12fenwick_treeIlE3addEil(%struct.fenwick_tree* %0, i32 %1, i64 %2) #5 comdat align 2 {
  %4 = add nsw i32 %1, 1
  br label %5
...
5:                                                ; preds = %16, %3
  %.0 = phi i32 [ %4, %3 ], [ %19, %16 ]
  %6 = sext i32 %.0 to i64
  %7 = getelementptr inbounds %struct.fenwick_tree, %struct.fenwick_tree* %0, i32 0, i32 0
  %8 = call i64 @_ZNKSt6vectorIlSaIlEE4sizeEv(%"class.std::vector"* %7) #3
  %9 = icmp ult i64 %6, %8
  br i1 %9, label %10, label %20

10:                                               ; preds = %5
  %11 = getelementptr inbounds %struct.fenwick_tree, %struct.fenwick_tree* %0, i32 0, i32 0
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64 @_ZN12fenwick_treeIlE3sumEi(%struct.fenwick_tree* %0, i32 %1) #5 comdat align 2 {
  %3 = add nsw i32 %1, 1
  br label %4

4:                                                ; preds = %12, %2
  %.01 = phi i32 [ %3, %2 ], [ %14, %12 ]
  %.0 = phi i64 [ 0, %2 ], [ %11, %12 ]
  %5 = icmp sgt i32 %.01, 0
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN12fenwick_treeIlED2Ev(%struct.fenwick_tree* %0) unnamed_addr #5 comdat align 2 {
  %2 = getelementptr inbounds %struct.fenwick_tree, %struct.fenwick_tree* %0, i32 0, i32 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_UpdateArray.cpp() #0 section ".text.startup" {
