; ModuleID = '/home/pedro/tcc/exDataset/sample/sample/CPP-master/Lesson9/Builder/builder2.ll'
source_filename = "/home/pedro/tcc/exDataset/sample/sample/CPP-master/Lesson9/Builder/builder2.cpp"
...
@.str = private unnamed_addr constant [14 x i8] c"The maze has \00", align 1
@.str.1 = private unnamed_addr constant [12 x i8] c" rooms and \00", align 1
@.str.2 = private unnamed_addr constant [7 x i8] c" doors\00", align 1
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_builder2.cpp, i8* null }]
...
define i32 @main() #4 {
  ...
  %3 = alloca %class.MazeGame, align 8
  %4 = alloca %class.CountingMazeBuilder, align 8
  call void @_ZN8MazeGameC2Ev(%class.MazeGame* %3) #3
  call void @_ZN19CountingMazeBuilderC1Ev(%class.CountingMazeBuilder* %4)
  %5 = bitcast %class.CountingMazeBuilder* %4 to %class.MazeBuilder*
  %6 = call %class.Maze* @_ZN8MazeGame10CreateMazeER11MazeBuilder(%class.MazeGame* %3, %class.MazeBuilder* dereferenceable(8) %5)
  call void @_ZNK19CountingMazeBuilder9GetCountsERiS0_(%class.CountingMazeBuilder* %4, i32* dereferenceable(4) %1, i32* dereferenceable(4) %2)
  %7 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i32 0, i32 0))
  %8 = load i32, i32* %1, align 4
  %9 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %7, i32 %8)
  %10 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %9, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i32 0, i32 0))
...
declare void @_ZN19CountingMazeBuilderC1Ev(%class.CountingMazeBuilder*) unnamed_addr #1

declare %class.Maze* @_ZN8MazeGame10CreateMazeER11MazeBuilder(%class.MazeGame*, %class.MazeBuilder* dereferenceable(8)) #1

declare void @_ZNK19CountingMazeBuilder9GetCountsERiS0_(%class.CountingMazeBuilder*, i32* dereferenceable(4), i32* dereferenceable(4)) #1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_builder2.cpp() #0 section ".text.startup" {
