; ModuleID = '/home/pedro/tcc/exDataset/sample/sample/Practice_of_Programming-master/RealPractices/01/I.ll'
source_filename = "/home/pedro/tcc/exDataset/sample/sample/Practice_of_Programming-master/RealPractices/01/I.PutApple.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_I.PutApple.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define void @_Z6searchii(i32 %0, i32 %1) #0 {
...
16:                                               ; preds = %14
  ...
  %19 = add nsw i32 %0, 1
  call void @_Z6searchii(i32 %19, i32 %.0)
...
7:                                                ; preds = %3
  ...
  call void @_Z6searchii(i32 1, i32 %10)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_I.PutApple.cpp() #0 section ".text.startup" {
