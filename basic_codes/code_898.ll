; ModuleID = '/home/pedro/tcc/exDataset/sample/sample/C-main/treewithafilepro.ll'
source_filename = "/home/pedro/tcc/exDataset/sample/sample/C-main/treewithafilepro.c"
...
; Function Attrs: noinline nounwind uwtable
define i32 @main() #0 {
  %1 = call %struct.treenode* @insert(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.21, i32 0, i32 0), %struct.treenode* null)
  %2 = call %struct.treenode* @insert(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.22, i32 0, i32 0), %struct.treenode* %1)
  %3 = call %struct.treenode* @insert(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.22, i32 0, i32 0), %struct.treenode* %2)
  call void @show(%struct.treenode* %3, i8 signext 43)
  ret i32 0
}
