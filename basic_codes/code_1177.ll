; ModuleID = '/home/pedro/tcc/exDataset/sample/sample/Practice_of_Programming-master/RealPractices/03/C.ll'
source_filename = "/home/pedro/tcc/exDataset/sample/sample/Practice_of_Programming-master/RealPractices/03/C.SimplistFraction.cpp"
...
@a = global [605 x i32] zeroinitializer, align 16
@_ZSt3cin = external global %"class.std::basic_istream", align 8
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_C.SimplistFraction.cpp, i8* null }]
...
6:                                                ; preds = %3
  ...
  %8 = getelementptr inbounds [605 x i32], [605 x i32]* @a, i64 0, i64 %7
...
13:                                               ; preds = %36, %12
  %.03 = phi i32 [ 1, %12 ], [ %37, %36 ]
  %.02 = phi i32 [ 0, %12 ], [ %.1, %36 ]
...
18:                                               ; preds = %33, %16
  %.1 = phi i32 [ %.02, %16 ], [ %.2, %33 ]
  %.0 = phi i32 [ %17, %16 ], [ %34, %33 ]
...
21:                                               ; preds = %18
  ...
  %23 = getelementptr inbounds [605 x i32], [605 x i32]* @a, i64 0, i64 %22
  %24 = load i32, i32* %23, align 4
  %25 = sext i32 %.0 to i64
  %26 = getelementptr inbounds [605 x i32], [605 x i32]* @a, i64 0, i64 %25
  %27 = load i32, i32* %26, align 4
  %28 = call i32 @_Z3gcdii(i32 %24, i32 %27)
  %29 = icmp eq i32 %28, 1
...
38:                                               ; preds = %13
  %39 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %.02)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_C.SimplistFraction.cpp() #0 section ".text.startup" {
