; ModuleID = '/home/pedro/tcc/exDataset/sample/sample/CPlusPlus-master/How_Much_Insurance.ll'
source_filename = "/home/pedro/tcc/exDataset/sample/sample/CPlusPlus-master/How_Much_Insurance.cpp"
...
@.str = private unnamed_addr constant [17 x i8] c"House Insurance!\00", align 1
@.str.1 = private unnamed_addr constant [46 x i8] c"Enter the replacement cost of the building: $\00", align 1
@_ZSt3cin = external global %"class.std::basic_istream", align 8
@.str.2 = private unnamed_addr constant [56 x i8] c"Minimum amount of insurance that should be purchased: $\00", align 1
@.str.3 = private unnamed_addr constant [6 x i8] c"pause\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_How_Much_Insurance.cpp, i8* null }]
...
define i32 @main() #4 {
  ...
  %5 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([46 x i8], [46 x i8]* @.str.1, i32 0, i32 0))
  ...
  %8 = fmul double %7, 8.000000e-01
  %9 = call i32 @_ZSt12setprecisioni(i32 2)
  ...
  %15 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([56 x i8], [56 x i8]* @.str.2, i32 0, i32 0))
  %16 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEd(%"class.std::basic_ostream"* %15, double %8)
  %17 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEPFRSoS_E(%"class.std::basic_ostream"* %16, %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  %18 = call i32 @system(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.3, i32 0, i32 0))
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_How_Much_Insurance.cpp() #0 section ".text.startup" {
