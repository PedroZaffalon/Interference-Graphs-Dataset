; ModuleID = '/home/pedro/tcc/exDataset/sample/sample/Practice_of_Programming-master/20200619EndTerm/2.ll'
source_filename = "/home/pedro/tcc/exDataset/sample/sample/Practice_of_Programming-master/20200619EndTerm/2.cpp"
...
7:                                                ; preds = %5
  %8 = call dereferenceable(4) i32* @_ZSt3minIiERKT_S2_S2_(i32* dereferenceable(4) @ans, i32* dereferenceable(4) @cnt)
...
13:                                               ; preds = %27, %11
  %.0 = phi i32 [ %0, %11 ], [ %20, %27 ]
  %14 = icmp sge i32 %.0, 0
  br i1 %14, label %15, label %28

15:                                               ; preds = %13
  %16 = add nsw i32 %1, 1
  call void @_Z3dfsii(i32 %.0, i32 %16)
...
16:                                               ; preds = %7
  %17 = call i32 @_ZNSt14numeric_limitsIiE3maxEv() #3
  store i32 %17, i32* @ans, align 4
  store i32 0, i32* @cnt, align 4
  %18 = load i32, i32* @k, align 4
  call void @_Z3dfsii(i32 %18, i32 1)
