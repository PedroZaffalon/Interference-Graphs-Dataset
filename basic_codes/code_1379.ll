; ModuleID = '/home/pedro/tcc/exDataset/sample/sample/spectre-cpp-basics-main/Solutions/Lesson2/Poly/Square.ll'
source_filename = "/home/pedro/tcc/exDataset/sample/sample/spectre-cpp-basics-main/Solutions/Lesson2/Poly/Square.cpp"
...
@_ZTV6Square = linkonce_odr unnamed_addr constant { [4 x i8*] } { [4 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i8* }* @_ZTI6Square to i8*), i8* bitcast (double (%class.Rectangle*)* @_ZNK9Rectangle9perimeterEv to i8*), i8* bitcast (double (%class.Rectangle*)* @_ZNK9Rectangle4areaEv to i8*)] }, comdat, align 8
...
; Function Attrs: nounwind
declare double @_ZNK9Rectangle4areaEv(%class.Rectangle*) unnamed_addr #1
