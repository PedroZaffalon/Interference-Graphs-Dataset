; ModuleID = '/home/pedro/tcc/exDataset/sample/sample/Practice_of_Programming-master/RealPractices/02/D.ll'
source_filename = "/home/pedro/tcc/exDataset/sample/sample/Practice_of_Programming-master/RealPractices/02/D.Factorization.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_D.Factorization.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define i32 @_Z5countii(i32 %0, i32 %1) #0 {
...
11:                                               ; preds = %23, %8
  %.02 = phi i32 [ %10, %8 ], [ %24, %23 ]
  %.01 = phi i32 [ 0, %8 ], [ %.1, %23 ]
  %12 = icmp sgt i32 %.02, 1
...
17:                                               ; preds = %13
  ...
  %19 = sdiv i32 %18, %.02
  %20 = call i32 @_Z5countii(i32 %19, i32 %.02)
  %21 = add nsw i32 %.01, %20
  br label %22

22:                                               ; preds = %17, %13
  %.1 = phi i32 [ %21, %17 ], [ %.01, %13 ]
  br label %23
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_D.Factorization.cpp() #0 section ".text.startup" {
