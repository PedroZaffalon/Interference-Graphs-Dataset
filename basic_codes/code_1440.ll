; ModuleID = '/home/pedro/tcc/exDataset/sample/sample/cpp-courses-master/02_keywords_and_specificators/02_01_override_and_final/02_01_00_override_and_final.ll'
source_filename = "/home/pedro/tcc/exDataset/sample/sample/cpp-courses-master/02_keywords_and_specificators/02_01_override_and_final/02_01_00_override_and_final.cpp"
...
@_ZTV7derived = linkonce_odr unnamed_addr constant { [4 x i8*] } { [4 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i8* }* @_ZTI7derived to i8*), i8* bitcast (void (%struct.derived*)* @_ZN7derived3fooEv to i8*), i8* bitcast (void (%struct.derived*)* @_ZN7derived3barEv to i8*)] }, comdat, align 8
...
@_ZTV4base = linkonce_odr unnamed_addr constant { [4 x i8*] } { [4 x i8*] [i8* null, i8* bitcast ({ i8*, i8* }* @_ZTI4base to i8*), i8* bitcast (void (%struct.base*)* @_ZN4base3fooEv to i8*), i8* bitcast (void (%struct.base*)* @_ZN4base3barEv to i8*)] }, comdat, align 8
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@.str = private unnamed_addr constant [9 x i8] c"Base Foo\00", align 1
@.str.1 = private unnamed_addr constant [9 x i8] c"Base Bar\00", align 1
@.str.2 = private unnamed_addr constant [12 x i8] c"Derived Foo\00", align 1
@.str.3 = private unnamed_addr constant [12 x i8] c"Derived Bar\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_02_01_00_override_and_final.cpp, i8* null }]
...
define i32 @main() #4 {
  ...
  call void @_ZN7derivedC2Ev(%struct.derived* %1) #3
  %3 = bitcast %struct.derived* %1 to %struct.base*
  %4 = bitcast %struct.base* %3 to void (%struct.base*)***
  %5 = load void (%struct.base*)**, void (%struct.base*)*** %4, align 8
  %6 = getelementptr inbounds void (%struct.base*)*, void (%struct.base*)** %5, i64 0
  %7 = load void (%struct.base*)*, void (%struct.base*)** %6, align 8
  call void %7(%struct.base* %3)
  ret i32 0
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN7derivedC2Ev(%struct.derived* %0) unnamed_addr #5 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN4baseC2Ev(%struct.base* %0) unnamed_addr #5 comdat align 2 {
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZN7derived3fooEv(%struct.derived* %0) unnamed_addr #0 comdat align 2 {
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZN7derived3barEv(%struct.derived* %0) unnamed_addr #0 comdat align 2 {
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZN4base3fooEv(%struct.base* %0) unnamed_addr #0 comdat align 2 {
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZN4base3barEv(%struct.base* %0) unnamed_addr #0 comdat align 2 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_02_01_00_override_and_final.cpp() #0 section ".text.startup" {
