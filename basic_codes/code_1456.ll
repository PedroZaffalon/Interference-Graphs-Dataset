; ModuleID = '/home/pedro/tcc/exDataset/sample/sample/cpp-courses-master/12_template_meta_programming/12_03_conditional/12_03_01_disjunction.ll'
source_filename = "/home/pedro/tcc/exDataset/sample/sample/cpp-courses-master/12_template_meta_programming/12_03_conditional/12_03_01_disjunction.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_12_03_01_disjunction.cpp, i8* null }]
...
define i32 @main() #4 {
  ...
  %2 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEb(%"class.std::basic_ostream"* %1, i1 zeroext true)
  ...
  %4 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEb(%"class.std::basic_ostream"* %3, i1 zeroext true)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_12_03_01_disjunction.cpp() #0 section ".text.startup" {
