; ModuleID = '/home/pedro/tcc/exDataset/sample/sample/spectre-cpp-basics-main/MeetingCodes/Meeting4/Main.ll'
source_filename = "/home/pedro/tcc/exDataset/sample/sample/spectre-cpp-basics-main/MeetingCodes/Meeting4/Main.cpp"
...
define i32 @main() #4 {
  ...
  call void @_ZN9RectangleC1Edd(%class.Rectangle* %1, double 4.000000e+00, double 5.000000e+00) #3
  call void @_ZN6SquareC1Ed(%class.Square* %2, double 4.000000e+00) #3
  %3 = call double @_ZNK9Rectangle9PerimeterEv(%class.Rectangle* %1) #3
  ...
  %6 = call double @_ZN6Square9PerimeterEv(%class.Square* %2) #3
  %7 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEd(%"class.std::basic_ostream"* @_ZSt4cout, double %6)
...
; Function Attrs: nounwind
declare double @_ZN6Square9PerimeterEv(%class.Square*) #2
