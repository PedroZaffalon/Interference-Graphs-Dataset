; ModuleID = '/home/pedro/tcc/exDataset/sample/sample/cpp-courses-master/11_variadic_templates/11_02_pack_expansion/11_02_02_braced_initialization.ll'
source_filename = "/home/pedro/tcc/exDataset/sample/sample/cpp-courses-master/11_variadic_templates/11_02_pack_expansion/11_02_02_braced_initialization.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_11_02_02_braced_initialization.cpp, i8* null }]
...
define i32 @main() #4 {
  call void @_Z3fooIJiiiEEvDpT_(i32 1, i32 2, i32 3)
  ret i32 0
}

; Function Attrs: noinline uwtable
define linkonce_odr void @_Z3fooIJiiiEEvDpT_(i32 %0, i32 %1, i32 %2) #0 comdat personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  invoke void @_ZNSt6vectorIiSaIiEEC2ESt16initializer_listIiERKS0_(%"class.std::vector"* %4, i32* %24, i64 %26, %"class.std::allocator"* dereferenceable(1) %7)
          to label %27 unwind label %72

27:                                               ; preds = %3
  call void @_ZNSaIiED2Ev(%"class.std::allocator"* %7) #3
  %28 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* %4) #3
...
32:                                               ; preds = %30
  ...
  %39 = getelementptr inbounds [5 x i32], [5 x i32]* %10, i64 0, i64 0
  ...
  invoke void @_ZNSt6vectorIiSaIiEEC2ESt16initializer_listIiERKS0_(%"class.std::vector"* %8, i32* %43, i64 %45, %"class.std::allocator"* dereferenceable(1) %11)
          to label %46 unwind label %80

46:                                               ; preds = %32
  call void @_ZNSaIiED2Ev(%"class.std::allocator"* %11) #3
  %47 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* %8) #3
...
51:                                               ; preds = %49
  %52 = getelementptr inbounds [6 x i32], [6 x i32]* %14, i64 0, i64 0
  ...
  %59 = getelementptr inbounds [6 x i32], [6 x i32]* %14, i64 0, i64 0
  ...
  invoke void @_ZNSt6vectorIiSaIiEEC2ESt16initializer_listIiERKS0_(%"class.std::vector"* %12, i32* %63, i64 %65, %"class.std::allocator"* dereferenceable(1) %15)
...
96:                                               ; preds = %92, %88, %84
  %.01 = phi i8* [ %94, %92 ], [ %90, %88 ], [ %86, %84 ]
  %.0 = phi i32 [ %95, %92 ], [ %91, %88 ], [ %87, %84 ]
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %8) #3
  br label %97

97:                                               ; preds = %96, %80, %76
  %.12 = phi i8* [ %.01, %96 ], [ %82, %80 ], [ %78, %76 ]
  %.1 = phi i32 [ %.0, %96 ], [ %83, %80 ], [ %79, %76 ]
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %4) #3
  br label %98

98:                                               ; preds = %97, %72
  %.23 = phi i8* [ %.12, %97 ], [ %74, %72 ]
  %.2 = phi i32 [ %.1, %97 ], [ %75, %72 ]
  %99 = insertvalue { i8*, i32 } undef, i8* %.23, 0
  %100 = insertvalue { i8*, i32 } %99, i32 %.2, 1
  resume { i8*, i32 } %100
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_11_02_02_braced_initialization.cpp() #0 section ".text.startup" {
