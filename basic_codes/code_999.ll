; ModuleID = '/home/pedro/tcc/exDataset/sample/sample/C-teaching-master/lab08-socket-process-thread/multiprocess.ll'
source_filename = "/home/pedro/tcc/exDataset/sample/sample/C-teaching-master/lab08-socket-process-thread/multiprocess.c"
...
@.str.12 = private unnamed_addr constant [49 x i8] c"Cannot fork server process to handle the request\00", align 1
@.str.13 = private unnamed_addr constant [47 x i8] c"Cannot close listening socket in child process\00", align 1
@.str.14 = private unnamed_addr constant [54 x i8] c"Process created to handle the request has completed.\0A\00", align 1
@.str.15 = private unnamed_addr constant [45 x i8] c"Cannot close incoming socket in main process\00", align 1
@.str.16 = private unnamed_addr constant [46 x i8] c"Child process created to handle the request!\0A\00", align 1
...
86:                                               ; preds = %85
  ...
  %91 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %87, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([49 x i8], [49 x i8]* @.str.12, i32 0, i32 0), i8* %90)
  call void @exit(i32 1) #10
  unreachable
...
99:                                               ; preds = %97
  ...
  %104 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %100, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([47 x i8], [47 x i8]* @.str.13, i32 0, i32 0), i8* %103)
  call void @exit(i32 1) #10
  unreachable
...
106:                                              ; preds = %105
  ...
  %108 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %107, i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.14, i32 0, i32 0))
  %109 = bitcast %struct.sockaddr_in* %60 to i8*
  call void @free(i8* %109) #8
  call void @exit(i32 0) #10
  unreachable

110:                                              ; preds = %93
  %111 = call i32 @close(i32 %63)
  br label %112
...
114:                                              ; preds = %112
  ...
  %119 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %115, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.15, i32 0, i32 0), i8* %118)
  call void @exit(i32 1) #10
  unreachable
...
121:                                              ; preds = %120
  ...
  %123 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %122, i8* getelementptr inbounds ([46 x i8], [46 x i8]* @.str.16, i32 0, i32 0))
  %124 = bitcast %struct.sockaddr_in* %60 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 4 %124, i8 0, i64 16, i1 false)
  br label %125
