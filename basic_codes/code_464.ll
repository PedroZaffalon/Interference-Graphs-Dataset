; ModuleID = '/home/pedro/tcc/exDataset/listasJandira-master/code_438.ll'
source_filename = "/home/pedro/tcc/exDataset/listasJandira-master/swag.c"
...
@.str.3 = private unnamed_addr constant [39 x i8] c"\0AAfter swapping, first number = %.2lf\0A\00", align 1
@.str.4 = private unnamed_addr constant [38 x i8] c"After swapping, second number = %.2lf\00", align 1
...
define i32 @main() #0 {
  ...
  %10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([39 x i8], [39 x i8]* @.str.3, i32 0, i32 0), double %9)
  %11 = load double, double* %2, align 8
  %12 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.4, i32 0, i32 0), double %11)
  ret i32 0
}
