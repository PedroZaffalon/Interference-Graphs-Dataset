; ModuleID = '/home/pedro/tcc/exDataset/sample/sample/C-teaching-master/lab10-chat-socket+fifo/chat-socket.ll'
source_filename = "/home/pedro/tcc/exDataset/sample/sample/C-teaching-master/lab10-chat-socket+fifo/chat-socket.c"
...
@.str.3 = private unnamed_addr constant [24 x i8] c"Cannot read from socket\00", align 1
@.str.4 = private unnamed_addr constant [67 x i8] c"[WARNING] Endpoint closed the connection unexpectedly. Exiting...\0A\00", align 1
...
@.str.8 = private unnamed_addr constant [23 x i8] c"Cannot write to socket\00", align 1
...
@.str.15 = private unnamed_addr constant [20 x i8] c"Cannot close socket\00", align 1
@.str.16 = private unnamed_addr constant [8 x i8] c"Usage:\0A\00", align 1
@.str.17 = private unnamed_addr constant [32 x i8] c"       %s accept <port_number>\0A\00", align 1
@.str.18 = private unnamed_addr constant [7 x i8] c"  OR:\0A\00", align 1
@.str.19 = private unnamed_addr constant [46 x i8] c"       %s connect <IP_address> <port_number>\0A\00", align 1
@.str.20 = private unnamed_addr constant [7 x i8] c"accept\00", align 1
@.str.21 = private unnamed_addr constant [50 x i8] c"Please use a port number between 1024 and 49151.\0A\00", align 1
...
56:                                               ; preds = %91, %67, %55
  ...
  %60 = call i64 @recv(i32 %6, i8* %59, i64 1, i32 0)
...
71:                                               ; preds = %69
  ...
  %76 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %72, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.3, i32 0, i32 0), i8* %75)
  call void @exit(i32 1) #10
  unreachable
...
80:                                               ; preds = %78
  ...
  %82 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %81, i8* getelementptr inbounds ([67 x i8], [67 x i8]* @.str.4, i32 0, i32 0))
...
29:                                               ; preds = %26
  ...
  %34 = sub i64 %25, %33
  %35 = call i64 @send(i32 %4, i8* %32, i64 %34, i32 0)
...
46:                                               ; preds = %44
  ...
  %51 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %47, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.8, i32 0, i32 0), i8* %50)
  call void @exit(i32 1) #10
  unreachable
...
; Function Attrs: noinline nounwind uwtable
define void @chatSession(i32 %0) #0 {
  %2 = alloca [2 x i64], align 16
  %3 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %4 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %3, i8* getelementptr inbounds ([44 x i8], [44 x i8]* @.str.10, i32 0, i32 0), i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0))
  %5 = getelementptr inbounds [2 x i64], [2 x i64]* %2, i64 0, i64 0
  %6 = sext i32 %0 to i64
  %7 = inttoptr i64 %6 to i8*
  %8 = call i32 @pthread_create(i64* %5, %union.pthread_attr_t* null, i8* (i8*)* @receiveMessage, i8* %7) #8
  br label %9
...
11:                                               ; preds = %9
  ...
  %13 = call i8* @strerror(i32 %8) #8
  %14 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %12, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([44 x i8], [44 x i8]* @.str.11, i32 0, i32 0), i8* %13)
  call void @exit(i32 1) #10
  unreachable
...
16:                                               ; preds = %15
  %17 = getelementptr inbounds [2 x i64], [2 x i64]* %2, i64 0, i64 1
  %18 = sext i32 %0 to i64
  %19 = inttoptr i64 %18 to i8*
  %20 = call i32 @pthread_create(i64* %17, %union.pthread_attr_t* null, i8* (i8*)* @sendMessage, i8* %19) #8
  br label %21
...
23:                                               ; preds = %21
  ...
  %25 = call i8* @strerror(i32 %20) #8
  %26 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %24, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([42 x i8], [42 x i8]* @.str.12, i32 0, i32 0), i8* %25)
  call void @exit(i32 1) #10
  unreachable
...
34:                                               ; preds = %32
  ...
  %36 = call i8* @strerror(i32 %31) #8
  %37 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %35, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.13, i32 0, i32 0), i8* %36)
  call void @exit(i32 1) #10
  unreachable
...
39:                                               ; preds = %38
  %40 = getelementptr inbounds [2 x i64], [2 x i64]* %2, i64 0, i64 1
  %41 = load i64, i64* %40, align 8
  %42 = call i32 @pthread_join(i64 %41, i8** null)
  br label %43
...
45:                                               ; preds = %43
  %46 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %47 = call i8* @strerror(i32 %42) #8
  %48 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %46, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.14, i32 0, i32 0), i8* %47)
  call void @exit(i32 1) #10
  unreachable
...
54:                                               ; preds = %52
  ...
  %59 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %55, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.15, i32 0, i32 0), i8* %58)
  call void @exit(i32 1) #10
  unreachable
...
define void @syntaxError(i8* %0) #0 {
  ...
  %3 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %2, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.16, i32 0, i32 0))
  %4 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %5 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %4, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.17, i32 0, i32 0), i8* %0)
  %6 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %7 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %6, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.18, i32 0, i32 0))
  %8 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %9 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %8, i8* getelementptr inbounds ([46 x i8], [46 x i8]* @.str.19, i32 0, i32 0), i8* %0)
  call void @exit(i32 1) #10
  unreachable
...
4:                                                ; preds = %2
  ...
  %7 = call i32 @strcmp(i8* %6, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.20, i32 0, i32 0)) #7
  %8 = icmp ne i32 %7, 0
...
9:                                                ; preds = %4
  ...
  call void @syntaxError(i8* %11)
  br label %12

12:                                               ; preds = %9, %4
  %13 = getelementptr inbounds i8*, i8** %1, i64 2
  %14 = load i8*, i8** %13, align 8
  %15 = call i64 @strtol(i8* %14, i8** null, i32 0) #8
  %16 = icmp slt i64 %15, 1024
  br i1 %16, label %19, label %17

17:                                               ; preds = %12
  %18 = icmp sgt i64 %15, 49151
  br i1 %18, label %19, label %22

19:                                               ; preds = %17, %12
  %20 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %21 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %20, i8* getelementptr inbounds ([50 x i8], [50 x i8]* @.str.21, i32 0, i32 0))
  call void @exit(i32 1) #10
  unreachable

22:                                               ; preds = %17
  %23 = trunc i64 %15 to i16
  %24 = call zeroext i16 @htons(i16 zeroext %23) #9
  call void @listenOnPort(i16 zeroext %24)
  br label %55
...
27:                                               ; preds = %25
  ...
  %30 = call i32 @strcmp(i8* %29, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.22, i32 0, i32 0)) #7
  %31 = icmp ne i32 %30, 0
...
32:                                               ; preds = %27
  ...
  call void @syntaxError(i8* %34)
  br label %35

35:                                               ; preds = %32, %27
  %36 = getelementptr inbounds i8*, i8** %1, i64 2
  %37 = load i8*, i8** %36, align 8
  %38 = call i32 @inet_addr(i8* %37) #8
  %39 = getelementptr inbounds i8*, i8** %1, i64 3
  %40 = load i8*, i8** %39, align 8
  %41 = call i64 @strtol(i8* %40, i8** null, i32 0) #8
  %42 = icmp slt i64 %41, 1024
  br i1 %42, label %45, label %43

43:                                               ; preds = %35
  %44 = icmp sgt i64 %41, 49151
  br i1 %44, label %45, label %48

45:                                               ; preds = %43, %35
  %46 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %47 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %46, i8* getelementptr inbounds ([50 x i8], [50 x i8]* @.str.21, i32 0, i32 0))
  call void @exit(i32 1) #10
  unreachable

48:                                               ; preds = %43
  %49 = trunc i64 %41 to i16
  %50 = call zeroext i16 @htons(i16 zeroext %49) #9
  call void @connectTo(i32 %38, i16 zeroext %50)
  br label %54

51:                                               ; preds = %25
  %52 = getelementptr inbounds i8*, i8** %1, i64 0
  %53 = load i8*, i8** %52, align 8
  call void @syntaxError(i8* %53)
  br label %54
...
declare void @listenOnPort(i16 zeroext) #2

; Function Attrs: nounwind
declare i32 @inet_addr(i8*) #4

declare void @connectTo(i32, i16 zeroext) #2
