; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01206/s276453355.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01206/s276453355.cpp"
...
@CAP = global i32 0, align 4
@num_resident = global i32 0, align 4
@diff_row = global [4 x i32] [i32 -1, i32 0, i32 0, i32 1], align 16
@diff_col = global [4 x i32] [i32 0, i32 -1, i32 1, i32 0], align 16
@height = global [21 x [21 x i32]] zeroinitializer, align 16
@pool = global i32 0, align 4
@exist = global [21 x [21 x i8]] zeroinitializer, align 16
@visited = global [21 x [21 x i8]] zeroinitializer, align 16
@Area_FLG = global i8 0, align 1
@SET = global %"class.std::set" zeroinitializer, align 8
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.2 = private unnamed_addr constant [6 x i8] c"%d %d\00", align 1
@.str.3 = private unnamed_addr constant [5 x i8] c"Yes\0A\00", align 1
@.str.4 = private unnamed_addr constant [4 x i8] c"No\0A\00", align 1
@.str.5 = private unnamed_addr constant [12 x i8] c"%d %d %d %d\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s276453355.cpp, i8* null }]
...
define internal void @__cxx_global_var_init.1() #0 section ".text.startup" {
  call void @_ZNSt3setIiSt4lessIiESaIiEEC2Ev(%"class.std::set"* @SET) #3
  %1 = call i32 @__cxa_atexit(void (i8*)* bitcast (void (%"class.std::set"*)* @_ZNSt3setIiSt4lessIiESaIiEED2Ev to void (i8*)*), i8* getelementptr inbounds (%"class.std::set", %"class.std::set"* @SET, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0), i8* @__dso_handle) #3
  ret void
}
...
16:                                               ; preds = %15, %14
  %.0 = phi i1 [ true, %14 ], [ false, %15 ]
  ret i1 %.0
}

; Function Attrs: noinline uwtable
define void @_Z10searchAreaiii(i32 %0, i32 %1, i32 %2) #0 {
  %4 = sext i32 %0 to i64
  %5 = getelementptr inbounds [21 x [21 x i8]], [21 x [21 x i8]]* @visited, i64 0, i64 %4
  %6 = sext i32 %1 to i64
  %7 = getelementptr inbounds [21 x i8], [21 x i8]* %5, i64 0, i64 %6
  store i8 1, i8* %7, align 1
  %8 = sext i32 %0 to i64
  %9 = getelementptr inbounds [21 x [21 x i32]], [21 x [21 x i32]]* @height, i64 0, i64 %8
  %10 = sext i32 %1 to i64
  %11 = getelementptr inbounds [21 x i32], [21 x i32]* %9, i64 0, i64 %10
  %12 = load i32, i32* %11, align 4
  %13 = sub nsw i32 %2, %12
  %14 = load i32, i32* @pool, align 4
  %15 = add nsw i32 %14, %13
  store i32 %15, i32* @pool, align 4
  %16 = icmp eq i32 %0, 0
...
27:                                               ; preds = %23
  ...
  %29 = getelementptr inbounds [21 x [21 x i8]], [21 x [21 x i8]]* @exist, i64 0, i64 %28
  %30 = sext i32 %1 to i64
  %31 = getelementptr inbounds [21 x i8], [21 x i8]* %29, i64 0, i64 %30
...
36:                                               ; preds = %27, %23, %21, %17, %3
  store i8 0, i8* @Area_FLG, align 1
  br label %37
...
38:                                               ; preds = %70, %37
  %.0 = phi i32 [ 0, %37 ], [ %71, %70 ]
  %39 = icmp slt i32 %.0, 4
  br i1 %39, label %40, label %72

40:                                               ; preds = %38
  %41 = sext i32 %.0 to i64
  %42 = getelementptr inbounds [4 x i32], [4 x i32]* @diff_row, i64 0, i64 %41
  %43 = load i32, i32* %42, align 4
  %44 = add nsw i32 %0, %43
  %45 = sext i32 %.0 to i64
  %46 = getelementptr inbounds [4 x i32], [4 x i32]* @diff_col, i64 0, i64 %45
  %47 = load i32, i32* %46, align 4
  %48 = add nsw i32 %1, %47
  %49 = call zeroext i1 @_Z10rangeCheckii(i32 %44, i32 %48)
...
52:                                               ; preds = %40
  ...
  %54 = getelementptr inbounds [21 x [21 x i8]], [21 x [21 x i8]]* @visited, i64 0, i64 %53
  %55 = sext i32 %48 to i64
  %56 = getelementptr inbounds [21 x i8], [21 x i8]* %54, i64 0, i64 %55
...
61:                                               ; preds = %52
  ...
  %63 = getelementptr inbounds [21 x [21 x i32]], [21 x [21 x i32]]* @height, i64 0, i64 %62
...
69:                                               ; preds = %61
  call void @_Z10searchAreaiii(i32 %44, i32 %48, i32 %2)
  br label %70
...
; Function Attrs: noinline uwtable
define zeroext i1 @_Z5is_oki(i32 %0) #0 {
  br label %2
...
9:                                                ; preds = %6
  ...
  %11 = getelementptr inbounds [21 x [21 x i8]], [21 x [21 x i8]]* @visited, i64 0, i64 %10
  %12 = sext i32 %.03 to i64
  %13 = getelementptr inbounds [21 x i8], [21 x i8]* %11, i64 0, i64 %12
...
27:                                               ; preds = %24
  ...
  %29 = getelementptr inbounds [21 x [21 x i8]], [21 x [21 x i8]]* @visited, i64 0, i64 %28
...
36:                                               ; preds = %27
  ...
  %38 = getelementptr inbounds [21 x [21 x i32]], [21 x [21 x i32]]* @height, i64 0, i64 %37
...
44:                                               ; preds = %36
  store i32 0, i32* @pool, align 4
  store i8 1, i8* @Area_FLG, align 1
  call void @_Z10searchAreaiii(i32 %.04, i32 %.01, i32 %0)
  %45 = load i8, i8* @Area_FLG, align 1
...
49:                                               ; preds = %44
  %50 = load i32, i32* @pool, align 4
  %51 = load i32, i32* @CAP, align 4
...
define void @_Z4funcv() #0 {
  ...
  call void @_ZNSt3setIiSt4lessIiESaIiEE5clearEv(%"class.std::set"* @SET) #3
  br label %7
...
14:                                               ; preds = %11
  ...
  %16 = getelementptr inbounds [21 x [21 x i32]], [21 x [21 x i32]]* @height, i64 0, i64 %15
  %17 = sext i32 %.01 to i64
  %18 = getelementptr inbounds [21 x i32], [21 x i32]* %16, i64 0, i64 %17
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0), i32* %18)
  %20 = sext i32 %.0 to i64
  %21 = getelementptr inbounds [21 x [21 x i32]], [21 x [21 x i32]]* @height, i64 0, i64 %20
  %22 = sext i32 %.01 to i64
  %23 = getelementptr inbounds [21 x i32], [21 x i32]* %21, i64 0, i64 %22
  %24 = call { %"struct.std::_Rb_tree_node_base"*, i8 } @_ZNSt3setIiSt4lessIiESaIiEE6insertERKi(%"class.std::set"* @SET, i32* dereferenceable(4) %23)
  %25 = bitcast %"struct.std::pair"* %1 to { %"struct.std::_Rb_tree_node_base"*, i8 }*
...
43:                                               ; preds = %40
  ...
  %45 = getelementptr inbounds [21 x [21 x i8]], [21 x [21 x i8]]* @exist, i64 0, i64 %44
  %46 = sext i32 %.03 to i64
  %47 = getelementptr inbounds [21 x i8], [21 x i8]* %45, i64 0, i64 %46
...
54:                                               ; preds = %69, %53
  %.04 = phi i32 [ 0, %53 ], [ %70, %69 ]
  %55 = load i32, i32* @num_resident, align 4
  %56 = icmp slt i32 %.04, %55
  br i1 %56, label %57, label %71

57:                                               ; preds = %54
  %58 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i32 0, i32 0), i32* %2, i32* %3)
  ...
  %65 = getelementptr inbounds [21 x [21 x i8]], [21 x [21 x i8]]* @exist, i64 0, i64 %64
...
71:                                               ; preds = %54
  %72 = call %"struct.std::_Rb_tree_node_base"* @_ZNKSt3setIiSt4lessIiESaIiEE5beginEv(%"class.std::set"* @SET) #3
...
74:                                               ; preds = %85, %71
  %75 = call %"struct.std::_Rb_tree_node_base"* @_ZNKSt3setIiSt4lessIiESaIiEE3endEv(%"class.std::set"* @SET) #3
  ...
  %77 = call zeroext i1 @_ZNKSt23_Rb_tree_const_iteratorIiEneERKS0_(%"struct.std::_Rb_tree_const_iterator"* %4, %"struct.std::_Rb_tree_const_iterator"* dereferenceable(8) %5) #3
  br i1 %77, label %78, label %88

78:                                               ; preds = %74
  %79 = call dereferenceable(4) i32* @_ZNKSt23_Rb_tree_const_iteratorIiEdeEv(%"struct.std::_Rb_tree_const_iterator"* %4) #3
  %80 = load i32, i32* %79, align 4
  %81 = call zeroext i1 @_Z5is_oki(i32 %80)
...
85:                                               ; preds = %84
  %86 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt23_Rb_tree_const_iteratorIiEppEi(%"struct.std::_Rb_tree_const_iterator"* %4, i32 0) #3
...
93:                                               ; preds = %126, %92
  %.05 = phi i32 [ 0, %92 ], [ %127, %126 ]
  %94 = load i32, i32* @W, align 4
  %95 = icmp slt i32 %.05, %94
  br i1 %95, label %96, label %128

96:                                               ; preds = %93
  %97 = sext i32 %.06 to i64
  %98 = getelementptr inbounds [21 x [21 x i8]], [21 x [21 x i8]]* @exist, i64 0, i64 %97
  %99 = sext i32 %.05 to i64
  %100 = getelementptr inbounds [21 x i8], [21 x i8]* %98, i64 0, i64 %99
...
104:                                              ; preds = %96
  ...
  %106 = getelementptr inbounds [21 x [21 x i32]], [21 x [21 x i32]]* @height, i64 0, i64 %105
  %107 = sext i32 %.05 to i64
  %108 = getelementptr inbounds [21 x i32], [21 x i32]* %106, i64 0, i64 %107
  %109 = load i32, i32* %108, align 4
  %110 = add nsw i32 %109, 1
  store i32 %110, i32* %108, align 4
  %111 = sext i32 %.06 to i64
  %112 = getelementptr inbounds [21 x [21 x i32]], [21 x [21 x i32]]* @height, i64 0, i64 %111
  %113 = sext i32 %.05 to i64
  %114 = getelementptr inbounds [21 x i32], [21 x i32]* %112, i64 0, i64 %113
  %115 = load i32, i32* %114, align 4
  %116 = call zeroext i1 @_Z5is_oki(i32 %115)
...
119:                                              ; preds = %104
  ...
  %121 = getelementptr inbounds [21 x [21 x i32]], [21 x [21 x i32]]* @height, i64 0, i64 %120
  %122 = sext i32 %.05 to i64
  %123 = getelementptr inbounds [21 x i32], [21 x i32]* %121, i64 0, i64 %122
...
1:                                                ; preds = %15, %0
  %2 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.5, i32 0, i32 0), i32* @H, i32* @W, i32* @CAP, i32* @num_resident)
  %3 = load i32, i32* @H, align 4
  %4 = icmp eq i32 %3, 0
...
11:                                               ; preds = %8
  %12 = load i32, i32* @num_resident, align 4
  %13 = icmp eq i32 %12, 0
  br i1 %13, label %14, label %15
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s276453355.cpp() #0 section ".text.startup" {
