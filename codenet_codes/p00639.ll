; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00639/s786955746.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00639/s786955746.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s786955746.cpp, i8* null }]
...
28:                                               ; preds = %23
  ...
  %31 = call double @hypot(double %29, double %30) #3
  br label %37

32:                                               ; preds = %23
  %33 = load double, double* %2, align 8
  %34 = load double, double* %3, align 8
  %35 = call double @hypot(double %33, double %34) #3
  %36 = fsub double 2.000000e+00, %35
  br label %37

37:                                               ; preds = %32, %28
  %.0 = phi double [ %31, %28 ], [ %36, %32 ]
  %38 = load double, double* %1, align 8
  %39 = fcmp olt double %.0, %38
...
40:                                               ; preds = %37
  ...
  %47 = call i64 @_ZNSt8ios_base9precisionEl(%"class.std::ios_base"* %46, i64 8)
  ...
  %49 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEd(%"class.std::basic_ostream"* %48, double %.0)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s786955746.cpp() #0 section ".text.startup" {
