; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03640/s400961834.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03640/s400961834.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s400961834.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define i64 @_Z1Cxx(i64 %0, i64 %1) #0 {
  %3 = icmp eq i64 %0, %1
  br i1 %3, label %4, label %5
...
14:                                               ; preds = %11
  %15 = sub nsw i64 %0, 1
  %16 = sub nsw i64 %1, 1
  %17 = call i64 @_Z1Cxx(i64 %15, i64 %16)
  %18 = sub nsw i64 %0, 1
  %19 = call i64 @_Z1Cxx(i64 %18, i64 %1)
  %20 = add nsw i64 %17, %19
  br label %21

21:                                               ; preds = %14, %13, %10, %7, %4
  %.0 = phi i64 [ 1, %4 ], [ 0, %7 ], [ 1, %10 ], [ %0, %13 ], [ %20, %14 ]
  ret i64 %.0
}

; Function Attrs: noinline uwtable
define i64 @_Z1Pxx(i64 %0, i64 %1) #0 {
  %3 = icmp eq i64 %1, 1
  br i1 %3, label %4, label %5
...
15:                                               ; preds = %12
  ...
  %17 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %4, i64 %16) #3
...
38:                                               ; preds = %80, %30
  %.015 = phi i32 [ 0, %30 ], [ %81, %80 ]
  %.010 = phi i32 [ 0, %30 ], [ %.111, %80 ]
  %.05 = phi i32 [ 0, %30 ], [ %.16, %80 ]
  %.04 = phi i32 [ 1, %30 ], [ %.1, %80 ]
  %39 = load i32, i32* %3, align 4
  %40 = icmp slt i32 %.015, %39
...
42:                                               ; preds = %77, %41
  %.016 = phi i32 [ 0, %41 ], [ %78, %77 ]
  %.111 = phi i32 [ %.010, %41 ], [ %.414, %77 ]
  %.16 = phi i32 [ %.05, %41 ], [ %.49, %77 ]
  %.1 = phi i32 [ %.04, %41 ], [ %.4, %77 ]
...
62:                                               ; preds = %59, %49
  %.212 = phi i32 [ %61, %59 ], [ %54, %49 ]
  %.27 = phi i32 [ %60, %59 ], [ %.16, %49 ]
  %.2 = phi i32 [ -1, %59 ], [ %.1, %49 ]
  br label %76

63:                                               ; preds = %47
  %64 = add nsw i32 %.015, 1
  %65 = sext i32 %.16 to i64
  %66 = mul nsw i64 %65, %34
  %67 = getelementptr inbounds i32, i32* %37, i64 %66
  %68 = add nsw i32 %.111, -1
...
75:                                               ; preds = %72, %63
  %.313 = phi i32 [ %74, %72 ], [ %68, %63 ]
  %.38 = phi i32 [ %73, %72 ], [ %.16, %63 ]
  %.3 = phi i32 [ 1, %72 ], [ %.1, %63 ]
  br label %76

76:                                               ; preds = %75, %62
  %.414 = phi i32 [ %.212, %62 ], [ %.313, %75 ]
  %.49 = phi i32 [ %.27, %62 ], [ %.38, %75 ]
  %.4 = phi i32 [ %.2, %62 ], [ %.3, %75 ]
  br label %77

77:                                               ; preds = %76
  %78 = add nsw i32 %.016, 1
  br label %42
...
109:                                              ; preds = %26, %22
  ...
  %110 = insertvalue { i8*, i32 } undef, i8* %.0, 0
  %111 = insertvalue { i8*, i32 } %110, i32 %.01, 1
  resume { i8*, i32 } %111
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s400961834.cpp() #0 section ".text.startup" {
