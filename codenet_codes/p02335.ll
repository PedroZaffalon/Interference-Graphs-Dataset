; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02335/s398107463.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02335/s398107463.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s398107463.cpp, i8* null }]
...
define i32 @main(i32 %0, i8** %1) #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  call void @_ZN9FactorialC2Ei(%struct.Factorial* %5, i32 %17)
...
26:                                               ; preds = %38, %36, %30, %23, %21
  %27 = landingpad { i8*, i32 }
          cleanup
  %28 = extractvalue { i8*, i32 } %27, 0
  %29 = extractvalue { i8*, i32 } %27, 1
  call void @_ZN9FactorialD2Ev(%struct.Factorial* %5) #3
  br label %42
...
30:                                               ; preds = %2
  ...
  %35 = invoke i64 @_ZN9Factorial4combEii(%struct.Factorial* %5, i32 %32, i32 %34)
...
42:                                               ; preds = %26
  %43 = insertvalue { i8*, i32 } undef, i8* %28, 0
  %44 = insertvalue { i8*, i32 } %43, i32 %29, 1
  resume { i8*, i32 } %44
}
...
define linkonce_odr void @_ZN9FactorialC2Ei(%struct.Factorial* %0, i32 %1) unnamed_addr #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %3 = getelementptr inbounds %struct.Factorial, %struct.Factorial* %0, i32 0, i32 0
  store i32 %1, i32* %3, align 8
  %4 = getelementptr inbounds %struct.Factorial, %struct.Factorial* %0, i32 0, i32 1
  store i32 1000000007, i32* %4, align 4
  %5 = getelementptr inbounds %struct.Factorial, %struct.Factorial* %0, i32 0, i32 2
  call void @_ZNSt6vectorIxSaIxEEC2Ev(%"class.std::vector"* %5) #3
  %6 = getelementptr inbounds %struct.Factorial, %struct.Factorial* %0, i32 0, i32 3
  call void @_ZNSt6vectorIxSaIxEEC2Ev(%"class.std::vector"* %6) #3
  %7 = getelementptr inbounds %struct.Factorial, %struct.Factorial* %0, i32 0, i32 2
  %8 = add nsw i32 %1, 1
  %9 = sext i32 %8 to i64
  invoke void @_ZNSt6vectorIxSaIxEE6resizeEm(%"class.std::vector"* %7, i64 %9)
          to label %10 unwind label %17

10:                                               ; preds = %2
  %11 = getelementptr inbounds %struct.Factorial, %struct.Factorial* %0, i32 0, i32 3
  %12 = add nsw i32 %1, 1
...
14:                                               ; preds = %10
  invoke void @_ZN9Factorial14calc_factorialEv(%struct.Factorial* %0)
          to label %15 unwind label %17

15:                                               ; preds = %14
  invoke void @_ZN9Factorial8calc_invEv(%struct.Factorial* %0)
...
define linkonce_odr i64 @_ZN9Factorial4combEii(%struct.Factorial* %0, i32 %1, i32 %2) #5 comdat align 2 {
  %4 = icmp slt i32 %1, %2
...
6:                                                ; preds = %3
  ...
  %17 = getelementptr inbounds %struct.Factorial, %struct.Factorial* %0, i32 0, i32 1
  %18 = load i32, i32* %17, align 4
  %19 = sext i32 %18 to i64
  %20 = srem i64 %16, %19
  %21 = getelementptr inbounds %struct.Factorial, %struct.Factorial* %0, i32 0, i32 3
  %22 = sext i32 %2 to i64
  %23 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %21, i64 %22) #3
  %24 = load i64, i64* %23, align 8
  %25 = mul nsw i64 %20, %24
  %26 = getelementptr inbounds %struct.Factorial, %struct.Factorial* %0, i32 0, i32 1
...
define linkonce_odr void @_ZN9FactorialD2Ev(%struct.Factorial* %0) unnamed_addr #5 comdat align 2 {
  %2 = getelementptr inbounds %struct.Factorial, %struct.Factorial* %0, i32 0, i32 3
  call void @_ZNSt6vectorIxSaIxEED2Ev(%"class.std::vector"* %2) #3
  %3 = getelementptr inbounds %struct.Factorial, %struct.Factorial* %0, i32 0, i32 2
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9Factorial14calc_factorialEv(%struct.Factorial* %0) #5 comdat align 2 {
  %2 = getelementptr inbounds %struct.Factorial, %struct.Factorial* %0, i32 0, i32 2
  %3 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %2, i64 0) #3
  store i64 1, i64* %3, align 8
  br label %4

4:                                                ; preds = %23, %1
  %.0 = phi i32 [ 1, %1 ], [ %24, %23 ]
  %5 = getelementptr inbounds %struct.Factorial, %struct.Factorial* %0, i32 0, i32 0
...
8:                                                ; preds = %4
  %9 = sext i32 %.0 to i64
  %10 = getelementptr inbounds %struct.Factorial, %struct.Factorial* %0, i32 0, i32 2
  %11 = sub nsw i32 %.0, 1
  %12 = sext i32 %11 to i64
  %13 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %10, i64 %12) #3
  %14 = load i64, i64* %13, align 8
  %15 = mul nsw i64 %9, %14
  %16 = getelementptr inbounds %struct.Factorial, %struct.Factorial* %0, i32 0, i32 1
  %17 = load i32, i32* %16, align 4
  %18 = sext i32 %17 to i64
  %19 = srem i64 %15, %18
  %20 = getelementptr inbounds %struct.Factorial, %struct.Factorial* %0, i32 0, i32 2
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZN9Factorial8calc_invEv(%struct.Factorial* %0) #0 comdat align 2 {
  %2 = getelementptr inbounds %struct.Factorial, %struct.Factorial* %0, i32 0, i32 2
  %3 = getelementptr inbounds %struct.Factorial, %struct.Factorial* %0, i32 0, i32 0
  %4 = load i32, i32* %3, align 8
  %5 = sext i32 %4 to i64
  %6 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %2, i64 %5) #3
  %7 = load i64, i64* %6, align 8
  %8 = getelementptr inbounds %struct.Factorial, %struct.Factorial* %0, i32 0, i32 1
  %9 = load i32, i32* %8, align 4
  %10 = sub nsw i32 %9, 2
  %11 = sext i32 %10 to i64
  %12 = getelementptr inbounds %struct.Factorial, %struct.Factorial* %0, i32 0, i32 1
  %13 = load i32, i32* %12, align 4
  %14 = sext i32 %13 to i64
  %15 = call i64 @_Z5powerIxET_S0_S0_S0_(i64 %7, i64 %11, i64 %14)
  %16 = getelementptr inbounds %struct.Factorial, %struct.Factorial* %0, i32 0, i32 3
  %17 = getelementptr inbounds %struct.Factorial, %struct.Factorial* %0, i32 0, i32 0
  %18 = load i32, i32* %17, align 8
  %19 = sext i32 %18 to i64
  %20 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %16, i64 %19) #3
  store i64 %15, i64* %20, align 8
  %21 = getelementptr inbounds %struct.Factorial, %struct.Factorial* %0, i32 0, i32 0
  %22 = load i32, i32* %21, align 8
  %23 = sub nsw i32 %22, 1
  br label %24

24:                                               ; preds = %42, %1
  %.0 = phi i32 [ %23, %1 ], [ %43, %42 ]
  %25 = icmp sge i32 %.0, 0
...
26:                                               ; preds = %24
  %27 = add nsw i32 %.0, 1
  %28 = sext i32 %27 to i64
  %29 = getelementptr inbounds %struct.Factorial, %struct.Factorial* %0, i32 0, i32 3
  %30 = add nsw i32 %.0, 1
  %31 = sext i32 %30 to i64
  %32 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %29, i64 %31) #3
  %33 = load i64, i64* %32, align 8
  %34 = mul nsw i64 %28, %33
  %35 = getelementptr inbounds %struct.Factorial, %struct.Factorial* %0, i32 0, i32 1
  %36 = load i32, i32* %35, align 4
  %37 = sext i32 %36 to i64
  %38 = srem i64 %34, %37
  %39 = getelementptr inbounds %struct.Factorial, %struct.Factorial* %0, i32 0, i32 3
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64 @_Z5powerIxET_S0_S0_S0_(i64 %0, i64 %1, i64 %2) #5 comdat {
  br label %4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s398107463.cpp() #0 section ".text.startup" {
