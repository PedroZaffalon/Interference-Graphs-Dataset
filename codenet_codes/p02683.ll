; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02683/s207081152.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02683/s207081152.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s207081152.cpp, i8* null }]
...
17:                                               ; preds = %0
  ...
  invoke void @_ZNSt6vectorIS_IxSaIxEESaIS1_EEC2EmRKS2_(%"class.std::vector.0"* %6, i64 %18, %"class.std::allocator.2"* dereferenceable(1) %7)
...
20:                                               ; preds = %50, %19
  %.05 = phi i64 [ 0, %19 ], [ %51, %50 ]
  %21 = load i64, i64* %1, align 8
  %22 = icmp slt i64 %.05, %21
  br i1 %22, label %23, label %52

23:                                               ; preds = %20
  %24 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %4, i64 %.05) #3
...
32:                                               ; preds = %30
  %33 = call dereferenceable(24) %"class.std::vector"* @_ZNSt6vectorIS_IxSaIxEESaIS1_EEixEm(%"class.std::vector.0"* %6, i64 %.05) #3
  invoke void @_ZNSt6vectorIxSaIxEE9push_backERKx(%"class.std::vector"* %33, i64* dereferenceable(8) %8)
...
45:                                               ; preds = %131, %129, %126, %123, %32, %30, %23
...
52:                                               ; preds = %20
  store i64 4000000000000000000, i64* %9, align 8
  br label %53

53:                                               ; preds = %118, %52
  %.07 = phi i64 [ 0, %52 ], [ %119, %118 ]
  %54 = load i64, i64* %1, align 8
  %55 = trunc i64 %54 to i32
  %56 = shl i32 1, %55
  %57 = sext i32 %56 to i64
  %58 = icmp slt i64 %.07, %57
...
62:                                               ; preds = %93, %61
  %.010 = phi i64 [ 0, %61 ], [ %94, %93 ]
  %.08 = phi i64 [ 0, %61 ], [ %.19, %93 ]
  %63 = load i64, i64* %1, align 8
  %64 = icmp slt i64 %.010, %63
  br i1 %64, label %65, label %95

65:                                               ; preds = %62
  %66 = trunc i64 %.010 to i32
  %67 = shl i32 1, %66
...
72:                                               ; preds = %82, %71
  %.011 = phi i64 [ 0, %71 ], [ %83, %82 ]
  %73 = load i64, i64* %2, align 8
  %74 = icmp slt i64 %.011, %73
  br i1 %74, label %75, label %88

75:                                               ; preds = %72
  %76 = call dereferenceable(24) %"class.std::vector"* @_ZNSt6vectorIS_IxSaIxEESaIS1_EEixEm(%"class.std::vector.0"* %6, i64 %.010) #3
  %77 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %76, i64 %.011) #3
  %78 = load i64, i64* %77, align 8
  %79 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %10, i64 %.011) #3
...
88:                                               ; preds = %72
  %89 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %4, i64 %.010) #3
  %90 = load i64, i64* %89, align 8
  %91 = add nsw i64 %.08, %90
  br label %92

92:                                               ; preds = %88, %65
  %.19 = phi i64 [ %91, %88 ], [ %.08, %65 ]
  br label %93

93:                                               ; preds = %92
  %94 = add nsw i64 %.010, 1
  br label %62
...
96:                                               ; preds = %106, %95
  %.012 = phi i64 [ 1, %95 ], [ %.113, %106 ]
  %.0 = phi i64 [ 0, %95 ], [ %107, %106 ]
  %97 = load i64, i64* %2, align 8
  %98 = icmp slt i64 %.0, %97
  br i1 %98, label %99, label %108

99:                                               ; preds = %96
  %100 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %10, i64 %.0) #3
...
108:                                              ; preds = %96
  %109 = icmp ne i64 %.012, 0
  br i1 %109, label %110, label %117

110:                                              ; preds = %108
  %111 = invoke zeroext i1 @_Z5chminIxEbRT_S0_(i64* dereferenceable(8) %9, i64 %.08)
...
118:                                              ; preds = %117
  %119 = add nsw i64 %.07, 1
  br label %53

120:                                              ; preds = %53
  %121 = load i64, i64* %9, align 8
  %122 = icmp ne i64 %121, 4000000000000000000
...
135:                                              ; preds = %113, %84, %45
  %.02 = phi i32 [ %48, %45 ], [ %116, %113 ], [ %87, %84 ]
  %.01 = phi i8* [ %47, %45 ], [ %115, %113 ], [ %86, %84 ]
  call void @_ZNSt6vectorIS_IxSaIxEESaIS1_EED2Ev(%"class.std::vector.0"* %6) #3
  br label %136

136:                                              ; preds = %135, %41
  %.13 = phi i32 [ %.02, %135 ], [ %44, %41 ]
  %.1 = phi i8* [ %.01, %135 ], [ %43, %41 ]
  call void @_ZNSt6vectorIxSaIxEED2Ev(%"class.std::vector"* %4) #3
  br label %137

137:                                              ; preds = %136, %37
  %.24 = phi i32 [ %.13, %136 ], [ %40, %37 ]
  %.2 = phi i8* [ %.1, %136 ], [ %39, %37 ]
  %138 = insertvalue { i8*, i32 } undef, i8* %.2, 0
  %139 = insertvalue { i8*, i32 } %138, i32 %.24, 1
  resume { i8*, i32 } %139
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(24) %"class.std::vector"* @_ZNSt6vectorIS_IxSaIxEESaIS1_EEixEm(%"class.std::vector.0"* %0, i64 %1) #5 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr zeroext i1 @_Z5chminIxEbRT_S0_(i64* dereferenceable(8) %0, i64 %1) #5 comdat {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64 @_ZNK9__gnu_cxx13new_allocatorISt6vectorIxSaIxEEE8max_sizeEv(%"class.__gnu_cxx::new_allocator.3"* %0) #5 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(1) %"class.std::allocator.2"* @_ZNSt12_Vector_baseISt6vectorIxSaIxEESaIS2_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base.1"* %0) #5 comdat align 2 {
  %2 = getelementptr inbounds %"struct.std::_Vector_base.1", %"struct.std::_Vector_base.1"* %0, i32 0, i32 0
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr %"class.std::vector"* @_ZSt11__addressofISt6vectorIxSaIxEEEPT_RS3_(%"class.std::vector"* dereferenceable(24) %0) #5 comdat {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorISt6vectorIxSaIxEEE10deallocateEPS3_m(%"class.__gnu_cxx::new_allocator.3"* %0, %"class.std::vector"* %1, i64 %2) #5 comdat align 2 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s207081152.cpp() #0 section ".text.startup" {
