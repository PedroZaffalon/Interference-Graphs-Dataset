; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03246/s167371788.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03246/s167371788.cpp"
...
@v = global [100010 x i32] zeroinitializer, align 16
@p = global [100010 x i32] zeroinitializer, align 16
@b = global [100010 x i32] zeroinitializer, align 16
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s167371788.cpp, i8* null }]
...
19:                                               ; preds = %16
  ...
  %24 = getelementptr inbounds [100010 x i32], [100010 x i32]* @v, i64 0, i64 %23
...
33:                                               ; preds = %30
  ...
  %38 = getelementptr inbounds [100010 x i32], [100010 x i32]* @p, i64 0, i64 %37
...
44:                                               ; preds = %52, %43
  %.04 = phi i32 [ 1, %43 ], [ %53, %52 ]
  %45 = icmp sle i32 %.04, 100000
...
54:                                               ; preds = %44
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([100010 x i32], [100010 x i32]* @b, i32 0, i64 1), i32* getelementptr inbounds ([100010 x i32], [100010 x i32]* @b, i32 0, i64 100001))
  store i32 0, i32* %2, align 4
  br label %55

55:                                               ; preds = %80, %54
  %.0 = phi i32 [ 1, %54 ], [ %81, %80 ]
  %56 = icmp sle i32 %.0, 100000
...
57:                                               ; preds = %55
  ...
  %61 = load i32, i32* getelementptr inbounds ([100010 x i32], [100010 x i32]* @b, i64 0, i64 100000), align 16
  %62 = icmp eq i32 %60, %61
  br i1 %62, label %63, label %71

63:                                               ; preds = %57
  %64 = sext i32 %.0 to i64
  %65 = getelementptr inbounds [100010 x i32], [100010 x i32]* @v, i64 0, i64 %64
  %66 = load i32, i32* %65, align 4
  %67 = load i32, i32* getelementptr inbounds ([100010 x i32], [100010 x i32]* @b, i64 0, i64 99999), align 4
  %68 = add nsw i32 %66, %67
  store i32 %68, i32* %3, align 4
  %69 = call dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* dereferenceable(4) %2, i32* dereferenceable(4) %3)
...
71:                                               ; preds = %57
  ...
  %73 = getelementptr inbounds [100010 x i32], [100010 x i32]* @v, i64 0, i64 %72
  %74 = load i32, i32* %73, align 4
  %75 = load i32, i32* getelementptr inbounds ([100010 x i32], [100010 x i32]* @b, i64 0, i64 100000), align 16
  %76 = add nsw i32 %74, %75
  store i32 %76, i32* %4, align 4
  %77 = call dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* dereferenceable(4) %2, i32* dereferenceable(4) %4)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s167371788.cpp() #0 section ".text.startup" {
