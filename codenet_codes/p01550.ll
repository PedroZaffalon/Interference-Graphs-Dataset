; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01550/s567729743.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01550/s567729743.cpp"
...
@a = global [222 x i32] zeroinitializer, align 16
@s = global [4 x i64] zeroinitializer, align 16
@cnt = global [4 x i64] zeroinitializer, align 16
@fact = global [222 x i64] zeroinitializer, align 16
@invfact = global [222 x i64] zeroinitializer, align 16
@powten = global [1000 x i64] zeroinitializer, align 16
@f = global [222 x i64] zeroinitializer, align 16
@_ZSt3cin = external global %"class.std::basic_istream", align 8
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s567729743.cpp, i8* null }]
...
4:                                                ; preds = %132, %1
  %.01 = phi i64 [ 0, %1 ], [ %.1, %132 ]
  %5 = getelementptr inbounds [4 x i32], [4 x i32]* %2, i64 0, i64 0
  %6 = load i32, i32* %5, align 16
  %7 = sext i32 %6 to i64
  %8 = load i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @cnt, i64 0, i64 0), align 16
  %9 = icmp sle i64 %7, %8
...
12:                                               ; preds = %127, %10
  %.1 = phi i64 [ %.01, %10 ], [ %.2, %127 ]
  %13 = getelementptr inbounds [4 x i32], [4 x i32]* %2, i64 0, i64 1
  %14 = load i32, i32* %13, align 4
  %15 = sext i32 %14 to i64
  %16 = load i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @cnt, i64 0, i64 1), align 8
...
20:                                               ; preds = %122, %18
  %.2 = phi i64 [ %.1, %18 ], [ %.3, %122 ]
  %21 = getelementptr inbounds [4 x i32], [4 x i32]* %2, i64 0, i64 2
  %22 = load i32, i32* %21, align 8
  %23 = sext i32 %22 to i64
  %24 = load i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @cnt, i64 0, i64 2), align 16
...
28:                                               ; preds = %117, %26
  %.3 = phi i64 [ %.2, %26 ], [ %116, %117 ]
  %29 = getelementptr inbounds [4 x i32], [4 x i32]* %2, i64 0, i64 3
  %30 = load i32, i32* %29, align 4
  %31 = sext i32 %30 to i64
  %32 = load i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @cnt, i64 0, i64 3), align 8
...
60:                                               ; preds = %89, %34
  %.04 = phi i64 [ 0, %34 ], [ %88, %89 ]
  %.03 = phi i32 [ 0, %34 ], [ %90, %89 ]
  %61 = icmp slt i32 %.03, 4
...
63:                                               ; preds = %79, %62
  %.02 = phi i64 [ 1, %62 ], [ %78, %79 ]
  %.0 = phi i32 [ 0, %62 ], [ %80, %79 ]
  %64 = icmp slt i32 %.0, 4
  br i1 %64, label %65, label %81

65:                                               ; preds = %63
  %66 = sext i32 %.0 to i64
  %67 = getelementptr inbounds [4 x i64], [4 x i64]* @cnt, i64 0, i64 %66
  ...
  %76 = call i64 @_Z1Cii(i32 %72, i32 %75)
  %77 = mul nsw i64 %.02, %76
...
81:                                               ; preds = %63
  ...
  %83 = getelementptr inbounds [4 x i64], [4 x i64]* @s, i64 0, i64 %82
  %84 = load i64, i64* %83, align 8
  %85 = mul nsw i64 %.02, %84
  %86 = srem i64 %85, 1000000007
  %87 = add nsw i64 %.04, %86
...
96:                                               ; preds = %91
  ...
  %100 = getelementptr inbounds [222 x i64], [222 x i64]* @f, i64 0, i64 %99
  %101 = load i64, i64* %100, align 8
  %102 = mul nsw i64 %.04, %101
  br label %103

103:                                              ; preds = %96, %95
  %.15 = phi i64 [ 0, %95 ], [ %102, %96 ]
  %104 = srem i64 %.15, 1000000007
  %105 = sext i32 %45 to i64
  %106 = getelementptr inbounds [222 x i64], [222 x i64]* @fact, i64 0, i64 %105
  %107 = load i64, i64* %106, align 8
  %108 = mul nsw i64 %104, %107
  %109 = srem i64 %108, 1000000007
  %110 = sext i32 %59 to i64
  %111 = getelementptr inbounds [1000 x i64], [1000 x i64]* @powten, i64 0, i64 %110
  %112 = load i64, i64* %111, align 8
  %113 = mul nsw i64 %109, %112
  %114 = srem i64 %113, 1000000007
  %115 = add nsw i64 %.3, %114
...
; Function Attrs: noinline uwtable
define linkonce_odr i64 @_Z1Cii(i32 %0, i32 %1) #0 comdat {
  %3 = icmp slt i32 %0, %1
...
5:                                                ; preds = %2
  %6 = call i64 @_Z1Pii(i32 %0, i32 %1)
  %7 = sext i32 %1 to i64
  %8 = getelementptr inbounds [222 x i64], [222 x i64]* @invfact, i64 0, i64 %7
...
define i32 @main() #4 {
  ...
  store i64 1, i64* getelementptr inbounds ([222 x i64], [222 x i64]* @invfact, i64 0, i64 1), align 8
  store i64 1, i64* getelementptr inbounds ([222 x i64], [222 x i64]* @invfact, i64 0, i64 0), align 16
  store i64 1, i64* getelementptr inbounds ([222 x i64], [222 x i64]* @fact, i64 0, i64 1), align 8
  store i64 1, i64* getelementptr inbounds ([222 x i64], [222 x i64]* @fact, i64 0, i64 0), align 16
  br label %2

2:                                                ; preds = %14, %0
  %.01 = phi i32 [ 2, %0 ], [ %15, %14 ]
  %3 = icmp slt i32 %.01, 222
  br i1 %3, label %4, label %16

4:                                                ; preds = %2
  %5 = sub nsw i32 %.01, 1
  %6 = sext i32 %5 to i64
  %7 = getelementptr inbounds [222 x i64], [222 x i64]* @fact, i64 0, i64 %6
  %8 = load i64, i64* %7, align 8
  %9 = sext i32 %.01 to i64
  %10 = mul nsw i64 %8, %9
  %11 = srem i64 %10, 1000000007
  %12 = sext i32 %.01 to i64
  %13 = getelementptr inbounds [222 x i64], [222 x i64]* @fact, i64 0, i64 %12
...
17:                                               ; preds = %26, %16
  %.02 = phi i32 [ 2, %16 ], [ %27, %26 ]
  %18 = icmp slt i32 %.02, 222
  br i1 %18, label %19, label %28

19:                                               ; preds = %17
  %20 = sext i32 %.02 to i64
  %21 = getelementptr inbounds [222 x i64], [222 x i64]* @fact, i64 0, i64 %20
  %22 = load i64, i64* %21, align 8
  %23 = call i64 @_Z11mod_inversexx(i64 %22, i64 1000000007)
  %24 = sext i32 %.02 to i64
  %25 = getelementptr inbounds [222 x i64], [222 x i64]* @invfact, i64 0, i64 %24
...
28:                                               ; preds = %17
  store i64 1, i64* getelementptr inbounds ([1000 x i64], [1000 x i64]* @powten, i64 0, i64 0), align 16
  br label %29

29:                                               ; preds = %40, %28
  %.03 = phi i32 [ 1, %28 ], [ %41, %40 ]
  %30 = icmp slt i32 %.03, 1000
  br i1 %30, label %31, label %42

31:                                               ; preds = %29
  %32 = sub nsw i32 %.03, 1
  %33 = sext i32 %32 to i64
  %34 = getelementptr inbounds [1000 x i64], [1000 x i64]* @powten, i64 0, i64 %33
  %35 = load i64, i64* %34, align 8
  %36 = mul nsw i64 %35, 10
  %37 = srem i64 %36, 1000000007
  %38 = sext i32 %.03 to i64
  %39 = getelementptr inbounds [1000 x i64], [1000 x i64]* @powten, i64 0, i64 %38
...
42:                                               ; preds = %29
  store i64 1, i64* getelementptr inbounds ([222 x i64], [222 x i64]* @f, i64 0, i64 0), align 16
  br label %43

43:                                               ; preds = %63, %42
  %.04 = phi i32 [ 1, %42 ], [ %64, %63 ]
  %44 = icmp slt i32 %.04, 222
  br i1 %44, label %45, label %65

45:                                               ; preds = %43
  %46 = sext i32 %.04 to i64
  %47 = getelementptr inbounds [222 x i64], [222 x i64]* @f, i64 0, i64 %46
  store i64 1, i64* %47, align 8
  br label %48

48:                                               ; preds = %60, %45
  %.05 = phi i32 [ 1, %45 ], [ %61, %60 ]
  %49 = add nsw i32 %.04, 1
...
51:                                               ; preds = %48
  ...
  %53 = getelementptr inbounds [222 x i64], [222 x i64]* @f, i64 0, i64 %52
  %54 = load i64, i64* %53, align 8
  %55 = call i64 @_Z1Pii(i32 %.04, i32 %.05)
  %56 = add nsw i64 %54, %55
  %57 = srem i64 %56, 1000000007
  %58 = sext i32 %.04 to i64
  %59 = getelementptr inbounds [222 x i64], [222 x i64]* @f, i64 0, i64 %58
...
70:                                               ; preds = %67
  ...
  %72 = getelementptr inbounds i32, i32* getelementptr inbounds ([222 x i32], [222 x i32]* @a, i32 0, i32 0), i64 %71
...
79:                                               ; preds = %76
  %80 = load i32, i32* getelementptr inbounds ([222 x i32], [222 x i32]* @a, i64 0, i64 0), align 16
...
83:                                               ; preds = %76
  ...
  %86 = getelementptr inbounds i32, i32* getelementptr inbounds ([222 x i32], [222 x i32]* @a, i32 0, i32 0), i64 %85
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([222 x i32], [222 x i32]* @a, i32 0, i32 0), i32* %86)
  br label %87

87:                                               ; preds = %111, %83
  %.010 = phi i32 [ 0, %83 ], [ %112, %111 ]
  %.08 = phi i32 [ 0, %83 ], [ %.19, %111 ]
  %.07 = phi i32 [ 10, %83 ], [ %.1, %111 ]
...
90:                                               ; preds = %87
  ...
  %92 = getelementptr inbounds [222 x i32], [222 x i32]* @a, i64 0, i64 %91
  %93 = load i32, i32* %92, align 4
  %94 = icmp sge i32 %93, %.07
  br i1 %94, label %95, label %98

95:                                               ; preds = %90
  %96 = add nsw i32 %.08, 1
  %97 = mul nsw i32 %.07, 10
  br label %98

98:                                               ; preds = %95, %90
  %.19 = phi i32 [ %96, %95 ], [ %.08, %90 ]
  %.1 = phi i32 [ %97, %95 ], [ %.07, %90 ]
  %99 = sext i32 %.19 to i64
  %100 = getelementptr inbounds [4 x i64], [4 x i64]* @cnt, i64 0, i64 %99
  %101 = load i64, i64* %100, align 8
  %102 = add nsw i64 %101, 1
  store i64 %102, i64* %100, align 8
  %103 = sext i32 %.010 to i64
  %104 = getelementptr inbounds [222 x i32], [222 x i32]* @a, i64 0, i64 %103
  %105 = load i32, i32* %104, align 4
  %106 = sext i32 %105 to i64
  %107 = sext i32 %.19 to i64
  %108 = getelementptr inbounds [4 x i64], [4 x i64]* @s, i64 0, i64 %107
...
111:                                              ; preds = %98
  %112 = add nsw i32 %.010, 1
  br label %87

113:                                              ; preds = %87
  %114 = load i32, i32* %1, align 4
  %115 = call i64 @_Z5solvei(i32 %114)
  %116 = load i32, i32* getelementptr inbounds ([222 x i32], [222 x i32]* @a, i64 0, i64 0), align 16
  %117 = icmp eq i32 %116, 0
  br i1 %117, label %118, label %125

118:                                              ; preds = %113
  %119 = load i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @cnt, i64 0, i64 0), align 16
  %120 = add nsw i64 %119, -1
  store i64 %120, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @cnt, i64 0, i64 0), align 16
  %121 = load i32, i32* %1, align 4
  %122 = sub nsw i32 %121, 1
  %123 = call i64 @_Z5solvei(i32 %122)
  %124 = sub nsw i64 %115, %123
  br label %125

125:                                              ; preds = %118, %113
  %.011 = phi i64 [ %124, %118 ], [ %115, %113 ]
  br label %126

126:                                              ; preds = %128, %125
  %.112 = phi i64 [ %.011, %125 ], [ %129, %128 ]
  %127 = icmp slt i64 %.112, 0
  br i1 %127, label %128, label %130

128:                                              ; preds = %126
  %129 = add nsw i64 %.112, 1000000007
  br label %126

130:                                              ; preds = %126
  %131 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEx(%"class.std::basic_ostream"* @_ZSt4cout, i64 %.112)
...
define linkonce_odr i64 @_Z1Pii(i32 %0, i32 %1) #5 comdat {
  %3 = icmp slt i32 %0, 0
  br i1 %3, label %4, label %5
...
5:                                                ; preds = %2
  ...
  %11 = getelementptr inbounds [222 x i64], [222 x i64]* @invfact, i64 0, i64 %10
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr zeroext i1 @_ZNK9__gnu_cxx5__ops14_Iter_less_valclIPiiEEbT_RT0_(%"struct.__gnu_cxx::__ops::_Iter_less_val"* %0, i32* %1, i32* dereferenceable(4) %2) #5 comdat align 2 {
  %4 = load i32, i32* %1, align 4
  %5 = load i32, i32* %2, align 4
  %6 = icmp slt i32 %4, %5
  ret i1 %6
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i32* @_ZSt21__unguarded_partitionIPiN9__gnu_cxx5__ops15_Iter_less_iterEET_S4_S4_S4_T0_(i32* %0, i32* %1, i32* %2) #5 comdat {
  %4 = alloca %"struct.__gnu_cxx::__ops::_Iter_less_iter", align 1
  br label %5
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr zeroext i1 @_ZNK9__gnu_cxx5__ops14_Val_less_iterclIiPiEEbRT_T0_(%"struct.__gnu_cxx::__ops::_Val_less_iter"* %0, i32* dereferenceable(4) %1, i32* %2) #5 comdat align 2 {
  %4 = load i32, i32* %1, align 4
  %5 = load i32, i32* %2, align 4
  %6 = icmp slt i32 %4, %5
  ret i1 %6
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s567729743.cpp() #0 section ".text.startup" {
