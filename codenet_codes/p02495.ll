; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02495/s938958221.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02495/s938958221.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s938958221.cpp, i8* null }]
...
21:                                               ; preds = %48, %13
  %.03 = phi i32 [ 0, %13 ], [ %49, %48 ]
  %.02 = phi i8 [ 1, %13 ], [ %47, %48 ]
...
27:                                               ; preds = %41, %24
  %.01 = phi i8 [ %26, %24 ], [ %40, %41 ]
  %.0 = phi i32 [ 0, %24 ], [ %42, %41 ]
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s938958221.cpp() #0 section ".text.startup" {
