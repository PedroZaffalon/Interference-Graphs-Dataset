; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03166/s680112069.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03166/s680112069.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s680112069.cpp, i8* null }]
...
2:                                                ; preds = %2, %1
  ...
  %5 = icmp eq %"class.std::vector"* %4, getelementptr inbounds ([100010 x %"class.std::vector"], [100010 x %"class.std::vector"]* @adj, i32 0, i32 0)
...
; Function Attrs: noinline uwtable
define i32 @_Z2Dpi(i32 %0) #0 {
  %2 = alloca i32, align 4
  %3 = sext i32 %0 to i64
  %4 = getelementptr inbounds [100010 x %"class.std::vector"], [100010 x %"class.std::vector"]* @adj, i64 0, i64 %3
...
13:                                               ; preds = %8
  ...
  %15 = getelementptr inbounds [100010 x i32], [100010 x i32]* @dp, i64 0, i64 %14
...
34:                                               ; preds = %24
  %35 = call i32 @_Z2Dpi(i32 %29)
  %36 = sext i32 %29 to i64
  %37 = getelementptr inbounds [100010 x i32], [100010 x i32]* @dp, i64 0, i64 %36
...
10:                                               ; preds = %7
  ...
  %15 = getelementptr inbounds [100010 x %"class.std::vector"], [100010 x %"class.std::vector"]* @adj, i64 0, i64 %14
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %15, i32* dereferenceable(4) %1)
  br label %16
...
19:                                               ; preds = %26, %18
  %.0 = phi i32 [ 1, %18 ], [ %27, %26 ]
  %20 = load i32, i32* @n, align 4
  %21 = icmp sle i32 %.0, %20
  br i1 %21, label %22, label %28

22:                                               ; preds = %19
  %23 = call i32 @_Z2Dpi(i32 %.0)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s680112069.cpp() #0 section ".text.startup" {
