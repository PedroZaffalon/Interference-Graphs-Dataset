; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03507/s154535011.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03507/s154535011.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s154535011.cpp, i8* null }]
...
10:                                               ; preds = %0
  ...
  invoke void @_ZNSt6vectorIxSaIxEEC2EmRKS0_(%"class.std::vector"* %5, i64 %11, %"class.std::allocator"* dereferenceable(1) %6)
...
21:                                               ; preds = %17
  ...
  %24 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERx(%"class.std::basic_istream"* %20, i64* dereferenceable(8) %23)
...
40:                                               ; preds = %13
  %41 = add nsw i64 0, 4611686018427387904
  %42 = sdiv i64 %41, 2
  br label %43

43:                                               ; preds = %75, %40
  %.08 = phi i64 [ %42, %40 ], [ %77, %75 ]
  %.06 = phi i64 [ 4611686018427387904, %40 ], [ %.17, %75 ]
  %.04 = phi i64 [ 0, %40 ], [ %.15, %75 ]
  %44 = sub nsw i64 %.06, %.04
...
47:                                               ; preds = %68, %46
  %.011 = phi i32 [ 0, %46 ], [ %69, %68 ]
  %.09 = phi i64 [ 0, %46 ], [ %.110, %68 ]
...
75:                                               ; preds = %74, %73
  %.17 = phi i64 [ %.06, %73 ], [ %.08, %74 ]
  %.15 = phi i64 [ %.08, %73 ], [ %.04, %74 ]
  %76 = add nsw i64 %.15, %.17
  %77 = sdiv i64 %76, 2
  br label %43

78:                                               ; preds = %43
  %79 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEx(%"class.std::basic_ostream"* @_ZSt4cout, i64 %.06)
...
84:                                               ; preds = %83, %28
  %.12 = phi i32 [ %.01, %83 ], [ %31, %28 ]
  %.1 = phi i8* [ %.0, %83 ], [ %30, %28 ]
  %85 = insertvalue { i8*, i32 } undef, i8* %.1, 0
  %86 = insertvalue { i8*, i32 } %85, i32 %.12, 1
  resume { i8*, i32 } %86
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s154535011.cpp() #0 section ".text.startup" {
