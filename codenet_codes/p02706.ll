; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02706/s271893159.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02706/s271893159.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s271893159.cpp, i8* null }]
...
50:                                               ; preds = %30, %26
  ...
  %52 = insertvalue { i8*, i32 } %51, i32 %.02, 1
  resume { i8*, i32 } %52
}
...
5:                                                ; preds = %2
  ...
  call void (i8*, ...) @_ZSt24__throw_out_of_range_fmtPKcz(i8* getelementptr inbounds ([74 x i8], [74 x i8]* @.str.1, i32 0, i32 0), i64 %1, i64 %6) #11
  unreachable
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s271893159.cpp() #0 section ".text.startup" {
