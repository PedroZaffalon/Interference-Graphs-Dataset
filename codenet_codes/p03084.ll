; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03084/s396441996.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03084/s396441996.cpp"
...
%"struct.std::_Vector_base.5" = type { %"struct.std::_Vector_base<std::pair<int, std::pair<int, int> >, std::allocator<std::pair<int, std::pair<int, int> > > >::_Vector_impl" }
%"struct.std::_Vector_base<std::pair<int, std::pair<int, int> >, std::allocator<std::pair<int, std::pair<int, int> > > >::_Vector_impl" = type { %"struct.std::pair.9"*, %"struct.std::pair.9"*, %"struct.std::pair.9"* }
%"struct.std::pair.9" = type { i32, %"struct.std::pair" }
%"struct.std::greater" = type { i8 }
%"class.__gnu_cxx::__normal_iterator.12" = type { %"struct.std::pair.9"* }
...
%"class.__gnu_cxx::__normal_iterator.14" = type { %"struct.std::pair.9"* }
...
@buf = global [100002 x i8] zeroinitializer, align 16
@_Z1sB5cxx11 = global %"class.std::__cxx11::basic_string" zeroinitializer, align 8
@_Z1tB5cxx11 = global %"class.std::__cxx11::basic_string" zeroinitializer, align 8
@q = global i32 0, align 4
@row = global [2 x %"class.std::vector"] zeroinitializer, align 16
@col = global [2 x %"class.std::vector"] zeroinitializer, align 16
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s396441996.cpp, i8* null }]
...
1:                                                ; preds = %1, %0
  %2 = phi %"class.std::vector"* [ getelementptr inbounds ([2 x %"class.std::vector"], [2 x %"class.std::vector"]* @row, i32 0, i32 0), %0 ], [ %3, %1 ]
  call void @_ZNSt6vectorIiSaIiEEC2Ev(%"class.std::vector"* %2) #3
  %3 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %2, i64 1
  %4 = icmp eq %"class.std::vector"* %3, getelementptr inbounds ([2 x %"class.std::vector"], [2 x %"class.std::vector"]* @row, i64 1, i64 0)
...
2:                                                ; preds = %2, %1
  %3 = phi %"class.std::vector"* [ getelementptr inbounds ([2 x %"class.std::vector"], [2 x %"class.std::vector"]* @row, i64 1, i64 0), %1 ], [ %4, %2 ]
  %4 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %3, i64 -1
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %4) #3
  %5 = icmp eq %"class.std::vector"* %4, getelementptr inbounds ([2 x %"class.std::vector"], [2 x %"class.std::vector"]* @row, i32 0, i32 0)
...
1:                                                ; preds = %1, %0
  %2 = phi %"class.std::vector"* [ getelementptr inbounds ([2 x %"class.std::vector"], [2 x %"class.std::vector"]* @col, i32 0, i32 0), %0 ], [ %3, %1 ]
  call void @_ZNSt6vectorIiSaIiEEC2Ev(%"class.std::vector"* %2) #3
  %3 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %2, i64 1
  %4 = icmp eq %"class.std::vector"* %3, getelementptr inbounds ([2 x %"class.std::vector"], [2 x %"class.std::vector"]* @col, i64 1, i64 0)
  br i1 %4, label %5, label %1
...
2:                                                ; preds = %2, %1
  %3 = phi %"class.std::vector"* [ getelementptr inbounds ([2 x %"class.std::vector"], [2 x %"class.std::vector"]* @col, i64 1, i64 0), %1 ], [ %4, %2 ]
  %4 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %3, i64 -1
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %4) #3
  %5 = icmp eq %"class.std::vector"* %4, getelementptr inbounds ([2 x %"class.std::vector"], [2 x %"class.std::vector"]* @col, i32 0, i32 0)
  br i1 %5, label %6, label %2
...
; Function Attrs: noinline uwtable
define void @_Z7row_avai(i32 %0) #0 {
...
9:                                                ; preds = %7
  ...
  %11 = getelementptr inbounds [2 x %"class.std::vector"], [2 x %"class.std::vector"]* @row, i64 0, i64 %10
  %12 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector"* %11) #3
  %13 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %4, i32 0, i32 0
  store i32* %12, i32** %13, align 8
  %14 = sext i32 %.0 to i64
  %15 = getelementptr inbounds [2 x %"class.std::vector"], [2 x %"class.std::vector"]* @row, i64 0, i64 %14
  ...
  %22 = call i32* @_ZSt11lower_boundIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEiET_S7_S7_RKT0_(i32* %19, i32* %21, i32* dereferenceable(4) %2)
  %23 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %3, i32 0, i32 0
  store i32* %22, i32** %23, align 8
  %24 = sext i32 %.0 to i64
  %25 = getelementptr inbounds [2 x %"class.std::vector"], [2 x %"class.std::vector"]* @row, i64 0, i64 %24
  ...
  %28 = call i64 @_ZN9__gnu_cxxmiIPiSt6vectorIiSaIiEEEENS_17__normal_iteratorIT_T0_E15difference_typeERKS8_SB_(%"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %3, %"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %6) #3
  %29 = trunc i64 %28 to i32
  %30 = sext i32 %29 to i64
  %31 = sext i32 %.0 to i64
  %32 = getelementptr inbounds [2 x %"class.std::vector"], [2 x %"class.std::vector"]* @row, i64 0, i64 %31
...
35:                                               ; preds = %9
  ...
  %37 = getelementptr inbounds [2 x %"class.std::vector"], [2 x %"class.std::vector"]* @row, i64 0, i64 %36
  %38 = sext i32 %29 to i64
  %39 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %37, i64 %38) #3
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* @R, i32* dereferenceable(4) %39)
  br label %40
...
43:                                               ; preds = %40
  ...
  %45 = getelementptr inbounds [2 x %"class.std::vector"], [2 x %"class.std::vector"]* @row, i64 0, i64 %44
  %46 = sext i32 %41 to i64
  %47 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %45, i64 %46) #3
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* @R, i32* dereferenceable(4) %47)
  br label %48
...
48:                                               ; preds = %43, %40
  ...
  %52 = getelementptr inbounds [2 x %"class.std::vector"], [2 x %"class.std::vector"]* @row, i64 0, i64 %51
...
55:                                               ; preds = %48
  ...
  %57 = getelementptr inbounds [2 x %"class.std::vector"], [2 x %"class.std::vector"]* @row, i64 0, i64 %56
...
63:                                               ; preds = %55
  ...
  %67 = getelementptr inbounds [2 x %"class.std::vector"], [2 x %"class.std::vector"]* @row, i64 0, i64 %66
...
70:                                               ; preds = %63
  ...
  %72 = getelementptr inbounds [2 x %"class.std::vector"], [2 x %"class.std::vector"]* @row, i64 0, i64 %71
  %73 = sext i32 %64 to i64
  %74 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %72, i64 %73) #3
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* @R, i32* dereferenceable(4) %74)
  br label %75
...
; Function Attrs: noinline uwtable
define void @_Z7col_avai(i32 %0) #0 {
  %2 = alloca i32, align 4
  %3 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %4 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %5 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
...
9:                                                ; preds = %7
  %10 = sext i32 %.0 to i64
  %11 = getelementptr inbounds [2 x %"class.std::vector"], [2 x %"class.std::vector"]* @col, i64 0, i64 %10
  %12 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector"* %11) #3
  %13 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %4, i32 0, i32 0
  store i32* %12, i32** %13, align 8
  %14 = sext i32 %.0 to i64
  %15 = getelementptr inbounds [2 x %"class.std::vector"], [2 x %"class.std::vector"]* @col, i64 0, i64 %14
  %16 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector"* %15) #3
  %17 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %5, i32 0, i32 0
  store i32* %16, i32** %17, align 8
  %18 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %4, i32 0, i32 0
  ...
  store i32* %22, i32** %23, align 8
  %24 = sext i32 %.0 to i64
  %25 = getelementptr inbounds [2 x %"class.std::vector"], [2 x %"class.std::vector"]* @col, i64 0, i64 %24
  %26 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector"* %25) #3
  %27 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %6, i32 0, i32 0
  store i32* %26, i32** %27, align 8
  %28 = call i64 @_ZN9__gnu_cxxmiIPiSt6vectorIiSaIiEEEENS_17__normal_iteratorIT_T0_E15difference_typeERKS8_SB_(%"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %3, %"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %6) #3
  ...
  %30 = sext i32 %29 to i64
  %31 = sext i32 %.0 to i64
  %32 = getelementptr inbounds [2 x %"class.std::vector"], [2 x %"class.std::vector"]* @col, i64 0, i64 %31
  %33 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* %32) #3
  %34 = icmp ne i64 %30, %33
  br i1 %34, label %35, label %40
...
35:                                               ; preds = %9
  %36 = sext i32 %.0 to i64
  %37 = getelementptr inbounds [2 x %"class.std::vector"], [2 x %"class.std::vector"]* @col, i64 0, i64 %36
  %38 = sext i32 %29 to i64
  %39 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %37, i64 %38) #3
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* @C, i32* dereferenceable(4) %39)
  br label %40
...
43:                                               ; preds = %40
  %44 = sext i32 %.0 to i64
  %45 = getelementptr inbounds [2 x %"class.std::vector"], [2 x %"class.std::vector"]* @col, i64 0, i64 %44
  %46 = sext i32 %41 to i64
  %47 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %45, i64 %46) #3
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* @C, i32* dereferenceable(4) %47)
  br label %48
...
48:                                               ; preds = %43, %40
  ...
  %50 = sext i32 %49 to i64
  %51 = sext i32 %.0 to i64
  %52 = getelementptr inbounds [2 x %"class.std::vector"], [2 x %"class.std::vector"]* @col, i64 0, i64 %51
  %53 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* %52) #3
  %54 = icmp ne i64 %50, %53
  br i1 %54, label %55, label %76
...
55:                                               ; preds = %48
  %56 = sext i32 %.0 to i64
  %57 = getelementptr inbounds [2 x %"class.std::vector"], [2 x %"class.std::vector"]* @col, i64 0, i64 %56
  %58 = sext i32 %49 to i64
  %59 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %57, i64 %58) #3
  %60 = load i32, i32* %59, align 4
  %61 = load i32, i32* %2, align 4
...
63:                                               ; preds = %55
  ...
  %65 = sext i32 %64 to i64
  %66 = sext i32 %.0 to i64
  %67 = getelementptr inbounds [2 x %"class.std::vector"], [2 x %"class.std::vector"]* @col, i64 0, i64 %66
  %68 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* %67) #3
  %69 = icmp ne i64 %65, %68
  br i1 %69, label %70, label %75
...
70:                                               ; preds = %63
  %71 = sext i32 %.0 to i64
  %72 = getelementptr inbounds [2 x %"class.std::vector"], [2 x %"class.std::vector"]* @col, i64 0, i64 %71
  %73 = sext i32 %64 to i64
  %74 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %72, i64 %73) #3
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* @C, i32* dereferenceable(4) %74)
  br label %75
...
define i32 @main() #5 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %36 = alloca %"struct.std::pair.9", align 4
  ...
  %65 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([100002 x i8], [100002 x i8]* @buf, i32 0, i32 0))
  %66 = call dereferenceable(32) %"class.std::__cxx11::basic_string"* @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEPKc(%"class.std::__cxx11::basic_string"* @_Z1sB5cxx11, i8* getelementptr inbounds ([100002 x i8], [100002 x i8]* @buf, i32 0, i32 0))
  %67 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([100002 x i8], [100002 x i8]* @buf, i32 0, i32 0))
  %68 = call dereferenceable(32) %"class.std::__cxx11::basic_string"* @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEPKc(%"class.std::__cxx11::basic_string"* @_Z1tB5cxx11, i8* getelementptr inbounds ([100002 x i8], [100002 x i8]* @buf, i32 0, i32 0))
...
81:                                               ; preds = %74
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* getelementptr inbounds ([2 x %"class.std::vector"], [2 x %"class.std::vector"]* @row, i64 0, i64 0), i32* dereferenceable(4) %1)
  br label %83

82:                                               ; preds = %74
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* getelementptr inbounds ([2 x %"class.std::vector"], [2 x %"class.std::vector"]* @row, i64 0, i64 1), i32* dereferenceable(4) %1)
  br label %83
...
88:                                               ; preds = %103, %87
  ...
  %91 = call i64 @_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE4sizeEv(%"class.std::__cxx11::basic_string"* @_Z1tB5cxx11) #3
...
93:                                               ; preds = %88
  ...
  %96 = call dereferenceable(1) i8* @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEixEm(%"class.std::__cxx11::basic_string"* @_Z1tB5cxx11, i64 %95)
...
100:                                              ; preds = %93
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* getelementptr inbounds ([2 x %"class.std::vector"], [2 x %"class.std::vector"]* @col, i64 0, i64 0), i32* dereferenceable(4) %2)
  br label %102

101:                                              ; preds = %93
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* getelementptr inbounds ([2 x %"class.std::vector"], [2 x %"class.std::vector"]* @col, i64 0, i64 1), i32* dereferenceable(4) %2)
  br label %102
...
111:                                              ; preds = %107
  %112 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.8, i32 0, i32 0), i32* %3, i32* %4, i32* %5, i32* %6)
  ...
  call void @_ZNSt6vectorIiSaIiEE5clearEv(%"class.std::vector"* @R) #3
  call void @_ZNSt6vectorIiSaIiEE5clearEv(%"class.std::vector"* @C) #3
  %121 = load i32, i32* %3, align 4
  call void @_Z7row_avai(i32 %121)
  %122 = load i32, i32* %5, align 4
  call void @_Z7row_avai(i32 %122)
  %123 = load i32, i32* %4, align 4
  call void @_Z7col_avai(i32 %123)
  %124 = load i32, i32* %6, align 4
  call void @_Z7col_avai(i32 %124)
  %125 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector"* @R) #3
  %126 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %7, i32 0, i32 0
  store i32* %125, i32** %126, align 8
  %127 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector"* @R) #3
  ...
  call void @_ZSt4sortIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEEvT_S7_(i32* %130, i32* %132)
  %133 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector"* @R) #3
  %134 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %11, i32 0, i32 0
  store i32* %133, i32** %134, align 8
  %135 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector"* @R) #3
  ...
  %141 = call i32* @_ZSt6uniqueIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEET_S7_S7_(i32* %138, i32* %140)
  ...
  %143 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector"* @R) #3
  ...
  %145 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator.3", %"class.__gnu_cxx::__normal_iterator.3"* %9, i32 0, i32 0
  %146 = load i32*, i32** %145, align 8
  %147 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator.3", %"class.__gnu_cxx::__normal_iterator.3"* %13, i32 0, i32 0
  %148 = load i32*, i32** %147, align 8
  %149 = call i32* @_ZNSt6vectorIiSaIiEE5eraseEN9__gnu_cxx17__normal_iteratorIPKiS1_EES6_(%"class.std::vector"* @R, i32* %146, i32* %148)
  %150 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %15, i32 0, i32 0
  store i32* %149, i32** %150, align 8
  %151 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector"* @C) #3
  %152 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %16, i32 0, i32 0
  store i32* %151, i32** %152, align 8
  %153 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector"* @C) #3
  ...
  call void @_ZSt4sortIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEEvT_S7_(i32* %156, i32* %158)
  %159 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector"* @C) #3
  %160 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %20, i32 0, i32 0
  store i32* %159, i32** %160, align 8
  %161 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector"* @C) #3
  ...
  %167 = call i32* @_ZSt6uniqueIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEET_S7_S7_(i32* %164, i32* %166)
  %168 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %19, i32 0, i32 0
  store i32* %167, i32** %168, align 8
  call void @_ZN9__gnu_cxx17__normal_iteratorIPKiSt6vectorIiSaIiEEEC2IPiEERKNS0_IT_NS_11__enable_ifIXsr3std10__are_sameIS9_S8_EE7__valueES5_E6__typeEEE(%"class.__gnu_cxx::__normal_iterator.3"* %18, %"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %19) #3
  ...
  call void @_ZN9__gnu_cxx17__normal_iteratorIPKiSt6vectorIiSaIiEEEC2IPiEERKNS0_IT_NS_11__enable_ifIXsr3std10__are_sameIS9_S8_EE7__valueES5_E6__typeEEE(%"class.__gnu_cxx::__normal_iterator.3"* %22, %"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %23) #3
  %171 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator.3", %"class.__gnu_cxx::__normal_iterator.3"* %18, i32 0, i32 0
  %172 = load i32*, i32** %171, align 8
  %173 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator.3", %"class.__gnu_cxx::__normal_iterator.3"* %22, i32 0, i32 0
  %174 = load i32*, i32** %173, align 8
  %175 = call i32* @_ZNSt6vectorIiSaIiEE5eraseEN9__gnu_cxx17__normal_iteratorIPKiS1_EES6_(%"class.std::vector"* @C, i32* %172, i32* %174)
  ...
  %177 = call i64 @_ZSt9make_pairIiiESt4pairINSt17__decay_and_stripIT_E6__typeENS1_IT0_E6__typeEEOS2_OS5_(i32* dereferenceable(4) %26, i32* dereferenceable(4) %27)
  %178 = bitcast %"struct.std::pair"* %25 to i64*
  store i64 %177, i64* %178, align 4
  store i32 -1, i32* %29, align 4
  store i32 -1, i32* %30, align 4
  %179 = call i64 @_ZSt9make_pairIiiESt4pairINSt17__decay_and_stripIT_E6__typeENS1_IT0_E6__typeEEOS2_OS5_(i32* dereferenceable(4) %29, i32* dereferenceable(4) %30)
  %180 = bitcast %"struct.std::pair"* %28 to i64*
...
181:                                              ; preds = %239, %111
  ...
  %184 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* @R) #3
...
187:                                              ; preds = %235, %186
  ...
  %190 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* @C) #3
...
192:                                              ; preds = %187
  ...
  %195 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @dist, i64 0, i64 %194
  ...
  %201 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* @R, i64 %200) #3
...
205:                                              ; preds = %192
  ...
  %208 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* @C, i64 %207) #3
...
212:                                              ; preds = %205
  %213 = call i64 @_ZSt9make_pairIRiS0_ESt4pairINSt17__decay_and_stripIT_E6__typeENS2_IT0_E6__typeEEOS3_OS6_(i32* dereferenceable(4) %31, i32* dereferenceable(4) %32)
  %214 = bitcast %"struct.std::pair"* %33 to i64*
  store i64 %213, i64* %214, align 4
  %215 = call dereferenceable(8) %"struct.std::pair"* @_ZNSt4pairIiiEaSEOS0_(%"struct.std::pair"* %25, %"struct.std::pair"* dereferenceable(8) %33) #3
  br label %216

216:                                              ; preds = %212, %205, %192
  %217 = load i32, i32* %31, align 4
  %218 = sext i32 %217 to i64
  %219 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* @R, i64 %218) #3
...
223:                                              ; preds = %216
  ...
  %226 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* @C, i64 %225) #3
...
230:                                              ; preds = %223
  %231 = call i64 @_ZSt9make_pairIRiS0_ESt4pairINSt17__decay_and_stripIT_E6__typeENS2_IT0_E6__typeEEOS3_OS6_(i32* dereferenceable(4) %31, i32* dereferenceable(4) %32)
  %232 = bitcast %"struct.std::pair"* %34 to i64*
  store i64 %231, i64* %232, align 4
  %233 = call dereferenceable(8) %"struct.std::pair"* @_ZNSt4pairIiiEaSEOS0_(%"struct.std::pair"* %28, %"struct.std::pair"* dereferenceable(8) %34) #3
  br label %234
...
242:                                              ; preds = %181
  ...
  %246 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @dist, i64 0, i64 %245
  ...
  call void @_ZNSt14priority_queueISt4pairIiS0_IiiEESt6vectorIS2_SaIS2_EESt7greaterIS2_EEC2IS5_vEEv(%"class.std::priority_queue"* %35)
  ...
  %253 = invoke i64 @_ZSt9make_pairIRiS0_ESt4pairINSt17__decay_and_stripIT_E6__typeENS2_IT0_E6__typeEEOS3_OS6_(i32* dereferenceable(4) %251, i32* dereferenceable(4) %252)
          to label %254 unwind label %290

254:                                              ; preds = %242
  %255 = bitcast %"struct.std::pair"* %38 to i64*
  store i64 %253, i64* %255, align 4
  %256 = invoke { i64, i32 } @_ZSt9make_pairIiSt4pairIiiEES0_INSt17__decay_and_stripIT_E6__typeENS2_IT0_E6__typeEEOS3_OS6_(i32* dereferenceable(4) %37, %"struct.std::pair"* dereferenceable(8) %38)
          to label %257 unwind label %290

257:                                              ; preds = %254
  store { i64, i32 } %256, { i64, i32 }* %39, align 8
  %258 = bitcast { i64, i32 }* %39 to i8*
  %259 = bitcast %"struct.std::pair.9"* %36 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %259, i8* align 4 %258, i64 12, i1 false)
  invoke void @_ZNSt14priority_queueISt4pairIiS0_IiiEESt6vectorIS2_SaIS2_EESt7greaterIS2_EE4pushEOS2_(%"class.std::priority_queue"* %35, %"struct.std::pair.9"* dereferenceable(12) %36)
          to label %260 unwind label %290

260:                                              ; preds = %257
  br label %261

261:                                              ; preds = %568, %289, %260
  %262 = invoke zeroext i1 @_ZNKSt14priority_queueISt4pairIiS0_IiiEESt6vectorIS2_SaIS2_EESt7greaterIS2_EE5emptyEv(%"class.std::priority_queue"* %35)
...
265:                                              ; preds = %263
  %266 = invoke dereferenceable(12) %"struct.std::pair.9"* @_ZNKSt14priority_queueISt4pairIiS0_IiiEESt6vectorIS2_SaIS2_EESt7greaterIS2_EE3topEv(%"class.std::priority_queue"* %35)
          to label %267 unwind label %290

267:                                              ; preds = %265
  %268 = getelementptr inbounds %"struct.std::pair.9", %"struct.std::pair.9"* %266, i32 0, i32 1
  %269 = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* %268, i32 0, i32 0
  %270 = load i32, i32* %269, align 4
  store i32 %270, i32* %40, align 4
  %271 = invoke dereferenceable(12) %"struct.std::pair.9"* @_ZNKSt14priority_queueISt4pairIiS0_IiiEESt6vectorIS2_SaIS2_EESt7greaterIS2_EE3topEv(%"class.std::priority_queue"* %35)
...
272:                                              ; preds = %267
  ...
  %276 = invoke dereferenceable(12) %"struct.std::pair.9"* @_ZNKSt14priority_queueISt4pairIiS0_IiiEESt6vectorIS2_SaIS2_EESt7greaterIS2_EE3topEv(%"class.std::priority_queue"* %35)
          to label %277 unwind label %290

277:                                              ; preds = %272
  %278 = getelementptr inbounds %"struct.std::pair.9", %"struct.std::pair.9"* %276, i32 0, i32 0
  %279 = load i32, i32* %278, align 4
  invoke void @_ZNSt14priority_queueISt4pairIiS0_IiiEESt6vectorIS2_SaIS2_EESt7greaterIS2_EE3popEv(%"class.std::priority_queue"* %35)
          to label %280 unwind label %290

280:                                              ; preds = %277
  %281 = load i32, i32* %40, align 4
  %282 = sext i32 %281 to i64
  %283 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @dist, i64 0, i64 %282
  %284 = load i32, i32* %41, align 4
  %285 = sext i32 %284 to i64
  %286 = getelementptr inbounds [8 x i32], [8 x i32]* %283, i64 0, i64 %285
  %287 = load i32, i32* %286, align 4
  %288 = icmp ne i32 %287, %279
  br i1 %288, label %289, label %294

289:                                              ; preds = %280
  br label %261

290:                                              ; preds = %569, %562, %559, %547, %498, %492, %489, %477, %431, %425, %422, %410, %361, %355, %352, %340, %294, %277, %272, %267, %265, %261, %257, %254, %242
  %291 = landingpad { i8*, i32 }
          cleanup
  %292 = extractvalue { i8*, i32 } %291, 0
  %293 = extractvalue { i8*, i32 } %291, 1
  call void @_ZNSt14priority_queueISt4pairIiS0_IiiEESt6vectorIS2_SaIS2_EESt7greaterIS2_EED2Ev(%"class.std::priority_queue"* %35) #3
  br label %582

294:                                              ; preds = %280
  %295 = load i32, i32* %40, align 4
  %296 = sext i32 %295 to i64
  %297 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* @R, i64 %296) #3
  %298 = load i32, i32* %297, align 4
  %299 = sext i32 %298 to i64
  %300 = invoke dereferenceable(1) i8* @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEixEm(%"class.std::__cxx11::basic_string"* @_Z1sB5cxx11, i64 %299)
          to label %301 unwind label %290

301:                                              ; preds = %294
  %302 = load i8, i8* %300, align 1
  %303 = sext i8 %302 to i32
  %304 = icmp eq i32 %303, 87
...
308:                                              ; preds = %305
  ...
  %311 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* @C, i64 %310) #3
  %312 = load i32, i32* %311, align 4
  %313 = load i32, i32* %41, align 4
  %314 = sub nsw i32 %313, 1
  %315 = sext i32 %314 to i64
  %316 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* @C, i64 %315) #3
  %317 = load i32, i32* %316, align 4
  %318 = sub nsw i32 %312, %317
  %319 = add nsw i32 %318, %287
  ...
  %326 = getelementptr inbounds [8 x i32], [8 x i32]* %322, i64 0, i64 %325
...
329:                                              ; preds = %308
  ...
  %332 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @dist, i64 0, i64 %331
  %333 = load i32, i32* %41, align 4
  %334 = sub nsw i32 %333, 1
  %335 = sext i32 %334 to i64
  %336 = getelementptr inbounds [8 x i32], [8 x i32]* %332, i64 0, i64 %335
...
340:                                              ; preds = %329, %308
  ...
  %344 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @dist, i64 0, i64 %343
  %345 = load i32, i32* %41, align 4
  %346 = sub nsw i32 %345, 1
  %347 = sext i32 %346 to i64
  %348 = getelementptr inbounds [8 x i32], [8 x i32]* %344, i64 0, i64 %347
  store i32 %341, i32* %348, align 4
  %349 = load i32, i32* %41, align 4
  %350 = sub nsw i32 %349, 1
  store i32 %350, i32* %45, align 4
  %351 = invoke i64 @_ZSt9make_pairIRiiESt4pairINSt17__decay_and_stripIT_E6__typeENS2_IT0_E6__typeEEOS3_OS6_(i32* dereferenceable(4) %40, i32* dereferenceable(4) %45)
          to label %352 unwind label %290

352:                                              ; preds = %340
  %353 = bitcast %"struct.std::pair"* %44 to i64*
  store i64 %351, i64* %353, align 4
  %354 = invoke { i64, i32 } @_ZSt9make_pairIRiSt4pairIiiEES1_INSt17__decay_and_stripIT_E6__typeENS3_IT0_E6__typeEEOS4_OS7_(i32* dereferenceable(4) %42, %"struct.std::pair"* dereferenceable(8) %44)
          to label %355 unwind label %290

355:                                              ; preds = %352
  store { i64, i32 } %354, { i64, i32 }* %46, align 8
  %356 = bitcast { i64, i32 }* %46 to i8*
  %357 = bitcast %"struct.std::pair.9"* %43 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %357, i8* align 4 %356, i64 12, i1 false)
  invoke void @_ZNSt14priority_queueISt4pairIiS0_IiiEESt6vectorIS2_SaIS2_EESt7greaterIS2_EE4pushEOS2_(%"class.std::priority_queue"* %35, %"struct.std::pair.9"* dereferenceable(12) %43)
...
361:                                              ; preds = %360, %301
  ...
  %364 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* @R, i64 %363) #3
  %365 = load i32, i32* %364, align 4
  %366 = sext i32 %365 to i64
  %367 = invoke dereferenceable(1) i8* @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEixEm(%"class.std::__cxx11::basic_string"* @_Z1sB5cxx11, i64 %366)
          to label %368 unwind label %290
...
372:                                              ; preds = %368
  ...
  %376 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* @C) #3
...
378:                                              ; preds = %372
  ...
  %382 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* @C, i64 %381) #3
  %383 = load i32, i32* %382, align 4
  %384 = load i32, i32* %41, align 4
  %385 = sext i32 %384 to i64
  %386 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* @C, i64 %385) #3
  %387 = load i32, i32* %386, align 4
  %388 = sub nsw i32 %383, %387
  %389 = add nsw i32 %388, %287
  store i32 %389, i32* %47, align 4
  %390 = load i32, i32* %40, align 4
  %391 = sext i32 %390 to i64
  %392 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @dist, i64 0, i64 %391
  %393 = load i32, i32* %41, align 4
  %394 = add nsw i32 %393, 1
  %395 = sext i32 %394 to i64
  %396 = getelementptr inbounds [8 x i32], [8 x i32]* %392, i64 0, i64 %395
...
399:                                              ; preds = %378
  ...
  %402 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @dist, i64 0, i64 %401
  %403 = load i32, i32* %41, align 4
  %404 = add nsw i32 %403, 1
  %405 = sext i32 %404 to i64
  %406 = getelementptr inbounds [8 x i32], [8 x i32]* %402, i64 0, i64 %405
...
410:                                              ; preds = %399, %378
  ...
  %414 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @dist, i64 0, i64 %413
  ...
  store i32 %420, i32* %50, align 4
  %421 = invoke i64 @_ZSt9make_pairIRiiESt4pairINSt17__decay_and_stripIT_E6__typeENS2_IT0_E6__typeEEOS3_OS6_(i32* dereferenceable(4) %40, i32* dereferenceable(4) %50)
          to label %422 unwind label %290

422:                                              ; preds = %410
  %423 = bitcast %"struct.std::pair"* %49 to i64*
  store i64 %421, i64* %423, align 4
  %424 = invoke { i64, i32 } @_ZSt9make_pairIRiSt4pairIiiEES1_INSt17__decay_and_stripIT_E6__typeENS3_IT0_E6__typeEEOS4_OS7_(i32* dereferenceable(4) %47, %"struct.std::pair"* dereferenceable(8) %49)
          to label %425 unwind label %290

425:                                              ; preds = %422
  store { i64, i32 } %424, { i64, i32 }* %51, align 8
  %426 = bitcast { i64, i32 }* %51 to i8*
  %427 = bitcast %"struct.std::pair.9"* %48 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %427, i8* align 4 %426, i64 12, i1 false)
  invoke void @_ZNSt14priority_queueISt4pairIiS0_IiiEESt6vectorIS2_SaIS2_EESt7greaterIS2_EE4pushEOS2_(%"class.std::priority_queue"* %35, %"struct.std::pair.9"* dereferenceable(12) %48)
          to label %428 unwind label %290
...
431:                                              ; preds = %430, %368
  ...
  %434 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* @C, i64 %433) #3
  %435 = load i32, i32* %434, align 4
  %436 = sext i32 %435 to i64
  %437 = invoke dereferenceable(1) i8* @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEixEm(%"class.std::__cxx11::basic_string"* @_Z1tB5cxx11, i64 %436)
          to label %438 unwind label %290

438:                                              ; preds = %431
  %439 = load i8, i8* %437, align 1
  %440 = sext i8 %439 to i32
  %441 = icmp eq i32 %440, 78
...
445:                                              ; preds = %442
  ...
  %448 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* @R, i64 %447) #3
  %449 = load i32, i32* %448, align 4
  %450 = load i32, i32* %40, align 4
  %451 = sub nsw i32 %450, 1
  %452 = sext i32 %451 to i64
  %453 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* @R, i64 %452) #3
  %454 = load i32, i32* %453, align 4
  %455 = sub nsw i32 %449, %454
  %456 = add nsw i32 %455, %287
  store i32 %456, i32* %52, align 4
  %457 = load i32, i32* %40, align 4
  %458 = sub nsw i32 %457, 1
  %459 = sext i32 %458 to i64
  %460 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @dist, i64 0, i64 %459
...
466:                                              ; preds = %445
  ...
  %470 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @dist, i64 0, i64 %469
...
477:                                              ; preds = %466, %445
  %478 = load i32, i32* %52, align 4
  %479 = load i32, i32* %40, align 4
  %480 = sub nsw i32 %479, 1
  %481 = sext i32 %480 to i64
  %482 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @dist, i64 0, i64 %481
  %483 = load i32, i32* %41, align 4
  %484 = sext i32 %483 to i64
  %485 = getelementptr inbounds [8 x i32], [8 x i32]* %482, i64 0, i64 %484
  store i32 %478, i32* %485, align 4
  %486 = load i32, i32* %40, align 4
  %487 = sub nsw i32 %486, 1
  store i32 %487, i32* %55, align 4
  %488 = invoke i64 @_ZSt9make_pairIiRiESt4pairINSt17__decay_and_stripIT_E6__typeENS2_IT0_E6__typeEEOS3_OS6_(i32* dereferenceable(4) %55, i32* dereferenceable(4) %41)
          to label %489 unwind label %290

489:                                              ; preds = %477
  %490 = bitcast %"struct.std::pair"* %54 to i64*
  store i64 %488, i64* %490, align 4
  %491 = invoke { i64, i32 } @_ZSt9make_pairIRiSt4pairIiiEES1_INSt17__decay_and_stripIT_E6__typeENS3_IT0_E6__typeEEOS4_OS7_(i32* dereferenceable(4) %52, %"struct.std::pair"* dereferenceable(8) %54)
          to label %492 unwind label %290

492:                                              ; preds = %489
  store { i64, i32 } %491, { i64, i32 }* %56, align 8
  %493 = bitcast { i64, i32 }* %56 to i8*
  %494 = bitcast %"struct.std::pair.9"* %53 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %494, i8* align 4 %493, i64 12, i1 false)
  invoke void @_ZNSt14priority_queueISt4pairIiS0_IiiEESt6vectorIS2_SaIS2_EESt7greaterIS2_EE4pushEOS2_(%"class.std::priority_queue"* %35, %"struct.std::pair.9"* dereferenceable(12) %53)
          to label %495 unwind label %290
...
498:                                              ; preds = %497, %438
  ...
  %501 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* @C, i64 %500) #3
  %502 = load i32, i32* %501, align 4
  %503 = sext i32 %502 to i64
  %504 = invoke dereferenceable(1) i8* @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEixEm(%"class.std::__cxx11::basic_string"* @_Z1tB5cxx11, i64 %503)
...
509:                                              ; preds = %505
  ...
  %513 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* @R) #3
...
515:                                              ; preds = %509
  ...
  %519 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* @R, i64 %518) #3
  %520 = load i32, i32* %519, align 4
  %521 = load i32, i32* %40, align 4
  %522 = sext i32 %521 to i64
  %523 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* @R, i64 %522) #3
  %524 = load i32, i32* %523, align 4
  %525 = sub nsw i32 %520, %524
  %526 = add nsw i32 %525, %287
  store i32 %526, i32* %57, align 4
  %527 = load i32, i32* %40, align 4
  %528 = add nsw i32 %527, 1
  %529 = sext i32 %528 to i64
  %530 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @dist, i64 0, i64 %529
...
536:                                              ; preds = %515
  ...
  %540 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @dist, i64 0, i64 %539
  %541 = load i32, i32* %41, align 4
  %542 = sext i32 %541 to i64
  %543 = getelementptr inbounds [8 x i32], [8 x i32]* %540, i64 0, i64 %542
...
547:                                              ; preds = %536, %515
  ...
  %552 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @dist, i64 0, i64 %551
  %553 = load i32, i32* %41, align 4
  %554 = sext i32 %553 to i64
  %555 = getelementptr inbounds [8 x i32], [8 x i32]* %552, i64 0, i64 %554
  store i32 %548, i32* %555, align 4
  %556 = load i32, i32* %40, align 4
  %557 = add nsw i32 %556, 1
  store i32 %557, i32* %60, align 4
  %558 = invoke i64 @_ZSt9make_pairIiRiESt4pairINSt17__decay_and_stripIT_E6__typeENS2_IT0_E6__typeEEOS3_OS6_(i32* dereferenceable(4) %60, i32* dereferenceable(4) %41)
          to label %559 unwind label %290

559:                                              ; preds = %547
  %560 = bitcast %"struct.std::pair"* %59 to i64*
  store i64 %558, i64* %560, align 4
  %561 = invoke { i64, i32 } @_ZSt9make_pairIRiSt4pairIiiEES1_INSt17__decay_and_stripIT_E6__typeENS3_IT0_E6__typeEEOS4_OS7_(i32* dereferenceable(4) %57, %"struct.std::pair"* dereferenceable(8) %59)
          to label %562 unwind label %290

562:                                              ; preds = %559
  store { i64, i32 } %561, { i64, i32 }* %61, align 8
  %563 = bitcast { i64, i32 }* %61 to i8*
  %564 = bitcast %"struct.std::pair.9"* %58 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %564, i8* align 4 %563, i64 12, i1 false)
  invoke void @_ZNSt14priority_queueISt4pairIiS0_IiiEESt6vectorIS2_SaIS2_EESt7greaterIS2_EE4pushEOS2_(%"class.std::priority_queue"* %35, %"struct.std::pair.9"* dereferenceable(12) %58)
          to label %565 unwind label %290
...
569:                                              ; preds = %263
  %570 = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* %28, i32 0, i32 0
  %571 = load i32, i32* %570, align 4
  %572 = sext i32 %571 to i64
  %573 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @dist, i64 0, i64 %572
  %574 = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* %28, i32 0, i32 1
  %575 = load i32, i32* %574, align 4
  %576 = sext i32 %575 to i64
  %577 = getelementptr inbounds [8 x i32], [8 x i32]* %573, i64 0, i64 %576
  %578 = load i32, i32* %577, align 4
  %579 = invoke i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.9, i32 0, i32 0), i32 %578)
...
582:                                              ; preds = %290
  %583 = insertvalue { i8*, i32 } undef, i8* %292, 0
  %584 = insertvalue { i8*, i32 } %583, i32 %293, 1
  resume { i8*, i32 } %584
}
...
define linkonce_odr i32* @_ZNSt6vectorIiSaIiEE5eraseEN9__gnu_cxx17__normal_iteratorIPKiS1_EES6_(%"class.std::vector"* %0, i32* %1, i32* %2) #0 comdat align 2 {
  ...
  %17 = call i64 @_ZN9__gnu_cxxmiIPKiSt6vectorIiSaIiEEEENS_17__normal_iteratorIT_T0_E15difference_typeERKS9_SC_(%"class.__gnu_cxx::__normal_iterator.3"* dereferenceable(8) %5, %"class.__gnu_cxx::__normal_iterator.3"* dereferenceable(8) %8) #3
  ...
  %20 = call i64 @_ZN9__gnu_cxxmiIPKiSt6vectorIiSaIiEEEENS_17__normal_iteratorIT_T0_E15difference_typeERKS9_SC_(%"class.__gnu_cxx::__normal_iterator.3"* dereferenceable(8) %6, %"class.__gnu_cxx::__normal_iterator.3"* dereferenceable(8) %8) #3
...
define linkonce_odr void @_ZNSt14priority_queueISt4pairIiS0_IiiEESt6vectorIS2_SaIS2_EESt7greaterIS2_EEC2IS5_vEEv(%"class.std::priority_queue"* %0) unnamed_addr #4 comdat align 2 {
  ...
  call void @_ZNSt6vectorISt4pairIiS0_IiiEESaIS2_EEC2Ev(%"class.std::vector.4"* %2) #3
  %3 = getelementptr inbounds %"class.std::priority_queue", %"class.std::priority_queue"* %0, i32 0, i32 1
  ret void
}

; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt14priority_queueISt4pairIiS0_IiiEESt6vectorIS2_SaIS2_EESt7greaterIS2_EE4pushEOS2_(%"class.std::priority_queue"* %0, %"struct.std::pair.9"* dereferenceable(12) %1) #0 comdat align 2 {
  %3 = alloca %"class.__gnu_cxx::__normal_iterator.12", align 8
  %4 = alloca %"class.__gnu_cxx::__normal_iterator.12", align 8
  %5 = getelementptr inbounds %"class.std::priority_queue", %"class.std::priority_queue"* %0, i32 0, i32 0
  %6 = call dereferenceable(12) %"struct.std::pair.9"* @_ZSt4moveIRSt4pairIiS0_IiiEEEONSt16remove_referenceIT_E4typeEOS5_(%"struct.std::pair.9"* dereferenceable(12) %1) #3
  call void @_ZNSt6vectorISt4pairIiS0_IiiEESaIS2_EE9push_backEOS2_(%"class.std::vector.4"* %5, %"struct.std::pair.9"* dereferenceable(12) %6)
  %7 = getelementptr inbounds %"class.std::priority_queue", %"class.std::priority_queue"* %0, i32 0, i32 0
  %8 = call %"struct.std::pair.9"* @_ZNSt6vectorISt4pairIiS0_IiiEESaIS2_EE5beginEv(%"class.std::vector.4"* %7) #3
  ...
  %11 = call %"struct.std::pair.9"* @_ZNSt6vectorISt4pairIiS0_IiiEESaIS2_EE3endEv(%"class.std::vector.4"* %10) #3
  ...
  call void @_ZSt9push_heapIN9__gnu_cxx17__normal_iteratorIPSt4pairIiS2_IiiEESt6vectorIS4_SaIS4_EEEESt7greaterIS4_EEvT_SC_T0_(%"struct.std::pair.9"* %15, %"struct.std::pair.9"* %17)
  ret void
}
...
define linkonce_odr { i64, i32 } @_ZSt9make_pairIiSt4pairIiiEES0_INSt17__decay_and_stripIT_E6__typeENS2_IT0_E6__typeEEOS3_OS6_(i32* dereferenceable(4) %0, %"struct.std::pair"* dereferenceable(8) %1) #0 comdat {
  ...
  call void @_ZNSt4pairIiS_IiiEEC2IiS0_Lb1EEEOT_OT0_(%"struct.std::pair.9"* %3, i32* dereferenceable(4) %5, %"struct.std::pair"* dereferenceable(8) %6)
  %7 = bitcast { i64, i32 }* %4 to i8*
  %8 = bitcast %"struct.std::pair.9"* %3 to i8*
...
define linkonce_odr zeroext i1 @_ZNKSt14priority_queueISt4pairIiS0_IiiEESt6vectorIS2_SaIS2_EESt7greaterIS2_EE5emptyEv(%"class.std::priority_queue"* %0) #4 comdat align 2 {
  %2 = getelementptr inbounds %"class.std::priority_queue", %"class.std::priority_queue"* %0, i32 0, i32 0
  %3 = call zeroext i1 @_ZNKSt6vectorISt4pairIiS0_IiiEESaIS2_EE5emptyEv(%"class.std::vector.4"* %2) #3
  ret i1 %3
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(12) %"struct.std::pair.9"* @_ZNKSt14priority_queueISt4pairIiS0_IiiEESt6vectorIS2_SaIS2_EESt7greaterIS2_EE3topEv(%"class.std::priority_queue"* %0) #4 comdat align 2 {
  %2 = getelementptr inbounds %"class.std::priority_queue", %"class.std::priority_queue"* %0, i32 0, i32 0
  %3 = call dereferenceable(12) %"struct.std::pair.9"* @_ZNKSt6vectorISt4pairIiS0_IiiEESaIS2_EE5frontEv(%"class.std::vector.4"* %2) #3
...
define linkonce_odr void @_ZNSt14priority_queueISt4pairIiS0_IiiEESt6vectorIS2_SaIS2_EESt7greaterIS2_EE3popEv(%"class.std::priority_queue"* %0) #0 comdat align 2 {
  ...
  %5 = call %"struct.std::pair.9"* @_ZNSt6vectorISt4pairIiS0_IiiEESaIS2_EE5beginEv(%"class.std::vector.4"* %4) #3
  ...
  %7 = getelementptr inbounds %"class.std::priority_queue", %"class.std::priority_queue"* %0, i32 0, i32 0
  %8 = call %"struct.std::pair.9"* @_ZNSt6vectorISt4pairIiS0_IiiEESaIS2_EE3endEv(%"class.std::vector.4"* %7) #3
  %9 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator.12", %"class.__gnu_cxx::__normal_iterator.12"* %3, i32 0, i32 0
  store %"struct.std::pair.9"* %8, %"struct.std::pair.9"** %9, align 8
  ...
  call void @_ZSt8pop_heapIN9__gnu_cxx17__normal_iteratorIPSt4pairIiS2_IiiEESt6vectorIS4_SaIS4_EEEESt7greaterIS4_EEvT_SC_T0_(%"struct.std::pair.9"* %12, %"struct.std::pair.9"* %14)
  %15 = getelementptr inbounds %"class.std::priority_queue", %"class.std::priority_queue"* %0, i32 0, i32 0
  call void @_ZNSt6vectorISt4pairIiS0_IiiEESaIS2_EE8pop_backEv(%"class.std::vector.4"* %15) #3
  ret void
}

; Function Attrs: noinline uwtable
define linkonce_odr { i64, i32 } @_ZSt9make_pairIRiSt4pairIiiEES1_INSt17__decay_and_stripIT_E6__typeENS3_IT0_E6__typeEEOS4_OS7_(i32* dereferenceable(4) %0, %"struct.std::pair"* dereferenceable(8) %1) #0 comdat {
  %3 = alloca %"struct.std::pair.9", align 4
  %4 = alloca { i64, i32 }, align 8
  %5 = call dereferenceable(4) i32* @_ZSt7forwardIRiEOT_RNSt16remove_referenceIS1_E4typeE(i32* dereferenceable(4) %0) #3
  %6 = call dereferenceable(8) %"struct.std::pair"* @_ZSt7forwardISt4pairIiiEEOT_RNSt16remove_referenceIS2_E4typeE(%"struct.std::pair"* dereferenceable(8) %1) #3
  call void @_ZNSt4pairIiS_IiiEEC2IRiS0_Lb1EEEOT_OT0_(%"struct.std::pair.9"* %3, i32* dereferenceable(4) %5, %"struct.std::pair"* dereferenceable(8) %6)
  %7 = bitcast { i64, i32 }* %4 to i8*
  %8 = bitcast %"struct.std::pair.9"* %3 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %7, i8* align 4 %8, i64 12, i1 false)
  %9 = load { i64, i32 }, { i64, i32 }* %4, align 8
...
define linkonce_odr void @_ZNSt14priority_queueISt4pairIiS0_IiiEESt6vectorIS2_SaIS2_EESt7greaterIS2_EED2Ev(%"class.std::priority_queue"* %0) unnamed_addr #4 comdat align 2 {
  %2 = getelementptr inbounds %"class.std::priority_queue", %"class.std::priority_queue"* %0, i32 0, i32 0
  call void @_ZNSt6vectorISt4pairIiS0_IiiEESaIS2_EED2Ev(%"class.std::vector.4"* %2) #3
  ret void
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt4pairIiS_IiiEEC2IiS0_Lb1EEEOT_OT0_(%"struct.std::pair.9"* %0, i32* dereferenceable(4) %1, %"struct.std::pair"* dereferenceable(8) %2) unnamed_addr #4 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt4pairIiS_IiiEEC2IRiS0_Lb1EEEOT_OT0_(%"struct.std::pair.9"* %0, i32* dereferenceable(4) %1, %"struct.std::pair"* dereferenceable(8) %2) unnamed_addr #4 comdat align 2 {
  %4 = bitcast %"struct.std::pair.9"* %0 to %"class.std::__pair_base.10"*
  %5 = getelementptr inbounds %"struct.std::pair.9", %"struct.std::pair.9"* %0, i32 0, i32 0
  %6 = call dereferenceable(4) i32* @_ZSt7forwardIRiEOT_RNSt16remove_referenceIS1_E4typeE(i32* dereferenceable(4) %1) #3
  %7 = load i32, i32* %6, align 4
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt6vectorISt4pairIiS0_IiiEESaIS2_EED2Ev(%"class.std::vector.4"* %0) unnamed_addr #4 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %11 = call dereferenceable(1) %"class.std::allocator.6"* @_ZNSt12_Vector_baseISt4pairIiS0_IiiEESaIS2_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base.5"* %10) #3
  invoke void @_ZSt8_DestroyIPSt4pairIiS0_IiiEES2_EvT_S4_RSaIT0_E(%"struct.std::pair.9"* %5, %"struct.std::pair.9"* %9, %"class.std::allocator.6"* dereferenceable(1) %11)
          to label %12 unwind label %14

12:                                               ; preds = %1
  %13 = bitcast %"class.std::vector.4"* %0 to %"struct.std::_Vector_base.5"*
  call void @_ZNSt12_Vector_baseISt4pairIiS0_IiiEESaIS2_EED2Ev(%"struct.std::_Vector_base.5"* %13) #3
  ret void
...
14:                                               ; preds = %1
  ...
  call void @_ZNSt12_Vector_baseISt4pairIiS0_IiiEESaIS2_EED2Ev(%"struct.std::_Vector_base.5"* %18) #3
  br label %19
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZSt8_DestroyIPSt4pairIiS0_IiiEES2_EvT_S4_RSaIT0_E(%"struct.std::pair.9"* %0, %"struct.std::pair.9"* %1, %"class.std::allocator.6"* dereferenceable(1) %2) #0 comdat {
  call void @_ZSt8_DestroyIPSt4pairIiS0_IiiEEEvT_S4_(%"struct.std::pair.9"* %0, %"struct.std::pair.9"* %1)
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(1) %"class.std::allocator.6"* @_ZNSt12_Vector_baseISt4pairIiS0_IiiEESaIS2_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base.5"* %0) #4 comdat align 2 {
  %2 = getelementptr inbounds %"struct.std::_Vector_base.5", %"struct.std::_Vector_base.5"* %0, i32 0, i32 0
  %3 = bitcast %"struct.std::_Vector_base<std::pair<int, std::pair<int, int> >, std::allocator<std::pair<int, std::pair<int, int> > > >::_Vector_impl"* %2 to %"class.std::allocator.6"*
  ret %"class.std::allocator.6"* %3
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt12_Vector_baseISt4pairIiS0_IiiEESaIS2_EED2Ev(%"struct.std::_Vector_base.5"* %0) unnamed_addr #4 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %2 = getelementptr inbounds %"struct.std::_Vector_base.5", %"struct.std::_Vector_base.5"* %0, i32 0, i32 0
  ...
  invoke void @_ZNSt12_Vector_baseISt4pairIiS0_IiiEESaIS2_EE13_M_deallocateEPS2_m(%"struct.std::_Vector_base.5"* %0, %"struct.std::pair.9"* %4, i64 %14)
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZSt8_DestroyIPSt4pairIiS0_IiiEEEvT_S4_(%"struct.std::pair.9"* %0, %"struct.std::pair.9"* %1) #0 comdat {
  call void @_ZNSt12_Destroy_auxILb1EE9__destroyIPSt4pairIiS2_IiiEEEEvT_S6_(%"struct.std::pair.9"* %0, %"struct.std::pair.9"* %1)
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt12_Destroy_auxILb1EE9__destroyIPSt4pairIiS2_IiiEEEEvT_S6_(%"struct.std::pair.9"* %0, %"struct.std::pair.9"* %1) #4 comdat align 2 {
  ret void
}

; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt12_Vector_baseISt4pairIiS0_IiiEESaIS2_EE13_M_deallocateEPS2_m(%"struct.std::_Vector_base.5"* %0, %"struct.std::pair.9"* %1, i64 %2) #0 comdat align 2 {
  %4 = icmp ne %"struct.std::pair.9"* %1, null
  br i1 %4, label %5, label %8

5:                                                ; preds = %3
  %6 = getelementptr inbounds %"struct.std::_Vector_base.5", %"struct.std::_Vector_base.5"* %0, i32 0, i32 0
  %7 = bitcast %"struct.std::_Vector_base<std::pair<int, std::pair<int, int> >, std::allocator<std::pair<int, std::pair<int, int> > > >::_Vector_impl"* %6 to %"class.std::allocator.6"*
  call void @_ZNSt16allocator_traitsISaISt4pairIiS0_IiiEEEE10deallocateERS3_PS2_m(%"class.std::allocator.6"* dereferenceable(1) %7, %"struct.std::pair.9"* %1, i64 %2)
  br label %8
...
define linkonce_odr void @_ZNSt12_Vector_baseISt4pairIiS0_IiiEESaIS2_EE12_Vector_implD2Ev(%"struct.std::_Vector_base<std::pair<int, std::pair<int, int> >, std::allocator<std::pair<int, std::pair<int, int> > > >::_Vector_impl"* %0) unnamed_addr #4 comdat align 2 {
  %2 = bitcast %"struct.std::_Vector_base<std::pair<int, std::pair<int, int> >, std::allocator<std::pair<int, std::pair<int, int> > > >::_Vector_impl"* %0 to %"class.std::allocator.6"*
  call void @_ZNSaISt4pairIiS_IiiEEED2Ev(%"class.std::allocator.6"* %2) #3
  ret void
}

; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt16allocator_traitsISaISt4pairIiS0_IiiEEEE10deallocateERS3_PS2_m(%"class.std::allocator.6"* dereferenceable(1) %0, %"struct.std::pair.9"* %1, i64 %2) #0 comdat align 2 {
  %4 = bitcast %"class.std::allocator.6"* %0 to %"class.__gnu_cxx::new_allocator.7"*
  call void @_ZN9__gnu_cxx13new_allocatorISt4pairIiS1_IiiEEE10deallocateEPS3_m(%"class.__gnu_cxx::new_allocator.7"* %4, %"struct.std::pair.9"* %1, i64 %2)
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorISt4pairIiS1_IiiEEE10deallocateEPS3_m(%"class.__gnu_cxx::new_allocator.7"* %0, %"struct.std::pair.9"* %1, i64 %2) #4 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSaISt4pairIiS_IiiEEED2Ev(%"class.std::allocator.6"* %0) unnamed_addr #4 comdat align 2 {
  %2 = bitcast %"class.std::allocator.6"* %0 to %"class.__gnu_cxx::new_allocator.7"*
  call void @_ZN9__gnu_cxx13new_allocatorISt4pairIiS1_IiiEEED2Ev(%"class.__gnu_cxx::new_allocator.7"* %2) #3
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorISt4pairIiS1_IiiEEED2Ev(%"class.__gnu_cxx::new_allocator.7"* %0) unnamed_addr #4 comdat align 2 {
  ret void
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64 @_ZN9__gnu_cxxmiIPKiSt6vectorIiSaIiEEEENS_17__normal_iteratorIT_T0_E15difference_typeERKS9_SC_(%"class.__gnu_cxx::__normal_iterator.3"* dereferenceable(8) %0, %"class.__gnu_cxx::__normal_iterator.3"* dereferenceable(8) %1) #4 comdat {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(8) i32** @_ZNK9__gnu_cxx17__normal_iteratorIPKiSt6vectorIiSaIiEEE4baseEv(%"class.__gnu_cxx::__normal_iterator.3"* %0) #4 comdat align 2 {
  %2 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator.3", %"class.__gnu_cxx::__normal_iterator.3"* %0, i32 0, i32 0
  ret i32** %2
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt6vectorISt4pairIiS0_IiiEESaIS2_EEC2Ev(%"class.std::vector.4"* %0) unnamed_addr #4 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %2 = bitcast %"class.std::vector.4"* %0 to %"struct.std::_Vector_base.5"*
  invoke void @_ZNSt12_Vector_baseISt4pairIiS0_IiiEESaIS2_EEC2Ev(%"struct.std::_Vector_base.5"* %2)
          to label %3 unwind label %4
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt12_Vector_baseISt4pairIiS0_IiiEESaIS2_EEC2Ev(%"struct.std::_Vector_base.5"* %0) unnamed_addr #0 comdat align 2 {
  %2 = getelementptr inbounds %"struct.std::_Vector_base.5", %"struct.std::_Vector_base.5"* %0, i32 0, i32 0
...
define linkonce_odr void @_ZNSt12_Vector_baseISt4pairIiS0_IiiEESaIS2_EE12_Vector_implC2Ev(%"struct.std::_Vector_base<std::pair<int, std::pair<int, int> >, std::allocator<std::pair<int, std::pair<int, int> > > >::_Vector_impl"* %0) unnamed_addr #4 comdat align 2 {
  %2 = bitcast %"struct.std::_Vector_base<std::pair<int, std::pair<int, int> >, std::allocator<std::pair<int, std::pair<int, int> > > >::_Vector_impl"* %0 to %"class.std::allocator.6"*
  call void @_ZNSaISt4pairIiS_IiiEEEC2Ev(%"class.std::allocator.6"* %2) #3
  ...
  store %"struct.std::pair.9"* null, %"struct.std::pair.9"** %3, align 8
  ...
  store %"struct.std::pair.9"* null, %"struct.std::pair.9"** %4, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSaISt4pairIiS_IiiEEEC2Ev(%"class.std::allocator.6"* %0) unnamed_addr #4 comdat align 2 {
  %2 = bitcast %"class.std::allocator.6"* %0 to %"class.__gnu_cxx::new_allocator.7"*
  call void @_ZN9__gnu_cxx13new_allocatorISt4pairIiS1_IiiEEEC2Ev(%"class.__gnu_cxx::new_allocator.7"* %2) #3
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorISt4pairIiS1_IiiEEEC2Ev(%"class.__gnu_cxx::new_allocator.7"* %0) unnamed_addr #4 comdat align 2 {
  ret void
}

; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt6vectorISt4pairIiS0_IiiEESaIS2_EE9push_backEOS2_(%"class.std::vector.4"* %0, %"struct.std::pair.9"* dereferenceable(12) %1) #0 comdat align 2 {
  %3 = call dereferenceable(12) %"struct.std::pair.9"* @_ZSt4moveIRSt4pairIiS0_IiiEEEONSt16remove_referenceIT_E4typeEOS5_(%"struct.std::pair.9"* dereferenceable(12) %1) #3
  call void @_ZNSt6vectorISt4pairIiS0_IiiEESaIS2_EE12emplace_backIJS2_EEEvDpOT_(%"class.std::vector.4"* %0, %"struct.std::pair.9"* dereferenceable(12) %3)
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(12) %"struct.std::pair.9"* @_ZSt4moveIRSt4pairIiS0_IiiEEEONSt16remove_referenceIT_E4typeEOS5_(%"struct.std::pair.9"* dereferenceable(12) %0) #4 comdat {
  ret %"struct.std::pair.9"* %0
}

; Function Attrs: noinline uwtable
define linkonce_odr void @_ZSt9push_heapIN9__gnu_cxx17__normal_iteratorIPSt4pairIiS2_IiiEESt6vectorIS4_SaIS4_EEEESt7greaterIS4_EEvT_SC_T0_(%"struct.std::pair.9"* %0, %"struct.std::pair.9"* %1) #0 comdat {
  %3 = alloca %"class.__gnu_cxx::__normal_iterator.12", align 8
  %4 = alloca %"class.__gnu_cxx::__normal_iterator.12", align 8
  ...
  %15 = call %"struct.std::pair.9"* @_ZNK9__gnu_cxx17__normal_iteratorIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEmiEl(%"class.__gnu_cxx::__normal_iterator.12"* %4, i64 1) #3
  ...
  %17 = call dereferenceable(12) %"struct.std::pair.9"* @_ZNK9__gnu_cxx17__normal_iteratorIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEdeEv(%"class.__gnu_cxx::__normal_iterator.12"* %8) #3
  %18 = call dereferenceable(12) %"struct.std::pair.9"* @_ZSt4moveIRSt4pairIiS0_IiiEEEONSt16remove_referenceIT_E4typeEOS5_(%"struct.std::pair.9"* dereferenceable(12) %17) #3
  %19 = bitcast %"struct.std::pair.9"* %7 to i8*
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %21, i8* align 8 %22, i64 8, i1 false)
  %23 = call i64 @_ZN9__gnu_cxxmiIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEENS_17__normal_iteratorIT_T0_E15difference_typeERKSB_SE_(%"class.__gnu_cxx::__normal_iterator.12"* dereferenceable(8) %4, %"class.__gnu_cxx::__normal_iterator.12"* dereferenceable(8) %3) #3
  %24 = sub nsw i64 %23, 1
  %25 = call dereferenceable(12) %"struct.std::pair.9"* @_ZSt4moveIRSt4pairIiS0_IiiEEEONSt16remove_referenceIT_E4typeEOS5_(%"struct.std::pair.9"* dereferenceable(12) %7) #3
  %26 = bitcast %"struct.std::pair.9"* %10 to i8*
  ...
  %31 = bitcast %"struct.std::pair.9"* %10 to i8*
  ...
  call void @_ZSt11__push_heapIN9__gnu_cxx17__normal_iteratorIPSt4pairIiS2_IiiEESt6vectorIS4_SaIS4_EEEElS4_NS0_5__ops14_Iter_comp_valISt7greaterIS4_EEEEvT_T0_SG_T1_RT2_(%"struct.std::pair.9"* %29, i64 %24, i64 0, i64 %33, i32 %35, %"struct.__gnu_cxx::__ops::_Iter_comp_val"* dereferenceable(1) %6)
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr %"struct.std::pair.9"* @_ZNSt6vectorISt4pairIiS0_IiiEESaIS2_EE5beginEv(%"class.std::vector.4"* %0) #4 comdat align 2 {
  %2 = alloca %"class.__gnu_cxx::__normal_iterator.12", align 8
  ...
  call void @_ZN9__gnu_cxx17__normal_iteratorIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEC2ERKS4_(%"class.__gnu_cxx::__normal_iterator.12"* %2, %"struct.std::pair.9"** dereferenceable(8) %5) #3
  %6 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator.12", %"class.__gnu_cxx::__normal_iterator.12"* %2, i32 0, i32 0
  %7 = load %"struct.std::pair.9"*, %"struct.std::pair.9"** %6, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr %"struct.std::pair.9"* @_ZNSt6vectorISt4pairIiS0_IiiEESaIS2_EE3endEv(%"class.std::vector.4"* %0) #4 comdat align 2 {
  %2 = alloca %"class.__gnu_cxx::__normal_iterator.12", align 8
  %3 = bitcast %"class.std::vector.4"* %0 to %"struct.std::_Vector_base.5"*
  %4 = getelementptr inbounds %"struct.std::_Vector_base.5", %"struct.std::_Vector_base.5"* %3, i32 0, i32 0
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt6vectorISt4pairIiS0_IiiEESaIS2_EE12emplace_backIJS2_EEEvDpOT_(%"class.std::vector.4"* %0, %"struct.std::pair.9"* dereferenceable(12) %1) #0 comdat align 2 {
  %3 = alloca %"class.__gnu_cxx::__normal_iterator.12", align 8
  ...
  %12 = icmp ne %"struct.std::pair.9"* %7, %11
...
13:                                               ; preds = %2
  ...
  %16 = bitcast %"struct.std::_Vector_base<std::pair<int, std::pair<int, int> >, std::allocator<std::pair<int, std::pair<int, int> > > >::_Vector_impl"* %15 to %"class.std::allocator.6"*
  ...
  %21 = call dereferenceable(12) %"struct.std::pair.9"* @_ZSt7forwardISt4pairIiS0_IiiEEEOT_RNSt16remove_referenceIS3_E4typeE(%"struct.std::pair.9"* dereferenceable(12) %1) #3
  call void @_ZNSt16allocator_traitsISaISt4pairIiS0_IiiEEEE9constructIS2_JS2_EEEvRS3_PT_DpOT0_(%"class.std::allocator.6"* dereferenceable(1) %16, %"struct.std::pair.9"* %20, %"struct.std::pair.9"* dereferenceable(12) %21)
  ...
  store %"struct.std::pair.9"* %26, %"struct.std::pair.9"** %24, align 8
  br label %33

27:                                               ; preds = %2
  %28 = call %"struct.std::pair.9"* @_ZNSt6vectorISt4pairIiS0_IiiEESaIS2_EE3endEv(%"class.std::vector.4"* %0) #3
  ...
  %30 = call dereferenceable(12) %"struct.std::pair.9"* @_ZSt7forwardISt4pairIiS0_IiiEEEOT_RNSt16remove_referenceIS3_E4typeE(%"struct.std::pair.9"* dereferenceable(12) %1) #3
  ...
  call void @_ZNSt6vectorISt4pairIiS0_IiiEESaIS2_EE17_M_realloc_insertIJS2_EEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_(%"class.std::vector.4"* %0, %"struct.std::pair.9"* %32, %"struct.std::pair.9"* dereferenceable(12) %30)
  br label %33
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt16allocator_traitsISaISt4pairIiS0_IiiEEEE9constructIS2_JS2_EEEvRS3_PT_DpOT0_(%"class.std::allocator.6"* dereferenceable(1) %0, %"struct.std::pair.9"* %1, %"struct.std::pair.9"* dereferenceable(12) %2) #0 comdat align 2 {
  %4 = bitcast %"class.std::allocator.6"* %0 to %"class.__gnu_cxx::new_allocator.7"*
  %5 = call dereferenceable(12) %"struct.std::pair.9"* @_ZSt7forwardISt4pairIiS0_IiiEEEOT_RNSt16remove_referenceIS3_E4typeE(%"struct.std::pair.9"* dereferenceable(12) %2) #3
  call void @_ZN9__gnu_cxx13new_allocatorISt4pairIiS1_IiiEEE9constructIS3_JS3_EEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator.7"* %4, %"struct.std::pair.9"* %1, %"struct.std::pair.9"* dereferenceable(12) %5)
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(12) %"struct.std::pair.9"* @_ZSt7forwardISt4pairIiS0_IiiEEEOT_RNSt16remove_referenceIS3_E4typeE(%"struct.std::pair.9"* dereferenceable(12) %0) #4 comdat {
  ret %"struct.std::pair.9"* %0
}

; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt6vectorISt4pairIiS0_IiiEESaIS2_EE17_M_realloc_insertIJS2_EEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_(%"class.std::vector.4"* %0, %"struct.std::pair.9"* %1, %"struct.std::pair.9"* dereferenceable(12) %2) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %4 = alloca %"class.__gnu_cxx::__normal_iterator.12", align 8
  ...
  %7 = call i64 @_ZNKSt6vectorISt4pairIiS0_IiiEESaIS2_EE12_M_check_lenEmPKc(%"class.std::vector.4"* %0, i64 1, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.10, i32 0, i32 0))
  %8 = bitcast %"class.std::vector.4"* %0 to %"struct.std::_Vector_base.5"*
  %9 = getelementptr inbounds %"struct.std::_Vector_base.5", %"struct.std::_Vector_base.5"* %8, i32 0, i32 0
  ...
  %15 = load %"struct.std::pair.9"*, %"struct.std::pair.9"** %14, align 8
  %16 = call %"struct.std::pair.9"* @_ZNSt6vectorISt4pairIiS0_IiiEESaIS2_EE5beginEv(%"class.std::vector.4"* %0) #3
  ...
  %18 = call i64 @_ZN9__gnu_cxxmiIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEENS_17__normal_iteratorIT_T0_E15difference_typeERKSB_SE_(%"class.__gnu_cxx::__normal_iterator.12"* dereferenceable(8) %4, %"class.__gnu_cxx::__normal_iterator.12"* dereferenceable(8) %5) #3
  %19 = bitcast %"class.std::vector.4"* %0 to %"struct.std::_Vector_base.5"*
  %20 = call %"struct.std::pair.9"* @_ZNSt12_Vector_baseISt4pairIiS0_IiiEESaIS2_EE11_M_allocateEm(%"struct.std::_Vector_base.5"* %19, i64 %7)
  ...
  %23 = bitcast %"struct.std::_Vector_base<std::pair<int, std::pair<int, int> >, std::allocator<std::pair<int, std::pair<int, int> > > >::_Vector_impl"* %22 to %"class.std::allocator.6"*
  %24 = getelementptr inbounds %"struct.std::pair.9", %"struct.std::pair.9"* %20, i64 %18
  %25 = call dereferenceable(12) %"struct.std::pair.9"* @_ZSt7forwardISt4pairIiS0_IiiEEEOT_RNSt16remove_referenceIS3_E4typeE(%"struct.std::pair.9"* dereferenceable(12) %2) #3
  invoke void @_ZNSt16allocator_traitsISaISt4pairIiS0_IiiEEEE9constructIS2_JS2_EEEvRS3_PT_DpOT0_(%"class.std::allocator.6"* dereferenceable(1) %23, %"struct.std::pair.9"* %24, %"struct.std::pair.9"* dereferenceable(12) %25)
          to label %26 unwind label %40

26:                                               ; preds = %3
  %27 = call dereferenceable(8) %"struct.std::pair.9"** @_ZNK9__gnu_cxx17__normal_iteratorIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEE4baseEv(%"class.__gnu_cxx::__normal_iterator.12"* %4) #3
  %28 = load %"struct.std::pair.9"*, %"struct.std::pair.9"** %27, align 8
  %29 = bitcast %"class.std::vector.4"* %0 to %"struct.std::_Vector_base.5"*
  %30 = call dereferenceable(1) %"class.std::allocator.6"* @_ZNSt12_Vector_baseISt4pairIiS0_IiiEESaIS2_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base.5"* %29) #3
  %31 = invoke %"struct.std::pair.9"* @_ZSt34__uninitialized_move_if_noexcept_aIPSt4pairIiS0_IiiEES3_SaIS2_EET0_T_S6_S5_RT1_(%"struct.std::pair.9"* %11, %"struct.std::pair.9"* %28, %"struct.std::pair.9"* %20, %"class.std::allocator.6"* dereferenceable(1) %30)
          to label %32 unwind label %40

32:                                               ; preds = %26
  %33 = getelementptr inbounds %"struct.std::pair.9", %"struct.std::pair.9"* %31, i32 1
  %34 = call dereferenceable(8) %"struct.std::pair.9"** @_ZNK9__gnu_cxx17__normal_iteratorIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEE4baseEv(%"class.__gnu_cxx::__normal_iterator.12"* %4) #3
  %35 = load %"struct.std::pair.9"*, %"struct.std::pair.9"** %34, align 8
  %36 = bitcast %"class.std::vector.4"* %0 to %"struct.std::_Vector_base.5"*
  %37 = call dereferenceable(1) %"class.std::allocator.6"* @_ZNSt12_Vector_baseISt4pairIiS0_IiiEESaIS2_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base.5"* %36) #3
  %38 = invoke %"struct.std::pair.9"* @_ZSt34__uninitialized_move_if_noexcept_aIPSt4pairIiS0_IiiEES3_SaIS2_EET0_T_S6_S5_RT1_(%"struct.std::pair.9"* %35, %"struct.std::pair.9"* %15, %"struct.std::pair.9"* %33, %"class.std::allocator.6"* dereferenceable(1) %37)
          to label %39 unwind label %40
...
40:                                               ; preds = %32, %26, %3
  %.0 = phi %"struct.std::pair.9"* [ %33, %32 ], [ null, %26 ], [ %20, %3 ]
  %41 = landingpad { i8*, i32 }
          catch i8* null
  %42 = extractvalue { i8*, i32 } %41, 0
  %43 = extractvalue { i8*, i32 } %41, 1
...
44:                                               ; preds = %40
  %45 = call i8* @__cxa_begin_catch(i8* %42) #3
  %46 = icmp ne %"struct.std::pair.9"* %.0, null
  br i1 %46, label %57, label %47
...
47:                                               ; preds = %44
  ...
  %50 = bitcast %"struct.std::_Vector_base<std::pair<int, std::pair<int, int> >, std::allocator<std::pair<int, std::pair<int, int> > > >::_Vector_impl"* %49 to %"class.std::allocator.6"*
  %51 = getelementptr inbounds %"struct.std::pair.9", %"struct.std::pair.9"* %20, i64 %18
  invoke void @_ZNSt16allocator_traitsISaISt4pairIiS0_IiiEEEE7destroyIS2_EEvRS3_PT_(%"class.std::allocator.6"* dereferenceable(1) %50, %"struct.std::pair.9"* %51)
          to label %52 unwind label %53
...
57:                                               ; preds = %44
  ...
  %59 = call dereferenceable(1) %"class.std::allocator.6"* @_ZNSt12_Vector_baseISt4pairIiS0_IiiEESaIS2_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base.5"* %58) #3
  invoke void @_ZSt8_DestroyIPSt4pairIiS0_IiiEES2_EvT_S4_RSaIT0_E(%"struct.std::pair.9"* %20, %"struct.std::pair.9"* %.0, %"class.std::allocator.6"* dereferenceable(1) %59)
          to label %60 unwind label %53
...
61:                                               ; preds = %60, %52
  ...
  invoke void @_ZNSt12_Vector_baseISt4pairIiS0_IiiEESaIS2_EE13_M_deallocateEPS2_m(%"struct.std::_Vector_base.5"* %62, %"struct.std::pair.9"* %20, i64 %7)
          to label %63 unwind label %53
...
65:                                               ; preds = %39
  ...
  %67 = call dereferenceable(1) %"class.std::allocator.6"* @_ZNSt12_Vector_baseISt4pairIiS0_IiiEESaIS2_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base.5"* %66) #3
  call void @_ZSt8_DestroyIPSt4pairIiS0_IiiEES2_EvT_S4_RSaIT0_E(%"struct.std::pair.9"* %11, %"struct.std::pair.9"* %15, %"class.std::allocator.6"* dereferenceable(1) %67)
  ...
  %73 = ptrtoint %"struct.std::pair.9"* %72 to i64
  %74 = ptrtoint %"struct.std::pair.9"* %11 to i64
  %75 = sub i64 %73, %74
  %76 = sdiv exact i64 %75, 12
  call void @_ZNSt12_Vector_baseISt4pairIiS0_IiiEESaIS2_EE13_M_deallocateEPS2_m(%"struct.std::_Vector_base.5"* %68, %"struct.std::pair.9"* %11, i64 %76)
  ...
  store %"struct.std::pair.9"* %20, %"struct.std::pair.9"** %79, align 8
  ...
  store %"struct.std::pair.9"* %38, %"struct.std::pair.9"** %82, align 8
  %83 = getelementptr inbounds %"struct.std::pair.9", %"struct.std::pair.9"* %20, i64 %7
  ...
  store %"struct.std::pair.9"* %83, %"struct.std::pair.9"** %86, align 8
  ret void
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorISt4pairIiS1_IiiEEE9constructIS3_JS3_EEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator.7"* %0, %"struct.std::pair.9"* %1, %"struct.std::pair.9"* dereferenceable(12) %2) #4 comdat align 2 {
  %4 = bitcast %"struct.std::pair.9"* %1 to i8*
  %5 = bitcast i8* %4 to %"struct.std::pair.9"*
  %6 = call dereferenceable(12) %"struct.std::pair.9"* @_ZSt7forwardISt4pairIiS0_IiiEEEOT_RNSt16remove_referenceIS3_E4typeE(%"struct.std::pair.9"* dereferenceable(12) %2) #3
  %7 = bitcast %"struct.std::pair.9"* %5 to i8*
  %8 = bitcast %"struct.std::pair.9"* %6 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %7, i8* align 4 %8, i64 12, i1 false)
  ret void
}

; Function Attrs: noinline uwtable
define linkonce_odr i64 @_ZNKSt6vectorISt4pairIiS0_IiiEESaIS2_EE12_M_check_lenEmPKc(%"class.std::vector.4"* %0, i64 %1, i8* %2) #0 comdat align 2 {
  %4 = alloca i64, align 8
  %5 = alloca i64, align 8
  store i64 %1, i64* %4, align 8
  %6 = call i64 @_ZNKSt6vectorISt4pairIiS0_IiiEESaIS2_EE8max_sizeEv(%"class.std::vector.4"* %0) #3
  %7 = call i64 @_ZNKSt6vectorISt4pairIiS0_IiiEESaIS2_EE4sizeEv(%"class.std::vector.4"* %0) #3
  %8 = sub i64 %6, %7
  %9 = load i64, i64* %4, align 8
  %10 = icmp ult i64 %8, %9
  br i1 %10, label %11, label %12
...
12:                                               ; preds = %3
  %13 = call i64 @_ZNKSt6vectorISt4pairIiS0_IiiEESaIS2_EE4sizeEv(%"class.std::vector.4"* %0) #3
  %14 = call i64 @_ZNKSt6vectorISt4pairIiS0_IiiEESaIS2_EE4sizeEv(%"class.std::vector.4"* %0) #3
  store i64 %14, i64* %5, align 8
  %15 = call dereferenceable(8) i64* @_ZSt3maxImERKT_S2_S2_(i64* dereferenceable(8) %5, i64* dereferenceable(8) %4)
  %16 = load i64, i64* %15, align 8
  %17 = add i64 %13, %16
  %18 = call i64 @_ZNKSt6vectorISt4pairIiS0_IiiEESaIS2_EE4sizeEv(%"class.std::vector.4"* %0) #3
  %19 = icmp ult i64 %17, %18
  br i1 %19, label %23, label %20

20:                                               ; preds = %12
  %21 = call i64 @_ZNKSt6vectorISt4pairIiS0_IiiEESaIS2_EE8max_sizeEv(%"class.std::vector.4"* %0) #3
  %22 = icmp ugt i64 %17, %21
  br i1 %22, label %23, label %25

23:                                               ; preds = %20, %12
  %24 = call i64 @_ZNKSt6vectorISt4pairIiS0_IiiEESaIS2_EE8max_sizeEv(%"class.std::vector.4"* %0) #3
  br label %26
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64 @_ZN9__gnu_cxxmiIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEENS_17__normal_iteratorIT_T0_E15difference_typeERKSB_SE_(%"class.__gnu_cxx::__normal_iterator.12"* dereferenceable(8) %0, %"class.__gnu_cxx::__normal_iterator.12"* dereferenceable(8) %1) #4 comdat {
  %3 = call dereferenceable(8) %"struct.std::pair.9"** @_ZNK9__gnu_cxx17__normal_iteratorIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEE4baseEv(%"class.__gnu_cxx::__normal_iterator.12"* %0) #3
  %4 = load %"struct.std::pair.9"*, %"struct.std::pair.9"** %3, align 8
  %5 = call dereferenceable(8) %"struct.std::pair.9"** @_ZNK9__gnu_cxx17__normal_iteratorIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEE4baseEv(%"class.__gnu_cxx::__normal_iterator.12"* %1) #3
...
; Function Attrs: noinline uwtable
define linkonce_odr %"struct.std::pair.9"* @_ZNSt12_Vector_baseISt4pairIiS0_IiiEESaIS2_EE11_M_allocateEm(%"struct.std::_Vector_base.5"* %0, i64 %1) #0 comdat align 2 {
  %3 = icmp ne i64 %1, 0
  br i1 %3, label %4, label %8

4:                                                ; preds = %2
  %5 = getelementptr inbounds %"struct.std::_Vector_base.5", %"struct.std::_Vector_base.5"* %0, i32 0, i32 0
  %6 = bitcast %"struct.std::_Vector_base<std::pair<int, std::pair<int, int> >, std::allocator<std::pair<int, std::pair<int, int> > > >::_Vector_impl"* %5 to %"class.std::allocator.6"*
  %7 = call %"struct.std::pair.9"* @_ZNSt16allocator_traitsISaISt4pairIiS0_IiiEEEE8allocateERS3_m(%"class.std::allocator.6"* dereferenceable(1) %6, i64 %1)
  br label %9
...
9:                                                ; preds = %8, %4
  %10 = phi %"struct.std::pair.9"* [ %7, %4 ], [ null, %8 ]
  ret %"struct.std::pair.9"* %10
}

; Function Attrs: noinline uwtable
define linkonce_odr %"struct.std::pair.9"* @_ZSt34__uninitialized_move_if_noexcept_aIPSt4pairIiS0_IiiEES3_SaIS2_EET0_T_S6_S5_RT1_(%"struct.std::pair.9"* %0, %"struct.std::pair.9"* %1, %"struct.std::pair.9"* %2, %"class.std::allocator.6"* dereferenceable(1) %3) #0 comdat {
  %5 = alloca %"class.std::move_iterator.13", align 8
  %6 = alloca %"class.std::move_iterator.13", align 8
  %7 = call %"struct.std::pair.9"* @_ZSt32__make_move_if_noexcept_iteratorISt4pairIiS0_IiiEESt13move_iteratorIPS2_EET0_PT_(%"struct.std::pair.9"* %0)
  %8 = getelementptr inbounds %"class.std::move_iterator.13", %"class.std::move_iterator.13"* %5, i32 0, i32 0
  store %"struct.std::pair.9"* %7, %"struct.std::pair.9"** %8, align 8
  %9 = call %"struct.std::pair.9"* @_ZSt32__make_move_if_noexcept_iteratorISt4pairIiS0_IiiEESt13move_iteratorIPS2_EET0_PT_(%"struct.std::pair.9"* %1)
  %10 = getelementptr inbounds %"class.std::move_iterator.13", %"class.std::move_iterator.13"* %6, i32 0, i32 0
  store %"struct.std::pair.9"* %9, %"struct.std::pair.9"** %10, align 8
  ...
  %14 = load %"struct.std::pair.9"*, %"struct.std::pair.9"** %13, align 8
  %15 = call %"struct.std::pair.9"* @_ZSt22__uninitialized_copy_aISt13move_iteratorIPSt4pairIiS1_IiiEEES4_S3_ET0_T_S7_S6_RSaIT1_E(%"struct.std::pair.9"* %12, %"struct.std::pair.9"* %14, %"struct.std::pair.9"* %2, %"class.std::allocator.6"* dereferenceable(1) %3)
  ret %"struct.std::pair.9"* %15
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(8) %"struct.std::pair.9"** @_ZNK9__gnu_cxx17__normal_iteratorIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEE4baseEv(%"class.__gnu_cxx::__normal_iterator.12"* %0) #4 comdat align 2 {
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt16allocator_traitsISaISt4pairIiS0_IiiEEEE7destroyIS2_EEvRS3_PT_(%"class.std::allocator.6"* dereferenceable(1) %0, %"struct.std::pair.9"* %1) #0 comdat align 2 {
  %3 = bitcast %"class.std::allocator.6"* %0 to %"class.__gnu_cxx::new_allocator.7"*
  call void @_ZN9__gnu_cxx13new_allocatorISt4pairIiS1_IiiEEE7destroyIS3_EEvPT_(%"class.__gnu_cxx::new_allocator.7"* %3, %"struct.std::pair.9"* %1)
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64 @_ZNKSt6vectorISt4pairIiS0_IiiEESaIS2_EE8max_sizeEv(%"class.std::vector.4"* %0) #4 comdat align 2 {
  %2 = bitcast %"class.std::vector.4"* %0 to %"struct.std::_Vector_base.5"*
  %3 = call dereferenceable(1) %"class.std::allocator.6"* @_ZNKSt12_Vector_baseISt4pairIiS0_IiiEESaIS2_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base.5"* %2) #3
  %4 = call i64 @_ZNSt16allocator_traitsISaISt4pairIiS0_IiiEEEE8max_sizeERKS3_(%"class.std::allocator.6"* dereferenceable(1) %3) #3
  ret i64 %4
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64 @_ZNKSt6vectorISt4pairIiS0_IiiEESaIS2_EE4sizeEv(%"class.std::vector.4"* %0) #4 comdat align 2 {
  %2 = bitcast %"class.std::vector.4"* %0 to %"struct.std::_Vector_base.5"*
  %3 = getelementptr inbounds %"struct.std::_Vector_base.5", %"struct.std::_Vector_base.5"* %2, i32 0, i32 0
  ...
  %9 = load %"struct.std::pair.9"*, %"struct.std::pair.9"** %8, align 8
  %10 = ptrtoint %"struct.std::pair.9"* %5 to i64
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64 @_ZNSt16allocator_traitsISaISt4pairIiS0_IiiEEEE8max_sizeERKS3_(%"class.std::allocator.6"* dereferenceable(1) %0) #4 comdat align 2 {
  %2 = bitcast %"class.std::allocator.6"* %0 to %"class.__gnu_cxx::new_allocator.7"*
  %3 = call i64 @_ZNK9__gnu_cxx13new_allocatorISt4pairIiS1_IiiEEE8max_sizeEv(%"class.__gnu_cxx::new_allocator.7"* %2) #3
  ret i64 %3
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(1) %"class.std::allocator.6"* @_ZNKSt12_Vector_baseISt4pairIiS0_IiiEESaIS2_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base.5"* %0) #4 comdat align 2 {
  %2 = getelementptr inbounds %"struct.std::_Vector_base.5", %"struct.std::_Vector_base.5"* %0, i32 0, i32 0
  %3 = bitcast %"struct.std::_Vector_base<std::pair<int, std::pair<int, int> >, std::allocator<std::pair<int, std::pair<int, int> > > >::_Vector_impl"* %2 to %"class.std::allocator.6"*
  ret %"class.std::allocator.6"* %3
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64 @_ZNK9__gnu_cxx13new_allocatorISt4pairIiS1_IiiEEE8max_sizeEv(%"class.__gnu_cxx::new_allocator.7"* %0) #4 comdat align 2 {
  ret i64 1537228672809129301
}

; Function Attrs: noinline uwtable
define linkonce_odr %"struct.std::pair.9"* @_ZNSt16allocator_traitsISaISt4pairIiS0_IiiEEEE8allocateERS3_m(%"class.std::allocator.6"* dereferenceable(1) %0, i64 %1) #0 comdat align 2 {
  %3 = bitcast %"class.std::allocator.6"* %0 to %"class.__gnu_cxx::new_allocator.7"*
  %4 = call %"struct.std::pair.9"* @_ZN9__gnu_cxx13new_allocatorISt4pairIiS1_IiiEEE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.7"* %3, i64 %1, i8* null)
  ret %"struct.std::pair.9"* %4
}

; Function Attrs: noinline uwtable
define linkonce_odr %"struct.std::pair.9"* @_ZN9__gnu_cxx13new_allocatorISt4pairIiS1_IiiEEE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.7"* %0, i64 %1, i8* %2) #0 comdat align 2 {
  %4 = call i64 @_ZNK9__gnu_cxx13new_allocatorISt4pairIiS1_IiiEEE8max_sizeEv(%"class.__gnu_cxx::new_allocator.7"* %0) #3
  %5 = icmp ugt i64 %1, %4
  br i1 %5, label %6, label %7
...
; Function Attrs: noinline uwtable
define linkonce_odr %"struct.std::pair.9"* @_ZSt22__uninitialized_copy_aISt13move_iteratorIPSt4pairIiS1_IiiEEES4_S3_ET0_T_S7_S6_RSaIT1_E(%"struct.std::pair.9"* %0, %"struct.std::pair.9"* %1, %"struct.std::pair.9"* %2, %"class.std::allocator.6"* dereferenceable(1) %3) #0 comdat {
  %5 = alloca %"class.std::move_iterator.13", align 8
  %6 = alloca %"class.std::move_iterator.13", align 8
  ...
  %19 = call %"struct.std::pair.9"* @_ZSt18uninitialized_copyISt13move_iteratorIPSt4pairIiS1_IiiEEES4_ET0_T_S7_S6_(%"struct.std::pair.9"* %16, %"struct.std::pair.9"* %18, %"struct.std::pair.9"* %2)
  ret %"struct.std::pair.9"* %19
}

; Function Attrs: noinline uwtable
define linkonce_odr %"struct.std::pair.9"* @_ZSt32__make_move_if_noexcept_iteratorISt4pairIiS0_IiiEESt13move_iteratorIPS2_EET0_PT_(%"struct.std::pair.9"* %0) #0 comdat {
  %2 = alloca %"class.std::move_iterator.13", align 8
  call void @_ZNSt13move_iteratorIPSt4pairIiS0_IiiEEEC2ES3_(%"class.std::move_iterator.13"* %2, %"struct.std::pair.9"* %0)
...
; Function Attrs: noinline uwtable
define linkonce_odr %"struct.std::pair.9"* @_ZSt18uninitialized_copyISt13move_iteratorIPSt4pairIiS1_IiiEEES4_ET0_T_S7_S6_(%"struct.std::pair.9"* %0, %"struct.std::pair.9"* %1, %"struct.std::pair.9"* %2) #0 comdat {
  ...
  %17 = load %"struct.std::pair.9"*, %"struct.std::pair.9"** %16, align 8
  %18 = call %"struct.std::pair.9"* @_ZNSt20__uninitialized_copyILb0EE13__uninit_copyISt13move_iteratorIPSt4pairIiS3_IiiEEES6_EET0_T_S9_S8_(%"struct.std::pair.9"* %15, %"struct.std::pair.9"* %17, %"struct.std::pair.9"* %2)
  ret %"struct.std::pair.9"* %18
}

; Function Attrs: noinline uwtable
define linkonce_odr %"struct.std::pair.9"* @_ZNSt20__uninitialized_copyILb0EE13__uninit_copyISt13move_iteratorIPSt4pairIiS3_IiiEEES6_EET0_T_S9_S8_(%"struct.std::pair.9"* %0, %"struct.std::pair.9"* %1, %"struct.std::pair.9"* %2) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %4 = alloca %"class.std::move_iterator.13", align 8
  %5 = alloca %"class.std::move_iterator.13", align 8
...
8:                                                ; preds = %18, %3
  %.0 = phi %"struct.std::pair.9"* [ %2, %3 ], [ %19, %18 ]
  %9 = invoke zeroext i1 @_ZStneIPSt4pairIiS0_IiiEEEbRKSt13move_iteratorIT_ES8_(%"class.std::move_iterator.13"* dereferenceable(8) %4, %"class.std::move_iterator.13"* dereferenceable(8) %5)
...
11:                                               ; preds = %10
  %12 = call %"struct.std::pair.9"* @_ZSt11__addressofISt4pairIiS0_IiiEEEPT_RS3_(%"struct.std::pair.9"* dereferenceable(12) %.0) #3
  %13 = invoke dereferenceable(12) %"struct.std::pair.9"* @_ZNKSt13move_iteratorIPSt4pairIiS0_IiiEEEdeEv(%"class.std::move_iterator.13"* %4)
          to label %14 unwind label %20

14:                                               ; preds = %11
  invoke void @_ZSt10_ConstructISt4pairIiS0_IiiEEJS2_EEvPT_DpOT0_(%"struct.std::pair.9"* %12, %"struct.std::pair.9"* dereferenceable(12) %13)
...
16:                                               ; preds = %15
  %17 = invoke dereferenceable(8) %"class.std::move_iterator.13"* @_ZNSt13move_iteratorIPSt4pairIiS0_IiiEEEppEv(%"class.std::move_iterator.13"* %4)
          to label %18 unwind label %20

18:                                               ; preds = %16
  %19 = getelementptr inbounds %"struct.std::pair.9", %"struct.std::pair.9"* %.0, i32 1
  br label %8
...
24:                                               ; preds = %20
  ...
  invoke void @_ZSt8_DestroyIPSt4pairIiS0_IiiEEEvT_S4_(%"struct.std::pair.9"* %2, %"struct.std::pair.9"* %.0)
...
; Function Attrs: noinline uwtable
define linkonce_odr zeroext i1 @_ZStneIPSt4pairIiS0_IiiEEEbRKSt13move_iteratorIT_ES8_(%"class.std::move_iterator.13"* dereferenceable(8) %0, %"class.std::move_iterator.13"* dereferenceable(8) %1) #0 comdat {
  %3 = call zeroext i1 @_ZSteqIPSt4pairIiS0_IiiEEEbRKSt13move_iteratorIT_ES8_(%"class.std::move_iterator.13"* dereferenceable(8) %0, %"class.std::move_iterator.13"* dereferenceable(8) %1)
  %4 = xor i1 %3, true
  ret i1 %4
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZSt10_ConstructISt4pairIiS0_IiiEEJS2_EEvPT_DpOT0_(%"struct.std::pair.9"* %0, %"struct.std::pair.9"* dereferenceable(12) %1) #4 comdat {
  %3 = bitcast %"struct.std::pair.9"* %0 to i8*
  %4 = bitcast i8* %3 to %"struct.std::pair.9"*
  %5 = call dereferenceable(12) %"struct.std::pair.9"* @_ZSt7forwardISt4pairIiS0_IiiEEEOT_RNSt16remove_referenceIS3_E4typeE(%"struct.std::pair.9"* dereferenceable(12) %1) #3
  %6 = bitcast %"struct.std::pair.9"* %4 to i8*
  %7 = bitcast %"struct.std::pair.9"* %5 to i8*
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr %"struct.std::pair.9"* @_ZSt11__addressofISt4pairIiS0_IiiEEEPT_RS3_(%"struct.std::pair.9"* dereferenceable(12) %0) #4 comdat {
  ret %"struct.std::pair.9"* %0
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(12) %"struct.std::pair.9"* @_ZNKSt13move_iteratorIPSt4pairIiS0_IiiEEEdeEv(%"class.std::move_iterator.13"* %0) #4 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(8) %"class.std::move_iterator.13"* @_ZNSt13move_iteratorIPSt4pairIiS0_IiiEEEppEv(%"class.std::move_iterator.13"* %0) #4 comdat align 2 {
  %2 = getelementptr inbounds %"class.std::move_iterator.13", %"class.std::move_iterator.13"* %0, i32 0, i32 0
  %3 = load %"struct.std::pair.9"*, %"struct.std::pair.9"** %2, align 8
  %4 = getelementptr inbounds %"struct.std::pair.9", %"struct.std::pair.9"* %3, i32 1
...
; Function Attrs: noinline uwtable
define linkonce_odr zeroext i1 @_ZSteqIPSt4pairIiS0_IiiEEEbRKSt13move_iteratorIT_ES8_(%"class.std::move_iterator.13"* dereferenceable(8) %0, %"class.std::move_iterator.13"* dereferenceable(8) %1) #0 comdat {
  %3 = call %"struct.std::pair.9"* @_ZNKSt13move_iteratorIPSt4pairIiS0_IiiEEE4baseEv(%"class.std::move_iterator.13"* %0)
  %4 = call %"struct.std::pair.9"* @_ZNKSt13move_iteratorIPSt4pairIiS0_IiiEEE4baseEv(%"class.std::move_iterator.13"* %1)
  %5 = icmp eq %"struct.std::pair.9"* %3, %4
  ret i1 %5
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr %"struct.std::pair.9"* @_ZNKSt13move_iteratorIPSt4pairIiS0_IiiEEE4baseEv(%"class.std::move_iterator.13"* %0) #4 comdat align 2 {
  %2 = getelementptr inbounds %"class.std::move_iterator.13", %"class.std::move_iterator.13"* %0, i32 0, i32 0
  %3 = load %"struct.std::pair.9"*, %"struct.std::pair.9"** %2, align 8
  ret %"struct.std::pair.9"* %3
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt13move_iteratorIPSt4pairIiS0_IiiEEEC2ES3_(%"class.std::move_iterator.13"* %0, %"struct.std::pair.9"* %1) unnamed_addr #4 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorISt4pairIiS1_IiiEEE7destroyIS3_EEvPT_(%"class.__gnu_cxx::new_allocator.7"* %0, %"struct.std::pair.9"* %1) #4 comdat align 2 {
  ret void
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr %"struct.std::pair.9"* @_ZNK9__gnu_cxx17__normal_iteratorIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEmiEl(%"class.__gnu_cxx::__normal_iterator.12"* %0, i64 %1) #4 comdat align 2 {
  %3 = alloca %"class.__gnu_cxx::__normal_iterator.12", align 8
  ...
  call void @_ZN9__gnu_cxx17__normal_iteratorIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEC2ERKS4_(%"class.__gnu_cxx::__normal_iterator.12"* %3, %"struct.std::pair.9"** dereferenceable(8) %4) #3
  %9 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator.12", %"class.__gnu_cxx::__normal_iterator.12"* %3, i32 0, i32 0
  %10 = load %"struct.std::pair.9"*, %"struct.std::pair.9"** %9, align 8
  ret %"struct.std::pair.9"* %10
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(12) %"struct.std::pair.9"* @_ZNK9__gnu_cxx17__normal_iteratorIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEdeEv(%"class.__gnu_cxx::__normal_iterator.12"* %0) #4 comdat align 2 {
  %2 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator.12", %"class.__gnu_cxx::__normal_iterator.12"* %0, i32 0, i32 0
  %3 = load %"struct.std::pair.9"*, %"struct.std::pair.9"** %2, align 8
  ret %"struct.std::pair.9"* %3
}
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZSt11__push_heapIN9__gnu_cxx17__normal_iteratorIPSt4pairIiS2_IiiEESt6vectorIS4_SaIS4_EEEElS4_NS0_5__ops14_Iter_comp_valISt7greaterIS4_EEEEvT_T0_SG_T1_RT2_(%"struct.std::pair.9"* %0, i64 %1, i64 %2, i64 %3, i32 %4, %"struct.__gnu_cxx::__ops::_Iter_comp_val"* dereferenceable(1) %5) #0 comdat {
...
23:                                               ; preds = %21
  %24 = call %"struct.std::pair.9"* @_ZNK9__gnu_cxx17__normal_iteratorIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEplEl(%"class.__gnu_cxx::__normal_iterator.12"* %7, i64 %.01) #3
  ...
  %28 = call zeroext i1 @_ZN9__gnu_cxx5__ops14_Iter_comp_valISt7greaterISt4pairIiS3_IiiEEEEclINS_17__normal_iteratorIPS5_St6vectorIS5_SaIS5_EEEES5_EEbT_RT0_(%"struct.__gnu_cxx::__ops::_Iter_comp_val"* %5, %"struct.std::pair.9"* %27, %"struct.std::pair.9"* dereferenceable(12) %8)
  br label %29
...
31:                                               ; preds = %29
  %32 = call %"struct.std::pair.9"* @_ZNK9__gnu_cxx17__normal_iteratorIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEplEl(%"class.__gnu_cxx::__normal_iterator.12"* %7, i64 %.01) #3
  ...
  %34 = call dereferenceable(12) %"struct.std::pair.9"* @_ZNK9__gnu_cxx17__normal_iteratorIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEdeEv(%"class.__gnu_cxx::__normal_iterator.12"* %11) #3
  %35 = call dereferenceable(12) %"struct.std::pair.9"* @_ZSt4moveIRSt4pairIiS0_IiiEEEONSt16remove_referenceIT_E4typeEOS5_(%"struct.std::pair.9"* dereferenceable(12) %34) #3
  %36 = call %"struct.std::pair.9"* @_ZNK9__gnu_cxx17__normal_iteratorIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEplEl(%"class.__gnu_cxx::__normal_iterator.12"* %7, i64 %.0) #3
  ...
  %38 = call dereferenceable(12) %"struct.std::pair.9"* @_ZNK9__gnu_cxx17__normal_iteratorIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEdeEv(%"class.__gnu_cxx::__normal_iterator.12"* %12) #3
  %39 = call dereferenceable(12) %"struct.std::pair.9"* @_ZNSt4pairIiS_IiiEEaSEOS1_(%"struct.std::pair.9"* %38, %"struct.std::pair.9"* dereferenceable(12) %35) #3
  %40 = sub nsw i64 %.01, 1
  %41 = sdiv i64 %40, 2
  br label %21

42:                                               ; preds = %29
  %43 = call dereferenceable(12) %"struct.std::pair.9"* @_ZSt4moveIRSt4pairIiS0_IiiEEEONSt16remove_referenceIT_E4typeEOS5_(%"struct.std::pair.9"* dereferenceable(12) %8) #3
  %44 = call %"struct.std::pair.9"* @_ZNK9__gnu_cxx17__normal_iteratorIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEplEl(%"class.__gnu_cxx::__normal_iterator.12"* %7, i64 %.0) #3
  ...
  %46 = call dereferenceable(12) %"struct.std::pair.9"* @_ZNK9__gnu_cxx17__normal_iteratorIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEdeEv(%"class.__gnu_cxx::__normal_iterator.12"* %13) #3
  %47 = call dereferenceable(12) %"struct.std::pair.9"* @_ZNSt4pairIiS_IiiEEaSEOS1_(%"struct.std::pair.9"* %46, %"struct.std::pair.9"* dereferenceable(12) %43) #3
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx17__normal_iteratorIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEC2ERKS4_(%"class.__gnu_cxx::__normal_iterator.12"* %0, %"struct.std::pair.9"** dereferenceable(8) %1) unnamed_addr #4 comdat align 2 {
...
; Function Attrs: noinline uwtable
define linkonce_odr zeroext i1 @_ZN9__gnu_cxx5__ops14_Iter_comp_valISt7greaterISt4pairIiS3_IiiEEEEclINS_17__normal_iteratorIPS5_St6vectorIS5_SaIS5_EEEES5_EEbT_RT0_(%"struct.__gnu_cxx::__ops::_Iter_comp_val"* %0, %"struct.std::pair.9"* %1, %"struct.std::pair.9"* dereferenceable(12) %2) #0 comdat align 2 {
  %4 = alloca %"class.__gnu_cxx::__normal_iterator.12", align 8
  ...
  %7 = call dereferenceable(12) %"struct.std::pair.9"* @_ZNK9__gnu_cxx17__normal_iteratorIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEdeEv(%"class.__gnu_cxx::__normal_iterator.12"* %4) #3
  %8 = call zeroext i1 @_ZNKSt7greaterISt4pairIiS0_IiiEEEclERKS2_S5_(%"struct.std::greater"* %6, %"struct.std::pair.9"* dereferenceable(12) %7, %"struct.std::pair.9"* dereferenceable(12) %2)
  ret i1 %8
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr %"struct.std::pair.9"* @_ZNK9__gnu_cxx17__normal_iteratorIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEplEl(%"class.__gnu_cxx::__normal_iterator.12"* %0, i64 %1) #4 comdat align 2 {
  %3 = alloca %"class.__gnu_cxx::__normal_iterator.12", align 8
  %4 = alloca %"struct.std::pair.9"*, align 8
  %5 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator.12", %"class.__gnu_cxx::__normal_iterator.12"* %0, i32 0, i32 0
  %6 = load %"struct.std::pair.9"*, %"struct.std::pair.9"** %5, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(12) %"struct.std::pair.9"* @_ZNSt4pairIiS_IiiEEaSEOS1_(%"struct.std::pair.9"* %0, %"struct.std::pair.9"* dereferenceable(12) %1) #4 comdat align 2 {
  ...
  store i32 %5, i32* %6, align 4
  %7 = getelementptr inbounds %"struct.std::pair.9", %"struct.std::pair.9"* %1, i32 0, i32 1
...
; Function Attrs: noinline uwtable
define linkonce_odr zeroext i1 @_ZNKSt7greaterISt4pairIiS0_IiiEEEclERKS2_S5_(%"struct.std::greater"* %0, %"struct.std::pair.9"* dereferenceable(12) %1, %"struct.std::pair.9"* dereferenceable(12) %2) #0 comdat align 2 {
  %4 = call zeroext i1 @_ZStgtIiSt4pairIiiEEbRKS0_IT_T0_ES6_(%"struct.std::pair.9"* dereferenceable(12) %1, %"struct.std::pair.9"* dereferenceable(12) %2)
  ret i1 %4
}

; Function Attrs: noinline uwtable
define linkonce_odr zeroext i1 @_ZStgtIiSt4pairIiiEEbRKS0_IT_T0_ES6_(%"struct.std::pair.9"* dereferenceable(12) %0, %"struct.std::pair.9"* dereferenceable(12) %1) #0 comdat {
  %3 = call zeroext i1 @_ZStltIiSt4pairIiiEEbRKS0_IT_T0_ES6_(%"struct.std::pair.9"* dereferenceable(12) %1, %"struct.std::pair.9"* dereferenceable(12) %0)
  ret i1 %3
}

; Function Attrs: noinline uwtable
define linkonce_odr zeroext i1 @_ZStltIiSt4pairIiiEEbRKS0_IT_T0_ES6_(%"struct.std::pair.9"* dereferenceable(12) %0, %"struct.std::pair.9"* dereferenceable(12) %1) #0 comdat {
...
8:                                                ; preds = %2
  %9 = getelementptr inbounds %"struct.std::pair.9", %"struct.std::pair.9"* %1, i32 0, i32 0
  %10 = load i32, i32* %9, align 4
  %11 = getelementptr inbounds %"struct.std::pair.9", %"struct.std::pair.9"* %0, i32 0, i32 0
  %12 = load i32, i32* %11, align 4
  %13 = icmp slt i32 %10, %12
  br i1 %13, label %18, label %14

14:                                               ; preds = %8
  %15 = getelementptr inbounds %"struct.std::pair.9", %"struct.std::pair.9"* %0, i32 0, i32 1
  %16 = getelementptr inbounds %"struct.std::pair.9", %"struct.std::pair.9"* %1, i32 0, i32 1
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr zeroext i1 @_ZNKSt6vectorISt4pairIiS0_IiiEESaIS2_EE5emptyEv(%"class.std::vector.4"* %0) #4 comdat align 2 {
  %2 = alloca %"class.__gnu_cxx::__normal_iterator.14", align 8
  %3 = alloca %"class.__gnu_cxx::__normal_iterator.14", align 8
  %4 = call %"struct.std::pair.9"* @_ZNKSt6vectorISt4pairIiS0_IiiEESaIS2_EE5beginEv(%"class.std::vector.4"* %0) #3
  ...
  %6 = call %"struct.std::pair.9"* @_ZNKSt6vectorISt4pairIiS0_IiiEESaIS2_EE3endEv(%"class.std::vector.4"* %0) #3
  ...
  %8 = call zeroext i1 @_ZN9__gnu_cxxeqIPKSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEEbRKNS_17__normal_iteratorIT_T0_EESE_(%"class.__gnu_cxx::__normal_iterator.14"* dereferenceable(8) %2, %"class.__gnu_cxx::__normal_iterator.14"* dereferenceable(8) %3) #3
  ret i1 %8
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr zeroext i1 @_ZN9__gnu_cxxeqIPKSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEEbRKNS_17__normal_iteratorIT_T0_EESE_(%"class.__gnu_cxx::__normal_iterator.14"* dereferenceable(8) %0, %"class.__gnu_cxx::__normal_iterator.14"* dereferenceable(8) %1) #4 comdat {
  %3 = call dereferenceable(8) %"struct.std::pair.9"** @_ZNK9__gnu_cxx17__normal_iteratorIPKSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEE4baseEv(%"class.__gnu_cxx::__normal_iterator.14"* %0) #3
  %4 = load %"struct.std::pair.9"*, %"struct.std::pair.9"** %3, align 8
  %5 = call dereferenceable(8) %"struct.std::pair.9"** @_ZNK9__gnu_cxx17__normal_iteratorIPKSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEE4baseEv(%"class.__gnu_cxx::__normal_iterator.14"* %1) #3
  %6 = load %"struct.std::pair.9"*, %"struct.std::pair.9"** %5, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr %"struct.std::pair.9"* @_ZNKSt6vectorISt4pairIiS0_IiiEESaIS2_EE5beginEv(%"class.std::vector.4"* %0) #4 comdat align 2 {
  %2 = alloca %"class.__gnu_cxx::__normal_iterator.14", align 8
  ...
  %7 = load %"struct.std::pair.9"*, %"struct.std::pair.9"** %6, align 8
  store %"struct.std::pair.9"* %7, %"struct.std::pair.9"** %3, align 8
  call void @_ZN9__gnu_cxx17__normal_iteratorIPKSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEC2ERKS5_(%"class.__gnu_cxx::__normal_iterator.14"* %2, %"struct.std::pair.9"** dereferenceable(8) %3) #3
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr %"struct.std::pair.9"* @_ZNKSt6vectorISt4pairIiS0_IiiEESaIS2_EE3endEv(%"class.std::vector.4"* %0) #4 comdat align 2 {
  %2 = alloca %"class.__gnu_cxx::__normal_iterator.14", align 8
  %3 = alloca %"struct.std::pair.9"*, align 8
  %4 = bitcast %"class.std::vector.4"* %0 to %"struct.std::_Vector_base.5"*
  %5 = getelementptr inbounds %"struct.std::_Vector_base.5", %"struct.std::_Vector_base.5"* %4, i32 0, i32 0
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(8) %"struct.std::pair.9"** @_ZNK9__gnu_cxx17__normal_iteratorIPKSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEE4baseEv(%"class.__gnu_cxx::__normal_iterator.14"* %0) #4 comdat align 2 {
  %2 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator.14", %"class.__gnu_cxx::__normal_iterator.14"* %0, i32 0, i32 0
  ret %"struct.std::pair.9"** %2
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx17__normal_iteratorIPKSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEC2ERKS5_(%"class.__gnu_cxx::__normal_iterator.14"* %0, %"struct.std::pair.9"** dereferenceable(8) %1) unnamed_addr #4 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(12) %"struct.std::pair.9"* @_ZNKSt6vectorISt4pairIiS0_IiiEESaIS2_EE5frontEv(%"class.std::vector.4"* %0) #4 comdat align 2 {
  %2 = alloca %"class.__gnu_cxx::__normal_iterator.14", align 8
  %3 = call %"struct.std::pair.9"* @_ZNKSt6vectorISt4pairIiS0_IiiEESaIS2_EE5beginEv(%"class.std::vector.4"* %0) #3
  ...
  %5 = call dereferenceable(12) %"struct.std::pair.9"* @_ZNK9__gnu_cxx17__normal_iteratorIPKSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEdeEv(%"class.__gnu_cxx::__normal_iterator.14"* %2) #3
  ret %"struct.std::pair.9"* %5
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(12) %"struct.std::pair.9"* @_ZNK9__gnu_cxx17__normal_iteratorIPKSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEdeEv(%"class.__gnu_cxx::__normal_iterator.14"* %0) #4 comdat align 2 {
  %2 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator.14", %"class.__gnu_cxx::__normal_iterator.14"* %0, i32 0, i32 0
  %3 = load %"struct.std::pair.9"*, %"struct.std::pair.9"** %2, align 8
  ret %"struct.std::pair.9"* %3
}
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZSt8pop_heapIN9__gnu_cxx17__normal_iteratorIPSt4pairIiS2_IiiEESt6vectorIS4_SaIS4_EEEESt7greaterIS4_EEvT_SC_T0_(%"struct.std::pair.9"* %0, %"struct.std::pair.9"* %1) #0 comdat {
  %3 = alloca %"class.__gnu_cxx::__normal_iterator.12", align 8
  %4 = alloca %"class.__gnu_cxx::__normal_iterator.12", align 8
  %5 = alloca %"struct.std::greater", align 1
  ...
  %12 = call i64 @_ZN9__gnu_cxxmiIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEENS_17__normal_iteratorIT_T0_E15difference_typeERKSB_SE_(%"class.__gnu_cxx::__normal_iterator.12"* dereferenceable(8) %4, %"class.__gnu_cxx::__normal_iterator.12"* dereferenceable(8) %3) #3
  %13 = icmp sgt i64 %12, 1
...
14:                                               ; preds = %2
  ...
  %16 = call dereferenceable(8) %"class.__gnu_cxx::__normal_iterator.12"* @_ZN9__gnu_cxx17__normal_iteratorIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEmmEv(%"class.__gnu_cxx::__normal_iterator.12"* %4) #3
  ...
  %28 = load %"struct.std::pair.9"*, %"struct.std::pair.9"** %27, align 8
  call void @_ZSt10__pop_heapIN9__gnu_cxx17__normal_iteratorIPSt4pairIiS2_IiiEESt6vectorIS4_SaIS4_EEEENS0_5__ops15_Iter_comp_iterISt7greaterIS4_EEEEvT_SF_SF_RT0_(%"struct.std::pair.9"* %24, %"struct.std::pair.9"* %26, %"struct.std::pair.9"* %28, %"struct.__gnu_cxx::__ops::_Iter_comp_iter"* dereferenceable(1) %6)
  br label %29
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt6vectorISt4pairIiS0_IiiEESaIS2_EE8pop_backEv(%"class.std::vector.4"* %0) #4 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %2 = bitcast %"class.std::vector.4"* %0 to %"struct.std::_Vector_base.5"*
  %3 = getelementptr inbounds %"struct.std::_Vector_base.5", %"struct.std::_Vector_base.5"* %2, i32 0, i32 0
  %4 = getelementptr inbounds %"struct.std::_Vector_base<std::pair<int, std::pair<int, int> >, std::allocator<std::pair<int, std::pair<int, int> > > >::_Vector_impl", %"struct.std::_Vector_base<std::pair<int, std::pair<int, int> >, std::allocator<std::pair<int, std::pair<int, int> > > >::_Vector_impl"* %3, i32 0, i32 1
  %5 = load %"struct.std::pair.9"*, %"struct.std::pair.9"** %4, align 8
  ...
  %9 = bitcast %"struct.std::_Vector_base<std::pair<int, std::pair<int, int> >, std::allocator<std::pair<int, std::pair<int, int> > > >::_Vector_impl"* %8 to %"class.std::allocator.6"*
  %10 = bitcast %"class.std::vector.4"* %0 to %"struct.std::_Vector_base.5"*
  ...
  invoke void @_ZNSt16allocator_traitsISaISt4pairIiS0_IiiEEEE7destroyIS2_EEvRS3_PT_(%"class.std::allocator.6"* dereferenceable(1) %9, %"struct.std::pair.9"* %13)
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(8) %"class.__gnu_cxx::__normal_iterator.12"* @_ZN9__gnu_cxx17__normal_iteratorIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEmmEv(%"class.__gnu_cxx::__normal_iterator.12"* %0) #4 comdat align 2 {
  %2 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator.12", %"class.__gnu_cxx::__normal_iterator.12"* %0, i32 0, i32 0
  %3 = load %"struct.std::pair.9"*, %"struct.std::pair.9"** %2, align 8
  %4 = getelementptr inbounds %"struct.std::pair.9", %"struct.std::pair.9"* %3, i32 -1
  store %"struct.std::pair.9"* %4, %"struct.std::pair.9"** %2, align 8
...
define linkonce_odr void @_ZSt10__pop_heapIN9__gnu_cxx17__normal_iteratorIPSt4pairIiS2_IiiEESt6vectorIS4_SaIS4_EEEENS0_5__ops15_Iter_comp_iterISt7greaterIS4_EEEEvT_SF_SF_RT0_(%"struct.std::pair.9"* %0, %"struct.std::pair.9"* %1, %"struct.std::pair.9"* %2, %"struct.__gnu_cxx::__ops::_Iter_comp_iter"* dereferenceable(1) %3) #0 comdat {
  ...
  %16 = call dereferenceable(12) %"struct.std::pair.9"* @_ZNK9__gnu_cxx17__normal_iteratorIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEdeEv(%"class.__gnu_cxx::__normal_iterator.12"* %7) #3
  %17 = call dereferenceable(12) %"struct.std::pair.9"* @_ZSt4moveIRSt4pairIiS0_IiiEEEONSt16remove_referenceIT_E4typeEOS5_(%"struct.std::pair.9"* dereferenceable(12) %16) #3
  %18 = bitcast %"struct.std::pair.9"* %8 to i8*
  %19 = bitcast %"struct.std::pair.9"* %17 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %18, i8* align 4 %19, i64 12, i1 false)
  %20 = call dereferenceable(12) %"struct.std::pair.9"* @_ZNK9__gnu_cxx17__normal_iteratorIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEdeEv(%"class.__gnu_cxx::__normal_iterator.12"* %5) #3
  %21 = call dereferenceable(12) %"struct.std::pair.9"* @_ZSt4moveIRSt4pairIiS0_IiiEEEONSt16remove_referenceIT_E4typeEOS5_(%"struct.std::pair.9"* dereferenceable(12) %20) #3
  %22 = call dereferenceable(12) %"struct.std::pair.9"* @_ZNK9__gnu_cxx17__normal_iteratorIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEdeEv(%"class.__gnu_cxx::__normal_iterator.12"* %7) #3
  %23 = call dereferenceable(12) %"struct.std::pair.9"* @_ZNSt4pairIiS_IiiEEaSEOS1_(%"struct.std::pair.9"* %22, %"struct.std::pair.9"* dereferenceable(12) %21) #3
  %24 = bitcast %"class.__gnu_cxx::__normal_iterator.12"* %9 to i8*
  %25 = bitcast %"class.__gnu_cxx::__normal_iterator.12"* %5 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %24, i8* align 8 %25, i64 8, i1 false)
  %26 = call i64 @_ZN9__gnu_cxxmiIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEENS_17__normal_iteratorIT_T0_E15difference_typeERKSB_SE_(%"class.__gnu_cxx::__normal_iterator.12"* dereferenceable(8) %6, %"class.__gnu_cxx::__normal_iterator.12"* dereferenceable(8) %5) #3
  %27 = call dereferenceable(12) %"struct.std::pair.9"* @_ZSt4moveIRSt4pairIiS0_IiiEEEONSt16remove_referenceIT_E4typeEOS5_(%"struct.std::pair.9"* dereferenceable(12) %8) #3
  %28 = bitcast %"struct.std::pair.9"* %10 to i8*
  ...
  %35 = bitcast %"struct.std::pair.9"* %10 to i8*
  ...
  call void @_ZSt13__adjust_heapIN9__gnu_cxx17__normal_iteratorIPSt4pairIiS2_IiiEESt6vectorIS4_SaIS4_EEEElS4_NS0_5__ops15_Iter_comp_iterISt7greaterIS4_EEEEvT_T0_SG_T1_T2_(%"struct.std::pair.9"* %33, i64 0, i64 %26, i64 %37, i32 %39)
  ret void
}

; Function Attrs: noinline uwtable
define linkonce_odr void @_ZSt13__adjust_heapIN9__gnu_cxx17__normal_iteratorIPSt4pairIiS2_IiiEESt6vectorIS4_SaIS4_EEEElS4_NS0_5__ops15_Iter_comp_iterISt7greaterIS4_EEEEvT_T0_SG_T1_T2_(%"struct.std::pair.9"* %0, i64 %1, i64 %2, i64 %3, i32 %4) #0 comdat {
  %6 = alloca %"class.__gnu_cxx::__normal_iterator.12", align 8
  %7 = alloca %"struct.std::pair.9", align 4
...
29:                                               ; preds = %25
  %30 = add nsw i64 %.01, 1
  %31 = mul nsw i64 2, %30
  %32 = call %"struct.std::pair.9"* @_ZNK9__gnu_cxx17__normal_iteratorIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEplEl(%"class.__gnu_cxx::__normal_iterator.12"* %6, i64 %31) #3
  %33 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator.12", %"class.__gnu_cxx::__normal_iterator.12"* %10, i32 0, i32 0
  store %"struct.std::pair.9"* %32, %"struct.std::pair.9"** %33, align 8
  %34 = sub nsw i64 %31, 1
  %35 = call %"struct.std::pair.9"* @_ZNK9__gnu_cxx17__normal_iteratorIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEplEl(%"class.__gnu_cxx::__normal_iterator.12"* %6, i64 %34) #3
  ...
  %41 = call zeroext i1 @_ZN9__gnu_cxx5__ops15_Iter_comp_iterISt7greaterISt4pairIiS3_IiiEEEEclINS_17__normal_iteratorIPS5_St6vectorIS5_SaIS5_EEEESE_EEbT_T0_(%"struct.__gnu_cxx::__ops::_Iter_comp_iter"* %9, %"struct.std::pair.9"* %38, %"struct.std::pair.9"* %40)
...
44:                                               ; preds = %42, %29
  ...
  %45 = call %"struct.std::pair.9"* @_ZNK9__gnu_cxx17__normal_iteratorIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEplEl(%"class.__gnu_cxx::__normal_iterator.12"* %6, i64 %.12) #3
  ...
  %47 = call dereferenceable(12) %"struct.std::pair.9"* @_ZNK9__gnu_cxx17__normal_iteratorIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEdeEv(%"class.__gnu_cxx::__normal_iterator.12"* %12) #3
  %48 = call dereferenceable(12) %"struct.std::pair.9"* @_ZSt4moveIRSt4pairIiS0_IiiEEEONSt16remove_referenceIT_E4typeEOS5_(%"struct.std::pair.9"* dereferenceable(12) %47) #3
  %49 = call %"struct.std::pair.9"* @_ZNK9__gnu_cxx17__normal_iteratorIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEplEl(%"class.__gnu_cxx::__normal_iterator.12"* %6, i64 %.0) #3
  ...
  %51 = call dereferenceable(12) %"struct.std::pair.9"* @_ZNK9__gnu_cxx17__normal_iteratorIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEdeEv(%"class.__gnu_cxx::__normal_iterator.12"* %13) #3
  %52 = call dereferenceable(12) %"struct.std::pair.9"* @_ZNSt4pairIiS_IiiEEaSEOS1_(%"struct.std::pair.9"* %51, %"struct.std::pair.9"* dereferenceable(12) %48) #3
  br label %25
...
60:                                               ; preds = %56
  ...
  %62 = mul nsw i64 2, %61
  %63 = sub nsw i64 %62, 1
  %64 = call %"struct.std::pair.9"* @_ZNK9__gnu_cxx17__normal_iteratorIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEplEl(%"class.__gnu_cxx::__normal_iterator.12"* %6, i64 %63) #3
  %65 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator.12", %"class.__gnu_cxx::__normal_iterator.12"* %14, i32 0, i32 0
  store %"struct.std::pair.9"* %64, %"struct.std::pair.9"** %65, align 8
  %66 = call dereferenceable(12) %"struct.std::pair.9"* @_ZNK9__gnu_cxx17__normal_iteratorIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEdeEv(%"class.__gnu_cxx::__normal_iterator.12"* %14) #3
  %67 = call dereferenceable(12) %"struct.std::pair.9"* @_ZSt4moveIRSt4pairIiS0_IiiEEEONSt16remove_referenceIT_E4typeEOS5_(%"struct.std::pair.9"* dereferenceable(12) %66) #3
  %68 = call %"struct.std::pair.9"* @_ZNK9__gnu_cxx17__normal_iteratorIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEplEl(%"class.__gnu_cxx::__normal_iterator.12"* %6, i64 %.0) #3
  ...
  %70 = call dereferenceable(12) %"struct.std::pair.9"* @_ZNK9__gnu_cxx17__normal_iteratorIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEdeEv(%"class.__gnu_cxx::__normal_iterator.12"* %15) #3
  %71 = call dereferenceable(12) %"struct.std::pair.9"* @_ZNSt4pairIiS_IiiEEaSEOS1_(%"struct.std::pair.9"* %70, %"struct.std::pair.9"* dereferenceable(12) %67) #3
  %72 = sub nsw i64 %62, 1
  br label %73
...
73:                                               ; preds = %60, %56, %53
  ...
  %76 = bitcast %"class.__gnu_cxx::__normal_iterator.12"* %6 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %75, i8* align 8 %76, i64 8, i1 false)
  %77 = call dereferenceable(12) %"struct.std::pair.9"* @_ZSt4moveIRSt4pairIiS0_IiiEEEONSt16remove_referenceIT_E4typeEOS5_(%"struct.std::pair.9"* dereferenceable(12) %7) #3
  %78 = bitcast %"struct.std::pair.9"* %18 to i8*
  ...
  %83 = bitcast %"struct.std::pair.9"* %18 to i8*
  ...
  call void @_ZSt11__push_heapIN9__gnu_cxx17__normal_iteratorIPSt4pairIiS2_IiiEESt6vectorIS4_SaIS4_EEEElS4_NS0_5__ops14_Iter_comp_valISt7greaterIS4_EEEEvT_T0_SG_T1_RT2_(%"struct.std::pair.9"* %81, i64 %.1, i64 %1, i64 %85, i32 %87, %"struct.__gnu_cxx::__ops::_Iter_comp_val"* dereferenceable(1) %16)
  ret void
}

; Function Attrs: noinline uwtable
define linkonce_odr zeroext i1 @_ZN9__gnu_cxx5__ops15_Iter_comp_iterISt7greaterISt4pairIiS3_IiiEEEEclINS_17__normal_iteratorIPS5_St6vectorIS5_SaIS5_EEEESE_EEbT_T0_(%"struct.__gnu_cxx::__ops::_Iter_comp_iter"* %0, %"struct.std::pair.9"* %1, %"struct.std::pair.9"* %2) #0 comdat align 2 {
  %4 = alloca %"class.__gnu_cxx::__normal_iterator.12", align 8
  %5 = alloca %"class.__gnu_cxx::__normal_iterator.12", align 8
  %6 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator.12", %"class.__gnu_cxx::__normal_iterator.12"* %4, i32 0, i32 0
  store %"struct.std::pair.9"* %1, %"struct.std::pair.9"** %6, align 8
  ...
  %9 = call dereferenceable(12) %"struct.std::pair.9"* @_ZNK9__gnu_cxx17__normal_iteratorIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEdeEv(%"class.__gnu_cxx::__normal_iterator.12"* %4) #3
  %10 = call dereferenceable(12) %"struct.std::pair.9"* @_ZNK9__gnu_cxx17__normal_iteratorIPSt4pairIiS1_IiiEESt6vectorIS3_SaIS3_EEEdeEv(%"class.__gnu_cxx::__normal_iterator.12"* %5) #3
  %11 = call zeroext i1 @_ZNKSt7greaterISt4pairIiS0_IiiEEEclERKS2_S5_(%"struct.std::greater"* %8, %"struct.std::pair.9"* dereferenceable(12) %9, %"struct.std::pair.9"* dereferenceable(12) %10)
  ret i1 %11
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s396441996.cpp() #0 section ".text.startup" {
