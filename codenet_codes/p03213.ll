; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03213/s819948734.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03213/s819948734.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s819948734.cpp, i8* null }]
...
define zeroext i1 @_Z5primei(i32 %0) #4 {
  %2 = icmp eq i32 %0, 1
...
15:                                               ; preds = %5
  %16 = trunc i8 %.02 to i1
  br label %17

17:                                               ; preds = %15, %3
  %.0 = phi i1 [ false, %3 ], [ %16, %15 ]
  ret i1 %.0
}
...
11:                                               ; preds = %7
  ...
  %13 = invoke zeroext i1 @_Z5primei(i32 %12)
...
26:                                               ; preds = %48, %25
  ...
  %28 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* %2) #3
...
55:                                               ; preds = %95, %54
  %.013 = phi i32 [ 0, %54 ], [ %96, %95 ]
  %.011 = phi i32 [ 0, %54 ], [ %.112, %95 ]
  %.09 = phi i32 [ 0, %54 ], [ %.110, %95 ]
  %.07 = phi i32 [ 0, %54 ], [ %.18, %95 ]
  %.05 = phi i32 [ 0, %54 ], [ %.16, %95 ]
  %.04 = phi i32 [ 0, %54 ], [ %.1, %95 ]
...
92:                                               ; preds = %87
  %93 = add nsw i32 %.011, 1
  br label %94

94:                                               ; preds = %92, %87
  %.112 = phi i32 [ %93, %92 ], [ %.011, %87 ]
  br label %95

95:                                               ; preds = %94
  %96 = add nsw i32 %.013, 1
  br label %55

97:                                               ; preds = %55
  %98 = add nsw i32 0, %.04
  %99 = sub nsw i32 %.011, 1
  %100 = mul nsw i32 %.05, %99
  %101 = add nsw i32 %98, %100
  %102 = sub nsw i32 %.09, 1
  %103 = mul nsw i32 %.07, %102
  %104 = add nsw i32 %101, %103
  %105 = sub nsw i32 %.09, 1
  %106 = mul nsw i32 %.09, %105
  %107 = sub nsw i32 %.011, 2
...
115:                                              ; preds = %50, %17
  %.01 = phi i32 [ %20, %17 ], [ %53, %50 ]
  %.0 = phi i8* [ %19, %17 ], [ %52, %50 ]
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %2) #3
  br label %116

116:                                              ; preds = %115
  %117 = insertvalue { i8*, i32 } undef, i8* %.0, 0
  %118 = insertvalue { i8*, i32 } %117, i32 %.01, 1
  resume { i8*, i32 } %118
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s819948734.cpp() #0 section ".text.startup" {
