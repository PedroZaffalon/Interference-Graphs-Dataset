; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00652/s440417343.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00652/s440417343.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s440417343.cpp, i8* null }]
...
57:                                               ; preds = %55
  ...
  invoke void @_ZNSt6vectorIdSaIdEEC2EmRKS0_(%"class.std::vector"* %6, i64 %59, %"class.std::allocator"* dereferenceable(1) %7)
...
60:                                               ; preds = %57
  ...
  invoke void @_ZNSt6vectorIdSaIdEEC2EmRKS0_(%"class.std::vector"* %8, i64 %62, %"class.std::allocator"* dereferenceable(1) %9)
...
63:                                               ; preds = %60
  ...
  call void @_ZNSt6vectorIiSaIiEEC2Ev(%"class.std::vector.5"* %13) #3
  store i32 0, i32* %14, align 4
  %64 = load i32, i32* %2, align 4
  %65 = add nsw i32 %64, 10
  %66 = sext i32 %65 to i64
  call void @_ZNSaIdEC2Ev(%"class.std::allocator"* %16) #3
  invoke void @_ZNSt6vectorIdSaIdEEC2EmRKS0_(%"class.std::vector"* %15, i64 %66, %"class.std::allocator"* dereferenceable(1) %16)
          to label %67 unwind label %89

67:                                               ; preds = %63
  call void @_ZNSaIdED2Ev(%"class.std::allocator"* %16) #3
...
74:                                               ; preds = %72
  %75 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* %73, i32* dereferenceable(4) %19)
...
93:                                               ; preds = %166, %162, %151, %150, %149, %147, %145, %139, %138, %137, %135, %133, %74, %72
...
97:                                               ; preds = %80, %76
  ...
  %114 = call dereferenceable(8) double* @_ZNSt6vectorIdSaIdEEixEm(%"class.std::vector"* %15, i64 %113) #3
  ...
  %127 = call dereferenceable(8) double* @_ZNSt6vectorIdSaIdEEixEm(%"class.std::vector"* %15, i64 %126) #3
...
133:                                              ; preds = %97
  %134 = invoke i64 @_ZSt9make_pairIRiS0_ESt4pairINSt17__decay_and_stripIT_E6__typeENS2_IT0_E6__typeEEOS3_OS6_(i32* dereferenceable(4) %14, i32* dereferenceable(4) %18)
          to label %135 unwind label %93

135:                                              ; preds = %133
  %136 = bitcast %"struct.std::pair"* %21 to i64*
  store i64 %134, i64* %136, align 4
  invoke void @_ZNSt6vectorISt4pairIiiESaIS1_EE9push_backEOS1_(%"class.std::vector.0"* %10, %"struct.std::pair"* dereferenceable(8) %21)
          to label %137 unwind label %93

137:                                              ; preds = %135
  store i32 0, i32* %22, align 4
  invoke void @_ZNSt6vectorIiSaIiEE9push_backEOi(%"class.std::vector.5"* %11, i32* dereferenceable(4) %22)
          to label %138 unwind label %93

138:                                              ; preds = %137
  invoke void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector.5"* %12, i32* dereferenceable(4) %17)
          to label %139 unwind label %93

139:                                              ; preds = %138
  store i32 0, i32* %23, align 4
  invoke void @_ZNSt6vectorIiSaIiEE9push_backEOi(%"class.std::vector.5"* %13, i32* dereferenceable(4) %23)
...
145:                                              ; preds = %141
  %146 = invoke i64 @_ZSt9make_pairIRiS0_ESt4pairINSt17__decay_and_stripIT_E6__typeENS2_IT0_E6__typeEEOS3_OS6_(i32* dereferenceable(4) %18, i32* dereferenceable(4) %19)
          to label %147 unwind label %93

147:                                              ; preds = %145
  %148 = bitcast %"struct.std::pair"* %24 to i64*
  store i64 %146, i64* %148, align 4
  invoke void @_ZNSt6vectorISt4pairIiiESaIS1_EE9push_backEOS1_(%"class.std::vector.0"* %10, %"struct.std::pair"* dereferenceable(8) %24)
          to label %149 unwind label %93

149:                                              ; preds = %147
  store i32 1, i32* %25, align 4
  invoke void @_ZNSt6vectorIiSaIiEE9push_backEOi(%"class.std::vector.5"* %11, i32* dereferenceable(4) %25)
...
151:                                              ; preds = %150
  invoke void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector.5"* %13, i32* dereferenceable(4) %20)
...
159:                                              ; preds = %171, %158
  %.07 = phi i32 [ 0, %158 ], [ %172, %171 ]
  %160 = load i32, i32* %1, align 4
  %161 = icmp slt i32 %.07, %160
  br i1 %161, label %162, label %173

162:                                              ; preds = %159
  %163 = sext i32 %.07 to i64
  %164 = call dereferenceable(8) double* @_ZNSt6vectorIdSaIdEEixEm(%"class.std::vector"* %6, i64 %163) #3
  %165 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERd(%"class.std::basic_istream"* @_ZSt3cin, double* dereferenceable(8) %164)
          to label %166 unwind label %93

166:                                              ; preds = %162
  %167 = sext i32 %.07 to i64
  %168 = call dereferenceable(8) double* @_ZNSt6vectorIdSaIdEEixEm(%"class.std::vector"* %8, i64 %167) #3
  %169 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERd(%"class.std::basic_istream"* %165, double* dereferenceable(8) %168)
...
173:                                              ; preds = %159
  ...
  invoke void @_ZNSt6vectorIiSaIiEEC2EmRKS0_(%"class.std::vector.5"* %26, i64 %176, %"class.std::allocator.7"* dereferenceable(1) %27)
...
178:                                              ; preds = %328, %177
  %.08 = phi i32 [ 0, %177 ], [ %329, %328 ]
  %179 = load i32, i32* %1, align 4
  %180 = icmp slt i32 %.08, %179
...
181:                                              ; preds = %178
  ...
  %189 = fadd double %188, 1.000000e-09
  %190 = fptosi double %189 to i32
  store i32 %190, i32* %32, align 4
  store i32 0, i32* %33, align 4
  %191 = invoke i64 @_ZSt9make_pairIiiESt4pairINSt17__decay_and_stripIT_E6__typeENS1_IT0_E6__typeEEOS2_OS5_(i32* dereferenceable(4) %32, i32* dereferenceable(4) %33)
          to label %192 unwind label %258

192:                                              ; preds = %181
  %193 = bitcast %"struct.std::pair"* %31 to i64*
  ...
  %198 = invoke %"struct.std::pair"* @_ZSt11upper_boundIN9__gnu_cxx17__normal_iteratorIPSt4pairIiiESt6vectorIS3_SaIS3_EEEES3_ET_S9_S9_RKT0_(%"struct.std::pair"* %195, %"struct.std::pair"* %197, %"struct.std::pair"* dereferenceable(8) %31)
...
199:                                              ; preds = %192
  ...
  %201 = call %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EE5beginEv(%"class.std::vector.0"* %10) #3
  ...
  %203 = call i64 @_ZN9__gnu_cxxmiIPSt4pairIiiESt6vectorIS2_SaIS2_EEEENS_17__normal_iteratorIT_T0_E15difference_typeERKSA_SD_(%"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %28, %"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %34) #3
  %204 = sub nsw i64 %203, 1
  %205 = trunc i64 %204 to i32
  %206 = sext i32 %205 to i64
  %207 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.5"* %11, i64 %206) #3
...
210:                                              ; preds = %199
  ...
  %212 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.5"* %13, i64 %211) #3
...
215:                                              ; preds = %210
  ...
  %217 = call dereferenceable(8) %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EEixEm(%"class.std::vector.0"* %10, i64 %216) #3
  %218 = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* %217, i32 0, i32 1
  %219 = load i32, i32* %218, align 4
  %220 = sitofp i32 %219 to double
  %221 = load i32, i32* %3, align 4
  %222 = sitofp i32 %221 to double
  %223 = sext i32 %.08 to i64
  %224 = call dereferenceable(8) double* @_ZNSt6vectorIdSaIdEEixEm(%"class.std::vector"* %6, i64 %223) #3
  %225 = load double, double* %224, align 8
  %226 = fsub double %222, %225
  %227 = sext i32 %205 to i64
  %228 = call dereferenceable(8) %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EEixEm(%"class.std::vector.0"* %10, i64 %227) #3
  %229 = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* %228, i32 0, i32 1
  %230 = load i32, i32* %229, align 4
  %231 = sext i32 %205 to i64
  %232 = call dereferenceable(8) %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EEixEm(%"class.std::vector.0"* %10, i64 %231) #3
  ...
  %243 = call dereferenceable(8) double* @_ZNSt6vectorIdSaIdEEixEm(%"class.std::vector"* %8, i64 %242) #3
  %244 = load double, double* %243, align 8
  %245 = fcmp olt double %244, %241
  br i1 %245, label %246, label %262

246:                                              ; preds = %215
  %247 = sext i32 %205 to i64
  %248 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.5"* %12, i64 %247) #3
  %249 = load i32, i32* %248, align 4
  %250 = sext i32 %249 to i64
  %251 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.5"* %26, i64 %250) #3
...
262:                                              ; preds = %215
  ...
  %264 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.5"* %12, i64 %263) #3
  %265 = load i32, i32* %264, align 4
  %266 = add nsw i32 %265, 1
  %267 = sext i32 %266 to i64
  %268 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.5"* %26, i64 %267) #3
...
272:                                              ; preds = %210
  ...
  %274 = call dereferenceable(8) %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EEixEm(%"class.std::vector.0"* %10, i64 %273) #3
  %275 = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* %274, i32 0, i32 0
  %276 = load i32, i32* %275, align 4
  %277 = sitofp i32 %276 to double
  %278 = sext i32 %.08 to i64
  %279 = call dereferenceable(8) double* @_ZNSt6vectorIdSaIdEEixEm(%"class.std::vector"* %6, i64 %278) #3
  %280 = load double, double* %279, align 8
  %281 = sext i32 %205 to i64
  %282 = call dereferenceable(8) %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EEixEm(%"class.std::vector.0"* %10, i64 %281) #3
  %283 = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* %282, i32 0, i32 1
  %284 = load i32, i32* %283, align 4
  %285 = sext i32 %205 to i64
  %286 = call dereferenceable(8) %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EEixEm(%"class.std::vector.0"* %10, i64 %285) #3
  ...
  %295 = fadd double %277, %294
  %296 = sext i32 %.08 to i64
  %297 = call dereferenceable(8) double* @_ZNSt6vectorIdSaIdEEixEm(%"class.std::vector"* %8, i64 %296) #3
  %298 = load double, double* %297, align 8
  %299 = fcmp olt double %298, %295
  br i1 %299, label %300, label %308

300:                                              ; preds = %272
  %301 = sext i32 %205 to i64
  %302 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.5"* %12, i64 %301) #3
  %303 = load i32, i32* %302, align 4
  %304 = sext i32 %303 to i64
  %305 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.5"* %26, i64 %304) #3
...
308:                                              ; preds = %272
  %309 = sext i32 %205 to i64
  %310 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.5"* %12, i64 %309) #3
  %311 = load i32, i32* %310, align 4
  %312 = add nsw i32 %311, 1
  %313 = sext i32 %312 to i64
  %314 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.5"* %26, i64 %313) #3
...
319:                                              ; preds = %199
  ...
  %321 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.5"* %12, i64 %320) #3
  %322 = load i32, i32* %321, align 4
  %323 = sext i32 %322 to i64
  %324 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.5"* %26, i64 %323) #3
...
331:                                              ; preds = %390, %330
  %.011 = phi i32 [ 0, %330 ], [ %.112, %390 ]
  %.09 = phi i32 [ 0, %330 ], [ %.110, %390 ]
  %.0 = phi double [ 0.000000e+00, %330 ], [ %.1, %390 ]
  %332 = load i32, i32* %2, align 4
  %333 = icmp slt i32 %.011, %332
  br i1 %333, label %334, label %337

334:                                              ; preds = %331
  %335 = load i32, i32* %2, align 4
  %336 = icmp sle i32 %.09, %335
  br label %337
...
352:                                              ; preds = %348
  ...
  %354 = call dereferenceable(8) double* @_ZNSt6vectorIdSaIdEEixEm(%"class.std::vector"* %15, i64 %353) #3
  %355 = load double, double* %354, align 8
  %356 = fadd double %.0, %355
  %357 = sext i32 %.09 to i64
  %358 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.5"* %26, i64 %357) #3
  %359 = load i32, i32* %358, align 4
  %360 = load i32, i32* %36, align 4
  %361 = add nsw i32 %360, %359
  store i32 %361, i32* %36, align 4
  %362 = add nsw i32 %.09, 1
  br label %374

363:                                              ; preds = %339
  %364 = sext i32 %.011 to i64
  %365 = call dereferenceable(8) double* @_ZNSt6vectorIdSaIdEEixEm(%"class.std::vector"* %15, i64 %364) #3
  %366 = load double, double* %365, align 8
  %367 = fsub double %.0, %366
  %368 = sext i32 %.011 to i64
  %369 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.5"* %26, i64 %368) #3
  %370 = load i32, i32* %369, align 4
  %371 = load i32, i32* %36, align 4
  %372 = sub nsw i32 %371, %370
  store i32 %372, i32* %36, align 4
  %373 = add nsw i32 %.011, 1
  br label %374

374:                                              ; preds = %363, %352
  %.112 = phi i32 [ %.011, %352 ], [ %373, %363 ]
  %.110 = phi i32 [ %362, %352 ], [ %.09, %363 ]
  %.1 = phi double [ %356, %352 ], [ %367, %363 ]
...
377:                                              ; preds = %374
  ...
  %382 = fsub double %381, %.1
  %383 = fadd double %382, 1.000000e-09
  %384 = load double, double* %5, align 8
  %385 = fcmp oge double %383, %384
  br i1 %385, label %386, label %390

386:                                              ; preds = %377
  %387 = invoke dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* dereferenceable(4) %36, i32* dereferenceable(4) %35)
...
399:                                              ; preds = %258, %254, %93
  %.03 = phi i32 [ %96, %93 ], [ %261, %258 ], [ %257, %254 ]
  %.01 = phi i8* [ %95, %93 ], [ %260, %258 ], [ %256, %254 ]
  call void @_ZNSt6vectorIdSaIdEED2Ev(%"class.std::vector"* %15) #3
  br label %400

400:                                              ; preds = %399, %89
  %.14 = phi i32 [ %.03, %399 ], [ %92, %89 ]
  %.12 = phi i8* [ %.01, %399 ], [ %91, %89 ]
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector.5"* %13) #3
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector.5"* %12) #3
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector.5"* %11) #3
  call void @_ZNSt6vectorISt4pairIiiESaIS1_EED2Ev(%"class.std::vector.0"* %10) #3
...
401:                                              ; preds = %400, %85
  %.25 = phi i32 [ %.14, %400 ], [ %88, %85 ]
  %.2 = phi i8* [ %.12, %400 ], [ %87, %85 ]
  call void @_ZNSt6vectorIdSaIdEED2Ev(%"class.std::vector"* %6) #3
  br label %403
...
403:                                              ; preds = %401, %81
  %.36 = phi i32 [ %.25, %401 ], [ %84, %81 ]
  %.3 = phi i8* [ %.2, %401 ], [ %83, %81 ]
  %404 = insertvalue { i8*, i32 } undef, i8* %.3, 0
  %405 = insertvalue { i8*, i32 } %404, i32 %.36, 1
  resume { i8*, i32 } %405
}
...
; Function Attrs: noinline uwtable
define linkonce_odr %"struct.std::pair"* @_ZSt11upper_boundIN9__gnu_cxx17__normal_iteratorIPSt4pairIiiESt6vectorIS3_SaIS3_EEEES3_ET_S9_S9_RKT0_(%"struct.std::pair"* %0, %"struct.std::pair"* %1, %"struct.std::pair"* dereferenceable(8) %2) #0 comdat {
  ...
  %19 = call %"struct.std::pair"* @_ZSt13__upper_boundIN9__gnu_cxx17__normal_iteratorIPSt4pairIiiESt6vectorIS3_SaIS3_EEEES3_NS0_5__ops14_Val_less_iterEET_SB_SB_RKT0_T1_(%"struct.std::pair"* %16, %"struct.std::pair"* %18, %"struct.std::pair"* dereferenceable(8) %2)
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(8) %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EEixEm(%"class.std::vector.0"* %0, i64 %1) #5 comdat align 2 {
  %3 = bitcast %"class.std::vector.0"* %0 to %"struct.std::_Vector_base.1"*
  %4 = getelementptr inbounds %"struct.std::_Vector_base.1", %"struct.std::_Vector_base.1"* %3, i32 0, i32 0
  %5 = getelementptr inbounds %"struct.std::_Vector_base<std::pair<int, int>, std::allocator<std::pair<int, int> > >::_Vector_impl", %"struct.std::_Vector_base<std::pair<int, int>, std::allocator<std::pair<int, int> > >::_Vector_impl"* %4, i32 0, i32 0
  %6 = load %"struct.std::pair"*, %"struct.std::pair"** %5, align 8
...
define linkonce_odr void @_ZNSt6vectorIiSaIiEE17_M_realloc_insertIJiEEEvN9__gnu_cxx17__normal_iteratorIPiS1_EEDpOT_(%"class.std::vector.5"* %0, i32* %1, i32* dereferenceable(4) %2) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %7 = call i64 @_ZNKSt6vectorIiSaIiEE12_M_check_lenEmPKc(%"class.std::vector.5"* %0, i64 1, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str, i32 0, i32 0))
  %8 = bitcast %"class.std::vector.5"* %0 to %"struct.std::_Vector_base.6"*
  %9 = getelementptr inbounds %"struct.std::_Vector_base.6", %"struct.std::_Vector_base.6"* %8, i32 0, i32 0
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector.5"* %0) #5 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorIiE9constructIiJiEEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator.8"* %0, i32* %1, i32* dereferenceable(4) %2) #5 comdat align 2 {
  %4 = bitcast i32* %1 to i8*
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64 @_ZN9__gnu_cxxmiIPiSt6vectorIiSaIiEEEENS_17__normal_iteratorIT_T0_E15difference_typeERKS8_SB_(%"class.__gnu_cxx::__normal_iterator.10"* dereferenceable(8) %0, %"class.__gnu_cxx::__normal_iterator.10"* dereferenceable(8) %1) #5 comdat {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector.5"* %0) #5 comdat align 2 {
  %2 = alloca %"class.__gnu_cxx::__normal_iterator.10", align 8
  %3 = bitcast %"class.std::vector.5"* %0 to %"struct.std::_Vector_base.6"*
  %4 = getelementptr inbounds %"struct.std::_Vector_base.6", %"struct.std::_Vector_base.6"* %3, i32 0, i32 0
  %5 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl", %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %4, i32 0, i32 0
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorIiE7destroyIiEEvPT_(%"class.__gnu_cxx::new_allocator.8"* %0, i32* %1) #5 comdat align 2 {
  ret void
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorIiE9constructIiJRKiEEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator.8"* %0, i32* %1, i32* dereferenceable(4) %2) #5 comdat align 2 {
  %4 = bitcast i32* %1 to i8*
  %5 = bitcast i8* %4 to i32*
...
; Function Attrs: noinline uwtable
define linkonce_odr %"struct.std::pair"* @_ZSt13__upper_boundIN9__gnu_cxx17__normal_iteratorIPSt4pairIiiESt6vectorIS3_SaIS3_EEEES3_NS0_5__ops14_Val_less_iterEET_SB_SB_RKT0_T1_(%"struct.std::pair"* %0, %"struct.std::pair"* %1, %"struct.std::pair"* dereferenceable(8) %2) #0 comdat {
  %4 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %5 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %6 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
...
25:                                               ; preds = %23
  ...
  %32 = load %"struct.std::pair"*, %"struct.std::pair"** %31, align 8
  %33 = call zeroext i1 @_ZNK9__gnu_cxx5__ops14_Val_less_iterclIKSt4pairIiiENS_17__normal_iteratorIPS4_St6vectorIS4_SaIS4_EEEEEEbRT_T0_(%"struct.__gnu_cxx::__ops::_Val_less_iter"* %7, %"struct.std::pair"* dereferenceable(8) %2, %"struct.std::pair"* %32)
...
35:                                               ; preds = %25
  ...
  %38 = call dereferenceable(8) %"class.__gnu_cxx::__normal_iterator"* @_ZN9__gnu_cxx17__normal_iteratorIPSt4pairIiiESt6vectorIS2_SaIS2_EEEppEv(%"class.__gnu_cxx::__normal_iterator"* %5) #3
  %39 = sub nsw i64 %.0, %26
  %40 = sub nsw i64 %39, 1
  br label %41
...
; Function Attrs: noinline uwtable
define linkonce_odr zeroext i1 @_ZNK9__gnu_cxx5__ops14_Val_less_iterclIKSt4pairIiiENS_17__normal_iteratorIPS4_St6vectorIS4_SaIS4_EEEEEEbRT_T0_(%"struct.__gnu_cxx::__ops::_Val_less_iter"* %0, %"struct.std::pair"* dereferenceable(8) %1, %"struct.std::pair"* %2) #0 comdat align 2 {
  %4 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64 @_ZSt10__distanceIN9__gnu_cxx17__normal_iteratorIPSt4pairIiiESt6vectorIS3_SaIS3_EEEEENSt15iterator_traitsIT_E15difference_typeESA_SA_St26random_access_iterator_tag(%"struct.std::pair"* %0, %"struct.std::pair"* %1) #5 comdat {
  %3 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %4 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZSt19__iterator_categoryIN9__gnu_cxx17__normal_iteratorIPSt4pairIiiESt6vectorIS3_SaIS3_EEEEENSt15iterator_traitsIT_E17iterator_categoryERKSA_(%"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %0) #5 comdat {
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZSt9__advanceIN9__gnu_cxx17__normal_iteratorIPSt4pairIiiESt6vectorIS3_SaIS3_EEEElEvRT_T0_St26random_access_iterator_tag(%"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %0, i64 %1) #5 comdat {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(8) %"class.__gnu_cxx::__normal_iterator"* @_ZN9__gnu_cxx17__normal_iteratorIPSt4pairIiiESt6vectorIS2_SaIS2_EEEpLEl(%"class.__gnu_cxx::__normal_iterator"* %0, i64 %1) #5 comdat align 2 {
  %3 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %0, i32 0, i32 0
  %4 = load %"struct.std::pair"*, %"struct.std::pair"** %3, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s440417343.cpp() #0 section ".text.startup" {
