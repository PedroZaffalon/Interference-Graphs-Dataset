; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03198/s946954229.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03198/s946954229.c"
...
@dpposi = common global [1000000 x i64] zeroinitializer, align 16
@n = common global i64 0, align 8
@a = common global [1000005 x i64] zeroinitializer, align 16
@dpnega = common global [1000000 x i64] zeroinitializer, align 16
...
define i64 @solve() #0 {
  ...
  %2 = sub i64 %1, 1
  %3 = getelementptr inbounds [1000000 x i64], [1000000 x i64]* @dpposi, i64 0, i64 %2
...
8:                                                ; preds = %6
  ...
  %11 = sub i64 %10, %.0
  %12 = add nsw i64 %.0, 1
  %13 = getelementptr inbounds [1000000 x i64], [1000000 x i64]* @dpposi, i64 0, i64 %12
  %14 = load i64, i64* %13, align 8
  %15 = getelementptr inbounds [1000005 x i64], [1000005 x i64]* @a, i64 0, i64 %.0
  %16 = load i64, i64* %15, align 8
  %17 = add nsw i64 %.0, 1
  %18 = getelementptr inbounds [1000005 x i64], [1000005 x i64]* @a, i64 0, i64 %17
  %19 = load i64, i64* %18, align 8
  %20 = call i64 @f(i64 %16, i64 %19)
  %21 = mul i64 %11, %20
  %22 = add i64 %14, %21
  %23 = getelementptr inbounds [1000000 x i64], [1000000 x i64]* @dpposi, i64 0, i64 %.0
...
26:                                               ; preds = %6
  store i64 0, i64* getelementptr inbounds ([1000000 x i64], [1000000 x i64]* @dpnega, i64 0, i64 0), align 16
  br label %27

27:                                               ; preds = %43, %26
  %.1 = phi i64 [ 1, %26 ], [ %44, %43 ]
...
30:                                               ; preds = %27
  %31 = sub nsw i64 %.1, 1
  %32 = getelementptr inbounds [1000000 x i64], [1000000 x i64]* @dpnega, i64 0, i64 %31
  %33 = load i64, i64* %32, align 8
  %34 = getelementptr inbounds [1000005 x i64], [1000005 x i64]* @a, i64 0, i64 %.1
  %35 = load i64, i64* %34, align 8
  %36 = sub nsw i64 %.1, 1
  %37 = getelementptr inbounds [1000005 x i64], [1000005 x i64]* @a, i64 0, i64 %36
  %38 = load i64, i64* %37, align 8
  %39 = call i64 @f(i64 %35, i64 %38)
  %40 = mul i64 %.1, %39
  %41 = add i64 %33, %40
  %42 = getelementptr inbounds [1000000 x i64], [1000000 x i64]* @dpnega, i64 0, i64 %.1
...
46:                                               ; preds = %69, %45
  %.03 = phi i64 [ 2000000000000007, %45 ], [ %.14, %69 ]
...
51:                                               ; preds = %49
  %52 = sub nsw i64 %.2, 1
  %53 = getelementptr inbounds [1000000 x i64], [1000000 x i64]* @dpnega, i64 0, i64 %52
...
57:                                               ; preds = %51, %49
  %.01 = phi i64 [ %56, %51 ], [ %.2, %49 ]
  %58 = load i64, i64* @n, align 8
  %59 = icmp ult i64 %.2, %58
  br i1 %59, label %60, label %65

60:                                               ; preds = %57
  %61 = getelementptr inbounds [1000000 x i64], [1000000 x i64]* @dpposi, i64 0, i64 %.2
...
65:                                               ; preds = %60, %57
  %.12 = phi i64 [ %64, %60 ], [ %.01, %57 ]
  %66 = icmp slt i64 %.12, %.03
...
71:                                               ; preds = %46
  %72 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i32 0, i32 0), i64 %.03)
  br label %77
