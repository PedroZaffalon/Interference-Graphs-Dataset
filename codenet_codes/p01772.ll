; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01772/s420152172.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01772/s420152172.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s420152172.cpp, i8* null }]
...
37:                                               ; preds = %34, %32
  %.1 = phi i32 [ %33, %32 ], [ %.01, %34 ]
  br label %38

38:                                               ; preds = %37, %23
  %.2 = phi i32 [ %.1, %37 ], [ %.01, %23 ]
  %39 = srem i32 %.2, 2
  %40 = icmp eq i32 %39, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s420152172.cpp() #0 section ".text.startup" {
