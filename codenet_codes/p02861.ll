; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02861/s850123095.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02861/s850123095.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s850123095.cpp, i8* null }]
...
define i32 @main() #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  invoke void @_ZNSt6vectorIdSaIdEEC2EmRKS0_(%"class.std::vector"* %2, i64 %7, %"class.std::allocator"* dereferenceable(1) %3)
...
8:                                                ; preds = %0
  ...
  invoke void @_ZNSt6vectorIdSaIdEEC2EmRKS0_(%"class.std::vector"* %4, i64 %9, %"class.std::allocator"* dereferenceable(1) %5)
...
11:                                               ; preds = %21, %10
  %.03 = phi i64 [ 0, %10 ], [ %22, %21 ]
  %12 = load i64, i64* %1, align 8
  %13 = icmp slt i64 %.03, %12
  br i1 %13, label %14, label %35

14:                                               ; preds = %11
  %15 = call dereferenceable(8) double* @_ZNSt6vectorIdSaIdEEixEm(%"class.std::vector"* %2, i64 %.03) #3
  %16 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERd(%"class.std::basic_istream"* @_ZSt3cin, double* dereferenceable(8) %15)
          to label %17 unwind label %31

17:                                               ; preds = %14
  %18 = call dereferenceable(8) double* @_ZNSt6vectorIdSaIdEEixEm(%"class.std::vector"* %4, i64 %.03) #3
  %19 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERd(%"class.std::basic_istream"* %16, double* dereferenceable(8) %18)
...
36:                                               ; preds = %64, %35
  %.06 = phi i64 [ 0, %35 ], [ %65, %64 ]
  %.04 = phi double [ 0.000000e+00, %35 ], [ %.15, %64 ]
  %37 = load i64, i64* %1, align 8
  %38 = icmp slt i64 %.06, %37
...
40:                                               ; preds = %61, %39
  %.07 = phi i64 [ 0, %39 ], [ %62, %61 ]
  %.15 = phi double [ %.04, %39 ], [ %60, %61 ]
  %41 = load i64, i64* %1, align 8
  %42 = icmp slt i64 %.07, %41
  br i1 %42, label %43, label %63

43:                                               ; preds = %40
  %44 = call dereferenceable(8) double* @_ZNSt6vectorIdSaIdEEixEm(%"class.std::vector"* %2, i64 %.06) #3
  %45 = load double, double* %44, align 8
  %46 = call dereferenceable(8) double* @_ZNSt6vectorIdSaIdEEixEm(%"class.std::vector"* %2, i64 %.07) #3
  %47 = load double, double* %46, align 8
  %48 = fsub double %45, %47
  %49 = invoke double @_ZSt3powIdiEN9__gnu_cxx11__promote_2IT_T0_NS0_9__promoteIS2_Xsr3std12__is_integerIS2_EE7__valueEE6__typeENS4_IS3_Xsr3std12__is_integerIS3_EE7__valueEE6__typeEE6__typeES2_S3_(double %48, i32 2)
          to label %50 unwind label %31

50:                                               ; preds = %43
  %51 = call dereferenceable(8) double* @_ZNSt6vectorIdSaIdEEixEm(%"class.std::vector"* %4, i64 %.06) #3
  %52 = load double, double* %51, align 8
  %53 = call dereferenceable(8) double* @_ZNSt6vectorIdSaIdEEixEm(%"class.std::vector"* %4, i64 %.07) #3
  %54 = load double, double* %53, align 8
  %55 = fsub double %52, %54
  %56 = invoke double @_ZSt3powIdiEN9__gnu_cxx11__promote_2IT_T0_NS0_9__promoteIS2_Xsr3std12__is_integerIS2_EE7__valueEE6__typeENS4_IS3_Xsr3std12__is_integerIS3_EE7__valueEE6__typeEE6__typeES2_S3_(double %55, i32 2)
          to label %57 unwind label %31

57:                                               ; preds = %50
  %58 = fadd double %49, %56
  %59 = call double @sqrt(double %58) #3
  %60 = fadd double %.15, %59
  br label %61
...
66:                                               ; preds = %36
  ...
  %69 = fdiv double %.04, %68
  %70 = invoke i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i32 0, i32 0), double %69)
...
73:                                               ; preds = %72, %23
  %.12 = phi i32 [ %.01, %72 ], [ %26, %23 ]
  %.1 = phi i8* [ %.0, %72 ], [ %25, %23 ]
  %74 = insertvalue { i8*, i32 } undef, i8* %.1, 0
  %75 = insertvalue { i8*, i32 } %74, i32 %.12, 1
  resume { i8*, i32 } %75
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s850123095.cpp() #0 section ".text.startup" {
