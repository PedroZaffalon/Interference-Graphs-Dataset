; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01945/s421979200.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01945/s421979200.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s421979200.cpp, i8* null }]
...
43:                                               ; preds = %42, %28
  %.1 = phi i32 [ %29, %28 ], [ %.02, %42 ]
  br label %44

44:                                               ; preds = %43, %15
  %.2 = phi i32 [ %16, %15 ], [ %.1, %43 ]
  br label %45
...
49:                                               ; preds = %17
  %50 = insertvalue { i8*, i32 } undef, i8* %19, 0
  %51 = insertvalue { i8*, i32 } %50, i32 %20, 1
  resume { i8*, i32 } %51
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s421979200.cpp() #0 section ".text.startup" {
