; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02782/s653347126.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02782/s653347126.c"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

@factorial = common global [4194304 x i64] zeroinitializer, align 16
@invfact = common global [4194304 x i64] zeroinitializer, align 16
...
; Function Attrs: noinline nounwind uwtable
define void @cfact() #0 {
  store i64 1, i64* getelementptr inbounds ([4194304 x i64], [4194304 x i64]* @factorial, i64 0, i64 0), align 16
  store i64 1, i64* getelementptr inbounds ([4194304 x i64], [4194304 x i64]* @factorial, i64 0, i64 1), align 8
  br label %1

1:                                                ; preds = %12, %0
  %.0 = phi i64 [ 2, %0 ], [ %13, %12 ]
  %2 = icmp slt i64 %.0, 4194304
  br i1 %2, label %3, label %14

3:                                                ; preds = %1
  %4 = sub nsw i64 %.0, 1
  %5 = getelementptr inbounds [4194304 x i64], [4194304 x i64]* @factorial, i64 0, i64 %4
  %6 = load i64, i64* %5, align 8
  %7 = mul nsw i64 %6, %.0
  %8 = getelementptr inbounds [4194304 x i64], [4194304 x i64]* @factorial, i64 0, i64 %.0
  store i64 %7, i64* %8, align 8
  %9 = getelementptr inbounds [4194304 x i64], [4194304 x i64]* @factorial, i64 0, i64 %.0
...
14:                                               ; preds = %1
  %15 = load i64, i64* getelementptr inbounds ([4194304 x i64], [4194304 x i64]* @factorial, i64 0, i64 4194303), align 8
  %16 = call i64 @modular_inverse(i64 %15)
  store i64 %16, i64* getelementptr inbounds ([4194304 x i64], [4194304 x i64]* @invfact, i64 0, i64 4194303), align 8
  br label %17

17:                                               ; preds = %29, %14
  %.1 = phi i64 [ 4194302, %14 ], [ %30, %29 ]
  %18 = icmp sge i64 %.1, 0
  br i1 %18, label %19, label %31

19:                                               ; preds = %17
  %20 = add nsw i64 %.1, 1
  %21 = getelementptr inbounds [4194304 x i64], [4194304 x i64]* @invfact, i64 0, i64 %20
  %22 = load i64, i64* %21, align 8
  %23 = add nsw i64 %.1, 1
  %24 = mul nsw i64 %22, %23
  %25 = getelementptr inbounds [4194304 x i64], [4194304 x i64]* @invfact, i64 0, i64 %.1
  store i64 %24, i64* %25, align 8
  %26 = getelementptr inbounds [4194304 x i64], [4194304 x i64]* @invfact, i64 0, i64 %.1
...
7:                                                ; preds = %4
  ...
  %10 = getelementptr inbounds [4194304 x i64], [4194304 x i64]* @invfact, i64 0, i64 %1
  %11 = load i64, i64* %10, align 8
  %12 = sub nsw i64 %0, %1
  %13 = getelementptr inbounds [4194304 x i64], [4194304 x i64]* @invfact, i64 0, i64 %12
...
define i32 @main() #0 {
  ...
  call void @cfact()
  %5 = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str, i32 0, i32 0), i64* %1, i64* %3, i64* %2, i64* %4)
  %6 = load i64, i64* %1, align 8
  br label %7

7:                                                ; preds = %25, %0
  %.01 = phi i64 [ %6, %0 ], [ %26, %25 ]
  %.0 = phi i64 [ 0, %0 ], [ %24, %25 ]
...
10:                                               ; preds = %7
  ...
  %15 = call i64 @calcnCr(i64 %13, i64 %14)
  %16 = add nsw i64 %.0, %15
  %17 = add nsw i64 %16, 1000000007
  %18 = load i64, i64* %3, align 8
  %19 = add nsw i64 %.01, %18
  %20 = load i64, i64* %3, align 8
  %21 = sub nsw i64 %20, 1
  %22 = call i64 @calcnCr(i64 %19, i64 %21)
...
27:                                               ; preds = %7
  %28 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i32 0, i32 0), i64 %.0)
  ret i32 0
}
