; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02030/s865773670.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02030/s865773670.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s865773670.cpp, i8* null }]
...
define i32 @main() #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %10 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i32 0, i32 0), i32* %1, i32* %2)
...
21:                                               ; preds = %18
  ...
  %24 = invoke i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i32 0, i32 0), i32* %23)
...
28:                                               ; preds = %177, %163, %152, %78, %64, %36, %21
...
36:                                               ; preds = %33
  ...
  %39 = invoke i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i32 0, i32 0), i32* %38)
...
44:                                               ; preds = %151, %43
  %.02 = phi i32 [ 0, %43 ], [ %.13, %151 ]
  %.0 = phi i32 [ 0, %43 ], [ %.1, %151 ]
...
152:                                              ; preds = %50
  ...
  %155 = invoke i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i32 0, i32 0), i64 %153, i64 %154)
...
159:                                              ; preds = %168, %156
  ...
  %162 = call zeroext i1 @_ZN9__gnu_cxxneIPiSt6vectorIiSaIiEEEEbRKNS_17__normal_iteratorIT_T0_EESA_(%"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %6, %"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %7) #3
...
163:                                              ; preds = %159
  ...
  %166 = invoke i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i32 0, i32 0), i32 %165)
...
170:                                              ; preds = %159
  %171 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector"* %4) #3
  %172 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %8, i32 0, i32 0
  store i32* %171, i32** %172, align 8
  br label %173

173:                                              ; preds = %182, %170
  %174 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector"* %4) #3
  %175 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %9, i32 0, i32 0
  store i32* %174, i32** %175, align 8
  %176 = call zeroext i1 @_ZN9__gnu_cxxneIPiSt6vectorIiSaIiEEEEbRKNS_17__normal_iteratorIT_T0_EESA_(%"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %8, %"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %9) #3
...
177:                                              ; preds = %173
  ...
  %180 = invoke i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i32 0, i32 0), i32 %179)
...
185:                                              ; preds = %28
  %186 = insertvalue { i8*, i32 } undef, i8* %30, 0
  %187 = insertvalue { i8*, i32 } %186, i32 %31, 1
  resume { i8*, i32 } %187
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s865773670.cpp() #0 section ".text.startup" {
