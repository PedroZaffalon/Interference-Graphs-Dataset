; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00972/s562045880.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00972/s562045880.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s562045880.cpp, i8* null }]
...
16:                                               ; preds = %13
  ...
  %18 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* @G, i64 0, i64 %17
...
24:                                               ; preds = %16
  ...
  %26 = getelementptr inbounds [10000 x i32], [10000 x i32]* @used, i64 0, i64 %25
...
30:                                               ; preds = %24
  ...
  %32 = getelementptr inbounds [10000 x i32], [10000 x i32]* @used, i64 0, i64 %31
  store i32 1, i32* %32, align 4
  %33 = sext i32 %.04 to i64
  %34 = getelementptr inbounds [100 x i32], [100 x i32]* @visited, i64 0, i64 %33
...
39:                                               ; preds = %37, %30
  %.03 = phi i32 [ %38, %37 ], [ %1, %30 ]
  %40 = sext i32 %.04 to i64
  %41 = getelementptr inbounds [100 x i32], [100 x i32]* @visited, i64 0, i64 %40
  store i32 1, i32* %41, align 4
  %42 = add nsw i32 %2, 1
  %43 = call zeroext i1 @_Z3dfsiii(i32 %.04, i32 %.03, i32 %42)
...
60:                                               ; preds = %52
  ...
  %62 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* @G, i64 0, i64 %61
  %63 = sext i32 %.02 to i64
  %64 = getelementptr inbounds [100 x i32], [100 x i32]* %62, i64 0, i64 %63
  store i32 -2, i32* %64, align 4
  %65 = sext i32 %.02 to i64
  %66 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* @G, i64 0, i64 %65
  %67 = sext i32 %0 to i64
  %68 = getelementptr inbounds [100 x i32], [100 x i32]* %66, i64 0, i64 %67
  store i32 -2, i32* %68, align 4
  %69 = sext i32 %.02 to i64
  %70 = getelementptr inbounds [100 x i32], [100 x i32]* @visited, i64 0, i64 %69
...
84:                                               ; preds = %83, %80, %79, %45, %44, %11
  %.0 = phi i1 [ true, %11 ], [ true, %44 ], [ false, %45 ], [ true, %79 ], [ false, %80 ], [ false, %83 ]
  ret i1 %.0
}
...
define i32 @main() #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  call void @llvm.memset.p0i8.i64(i8* align 16 bitcast ([100 x [100 x i32]]* @G to i8*), i8 -1, i64 40000, i1 false)
...
33:                                               ; preds = %9
  %34 = call zeroext i1 @_Z3dfsiii(i32 0, i32 0, i32 0)
  %35 = zext i1 %34 to i8
...
64:                                               ; preds = %100, %94, %92, %86, %79, %76, %62, %61
...
107:                                              ; preds = %64
  %108 = insertvalue { i8*, i32 } undef, i8* %66, 0
  %109 = insertvalue { i8*, i32 } %108, i32 %67, 1
  resume { i8*, i32 } %109
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s562045880.cpp() #0 section ".text.startup" {
