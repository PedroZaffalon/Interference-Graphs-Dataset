; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02430/s054635718.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02430/s054635718.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s054635718.cpp, i8* null }]
...
65:                                               ; preds = %47
  %66 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* %5) #3
...
70:                                               ; preds = %65
  %71 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %.03)
          to label %72 unwind label %58

72:                                               ; preds = %70
  %73 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(%"class.std::basic_ostream"* dereferenceable(272) %71, i8 signext 58)
...
79:                                               ; preds = %88, %74
  %80 = call zeroext i1 @_ZN9__gnu_cxxneIPiSt6vectorIiSaIiEEEEbRKNS_17__normal_iteratorIT_T0_EESA_(%"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %6, %"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %7) #3
...
81:                                               ; preds = %79
  ...
  %84 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8 signext 32)
          to label %85 unwind label %58

85:                                               ; preds = %81
  %86 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %84, i32 %83)
...
97:                                               ; preds = %58, %37
  %.01 = phi i32 [ %61, %58 ], [ %40, %37 ]
  %.0 = phi i8* [ %60, %58 ], [ %39, %37 ]
  %98 = insertvalue { i8*, i32 } undef, i8* %.0, 0
  %99 = insertvalue { i8*, i32 } %98, i32 %.01, 1
  resume { i8*, i32 } %99
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s054635718.cpp() #0 section ".text.startup" {
