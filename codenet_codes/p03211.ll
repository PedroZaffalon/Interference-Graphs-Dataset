; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03211/s564434191.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03211/s564434191.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s564434191.cpp, i8* null }]
...
46:                                               ; preds = %6
  %47 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %.01)
...
51:                                               ; preds = %39
  %52 = insertvalue { i8*, i32 } undef, i8* %41, 0
  %53 = insertvalue { i8*, i32 } %52, i32 %42, 1
  resume { i8*, i32 } %53
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s564434191.cpp() #0 section ".text.startup" {
