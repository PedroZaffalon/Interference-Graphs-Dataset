; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01086/s291392549.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01086/s291392549.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s291392549.cpp, i8* null }]
...
15:                                               ; preds = %13
  invoke void @_ZNSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EE9push_backERKS5_(%"class.std::vector"* %3, %"class.std::__cxx11::basic_string"* dereferenceable(32) %2)
...
28:                                               ; preds = %105, %101, %87, %73, %59, %45, %27
  %.18 = phi i32 [ %.07, %27 ], [ %32, %45 ], [ %32, %59 ], [ %32, %73 ], [ %32, %87 ], [ %32, %101 ], [ %32, %105 ]
  %.1 = phi i32 [ 0, %27 ], [ %32, %45 ], [ %32, %59 ], [ %32, %73 ], [ %32, %87 ], [ %32, %101 ], [ %.6, %105 ]
...
33:                                               ; preds = %35, %31
  %.02 = phi i32 [ 0, %31 ], [ %41, %35 ]
  %.2 = phi i32 [ %.1, %31 ], [ %42, %35 ]
  %34 = icmp slt i32 %.02, 5
...
47:                                               ; preds = %49, %46
  %.13 = phi i32 [ 0, %46 ], [ %55, %49 ]
  %.3 = phi i32 [ %.2, %46 ], [ %56, %49 ]
  %48 = icmp slt i32 %.13, 7
...
61:                                               ; preds = %63, %60
  %.24 = phi i32 [ 0, %60 ], [ %69, %63 ]
  %.4 = phi i32 [ %.3, %60 ], [ %70, %63 ]
  %62 = icmp slt i32 %.24, 5
  br i1 %62, label %63, label %71

63:                                               ; preds = %61
  %64 = sext i32 %.4 to i64
  %65 = call dereferenceable(32) %"class.std::__cxx11::basic_string"* @_ZNSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EEixEm(%"class.std::vector"* %3, i64 %64) #3
...
75:                                               ; preds = %77, %74
  %.35 = phi i32 [ 0, %74 ], [ %83, %77 ]
  %.5 = phi i32 [ %.4, %74 ], [ %84, %77 ]
  %76 = icmp slt i32 %.35, 7
...
89:                                               ; preds = %91, %88
  %.46 = phi i32 [ 0, %88 ], [ %97, %91 ]
  %.6 = phi i32 [ %.5, %88 ], [ %98, %91 ]
  %90 = icmp slt i32 %.46, 7
...
106:                                              ; preds = %104, %28
  %.29 = phi i32 [ %32, %104 ], [ %.18, %28 ]
  %107 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %.29)
...
112:                                              ; preds = %23, %19
  %.010 = phi i8* [ %25, %23 ], [ %21, %19 ]
  %.01 = phi i32 [ %26, %23 ], [ %22, %19 ]
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED1Ev(%"class.std::__cxx11::basic_string"* %2) #3
  br label %113

113:                                              ; preds = %112
  %114 = insertvalue { i8*, i32 } undef, i8* %.010, 0
...
define linkonce_odr void @_ZNSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EE17_M_realloc_insertIJRKS5_EEEvN9__gnu_cxx17__normal_iteratorIPS5_S7_EEDpOT_(%"class.std::vector"* %0, %"class.std::__cxx11::basic_string"* %1, %"class.std::__cxx11::basic_string"* dereferenceable(32) %2) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %7 = call i64 @_ZNKSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EE12_M_check_lenEmPKc(%"class.std::vector"* %0, i64 1, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str, i32 0, i32 0))
  %8 = bitcast %"class.std::vector"* %0 to %"struct.std::_Vector_base"*
  %9 = getelementptr inbounds %"struct.std::_Vector_base", %"struct.std::_Vector_base"* %8, i32 0, i32 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s291392549.cpp() #0 section ".text.startup" {
