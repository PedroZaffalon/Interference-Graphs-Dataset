; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03482/s352503452.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03482/s352503452.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s352503452.cpp, i8* null }]
...
22:                                               ; preds = %18
  ...
  %26 = invoke dereferenceable(8) i64* @_ZSt3maxIxERKT_S2_S2_(i64* dereferenceable(8) %3, i64* dereferenceable(8) %4)
          to label %27 unwind label %31

27:                                               ; preds = %22
  %28 = invoke dereferenceable(8) i64* @_ZSt3minIxERKT_S2_S2_(i64* dereferenceable(8) %2, i64* dereferenceable(8) %26)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s352503452.cpp() #0 section ".text.startup" {
