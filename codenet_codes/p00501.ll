; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00501/s213738703.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00501/s213738703.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s213738703.cpp, i8* null }]
...
10:                                               ; preds = %82, %9
  %.06 = phi i32 [ 0, %9 ], [ %83, %82 ]
  %.04 = phi i32 [ 0, %9 ], [ %.15, %82 ]
...
33:                                               ; preds = %29
  %34 = mul nsw i32 %.09, %.08
  %35 = add nsw i32 %.07, %34
...
44:                                               ; preds = %39
  ...
  %46 = invoke dereferenceable(32) %"class.std::__cxx11::basic_string"* @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEpLEc(%"class.std::__cxx11::basic_string"* %4, i8 signext %45)
          to label %47 unwind label %56

47:                                               ; preds = %44
  br label %60

48:                                               ; preds = %86, %84, %13, %7, %0
...
63:                                               ; preds = %29
  %64 = call zeroext i1 @_ZSteqIcEN9__gnu_cxx11__enable_ifIXsr9__is_charIT_EE7__valueEbE6__typeERKNSt7__cxx1112basic_stringIS2_St11char_traitsIS2_ESaIS2_EEESC_(%"class.std::__cxx11::basic_string"* dereferenceable(32) %2, %"class.std::__cxx11::basic_string"* dereferenceable(32) %4) #3
...
84:                                               ; preds = %10
  %85 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %.04)
...
89:                                               ; preds = %56, %52, %48
  %.03 = phi i32 [ %59, %56 ], [ %55, %52 ], [ %51, %48 ]
  %.02 = phi i8* [ %58, %56 ], [ %54, %52 ], [ %50, %48 ]
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED1Ev(%"class.std::__cxx11::basic_string"* %3) #3
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED1Ev(%"class.std::__cxx11::basic_string"* %2) #3
  br label %90

90:                                               ; preds = %89
  %91 = insertvalue { i8*, i32 } undef, i8* %.02, 0
  %92 = insertvalue { i8*, i32 } %91, i32 %.03, 1
  resume { i8*, i32 } %92
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s213738703.cpp() #0 section ".text.startup" {
