; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01238/s980338156.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01238/s980338156.cpp"
...
@.str = private unnamed_addr constant [21 x i8] c"den*den-d*num*num==1\00", align 1
@.str.1 = private unnamed_addr constant [71 x i8] c"/home/pedro/tcc/exDataset/codenet/data/selection/p01238/s980338156.cpp\00", align 1
@__PRETTY_FUNCTION__._Z16fundamental_unitx = private unnamed_addr constant [27 x i8] c"pll fundamental_unit(lint)\00", align 1
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s980338156.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define { i64, i64 } @_Z16fundamental_unitx(i64 %0) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %13 = invoke double @_ZSt4sqrtIxEN9__gnu_cxx11__enable_ifIXsr12__is_integerIT_EE7__valueEdE6__typeES2_(i64 %0)
          to label %14 unwind label %24

14:                                               ; preds = %1
  %15 = call double @llvm.floor.f64(double %13)
...
18:                                               ; preds = %17
  invoke void @_ZNSt4pairIxxEC2IRxS2_Lb1EEEOT_OT0_(%"struct.std::pair"* %7, i64* dereferenceable(8) %4, i64* dereferenceable(8) %5)
          to label %19 unwind label %28

19:                                               ; preds = %18
  %20 = invoke i64 @_ZNKSt3setISt4pairIxxESt4lessIS1_ESaIS1_EE5countERKS1_(%"class.std::set"* %6, %"struct.std::pair"* dereferenceable(16) %7)
...
32:                                               ; preds = %21
  invoke void @_ZNSt4pairIxxEC2IRxS2_Lb1EEEOT_OT0_(%"struct.std::pair"* %8, i64* dereferenceable(8) %4, i64* dereferenceable(8) %5)
          to label %33 unwind label %28

33:                                               ; preds = %32
  %34 = invoke { %"struct.std::_Rb_tree_node_base"*, i8 } @_ZNSt3setISt4pairIxxESt4lessIS1_ESaIS1_EE6insertEOS1_(%"class.std::set"* %6, %"struct.std::pair"* dereferenceable(16) %8)
          to label %35 unwind label %28

35:                                               ; preds = %33
  %36 = bitcast %"struct.std::pair.3"* %9 to { %"struct.std::_Rb_tree_node_base"*, i8 }*
...
110:                                              ; preds = %99
  call void @__assert_fail(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([71 x i8], [71 x i8]* @.str.1, i32 0, i32 0), i32 37, i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__PRETTY_FUNCTION__._Z16fundamental_unitx, i32 0, i32 0)) #14
  unreachable
...
112:                                              ; preds = %111, %109
  invoke void @_ZNSt4pairIxxEC2IRxS2_Lb1EEEOT_OT0_(%"struct.std::pair"* %2, i64* dereferenceable(8) %12, i64* dereferenceable(8) %11)
          to label %113 unwind label %28

113:                                              ; preds = %112
  call void @_ZNSt3setISt4pairIxxESt4lessIS1_ESaIS1_EED2Ev(%"class.std::set"* %6) #3
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %3) #3
  %114 = bitcast %"struct.std::pair"* %2 to { i64, i64 }*
  %115 = load { i64, i64 }, { i64, i64 }* %114, align 8
  ret { i64, i64 } %115

116:                                              ; preds = %28, %24
  %.02 = phi i8* [ %30, %28 ], [ %26, %24 ]
  %.01 = phi i32 [ %31, %28 ], [ %27, %24 ]
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %3) #3
  br label %117

117:                                              ; preds = %116
  %118 = insertvalue { i8*, i32 } undef, i8* %.02, 0
  %119 = insertvalue { i8*, i32 } %118, i32 %.01, 1
  resume { i8*, i32 } %119
}
...
; Function Attrs: noinline uwtable
define { i64, i64 } @_Z5solvex(i64 %0) #0 {
  %2 = alloca %"struct.std::pair", align 8
...
15:                                               ; preds = %8
  ...
  call void @_ZNSt4pairIxxEC2IRiiLb1EEEOT_OT0_(%"struct.std::pair"* %2, i32* dereferenceable(4) %3, i32* dereferenceable(4) %4)
  br label %28
...
20:                                               ; preds = %5
  %21 = mul nsw i64 2, %0
  %22 = call { i64, i64 } @_Z16fundamental_unitx(i64 %21)
  %23 = bitcast %"struct.std::pair"* %2 to { i64, i64 }*
...
28:                                               ; preds = %20, %15
  %29 = bitcast %"struct.std::pair"* %2 to { i64, i64 }*
...
8:                                                ; preds = %3
  ...
  %10 = call { i64, i64 } @_Z5solvex(i64 %9)
  %11 = bitcast %"struct.std::pair"* %2 to { i64, i64 }*
  ...
  %17 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %16, i32 %.0)
  %18 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %17, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i32 0, i32 0))
  ...
  %23 = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* %2, i32 0, i32 1
  %24 = load i64, i64* %23, align 8
  %25 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEx(%"class.std::basic_ostream"* %22, i64 %24)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s980338156.cpp() #0 section ".text.startup" {
