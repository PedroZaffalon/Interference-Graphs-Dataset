; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00712/s518198976.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00712/s518198976.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s518198976.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define i64 @_Z4calcxxxxx(i64 %0, i64 %1, i64 %2, i64 %3, i64 %4) #0 {
...
9:                                                ; preds = %5
  %10 = call i64 @_Z3gcdxx(i64 %0, i64 %1)
  %11 = sdiv i64 %0, %10
  %12 = sdiv i64 %1, %10
  %13 = icmp eq i64 %11, 1
...
24:                                               ; preds = %43, %23
  %.2 = phi i64 [ %.1, %23 ], [ %.3, %43 ]
  %.01 = phi i64 [ %4, %23 ], [ %44, %43 ]
  %25 = mul nsw i64 %.01, %.01
  %26 = mul nsw i64 %25, %2
...
29:                                               ; preds = %24
  %30 = mul nsw i64 %11, %.01
  %31 = sub nsw i64 %30, %12
  %32 = mul nsw i64 %12, %.01
...
35:                                               ; preds = %29
  %36 = call i64 @_Z3gcdxx(i64 %31, i64 %32)
  %37 = sdiv i64 %31, %36
  %38 = sdiv i64 %32, %36
  %39 = mul nsw i64 %2, %.01
  %40 = add nsw i64 %3, 1
  %41 = call i64 @_Z4calcxxxxx(i64 %37, i64 %38, i64 %39, i64 %40, i64 %.01)
  %42 = add nsw i64 %.2, %41
  br label %43

43:                                               ; preds = %35, %34
  %.3 = phi i64 [ %.2, %34 ], [ %42, %35 ]
  %44 = add nsw i64 %.01, 1
  br label %24
...
9:                                                ; preds = %23, %0
  %10 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERx(%"class.std::basic_istream"* @_ZSt3cin, i64* dereferenceable(8) @p)
...
23:                                               ; preds = %9
  ...
  %26 = call i64 @_Z4calcxxxxx(i64 %24, i64 %25, i64 1, i64 1, i64 1)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s518198976.cpp() #0 section ".text.startup" {
