; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03319/s581779907.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03319/s581779907.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s581779907.cpp, i8* null }]
...
48:                                               ; preds = %50, %47
  %.04 = phi i32 [ %.01, %47 ], [ %53, %50 ]
  %.0 = phi i32 [ 0, %47 ], [ %54, %50 ]
  %49 = icmp ne i32 %.04, 0
...
56:                                               ; preds = %60, %55
  %.2 = phi i32 [ %.01, %55 ], [ %63, %60 ]
  %.1 = phi i32 [ %.0, %55 ], [ %64, %60 ]
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s581779907.cpp() #0 section ".text.startup" {
