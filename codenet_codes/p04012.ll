; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p04012/s492816043.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p04012/s492816043.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s492816043.cpp, i8* null }]
...
41:                                               ; preds = %38
  %42 = invoke i32 @puts(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0))
...
44:                                               ; preds = %38
  %45 = invoke i32 @puts(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i32 0, i32 0))
...
48:                                               ; preds = %21
  %49 = insertvalue { i8*, i32 } undef, i8* %23, 0
  %50 = insertvalue { i8*, i32 } %49, i32 %24, 1
  resume { i8*, i32 } %50
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s492816043.cpp() #0 section ".text.startup" {
