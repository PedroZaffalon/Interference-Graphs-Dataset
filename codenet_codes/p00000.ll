; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00000/s289527151.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00000/s289527151.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s289527151.cpp, i8* null }]
...
6:                                                ; preds = %4
  %7 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %.01)
  ...
  %9 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %8, i32 %.0)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s289527151.cpp() #0 section ".text.startup" {
