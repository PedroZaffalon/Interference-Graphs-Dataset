; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01557/s824322317.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01557/s824322317.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s824322317.cpp, i8* null }]
...
define void @_Z5calcFiRSt6vectorIiSaIiEES2_(i32 %0, %"class.std::vector"* dereferenceable(24) %1, %"class.std::vector"* dereferenceable(24) %2) #4 {
  br label %4
...
6:                                                ; preds = %4
  ...
  %8 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %2, i64 %7) #3
...
39:                                               ; preds = %120, %118, %114, %86, %46, %43, %24
...
43:                                               ; preds = %21
  ...
  invoke void @_Z5calcFiRSt6vectorIiSaIiEES2_(i32 %44, %"class.std::vector"* dereferenceable(24) %2, %"class.std::vector"* dereferenceable(24) %4)
...
46:                                               ; preds = %116, %45
  ...
  %55 = invoke i32 @_ZSt10accumulateIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEiET0_T_S8_S7_(i32* %52, i32* %54, i32 0)
...
61:                                               ; preds = %112, %58
  %.06 = phi i32 [ %60, %58 ], [ %113, %112 ]
  %62 = icmp sge i32 %.06, 1
...
86:                                               ; preds = %81
  ...
  %90 = call i32* @_ZNK9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEplEl(%"class.__gnu_cxx::__normal_iterator"* %10, i64 %89) #3
  ...
  %97 = call i32* @_ZNK9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEplEl(%"class.__gnu_cxx::__normal_iterator"* %13, i64 1) #3
...
107:                                              ; preds = %103, %80, %70
  %.07 = phi i8 [ 0, %80 ], [ 1, %103 ], [ 1, %70 ]
  %108 = trunc i8 %.07 to i1
...
114:                                              ; preds = %109, %61
  ...
  invoke void @_Z5calcFiRSt6vectorIiSaIiEES2_(i32 %115, %"class.std::vector"* dereferenceable(24) %2, %"class.std::vector"* dereferenceable(24) %4)
...
118:                                              ; preds = %56
  %119 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %.05)
...
123:                                              ; preds = %39, %35
  %.02 = phi i32 [ %42, %39 ], [ %38, %35 ]
  %.01 = phi i8* [ %41, %39 ], [ %37, %35 ]
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %2) #3
  br label %124

124:                                              ; preds = %123, %31
  %.13 = phi i32 [ %.02, %123 ], [ %34, %31 ]
  %.1 = phi i8* [ %.01, %123 ], [ %33, %31 ]
  %125 = insertvalue { i8*, i32 } undef, i8* %.1, 0
  %126 = insertvalue { i8*, i32 } %125, i32 %.13, 1
  resume { i8*, i32 } %126
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s824322317.cpp() #0 section ".text.startup" {
