; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02020/s551877043.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02020/s551877043.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s551877043.cpp, i8* null }]
...
60:                                               ; preds = %19
  %61 = insertvalue { i8*, i32 } undef, i8* %21, 0
  %62 = insertvalue { i8*, i32 } %61, i32 %22, 1
  resume { i8*, i32 } %62
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s551877043.cpp() #0 section ".text.startup" {
