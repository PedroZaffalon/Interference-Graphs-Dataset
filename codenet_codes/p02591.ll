; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02591/s123040115.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02591/s123040115.cpp"
...
$_Z6writepIiEvT_ = comdat any

@_ZStL8__ioinit = internal global %"class.std::ios_base::Init" zeroinitializer, align 1
@__dso_handle = external hidden global i8
@n = global i32 0, align 4
@a = global [600005 x i32] zeroinitializer, align 16
@ans = global i32 0, align 4
@sum = global [600005 x i32] zeroinitializer, align 16
@de = global %"class.std::vector" zeroinitializer, align 8
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s123040115.cpp, i8* null }]
...
define internal void @__cxx_global_var_init.1() #0 section ".text.startup" {
  call void @_ZNSt6vectorIiSaIiEEC2Ev(%"class.std::vector"* @de) #3
  %1 = call i32 @__cxa_atexit(void (i8*)* bitcast (void (%"class.std::vector"*)* @_ZNSt6vectorIiSaIiEED2Ev to void (i8*)*), i8* bitcast (%"class.std::vector"* @de to i8*), i8* @__dso_handle) #3
  ret void
}
...
; Function Attrs: noinline uwtable
define void @_Z4Dfs2iib(i32 %0, i32 %1, i1 zeroext %2) #0 {
  %4 = zext i1 %2 to i8
  %5 = icmp eq i32 %0, 1
...
7:                                                ; preds = %3
  %8 = call i32 @_Z3Mulii(i32 %1, i32 %0)
  %9 = trunc i8 %4 to i1
  br i1 %9, label %10, label %17

10:                                               ; preds = %7
  %11 = sext i32 %0 to i64
  %12 = getelementptr inbounds [600005 x i32], [600005 x i32]* @sum, i64 0, i64 %11
  %13 = load i32, i32* %12, align 4
  %14 = call i32 @_Z3Addii(i32 %13, i32 %8)
  %15 = sext i32 %0 to i64
  %16 = getelementptr inbounds [600005 x i32], [600005 x i32]* @sum, i64 0, i64 %15
...
17:                                               ; preds = %7
  ...
  %22 = getelementptr inbounds [600005 x i32], [600005 x i32]* @sum, i64 0, i64 %21
  %23 = load i32, i32* %22, align 4
  %24 = call i32 @_Z3Mulii(i32 %23, i32 %8)
  %25 = call i32 @_Z3Mulii(i32 %19, i32 %24)
  %26 = call i32 @_Z3Addii(i32 %18, i32 %25)
...
27:                                               ; preds = %17, %10
  %28 = ashr i32 %0, 1
  %29 = trunc i8 %4 to i1
  call void @_Z4Dfs2iib(i32 %28, i32 %8, i1 zeroext %29)
  br label %30
...
; Function Attrs: noinline uwtable
define void @_Z4Dfs1iib(i32 %0, i32 %1, i1 zeroext %2) #0 {
  %4 = alloca i32, align 4
  %5 = zext i1 %2 to i8
  %6 = call i32 @_Z3Mulii(i32 %1, i32 %0)
...
9:                                                ; preds = %3
  ...
  %11 = getelementptr inbounds [600005 x i32], [600005 x i32]* @a, i64 0, i64 %10
  %12 = load i32, i32* %11, align 4
  store i32 %12, i32* %4, align 4
  %13 = load i32, i32* %4, align 4
  %14 = trunc i8 %5 to i1
  call void @_Z4Dfs2iib(i32 %13, i32 %6, i1 zeroext %14)
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* @de, i32* dereferenceable(4) %4)
  br label %21

15:                                               ; preds = %3
  %16 = mul nsw i32 2, %0
  %17 = trunc i8 %5 to i1
  call void @_Z4Dfs1iib(i32 %16, i32 %6, i1 zeroext %17)
  %18 = mul nsw i32 2, %0
  %19 = add nsw i32 %18, 1
  %20 = trunc i8 %5 to i1
  call void @_Z4Dfs1iib(i32 %19, i32 %6, i1 zeroext %20)
  br label %21
...
define i32 @main() #5 {
  ...
  %20 = call %struct._IO_FILE* @fopen(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0))
  %21 = icmp ne %struct._IO_FILE* %20, null
  br i1 %21, label %22, label %25

22:                                               ; preds = %0
  %23 = load %struct._IO_FILE*, %struct._IO_FILE** @stdin, align 8
  %24 = call %struct._IO_FILE* @freopen(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0), %struct._IO_FILE* %23)
  br label %25
...
29:                                               ; preds = %47, %25
  %.01 = phi i32 [ 1, %25 ], [ %48, %47 ]
  %30 = load i32, i32* @n, align 4
  %31 = icmp sle i32 %.01, %30
...
32:                                               ; preds = %29
  ...
  %37 = getelementptr inbounds [600005 x i32], [600005 x i32]* @a, i64 0, i64 %36
  ...
  %44 = getelementptr inbounds [600005 x i32], [600005 x i32]* @a, i64 0, i64 %43
...
54:                                               ; preds = %50
  %55 = mul nsw i32 2, %.0
  call void @_Z4Dfs1iib(i32 %55, i32 %.0, i1 zeroext true)
  %56 = mul nsw i32 2, %.0
  %57 = add nsw i32 %56, 1
  call void @_Z4Dfs1iib(i32 %57, i32 1, i1 zeroext false)
  %58 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector"* @de) #3
  %59 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %1, i32 0, i32 0
  store i32* %58, i32** %59, align 8
  %60 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector"* @de) #3
  %61 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %2, i32 0, i32 0
  store i32* %60, i32** %61, align 8
  br label %62

62:                                               ; preds = %76, %54
  %63 = call zeroext i1 @_ZN9__gnu_cxxneIPiSt6vectorIiSaIiEEEEbRKNS_17__normal_iteratorIT_T0_EESA_(%"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %1, %"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %2) #3
  br i1 %63, label %64, label %78

64:                                               ; preds = %62
  %65 = call dereferenceable(4) i32* @_ZNK9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEdeEv(%"class.__gnu_cxx::__normal_iterator"* %1) #3
  br label %66
...
69:                                               ; preds = %66
  ...
  %72 = getelementptr inbounds [600005 x i32], [600005 x i32]* @sum, i64 0, i64 %71
...
76:                                               ; preds = %75
  %77 = call dereferenceable(8) %"class.__gnu_cxx::__normal_iterator"* @_ZN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEppEv(%"class.__gnu_cxx::__normal_iterator"* %1) #3
  br label %62
...
81:                                               ; preds = %50
  ...
  call void @_Z5writeIiEvT_(i32 %82)
  ret i32 0
}
...
20:                                               ; preds = %17, %14
  %.01 = phi i8 [ %19, %17 ], [ %4, %14 ]
  %.0 = phi i8 [ 1, %17 ], [ 0, %14 ]
  %21 = sext i8 %.01 to i32
...
6:                                                ; preds = %3, %1
  %.0 = phi i32 [ %5, %3 ], [ %0, %1 ]
  call void @_Z6writepIiEvT_(i32 %.0)
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_Z6writepIiEvT_(i32 %0) #0 comdat {
  %2 = icmp sgt i32 %0, 9
  br i1 %2, label %3, label %5

3:                                                ; preds = %1
  %4 = sdiv i32 %0, 10
  call void @_Z6writepIiEvT_(i32 %4)
  br label %5
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s123040115.cpp() #0 section ".text.startup" {
