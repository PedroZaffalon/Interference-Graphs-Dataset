; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01855/s275306110.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01855/s275306110.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s275306110.cpp, i8* null }]
...
8:                                                ; preds = %5
  ...
  %13 = call i32 @_ZSt5__gcdIiET_S0_S0_(i32 %11, i32 %12)
...
23:                                               ; preds = %20
  ...
  %26 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %25, i32 0)
...
39:                                               ; preds = %34
  %40 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %36)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s275306110.cpp() #0 section ".text.startup" {
