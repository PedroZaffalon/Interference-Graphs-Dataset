; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03699/s233560982.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03699/s233560982.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s233560982.cpp, i8* null }]
...
define i32 @main() #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  invoke void @_ZNSt6vectorIiSaIiEEC2EmRKS0_(%"class.std::vector"* %2, i64 %8, %"class.std::allocator"* dereferenceable(1) %3)
...
13:                                               ; preds = %10
  ...
  %15 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %2, i64 %14) #3
...
24:                                               ; preds = %80, %78, %72, %66, %47, %44, %42, %13
...
29:                                               ; preds = %37, %28
  %.05 = phi i32 [ 0, %28 ], [ %38, %37 ]
  %.04 = phi i32 [ 0, %28 ], [ %36, %37 ]
...
42:                                               ; preds = %39
  %43 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %.04)
...
84:                                               ; preds = %83, %74
  %.07 = phi i32 [ 0, %83 ], [ 1, %74 ]
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %2) #3
  switch i32 %.07, label %89 [
    i32 0, label %85
    i32 1, label %85
  ]
...
86:                                               ; preds = %24, %20
  %.02 = phi i32 [ %27, %24 ], [ %23, %20 ]
  %.01 = phi i8* [ %26, %24 ], [ %22, %20 ]
  %87 = insertvalue { i8*, i32 } undef, i8* %.01, 0
  %88 = insertvalue { i8*, i32 } %87, i32 %.02, 1
  resume { i8*, i32 } %88
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s233560982.cpp() #0 section ".text.startup" {
