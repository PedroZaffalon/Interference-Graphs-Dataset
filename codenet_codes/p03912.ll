; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03912/s154936743.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03912/s154936743.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s154936743.cpp, i8* null }]
...
16:                                               ; preds = %0
  ...
  invoke void @_ZNSt6vectorIiSaIiEEC2EmRKS0_(%"class.std::vector"* %5, i64 100005, %"class.std::allocator"* dereferenceable(1) %6)
...
23:                                               ; preds = %21
  ...
  %31 = invoke dereferenceable(4) i32* @_ZNSt3mapIiiSt4lessIiESaISt4pairIKiiEEEixERS3_(%"class.std::map"* %7, i32* dereferenceable(4) %8)
...
45:                                               ; preds = %160, %158, %138, %125, %97, %53, %23, %21
...
53:                                               ; preds = %50
  %54 = invoke dereferenceable(4) i32* @_ZNSt3mapIiiSt4lessIiESaISt4pairIKiiEEEixERS3_(%"class.std::map"* %7, i32* dereferenceable(4) %9)
...
65:                                               ; preds = %120, %64
  %.07 = phi i32 [ 0, %64 ], [ %121, %120 ]
  %.05 = phi i32 [ 0, %64 ], [ %.2, %120 ]
...
97:                                               ; preds = %81, %77
  ...
  %101 = sub nsw i32 %100, %.07
  %102 = sext i32 %101 to i64
  %103 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %3, i64 %102) #3
  %104 = invoke dereferenceable(4) i32* @_ZSt3minIiERKT_S2_S2_(i32* dereferenceable(4) %99, i32* dereferenceable(4) %103)
...
118:                                              ; preds = %105, %85
  %.16 = phi i32 [ %92, %85 ], [ %107, %105 ]
  br label %119

119:                                              ; preds = %118, %71
  %.2 = phi i32 [ %75, %71 ], [ %.16, %118 ]
  br label %120
...
123:                                              ; preds = %156, %122
  %.3 = phi i32 [ %.05, %122 ], [ %142, %156 ]
  %.0 = phi i32 [ 1, %122 ], [ %157, %156 ]
  %124 = icmp sle i32 %.0, 100000
...
125:                                              ; preds = %123
  ...
  %137 = invoke dereferenceable(4) i32* @_ZSt3minIiERKT_S2_S2_(i32* dereferenceable(4) %11, i32* dereferenceable(4) %136)
          to label %138 unwind label %45

138:                                              ; preds = %125
  %139 = invoke dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* dereferenceable(4) %10, i32* dereferenceable(4) %137)
          to label %140 unwind label %45

140:                                              ; preds = %138
  %141 = load i32, i32* %139, align 4
  %142 = add nsw i32 %.3, %141
...
158:                                              ; preds = %123
  %159 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %.3)
...
164:                                              ; preds = %163, %37
  ...
  %165 = insertvalue { i8*, i32 } undef, i8* %.1, 0
  %166 = insertvalue { i8*, i32 } %165, i32 %.13, 1
  resume { i8*, i32 } %166
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s154936743.cpp() #0 section ".text.startup" {
