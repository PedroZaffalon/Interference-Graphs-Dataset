; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00042/s872580087.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00042/s872580087.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s872580087.cpp, i8* null }]
...
35:                                               ; preds = %52, %30
  %.03 = phi i32 [ %34, %30 ], [ %53, %52 ]
  %36 = load i32, i32* %5, align 4
  %37 = icmp sge i32 %.03, %36
...
38:                                               ; preds = %35
  ...
  %48 = call dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* dereferenceable(4) %40, i32* dereferenceable(4) %7)
...
58:                                               ; preds = %71, %57
  %.05 = phi i32 [ 0, %57 ], [ %.16, %71 ]
  %.04 = phi i32 [ 0, %57 ], [ %.1, %71 ]
  %.0 = phi i32 [ 0, %57 ], [ %72, %71 ]
...
70:                                               ; preds = %66, %61
  %.16 = phi i32 [ %.0, %66 ], [ %.05, %61 ]
  %.1 = phi i32 [ %69, %66 ], [ %.04, %61 ]
  br label %71
...
73:                                               ; preds = %58
  ...
  %77 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %76, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i32 0, i32 0))
  %78 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %77, i32 %.04)
  ...
  %80 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %79, i32 %.05)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s872580087.cpp() #0 section ".text.startup" {
