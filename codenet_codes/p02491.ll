; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02491/s715464469.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02491/s715464469.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s715464469.cpp, i8* null }]
...
define void @_Z4funcv() #0 {
  ...
  %20 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %19, i32 %10)
  ...
  %22 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEf(%"class.std::basic_ostream"* %21, float %17)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s715464469.cpp() #0 section ".text.startup" {
