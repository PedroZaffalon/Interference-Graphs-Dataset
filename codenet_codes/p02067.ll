; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02067/s946704443.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02067/s946704443.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s946704443.cpp, i8* null }]
...
32:                                               ; preds = %49, %30
  %.01 = phi i32 [ %31, %30 ], [ %50, %49 ]
  %33 = icmp sge i32 %.01, 0
...
51:                                               ; preds = %47, %32
  %.04 = phi i8 [ 1, %47 ], [ 0, %32 ]
  %52 = trunc i8 %.02 to i1
  br i1 %52, label %53, label %56

53:                                               ; preds = %51
  %54 = trunc i8 %.04 to i1
...
57:                                               ; preds = %56, %55, %40, %19, %7
  %.0 = phi i1 [ false, %7 ], [ true, %19 ], [ true, %40 ], [ false, %55 ], [ true, %56 ]
  ret i1 %.0
}
...
8:                                                ; preds = %5
  %9 = call zeroext i1 @_Z5checki(i32 %.0)
  br i1 %9, label %10, label %14

10:                                               ; preds = %8
  %11 = call i32 @_Z4calci(i32 %.0)
  store i32 %11, i32* %2, align 4
  %12 = call dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* dereferenceable(4) %1, i32* dereferenceable(4) %2)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s946704443.cpp() #0 section ".text.startup" {
