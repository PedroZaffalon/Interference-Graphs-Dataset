; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00974/s474624147.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00974/s474624147.cpp"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

%"class.std::ios_base::Init" = type { i8 }
%struct.BIT = type { [100005 x i32] }
...
@kaede = global %struct.BIT zeroinitializer, align 4
@n = global i32 0, align 4
@vec = global [100005 x %"class.std::vector"] zeroinitializer, align 16
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@.str.2 = private unnamed_addr constant [26 x i8] c"vector::_M_realloc_insert\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s474624147.cpp, i8* null }]
...
9:                                                ; preds = %6
  ...
  %13 = getelementptr inbounds [100005 x %"class.std::vector"], [100005 x %"class.std::vector"]* @vec, i64 0, i64 %12
  %14 = add nsw i32 %.01, 1
  store i32 %14, i32* %2, align 4
  call void @_ZNSt6vectorIiSaIiEE9push_backEOi(%"class.std::vector"* %13, i32* dereferenceable(4) %2)
  br label %15
...
17:                                               ; preds = %6
  call void @_ZN3BIT4initEv(%struct.BIT* @kaede)
  br label %18

18:                                               ; preds = %65, %17
  %.04 = phi i32 [ 100000, %17 ], [ %66, %65 ]
  %.03 = phi i64 [ 0, %17 ], [ %.1, %65 ]
  %.02 = phi i32 [ 0, %17 ], [ %64, %65 ]
  %19 = icmp sge i32 %.04, 0
...
21:                                               ; preds = %41, %20
  %.05 = phi i32 [ 0, %20 ], [ %42, %41 ]
  %.1 = phi i64 [ %.03, %20 ], [ %40, %41 ]
...
27:                                               ; preds = %21
  ...
  %29 = getelementptr inbounds [100005 x %"class.std::vector"], [100005 x %"class.std::vector"]* @vec, i64 0, i64 %28
  %30 = sext i32 %.05 to i64
  %31 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %29, i64 %30) #3
  %32 = load i32, i32* %31, align 4
  %33 = sub nsw i32 %32, 1
  %34 = call i32 @_ZN3BIT3sumEi(%struct.BIT* @kaede, i32 %33)
...
44:                                               ; preds = %56, %43
  ...
  %47 = getelementptr inbounds [100005 x %"class.std::vector"], [100005 x %"class.std::vector"]* @vec, i64 0, i64 %46
...
50:                                               ; preds = %44
  ...
  call void @_ZN3BIT3addEii(%struct.BIT* @kaede, i32 %55, i32 1)
  br label %56
...
67:                                               ; preds = %18
  %68 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEx(%"class.std::basic_ostream"* @_ZSt4cout, i64 %.03)
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN3BIT4initEv(%struct.BIT* %0) #4 comdat align 2 {
  %2 = getelementptr inbounds %struct.BIT, %struct.BIT* %0, i32 0, i32 0
  %3 = getelementptr inbounds [100005 x i32], [100005 x i32]* %2, i32 0, i32 0
  %4 = bitcast i32* %3 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 4 %4, i8 0, i64 400020, i1 false)
  ret void
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i32 @_ZN3BIT3sumEi(%struct.BIT* %0, i32 %1) #4 comdat align 2 {
  br label %3
...
5:                                                ; preds = %3
  ...
  %8 = getelementptr inbounds [100005 x i32], [100005 x i32]* %6, i64 0, i64 %7
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN3BIT3addEii(%struct.BIT* %0, i32 %1, i32 %2) #4 comdat align 2 {
  br label %4

4:                                                ; preds = %12, %3
  %.0 = phi i32 [ %1, %3 ], [ %15, %12 ]
  %5 = icmp slt i32 %.0, 100005
  br i1 %5, label %6, label %16

6:                                                ; preds = %4
  %7 = getelementptr inbounds %struct.BIT, %struct.BIT* %0, i32 0, i32 0
  %8 = sext i32 %.0 to i64
  %9 = getelementptr inbounds [100005 x i32], [100005 x i32]* %7, i64 0, i64 %8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s474624147.cpp() #0 section ".text.startup" {
