; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02175/s475550545.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02175/s475550545.cpp"
...
@.str = private unnamed_addr constant [7 x i8] c"nobiro\00", align 1
@.str.1 = private unnamed_addr constant [7 x i8] c"tidime\00", align 1
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s475550545.cpp, i8* null }]
...
19:                                               ; preds = %17
  %20 = invoke zeroext i1 @_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_(%"class.std::__cxx11::basic_string"* dereferenceable(32) %5, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i32 0, i32 0))
...
22:                                               ; preds = %21
  ...
  %26 = invoke dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* dereferenceable(4) %6, i32* dereferenceable(4) %7)
...
33:                                               ; preds = %21
  %34 = invoke zeroext i1 @_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_(%"class.std::__cxx11::basic_string"* dereferenceable(32) %5, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i32 0, i32 0))
...
36:                                               ; preds = %35
  ...
  %40 = invoke dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* dereferenceable(4) %8, i32* dereferenceable(4) %9)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s475550545.cpp() #0 section ".text.startup" {
