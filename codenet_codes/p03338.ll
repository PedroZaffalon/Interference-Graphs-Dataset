; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03338/s843981559.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03338/s843981559.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s843981559.cpp, i8* null }]
...
21:                                               ; preds = %71, %20
  %.03 = phi i8 [ 97, %20 ], [ %72, %71 ]
  %22 = sext i8 %.03 to i32
...
25:                                               ; preds = %41, %24
  %.04 = phi i8 [ 0, %24 ], [ %.1, %41 ]
  %.01 = phi i32 [ 0, %24 ], [ %42, %41 ]
  %26 = icmp slt i32 %.01, %.02
...
44:                                               ; preds = %57, %43
  %.05 = phi i8 [ 0, %43 ], [ %.16, %57 ]
  %.0 = phi i32 [ %.02, %43 ], [ %58, %57 ]
...
59:                                               ; preds = %44
  %60 = trunc i8 %.04 to i1
  %61 = zext i1 %60 to i32
  %62 = icmp eq i32 %61, 1
  br i1 %62, label %63, label %70

63:                                               ; preds = %59
  %64 = trunc i8 %.05 to i1
...
73:                                               ; preds = %21
  %74 = invoke dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* dereferenceable(4) %4, i32* dereferenceable(4) %3)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s843981559.cpp() #0 section ".text.startup" {
