; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03519/s469645009.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03519/s469645009.cpp"
...
@_ZL4nyanB5cxx11 = internal global %"class.std::__cxx11::basic_string" zeroinitializer, align 8
@.str = private unnamed_addr constant [15 x i8] c"(=^\E3\83\BB\CF\89\E3\83\BB^=)\00", align 1
...
@u = global [200000 x i8] zeroinitializer, align 16
@st = global [2 x %"class.std::set"] zeroinitializer, align 16
@res = global i64 0, align 8
@_ZSt3cin = external global %"class.std::basic_istream", align 8
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s469645009.cpp, i8* null }]
...
define internal void @__cxx_global_var_init.1() #0 section ".text.startup" personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1EPKcRKS3_(%"class.std::__cxx11::basic_string"* @_ZL4nyanB5cxx11, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i32 0, i32 0), %"class.std::allocator"* dereferenceable(1) %1)
          to label %2 unwind label %4

2:                                                ; preds = %0
  call void @_ZNSaIcED1Ev(%"class.std::allocator"* %1) #3
  %3 = call i32 @__cxa_atexit(void (i8*)* bitcast (void (%"class.std::__cxx11::basic_string"*)* @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED1Ev to void (i8*)*), i8* bitcast (%"class.std::__cxx11::basic_string"* @_ZL4nyanB5cxx11 to i8*), i8* @__dso_handle) #3
  ret void
...
1:                                                ; preds = %1, %0
  ...
  %4 = icmp eq %"class.std::set"* %3, getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 1, i64 0)
...
2:                                                ; preds = %2, %1
  ...
  %5 = icmp eq %"class.std::set"* %4, getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i32 0, i32 0)
...
define i32 @main() #5 {
  ...
  %43 = alloca %"struct.std::pair.3", align 4
  ...
  %52 = alloca %"struct.std::pair.3", align 4
  ...
  %67 = alloca %"struct.std::pair.3", align 4
...
74:                                               ; preds = %81, %0
  %.01 = phi i32 [ 0, %0 ], [ %82, %81 ]
  %75 = load i32, i32* @N, align 4
  %76 = icmp slt i32 %.01, %75
...
93:                                               ; preds = %84
  ...
  %96 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* @_ZSt3cin, i32* dereferenceable(4) @p)
  %97 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* %96, i32* dereferenceable(4) @x)
  %98 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* %97, i32* dereferenceable(4) @y)
  ...
  %104 = getelementptr inbounds [200000 x i32], [200000 x i32]* @a, i64 0, i64 %103
  store i32 %101, i32* %104, align 4
  %105 = load i32, i32* @y, align 4
  %106 = load i32, i32* @p, align 4
  %107 = sext i32 %106 to i64
  %108 = getelementptr inbounds [200000 x i32], [200000 x i32]* @b, i64 0, i64 %107
  store i32 %105, i32* %108, align 4
  %109 = load i32, i32* getelementptr inbounds ([200000 x i32], [200000 x i32]* @a, i64 0, i64 0), align 16
  %110 = load i32, i32* @N, align 4
  %111 = sub nsw i32 %110, 1
  %112 = sext i32 %111 to i64
  %113 = getelementptr inbounds [200000 x i32], [200000 x i32]* @a, i64 0, i64 %112
...
122:                                              ; preds = %117
  ...
  %129 = getelementptr inbounds [200000 x i32], [200000 x i32]* @b, i64 0, i64 %128
...
132:                                              ; preds = %122
  ...
  %135 = getelementptr inbounds [200000 x i8], [200000 x i8]* @u, i64 0, i64 %134
  store i8 1, i8* %135, align 1
  %136 = load i32, i32* %1, align 4
  %137 = sext i32 %136 to i64
  %138 = getelementptr inbounds [200000 x i32], [200000 x i32]* @a, i64 0, i64 %137
  ...
  %145 = getelementptr inbounds [200000 x i32], [200000 x i32]* @a, i64 0, i64 %144
  %146 = load i32, i32* %145, align 4
  %147 = load i32, i32* %1, align 4
  %148 = sext i32 %147 to i64
  %149 = getelementptr inbounds [200000 x i32], [200000 x i32]* @b, i64 0, i64 %148
  %150 = load i32, i32* %149, align 4
  %151 = sub nsw i32 %146, %150
  store i32 %151, i32* %3, align 4
  %152 = call i64 @_ZSt9make_pairIiRiESt4pairINSt17__decay_and_stripIT_E6__typeENS2_IT0_E6__typeEEOS3_OS6_(i32* dereferenceable(4) %3, i32* dereferenceable(4) %1)
  %153 = bitcast %"struct.std::pair.3"* %2 to i64*
  store i64 %152, i64* %153, align 4
  %154 = call { %"struct.std::_Rb_tree_node_base"*, i8 } @_ZNSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE6insertEOS1_(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 1), %"struct.std::pair.3"* dereferenceable(8) %2)
  %155 = bitcast %"struct.std::pair"* %4 to { %"struct.std::_Rb_tree_node_base"*, i8 }*
...
160:                                              ; preds = %122
  ...
  %163 = getelementptr inbounds [200000 x i32], [200000 x i32]* @b, i64 0, i64 %162
  ...
  %170 = getelementptr inbounds [200000 x i32], [200000 x i32]* @b, i64 0, i64 %169
  %171 = load i32, i32* %170, align 4
  %172 = load i32, i32* %1, align 4
  %173 = sext i32 %172 to i64
  %174 = getelementptr inbounds [200000 x i32], [200000 x i32]* @a, i64 0, i64 %173
  %175 = load i32, i32* %174, align 4
  %176 = sub nsw i32 %171, %175
  store i32 %176, i32* %6, align 4
  %177 = call i64 @_ZSt9make_pairIiRiESt4pairINSt17__decay_and_stripIT_E6__typeENS2_IT0_E6__typeEEOS3_OS6_(i32* dereferenceable(4) %6, i32* dereferenceable(4) %1)
  %178 = bitcast %"struct.std::pair.3"* %5 to i64*
  store i64 %177, i64* %178, align 4
  %179 = call { %"struct.std::_Rb_tree_node_base"*, i8 } @_ZNSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE6insertEOS1_(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 0), %"struct.std::pair.3"* dereferenceable(8) %5)
  %180 = bitcast %"struct.std::pair"* %7 to { %"struct.std::_Rb_tree_node_base"*, i8 }*
...
189:                                              ; preds = %117
  %190 = call i64 @_ZNKSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE4sizeEv(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 0)) #3
  %191 = and i64 %190, 1
  %192 = icmp ne i64 %191, 0
  br i1 %192, label %193, label %298

193:                                              ; preds = %189
  %194 = call %"struct.std::_Rb_tree_node_base"* @_ZNKSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE5beginEv(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 0)) #3
  %195 = getelementptr inbounds %"struct.std::_Rb_tree_const_iterator", %"struct.std::_Rb_tree_const_iterator"* %8, i32 0, i32 0
  store %"struct.std::_Rb_tree_node_base"* %194, %"struct.std::_Rb_tree_node_base"** %195, align 8
  %196 = call %"struct.std::pair.3"* @_ZNKSt23_Rb_tree_const_iteratorISt4pairIiiEEptEv(%"struct.std::_Rb_tree_const_iterator"* %8) #3
  %197 = getelementptr inbounds %"struct.std::pair.3", %"struct.std::pair.3"* %196, i32 0, i32 0
  %198 = load i32, i32* %197, align 4
  %199 = call %"struct.std::_Rb_tree_node_base"* @_ZNKSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE5beginEv(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 1)) #3
  ...
  %201 = call %"struct.std::pair.3"* @_ZNKSt23_Rb_tree_const_iteratorISt4pairIiiEEptEv(%"struct.std::_Rb_tree_const_iterator"* %9) #3
  %202 = getelementptr inbounds %"struct.std::pair.3", %"struct.std::pair.3"* %201, i32 0, i32 0
  %203 = load i32, i32* %202, align 4
  %204 = icmp sgt i32 %198, %203
  br i1 %204, label %205, label %251

205:                                              ; preds = %193
  %206 = call %"struct.std::_Rb_tree_node_base"* @_ZNKSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE5beginEv(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 1)) #3
  %207 = getelementptr inbounds %"struct.std::_Rb_tree_const_iterator", %"struct.std::_Rb_tree_const_iterator"* %10, i32 0, i32 0
  store %"struct.std::_Rb_tree_node_base"* %206, %"struct.std::_Rb_tree_node_base"** %207, align 8
  %208 = call %"struct.std::pair.3"* @_ZNKSt23_Rb_tree_const_iteratorISt4pairIiiEEptEv(%"struct.std::_Rb_tree_const_iterator"* %10) #3
  %209 = getelementptr inbounds %"struct.std::pair.3", %"struct.std::pair.3"* %208, i32 0, i32 0
  %210 = load i32, i32* %209, align 4
  %211 = sext i32 %210 to i64
  %212 = load i64, i64* @res, align 8
  %213 = sub nsw i64 %212, %211
  store i64 %213, i64* @res, align 8
  %214 = call %"struct.std::_Rb_tree_node_base"* @_ZNKSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE5beginEv(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 1)) #3
  ...
  %216 = call %"struct.std::pair.3"* @_ZNKSt23_Rb_tree_const_iteratorISt4pairIiiEEptEv(%"struct.std::_Rb_tree_const_iterator"* %11) #3
  %217 = getelementptr inbounds %"struct.std::pair.3", %"struct.std::pair.3"* %216, i32 0, i32 1
  %218 = load i32, i32* %217, align 4
  %219 = sext i32 %218 to i64
  %220 = getelementptr inbounds [200000 x i8], [200000 x i8]* @u, i64 0, i64 %219
  ...
  %227 = call %"struct.std::_Rb_tree_node_base"* @_ZNKSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE5beginEv(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 1)) #3
  ...
  %229 = call %"struct.std::pair.3"* @_ZNKSt23_Rb_tree_const_iteratorISt4pairIiiEEptEv(%"struct.std::_Rb_tree_const_iterator"* %14) #3
  %230 = getelementptr inbounds %"struct.std::pair.3", %"struct.std::pair.3"* %229, i32 0, i32 0
  %231 = load i32, i32* %230, align 4
  %232 = sub nsw i32 0, %231
  store i32 %232, i32* %13, align 4
  %233 = call %"struct.std::_Rb_tree_node_base"* @_ZNKSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE5beginEv(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 1)) #3
  %234 = getelementptr inbounds %"struct.std::_Rb_tree_const_iterator", %"struct.std::_Rb_tree_const_iterator"* %15, i32 0, i32 0
  store %"struct.std::_Rb_tree_node_base"* %233, %"struct.std::_Rb_tree_node_base"** %234, align 8
  %235 = call %"struct.std::pair.3"* @_ZNKSt23_Rb_tree_const_iteratorISt4pairIiiEEptEv(%"struct.std::_Rb_tree_const_iterator"* %15) #3
  %236 = getelementptr inbounds %"struct.std::pair.3", %"struct.std::pair.3"* %235, i32 0, i32 1
  %237 = call i64 @_ZSt9make_pairIiRKiESt4pairINSt17__decay_and_stripIT_E6__typeENS3_IT0_E6__typeEEOS4_OS7_(i32* dereferenceable(4) %13, i32* dereferenceable(4) %236)
  %238 = bitcast %"struct.std::pair.3"* %12 to i64*
  store i64 %237, i64* %238, align 4
  %239 = call { %"struct.std::_Rb_tree_node_base"*, i8 } @_ZNSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE6insertEOS1_(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 0), %"struct.std::pair.3"* dereferenceable(8) %12)
  %240 = bitcast %"struct.std::pair"* %16 to { %"struct.std::_Rb_tree_node_base"*, i8 }*
  %241 = getelementptr inbounds { %"struct.std::_Rb_tree_node_base"*, i8 }, { %"struct.std::_Rb_tree_node_base"*, i8 }* %240, i32 0, i32 0
  %242 = extractvalue { %"struct.std::_Rb_tree_node_base"*, i8 } %239, 0
  ...
  %244 = extractvalue { %"struct.std::_Rb_tree_node_base"*, i8 } %239, 1
  store i8 %244, i8* %243, align 8
  %245 = call %"struct.std::_Rb_tree_node_base"* @_ZNKSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE5beginEv(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 1)) #3
  %246 = getelementptr inbounds %"struct.std::_Rb_tree_const_iterator", %"struct.std::_Rb_tree_const_iterator"* %17, i32 0, i32 0
  ...
  %249 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE5eraseB5cxx11ESt23_Rb_tree_const_iteratorIS1_E(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 1), %"struct.std::_Rb_tree_node_base"* %248)
...
251:                                              ; preds = %193
  %252 = call %"struct.std::_Rb_tree_node_base"* @_ZNKSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE5beginEv(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 0)) #3
  ...
  %254 = call %"struct.std::pair.3"* @_ZNKSt23_Rb_tree_const_iteratorISt4pairIiiEEptEv(%"struct.std::_Rb_tree_const_iterator"* %19) #3
  ...
  %260 = call %"struct.std::_Rb_tree_node_base"* @_ZNKSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE5beginEv(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 0)) #3
  ...
  %262 = call %"struct.std::pair.3"* @_ZNKSt23_Rb_tree_const_iteratorISt4pairIiiEEptEv(%"struct.std::_Rb_tree_const_iterator"* %20) #3
  %263 = getelementptr inbounds %"struct.std::pair.3", %"struct.std::pair.3"* %262, i32 0, i32 1
  %264 = load i32, i32* %263, align 4
  %265 = sext i32 %264 to i64
  %266 = getelementptr inbounds [200000 x i8], [200000 x i8]* @u, i64 0, i64 %265
  ...
  store i8 %272, i8* %266, align 1
  %273 = call %"struct.std::_Rb_tree_node_base"* @_ZNKSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE5beginEv(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 0)) #3
  %274 = getelementptr inbounds %"struct.std::_Rb_tree_const_iterator", %"struct.std::_Rb_tree_const_iterator"* %23, i32 0, i32 0
  store %"struct.std::_Rb_tree_node_base"* %273, %"struct.std::_Rb_tree_node_base"** %274, align 8
  %275 = call %"struct.std::pair.3"* @_ZNKSt23_Rb_tree_const_iteratorISt4pairIiiEEptEv(%"struct.std::_Rb_tree_const_iterator"* %23) #3
  ...
  %279 = call %"struct.std::_Rb_tree_node_base"* @_ZNKSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE5beginEv(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 0)) #3
  %280 = getelementptr inbounds %"struct.std::_Rb_tree_const_iterator", %"struct.std::_Rb_tree_const_iterator"* %24, i32 0, i32 0
  store %"struct.std::_Rb_tree_node_base"* %279, %"struct.std::_Rb_tree_node_base"** %280, align 8
  %281 = call %"struct.std::pair.3"* @_ZNKSt23_Rb_tree_const_iteratorISt4pairIiiEEptEv(%"struct.std::_Rb_tree_const_iterator"* %24) #3
  %282 = getelementptr inbounds %"struct.std::pair.3", %"struct.std::pair.3"* %281, i32 0, i32 1
  %283 = call i64 @_ZSt9make_pairIiRKiESt4pairINSt17__decay_and_stripIT_E6__typeENS3_IT0_E6__typeEEOS4_OS7_(i32* dereferenceable(4) %22, i32* dereferenceable(4) %282)
  %284 = bitcast %"struct.std::pair.3"* %21 to i64*
  store i64 %283, i64* %284, align 4
  %285 = call { %"struct.std::_Rb_tree_node_base"*, i8 } @_ZNSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE6insertEOS1_(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 1), %"struct.std::pair.3"* dereferenceable(8) %21)
  %286 = bitcast %"struct.std::pair"* %25 to { %"struct.std::_Rb_tree_node_base"*, i8 }*
  %287 = getelementptr inbounds { %"struct.std::_Rb_tree_node_base"*, i8 }, { %"struct.std::_Rb_tree_node_base"*, i8 }* %286, i32 0, i32 0
  %288 = extractvalue { %"struct.std::_Rb_tree_node_base"*, i8 } %285, 0
  ...
  %290 = extractvalue { %"struct.std::_Rb_tree_node_base"*, i8 } %285, 1
  store i8 %290, i8* %289, align 8
  %291 = call %"struct.std::_Rb_tree_node_base"* @_ZNKSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE5beginEv(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 0)) #3
  %292 = getelementptr inbounds %"struct.std::_Rb_tree_const_iterator", %"struct.std::_Rb_tree_const_iterator"* %26, i32 0, i32 0
  ...
  %295 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE5eraseB5cxx11ESt23_Rb_tree_const_iteratorIS1_E(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 0), %"struct.std::_Rb_tree_node_base"* %294)
...
306:                                              ; preds = %302
  %307 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* @_ZSt3cin, i32* dereferenceable(4) @p)
  %308 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* %307, i32* dereferenceable(4) @x)
  %309 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* %308, i32* dereferenceable(4) @y)
...
319:                                              ; preds = %314, %306
  ...
  %323 = getelementptr inbounds [200000 x i32], [200000 x i32]* @a, i64 0, i64 %322
  %324 = load i32, i32* %323, align 4
  %325 = sub nsw i32 %320, %324
  %326 = sext i32 %325 to i64
  %327 = load i64, i64* @res, align 8
  %328 = add nsw i64 %327, %326
  store i64 %328, i64* @res, align 8
...
333:                                              ; preds = %314
  ...
  %336 = getelementptr inbounds [200000 x i8], [200000 x i8]* @u, i64 0, i64 %335
...
339:                                              ; preds = %333
  ...
  %343 = getelementptr inbounds [200000 x i32], [200000 x i32]* @a, i64 0, i64 %342
  %344 = load i32, i32* %343, align 4
  %345 = sub nsw i32 %340, %344
  %346 = sext i32 %345 to i64
  %347 = load i64, i64* @res, align 8
  %348 = add nsw i64 %347, %346
  store i64 %348, i64* @res, align 8
  %349 = load i32, i32* @p, align 4
  %350 = sext i32 %349 to i64
  %351 = getelementptr inbounds [200000 x i32], [200000 x i32]* @a, i64 0, i64 %350
  %352 = load i32, i32* %351, align 4
  %353 = load i32, i32* @p, align 4
  %354 = sext i32 %353 to i64
  %355 = getelementptr inbounds [200000 x i32], [200000 x i32]* @b, i64 0, i64 %354
  %356 = load i32, i32* %355, align 4
  %357 = sub nsw i32 %352, %356
  store i32 %357, i32* %29, align 4
  %358 = call i64 @_ZSt9make_pairIiRiESt4pairINSt17__decay_and_stripIT_E6__typeENS2_IT0_E6__typeEEOS3_OS6_(i32* dereferenceable(4) %29, i32* dereferenceable(4) @p)
  %359 = bitcast %"struct.std::pair.3"* %28 to i64*
  store i64 %358, i64* %359, align 4
  %360 = call i64 @_ZNSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE5eraseERKS1_(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 1), %"struct.std::pair.3"* dereferenceable(8) %28)
  %361 = load i32, i32* @x, align 4
  %362 = load i32, i32* @y, align 4
  %363 = sub nsw i32 %361, %362
  store i32 %363, i32* %31, align 4
  %364 = call i64 @_ZSt9make_pairIiRiESt4pairINSt17__decay_and_stripIT_E6__typeENS2_IT0_E6__typeEEOS3_OS6_(i32* dereferenceable(4) %31, i32* dereferenceable(4) @p)
  %365 = bitcast %"struct.std::pair.3"* %30 to i64*
  store i64 %364, i64* %365, align 4
  %366 = call { %"struct.std::_Rb_tree_node_base"*, i8 } @_ZNSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE6insertEOS1_(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 1), %"struct.std::pair.3"* dereferenceable(8) %30)
  %367 = bitcast %"struct.std::pair"* %32 to { %"struct.std::_Rb_tree_node_base"*, i8 }*
  %368 = getelementptr inbounds { %"struct.std::_Rb_tree_node_base"*, i8 }, { %"struct.std::_Rb_tree_node_base"*, i8 }* %367, i32 0, i32 0
  %369 = extractvalue { %"struct.std::_Rb_tree_node_base"*, i8 } %366, 0
  ...
  %371 = extractvalue { %"struct.std::_Rb_tree_node_base"*, i8 } %366, 1
  store i8 %371, i8* %370, align 8
  %372 = call %"struct.std::_Rb_tree_node_base"* @_ZNKSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE5beginEv(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 1)) #3
  ...
  %374 = bitcast %"struct.std::_Rb_tree_const_iterator"* %34 to i8*
  %375 = bitcast %"struct.std::_Rb_tree_const_iterator"* %33 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %374, i8* align 8 %375, i64 8, i1 false)
  %376 = call dereferenceable(8) %"struct.std::_Rb_tree_const_iterator"* @_ZNSt23_Rb_tree_const_iteratorISt4pairIiiEEppEv(%"struct.std::_Rb_tree_const_iterator"* %34) #3
  %377 = call dereferenceable(8) %"struct.std::pair.3"* @_ZNKSt23_Rb_tree_const_iteratorISt4pairIiiEEdeEv(%"struct.std::_Rb_tree_const_iterator"* %33) #3
  %378 = bitcast %"struct.std::pair.3"* %35 to i8*
  %379 = bitcast %"struct.std::pair.3"* %377 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %378, i8* align 4 %379, i64 8, i1 false)
  %380 = call dereferenceable(8) %"struct.std::pair.3"* @_ZNKSt23_Rb_tree_const_iteratorISt4pairIiiEEdeEv(%"struct.std::_Rb_tree_const_iterator"* %34) #3
  %381 = bitcast %"struct.std::pair.3"* %36 to i8*
  %382 = bitcast %"struct.std::pair.3"* %380 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %381, i8* align 4 %382, i64 8, i1 false)
  %383 = getelementptr inbounds %"struct.std::pair.3", %"struct.std::pair.3"* %35, i32 0, i32 0
  %384 = load i32, i32* %383, align 4
  %385 = icmp slt i32 %384, 0
  br i1 %385, label %386, label %445

386:                                              ; preds = %339
  %387 = getelementptr inbounds %"struct.std::pair.3", %"struct.std::pair.3"* %36, i32 0, i32 0
  %388 = load i32, i32* %387, align 4
  %389 = icmp slt i32 %388, 0
  br i1 %389, label %390, label %445

390:                                              ; preds = %386
  %391 = getelementptr inbounds %"struct.std::pair.3", %"struct.std::pair.3"* %35, i32 0, i32 0
  %392 = load i32, i32* %391, align 4
  %393 = getelementptr inbounds %"struct.std::pair.3", %"struct.std::pair.3"* %36, i32 0, i32 0
  %394 = load i32, i32* %393, align 4
  %395 = add nsw i32 %392, %394
  %396 = sext i32 %395 to i64
  %397 = load i64, i64* @res, align 8
  %398 = sub nsw i64 %397, %396
  store i64 %398, i64* @res, align 8
  %399 = getelementptr inbounds %"struct.std::pair.3", %"struct.std::pair.3"* %35, i32 0, i32 0
  %400 = load i32, i32* %399, align 4
  %401 = sub nsw i32 0, %400
  store i32 %401, i32* %38, align 4
  %402 = getelementptr inbounds %"struct.std::pair.3", %"struct.std::pair.3"* %35, i32 0, i32 1
  %403 = call i64 @_ZSt9make_pairIiRiESt4pairINSt17__decay_and_stripIT_E6__typeENS2_IT0_E6__typeEEOS3_OS6_(i32* dereferenceable(4) %38, i32* dereferenceable(4) %402)
  %404 = bitcast %"struct.std::pair.3"* %37 to i64*
  store i64 %403, i64* %404, align 4
  %405 = call { %"struct.std::_Rb_tree_node_base"*, i8 } @_ZNSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE6insertEOS1_(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 0), %"struct.std::pair.3"* dereferenceable(8) %37)
  %406 = bitcast %"struct.std::pair"* %39 to { %"struct.std::_Rb_tree_node_base"*, i8 }*
  ...
  %411 = getelementptr inbounds %"struct.std::pair.3", %"struct.std::pair.3"* %36, i32 0, i32 0
  %412 = load i32, i32* %411, align 4
  %413 = sub nsw i32 0, %412
  store i32 %413, i32* %41, align 4
  %414 = getelementptr inbounds %"struct.std::pair.3", %"struct.std::pair.3"* %36, i32 0, i32 1
  %415 = call i64 @_ZSt9make_pairIiRiESt4pairINSt17__decay_and_stripIT_E6__typeENS2_IT0_E6__typeEEOS3_OS6_(i32* dereferenceable(4) %41, i32* dereferenceable(4) %414)
  %416 = bitcast %"struct.std::pair.3"* %40 to i64*
  store i64 %415, i64* %416, align 4
  %417 = call { %"struct.std::_Rb_tree_node_base"*, i8 } @_ZNSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE6insertEOS1_(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 0), %"struct.std::pair.3"* dereferenceable(8) %40)
  %418 = bitcast %"struct.std::pair"* %42 to { %"struct.std::_Rb_tree_node_base"*, i8 }*
  ...
  %423 = getelementptr inbounds %"struct.std::pair.3", %"struct.std::pair.3"* %35, i32 0, i32 1
  %424 = load i32, i32* %423, align 4
  %425 = sext i32 %424 to i64
  %426 = getelementptr inbounds [200000 x i8], [200000 x i8]* @u, i64 0, i64 %425
  ...
  %433 = getelementptr inbounds %"struct.std::pair.3", %"struct.std::pair.3"* %36, i32 0, i32 1
  %434 = load i32, i32* %433, align 4
  %435 = sext i32 %434 to i64
  %436 = getelementptr inbounds [200000 x i8], [200000 x i8]* @u, i64 0, i64 %435
  ...
  %443 = call i64 @_ZNSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE5eraseERKS1_(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 1), %"struct.std::pair.3"* dereferenceable(8) %35)
  %444 = call i64 @_ZNSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE5eraseERKS1_(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 1), %"struct.std::pair.3"* dereferenceable(8) %36)
  br label %445

445:                                              ; preds = %390, %386, %339
  br label %553
...
446:                                              ; preds = %333
  ...
  %450 = getelementptr inbounds [200000 x i32], [200000 x i32]* @b, i64 0, i64 %449
  %451 = load i32, i32* %450, align 4
  %452 = sub nsw i32 %447, %451
  %453 = sext i32 %452 to i64
  %454 = load i64, i64* @res, align 8
  %455 = add nsw i64 %454, %453
  store i64 %455, i64* @res, align 8
  %456 = load i32, i32* @p, align 4
  %457 = sext i32 %456 to i64
  %458 = getelementptr inbounds [200000 x i32], [200000 x i32]* @b, i64 0, i64 %457
  %459 = load i32, i32* %458, align 4
  %460 = load i32, i32* @p, align 4
  %461 = sext i32 %460 to i64
  %462 = getelementptr inbounds [200000 x i32], [200000 x i32]* @a, i64 0, i64 %461
  %463 = load i32, i32* %462, align 4
  %464 = sub nsw i32 %459, %463
  store i32 %464, i32* %44, align 4
  %465 = call i64 @_ZSt9make_pairIiRiESt4pairINSt17__decay_and_stripIT_E6__typeENS2_IT0_E6__typeEEOS3_OS6_(i32* dereferenceable(4) %44, i32* dereferenceable(4) @p)
  %466 = bitcast %"struct.std::pair.3"* %43 to i64*
  store i64 %465, i64* %466, align 4
  %467 = call i64 @_ZNSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE5eraseERKS1_(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 0), %"struct.std::pair.3"* dereferenceable(8) %43)
  %468 = load i32, i32* @y, align 4
  %469 = load i32, i32* @x, align 4
  %470 = sub nsw i32 %468, %469
  store i32 %470, i32* %46, align 4
  %471 = call i64 @_ZSt9make_pairIiRiESt4pairINSt17__decay_and_stripIT_E6__typeENS2_IT0_E6__typeEEOS3_OS6_(i32* dereferenceable(4) %46, i32* dereferenceable(4) @p)
  %472 = bitcast %"struct.std::pair.3"* %45 to i64*
  store i64 %471, i64* %472, align 4
  %473 = call { %"struct.std::_Rb_tree_node_base"*, i8 } @_ZNSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE6insertEOS1_(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 0), %"struct.std::pair.3"* dereferenceable(8) %45)
  %474 = bitcast %"struct.std::pair"* %47 to { %"struct.std::_Rb_tree_node_base"*, i8 }*
  %475 = getelementptr inbounds { %"struct.std::_Rb_tree_node_base"*, i8 }, { %"struct.std::_Rb_tree_node_base"*, i8 }* %474, i32 0, i32 0
  %476 = extractvalue { %"struct.std::_Rb_tree_node_base"*, i8 } %473, 0
  ...
  %478 = extractvalue { %"struct.std::_Rb_tree_node_base"*, i8 } %473, 1
  store i8 %478, i8* %477, align 8
  %479 = call %"struct.std::_Rb_tree_node_base"* @_ZNKSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE5beginEv(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 0)) #3
  %480 = getelementptr inbounds %"struct.std::_Rb_tree_const_iterator", %"struct.std::_Rb_tree_const_iterator"* %48, i32 0, i32 0
  store %"struct.std::_Rb_tree_node_base"* %479, %"struct.std::_Rb_tree_node_base"** %480, align 8
  %481 = bitcast %"struct.std::_Rb_tree_const_iterator"* %49 to i8*
  %482 = bitcast %"struct.std::_Rb_tree_const_iterator"* %48 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %481, i8* align 8 %482, i64 8, i1 false)
  %483 = call dereferenceable(8) %"struct.std::_Rb_tree_const_iterator"* @_ZNSt23_Rb_tree_const_iteratorISt4pairIiiEEppEv(%"struct.std::_Rb_tree_const_iterator"* %49) #3
  %484 = call dereferenceable(8) %"struct.std::pair.3"* @_ZNKSt23_Rb_tree_const_iteratorISt4pairIiiEEdeEv(%"struct.std::_Rb_tree_const_iterator"* %48) #3
  %485 = bitcast %"struct.std::pair.3"* %50 to i8*
  %486 = bitcast %"struct.std::pair.3"* %484 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %485, i8* align 4 %486, i64 8, i1 false)
  %487 = call dereferenceable(8) %"struct.std::pair.3"* @_ZNKSt23_Rb_tree_const_iteratorISt4pairIiiEEdeEv(%"struct.std::_Rb_tree_const_iterator"* %49) #3
  %488 = bitcast %"struct.std::pair.3"* %51 to i8*
  %489 = bitcast %"struct.std::pair.3"* %487 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %488, i8* align 4 %489, i64 8, i1 false)
  %490 = getelementptr inbounds %"struct.std::pair.3", %"struct.std::pair.3"* %50, i32 0, i32 0
  %491 = load i32, i32* %490, align 4
  %492 = icmp slt i32 %491, 0
  br i1 %492, label %493, label %552

493:                                              ; preds = %446
  %494 = getelementptr inbounds %"struct.std::pair.3", %"struct.std::pair.3"* %51, i32 0, i32 0
  %495 = load i32, i32* %494, align 4
  %496 = icmp slt i32 %495, 0
  br i1 %496, label %497, label %552

497:                                              ; preds = %493
  %498 = getelementptr inbounds %"struct.std::pair.3", %"struct.std::pair.3"* %50, i32 0, i32 0
  %499 = load i32, i32* %498, align 4
  %500 = getelementptr inbounds %"struct.std::pair.3", %"struct.std::pair.3"* %51, i32 0, i32 0
  %501 = load i32, i32* %500, align 4
  %502 = add nsw i32 %499, %501
  %503 = sext i32 %502 to i64
  %504 = load i64, i64* @res, align 8
  %505 = sub nsw i64 %504, %503
  store i64 %505, i64* @res, align 8
  %506 = getelementptr inbounds %"struct.std::pair.3", %"struct.std::pair.3"* %50, i32 0, i32 0
  %507 = load i32, i32* %506, align 4
  %508 = sub nsw i32 0, %507
  store i32 %508, i32* %53, align 4
  %509 = getelementptr inbounds %"struct.std::pair.3", %"struct.std::pair.3"* %50, i32 0, i32 1
  %510 = call i64 @_ZSt9make_pairIiRiESt4pairINSt17__decay_and_stripIT_E6__typeENS2_IT0_E6__typeEEOS3_OS6_(i32* dereferenceable(4) %53, i32* dereferenceable(4) %509)
  %511 = bitcast %"struct.std::pair.3"* %52 to i64*
  store i64 %510, i64* %511, align 4
  %512 = call { %"struct.std::_Rb_tree_node_base"*, i8 } @_ZNSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE6insertEOS1_(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 1), %"struct.std::pair.3"* dereferenceable(8) %52)
  %513 = bitcast %"struct.std::pair"* %54 to { %"struct.std::_Rb_tree_node_base"*, i8 }*
  ...
  %518 = getelementptr inbounds %"struct.std::pair.3", %"struct.std::pair.3"* %51, i32 0, i32 0
  %519 = load i32, i32* %518, align 4
  %520 = sub nsw i32 0, %519
  store i32 %520, i32* %56, align 4
  %521 = getelementptr inbounds %"struct.std::pair.3", %"struct.std::pair.3"* %51, i32 0, i32 1
  %522 = call i64 @_ZSt9make_pairIiRiESt4pairINSt17__decay_and_stripIT_E6__typeENS2_IT0_E6__typeEEOS3_OS6_(i32* dereferenceable(4) %56, i32* dereferenceable(4) %521)
  %523 = bitcast %"struct.std::pair.3"* %55 to i64*
  store i64 %522, i64* %523, align 4
  %524 = call { %"struct.std::_Rb_tree_node_base"*, i8 } @_ZNSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE6insertEOS1_(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 1), %"struct.std::pair.3"* dereferenceable(8) %55)
  %525 = bitcast %"struct.std::pair"* %57 to { %"struct.std::_Rb_tree_node_base"*, i8 }*
  %526 = getelementptr inbounds { %"struct.std::_Rb_tree_node_base"*, i8 }, { %"struct.std::_Rb_tree_node_base"*, i8 }* %525, i32 0, i32 0
  %527 = extractvalue { %"struct.std::_Rb_tree_node_base"*, i8 } %524, 0
  ...
  %529 = extractvalue { %"struct.std::_Rb_tree_node_base"*, i8 } %524, 1
  store i8 %529, i8* %528, align 8
  %530 = getelementptr inbounds %"struct.std::pair.3", %"struct.std::pair.3"* %50, i32 0, i32 1
  %531 = load i32, i32* %530, align 4
  %532 = sext i32 %531 to i64
  %533 = getelementptr inbounds [200000 x i8], [200000 x i8]* @u, i64 0, i64 %532
  ...
  %540 = getelementptr inbounds %"struct.std::pair.3", %"struct.std::pair.3"* %51, i32 0, i32 1
  %541 = load i32, i32* %540, align 4
  %542 = sext i32 %541 to i64
  %543 = getelementptr inbounds [200000 x i8], [200000 x i8]* @u, i64 0, i64 %542
  ...
  store i8 %549, i8* %543, align 1
  %550 = call i64 @_ZNSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE5eraseERKS1_(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 0), %"struct.std::pair.3"* dereferenceable(8) %50)
  %551 = call i64 @_ZNSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE5eraseERKS1_(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 0), %"struct.std::pair.3"* dereferenceable(8) %51)
  br label %552

552:                                              ; preds = %497, %493, %446
  br label %553

553:                                              ; preds = %552, %445
  %554 = call zeroext i1 @_ZNKSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE5emptyEv(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 0)) #3
  br i1 %554, label %635, label %555

555:                                              ; preds = %553
  %556 = call zeroext i1 @_ZNKSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE5emptyEv(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 1)) #3
  br i1 %556, label %635, label %557

557:                                              ; preds = %555
  %558 = call %"struct.std::_Rb_tree_node_base"* @_ZNKSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE5beginEv(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 0)) #3
  %559 = getelementptr inbounds %"struct.std::_Rb_tree_const_iterator", %"struct.std::_Rb_tree_const_iterator"* %58, i32 0, i32 0
  store %"struct.std::_Rb_tree_node_base"* %558, %"struct.std::_Rb_tree_node_base"** %559, align 8
  %560 = call %"struct.std::pair.3"* @_ZNKSt23_Rb_tree_const_iteratorISt4pairIiiEEptEv(%"struct.std::_Rb_tree_const_iterator"* %58) #3
  %561 = getelementptr inbounds %"struct.std::pair.3", %"struct.std::pair.3"* %560, i32 0, i32 0
  %562 = load i32, i32* %561, align 4
  %563 = call %"struct.std::_Rb_tree_node_base"* @_ZNKSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE5beginEv(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 1)) #3
  %564 = getelementptr inbounds %"struct.std::_Rb_tree_const_iterator", %"struct.std::_Rb_tree_const_iterator"* %59, i32 0, i32 0
  store %"struct.std::_Rb_tree_node_base"* %563, %"struct.std::_Rb_tree_node_base"** %564, align 8
  %565 = call %"struct.std::pair.3"* @_ZNKSt23_Rb_tree_const_iteratorISt4pairIiiEEptEv(%"struct.std::_Rb_tree_const_iterator"* %59) #3
  %566 = getelementptr inbounds %"struct.std::pair.3", %"struct.std::pair.3"* %565, i32 0, i32 0
...
570:                                              ; preds = %557
  %571 = call %"struct.std::_Rb_tree_node_base"* @_ZNKSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE5beginEv(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 0)) #3
  %572 = getelementptr inbounds %"struct.std::_Rb_tree_const_iterator", %"struct.std::_Rb_tree_const_iterator"* %61, i32 0, i32 0
  store %"struct.std::_Rb_tree_node_base"* %571, %"struct.std::_Rb_tree_node_base"** %572, align 8
  %573 = call dereferenceable(8) %"struct.std::pair.3"* @_ZNKSt23_Rb_tree_const_iteratorISt4pairIiiEEdeEv(%"struct.std::_Rb_tree_const_iterator"* %61) #3
  %574 = bitcast %"struct.std::pair.3"* %60 to i8*
  %575 = bitcast %"struct.std::pair.3"* %573 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %574, i8* align 4 %575, i64 8, i1 false)
  %576 = call %"struct.std::_Rb_tree_node_base"* @_ZNKSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE5beginEv(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 1)) #3
  %577 = getelementptr inbounds %"struct.std::_Rb_tree_const_iterator", %"struct.std::_Rb_tree_const_iterator"* %63, i32 0, i32 0
  store %"struct.std::_Rb_tree_node_base"* %576, %"struct.std::_Rb_tree_node_base"** %577, align 8
  %578 = call dereferenceable(8) %"struct.std::pair.3"* @_ZNKSt23_Rb_tree_const_iteratorISt4pairIiiEEdeEv(%"struct.std::_Rb_tree_const_iterator"* %63) #3
  %579 = bitcast %"struct.std::pair.3"* %62 to i8*
  %580 = bitcast %"struct.std::pair.3"* %578 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %579, i8* align 4 %580, i64 8, i1 false)
  %581 = getelementptr inbounds %"struct.std::pair.3", %"struct.std::pair.3"* %60, i32 0, i32 0
  %582 = load i32, i32* %581, align 4
  %583 = getelementptr inbounds %"struct.std::pair.3", %"struct.std::pair.3"* %62, i32 0, i32 0
  %584 = load i32, i32* %583, align 4
  %585 = add nsw i32 %582, %584
  %586 = sext i32 %585 to i64
  %587 = load i64, i64* @res, align 8
  %588 = sub nsw i64 %587, %586
  store i64 %588, i64* @res, align 8
  %589 = getelementptr inbounds %"struct.std::pair.3", %"struct.std::pair.3"* %60, i32 0, i32 1
  %590 = load i32, i32* %589, align 4
  %591 = sext i32 %590 to i64
  %592 = getelementptr inbounds [200000 x i8], [200000 x i8]* @u, i64 0, i64 %591
  ...
  %599 = getelementptr inbounds %"struct.std::pair.3", %"struct.std::pair.3"* %62, i32 0, i32 1
  %600 = load i32, i32* %599, align 4
  %601 = sext i32 %600 to i64
  %602 = getelementptr inbounds [200000 x i8], [200000 x i8]* @u, i64 0, i64 %601
  ...
  %609 = getelementptr inbounds %"struct.std::pair.3", %"struct.std::pair.3"* %62, i32 0, i32 0
  %610 = load i32, i32* %609, align 4
  %611 = sub nsw i32 0, %610
  store i32 %611, i32* %65, align 4
  %612 = getelementptr inbounds %"struct.std::pair.3", %"struct.std::pair.3"* %62, i32 0, i32 1
  %613 = call i64 @_ZSt9make_pairIiRiESt4pairINSt17__decay_and_stripIT_E6__typeENS2_IT0_E6__typeEEOS3_OS6_(i32* dereferenceable(4) %65, i32* dereferenceable(4) %612)
  %614 = bitcast %"struct.std::pair.3"* %64 to i64*
  store i64 %613, i64* %614, align 4
  %615 = call { %"struct.std::_Rb_tree_node_base"*, i8 } @_ZNSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE6insertEOS1_(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 0), %"struct.std::pair.3"* dereferenceable(8) %64)
  %616 = bitcast %"struct.std::pair"* %66 to { %"struct.std::_Rb_tree_node_base"*, i8 }*
  ...
  %621 = getelementptr inbounds %"struct.std::pair.3", %"struct.std::pair.3"* %60, i32 0, i32 0
  %622 = load i32, i32* %621, align 4
  %623 = sub nsw i32 0, %622
  store i32 %623, i32* %68, align 4
  %624 = getelementptr inbounds %"struct.std::pair.3", %"struct.std::pair.3"* %60, i32 0, i32 1
  %625 = call i64 @_ZSt9make_pairIiRiESt4pairINSt17__decay_and_stripIT_E6__typeENS2_IT0_E6__typeEEOS3_OS6_(i32* dereferenceable(4) %68, i32* dereferenceable(4) %624)
  %626 = bitcast %"struct.std::pair.3"* %67 to i64*
  store i64 %625, i64* %626, align 4
  %627 = call { %"struct.std::_Rb_tree_node_base"*, i8 } @_ZNSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE6insertEOS1_(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 1), %"struct.std::pair.3"* dereferenceable(8) %67)
  %628 = bitcast %"struct.std::pair"* %69 to { %"struct.std::_Rb_tree_node_base"*, i8 }*
  ...
  %633 = call i64 @_ZNSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE5eraseERKS1_(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 0), %"struct.std::pair.3"* dereferenceable(8) %60)
  %634 = call i64 @_ZNSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE5eraseERKS1_(%"class.std::set"* getelementptr inbounds ([2 x %"class.std::set"], [2 x %"class.std::set"]* @st, i64 0, i64 1), %"struct.std::pair.3"* dereferenceable(8) %62)
  br label %635

635:                                              ; preds = %570, %557, %555, %553
  %636 = load i32, i32* @x, align 4
  %637 = load i32, i32* @p, align 4
  %638 = sext i32 %637 to i64
  %639 = getelementptr inbounds [200000 x i32], [200000 x i32]* @a, i64 0, i64 %638
  store i32 %636, i32* %639, align 4
  %640 = load i32, i32* @y, align 4
  %641 = load i32, i32* @p, align 4
  %642 = sext i32 %641 to i64
  %643 = getelementptr inbounds [200000 x i32], [200000 x i32]* @b, i64 0, i64 %642
  store i32 %640, i32* %643, align 4
  br label %644

644:                                              ; preds = %635, %319
  %645 = load i64, i64* @res, align 8
...
; Function Attrs: noinline uwtable
define linkonce_odr { %"struct.std::_Rb_tree_node_base"*, i8 } @_ZNSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE6insertEOS1_(%"class.std::set"* %0, %"struct.std::pair.3"* dereferenceable(8) %1) #0 comdat align 2 {
  ...
  %7 = call { %"struct.std::_Rb_tree_node_base"*, i8 } @_ZNSt8_Rb_treeISt4pairIiiES1_St9_IdentityIS1_ESt4lessIS1_ESaIS1_EE16_M_insert_uniqueIS1_EES0_ISt17_Rb_tree_iteratorIS1_EbEOT_(%"class.std::_Rb_tree"* %5, %"struct.std::pair.3"* dereferenceable(8) %6)
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr %"struct.std::pair.3"* @_ZNKSt23_Rb_tree_const_iteratorISt4pairIiiEEptEv(%"struct.std::_Rb_tree_const_iterator"* %0) #4 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
...
define linkonce_odr i64 @_ZSt9make_pairIiRKiESt4pairINSt17__decay_and_stripIT_E6__typeENS3_IT0_E6__typeEEOS4_OS7_(i32* dereferenceable(4) %0, i32* dereferenceable(4) %1) #0 comdat {
  ...
  call void @_ZNSt4pairIiiEC2IiLb1EEEOT_RKi(%"struct.std::pair.3"* %3, i32* dereferenceable(4) %4, i32* dereferenceable(4) %5)
  %6 = bitcast %"struct.std::pair.3"* %3 to i64*
  %7 = load i64, i64* %6, align 4
  ret i64 %7
}
...
; Function Attrs: noinline uwtable
define linkonce_odr %"struct.std::_Rb_tree_node_base"* @_ZNSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE5eraseB5cxx11ESt23_Rb_tree_const_iteratorIS1_E(%"class.std::set"* %0, %"struct.std::_Rb_tree_node_base"* %1) #0 comdat align 2 {
  ...
  %13 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt8_Rb_treeISt4pairIiiES1_St9_IdentityIS1_ESt4lessIS1_ESaIS1_EE5eraseB5cxx11ESt23_Rb_tree_const_iteratorIS1_E(%"class.std::_Rb_tree"* %8, %"struct.std::_Rb_tree_node_base"* %12)
  %14 = getelementptr inbounds %"struct.std::_Rb_tree_iterator", %"struct.std::_Rb_tree_iterator"* %5, i32 0, i32 0
  store %"struct.std::_Rb_tree_node_base"* %13, %"struct.std::_Rb_tree_node_base"** %14, align 8
  call void @_ZNSt23_Rb_tree_const_iteratorISt4pairIiiEEC2ERKSt17_Rb_tree_iteratorIS1_E(%"struct.std::_Rb_tree_const_iterator"* %3, %"struct.std::_Rb_tree_iterator"* dereferenceable(8) %5) #3
...
; Function Attrs: noinline uwtable
define linkonce_odr i64 @_ZNSt3setISt4pairIiiESt4lessIS1_ESaIS1_EE5eraseERKS1_(%"class.std::set"* %0, %"struct.std::pair.3"* dereferenceable(8) %1) #0 comdat align 2 {
  %3 = getelementptr inbounds %"class.std::set", %"class.std::set"* %0, i32 0, i32 0
  %4 = call i64 @_ZNSt8_Rb_treeISt4pairIiiES1_St9_IdentityIS1_ESt4lessIS1_ESaIS1_EE5eraseERKS1_(%"class.std::_Rb_tree"* %3, %"struct.std::pair.3"* dereferenceable(8) %1)
  ret i64 %4
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(8) %"struct.std::pair.3"* @_ZNKSt23_Rb_tree_const_iteratorISt4pairIiiEEdeEv(%"struct.std::_Rb_tree_const_iterator"* %0) #4 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %2 = getelementptr inbounds %"struct.std::_Rb_tree_const_iterator", %"struct.std::_Rb_tree_const_iterator"* %0, i32 0, i32 0
  %3 = load %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"** %2, align 8
  %4 = bitcast %"struct.std::_Rb_tree_node_base"* %3 to %"struct.std::_Rb_tree_node"*
  %5 = invoke %"struct.std::pair.3"* @_ZNKSt13_Rb_tree_nodeISt4pairIiiEE9_M_valptrEv(%"struct.std::_Rb_tree_node"* %4)
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr %"struct.std::pair.3"* @_ZNSt13_Rb_tree_nodeISt4pairIiiEE9_M_valptrEv(%"struct.std::_Rb_tree_node"* %0) #4 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIiiEEE7destroyIS3_EEvPT_(%"class.__gnu_cxx::new_allocator.1"* %0, %"struct.std::pair.3"* %1) #4 comdat align 2 {
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr %"struct.std::pair.3"* @_ZN9__gnu_cxx16__aligned_membufISt4pairIiiEE6_M_ptrEv(%"struct.__gnu_cxx::__aligned_membuf"* %0) #4 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt4pairIiiEC2IiRiLb1EEEOT_OT0_(%"struct.std::pair.3"* %0, i32* dereferenceable(4) %1, i32* dereferenceable(4) %2) unnamed_addr #4 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt4pairIiiEC2IiLb1EEEOT_RKi(%"struct.std::pair.3"* %0, i32* dereferenceable(4) %1, i32* dereferenceable(4) %2) unnamed_addr #4 comdat align 2 {
  %4 = bitcast %"struct.std::pair.3"* %0 to %"class.std::__pair_base.4"*
  %5 = getelementptr inbounds %"struct.std::pair.3", %"struct.std::pair.3"* %0, i32 0, i32 0
  %6 = call dereferenceable(4) i32* @_ZSt7forwardIiEOT_RNSt16remove_referenceIS0_E4typeE(i32* dereferenceable(4) %1) #3
  %7 = load i32, i32* %6, align 4
...
; Function Attrs: noinline uwtable
define linkonce_odr { %"struct.std::_Rb_tree_node_base"*, i8 } @_ZNSt8_Rb_treeISt4pairIiiES1_St9_IdentityIS1_ESt4lessIS1_ESaIS1_EE16_M_insert_uniqueIS1_EES0_ISt17_Rb_tree_iteratorIS1_EbEOT_(%"class.std::_Rb_tree"* %0, %"struct.std::pair.3"* dereferenceable(8) %1) #0 comdat align 2 {
  ...
  %12 = call { %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"* } @_ZNSt8_Rb_treeISt4pairIiiES1_St9_IdentityIS1_ESt4lessIS1_ESaIS1_EE24_M_get_insert_unique_posERKS1_(%"class.std::_Rb_tree"* %0, %"struct.std::pair.3"* dereferenceable(8) %11)
...
21:                                               ; preds = %2
  ...
  %27 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt8_Rb_treeISt4pairIiiES1_St9_IdentityIS1_ESt4lessIS1_ESaIS1_EE10_M_insert_IS1_NS7_11_Alloc_nodeEEESt17_Rb_tree_iteratorIS1_EPSt18_Rb_tree_node_baseSD_OT_RT0_(%"class.std::_Rb_tree"* %0, %"struct.std::_Rb_tree_node_base"* %23, %"struct.std::_Rb_tree_node_base"* %25, %"struct.std::pair.3"* dereferenceable(8) %26, %"struct.std::_Rb_tree<std::pair<int, int>, std::pair<int, int>, std::_Identity<std::pair<int, int> >, std::less<std::pair<int, int> >, std::allocator<std::pair<int, int> > >::_Alloc_node"* dereferenceable(8) %6)
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(8) %"struct.std::pair.3"* @_ZSt4moveIRSt4pairIiiEEONSt16remove_referenceIT_E4typeEOS4_(%"struct.std::pair.3"* dereferenceable(8) %0) #4 comdat {
  ret %"struct.std::pair.3"* %0
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt4pairISt23_Rb_tree_const_iteratorIS_IiiEEbEC2IRSt17_Rb_tree_iteratorIS1_ERbLb1EEEOT_OT0_(%"struct.std::pair"* %0, %"struct.std::_Rb_tree_iterator"* dereferenceable(8) %1, i8* dereferenceable(1) %2) unnamed_addr #4 comdat align 2 {
...
; Function Attrs: noinline uwtable
define linkonce_odr { %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"* } @_ZNSt8_Rb_treeISt4pairIiiES1_St9_IdentityIS1_ESt4lessIS1_ESaIS1_EE24_M_get_insert_unique_posERKS1_(%"class.std::_Rb_tree"* %0, %"struct.std::pair.3"* dereferenceable(8) %1) #0 comdat align 2 {
...
14:                                               ; preds = %11
  ...
  %21 = call dereferenceable(8) %"struct.std::pair.3"* @_ZNSt8_Rb_treeISt4pairIiiES1_St9_IdentityIS1_ESt4lessIS1_ESaIS1_EE6_S_keyEPKSt13_Rb_tree_nodeIS1_E(%"struct.std::_Rb_tree_node"* %20)
  %22 = call zeroext i1 @_ZNKSt4lessISt4pairIiiEEclERKS1_S4_(%"struct.std::less"* %19, %"struct.std::pair.3"* dereferenceable(8) %1, %"struct.std::pair.3"* dereferenceable(8) %21)
  %23 = zext i1 %22 to i8
...
46:                                               ; preds = %45, %35
  ...
  %53 = call zeroext i1 @_ZNKSt4lessISt4pairIiiEEclERKS1_S4_(%"struct.std::less"* %49, %"struct.std::pair.3"* dereferenceable(8) %52, %"struct.std::pair.3"* dereferenceable(8) %1)
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(8) %"struct.std::pair.3"* @_ZNKSt9_IdentityISt4pairIiiEEclERS1_(%"struct.std::_Identity"* %0, %"struct.std::pair.3"* dereferenceable(8) %1) #4 comdat align 2 {
...
12:                                               ; preds = %9
  ...
  %17 = call dereferenceable(8) %"struct.std::pair.3"* @_ZNSt8_Rb_treeISt4pairIiiES1_St9_IdentityIS1_ESt4lessIS1_ESaIS1_EE6_S_keyEPKSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %2)
  %18 = call zeroext i1 @_ZNKSt4lessISt4pairIiiEEclERKS1_S4_(%"struct.std::less"* %15, %"struct.std::pair.3"* dereferenceable(8) %16, %"struct.std::pair.3"* dereferenceable(8) %17)
  br label %19
...
; Function Attrs: noinline uwtable
define linkonce_odr zeroext i1 @_ZNKSt4lessISt4pairIiiEEclERKS1_S4_(%"struct.std::less"* %0, %"struct.std::pair.3"* dereferenceable(8) %1, %"struct.std::pair.3"* dereferenceable(8) %2) #0 comdat align 2 {
  %4 = call zeroext i1 @_ZStltIiiEbRKSt4pairIT_T0_ES5_(%"struct.std::pair.3"* dereferenceable(8) %1, %"struct.std::pair.3"* dereferenceable(8) %2)
  ret i1 %4
}

; Function Attrs: noinline uwtable
define linkonce_odr dereferenceable(8) %"struct.std::pair.3"* @_ZNSt8_Rb_treeISt4pairIiiES1_St9_IdentityIS1_ESt4lessIS1_ESaIS1_EE6_S_keyEPKSt13_Rb_tree_nodeIS1_E(%"struct.std::_Rb_tree_node"* %0) #0 comdat align 2 {
...
; Function Attrs: noinline uwtable
define linkonce_odr dereferenceable(8) %"struct.std::pair.3"* @_ZNSt8_Rb_treeISt4pairIiiES1_St9_IdentityIS1_ESt4lessIS1_ESaIS1_EE6_S_keyEPKSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %0) #0 comdat align 2 {
  %2 = bitcast %"struct.std::_Rb_tree_node_base"* %0 to %"struct.std::_Rb_tree_node"*
  %3 = call dereferenceable(8) %"struct.std::pair.3"* @_ZNSt8_Rb_treeISt4pairIiiES1_St9_IdentityIS1_ESt4lessIS1_ESaIS1_EE6_S_keyEPKSt13_Rb_tree_nodeIS1_E(%"struct.std::_Rb_tree_node"* %2)
  ret %"struct.std::pair.3"* %3
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(8) %"struct.std::pair.3"* @_ZNKSt9_IdentityISt4pairIiiEEclERKS1_(%"struct.std::_Identity"* %0, %"struct.std::pair.3"* dereferenceable(8) %1) #4 comdat align 2 {
  ret %"struct.std::pair.3"* %1
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr %"struct.std::pair.3"* @_ZNKSt13_Rb_tree_nodeISt4pairIiiEE9_M_valptrEv(%"struct.std::_Rb_tree_node"* %0) #4 comdat align 2 {
  %2 = getelementptr inbounds %"struct.std::_Rb_tree_node", %"struct.std::_Rb_tree_node"* %0, i32 0, i32 1
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr %"struct.std::pair.3"* @_ZNK9__gnu_cxx16__aligned_membufISt4pairIiiEE6_M_ptrEv(%"struct.__gnu_cxx::__aligned_membuf"* %0) #4 comdat align 2 {
...
define linkonce_odr %"struct.std::_Rb_tree_node"* @_ZNKSt8_Rb_treeISt4pairIiiES1_St9_IdentityIS1_ESt4lessIS1_ESaIS1_EE11_Alloc_nodeclIS1_EEPSt13_Rb_tree_nodeIS1_EOT_(%"struct.std::_Rb_tree<std::pair<int, int>, std::pair<int, int>, std::_Identity<std::pair<int, int> >, std::less<std::pair<int, int> >, std::allocator<std::pair<int, int> > >::_Alloc_node"* %0, %"struct.std::pair.3"* dereferenceable(8) %1) #0 comdat align 2 {
  ...
  %6 = call %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeISt4pairIiiES1_St9_IdentityIS1_ESt4lessIS1_ESaIS1_EE14_M_create_nodeIJS1_EEEPSt13_Rb_tree_nodeIS1_EDpOT_(%"class.std::_Rb_tree"* %4, %"struct.std::pair.3"* dereferenceable(8) %5)
...
; Function Attrs: noinline uwtable
define linkonce_odr %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeISt4pairIiiES1_St9_IdentityIS1_ESt4lessIS1_ESaIS1_EE14_M_create_nodeIJS1_EEEPSt13_Rb_tree_nodeIS1_EDpOT_(%"class.std::_Rb_tree"* %0, %"struct.std::pair.3"* dereferenceable(8) %1) #0 comdat align 2 {
  ...
  call void @_ZNSt8_Rb_treeISt4pairIiiES1_St9_IdentityIS1_ESt4lessIS1_ESaIS1_EE17_M_construct_nodeIJS1_EEEvPSt13_Rb_tree_nodeIS1_EDpOT_(%"class.std::_Rb_tree"* %0, %"struct.std::_Rb_tree_node"* %3, %"struct.std::pair.3"* dereferenceable(8) %4)
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIiiEEE9constructIS3_JS3_EEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator.1"* %0, %"struct.std::pair.3"* %1, %"struct.std::pair.3"* dereferenceable(8) %2) #4 comdat align 2 {
...
; Function Attrs: noinline uwtable
define linkonce_odr %"struct.std::_Rb_tree_node_base"* @_ZNSt8_Rb_treeISt4pairIiiES1_St9_IdentityIS1_ESt4lessIS1_ESaIS1_EE5eraseB5cxx11ESt23_Rb_tree_const_iteratorIS1_E(%"class.std::_Rb_tree"* %0, %"struct.std::_Rb_tree_node_base"* %1) #0 comdat align 2 {
  ...
  %10 = call dereferenceable(8) %"struct.std::_Rb_tree_const_iterator"* @_ZNSt23_Rb_tree_const_iteratorISt4pairIiiEEppEv(%"struct.std::_Rb_tree_const_iterator"* %5) #3
  ...
  call void @_ZNSt8_Rb_treeISt4pairIiiES1_St9_IdentityIS1_ESt4lessIS1_ESaIS1_EE12_M_erase_auxESt23_Rb_tree_const_iteratorIS1_E(%"class.std::_Rb_tree"* %0, %"struct.std::_Rb_tree_node_base"* %14)
  %15 = call %"struct.std::_Rb_tree_node_base"* @_ZNKSt23_Rb_tree_const_iteratorISt4pairIiiEE13_M_const_castEv(%"struct.std::_Rb_tree_const_iterator"* %5) #3
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr %"struct.std::_Rb_tree_node_base"* @_ZNKSt23_Rb_tree_const_iteratorISt4pairIiiEE13_M_const_castEv(%"struct.std::_Rb_tree_const_iterator"* %0) #4 comdat align 2 {
  %2 = alloca %"struct.std::_Rb_tree_iterator", align 8
  %3 = getelementptr inbounds %"struct.std::_Rb_tree_const_iterator", %"struct.std::_Rb_tree_const_iterator"* %0, i32 0, i32 0
  %4 = load %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"** %3, align 8
  call void @_ZNSt17_Rb_tree_iteratorISt4pairIiiEEC2EPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_iterator"* %2, %"struct.std::_Rb_tree_node_base"* %4) #3
...
; Function Attrs: noinline uwtable
define linkonce_odr i64 @_ZNSt8_Rb_treeISt4pairIiiES1_St9_IdentityIS1_ESt4lessIS1_ESaIS1_EE5eraseERKS1_(%"class.std::_Rb_tree"* %0, %"struct.std::pair.3"* dereferenceable(8) %1) #0 comdat align 2 {
  %3 = alloca %"struct.std::pair.13", align 8
  %4 = alloca %"struct.std::_Rb_tree_const_iterator", align 8
  %5 = alloca %"struct.std::_Rb_tree_const_iterator", align 8
  %6 = call { %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"* } @_ZNSt8_Rb_treeISt4pairIiiES1_St9_IdentityIS1_ESt4lessIS1_ESaIS1_EE11equal_rangeERKS1_(%"class.std::_Rb_tree"* %0, %"struct.std::pair.3"* dereferenceable(8) %1)
...
; Function Attrs: noinline uwtable
define linkonce_odr { %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"* } @_ZNSt8_Rb_treeISt4pairIiiES1_St9_IdentityIS1_ESt4lessIS1_ESaIS1_EE11equal_rangeERKS1_(%"class.std::_Rb_tree"* %0, %"struct.std::pair.3"* dereferenceable(8) %1) #0 comdat align 2 {
  %3 = alloca %"struct.std::pair.13", align 8
...
12:                                               ; preds = %10
  ...
  %14 = bitcast %"struct.std::_Rb_tree<std::pair<int, int>, std::pair<int, int>, std::_Identity<std::pair<int, int> >, std::less<std::pair<int, int> >, std::allocator<std::pair<int, int> > >::_Rb_tree_impl"* %13 to %"struct.std::_Rb_tree_key_compare"*
  %15 = getelementptr inbounds %"struct.std::_Rb_tree_key_compare", %"struct.std::_Rb_tree_key_compare"* %14, i32 0, i32 0
  %16 = call dereferenceable(8) %"struct.std::pair.3"* @_ZNSt8_Rb_treeISt4pairIiiES1_St9_IdentityIS1_ESt4lessIS1_ESaIS1_EE6_S_keyEPKSt13_Rb_tree_nodeIS1_E(%"struct.std::_Rb_tree_node"* %.01)
  %17 = call zeroext i1 @_ZNKSt4lessISt4pairIiiEEclERKS1_S4_(%"struct.std::less"* %15, %"struct.std::pair.3"* dereferenceable(8) %16, %"struct.std::pair.3"* dereferenceable(8) %1)
...
21:                                               ; preds = %12
  ...
  %25 = call dereferenceable(8) %"struct.std::pair.3"* @_ZNSt8_Rb_treeISt4pairIiiES1_St9_IdentityIS1_ESt4lessIS1_ESaIS1_EE6_S_keyEPKSt13_Rb_tree_nodeIS1_E(%"struct.std::_Rb_tree_node"* %.01)
  %26 = call zeroext i1 @_ZNKSt4lessISt4pairIiiEEclERKS1_S4_(%"struct.std::less"* %24, %"struct.std::pair.3"* dereferenceable(8) %1, %"struct.std::pair.3"* dereferenceable(8) %25)
...
31:                                               ; preds = %21
  ...
  %37 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt8_Rb_treeISt4pairIiiES1_St9_IdentityIS1_ESt4lessIS1_ESaIS1_EE14_M_lower_boundEPSt13_Rb_tree_nodeIS1_EPSt18_Rb_tree_node_baseRKS1_(%"class.std::_Rb_tree"* %0, %"struct.std::_Rb_tree_node"* %34, %"struct.std::_Rb_tree_node_base"* %32, %"struct.std::pair.3"* dereferenceable(8) %1)
  ...
  %39 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt8_Rb_treeISt4pairIiiES1_St9_IdentityIS1_ESt4lessIS1_ESaIS1_EE14_M_upper_boundEPSt13_Rb_tree_nodeIS1_EPSt18_Rb_tree_node_baseRKS1_(%"class.std::_Rb_tree"* %0, %"struct.std::_Rb_tree_node"* %36, %"struct.std::_Rb_tree_node_base"* %.0, %"struct.std::pair.3"* dereferenceable(8) %1)
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt8_Rb_treeISt4pairIiiES1_St9_IdentityIS1_ESt4lessIS1_ESaIS1_EE12_M_erase_auxESt23_Rb_tree_const_iteratorIS1_ES9_(%"class.std::_Rb_tree"* %0, %"struct.std::_Rb_tree_node_base"* %1, %"struct.std::_Rb_tree_node_base"* %2) #4 comdat align 2 {
  %4 = alloca %"struct.std::_Rb_tree_const_iterator", align 8
  %5 = alloca %"struct.std::_Rb_tree_const_iterator", align 8
  %6 = alloca %"struct.std::_Rb_tree_const_iterator", align 8
  %7 = alloca %"struct.std::_Rb_tree_iterator", align 8
...
8:                                                ; preds = %6
  ...
  %12 = call dereferenceable(8) %"struct.std::pair.3"* @_ZNSt8_Rb_treeISt4pairIiiES1_St9_IdentityIS1_ESt4lessIS1_ESaIS1_EE6_S_keyEPKSt13_Rb_tree_nodeIS1_E(%"struct.std::_Rb_tree_node"* %.01)
  %13 = call zeroext i1 @_ZNKSt4lessISt4pairIiiEEclERKS1_S4_(%"struct.std::less"* %11, %"struct.std::pair.3"* dereferenceable(8) %12, %"struct.std::pair.3"* dereferenceable(8) %3)
...
8:                                                ; preds = %6
  ...
  %11 = getelementptr inbounds %"struct.std::_Rb_tree_key_compare", %"struct.std::_Rb_tree_key_compare"* %10, i32 0, i32 0
  %12 = call dereferenceable(8) %"struct.std::pair.3"* @_ZNSt8_Rb_treeISt4pairIiiES1_St9_IdentityIS1_ESt4lessIS1_ESaIS1_EE6_S_keyEPKSt13_Rb_tree_nodeIS1_E(%"struct.std::_Rb_tree_node"* %.01)
  %13 = call zeroext i1 @_ZNKSt4lessISt4pairIiiEEclERKS1_S4_(%"struct.std::less"* %11, %"struct.std::pair.3"* dereferenceable(8) %3, %"struct.std::pair.3"* dereferenceable(8) %12)
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt4pairISt17_Rb_tree_iteratorIS_IiiEES2_EC2IS2_S2_Lb1EEEOT_OT0_(%"struct.std::pair.13"* %0, %"struct.std::_Rb_tree_iterator"* dereferenceable(8) %1, %"struct.std::_Rb_tree_iterator"* dereferenceable(8) %2) unnamed_addr #4 comdat align 2 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s469645009.cpp() #0 section ".text.startup" {
