; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02209/s900174506.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02209/s900174506.cpp"
...
$_Z2inISt6vectorIxSaIxEEJEEvRT_DpRT0_ = comdat any
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s900174506.cpp, i8* null }]
...
11:                                               ; preds = %0
  ...
  invoke void @_Z2inISt6vectorIxSaIxEEJEEvRT_DpRT0_(%"class.std::vector"* dereferenceable(24) %3)
...
12:                                               ; preds = %11
  ...
  invoke void @_ZNSt6vectorIiSaIiEEC2EmRKiRKS0_(%"class.std::vector.0"* %5, i64 %15, i32* dereferenceable(4) %6, %"class.std::allocator.2"* dereferenceable(1) %7)
...
22:                                               ; preds = %47, %21
  %.06 = phi i32 [ 0, %21 ], [ %48, %47 ]
  %.04 = phi i64 [ 0, %21 ], [ %.15, %47 ]
...
94:                                               ; preds = %90
  ...
  %96 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.0"* %5, i64 %95) #3
...
99:                                               ; preds = %94
  ...
  %101 = call i32 @llvm.ctpop.i32(i32 %.09)
  %102 = sub nsw i32 %100, %101
  %103 = invoke zeroext i1 @_Z4aminIxiEbRT_T0_(i64* dereferenceable(8) %8, i32 %102)
...
112:                                              ; preds = %90
  invoke void @_Z3outIxJEEvRKT_DpRKT0_(i64* dereferenceable(8) %8)
...
114:                                              ; preds = %105, %42, %38
  %.01 = phi i32 [ %108, %105 ], [ %45, %42 ], [ %41, %38 ]
  %.0 = phi i8* [ %107, %105 ], [ %44, %42 ], [ %40, %38 ]
  call void @_ZNSt6vectorIxSaIxEED2Ev(%"class.std::vector"* %3) #3
  br label %115

115:                                              ; preds = %114, %34
  %.12 = phi i32 [ %.01, %114 ], [ %37, %34 ]
  %.1 = phi i8* [ %.0, %114 ], [ %36, %34 ]
  %116 = insertvalue { i8*, i32 } undef, i8* %.1, 0
  %117 = insertvalue { i8*, i32 } %116, i32 %.12, 1
  resume { i8*, i32 } %117
}
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_Z2inISt6vectorIxSaIxEEJEEvRT_DpRT0_(%"class.std::vector"* dereferenceable(24) %0) #0 comdat {
  %2 = call dereferenceable(280) %"class.std::basic_istream"* @_ZrsIxERSiS0_RSt6vectorIT_SaIS2_EE(%"class.std::basic_istream"* dereferenceable(280) @_ZSt3cin, %"class.std::vector"* dereferenceable(24) %0)
  call void @_Z2inv()
  ret void
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr zeroext i1 @_Z4aminIxiEbRT_T0_(i64* dereferenceable(8) %0, i32 %1) #4 comdat {
  %3 = sext i32 %1 to i64
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s900174506.cpp() #0 section ".text.startup" {
