; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00077/s860470697.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00077/s860470697.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s860470697.cpp, i8* null }]
...
47:                                               ; preds = %63, %56, %53, %41, %37, %28, %20, %4, %2
...
67:                                               ; preds = %47
  %68 = insertvalue { i8*, i32 } undef, i8* %49, 0
  %69 = insertvalue { i8*, i32 } %68, i32 %50, 1
  resume { i8*, i32 } %69
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s860470697.cpp() #0 section ".text.startup" {
