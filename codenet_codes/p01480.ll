; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01480/s973991742.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01480/s973991742.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s973991742.cpp, i8* null }]
...
13:                                               ; preds = %102, %0
  %.02 = phi double [ 0.000000e+00, %0 ], [ %.1, %102 ]
  %.01 = phi double [ 0.000000e+00, %0 ], [ %103, %102 ]
...
17:                                               ; preds = %13
  ...
  invoke void @_ZNSt6vectorIdSaIdEEC2EmRKdRKS0_(%"class.std::vector"* %4, i64 %21, double* dereferenceable(8) %5, %"class.std::allocator"* dereferenceable(1) %6)
...
22:                                               ; preds = %17
  ...
  invoke void @_ZNSt6vectorIdSaIdEEC2EmRKdRKS0_(%"class.std::vector"* %7, i64 %24, double* dereferenceable(8) %8, %"class.std::allocator"* dereferenceable(1) %9)
...
26:                                               ; preds = %42, %25
  %.010 = phi i32 [ 0, %25 ], [ %43, %42 ]
  %.03 = phi double [ 0.000000e+00, %25 ], [ %41, %42 ]
  %27 = load i32, i32* %3, align 4
  %28 = icmp slt i32 %.010, %27
  br i1 %28, label %29, label %56

29:                                               ; preds = %26
  %30 = sext i32 %.010 to i64
  %31 = call dereferenceable(8) double* @_ZNSt6vectorIdSaIdEEixEm(%"class.std::vector"* %4, i64 %30) #3
...
33:                                               ; preds = %29
  ...
  %35 = call dereferenceable(8) double* @_ZNSt6vectorIdSaIdEEixEm(%"class.std::vector"* %7, i64 %34) #3
  %36 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERd(%"class.std::basic_istream"* %32, double* dereferenceable(8) %35)
...
56:                                               ; preds = %26
  %57 = fsub double 1.000000e+00, %.03
  br label %58

58:                                               ; preds = %80, %56
  %.05 = phi double [ %57, %56 ], [ %82, %80 ]
  %.14 = phi double [ %.03, %56 ], [ %.2, %80 ]
  %59 = fcmp ole double %.14, 1.000000e+00
...
61:                                               ; preds = %78, %60
  %.011 = phi i32 [ 0, %60 ], [ %79, %78 ]
  %.2 = phi double [ 0.000000e+00, %60 ], [ %77, %78 ]
  %62 = sext i32 %.011 to i64
  %63 = call i64 @_ZNKSt6vectorIdSaIdEE4sizeEv(%"class.std::vector"* %7) #3
...
65:                                               ; preds = %61
  ...
  %69 = fmul double %68, %.05
  %70 = sext i32 %.011 to i64
  %71 = call dereferenceable(8) double* @_ZNSt6vectorIdSaIdEEixEm(%"class.std::vector"* %7, i64 %70) #3
...
80:                                               ; preds = %61
  %81 = fsub double 1.000000e+00, %.2
  %82 = fadd double %81, 0x3DA5FD7FE1796495
  br label %58
...
84:                                               ; preds = %96, %83
  %.1 = phi double [ 0.000000e+00, %83 ], [ %95, %96 ]
  %.0 = phi i32 [ 0, %83 ], [ %97, %96 ]
...
87:                                               ; preds = %84
  ...
  %89 = call dereferenceable(8) double* @_ZNSt6vectorIdSaIdEEixEm(%"class.std::vector"* %4, i64 %88) #3
  %90 = load double, double* %89, align 8
  %91 = sext i32 %.0 to i64
  %92 = call dereferenceable(8) double* @_ZNSt6vectorIdSaIdEEixEm(%"class.std::vector"* %7, i64 %91) #3
...
102:                                              ; preds = %101, %100
  %103 = phi double [ %.1, %100 ], [ %.01, %101 ]
  call void @_ZNSt6vectorIdSaIdEED2Ev(%"class.std::vector"* %7) #3
  call void @_ZNSt6vectorIdSaIdEED2Ev(%"class.std::vector"* %4) #3
  br label %13

104:                                              ; preds = %52, %48
  %.08 = phi i32 [ %55, %52 ], [ %51, %48 ]
  %.06 = phi i8* [ %54, %52 ], [ %50, %48 ]
  call void @_ZNSt6vectorIdSaIdEED2Ev(%"class.std::vector"* %4) #3
  br label %111

105:                                              ; preds = %13
  %106 = fcmp oeq double %.02, %.01
  %107 = zext i1 %106 to i64
  %108 = select i1 %106, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i32 0, i32 0)
...
111:                                              ; preds = %104, %44
  %.19 = phi i32 [ %.08, %104 ], [ %47, %44 ]
  %.17 = phi i8* [ %.06, %104 ], [ %46, %44 ]
  %112 = insertvalue { i8*, i32 } undef, i8* %.17, 0
  %113 = insertvalue { i8*, i32 } %112, i32 %.19, 1
  resume { i8*, i32 } %113
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s973991742.cpp() #0 section ".text.startup" {
