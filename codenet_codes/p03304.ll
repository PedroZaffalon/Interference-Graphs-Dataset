; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03304/s084273732.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03304/s084273732.cpp"
...
@_ = global double 0.000000e+00, align 8
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s084273732.cpp, i8* null }]
...
define i32 @main() #4 {
  ...
  %11 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERd(%"class.std::basic_istream"* %10, double* dereferenceable(8) @m)
  %12 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERd(%"class.std::basic_istream"* %11, double* dereferenceable(8) @q)
...
32:                                               ; preds = %29, %20
  %33 = phi double [ %28, %20 ], [ %31, %29 ]
  %34 = load double, double* @m, align 8
  %35 = fsub double %34, 1.000000e+00
  %36 = fmul double %33, %35
  %37 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEd(%"class.std::basic_ostream"* %17, double %36)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s084273732.cpp() #0 section ".text.startup" {
