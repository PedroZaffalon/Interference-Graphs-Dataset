; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01984/s542188558.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01984/s542188558.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s542188558.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define void @_Z5solvex(i64 %0) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
...
10:                                               ; preds = %15, %1
  %.01 = phi i64 [ 2, %1 ], [ %17, %15 ]
  %.0 = phi i64 [ %9, %1 ], [ %16, %15 ]
  %11 = call i64 @_Z1fx(i64 %.01)
  %12 = sub nsw i64 %.0, %11
...
18:                                               ; preds = %14
  ...
  invoke void @_ZNSt6vectorIxSaIxEEC2EmRKxRKS0_(%"class.std::vector"* %3, i64 %.01, i64* dereferenceable(8) %4, %"class.std::allocator"* dereferenceable(1) %5)
...
20:                                               ; preds = %35, %19
  %.07 = phi i64 [ 1, %19 ], [ %37, %35 ]
  %.1 = phi i64 [ %.0, %19 ], [ %36, %35 ]
  br label %21

21:                                               ; preds = %20
  %22 = invoke i64 @"_ZZ5solvexENK3$_0clEx"(%class.anon* %2, i64 %.01)
...
38:                                               ; preds = %26
  ...
  store i64 %.07, i64* %39, align 8
  br label %40

40:                                               ; preds = %131, %38
  %.09 = phi i64 [ 1, %38 ], [ %132, %131 ]
  %.2 = phi i64 [ %.1, %38 ], [ %.4, %131 ]
  %41 = icmp slt i64 %.09, %.01
  br i1 %41, label %42, label %133

42:                                               ; preds = %40
  %43 = sub nsw i64 %.01, 1
  %44 = icmp eq i64 %.09, %43
...
46:                                               ; preds = %57, %45
  %.010 = phi i64 [ 0, %45 ], [ %.111, %57 ]
  %.3 = phi i64 [ %.2, %45 ], [ %47, %57 ]
  %47 = add nsw i64 %.3, -1
  %48 = icmp ne i64 %.3, 0
  br i1 %48, label %49, label %58

49:                                               ; preds = %46
  %50 = add nsw i64 %.010, 1
  %51 = sub nsw i64 %.09, 1
...
57:                                               ; preds = %55, %49
  %.111 = phi i64 [ %56, %55 ], [ %50, %49 ]
  br label %46

58:                                               ; preds = %46
  %59 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %3, i64 %.09) #3
  store i64 %.010, i64* %59, align 8
  br label %133
...
61:                                               ; preds = %85, %60
  %.012 = phi i64 [ 0, %60 ], [ %86, %85 ]
  %.4 = phi i64 [ %.2, %60 ], [ %84, %85 ]
  %62 = icmp slt i64 %.012, 10
...
63:                                               ; preds = %61
  ...
  %67 = icmp eq i64 %66, %.012
  br i1 %67, label %68, label %74

68:                                               ; preds = %63
  %69 = add nsw i64 %.09, 1
  %70 = sub nsw i64 %.01, %69
  %71 = shl i64 1, %70
  %72 = sub nsw i64 %71, 1
  %73 = mul nsw i64 %72, 9
  br label %78
...
74:                                               ; preds = %63
  %75 = add nsw i64 %.09, 1
  %76 = sub nsw i64 %.01, %75
  %77 = shl i64 1, %76
  br label %78

78:                                               ; preds = %74, %68
  %.08 = phi i64 [ %73, %68 ], [ %77, %74 ]
  %79 = sub nsw i64 %.4, %.08
  %80 = icmp slt i64 %79, 0
  br i1 %80, label %81, label %83

81:                                               ; preds = %78
  %82 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %3, i64 %.09) #3
  store i64 %.012, i64* %82, align 8
  br label %87
...
85:                                               ; preds = %83
  %86 = add nsw i64 %.012, 1
  br label %61

87:                                               ; preds = %81, %61
  %88 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %3, i64 %.09) #3
...
94:                                               ; preds = %87
  %95 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %3, i64 %.09) #3
  %96 = sub nsw i64 %.09, 1
...
99:                                               ; preds = %94
  ...
  %101 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %3, i64 %.09) #3
  %102 = sub nsw i64 %.09, 1
  %103 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %3, i64 %102) #3
  %104 = invoke dereferenceable(8) i64* @_ZSt3maxIxERKT_S2_S2_(i64* dereferenceable(8) %101, i64* dereferenceable(8) %103)
...
107:                                              ; preds = %126, %105
  %.02 = phi i64 [ 0, %105 ], [ %127, %126 ]
  %108 = sub nsw i64 %.01, 1
...
138:                                              ; preds = %146, %133
  %139 = call zeroext i1 @_ZN9__gnu_cxxneIPxSt6vectorIxSaIxEEEEbRKNS_17__normal_iteratorIT_T0_EESA_(%"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %7, %"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %8) #3
  br i1 %139, label %140, label %152

140:                                              ; preds = %138
  %141 = call dereferenceable(8) i64* @_ZNK9__gnu_cxx17__normal_iteratorIPxSt6vectorIxSaIxEEEdeEv(%"class.__gnu_cxx::__normal_iterator"* %7) #3
  %142 = load i64, i64* %141, align 8
  %143 = add nsw i64 %142, 48
  %144 = trunc i64 %143 to i8
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9push_backEc(%"class.std::__cxx11::basic_string"* %6, i8 signext %144)
...
157:                                              ; preds = %148, %31
  %.05 = phi i32 [ %151, %148 ], [ %34, %31 ]
  %.03 = phi i8* [ %150, %148 ], [ %33, %31 ]
  call void @_ZNSt6vectorIxSaIxEED2Ev(%"class.std::vector"* %3) #3
  br label %158

158:                                              ; preds = %157, %27
  %.16 = phi i32 [ %.05, %157 ], [ %30, %27 ]
  %.14 = phi i8* [ %.03, %157 ], [ %29, %27 ]
  %159 = insertvalue { i8*, i32 } undef, i8* %.14, 0
  %160 = insertvalue { i8*, i32 } %159, i32 %.16, 1
  resume { i8*, i32 } %160
}
...
; Function Attrs: noinline nounwind uwtable
define internal i64 @"_ZZ5solvexENK3$_0clEx"(%class.anon* %0, i64 %1) #4 align 2 {
  %3 = sub nsw i64 %1, 1
  %4 = shl i64 1, %3
  %5 = sub nsw i64 %4, 1
  %6 = mul nsw i64 %5, 9
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s542188558.cpp() #0 section ".text.startup" {
