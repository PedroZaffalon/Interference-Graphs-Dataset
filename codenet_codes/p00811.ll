; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00811/s324335478.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00811/s324335478.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s324335478.cpp, i8* null }]
...
2:                                                ; preds = %6, %0
  %.0 = phi i64 [ 0, %0 ], [ %7, %6 ]
  %3 = icmp slt i64 %.0, 100005
  br i1 %3, label %4, label %8

4:                                                ; preds = %2
  %5 = getelementptr inbounds [100005 x i8], [100005 x i8]* @isPrime, i64 0, i64 %.0
...
9:                                                ; preds = %26, %8
  %.01 = phi i64 [ 2, %8 ], [ %27, %26 ]
  %10 = mul nsw i64 %.01, %.01
  %11 = icmp slt i64 %10, 100006
  br i1 %11, label %12, label %28

12:                                               ; preds = %9
  %13 = getelementptr inbounds [100005 x i8], [100005 x i8]* @isPrime, i64 0, i64 %.01
...
18:                                               ; preds = %22, %16
  %.02 = phi i64 [ %17, %16 ], [ %23, %22 ]
  %19 = icmp slt i64 %.02, 100005
  br i1 %19, label %20, label %24

20:                                               ; preds = %18
  %21 = getelementptr inbounds [100005 x i8], [100005 x i8]* @isPrime, i64 0, i64 %.02
...
33:                                               ; preds = %29
  ...
  %36 = getelementptr inbounds [100005 x i8], [100005 x i8]* @isPrime, i64 0, i64 %35
...
define i32 @main() #5 {
  ...
  %16 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector"* @prime) #3
  %17 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %4, i32 0, i32 0
  store i32* %16, i32** %17, align 8
  %18 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector"* @prime) #3
...
24:                                               ; preds = %97, %0
  ...
  %26 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* %25, i32* dereferenceable(4) %1)
...
36:                                               ; preds = %33, %30, %24
  %37 = phi i1 [ true, %30 ], [ true, %24 ], [ %35, %33 ]
...
40:                                               ; preds = %95, %38
  %.07 = phi i32 [ %39, %38 ], [ %.18, %95 ]
  %.03 = phi i32 [ 0, %38 ], [ %.14, %95 ]
  %.02 = phi i32 [ 0, %38 ], [ %.1, %95 ]
  %.01 = phi i32 [ 0, %38 ], [ %96, %95 ]
  %41 = icmp slt i32 %.01, %15
...
43:                                               ; preds = %92, %42
  %.18 = phi i32 [ %.07, %42 ], [ %.310, %92 ]
  %.14 = phi i32 [ %.03, %42 ], [ %.36, %92 ]
  %.1 = phi i32 [ %.02, %42 ], [ %.3, %92 ]
  %.0 = phi i32 [ %.01, %42 ], [ %93, %92 ]
  %44 = icmp slt i32 %.0, %15
...
45:                                               ; preds = %43
  ...
  %52 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* @prime, i64 %51) #3
...
57:                                               ; preds = %45
  ...
  %62 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* @prime, i64 %61) #3
...
67:                                               ; preds = %57
  ...
  %69 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* @prime, i64 %68) #3
  %70 = load i32, i32* %69, align 4
  %71 = sext i32 %.0 to i64
  %72 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* @prime, i64 %71) #3
...
76:                                               ; preds = %67
  ...
  %78 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* @prime, i64 %77) #3
  %79 = load i32, i32* %78, align 4
  %80 = sext i32 %.0 to i64
  %81 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* @prime, i64 %80) #3
  %82 = load i32, i32* %81, align 4
  %83 = sext i32 %.01 to i64
  %84 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* @prime, i64 %83) #3
  %85 = load i32, i32* %84, align 4
  %86 = sext i32 %.0 to i64
  %87 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* @prime, i64 %86) #3
  %88 = load i32, i32* %87, align 4
  %89 = mul nsw i32 %85, %88
  br label %90

90:                                               ; preds = %76, %67
  %.29 = phi i32 [ %89, %76 ], [ %.18, %67 ]
  %.25 = phi i32 [ %82, %76 ], [ %.14, %67 ]
  %.2 = phi i32 [ %79, %76 ], [ %.1, %67 ]
  br label %91

91:                                               ; preds = %90, %57, %45
  %.310 = phi i32 [ %.29, %90 ], [ %.18, %57 ], [ %.18, %45 ]
  %.36 = phi i32 [ %.25, %90 ], [ %.14, %57 ], [ %.14, %45 ]
  %.3 = phi i32 [ %.2, %90 ], [ %.1, %57 ], [ %.1, %45 ]
  br label %92
...
97:                                               ; preds = %40
  %98 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %.02)
  ...
  %100 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %99, i32 %.03)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s324335478.cpp() #0 section ".text.startup" {
