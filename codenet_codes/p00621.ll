; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00621/s333778152.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00621/s333778152.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s333778152.cpp, i8* null }]
...
20:                                               ; preds = %9
  ...
  invoke void @_ZNSt6vectorIiSaIiEEC2EmRKiRKS0_(%"class.std::vector"* %3, i64 1000, i32* dereferenceable(4) %4, %"class.std::allocator"* dereferenceable(1) %5)
...
34:                                               ; preds = %126, %124, %102, %98, %96, %93, %91, %50, %48, %42, %21
...
39:                                               ; preds = %122, %38
  %.04 = phi i32 [ 0, %38 ], [ %123, %122 ]
  %40 = load i32, i32* %2, align 4
  %41 = icmp slt i32 %.04, %40
  br i1 %41, label %42, label %124

42:                                               ; preds = %39
  %43 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_RS3_(%"class.std::basic_istream"* dereferenceable(280) @_ZSt3cin, i8* dereferenceable(1) %6)
...
53:                                               ; preds = %87, %52
  %.06 = phi i32 [ 0, %52 ], [ %88, %87 ]
  %54 = load i32, i32* %1, align 4
  %55 = load i32, i32* %8, align 4
  %56 = sub nsw i32 %54, %55
  %57 = icmp sle i32 %.06, %56
...
59:                                               ; preds = %70, %58
  %.09 = phi i32 [ 0, %58 ], [ %71, %70 ]
  %.07 = phi i8 [ 1, %58 ], [ %.18, %70 ]
  %60 = load i32, i32* %8, align 4
  %61 = icmp slt i32 %.09, %60
  br i1 %61, label %62, label %72

62:                                               ; preds = %59
  %63 = add nsw i32 %.06, %.09
...
89:                                               ; preds = %85, %53
  %.05 = phi i32 [ %.06, %85 ], [ -1, %53 ]
  %90 = icmp eq i32 %.05, -1
  br i1 %90, label %91, label %96

91:                                               ; preds = %89
  %92 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0))
...
96:                                               ; preds = %89
  %97 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %.05)
...
129:                                              ; preds = %128, %29
  %.03 = phi i32 [ 1, %29 ], [ 0, %128 ]
  %.1 = phi i32 [ 0, %29 ], [ %.0, %128 ]
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %3) #3
  switch i32 %.03, label %136 [
    i32 0, label %130
    i32 1, label %132
  ]
...
132:                                              ; preds = %131, %129
  %.2 = phi i32 [ %.1, %129 ], [ 0, %131 ]
  ret i32 %.2

133:                                              ; preds = %34, %30
  %.02 = phi i32 [ %37, %34 ], [ %33, %30 ]
  %.01 = phi i8* [ %36, %34 ], [ %32, %30 ]
  %134 = insertvalue { i8*, i32 } undef, i8* %.01, 0
  %135 = insertvalue { i8*, i32 } %134, i32 %.02, 1
  resume { i8*, i32 } %135
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s333778152.cpp() #0 section ".text.startup" {
