; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02469/s221317029.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02469/s221317029.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s221317029.cpp, i8* null }]
...
define i32 @main() #4 {
  ...
  %3 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i32* %1)
  br label %4
...
13:                                               ; preds = %4
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* %14, i32* %18)
...
24:                                               ; preds = %43, %13
  %.03 = phi i32 [ 0, %13 ], [ %28, %43 ]
  %.02 = phi i8 [ 0, %13 ], [ %.1, %43 ]
  %25 = trunc i8 %.02 to i1
  %26 = xor i1 %25, true
  br i1 %26, label %27, label %44

27:                                               ; preds = %24
  %28 = add nsw i32 %.03, %23
  br label %29
...
44:                                               ; preds = %24
  %45 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i32 %.03)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s221317029.cpp() #0 section ".text.startup" {
