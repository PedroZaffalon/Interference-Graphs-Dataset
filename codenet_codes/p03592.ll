; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03592/s809079780.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03592/s809079780.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s809079780.cpp, i8* null }]
...
14:                                               ; preds = %11
  ...
  %18 = mul nsw i64 %.01, %17
  %19 = add nsw i64 %16, %18
  %20 = mul nsw i64 2, %.0
  %21 = mul nsw i64 %20, %.01
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s809079780.cpp() #0 section ".text.startup" {
