; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03829/s116912609.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03829/s116912609.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s116912609.cpp, i8* null }]
...
16:                                               ; preds = %13
  ...
  %18 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %4, i64 %17) #3
...
32:                                               ; preds = %50, %31
  %.04 = phi i32 [ 1, %31 ], [ %51, %50 ]
  %.03 = phi i64 [ 0, %31 ], [ %49, %50 ]
...
35:                                               ; preds = %32
  ...
  %46 = invoke dereferenceable(8) i64* @_ZSt3minIxERKT_S2_S2_(i64* dereferenceable(8) %3, i64* dereferenceable(8) %6)
          to label %47 unwind label %27

47:                                               ; preds = %35
  %48 = load i64, i64* %46, align 8
  %49 = add nsw i64 %.03, %48
  br label %50
...
52:                                               ; preds = %32
  %53 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEx(%"class.std::basic_ostream"* @_ZSt4cout, i64 %.03)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s116912609.cpp() #0 section ".text.startup" {
