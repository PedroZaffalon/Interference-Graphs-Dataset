; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02466/s151480132.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02466/s151480132.cpp"
...
$_ZSt24set_symmetric_differenceISt23_Rb_tree_const_iteratorIiES1_St20back_insert_iteratorISt6vectorIiSaIiEEEET1_T_S8_T0_S9_S7_ = comdat any
...
$_ZSt26__set_symmetric_differenceISt23_Rb_tree_const_iteratorIiES1_St20back_insert_iteratorISt6vectorIiSaIiEEEN9__gnu_cxx5__ops15_Iter_less_iterEET1_T_SB_T0_SC_SA_T2_ = comdat any
...
$_ZSt4copyISt23_Rb_tree_const_iteratorIiESt20back_insert_iteratorISt6vectorIiSaIiEEEET0_T_S8_S7_ = comdat any
...
$_ZSt14__copy_move_a2ILb0ESt23_Rb_tree_const_iteratorIiESt20back_insert_iteratorISt6vectorIiSaIiEEEET1_T0_S8_S7_ = comdat any

$_ZSt12__miter_baseISt23_Rb_tree_const_iteratorIiEET_S2_ = comdat any

$_ZSt13__copy_move_aILb0ESt23_Rb_tree_const_iteratorIiESt20back_insert_iteratorISt6vectorIiSaIiEEEET1_T0_S8_S7_ = comdat any
...
$_ZNSt11__copy_moveILb0ELb0ESt26bidirectional_iterator_tagE8__copy_mISt23_Rb_tree_const_iteratorIiESt20back_insert_iteratorISt6vectorIiSaIiEEEEET0_T_SB_SA_ = comdat any
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s151480132.cpp, i8* null }]
...
23:                                               ; preds = %21
  %24 = invoke { %"struct.std::_Rb_tree_node_base"*, i8 } @_ZNSt3setIiSt4lessIiESaIiEE6insertERKi(%"class.std::set"* %2, i32* dereferenceable(4) %4)
...
35:                                               ; preds = %17
  %36 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* @_ZSt3cin, i32* dereferenceable(4) %1)
...
44:                                               ; preds = %42
  %45 = invoke { %"struct.std::_Rb_tree_node_base"*, i8 } @_ZNSt3setIiSt4lessIiESaIiEE6insertERKi(%"class.std::set"* %3, i32* dereferenceable(4) %6)
          to label %46 unwind label %31

46:                                               ; preds = %44
  %47 = bitcast %"struct.std::pair"* %7 to { %"struct.std::_Rb_tree_node_base"*, i8 }*
...
52:                                               ; preds = %38
  ...
  %53 = call %"struct.std::_Rb_tree_node_base"* @_ZNKSt3setIiSt4lessIiESaIiEE5beginEv(%"class.std::set"* %2) #3
  ...
  %55 = call %"struct.std::_Rb_tree_node_base"* @_ZNKSt3setIiSt4lessIiESaIiEE3endEv(%"class.std::set"* %2) #3
  ...
  %57 = call %"struct.std::_Rb_tree_node_base"* @_ZNKSt3setIiSt4lessIiESaIiEE5beginEv(%"class.std::set"* %3) #3
  ...
  %59 = call %"struct.std::_Rb_tree_node_base"* @_ZNKSt3setIiSt4lessIiESaIiEE3endEv(%"class.std::set"* %3) #3
  ...
  %61 = invoke %"class.std::vector"* @_ZSt13back_inserterISt6vectorIiSaIiEEESt20back_insert_iteratorIT_ERS4_(%"class.std::vector"* dereferenceable(24) %8)
          to label %62 unwind label %91

62:                                               ; preds = %52
  %63 = getelementptr inbounds %"class.std::back_insert_iterator", %"class.std::back_insert_iterator"* %13, i32 0, i32 0
  store %"class.std::vector"* %61, %"class.std::vector"** %63, align 8
  ...
  %72 = getelementptr inbounds %"class.std::back_insert_iterator", %"class.std::back_insert_iterator"* %13, i32 0, i32 0
  %73 = load %"class.std::vector"*, %"class.std::vector"** %72, align 8
  %74 = invoke %"class.std::vector"* @_ZSt24set_symmetric_differenceISt23_Rb_tree_const_iteratorIiES1_St20back_insert_iteratorISt6vectorIiSaIiEEEET1_T_S8_T0_S9_S7_(%"struct.std::_Rb_tree_node_base"* %65, %"struct.std::_Rb_tree_node_base"* %67, %"struct.std::_Rb_tree_node_base"* %69, %"struct.std::_Rb_tree_node_base"* %71, %"class.std::vector"* %73)
          to label %75 unwind label %91

75:                                               ; preds = %62
  %76 = getelementptr inbounds %"class.std::back_insert_iterator", %"class.std::back_insert_iterator"* %14, i32 0, i32 0
  store %"class.std::vector"* %74, %"class.std::vector"** %76, align 8
  br label %77

77:                                               ; preds = %89, %75
  %.02 = phi i32 [ 0, %75 ], [ %90, %89 ]
...
96:                                               ; preds = %91, %31
  %.01 = phi i32 [ %34, %31 ], [ %94, %91 ]
  %.0 = phi i8* [ %33, %31 ], [ %93, %91 ]
  call void @_ZNSt3setIiSt4lessIiESaIiEED2Ev(%"class.std::set"* %3) #3
  call void @_ZNSt3setIiSt4lessIiESaIiEED2Ev(%"class.std::set"* %2) #3
  br label %97
...
; Function Attrs: noinline uwtable
define linkonce_odr %"class.std::vector"* @_ZSt24set_symmetric_differenceISt23_Rb_tree_const_iteratorIiES1_St20back_insert_iteratorISt6vectorIiSaIiEEEET1_T_S8_T0_S9_S7_(%"struct.std::_Rb_tree_node_base"* %0, %"struct.std::_Rb_tree_node_base"* %1, %"struct.std::_Rb_tree_node_base"* %2, %"struct.std::_Rb_tree_node_base"* %3, %"class.std::vector"* %4) #0 comdat {
  ...
  %27 = bitcast %"struct.std::_Rb_tree_const_iterator"* %9 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %26, i8* align 8 %27, i64 8, i1 false)
  %28 = bitcast %"struct.std::_Rb_tree_const_iterator"* %15 to i8*
  %29 = bitcast %"struct.std::_Rb_tree_const_iterator"* %10 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %28, i8* align 8 %29, i64 8, i1 false)
  %30 = bitcast %"class.std::back_insert_iterator"* %16 to i8*
  %31 = bitcast %"class.std::back_insert_iterator"* %11 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %30, i8* align 8 %31, i64 8, i1 false)
  call void @_ZN9__gnu_cxx5__ops16__iter_less_iterEv()
  %32 = getelementptr inbounds %"struct.std::_Rb_tree_const_iterator", %"struct.std::_Rb_tree_const_iterator"* %12, i32 0, i32 0
  ...
  %40 = getelementptr inbounds %"class.std::back_insert_iterator", %"class.std::back_insert_iterator"* %16, i32 0, i32 0
  %41 = load %"class.std::vector"*, %"class.std::vector"** %40, align 8
  %42 = call %"class.std::vector"* @_ZSt26__set_symmetric_differenceISt23_Rb_tree_const_iteratorIiES1_St20back_insert_iteratorISt6vectorIiSaIiEEEN9__gnu_cxx5__ops15_Iter_less_iterEET1_T_SB_T0_SC_SA_T2_(%"struct.std::_Rb_tree_node_base"* %33, %"struct.std::_Rb_tree_node_base"* %35, %"struct.std::_Rb_tree_node_base"* %37, %"struct.std::_Rb_tree_node_base"* %39, %"class.std::vector"* %41)
  %43 = getelementptr inbounds %"class.std::back_insert_iterator", %"class.std::back_insert_iterator"* %6, i32 0, i32 0
  store %"class.std::vector"* %42, %"class.std::vector"** %43, align 8
  %44 = getelementptr inbounds %"class.std::back_insert_iterator", %"class.std::back_insert_iterator"* %6, i32 0, i32 0
...
; Function Attrs: noinline uwtable
define linkonce_odr %"class.std::vector"* @_ZSt13back_inserterISt6vectorIiSaIiEEESt20back_insert_iteratorIT_ERS4_(%"class.std::vector"* dereferenceable(24) %0) #0 comdat {
  %2 = alloca %"class.std::back_insert_iterator", align 8
  call void @_ZNSt20back_insert_iteratorISt6vectorIiSaIiEEEC2ERS2_(%"class.std::back_insert_iterator"* %2, %"class.std::vector"* dereferenceable(24) %0)
  %3 = getelementptr inbounds %"class.std::back_insert_iterator", %"class.std::back_insert_iterator"* %2, i32 0, i32 0
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt4pairISt17_Rb_tree_iteratorIiEbEC2IS1_bLb1EEEOT_OT0_(%"struct.std::pair.3"* %0, %"struct.std::_Rb_tree_iterator"* dereferenceable(8) %1, i8* dereferenceable(1) %2) unnamed_addr #5 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt4pairIPSt18_Rb_tree_node_baseS1_EC2IRPSt13_Rb_tree_nodeIiERS1_Lb1EEEOT_OT0_(%"struct.std::pair.7"* %0, %"struct.std::_Rb_tree_node"** dereferenceable(8) %1, %"struct.std::_Rb_tree_node_base"** dereferenceable(8) %2) unnamed_addr #5 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt20back_insert_iteratorISt6vectorIiSaIiEEEC2ERS2_(%"class.std::back_insert_iterator"* %0, %"class.std::vector"* dereferenceable(24) %1) unnamed_addr #5 comdat align 2 {
  %3 = bitcast %"class.std::back_insert_iterator"* %0 to %"struct.std::iterator"*
  %4 = getelementptr inbounds %"class.std::back_insert_iterator", %"class.std::back_insert_iterator"* %0, i32 0, i32 0
  %5 = call %"class.std::vector"* @_ZSt11__addressofISt6vectorIiSaIiEEEPT_RS3_(%"class.std::vector"* dereferenceable(24) %1) #3
  store %"class.std::vector"* %5, %"class.std::vector"** %4, align 8
  ret void
}
...
; Function Attrs: noinline uwtable
define linkonce_odr %"class.std::vector"* @_ZSt26__set_symmetric_differenceISt23_Rb_tree_const_iteratorIiES1_St20back_insert_iteratorISt6vectorIiSaIiEEEN9__gnu_cxx5__ops15_Iter_less_iterEET1_T_SB_T0_SC_SA_T2_(%"struct.std::_Rb_tree_node_base"* %0, %"struct.std::_Rb_tree_node_base"* %1, %"struct.std::_Rb_tree_node_base"* %2, %"struct.std::_Rb_tree_node_base"* %3, %"class.std::vector"* %4) #0 comdat {
  %6 = alloca %"class.std::back_insert_iterator", align 8
  %7 = alloca %"struct.std::_Rb_tree_const_iterator", align 8
  %8 = alloca %"struct.std::_Rb_tree_const_iterator", align 8
  %9 = alloca %"struct.std::_Rb_tree_const_iterator", align 8
...
28:                                               ; preds = %70, %5
  %29 = call zeroext i1 @_ZNKSt23_Rb_tree_const_iteratorIiEneERKS0_(%"struct.std::_Rb_tree_const_iterator"* %7, %"struct.std::_Rb_tree_const_iterator"* dereferenceable(8) %8) #3
  br i1 %29, label %30, label %32

30:                                               ; preds = %28
  %31 = call zeroext i1 @_ZNKSt23_Rb_tree_const_iteratorIiEneERKS0_(%"struct.std::_Rb_tree_const_iterator"* %9, %"struct.std::_Rb_tree_const_iterator"* dereferenceable(8) %10) #3
  br label %32
...
34:                                               ; preds = %32
  %35 = bitcast %"struct.std::_Rb_tree_const_iterator"* %13 to i8*
  %36 = bitcast %"struct.std::_Rb_tree_const_iterator"* %7 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %35, i8* align 8 %36, i64 8, i1 false)
  %37 = bitcast %"struct.std::_Rb_tree_const_iterator"* %14 to i8*
  %38 = bitcast %"struct.std::_Rb_tree_const_iterator"* %9 to i8*
  ...
  %43 = call zeroext i1 @_ZNK9__gnu_cxx5__ops15_Iter_less_iterclISt23_Rb_tree_const_iteratorIiES4_EEbT_T0_(%"struct.__gnu_cxx::__ops::_Iter_less_iter"* %12, %"struct.std::_Rb_tree_node_base"* %40, %"struct.std::_Rb_tree_node_base"* %42)
  br i1 %43, label %44, label %50

44:                                               ; preds = %34
  %45 = call dereferenceable(4) i32* @_ZNKSt23_Rb_tree_const_iteratorIiEdeEv(%"struct.std::_Rb_tree_const_iterator"* %7) #3
  %46 = call dereferenceable(8) %"class.std::back_insert_iterator"* @_ZNSt20back_insert_iteratorISt6vectorIiSaIiEEEdeEv(%"class.std::back_insert_iterator"* %11)
  %47 = call dereferenceable(8) %"class.std::back_insert_iterator"* @_ZNSt20back_insert_iteratorISt6vectorIiSaIiEEEaSERKi(%"class.std::back_insert_iterator"* %46, i32* dereferenceable(4) %45)
  %48 = call dereferenceable(8) %"struct.std::_Rb_tree_const_iterator"* @_ZNSt23_Rb_tree_const_iteratorIiEppEv(%"struct.std::_Rb_tree_const_iterator"* %7) #3
  %49 = call dereferenceable(8) %"class.std::back_insert_iterator"* @_ZNSt20back_insert_iteratorISt6vectorIiSaIiEEEppEv(%"class.std::back_insert_iterator"* %11)
  br label %70

50:                                               ; preds = %34
  %51 = bitcast %"struct.std::_Rb_tree_const_iterator"* %15 to i8*
  ...
  %54 = bitcast %"struct.std::_Rb_tree_const_iterator"* %7 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %53, i8* align 8 %54, i64 8, i1 false)
  %55 = getelementptr inbounds %"struct.std::_Rb_tree_const_iterator", %"struct.std::_Rb_tree_const_iterator"* %15, i32 0, i32 0
  ...
  %59 = call zeroext i1 @_ZNK9__gnu_cxx5__ops15_Iter_less_iterclISt23_Rb_tree_const_iteratorIiES4_EEbT_T0_(%"struct.__gnu_cxx::__ops::_Iter_less_iter"* %12, %"struct.std::_Rb_tree_node_base"* %56, %"struct.std::_Rb_tree_node_base"* %58)
  br i1 %59, label %60, label %66

60:                                               ; preds = %50
  %61 = call dereferenceable(4) i32* @_ZNKSt23_Rb_tree_const_iteratorIiEdeEv(%"struct.std::_Rb_tree_const_iterator"* %9) #3
  %62 = call dereferenceable(8) %"class.std::back_insert_iterator"* @_ZNSt20back_insert_iteratorISt6vectorIiSaIiEEEdeEv(%"class.std::back_insert_iterator"* %11)
  %63 = call dereferenceable(8) %"class.std::back_insert_iterator"* @_ZNSt20back_insert_iteratorISt6vectorIiSaIiEEEaSERKi(%"class.std::back_insert_iterator"* %62, i32* dereferenceable(4) %61)
  %64 = call dereferenceable(8) %"struct.std::_Rb_tree_const_iterator"* @_ZNSt23_Rb_tree_const_iteratorIiEppEv(%"struct.std::_Rb_tree_const_iterator"* %9) #3
  %65 = call dereferenceable(8) %"class.std::back_insert_iterator"* @_ZNSt20back_insert_iteratorISt6vectorIiSaIiEEEppEv(%"class.std::back_insert_iterator"* %11)
  br label %69

66:                                               ; preds = %50
  %67 = call dereferenceable(8) %"struct.std::_Rb_tree_const_iterator"* @_ZNSt23_Rb_tree_const_iteratorIiEppEv(%"struct.std::_Rb_tree_const_iterator"* %7) #3
  %68 = call dereferenceable(8) %"struct.std::_Rb_tree_const_iterator"* @_ZNSt23_Rb_tree_const_iteratorIiEppEv(%"struct.std::_Rb_tree_const_iterator"* %9) #3
  br label %69
...
71:                                               ; preds = %32
  %72 = bitcast %"struct.std::_Rb_tree_const_iterator"* %17 to i8*
  %73 = bitcast %"struct.std::_Rb_tree_const_iterator"* %9 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %72, i8* align 8 %73, i64 8, i1 false)
  %74 = bitcast %"struct.std::_Rb_tree_const_iterator"* %18 to i8*
  %75 = bitcast %"struct.std::_Rb_tree_const_iterator"* %10 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %74, i8* align 8 %75, i64 8, i1 false)
  %76 = bitcast %"struct.std::_Rb_tree_const_iterator"* %20 to i8*
  %77 = bitcast %"struct.std::_Rb_tree_const_iterator"* %7 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %76, i8* align 8 %77, i64 8, i1 false)
  %78 = bitcast %"struct.std::_Rb_tree_const_iterator"* %21 to i8*
  %79 = bitcast %"struct.std::_Rb_tree_const_iterator"* %8 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %78, i8* align 8 %79, i64 8, i1 false)
  %80 = bitcast %"class.std::back_insert_iterator"* %22 to i8*
  %81 = bitcast %"class.std::back_insert_iterator"* %11 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %80, i8* align 8 %81, i64 8, i1 false)
  %82 = getelementptr inbounds %"struct.std::_Rb_tree_const_iterator", %"struct.std::_Rb_tree_const_iterator"* %20, i32 0, i32 0
  %83 = load %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"** %82, align 8
  %84 = getelementptr inbounds %"struct.std::_Rb_tree_const_iterator", %"struct.std::_Rb_tree_const_iterator"* %21, i32 0, i32 0
  %85 = load %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"** %84, align 8
  %86 = getelementptr inbounds %"class.std::back_insert_iterator", %"class.std::back_insert_iterator"* %22, i32 0, i32 0
  %87 = load %"class.std::vector"*, %"class.std::vector"** %86, align 8
  %88 = call %"class.std::vector"* @_ZSt4copyISt23_Rb_tree_const_iteratorIiESt20back_insert_iteratorISt6vectorIiSaIiEEEET0_T_S8_S7_(%"struct.std::_Rb_tree_node_base"* %83, %"struct.std::_Rb_tree_node_base"* %85, %"class.std::vector"* %87)
  %89 = getelementptr inbounds %"class.std::back_insert_iterator", %"class.std::back_insert_iterator"* %19, i32 0, i32 0
  ...
  %94 = getelementptr inbounds %"class.std::back_insert_iterator", %"class.std::back_insert_iterator"* %19, i32 0, i32 0
  %95 = load %"class.std::vector"*, %"class.std::vector"** %94, align 8
  %96 = call %"class.std::vector"* @_ZSt4copyISt23_Rb_tree_const_iteratorIiESt20back_insert_iteratorISt6vectorIiSaIiEEEET0_T_S8_S7_(%"struct.std::_Rb_tree_node_base"* %91, %"struct.std::_Rb_tree_node_base"* %93, %"class.std::vector"* %95)
  %97 = getelementptr inbounds %"class.std::back_insert_iterator", %"class.std::back_insert_iterator"* %6, i32 0, i32 0
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(8) %"class.std::back_insert_iterator"* @_ZNSt20back_insert_iteratorISt6vectorIiSaIiEEEdeEv(%"class.std::back_insert_iterator"* %0) #5 comdat align 2 {
  ret %"class.std::back_insert_iterator"* %0
}

; Function Attrs: noinline uwtable
define linkonce_odr dereferenceable(8) %"class.std::back_insert_iterator"* @_ZNSt20back_insert_iteratorISt6vectorIiSaIiEEEaSERKi(%"class.std::back_insert_iterator"* %0, i32* dereferenceable(4) %1) #0 comdat align 2 {
  %3 = getelementptr inbounds %"class.std::back_insert_iterator", %"class.std::back_insert_iterator"* %0, i32 0, i32 0
  %4 = load %"class.std::vector"*, %"class.std::vector"** %3, align 8
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %4, i32* dereferenceable(4) %1)
  ret %"class.std::back_insert_iterator"* %0
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(8) %"class.std::back_insert_iterator"* @_ZNSt20back_insert_iteratorISt6vectorIiSaIiEEEppEv(%"class.std::back_insert_iterator"* %0) #5 comdat align 2 {
  ret %"class.std::back_insert_iterator"* %0
}

; Function Attrs: noinline uwtable
define linkonce_odr %"class.std::vector"* @_ZSt4copyISt23_Rb_tree_const_iteratorIiESt20back_insert_iteratorISt6vectorIiSaIiEEEET0_T_S8_S7_(%"struct.std::_Rb_tree_node_base"* %0, %"struct.std::_Rb_tree_node_base"* %1, %"class.std::vector"* %2) #0 comdat {
  ...
  %19 = load %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"** %18, align 8
  %20 = call %"struct.std::_Rb_tree_node_base"* @_ZSt12__miter_baseISt23_Rb_tree_const_iteratorIiEET_S2_(%"struct.std::_Rb_tree_node_base"* %19)
  ...
  %22 = bitcast %"struct.std::_Rb_tree_const_iterator"* %11 to i8*
  %23 = bitcast %"struct.std::_Rb_tree_const_iterator"* %6 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %22, i8* align 8 %23, i64 8, i1 false)
  %24 = getelementptr inbounds %"struct.std::_Rb_tree_const_iterator", %"struct.std::_Rb_tree_const_iterator"* %11, i32 0, i32 0
  %25 = load %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"** %24, align 8
  %26 = call %"struct.std::_Rb_tree_node_base"* @_ZSt12__miter_baseISt23_Rb_tree_const_iteratorIiEET_S2_(%"struct.std::_Rb_tree_node_base"* %25)
  ...
  %36 = call %"class.std::vector"* @_ZSt14__copy_move_a2ILb0ESt23_Rb_tree_const_iteratorIiESt20back_insert_iteratorISt6vectorIiSaIiEEEET1_T0_S8_S7_(%"struct.std::_Rb_tree_node_base"* %31, %"struct.std::_Rb_tree_node_base"* %33, %"class.std::vector"* %35)
...
; Function Attrs: noinline uwtable
define linkonce_odr %"class.std::vector"* @_ZSt14__copy_move_a2ILb0ESt23_Rb_tree_const_iteratorIiESt20back_insert_iteratorISt6vectorIiSaIiEEEET1_T0_S8_S7_(%"struct.std::_Rb_tree_node_base"* %0, %"struct.std::_Rb_tree_node_base"* %1, %"class.std::vector"* %2) #0 comdat {
  %4 = alloca %"class.std::back_insert_iterator", align 8
  %5 = alloca %"struct.std::_Rb_tree_const_iterator", align 8
  %6 = alloca %"struct.std::_Rb_tree_const_iterator", align 8
  %7 = alloca %"class.std::back_insert_iterator", align 8
  ...
  %16 = getelementptr inbounds %"class.std::back_insert_iterator", %"class.std::back_insert_iterator"* %7, i32 0, i32 0
  ...
  %21 = call %"struct.std::_Rb_tree_node_base"* @_ZSt12__niter_baseISt23_Rb_tree_const_iteratorIiEET_S2_(%"struct.std::_Rb_tree_node_base"* %20)
  ...
  %24 = bitcast %"struct.std::_Rb_tree_const_iterator"* %6 to i8*
  ...
  %27 = call %"struct.std::_Rb_tree_node_base"* @_ZSt12__niter_baseISt23_Rb_tree_const_iteratorIiEET_S2_(%"struct.std::_Rb_tree_node_base"* %26)
  %28 = getelementptr inbounds %"struct.std::_Rb_tree_const_iterator", %"struct.std::_Rb_tree_const_iterator"* %10, i32 0, i32 0
  store %"struct.std::_Rb_tree_node_base"* %27, %"struct.std::_Rb_tree_node_base"** %28, align 8
  %29 = bitcast %"class.std::back_insert_iterator"* %13 to i8*
  %30 = bitcast %"class.std::back_insert_iterator"* %7 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %29, i8* align 8 %30, i64 8, i1 false)
  %31 = getelementptr inbounds %"class.std::back_insert_iterator", %"class.std::back_insert_iterator"* %13, i32 0, i32 0
  %32 = load %"class.std::vector"*, %"class.std::vector"** %31, align 8
  %33 = call %"class.std::vector"* @_ZSt12__niter_baseISt20back_insert_iteratorISt6vectorIiSaIiEEEET_S5_(%"class.std::vector"* %32)
  %34 = getelementptr inbounds %"class.std::back_insert_iterator", %"class.std::back_insert_iterator"* %12, i32 0, i32 0
  ...
  %37 = getelementptr inbounds %"struct.std::_Rb_tree_const_iterator", %"struct.std::_Rb_tree_const_iterator"* %10, i32 0, i32 0
  %38 = load %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"** %37, align 8
  %39 = getelementptr inbounds %"class.std::back_insert_iterator", %"class.std::back_insert_iterator"* %12, i32 0, i32 0
  %40 = load %"class.std::vector"*, %"class.std::vector"** %39, align 8
  %41 = call %"class.std::vector"* @_ZSt13__copy_move_aILb0ESt23_Rb_tree_const_iteratorIiESt20back_insert_iteratorISt6vectorIiSaIiEEEET1_T0_S8_S7_(%"struct.std::_Rb_tree_node_base"* %36, %"struct.std::_Rb_tree_node_base"* %38, %"class.std::vector"* %40)
  %42 = getelementptr inbounds %"class.std::back_insert_iterator", %"class.std::back_insert_iterator"* %4, i32 0, i32 0
...
; Function Attrs: noinline uwtable
define linkonce_odr %"class.std::vector"* @_ZSt13__copy_move_aILb0ESt23_Rb_tree_const_iteratorIiESt20back_insert_iteratorISt6vectorIiSaIiEEEET1_T0_S8_S7_(%"struct.std::_Rb_tree_node_base"* %0, %"struct.std::_Rb_tree_node_base"* %1, %"class.std::vector"* %2) #0 comdat {
  %4 = alloca %"class.std::back_insert_iterator", align 8
  %5 = alloca %"struct.std::_Rb_tree_const_iterator", align 8
  %6 = alloca %"struct.std::_Rb_tree_const_iterator", align 8
  %7 = alloca %"class.std::back_insert_iterator", align 8
  ...
  %13 = getelementptr inbounds %"class.std::back_insert_iterator", %"class.std::back_insert_iterator"* %7, i32 0, i32 0
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %16, i8* align 8 %17, i64 8, i1 false)
  %18 = bitcast %"class.std::back_insert_iterator"* %10 to i8*
  %19 = bitcast %"class.std::back_insert_iterator"* %7 to i8*
  ...
  %23 = load %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"** %22, align 8
  %24 = getelementptr inbounds %"class.std::back_insert_iterator", %"class.std::back_insert_iterator"* %10, i32 0, i32 0
  %25 = load %"class.std::vector"*, %"class.std::vector"** %24, align 8
  %26 = call %"class.std::vector"* @_ZNSt11__copy_moveILb0ELb0ESt26bidirectional_iterator_tagE8__copy_mISt23_Rb_tree_const_iteratorIiESt20back_insert_iteratorISt6vectorIiSaIiEEEEET0_T_SB_SA_(%"struct.std::_Rb_tree_node_base"* %21, %"struct.std::_Rb_tree_node_base"* %23, %"class.std::vector"* %25)
  %27 = getelementptr inbounds %"class.std::back_insert_iterator", %"class.std::back_insert_iterator"* %4, i32 0, i32 0
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr %"class.std::vector"* @_ZSt12__niter_baseISt20back_insert_iteratorISt6vectorIiSaIiEEEET_S5_(%"class.std::vector"* %0) #5 comdat {
  %2 = alloca %"class.std::back_insert_iterator", align 8
...
; Function Attrs: noinline uwtable
define linkonce_odr %"class.std::vector"* @_ZNSt11__copy_moveILb0ELb0ESt26bidirectional_iterator_tagE8__copy_mISt23_Rb_tree_const_iteratorIiESt20back_insert_iteratorISt6vectorIiSaIiEEEEET0_T_SB_SA_(%"struct.std::_Rb_tree_node_base"* %0, %"struct.std::_Rb_tree_node_base"* %1, %"class.std::vector"* %2) #0 comdat align 2 {
  %4 = alloca %"class.std::back_insert_iterator", align 8
  %5 = alloca %"struct.std::_Rb_tree_const_iterator", align 8
  %6 = alloca %"struct.std::_Rb_tree_const_iterator", align 8
  %7 = alloca %"class.std::back_insert_iterator", align 8
  ...
  %10 = getelementptr inbounds %"class.std::back_insert_iterator", %"class.std::back_insert_iterator"* %7, i32 0, i32 0
...
13:                                               ; preds = %11
  ...
  %15 = call dereferenceable(8) %"class.std::back_insert_iterator"* @_ZNSt20back_insert_iteratorISt6vectorIiSaIiEEEdeEv(%"class.std::back_insert_iterator"* %7)
  %16 = call dereferenceable(8) %"class.std::back_insert_iterator"* @_ZNSt20back_insert_iteratorISt6vectorIiSaIiEEEaSERKi(%"class.std::back_insert_iterator"* %15, i32* dereferenceable(4) %14)
  br label %17

17:                                               ; preds = %13
  %18 = call dereferenceable(8) %"class.std::back_insert_iterator"* @_ZNSt20back_insert_iteratorISt6vectorIiSaIiEEEppEv(%"class.std::back_insert_iterator"* %7)
  %19 = call dereferenceable(8) %"struct.std::_Rb_tree_const_iterator"* @_ZNSt23_Rb_tree_const_iteratorIiEppEv(%"struct.std::_Rb_tree_const_iterator"* %5) #3
  br label %11

20:                                               ; preds = %11
  %21 = bitcast %"class.std::back_insert_iterator"* %4 to i8*
  %22 = bitcast %"class.std::back_insert_iterator"* %7 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %21, i8* align 8 %22, i64 8, i1 false)
  %23 = getelementptr inbounds %"class.std::back_insert_iterator", %"class.std::back_insert_iterator"* %4, i32 0, i32 0
  %24 = load %"class.std::vector"*, %"class.std::vector"** %23, align 8
  ret %"class.std::vector"* %24
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s151480132.cpp() #0 section ".text.startup" {
