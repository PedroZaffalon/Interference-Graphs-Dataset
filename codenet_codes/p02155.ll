; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02155/s580827041.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02155/s580827041.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s580827041.cpp, i8* null }]
...
12:                                               ; preds = %0
  ...
  %13 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZrsIxERSiS0_RSt6vectorIT_SaIS2_EE(%"class.std::basic_istream"* dereferenceable(280) @_ZSt3cin, %"class.std::vector"* dereferenceable(24) %3)
          to label %14 unwind label %31

14:                                               ; preds = %12
  %15 = call i64* @_ZNSt6vectorIxSaIxEE5beginEv(%"class.std::vector"* %3) #3
  %16 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %5, i32 0, i32 0
  store i64* %15, i64** %16, align 8
  %17 = call i64* @_ZNSt6vectorIxSaIxEE3endEv(%"class.std::vector"* %3) #3
...
42:                                               ; preds = %40
  %43 = call dereferenceable(8) i64* @_ZNK9__gnu_cxx17__normal_iteratorIPxSt6vectorIxSaIxEEEdeEv(%"class.__gnu_cxx::__normal_iterator"* %7) #3
...
51:                                               ; preds = %58, %50
  %.03 = phi i64 [ 0, %50 ], [ %57, %58 ]
  %.0 = phi i64 [ 0, %50 ], [ %59, %58 ]
...
67:                                               ; preds = %60
  %68 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i32 0, i32 0))
...
73:                                               ; preds = %31, %27
  ...
  %74 = insertvalue { i8*, i32 } undef, i8* %.01, 0
  %75 = insertvalue { i8*, i32 } %74, i32 %.02, 1
  resume { i8*, i32 } %75
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s580827041.cpp() #0 section ".text.startup" {
