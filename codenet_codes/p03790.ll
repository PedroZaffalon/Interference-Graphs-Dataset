; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03790/s447288511.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03790/s447288511.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s447288511.cpp, i8* null }]
...
71:                                               ; preds = %28
  ...
  invoke void @_ZNSt6vectorIxSaIxEEC2EmRKS0_(%"class.std::vector.0"* %7, i64 %74, %"class.std::allocator.2"* dereferenceable(1) %8)
...
97:                                               ; preds = %76
  ...
  invoke void @_ZNSt6vectorIxSaIxEEC2EmRKS0_(%"class.std::vector.0"* %9, i64 %103, %"class.std::allocator.2"* dereferenceable(1) %10)
...
107:                                              ; preds = %183, %104
  %.09 = phi i32 [ %106, %104 ], [ %184, %183 ]
  %108 = icmp sge i32 %.09, 0
...
112:                                              ; preds = %162, %109
  %.010 = phi i64 [ %111, %109 ], [ %.111, %162 ]
  %.08 = phi i32 [ %.09, %109 ], [ %163, %162 ]
...
155:                                              ; preds = %134
  ...
  %159 = add nsw i64 %.010, %158
  %160 = sext i32 %.09 to i64
  %161 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector.0"* %9, i64 %160) #3
  store i64 %159, i64* %161, align 8
  br label %164

162:                                              ; preds = %139, %123
  %.111 = phi i64 [ %129, %123 ], [ %154, %139 ]
  %163 = add nsw i32 %.08, 1
  br label %112

164:                                              ; preds = %155, %112
  %165 = sext i32 %.09 to i64
  %166 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector.0"* %7, i64 %165) #3
...
172:                                              ; preds = %164
  ...
  %174 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector.0"* %9, i64 %173) #3
  %175 = invoke dereferenceable(8) i64* @_ZSt3minIxERKT_S2_S2_(i64* dereferenceable(8) %11, i64* dereferenceable(8) %174)
...
193:                                              ; preds = %178, %130
  %.02 = phi i32 [ %181, %178 ], [ %133, %130 ]
  %.01 = phi i8* [ %180, %178 ], [ %132, %130 ]
  call void @_ZNSt6vectorIxSaIxEED2Ev(%"class.std::vector.0"* %7) #3
  br label %195
...
195:                                              ; preds = %193, %93, %64
  %.13 = phi i32 [ %67, %64 ], [ %.02, %193 ], [ %96, %93 ]
  %.1 = phi i8* [ %66, %64 ], [ %.01, %193 ], [ %95, %93 ]
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %5) #3
  br label %196

196:                                              ; preds = %195, %60
  %.24 = phi i32 [ %.13, %195 ], [ %63, %60 ]
  %.2 = phi i8* [ %.1, %195 ], [ %62, %60 ]
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %3) #3
  br label %197

197:                                              ; preds = %196, %56
  %.35 = phi i32 [ %.24, %196 ], [ %59, %56 ]
  %.3 = phi i8* [ %.2, %196 ], [ %58, %56 ]
  %198 = insertvalue { i8*, i32 } undef, i8* %.3, 0
  %199 = insertvalue { i8*, i32 } %198, i32 %.35, 1
  resume { i8*, i32 } %199
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s447288511.cpp() #0 section ".text.startup" {
