; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02022/s787210997.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02022/s787210997.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s787210997.cpp, i8* null }]
...
22:                                               ; preds = %29, %0
  %.02 = phi i64 [ 0, %0 ], [ %30, %29 ]
  %.01 = phi i64 [ 0, %0 ], [ %28, %29 ]
...
32:                                               ; preds = %40, %31
  %.03 = phi i64 [ 0, %31 ], [ %39, %40 ]
  %.0 = phi i64 [ 0, %31 ], [ %41, %40 ]
...
35:                                               ; preds = %32
  ...
  %38 = mul nsw i64 %37, %.01
  %39 = add nsw i64 %.03, %38
  br label %40
...
42:                                               ; preds = %32
  %43 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEx(%"class.std::basic_ostream"* @_ZSt4cout, i64 %.03)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s787210997.cpp() #0 section ".text.startup" {
