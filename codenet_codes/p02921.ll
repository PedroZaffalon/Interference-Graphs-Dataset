; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02921/s734701632.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02921/s734701632.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s734701632.cpp, i8* null }]
...
32:                                               ; preds = %7
  %33 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %.01)
...
37:                                               ; preds = %25
  %38 = insertvalue { i8*, i32 } undef, i8* %27, 0
  %39 = insertvalue { i8*, i32 } %38, i32 %28, 1
  resume { i8*, i32 } %39
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s734701632.cpp() #0 section ".text.startup" {
