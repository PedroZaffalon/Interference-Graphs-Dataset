; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03111/s613550888.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03111/s613550888.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s613550888.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define i32 @_Z3reciiii(i32 %0, i32 %1, i32 %2, i32 %3) #0 {
...
18:                                               ; preds = %15
  ...
  %27 = sub nsw i32 %26, %3
  %28 = call i32 @abs(i32 %27) #13
  %29 = add nsw i32 %25, %28
  br label %70

30:                                               ; preds = %4
  %31 = add nsw i32 %0, 1
  %32 = call i32 @_Z3reciiii(i32 %31, i32 %1, i32 %2, i32 %3)
  ...
  %37 = add nsw i32 %1, %36
  %38 = call i32 @_Z3reciiii(i32 %33, i32 %37, i32 %2, i32 %3)
  %39 = icmp ne i32 %1, 0
  %40 = zext i1 %39 to i64
  %41 = select i1 %39, i32 10, i32 0
  ...
  %49 = add nsw i32 %2, %48
  %50 = call i32 @_Z3reciiii(i32 %45, i32 %1, i32 %49, i32 %3)
  %51 = icmp ne i32 %2, 0
  %52 = zext i1 %51 to i64
  %53 = select i1 %51, i32 10, i32 0
  ...
  %61 = add nsw i32 %3, %60
  %62 = call i32 @_Z3reciiii(i32 %57, i32 %1, i32 %2, i32 %61)
  %63 = icmp ne i32 %3, 0
  %64 = zext i1 %63 to i64
  %65 = select i1 %63, i32 10, i32 0
  %66 = add nsw i32 %62, %65
  store i32 %66, i32* %8, align 4
  %67 = call dereferenceable(4) i32* @_ZSt3minIiERKT_S2_S2_(i32* dereferenceable(4) %5, i32* dereferenceable(4) %8)
...
70:                                               ; preds = %30, %18, %17
  %.0 = phi i32 [ %29, %18 ], [ 1000000000, %17 ], [ %69, %30 ]
  ret i32 %.0
}
...
define i32 @main() #6 {
  ...
  %6 = sext i32 %5 to i64
  call void @_ZNSt6vectorIiSaIiEE6resizeEm(%"class.std::vector"* @l, i64 %6)
  br label %7
...
10:                                               ; preds = %7
  ...
  %12 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* @l, i64 %11) #3
...
16:                                               ; preds = %7
  %17 = call i32 @_Z3reciiii(i32 0, i32 0, i32 0, i32 0)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s613550888.cpp() #0 section ".text.startup" {
