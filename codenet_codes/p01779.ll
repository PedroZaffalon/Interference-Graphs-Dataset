; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01779/s155609503.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01779/s155609503.cpp"
...
@.str.2 = private unnamed_addr constant [19 x i8] c"! Game Clear %.1f\0A\00", align 1
@stdout = external global %struct._IO_FILE*, align 8
@.str.3 = private unnamed_addr constant [13 x i8] c"! Game Over\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s155609503.cpp, i8* null }]
...
define i32 @main() #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  invoke void @_ZNSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EEC2EmRKS6_(%"class.std::vector"* %3, i64 %11, %"class.std::allocator"* dereferenceable(1) %4)
...
12:                                               ; preds = %0
  ...
  invoke void @_ZNSt6vectorIiSaIiEEC2EmRKS0_(%"class.std::vector.3"* %5, i64 %14, %"class.std::allocator.5"* dereferenceable(1) %6)
...
19:                                               ; preds = %16
  ...
  %21 = call dereferenceable(32) %"class.std::__cxx11::basic_string"* @_ZNSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EEixEm(%"class.std::vector"* %3, i64 %20) #3
...
23:                                               ; preds = %19
  ...
  %25 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.3"* %5, i64 %24) #3
  %26 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* %22, i32* dereferenceable(4) %25)
...
38:                                               ; preds = %121, %119, %115, %109, %107, %79, %56, %54, %52, %48, %46, %23, %19
...
43:                                               ; preds = %103, %94, %42
  %.011 = phi i32 [ 0, %42 ], [ %.112, %94 ], [ %96, %103 ]
  %.09 = phi i32 [ 0, %42 ], [ %74, %94 ], [ %74, %103 ]
  %.08 = phi i32 [ 0, %42 ], [ %85, %94 ], [ %.08, %103 ]
  %.06 = phi i32 [ 0, %42 ], [ %.17, %94 ], [ %.06, %103 ]
  %.04 = phi i32 [ 0, %42 ], [ %.15, %94 ], [ %.04, %103 ]
...
48:                                               ; preds = %46
  ...
  %51 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsIcSt11char_traitsIcESaIcEERSt13basic_ostreamIT_T0_ES7_RKNSt7__cxx1112basic_stringIS4_S5_T1_EE(%"class.std::basic_ostream"* dereferenceable(272) %47, %"class.std::__cxx11::basic_string"* dereferenceable(32) %50)
...
73:                                               ; preds = %68, %65, %61
  %.013 = phi i8 [ %72, %68 ], [ %62, %65 ], [ %62, %61 ]
  %74 = add nsw i32 %.09, 1
  %75 = sext i8 %.013 to i32
...
84:                                               ; preds = %79
  ...
  %89 = call dereferenceable(32) %"class.std::__cxx11::basic_string"* @_ZNSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EEixEm(%"class.std::vector"* %3, i64 %88) #3
...
94:                                               ; preds = %92, %84
  %.112 = phi i32 [ 0, %92 ], [ %.011, %84 ]
  %.17 = phi i32 [ 0, %92 ], [ %86, %84 ]
  %.15 = phi i32 [ %93, %92 ], [ %.04, %84 ]
  br label %43

95:                                               ; preds = %73
  %96 = add nsw i32 %.011, 1
  br label %97

97:                                               ; preds = %95
  %98 = sext i32 %.04 to i64
  %99 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.3"* %5, i64 %98) #3
...
104:                                              ; preds = %102, %43
  %.110 = phi i32 [ %74, %102 ], [ %.09, %43 ]
  %105 = load i32, i32* %1, align 4
  %106 = icmp eq i32 %.04, %105
  br i1 %106, label %107, label %119

107:                                              ; preds = %104
  %108 = invoke i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i32 0, i32 0))
          to label %109 unwind label %38

109:                                              ; preds = %107
  %110 = sitofp i32 %.08 to double
  %111 = fmul double 1.000000e+02, %110
  %112 = sitofp i32 %.110 to double
  %113 = fdiv double %111, %112
  %114 = invoke i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.2, i32 0, i32 0), double %113)
          to label %115 unwind label %38

115:                                              ; preds = %109
  %116 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8
  %117 = invoke i32 @fflush(%struct._IO_FILE* %116)
...
119:                                              ; preds = %104
  %120 = invoke i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.3, i32 0, i32 0))
          to label %121 unwind label %38

121:                                              ; preds = %119
  %122 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8
  %123 = invoke i32 @fflush(%struct._IO_FILE* %122)
...
127:                                              ; preds = %126, %30
  %.12 = phi i32 [ %.01, %126 ], [ %33, %30 ]
  %.1 = phi i8* [ %.0, %126 ], [ %32, %30 ]
  %128 = insertvalue { i8*, i32 } undef, i8* %.1, 0
  %129 = insertvalue { i8*, i32 } %128, i32 %.12, 1
  resume { i8*, i32 } %129
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s155609503.cpp() #0 section ".text.startup" {
