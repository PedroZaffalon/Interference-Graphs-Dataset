; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03920/s931054999.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03920/s931054999.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s931054999.cpp, i8* null }]
...
define i32 @main() #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  invoke void @_ZNSt6vectorIxSaIxEEC2EmRKxRKS0_(%"class.std::vector"* %2, i64 10000001, i64* dereferenceable(8) %3, %"class.std::allocator"* dereferenceable(1) %4)
...
12:                                               ; preds = %20, %11
  %.02 = phi i64 [ 1, %11 ], [ %21, %20 ]
  %13 = icmp sle i64 %.02, 10000000
...
14:                                               ; preds = %12
  ...
  %18 = add nsw i64 %17, %.02
  %19 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %2, i64 %.02) #3
...
26:                                               ; preds = %12
  %27 = call i64* @_ZNSt6vectorIxSaIxEE5beginEv(%"class.std::vector"* %2) #3
  %28 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %6, i32 0, i32 0
  store i64* %27, i64** %28, align 8
  %29 = call i64* @_ZNSt6vectorIxSaIxEE3endEv(%"class.std::vector"* %2) #3
  ...
  %35 = invoke i64* @_ZSt11lower_boundIN9__gnu_cxx17__normal_iteratorIPxSt6vectorIxSaIxEEEExET_S7_S7_RKT0_(i64* %32, i64* %34, i64* dereferenceable(8) %1)
...
36:                                               ; preds = %26
  ...
  %40 = call i64 @_ZN9__gnu_cxxmiIPxSt6vectorIxSaIxEEEENS_17__normal_iteratorIT_T0_E15difference_typeERKS8_SB_(%"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %5, %"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %9) #3
...
49:                                               ; preds = %47
  ...
  %55 = invoke dereferenceable(8) i64* @_ZSt3minIxERKT_S2_S2_(i64* dereferenceable(8) %1, i64* dereferenceable(8) %8)
...
63:                                               ; preds = %58, %22
  %.01 = phi i32 [ %61, %58 ], [ %25, %22 ]
  %.0 = phi i8* [ %60, %58 ], [ %24, %22 ]
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s931054999.cpp() #0 section ".text.startup" {
