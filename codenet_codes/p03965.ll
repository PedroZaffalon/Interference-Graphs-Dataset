; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03965/s134379456.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03965/s134379456.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s134379456.cpp, i8* null }]
...
31:                                               ; preds = %17
  %32 = insertvalue { i8*, i32 } undef, i8* %19, 0
  %33 = insertvalue { i8*, i32 } %32, i32 %20, 1
  resume { i8*, i32 } %33
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s134379456.cpp() #0 section ".text.startup" {
