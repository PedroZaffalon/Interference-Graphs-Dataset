; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01109/s254460012.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01109/s254460012.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s254460012.cpp, i8* null }]
...
12:                                               ; preds = %24, %11
  %.04 = phi i32 [ 0, %11 ], [ %25, %24 ]
  %.03 = phi i32 [ 0, %11 ], [ %23, %24 ]
...
35:                                               ; preds = %47, %34
  %.05 = phi i32 [ 0, %34 ], [ %46, %47 ]
  %.0 = phi i32 [ 0, %34 ], [ %48, %47 ]
...
38:                                               ; preds = %35
  ...
  %44 = icmp sle i32 %43, %.03
  %45 = zext i1 %44 to i32
  %46 = add nsw i32 %.05, %45
  br label %47
...
49:                                               ; preds = %35
  %50 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %.05)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s254460012.cpp() #0 section ".text.startup" {
