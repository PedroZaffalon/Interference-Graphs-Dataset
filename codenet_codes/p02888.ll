; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02888/s461479854.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02888/s461479854.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s461479854.cpp, i8* null }]
...
define i32 @main() #4 {
  ...
  %8 = bitcast [1000005 x i32]* %2 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %8, i8 0, i64 4000020, i1 false)
  br label %9

9:                                                ; preds = %23, %0
  %.04 = phi i32 [ 0, %0 ], [ %24, %23 ]
...
12:                                               ; preds = %9
  ...
  %20 = getelementptr inbounds [1000005 x i32], [1000005 x i32]* %2, i64 0, i64 %19
...
26:                                               ; preds = %37, %25
  %.03 = phi i32 [ 1, %25 ], [ %38, %37 ]
  %27 = icmp slt i32 %.03, 1000005
  br i1 %27, label %28, label %39

28:                                               ; preds = %26
  %29 = sub nsw i32 %.03, 1
  %30 = sext i32 %29 to i64
  %31 = getelementptr inbounds [1000005 x i32], [1000005 x i32]* %2, i64 0, i64 %30
  %32 = load i32, i32* %31, align 4
  %33 = sext i32 %.03 to i64
  %34 = getelementptr inbounds [1000005 x i32], [1000005 x i32]* %2, i64 0, i64 %33
...
39:                                               ; preds = %26
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* %7, i32* %42)
  br label %43

43:                                               ; preds = %75, %39
  %.02 = phi i32 [ 0, %39 ], [ %76, %75 ]
  %.01 = phi i64 [ 0, %39 ], [ %.1, %75 ]
...
48:                                               ; preds = %72, %46
  %.1 = phi i64 [ %.01, %46 ], [ %71, %72 ]
  %.0 = phi i32 [ %47, %46 ], [ %73, %72 ]
...
51:                                               ; preds = %48
  ...
  %61 = getelementptr inbounds [1000005 x i32], [1000005 x i32]* %2, i64 0, i64 %60
  %62 = load i32, i32* %61, align 4
  %63 = sext i32 %.0 to i64
  %64 = getelementptr inbounds i32, i32* %7, i64 %63
  %65 = load i32, i32* %64, align 4
  %66 = sext i32 %65 to i64
  %67 = getelementptr inbounds [1000005 x i32], [1000005 x i32]* %2, i64 0, i64 %66
...
77:                                               ; preds = %43
  %78 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEx(%"class.std::basic_ostream"* @_ZSt4cout, i64 %.01)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s461479854.cpp() #0 section ".text.startup" {
