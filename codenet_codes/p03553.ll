; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03553/s116579479.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03553/s116579479.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s116579479.cpp, i8* null }]
...
35:                                               ; preds = %64, %32
  %.05 = phi i32 [ %34, %32 ], [ %65, %64 ]
  %36 = icmp sge i32 %.05, 0
...
38:                                               ; preds = %47, %37
  %.04 = phi i64 [ 0, %37 ], [ %46, %47 ]
  %.03 = phi i32 [ %.05, %37 ], [ %49, %47 ]
...
66:                                               ; preds = %35
  %67 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector"* %2) #3
  %68 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %6, i32 0, i32 0
  store i32* %67, i32** %68, align 8
  %69 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector"* %2) #3
  ...
  %75 = invoke i64 @_ZSt10accumulateIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEExET0_T_S8_S7_(i32* %72, i32* %74, i64 0)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s116579479.cpp() #0 section ".text.startup" {
