; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03343/s329401513.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03343/s329401513.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s329401513.cpp, i8* null }]
...
5:                                                ; preds = %41, %2
  %.04 = phi i32 [ 1, %2 ], [ %42, %41 ]
  %.02 = phi i32 [ 0, %2 ], [ %.13, %41 ]
  %.0 = phi i32 [ 0, %2 ], [ %.1, %41 ]
...
9:                                                ; preds = %5
  ...
  %11 = getelementptr inbounds [2005 x i32], [2005 x i32]* @a, i64 0, i64 %10
  %12 = load i32, i32* %11, align 4
  %13 = sext i32 %0 to i64
  %14 = getelementptr inbounds [2005 x i32], [2005 x i32]* @c, i64 0, i64 %13
...
18:                                               ; preds = %32, %17
  %.01 = phi i32 [ %.02, %17 ], [ %19, %32 ]
  %19 = add nsw i32 %.01, 1
  %20 = icmp slt i32 %19, %.04
...
21:                                               ; preds = %18
  ...
  %26 = getelementptr inbounds [2005 x i32], [2005 x i32]* @c, i64 0, i64 %25
...
define i32 @main() #5 {
  ...
  %3 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i32 0, i32 0), i32* @n, i32* @k, i32* @q)
  br label %4
...
7:                                                ; preds = %4
  ...
  %9 = getelementptr inbounds [2005 x i32], [2005 x i32]* @a, i64 0, i64 %8
  %10 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i32 0, i32 0), i32* %9)
  %11 = sext i32 %.01 to i64
  %12 = getelementptr inbounds [2005 x i32], [2005 x i32]* @a, i64 0, i64 %11
  %13 = load i32, i32* %12, align 4
  %14 = sext i32 %.01 to i64
  %15 = getelementptr inbounds [2005 x i32], [2005 x i32]* @c, i64 0, i64 %14
...
18:                                               ; preds = %4
  ...
  %21 = getelementptr inbounds i32, i32* getelementptr inbounds ([2005 x i32], [2005 x i32]* @c, i32 0, i32 0), i64 %20
  %22 = getelementptr inbounds i32, i32* %21, i64 1
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([2005 x i32], [2005 x i32]* @c, i32 0, i64 1), i32* %22)
  br label %23

23:                                               ; preds = %51, %18
  %.12 = phi i32 [ 1, %18 ], [ %52, %51 ]
  %.0 = phi i32 [ 1, %18 ], [ %.1, %51 ]
...
27:                                               ; preds = %35, %26
  %.1 = phi i32 [ %.0, %26 ], [ %36, %35 ]
  %28 = load i32, i32* @n, align 4
  %29 = icmp sle i32 %.1, %28
  br i1 %29, label %30, label %33

30:                                               ; preds = %27
  %31 = call zeroext i1 @_Z5checkii(i32 %.12, i32 %.1)
  %32 = xor i1 %31, true
  br label %33
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s329401513.cpp() #0 section ".text.startup" {
