; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01800/s538918663.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01800/s538918663.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s538918663.cpp, i8* null }]
...
define i32 @main() #4 {
  ...
  %46 = call double @atan2(double %44, double %45) #3
...
50:                                               ; preds = %0
  %51 = call double @_ZSt4acosIiEN9__gnu_cxx11__enable_ifIXsr12__is_integerIT_EE7__valueEdE6__typeES2_(i32 -1)
...
59:                                               ; preds = %55
  call void @_ZSt4swapIdENSt9enable_ifIXsr6__and_ISt6__not_ISt15__is_tuple_likeIT_EESt21is_move_constructibleIS3_ESt18is_move_assignableIS3_EEE5valueEvE4typeERS3_SC_(double* dereferenceable(8) %6, double* dereferenceable(8) %7) #3
  br label %60
...
60:                                               ; preds = %59, %55
  ...
  %64 = call double @_ZSt4acosIiEN9__gnu_cxx11__enable_ifIXsr12__is_integerIT_EE7__valueEdE6__typeES2_(i32 -1)
  ...
  %70 = call dereferenceable(8) double* @_ZSt3minIdERKT_S2_S2_(double* dereferenceable(8) %8, double* dereferenceable(8) %9)
...
74:                                               ; preds = %98, %60
  %.03 = phi double [ 0.000000e+00, %60 ], [ %.14, %98 ]
  %.02 = phi double [ %73, %60 ], [ %.1, %98 ]
  %.01 = phi i64 [ 0, %60 ], [ %99, %98 ]
  %75 = icmp slt i64 %.01, 200
  br i1 %75, label %76, label %100

76:                                               ; preds = %74
  %77 = fadd double %.03, %.02
  %78 = fdiv double %77, 2.000000e+00
  %79 = load double, double* %5, align 8
  %80 = fdiv double %78, %79
  %81 = fmul double %43, %43
  %82 = fmul double %80, %80
  %83 = fsub double %81, %82
  %84 = call double @sqrt(double %83) #3
  %85 = call double @atan2(double %84, double %80) #3
  %86 = fcmp olt double %85, 0.000000e+00
  br i1 %86, label %87, label %91

87:                                               ; preds = %76
  %88 = call double @_ZSt4acosIiEN9__gnu_cxx11__enable_ifIXsr12__is_integerIT_EE7__valueEdE6__typeES2_(i32 -1)
  %89 = fmul double 2.000000e+00, %88
  %90 = fadd double %85, %89
  br label %91

91:                                               ; preds = %87, %76
  %.0 = phi double [ %90, %87 ], [ %85, %76 ]
  %92 = fadd double %71, %.0
  %93 = fmul double %80, %92
  %94 = fcmp ole double %84, %93
...
97:                                               ; preds = %96, %95
  %.14 = phi double [ %.03, %95 ], [ %78, %96 ]
  %.1 = phi double [ %78, %95 ], [ %.02, %96 ]
  br label %98
...
100:                                              ; preds = %74
  %101 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEd(%"class.std::basic_ostream"* @_ZSt4cout, double %.02)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s538918663.cpp() #0 section ".text.startup" {
