; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01574/s157970309.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01574/s157970309.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s157970309.cpp, i8* null }]
...
26:                                               ; preds = %24
  ...
  invoke void @"_ZZ4mainENK3$_0clExx"(%class.anon* %3, i64 %27, i64 %28)
...
44:                                               ; preds = %39, %33, %29
  invoke void @_ZNSt6vectorIiSaIiEE12emplace_backIJRxEEEvDpOT_(%"class.std::vector"* %5, i64* dereferenceable(8) %6)
...
62:                                               ; preds = %70, %55
  %63 = call zeroext i1 @_ZN9__gnu_cxxneIPiSt6vectorIiSaIiEEEEbRKNS_17__normal_iteratorIT_T0_EESA_(%"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %9, %"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %10) #3
...
64:                                               ; preds = %62
  ...
  invoke void @"_ZZ4mainENK3$_0clExx"(%class.anon* %3, i64 %67, i64 %68)
...
80:                                               ; preds = %40
  %81 = insertvalue { i8*, i32 } undef, i8* %42, 0
  %82 = insertvalue { i8*, i32 } %81, i32 %43, 1
  resume { i8*, i32 } %82
}
...
; Function Attrs: noinline uwtable
define internal void @"_ZZ4mainENK3$_0clExx"(%class.anon* %0, i64 %1, i64 %2) #0 align 2 {
  %4 = call i64 @_ZSt5__gcdIxET_S0_S0_(i64 %1, i64 %2)
  %5 = icmp eq i64 %4, 1
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt6vectorIiSaIiEE12emplace_backIJRxEEEvDpOT_(%"class.std::vector"* %0, i64* dereferenceable(8) %1) #0 comdat align 2 {
...
13:                                               ; preds = %2
  ...
  call void @_ZNSt16allocator_traitsISaIiEE9constructIiJRxEEEvRS0_PT_DpOT0_(%"class.std::allocator"* dereferenceable(1) %16, i32* %20, i64* dereferenceable(8) %21)
...
27:                                               ; preds = %2
  ...
  call void @_ZNSt6vectorIiSaIiEE17_M_realloc_insertIJRxEEEvN9__gnu_cxx17__normal_iteratorIPiS1_EEDpOT_(%"class.std::vector"* %0, i32* %32, i64* dereferenceable(8) %30)
  br label %33
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt16allocator_traitsISaIiEE9constructIiJRxEEEvRS0_PT_DpOT0_(%"class.std::allocator"* dereferenceable(1) %0, i32* %1, i64* dereferenceable(8) %2) #0 comdat align 2 {
  %4 = bitcast %"class.std::allocator"* %0 to %"class.__gnu_cxx::new_allocator"*
  %5 = call dereferenceable(8) i64* @_ZSt7forwardIRxEOT_RNSt16remove_referenceIS1_E4typeE(i64* dereferenceable(8) %2) #3
  call void @_ZN9__gnu_cxx13new_allocatorIiE9constructIiJRxEEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator"* %4, i32* %1, i64* dereferenceable(8) %5)
  ret void
}
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt6vectorIiSaIiEE17_M_realloc_insertIJRxEEEvN9__gnu_cxx17__normal_iteratorIPiS1_EEDpOT_(%"class.std::vector"* %0, i32* %1, i64* dereferenceable(8) %2) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  invoke void @_ZNSt16allocator_traitsISaIiEE9constructIiJRxEEEvRS0_PT_DpOT0_(%"class.std::allocator"* dereferenceable(1) %23, i32* %24, i64* dereferenceable(8) %25)
          to label %26 unwind label %40
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorIiE9constructIiJRxEEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator"* %0, i32* %1, i64* dereferenceable(8) %2) #5 comdat align 2 {
  %4 = bitcast i32* %1 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s157970309.cpp() #0 section ".text.startup" {
