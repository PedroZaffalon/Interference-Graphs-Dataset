; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03704/s492175135.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03704/s492175135.c"
...
@p10 = common global [32 x i64] zeroinitializer, align 16
...
3:                                                ; preds = %1
  %4 = getelementptr inbounds [32 x i64], [32 x i64]* @p10, i64 0, i64 %.0
  store i64 %.01, i64* %4, align 8
  %5 = mul nsw i64 %.01, 10
  br label %6
...
; Function Attrs: noinline nounwind uwtable
define void @rep(i64 %0, i64 %1, i64 %2, i64 %3) #0 {
  %5 = icmp sle i64 %1, 0
...
15:                                               ; preds = %13, %10
  %.01 = phi i64 [ %14, %13 ], [ %1, %10 ]
  %16 = icmp eq i64 %0, 0
  br i1 %16, label %17, label %20

17:                                               ; preds = %15
  %18 = load i64, i64* @r, align 8
  %19 = add nsw i64 %18, %.01
...
21:                                               ; preds = %7
  %22 = sub nsw i64 %3, %2
  %23 = getelementptr inbounds [32 x i64], [32 x i64]* @p10, i64 0, i64 %22
  %24 = load i64, i64* %23, align 8
  %25 = sub nsw i64 %2, 1
  %26 = getelementptr inbounds [32 x i64], [32 x i64]* @p10, i64 0, i64 %25
  %27 = load i64, i64* %26, align 8
  %28 = sub nsw i64 %24, %27
  br label %29

29:                                               ; preds = %36, %21
  %.03 = phi i64 [ 9, %21 ], [ %37, %36 ]
  %30 = icmp sge i64 %.03, -9
  br i1 %30, label %31, label %38

31:                                               ; preds = %29
  %32 = mul nsw i64 %28, %.03
...
41:                                               ; preds = %40, %38
  %.0 = phi i64 [ 1, %40 ], [ 0, %38 ]
  %42 = mul nsw i64 %28, %.02
  %43 = sub nsw i64 %0, %42
  %44 = sub nsw i64 10, %.0
  %45 = call i64 @llzt(i64 0, i64 %.02)
  %46 = sub nsw i64 %44, %45
  %47 = mul nsw i64 %1, %46
  %48 = add nsw i64 %2, 1
  call void @rep(i64 %43, i64 %47, i64 %48, i64 %3)
  %49 = add nsw i64 %.02, 1
  %50 = mul nsw i64 %28, %49
  %51 = sub nsw i64 %0, %50
  %52 = sub nsw i64 10, %.0
  %53 = call i64 @llzt(i64 0, i64 %49)
  %54 = sub nsw i64 %52, %53
  %55 = mul nsw i64 %1, %54
  %56 = add nsw i64 %2, 1
  call void @rep(i64 %51, i64 %55, i64 %56, i64 %3)
  br label %57
...
5:                                                ; preds = %3
  ...
  call void @rep(i64 %6, i64 1, i64 1, i64 %.0)
  br label %7
...
9:                                                ; preds = %3
  ...
  %11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i32 0, i32 0), i64 %10)
  ret i32 0
}
