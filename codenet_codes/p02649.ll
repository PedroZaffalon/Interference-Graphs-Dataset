; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02649/s982465580.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02649/s982465580.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s982465580.cpp, i8* null }]
...
18:                                               ; preds = %15
  ...
  %20 = invoke dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEE2atEm(%"class.std::vector"* %5, i64 %19)
          to label %21 unwind label %50

21:                                               ; preds = %18
  %22 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* @_ZSt3cin, i32* dereferenceable(4) %20)
          to label %23 unwind label %50

23:                                               ; preds = %21
  %24 = sext i32 %.03 to i64
  %25 = invoke dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEE2atEm(%"class.std::vector"* %5, i64 %24)
...
44:                                               ; preds = %41
  invoke void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %7, i32* dereferenceable(4) %43)
...
50:                                               ; preds = %78, %75, %64, %61, %44, %41, %32, %23, %21, %18
...
75:                                               ; preds = %68
  ...
  %77 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEm(%"class.std::basic_ostream"* @_ZSt4cout, i64 %76)
...
81:                                               ; preds = %80, %66
  %.04 = phi i32 [ 1, %66 ], [ 0, %80 ]
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %7) #3
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %5) #3
  switch i32 %.04, label %86 [
    i32 0, label %82
    i32 1, label %82
  ]
...
83:                                               ; preds = %50, %46
  %.02 = phi i32 [ %53, %50 ], [ %49, %46 ]
  %.01 = phi i8* [ %52, %50 ], [ %48, %46 ]
...
5:                                                ; preds = %2
  ...
  call void (i8*, ...) @_ZSt24__throw_out_of_range_fmtPKcz(i8* getelementptr inbounds ([74 x i8], [74 x i8]* @.str, i32 0, i32 0), i64 %1, i64 %6) #12
  unreachable
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s982465580.cpp() #0 section ".text.startup" {
