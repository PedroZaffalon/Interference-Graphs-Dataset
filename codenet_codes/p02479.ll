; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02479/s095103027.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02479/s095103027.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s095103027.cpp, i8* null }]
...
define i32 @main() #4 {
  ...
  %9 = call i32 @_ZNSt8ios_base4setfESt13_Ios_FmtflagsS0_(%"class.std::ios_base"* %8, i32 4, i32 260)
  ...
  %19 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEd(%"class.std::basic_ostream"* %15, double %18)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s095103027.cpp() #0 section ".text.startup" {
