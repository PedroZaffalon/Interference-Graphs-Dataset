; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01847/s226564379.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01847/s226564379.cpp"
...
%struct.LazySegmentTree = type { i32, i32, %class.anon, %class.anon.10, %class.anon.12, %"struct.std::pair", i32, %"class.std::vector.14", %"class.std::vector.5" }
%class.anon = type { i8 }
...
$_Z5chminIixEvRT_RKT0_ = comdat any

$_Z5chmaxIixEvRT_RKT0_ = comdat any
...
@.str = private unnamed_addr constant [29 x i8] c"sg.query(0, MAXW).first == 0\00", align 1
@.str.1 = private unnamed_addr constant [71 x i8] c"/home/pedro/tcc/exDataset/codenet/data/selection/p01847/s226564379.cpp\00", align 1
@__PRETTY_FUNCTION__._Z5solvev = private unnamed_addr constant [13 x i8] c"bool solve()\00", align 1
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@.str.2 = private unnamed_addr constant [26 x i8] c"vector::_M_realloc_insert\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s226564379.cpp, i8* null }]
...
40:                                               ; preds = %0
  ...
  invoke void @_ZNSt6vectorIxSaIxEEC2EmRKS0_(%"class.std::vector"* %2, i64 %42, %"class.std::allocator"* dereferenceable(1) %3)
...
83:                                               ; preds = %47
  ...
  invoke void @_ZNSt6vectorIxSaIxEEC2EmRKS0_(%"class.std::vector"* %6, i64 4, %"class.std::allocator"* dereferenceable(1) %7)
          to label %84 unwind label %109

84:                                               ; preds = %83
  call void @_ZNSaIxED2Ev(%"class.std::allocator"* %7) #3
  call void @_ZNSaIxEC2Ev(%"class.std::allocator"* %9) #3
  invoke void @_ZNSt6vectorIxSaIxEEC2EmRKS0_(%"class.std::vector"* %8, i64 4, %"class.std::allocator"* dereferenceable(1) %9)
...
86:                                               ; preds = %107, %85
  %.015 = phi i32 [ 0, %85 ], [ %108, %107 ]
  %87 = icmp slt i32 %.015, 4
...
121:                                              ; preds = %86
  %122 = sext i32 40010 to i64
  call void @_ZNSaISt6vectorIiSaIiEEEC2Ev(%"class.std::allocator.2"* %11) #3
  invoke void @_ZNSt6vectorIS_IiSaIiEESaIS1_EEC2EmRKS2_(%"class.std::vector.0"* %10, i64 %122, %"class.std::allocator.2"* dereferenceable(1) %11)
...
124:                                              ; preds = %183, %123
  %.016 = phi i32 [ 0, %123 ], [ %184, %183 ]
  %125 = load i32, i32* %1, align 4
  %126 = icmp slt i32 %.016, %125
...
143:                                              ; preds = %127
  ...
  %146 = add nsw i32 %.016, 1
  %147 = load i32, i32* %1, align 4
  %148 = srem i32 %146, %147
  %149 = sext i32 %148 to i64
  %150 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %4, i64 %149) #3
  %151 = invoke dereferenceable(8) i64* @_ZSt3minIxERKT_S2_S2_(i64* dereferenceable(8) %145, i64* dereferenceable(8) %150)
...
152:                                              ; preds = %143
  ...
  %157 = add nsw i32 %.016, 1
  %158 = load i32, i32* %1, align 4
  %159 = srem i32 %157, %158
  %160 = sext i32 %159 to i64
  %161 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %4, i64 %160) #3
  %162 = invoke dereferenceable(8) i64* @_ZSt3maxIxERKT_S2_S2_(i64* dereferenceable(8) %156, i64* dereferenceable(8) %161)
...
166:                                              ; preds = %176, %163
  %.020 = phi i32 [ %154, %163 ], [ %177, %176 ]
  %167 = icmp slt i32 %.020, %165
  br i1 %167, label %168, label %182

168:                                              ; preds = %166
  %169 = sext i32 %.020 to i64
  %170 = call dereferenceable(24) %"class.std::vector.5"* @_ZNSt6vectorIS_IiSaIiEESaIS1_EEixEm(%"class.std::vector.0"* %10, i64 %169) #3
  ...
  invoke void @_ZNSt6vectorIiSaIiEE9push_backEOi(%"class.std::vector.5"* %170, i32* dereferenceable(4) %12)
...
186:                                              ; preds = %202, %185
  %.021 = phi i32 [ 0, %185 ], [ %203, %202 ]
  %187 = icmp slt i32 %.021, 40010
  br i1 %187, label %188, label %204

188:                                              ; preds = %186
  %189 = sext i32 %.021 to i64
  %190 = call dereferenceable(24) %"class.std::vector.5"* @_ZNSt6vectorIS_IiSaIiEESaIS1_EEixEm(%"class.std::vector.0"* %10, i64 %189) #3
  %191 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector.5"* %190) #3
  ...
  %194 = call dereferenceable(24) %"class.std::vector.5"* @_ZNSt6vectorIS_IiSaIiEESaIS1_EEixEm(%"class.std::vector.0"* %10, i64 %193) #3
  %195 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector.5"* %194) #3
...
202:                                              ; preds = %201
  %203 = add nsw i32 %.021, 1
  br label %186

204:                                              ; preds = %186
  %205 = sext i32 40010 to i64
  call void @_ZNSaISt6vectorIiSaIiEEEC2Ev(%"class.std::allocator.2"* %16) #3
  invoke void @_ZNSt6vectorIS_IiSaIiEESaIS1_EEC2EmRKS2_(%"class.std::vector.0"* %15, i64 %205, %"class.std::allocator.2"* dereferenceable(1) %16)
          to label %206 unwind label %229

206:                                              ; preds = %204
  call void @_ZNSaISt6vectorIiSaIiEEED2Ev(%"class.std::allocator.2"* %16) #3
  %207 = sext i32 40010 to i64
  call void @_ZNSaISt6vectorIiSaIiEEEC2Ev(%"class.std::allocator.2"* %18) #3
  invoke void @_ZNSt6vectorIS_IiSaIiEESaIS1_EEC2EmRKS2_(%"class.std::vector.0"* %17, i64 %207, %"class.std::allocator.2"* dereferenceable(1) %18)
...
209:                                              ; preds = %253, %208
  %.022 = phi i32 [ 0, %208 ], [ %254, %253 ]
  %210 = icmp slt i32 %.022, 40010
...
212:                                              ; preds = %250, %211
  %.023 = phi i32 [ 0, %211 ], [ %251, %250 ]
  %213 = sext i32 %.023 to i64
  %214 = sext i32 %.022 to i64
  %215 = call dereferenceable(24) %"class.std::vector.5"* @_ZNSt6vectorIS_IiSaIiEESaIS1_EEixEm(%"class.std::vector.0"* %10, i64 %214) #3
  %216 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector.5"* %215) #3
...
221:                                              ; preds = %218
  ...
  %223 = call dereferenceable(24) %"class.std::vector.5"* @_ZNSt6vectorIS_IiSaIiEESaIS1_EEixEm(%"class.std::vector.0"* %15, i64 %222) #3
  ...
  invoke void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector.5"* %223, i32* dereferenceable(4) %227)
...
237:                                              ; preds = %274, %273, %267, %264, %261, %258, %241, %221
...
241:                                              ; preds = %218
  %242 = sext i32 %.022 to i64
  %243 = call dereferenceable(24) %"class.std::vector.5"* @_ZNSt6vectorIS_IiSaIiEESaIS1_EEixEm(%"class.std::vector.0"* %17, i64 %242) #3
  %244 = sext i32 %.022 to i64
  %245 = call dereferenceable(24) %"class.std::vector.5"* @_ZNSt6vectorIS_IiSaIiEESaIS1_EEixEm(%"class.std::vector.0"* %10, i64 %244) #3
  %246 = sext i32 %.023 to i64
  %247 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.5"* %245, i64 %246) #3
  invoke void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector.5"* %243, i32* dereferenceable(4) %247)
...
253:                                              ; preds = %252
  %254 = add nsw i32 %.022, 1
  br label %209

255:                                              ; preds = %209
  store i32 40010, i32* %19, align 4
  store i32 0, i32* %20, align 4
  store i32 40010, i32* %21, align 4
  store i32 0, i32* %22, align 4
  br label %256

256:                                              ; preds = %271, %255
  %.024 = phi i32 [ 0, %255 ], [ %272, %271 ]
  %257 = icmp slt i32 %.024, 4
  br i1 %257, label %258, label %273

258:                                              ; preds = %256
  %259 = sext i32 %.024 to i64
  %260 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %6, i64 %259) #3
  invoke void @_Z5chminIixEvRT_RKT0_(i32* dereferenceable(4) %19, i64* dereferenceable(8) %260)
          to label %261 unwind label %237

261:                                              ; preds = %258
  %262 = sext i32 %.024 to i64
  %263 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %8, i64 %262) #3
  invoke void @_Z5chminIixEvRT_RKT0_(i32* dereferenceable(4) %21, i64* dereferenceable(8) %263)
          to label %264 unwind label %237

264:                                              ; preds = %261
  %265 = sext i32 %.024 to i64
  %266 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %6, i64 %265) #3
  invoke void @_Z5chmaxIixEvRT_RKT0_(i32* dereferenceable(4) %20, i64* dereferenceable(8) %266)
          to label %267 unwind label %237

267:                                              ; preds = %264
  %268 = sext i32 %.024 to i64
  %269 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %8, i64 %268) #3
  invoke void @_Z5chmaxIixEvRT_RKT0_(i32* dereferenceable(4) %22, i64* dereferenceable(8) %269)
...
271:                                              ; preds = %270
  %272 = add nsw i32 %.024, 1
  br label %256

273:                                              ; preds = %256
  store i32 0, i32* %25, align 4
  store i32 0, i32* %26, align 4
  invoke void @_ZNSt4pairIiiEC2IiiLb1EEEOT_OT0_(%"struct.std::pair"* %24, i32* dereferenceable(4) %25, i32* dereferenceable(4) %26)
          to label %274 unwind label %237

274:                                              ; preds = %273
  %275 = bitcast %"struct.std::pair"* %24 to i64*
  %276 = load i64, i64* %275, align 4
  invoke void @"_ZN15LazySegmentTreeISt4pairIiiEiZ5solvevE3$_0Z5solvevE3$_1Z5solvevE3$_2EC2ES2_S3_S4_S1_i"(%struct.LazySegmentTree* %23, i64 %276, i32 0)
          to label %277 unwind label %237

277:                                              ; preds = %274
  %278 = sext i32 40010 to i64
  store i32 0, i32* %29, align 4
  store i32 1, i32* %30, align 4
  invoke void @_ZNSt4pairIiiEC2IiiLb1EEEOT_OT0_(%"struct.std::pair"* %28, i32* dereferenceable(4) %29, i32* dereferenceable(4) %30)
          to label %279 unwind label %305

279:                                              ; preds = %277
  call void @_ZNSaISt4pairIiiEEC2Ev(%"class.std::allocator.16"* %31) #3
  invoke void @_ZNSt6vectorISt4pairIiiESaIS1_EEC2EmRKS1_RKS2_(%"class.std::vector.14"* %27, i64 %278, %"struct.std::pair"* dereferenceable(8) %28, %"class.std::allocator.16"* dereferenceable(1) %31)
          to label %280 unwind label %309

280:                                              ; preds = %279
  invoke void @"_ZN15LazySegmentTreeISt4pairIiiEiZ5solvevE3$_0Z5solvevE3$_1Z5solvevE3$_2E5buildERKSt6vectorIS1_SaIS1_EE"(%struct.LazySegmentTree* %23, %"class.std::vector.14"* dereferenceable(24) %27)
          to label %281 unwind label %313

281:                                              ; preds = %280
  call void @_ZNSt6vectorISt4pairIiiESaIS1_EED2Ev(%"class.std::vector.14"* %27) #3
  call void @_ZNSaISt4pairIiiEED2Ev(%"class.std::allocator.16"* %31) #3
  br label %282

282:                                              ; preds = %381, %281
  %.018 = phi i64 [ 0, %281 ], [ %.119, %381 ]
  %.017 = phi i32 [ 0, %281 ], [ %382, %381 ]
  %283 = icmp slt i32 %.017, 40010
...
285:                                              ; preds = %303, %284
  %.013 = phi i32 [ 0, %284 ], [ %304, %303 ]
  %286 = sext i32 %.013 to i64
  %287 = sext i32 %.017 to i64
  %288 = call dereferenceable(24) %"class.std::vector.5"* @_ZNSt6vectorIS_IiSaIiEESaIS1_EEixEm(%"class.std::vector.0"* %15, i64 %287) #3
  %289 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector.5"* %288) #3
  %290 = icmp ult i64 %286, %289
  br i1 %290, label %291, label %318

291:                                              ; preds = %285
  %292 = sext i32 %.017 to i64
  %293 = call dereferenceable(24) %"class.std::vector.5"* @_ZNSt6vectorIS_IiSaIiEESaIS1_EEixEm(%"class.std::vector.0"* %15, i64 %292) #3
  %294 = sext i32 %.013 to i64
  %295 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.5"* %293, i64 %294) #3
  %296 = load i32, i32* %295, align 4
  %297 = sext i32 %.017 to i64
  %298 = call dereferenceable(24) %"class.std::vector.5"* @_ZNSt6vectorIS_IiSaIiEESaIS1_EEixEm(%"class.std::vector.0"* %17, i64 %297) #3
  %299 = sext i32 %.013 to i64
  %300 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.5"* %298, i64 %299) #3
  %301 = load i32, i32* %300, align 4
  invoke void @"_ZN15LazySegmentTreeISt4pairIiiEiZ5solvevE3$_0Z5solvevE3$_1Z5solvevE3$_2E6updateEiii"(%struct.LazySegmentTree* %23, i32 %296, i32 %301, i32 1)
...
305:                                              ; preds = %385, %383, %370, %356, %339, %320, %318, %291, %277
...
317:                                              ; preds = %313, %309
  %.02 = phi i32 [ %316, %313 ], [ %312, %309 ]
  %.01 = phi i8* [ %315, %313 ], [ %311, %309 ]
  call void @_ZNSaISt4pairIiiEED2Ev(%"class.std::allocator.16"* %31) #3
  br label %388

318:                                              ; preds = %285
  %319 = invoke i64 @"_ZN15LazySegmentTreeISt4pairIiiEiZ5solvevE3$_0Z5solvevE3$_1Z5solvevE3$_2E5queryEii"(%struct.LazySegmentTree* %23, i32 0, i32 40010)
          to label %320 unwind label %305

320:                                              ; preds = %318
  %321 = bitcast %"struct.std::pair"* %32 to i64*
  store i64 %319, i64* %321, align 4
  %322 = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* %32, i32 0, i32 0
  %323 = load i32, i32* %322, align 4
  %324 = sext i32 %323 to i64
  %325 = add nsw i64 %.018, %324
  %326 = invoke i64 @"_ZN15LazySegmentTreeISt4pairIiiEiZ5solvevE3$_0Z5solvevE3$_1Z5solvevE3$_2E5queryEii"(%struct.LazySegmentTree* %23, i32 0, i32 40010)
          to label %327 unwind label %305

327:                                              ; preds = %320
  %328 = bitcast %"struct.std::pair"* %33 to i64*
  store i64 %326, i64* %328, align 4
  %329 = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* %33, i32 0, i32 0
...
333:                                              ; preds = %332, %327
  ...
  %335 = icmp sle i32 %334, %.017
  br i1 %335, label %336, label %349

336:                                              ; preds = %333
  %337 = load i32, i32* %22, align 4
  %338 = icmp slt i32 %.017, %337
  br i1 %338, label %339, label %349

339:                                              ; preds = %336
  %340 = load i32, i32* %19, align 4
  %341 = load i32, i32* %20, align 4
  %342 = invoke i64 @"_ZN15LazySegmentTreeISt4pairIiiEiZ5solvevE3$_0Z5solvevE3$_1Z5solvevE3$_2E5queryEii"(%struct.LazySegmentTree* %23, i32 %340, i32 %341)
          to label %343 unwind label %305

343:                                              ; preds = %339
  %344 = bitcast %"struct.std::pair"* %34 to i64*
  store i64 %342, i64* %344, align 4
  %345 = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* %34, i32 0, i32 0
  %346 = load i32, i32* %345, align 4
  %347 = sext i32 %346 to i64
  %348 = sub nsw i64 %325, %347
  br label %349

349:                                              ; preds = %343, %336, %333
  %.119 = phi i64 [ %348, %343 ], [ %325, %336 ], [ %325, %333 ]
  br label %350

350:                                              ; preds = %368, %349
  %.012 = phi i32 [ 0, %349 ], [ %369, %368 ]
  %351 = sext i32 %.012 to i64
  %352 = sext i32 %.017 to i64
  %353 = call dereferenceable(24) %"class.std::vector.5"* @_ZNSt6vectorIS_IiSaIiEESaIS1_EEixEm(%"class.std::vector.0"* %15, i64 %352) #3
  %354 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector.5"* %353) #3
  %355 = icmp ult i64 %351, %354
  br i1 %355, label %356, label %370

356:                                              ; preds = %350
  %357 = sext i32 %.017 to i64
  %358 = call dereferenceable(24) %"class.std::vector.5"* @_ZNSt6vectorIS_IiSaIiEESaIS1_EEixEm(%"class.std::vector.0"* %15, i64 %357) #3
  %359 = sext i32 %.012 to i64
  %360 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.5"* %358, i64 %359) #3
  %361 = load i32, i32* %360, align 4
  %362 = sext i32 %.017 to i64
  %363 = call dereferenceable(24) %"class.std::vector.5"* @_ZNSt6vectorIS_IiSaIiEESaIS1_EEixEm(%"class.std::vector.0"* %17, i64 %362) #3
  %364 = sext i32 %.012 to i64
  %365 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.5"* %363, i64 %364) #3
  %366 = load i32, i32* %365, align 4
  invoke void @"_ZN15LazySegmentTreeISt4pairIiiEiZ5solvevE3$_0Z5solvevE3$_1Z5solvevE3$_2E6updateEiii"(%struct.LazySegmentTree* %23, i32 %361, i32 %366, i32 -1)
...
368:                                              ; preds = %367
  %369 = add nsw i32 %.012, 1
  br label %350

370:                                              ; preds = %350
  %371 = invoke i64 @"_ZN15LazySegmentTreeISt4pairIiiEiZ5solvevE3$_0Z5solvevE3$_1Z5solvevE3$_2E5queryEii"(%struct.LazySegmentTree* %23, i32 0, i32 40010)
          to label %372 unwind label %305

372:                                              ; preds = %370
  %373 = bitcast %"struct.std::pair"* %35 to i64*
  store i64 %371, i64* %373, align 4
  %374 = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* %35, i32 0, i32 0
...
378:                                              ; preds = %372
  call void @__assert_fail(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([71 x i8], [71 x i8]* @.str.1, i32 0, i32 0), i32 247, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @__PRETTY_FUNCTION__._Z5solvev, i32 0, i32 0)) #14
  unreachable
...
381:                                              ; preds = %380
  %382 = add nsw i32 %.017, 1
  br label %282

383:                                              ; preds = %282
  %384 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEx(%"class.std::basic_ostream"* @_ZSt4cout, i64 %.018)
...
387:                                              ; preds = %385
  call void @"_ZN15LazySegmentTreeISt4pairIiiEiZ5solvevE3$_0Z5solvevE3$_1Z5solvevE3$_2ED2Ev"(%struct.LazySegmentTree* %23) #3
...
388:                                              ; preds = %317, %305
  %.13 = phi i32 [ %308, %305 ], [ %.02, %317 ]
  %.1 = phi i8* [ %307, %305 ], [ %.01, %317 ]
  call void @"_ZN15LazySegmentTreeISt4pairIiiEiZ5solvevE3$_0Z5solvevE3$_1Z5solvevE3$_2ED2Ev"(%struct.LazySegmentTree* %23) #3
  br label %389

389:                                              ; preds = %388, %237
  %.24 = phi i32 [ %240, %237 ], [ %.13, %388 ]
  %.2 = phi i8* [ %239, %237 ], [ %.1, %388 ]
  call void @_ZNSt6vectorIS_IiSaIiEESaIS1_EED2Ev(%"class.std::vector.0"* %17) #3
  br label %390

390:                                              ; preds = %389, %233
  %.35 = phi i32 [ %.24, %389 ], [ %236, %233 ]
  %.3 = phi i8* [ %.2, %389 ], [ %235, %233 ]
  call void @_ZNSt6vectorIS_IiSaIiEESaIS1_EED2Ev(%"class.std::vector.0"* %15) #3
  br label %391

391:                                              ; preds = %390, %229, %178
  %.46 = phi i32 [ %181, %178 ], [ %.35, %390 ], [ %232, %229 ]
  %.4 = phi i8* [ %180, %178 ], [ %.3, %390 ], [ %231, %229 ]
  call void @_ZNSt6vectorIS_IiSaIiEESaIS1_EED2Ev(%"class.std::vector.0"* %10) #3
  br label %392

392:                                              ; preds = %391, %139, %117
  %.57 = phi i32 [ %120, %117 ], [ %.46, %391 ], [ %142, %139 ]
  %.5 = phi i8* [ %119, %117 ], [ %.4, %391 ], [ %141, %139 ]
  call void @_ZNSt6vectorIxSaIxEED2Ev(%"class.std::vector"* %8) #3
  br label %393

393:                                              ; preds = %392, %113
  %.68 = phi i32 [ %.57, %392 ], [ %116, %113 ]
  %.6 = phi i8* [ %.5, %392 ], [ %115, %113 ]
  call void @_ZNSt6vectorIxSaIxEED2Ev(%"class.std::vector"* %6) #3
  br label %394

394:                                              ; preds = %393, %109, %79
  %.79 = phi i32 [ %82, %79 ], [ %.68, %393 ], [ %112, %109 ]
  %.7 = phi i8* [ %81, %79 ], [ %.6, %393 ], [ %111, %109 ]
  call void @_ZNSt6vectorIxSaIxEED2Ev(%"class.std::vector"* %4) #3
  br label %395

395:                                              ; preds = %394, %75
  %.810 = phi i32 [ %.79, %394 ], [ %78, %75 ]
  %.8 = phi i8* [ %.7, %394 ], [ %77, %75 ]
  call void @_ZNSt6vectorIxSaIxEED2Ev(%"class.std::vector"* %2) #3
  br label %397

396:                                              ; preds = %387, %39
  %.0 = phi i1 [ false, %39 ], [ true, %387 ]
  ret i1 %.0

397:                                              ; preds = %395, %71
  %.911 = phi i32 [ %.810, %395 ], [ %74, %71 ]
  %.9 = phi i8* [ %.8, %395 ], [ %73, %71 ]
  %398 = insertvalue { i8*, i32 } undef, i8* %.9, 0
  %399 = insertvalue { i8*, i32 } %398, i32 %.911, 1
  resume { i8*, i32 } %399
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(24) %"class.std::vector.5"* @_ZNSt6vectorIS_IiSaIiEESaIS1_EEixEm(%"class.std::vector.0"* %0, i64 %1) #4 comdat align 2 {
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt6vectorIiSaIiEE9push_backEOi(%"class.std::vector.5"* %0, i32* dereferenceable(4) %1) #0 comdat align 2 {
  %3 = call dereferenceable(4) i32* @_ZSt4moveIRiEONSt16remove_referenceIT_E4typeEOS2_(i32* dereferenceable(4) %1) #3
  call void @_ZNSt6vectorIiSaIiEE12emplace_backIJiEEEvDpOT_(%"class.std::vector.5"* %0, i32* dereferenceable(4) %3)
  ret void
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector.5"* %0) #4 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector.5"* %0) #4 comdat align 2 {
  %2 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %3 = bitcast %"class.std::vector.5"* %0 to %"struct.std::_Vector_base.6"*
  %4 = getelementptr inbounds %"struct.std::_Vector_base.6", %"struct.std::_Vector_base.6"* %3, i32 0, i32 0
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector.5"* %0) #4 comdat align 2 {
...
26:                                               ; preds = %2
  %27 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector.5"* %0) #3
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.5"* %0, i64 %1) #4 comdat align 2 {
  %3 = bitcast %"class.std::vector.5"* %0 to %"struct.std::_Vector_base.6"*
  %4 = getelementptr inbounds %"struct.std::_Vector_base.6", %"struct.std::_Vector_base.6"* %3, i32 0, i32 0
  %5 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl", %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %4, i32 0, i32 0
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_Z5chminIixEvRT_RKT0_(i32* dereferenceable(4) %0, i64* dereferenceable(8) %1) #4 comdat {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_Z5chmaxIixEvRT_RKT0_(i32* dereferenceable(4) %0, i64* dereferenceable(8) %1) #4 comdat {
  %3 = load i32, i32* %0, align 4
  %4 = sext i32 %3 to i64
  %5 = load i64, i64* %1, align 8
  %6 = icmp slt i64 %4, %5
...
; Function Attrs: noinline nounwind uwtable
define internal void @"_ZN15LazySegmentTreeISt4pairIiiEiZ5solvevE3$_0Z5solvevE3$_1Z5solvevE3$_2EC2ES2_S3_S4_S1_i"(%struct.LazySegmentTree* %0, i64 %1, i32 %2) unnamed_addr #4 align 2 {
  %4 = alloca %"struct.std::pair", align 4
  %5 = bitcast %"struct.std::pair"* %4 to i64*
  store i64 %1, i64* %5, align 4
  %6 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 2
  %7 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 3
  %8 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 4
  %9 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 5
  ...
  %12 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 6
  store i32 %2, i32* %12, align 4
  %13 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 7
  call void @_ZNSt6vectorISt4pairIiiESaIS1_EEC2Ev(%"class.std::vector.14"* %13) #3
  %14 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 8
  call void @_ZNSt6vectorIiSaIiEEC2Ev(%"class.std::vector.5"* %14) #3
  ret void
}

; Function Attrs: noinline uwtable
define internal void @"_ZN15LazySegmentTreeISt4pairIiiEiZ5solvevE3$_0Z5solvevE3$_1Z5solvevE3$_2E5buildERKSt6vectorIS1_SaIS1_EE"(%struct.LazySegmentTree* %0, %"class.std::vector.14"* dereferenceable(24) %1) #0 align 2 {
  %3 = alloca %"struct.std::pair", align 4
  %4 = alloca %"struct.std::pair", align 4
  %5 = alloca %"struct.std::pair", align 4
  %6 = call i64 @_ZNKSt6vectorISt4pairIiiESaIS1_EE4sizeEv(%"class.std::vector.14"* %1) #3
  %7 = trunc i64 %6 to i32
  call void @"_ZN15LazySegmentTreeISt4pairIiiEiZ5solvevE3$_0Z5solvevE3$_1Z5solvevE3$_2E4initEi"(%struct.LazySegmentTree* %0, i32 %7)
  br label %8
...
10:                                               ; preds = %8
  ...
  %12 = call dereferenceable(8) %"struct.std::pair"* @_ZNKSt6vectorISt4pairIiiESaIS1_EEixEm(%"class.std::vector.14"* %1, i64 %11) #3
  %13 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 7
  %14 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 0
  %15 = load i32, i32* %14, align 8
  %16 = add nsw i32 %15, %.01
  %17 = sext i32 %16 to i64
  %18 = call dereferenceable(8) %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EEixEm(%"class.std::vector.14"* %13, i64 %17) #3
  %19 = call dereferenceable(8) %"struct.std::pair"* @_ZNSt4pairIiiEaSERKS0_(%"struct.std::pair"* %18, %"struct.std::pair"* dereferenceable(8) %12)
  br label %20
...
22:                                               ; preds = %8
  %23 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 0
  %24 = load i32, i32* %23, align 8
  %25 = sub nsw i32 %24, 1
  br label %26

26:                                               ; preds = %53, %22
  %.0 = phi i32 [ %25, %22 ], [ %54, %53 ]
  %27 = icmp ne i32 %.0, 0
  br i1 %27, label %28, label %55

28:                                               ; preds = %26
  %29 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 2
  %30 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 7
  %31 = shl i32 %.0, 1
  %32 = sext i32 %31 to i64
  %33 = call dereferenceable(8) %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EEixEm(%"class.std::vector.14"* %30, i64 %32) #3
  ...
  %36 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 7
  %37 = shl i32 %.0, 1
  %38 = or i32 %37, 1
  %39 = sext i32 %38 to i64
  %40 = call dereferenceable(8) %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EEixEm(%"class.std::vector.14"* %36, i64 %39) #3
  ...
  %47 = call i64 @"_ZZ5solvevENK3$_0clESt4pairIiiES1_"(%class.anon* %29, i64 %44, i64 %46)
  %48 = bitcast %"struct.std::pair"* %3 to i64*
  store i64 %47, i64* %48, align 4
  %49 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 7
  %50 = sext i32 %.0 to i64
  %51 = call dereferenceable(8) %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EEixEm(%"class.std::vector.14"* %49, i64 %50) #3
  %52 = call dereferenceable(8) %"struct.std::pair"* @_ZNSt4pairIiiEaSEOS0_(%"struct.std::pair"* %51, %"struct.std::pair"* dereferenceable(8) %3) #3
  br label %53
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSaISt4pairIiiEEC2Ev(%"class.std::allocator.16"* %0) unnamed_addr #4 comdat align 2 {
  %2 = bitcast %"class.std::allocator.16"* %0 to %"class.__gnu_cxx::new_allocator.17"*
  call void @_ZN9__gnu_cxx13new_allocatorISt4pairIiiEEC2Ev(%"class.__gnu_cxx::new_allocator.17"* %2) #3
  ret void
}

; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt6vectorISt4pairIiiESaIS1_EEC2EmRKS1_RKS2_(%"class.std::vector.14"* %0, i64 %1, %"struct.std::pair"* dereferenceable(8) %2, %"class.std::allocator.16"* dereferenceable(1) %3) unnamed_addr #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %5 = bitcast %"class.std::vector.14"* %0 to %"struct.std::_Vector_base.15"*
  call void @_ZNSt12_Vector_baseISt4pairIiiESaIS1_EEC2EmRKS2_(%"struct.std::_Vector_base.15"* %5, i64 %1, %"class.std::allocator.16"* dereferenceable(1) %3)
  invoke void @_ZNSt6vectorISt4pairIiiESaIS1_EE18_M_fill_initializeEmRKS1_(%"class.std::vector.14"* %0, i64 %1, %"struct.std::pair"* dereferenceable(8) %2)
...
7:                                                ; preds = %4
  ...
  %11 = bitcast %"class.std::vector.14"* %0 to %"struct.std::_Vector_base.15"*
  call void @_ZNSt12_Vector_baseISt4pairIiiESaIS1_EED2Ev(%"struct.std::_Vector_base.15"* %11) #3
  br label %12
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt6vectorISt4pairIiiESaIS1_EED2Ev(%"class.std::vector.14"* %0) unnamed_addr #4 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %11 = call dereferenceable(1) %"class.std::allocator.16"* @_ZNSt12_Vector_baseISt4pairIiiESaIS1_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base.15"* %10) #3
  invoke void @_ZSt8_DestroyIPSt4pairIiiES1_EvT_S3_RSaIT0_E(%"struct.std::pair"* %5, %"struct.std::pair"* %9, %"class.std::allocator.16"* dereferenceable(1) %11)
          to label %12 unwind label %14

12:                                               ; preds = %1
  %13 = bitcast %"class.std::vector.14"* %0 to %"struct.std::_Vector_base.15"*
  call void @_ZNSt12_Vector_baseISt4pairIiiESaIS1_EED2Ev(%"struct.std::_Vector_base.15"* %13) #3
  ret void
...
14:                                               ; preds = %1
  ...
  call void @_ZNSt12_Vector_baseISt4pairIiiESaIS1_EED2Ev(%"struct.std::_Vector_base.15"* %18) #3
  br label %19
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSaISt4pairIiiEED2Ev(%"class.std::allocator.16"* %0) unnamed_addr #4 comdat align 2 {
  %2 = bitcast %"class.std::allocator.16"* %0 to %"class.__gnu_cxx::new_allocator.17"*
  call void @_ZN9__gnu_cxx13new_allocatorISt4pairIiiEED2Ev(%"class.__gnu_cxx::new_allocator.17"* %2) #3
  ret void
}

; Function Attrs: noinline uwtable
define internal void @"_ZN15LazySegmentTreeISt4pairIiiEiZ5solvevE3$_0Z5solvevE3$_1Z5solvevE3$_2E6updateEiii"(%struct.LazySegmentTree* %0, i32 %1, i32 %2, i32 %3) #0 align 2 {
  %5 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 0
  %6 = load i32, i32* %5, align 8
  %7 = add nsw i32 %1, %6
  call void @"_ZN15LazySegmentTreeISt4pairIiiEiZ5solvevE3$_0Z5solvevE3$_1Z5solvevE3$_2E6thrustEi"(%struct.LazySegmentTree* %0, i32 %7)
  %8 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 0
  %9 = load i32, i32* %8, align 8
  %10 = sub nsw i32 %9, 1
  %11 = add nsw i32 %2, %10
  call void @"_ZN15LazySegmentTreeISt4pairIiiEiZ5solvevE3$_0Z5solvevE3$_1Z5solvevE3$_2E6thrustEi"(%struct.LazySegmentTree* %0, i32 %11)
  %12 = add nsw i32 %11, 1
  br label %13

13:                                               ; preds = %44, %4
  %.01 = phi i32 [ %7, %4 ], [ %45, %44 ]
  %.0 = phi i32 [ %12, %4 ], [ %46, %44 ]
...
18:                                               ; preds = %15
  %19 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 4
  %20 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 8
  %21 = sext i32 %.01 to i64
  %22 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.5"* %20, i64 %21) #3
  %23 = load i32, i32* %22, align 4
  %24 = call i32 @"_ZZ5solvevENK3$_2clEii"(%class.anon.12* %19, i32 %23, i32 %3)
  %25 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 8
  %26 = sext i32 %.01 to i64
  %27 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.5"* %25, i64 %26) #3
  store i32 %24, i32* %27, align 4
  %28 = add nsw i32 %.01, 1
  br label %29

29:                                               ; preds = %18, %15
  %.12 = phi i32 [ %28, %18 ], [ %.01, %15 ]
  %30 = and i32 %.0, 1
  %31 = icmp ne i32 %30, 0
...
32:                                               ; preds = %29
  %33 = add nsw i32 %.0, -1
  %34 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 4
  %35 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 8
  %36 = sext i32 %33 to i64
  %37 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.5"* %35, i64 %36) #3
  %38 = load i32, i32* %37, align 4
  %39 = call i32 @"_ZZ5solvevENK3$_2clEii"(%class.anon.12* %34, i32 %38, i32 %3)
  %40 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 8
...
47:                                               ; preds = %13
  call void @"_ZN15LazySegmentTreeISt4pairIiiEiZ5solvevE3$_0Z5solvevE3$_1Z5solvevE3$_2E6recalcEi"(%struct.LazySegmentTree* %0, i32 %7)
  call void @"_ZN15LazySegmentTreeISt4pairIiiEiZ5solvevE3$_0Z5solvevE3$_1Z5solvevE3$_2E6recalcEi"(%struct.LazySegmentTree* %0, i32 %11)
  ret void
}

; Function Attrs: noinline uwtable
define internal i64 @"_ZN15LazySegmentTreeISt4pairIiiEiZ5solvevE3$_0Z5solvevE3$_1Z5solvevE3$_2E5queryEii"(%struct.LazySegmentTree* %0, i32 %1, i32 %2) #0 align 2 {
  %4 = alloca %"struct.std::pair", align 4
  %5 = alloca %"struct.std::pair", align 4
  ...
  %15 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 0
  %16 = load i32, i32* %15, align 8
  %17 = add nsw i32 %1, %16
  call void @"_ZN15LazySegmentTreeISt4pairIiiEiZ5solvevE3$_0Z5solvevE3$_1Z5solvevE3$_2E6thrustEi"(%struct.LazySegmentTree* %0, i32 %17)
  %18 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 0
  %19 = load i32, i32* %18, align 8
  %20 = sub nsw i32 %19, 1
  %21 = add nsw i32 %2, %20
  call void @"_ZN15LazySegmentTreeISt4pairIiiEiZ5solvevE3$_0Z5solvevE3$_1Z5solvevE3$_2E6thrustEi"(%struct.LazySegmentTree* %0, i32 %21)
  %22 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 5
  ...
  %25 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 5
...
29:                                               ; preds = %66, %3
  %.01 = phi i32 [ %17, %3 ], [ %67, %66 ]
  %.0 = phi i32 [ %28, %3 ], [ %68, %66 ]
  %30 = icmp slt i32 %.01, %.0
...
34:                                               ; preds = %31
  %35 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 2
  ...
  %38 = add nsw i32 %.01, 1
  %39 = call i64 @"_ZN15LazySegmentTreeISt4pairIiiEiZ5solvevE3$_0Z5solvevE3$_1Z5solvevE3$_2E7reflectEi"(%struct.LazySegmentTree* %0, i32 %.01)
  %40 = bitcast %"struct.std::pair"* %9 to i64*
  store i64 %39, i64* %40, align 4
  %41 = bitcast %"struct.std::pair"* %8 to i64*
  %42 = load i64, i64* %41, align 4
  %43 = bitcast %"struct.std::pair"* %9 to i64*
  %44 = load i64, i64* %43, align 4
  %45 = call i64 @"_ZZ5solvevENK3$_0clESt4pairIiiES1_"(%class.anon* %35, i64 %42, i64 %44)
  %46 = bitcast %"struct.std::pair"* %7 to i64*
  store i64 %45, i64* %46, align 4
  %47 = call dereferenceable(8) %"struct.std::pair"* @_ZNSt4pairIiiEaSEOS0_(%"struct.std::pair"* %5, %"struct.std::pair"* dereferenceable(8) %7) #3
  br label %48

48:                                               ; preds = %34, %31
  %.12 = phi i32 [ %38, %34 ], [ %.01, %31 ]
  %49 = and i32 %.0, 1
  %50 = icmp ne i32 %49, 0
  br i1 %50, label %51, label %65

51:                                               ; preds = %48
  %52 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 2
  %53 = add nsw i32 %.0, -1
  %54 = call i64 @"_ZN15LazySegmentTreeISt4pairIiiEiZ5solvevE3$_0Z5solvevE3$_1Z5solvevE3$_2E7reflectEi"(%struct.LazySegmentTree* %0, i32 %53)
  ...
  %62 = call i64 @"_ZZ5solvevENK3$_0clESt4pairIiiES1_"(%class.anon* %52, i64 %59, i64 %61)
  %63 = bitcast %"struct.std::pair"* %10 to i64*
  store i64 %62, i64* %63, align 4
  %64 = call dereferenceable(8) %"struct.std::pair"* @_ZNSt4pairIiiEaSEOS0_(%"struct.std::pair"* %6, %"struct.std::pair"* dereferenceable(8) %10) #3
  br label %65

65:                                               ; preds = %51, %48
  %.1 = phi i32 [ %53, %51 ], [ %.0, %48 ]
  br label %66
...
69:                                               ; preds = %29
  %70 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 2
  ...
  %75 = bitcast %"struct.std::pair"* %13 to i64*
  %76 = load i64, i64* %75, align 4
  %77 = bitcast %"struct.std::pair"* %14 to i64*
  %78 = load i64, i64* %77, align 4
  %79 = call i64 @"_ZZ5solvevENK3$_0clESt4pairIiiES1_"(%class.anon* %70, i64 %76, i64 %78)
...
; Function Attrs: noinline nounwind uwtable
define internal void @"_ZN15LazySegmentTreeISt4pairIiiEiZ5solvevE3$_0Z5solvevE3$_1Z5solvevE3$_2ED2Ev"(%struct.LazySegmentTree* %0) unnamed_addr #4 align 2 {
  %2 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 8
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector.5"* %2) #3
  %3 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 7
  call void @_ZNSt6vectorISt4pairIiiESaIS1_EED2Ev(%"class.std::vector.14"* %3) #3
  ret void
}
...
define linkonce_odr void @_ZNSt6vectorIS_IiSaIiEESaIS1_EED2Ev(%"class.std::vector.0"* %0) unnamed_addr #4 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  invoke void @_ZSt8_DestroyIPSt6vectorIiSaIiEES2_EvT_S4_RSaIT0_E(%"class.std::vector.5"* %5, %"class.std::vector.5"* %9, %"class.std::allocator.2"* dereferenceable(1) %11)
          to label %12 unwind label %14
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(1) %"class.std::allocator.7"* @_ZNSt12_Vector_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base.6"* %0) #4 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorIiE10deallocateEPim(%"class.__gnu_cxx::new_allocator.8"* %0, i32* %1, i64 %2) #4 comdat align 2 {
...
define linkonce_odr void @_ZNSt6vectorIS_IiSaIiEESaIS1_EE21_M_default_initializeEm(%"class.std::vector.0"* %0, i64 %1) #0 comdat align 2 {
  ...
  %9 = call %"class.std::vector.5"* @_ZSt27__uninitialized_default_n_aIPSt6vectorIiSaIiEEmS2_ET_S4_T0_RSaIT1_E(%"class.std::vector.5"* %6, i64 %1, %"class.std::allocator.2"* dereferenceable(1) %8)
  %10 = bitcast %"class.std::vector.0"* %0 to %"struct.std::_Vector_base.1"*
...
define linkonce_odr void @_ZNSt12_Vector_baseISt6vectorIiSaIiEESaIS2_EED2Ev(%"struct.std::_Vector_base.1"* %0) unnamed_addr #4 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  invoke void @_ZNSt12_Vector_baseISt6vectorIiSaIiEESaIS2_EE13_M_deallocateEPS2_m(%"struct.std::_Vector_base.1"* %0, %"class.std::vector.5"* %4, i64 %14)
          to label %15 unwind label %17
...
define linkonce_odr void @_ZNSt12_Vector_baseISt6vectorIiSaIiEESaIS2_EE17_M_create_storageEm(%"struct.std::_Vector_base.1"* %0, i64 %1) #0 comdat align 2 {
  %3 = call %"class.std::vector.5"* @_ZNSt12_Vector_baseISt6vectorIiSaIiEESaIS2_EE11_M_allocateEm(%"struct.std::_Vector_base.1"* %0, i64 %1)
  %4 = getelementptr inbounds %"struct.std::_Vector_base.1", %"struct.std::_Vector_base.1"* %0, i32 0, i32 0
  %5 = getelementptr inbounds %"struct.std::_Vector_base<std::vector<int, std::allocator<int> >, std::allocator<std::vector<int, std::allocator<int> > > >::_Vector_impl", %"struct.std::_Vector_base<std::vector<int, std::allocator<int> >, std::allocator<std::vector<int, std::allocator<int> > > >::_Vector_impl"* %4, i32 0, i32 0
...
; Function Attrs: noinline uwtable
define linkonce_odr %"class.std::vector.5"* @_ZNSt12_Vector_baseISt6vectorIiSaIiEESaIS2_EE11_M_allocateEm(%"struct.std::_Vector_base.1"* %0, i64 %1) #0 comdat align 2 {
  %3 = icmp ne i64 %1, 0
  br i1 %3, label %4, label %8
...
4:                                                ; preds = %2
  ...
  %7 = call %"class.std::vector.5"* @_ZNSt16allocator_traitsISaISt6vectorIiSaIiEEEE8allocateERS3_m(%"class.std::allocator.2"* dereferenceable(1) %6, i64 %1)
  br label %9
...
; Function Attrs: noinline uwtable
define linkonce_odr %"class.std::vector.5"* @_ZNSt16allocator_traitsISaISt6vectorIiSaIiEEEE8allocateERS3_m(%"class.std::allocator.2"* dereferenceable(1) %0, i64 %1) #0 comdat align 2 {
  %3 = bitcast %"class.std::allocator.2"* %0 to %"class.__gnu_cxx::new_allocator.3"*
  %4 = call %"class.std::vector.5"* @_ZN9__gnu_cxx13new_allocatorISt6vectorIiSaIiEEE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.3"* %3, i64 %1, i8* null)
  ret %"class.std::vector.5"* %4
}

; Function Attrs: noinline uwtable
define linkonce_odr %"class.std::vector.5"* @_ZN9__gnu_cxx13new_allocatorISt6vectorIiSaIiEEE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.3"* %0, i64 %1, i8* %2) #0 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64 @_ZNK9__gnu_cxx13new_allocatorISt6vectorIiSaIiEEE8max_sizeEv(%"class.__gnu_cxx::new_allocator.3"* %0) #4 comdat align 2 {
  ret i64 768614336404564650
}

; Function Attrs: noinline uwtable
define linkonce_odr %"class.std::vector.5"* @_ZSt27__uninitialized_default_n_aIPSt6vectorIiSaIiEEmS2_ET_S4_T0_RSaIT1_E(%"class.std::vector.5"* %0, i64 %1, %"class.std::allocator.2"* dereferenceable(1) %2) #0 comdat {
  %4 = call %"class.std::vector.5"* @_ZSt25__uninitialized_default_nIPSt6vectorIiSaIiEEmET_S4_T0_(%"class.std::vector.5"* %0, i64 %1)
  ret %"class.std::vector.5"* %4
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(1) %"class.std::allocator.2"* @_ZNSt12_Vector_baseISt6vectorIiSaIiEESaIS2_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base.1"* %0) #4 comdat align 2 {
  %2 = getelementptr inbounds %"struct.std::_Vector_base.1", %"struct.std::_Vector_base.1"* %0, i32 0, i32 0
...
; Function Attrs: noinline uwtable
define linkonce_odr %"class.std::vector.5"* @_ZSt25__uninitialized_default_nIPSt6vectorIiSaIiEEmET_S4_T0_(%"class.std::vector.5"* %0, i64 %1) #0 comdat {
  %3 = call %"class.std::vector.5"* @_ZNSt27__uninitialized_default_n_1ILb0EE18__uninit_default_nIPSt6vectorIiSaIiEEmEET_S6_T0_(%"class.std::vector.5"* %0, i64 %1)
  ret %"class.std::vector.5"* %3
}

; Function Attrs: noinline uwtable
define linkonce_odr %"class.std::vector.5"* @_ZNSt27__uninitialized_default_n_1ILb0EE18__uninit_default_nIPSt6vectorIiSaIiEEmEET_S6_T0_(%"class.std::vector.5"* %0, i64 %1) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  br label %3
...
5:                                                ; preds = %3
  %6 = call %"class.std::vector.5"* @_ZSt11__addressofISt6vectorIiSaIiEEEPT_RS3_(%"class.std::vector.5"* dereferenceable(24) %.01) #3
  invoke void @_ZSt10_ConstructISt6vectorIiSaIiEEJEEvPT_DpOT0_(%"class.std::vector.5"* %6)
...
15:                                               ; preds = %11
  ...
  invoke void @_ZSt8_DestroyIPSt6vectorIiSaIiEEEvT_S4_(%"class.std::vector.5"* %0, %"class.std::vector.5"* %.01)
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZSt10_ConstructISt6vectorIiSaIiEEJEEvPT_DpOT0_(%"class.std::vector.5"* %0) #4 comdat {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr %"class.std::vector.5"* @_ZSt11__addressofISt6vectorIiSaIiEEEPT_RS3_(%"class.std::vector.5"* dereferenceable(24) %0) #4 comdat {
  ret %"class.std::vector.5"* %0
}

; Function Attrs: noinline uwtable
define linkonce_odr void @_ZSt8_DestroyIPSt6vectorIiSaIiEEEvT_S4_(%"class.std::vector.5"* %0, %"class.std::vector.5"* %1) #0 comdat {
  call void @_ZNSt12_Destroy_auxILb0EE9__destroyIPSt6vectorIiSaIiEEEEvT_S6_(%"class.std::vector.5"* %0, %"class.std::vector.5"* %1)
  ret void
}
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt12_Destroy_auxILb0EE9__destroyIPSt6vectorIiSaIiEEEEvT_S6_(%"class.std::vector.5"* %0, %"class.std::vector.5"* %1) #0 comdat align 2 {
  br label %3
...
5:                                                ; preds = %3
  %6 = call %"class.std::vector.5"* @_ZSt11__addressofISt6vectorIiSaIiEEEPT_RS3_(%"class.std::vector.5"* dereferenceable(24) %.0) #3
  call void @_ZSt8_DestroyISt6vectorIiSaIiEEEvPT_(%"class.std::vector.5"* %6)
  br label %7
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZSt8_DestroyISt6vectorIiSaIiEEEvPT_(%"class.std::vector.5"* %0) #4 comdat {
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector.5"* %0) #3
  ret void
}

; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt12_Vector_baseISt6vectorIiSaIiEESaIS2_EE13_M_deallocateEPS2_m(%"struct.std::_Vector_base.1"* %0, %"class.std::vector.5"* %1, i64 %2) #0 comdat align 2 {
...
5:                                                ; preds = %3
  ...
  call void @_ZNSt16allocator_traitsISaISt6vectorIiSaIiEEEE10deallocateERS3_PS2_m(%"class.std::allocator.2"* dereferenceable(1) %7, %"class.std::vector.5"* %1, i64 %2)
  br label %8
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt16allocator_traitsISaISt6vectorIiSaIiEEEE10deallocateERS3_PS2_m(%"class.std::allocator.2"* dereferenceable(1) %0, %"class.std::vector.5"* %1, i64 %2) #0 comdat align 2 {
  %4 = bitcast %"class.std::allocator.2"* %0 to %"class.__gnu_cxx::new_allocator.3"*
  call void @_ZN9__gnu_cxx13new_allocatorISt6vectorIiSaIiEEE10deallocateEPS3_m(%"class.__gnu_cxx::new_allocator.3"* %4, %"class.std::vector.5"* %1, i64 %2)
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorISt6vectorIiSaIiEEE10deallocateEPS3_m(%"class.__gnu_cxx::new_allocator.3"* %0, %"class.std::vector.5"* %1, i64 %2) #4 comdat align 2 {
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZSt8_DestroyIPSt6vectorIiSaIiEES2_EvT_S4_RSaIT0_E(%"class.std::vector.5"* %0, %"class.std::vector.5"* %1, %"class.std::allocator.2"* dereferenceable(1) %2) #0 comdat {
  call void @_ZSt8_DestroyIPSt6vectorIiSaIiEEEvT_S4_(%"class.std::vector.5"* %0, %"class.std::vector.5"* %1)
  ret void
}

; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt6vectorIiSaIiEE12emplace_backIJiEEEvDpOT_(%"class.std::vector.5"* %0, i32* dereferenceable(4) %1) #0 comdat align 2 {
  %3 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %4 = bitcast %"class.std::vector.5"* %0 to %"struct.std::_Vector_base.6"*
  %5 = getelementptr inbounds %"struct.std::_Vector_base.6", %"struct.std::_Vector_base.6"* %4, i32 0, i32 0
  %6 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl", %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %5, i32 0, i32 1
...
13:                                               ; preds = %2
  ...
  call void @_ZNSt16allocator_traitsISaIiEE9constructIiJiEEEvRS0_PT_DpOT0_(%"class.std::allocator.7"* dereferenceable(1) %16, i32* %20, i32* dereferenceable(4) %21)
...
27:                                               ; preds = %2
  %28 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector.5"* %0) #3
  %29 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %3, i32 0, i32 0
  ...
  call void @_ZNSt6vectorIiSaIiEE17_M_realloc_insertIJiEEEvN9__gnu_cxx17__normal_iteratorIPiS1_EEDpOT_(%"class.std::vector.5"* %0, i32* %32, i32* dereferenceable(4) %30)
  br label %33
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt16allocator_traitsISaIiEE9constructIiJiEEEvRS0_PT_DpOT0_(%"class.std::allocator.7"* dereferenceable(1) %0, i32* %1, i32* dereferenceable(4) %2) #0 comdat align 2 {
  %4 = bitcast %"class.std::allocator.7"* %0 to %"class.__gnu_cxx::new_allocator.8"*
  %5 = call dereferenceable(4) i32* @_ZSt7forwardIiEOT_RNSt16remove_referenceIS0_E4typeE(i32* dereferenceable(4) %2) #3
  call void @_ZN9__gnu_cxx13new_allocatorIiE9constructIiJiEEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator.8"* %4, i32* %1, i32* dereferenceable(4) %5)
  ret void
}

; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt6vectorIiSaIiEE17_M_realloc_insertIJiEEEvN9__gnu_cxx17__normal_iteratorIPiS1_EEDpOT_(%"class.std::vector.5"* %0, i32* %1, i32* dereferenceable(4) %2) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %4 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %5 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %6 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %4, i32 0, i32 0
  store i32* %1, i32** %6, align 8
  %7 = call i64 @_ZNKSt6vectorIiSaIiEE12_M_check_lenEmPKc(%"class.std::vector.5"* %0, i64 1, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.2, i32 0, i32 0))
  %8 = bitcast %"class.std::vector.5"* %0 to %"struct.std::_Vector_base.6"*
  %9 = getelementptr inbounds %"struct.std::_Vector_base.6", %"struct.std::_Vector_base.6"* %8, i32 0, i32 0
  ...
  %15 = load i32*, i32** %14, align 8
  %16 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector.5"* %0) #3
  ...
  invoke void @_ZNSt16allocator_traitsISaIiEE9constructIiJiEEEvRS0_PT_DpOT0_(%"class.std::allocator.7"* dereferenceable(1) %23, i32* %24, i32* dereferenceable(4) %25)
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorIiE9constructIiJiEEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator.8"* %0, i32* %1, i32* dereferenceable(4) %2) #4 comdat align 2 {
  %4 = bitcast i32* %1 to i8*
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64 @_ZNKSt6vectorIiSaIiEE8max_sizeEv(%"class.std::vector.5"* %0) #4 comdat align 2 {
  %2 = bitcast %"class.std::vector.5"* %0 to %"struct.std::_Vector_base.6"*
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64 @_ZNSt16allocator_traitsISaIiEE8max_sizeERKS0_(%"class.std::allocator.7"* dereferenceable(1) %0) #4 comdat align 2 {
  %2 = bitcast %"class.std::allocator.7"* %0 to %"class.__gnu_cxx::new_allocator.8"*
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(1) %"class.std::allocator.7"* @_ZNKSt12_Vector_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base.6"* %0) #4 comdat align 2 {
  %2 = getelementptr inbounds %"struct.std::_Vector_base.6", %"struct.std::_Vector_base.6"* %0, i32 0, i32 0
  %3 = bitcast %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %2 to %"class.std::allocator.7"*
  ret %"class.std::allocator.7"* %3
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64 @_ZNK9__gnu_cxx13new_allocatorIiE8max_sizeEv(%"class.__gnu_cxx::new_allocator.8"* %0) #4 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorIiE7destroyIiEEvPT_(%"class.__gnu_cxx::new_allocator.8"* %0, i32* %1) #4 comdat align 2 {
  ret void
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorIiE9constructIiJRKiEEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator.8"* %0, i32* %1, i32* dereferenceable(4) %2) #4 comdat align 2 {
  %4 = bitcast i32* %1 to i8*
  %5 = bitcast i8* %4 to i32*
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt6vectorISt4pairIiiESaIS1_EEC2Ev(%"class.std::vector.14"* %0) unnamed_addr #4 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %2 = bitcast %"class.std::vector.14"* %0 to %"struct.std::_Vector_base.15"*
...
define linkonce_odr void @_ZNSt12_Vector_baseISt4pairIiiESaIS1_EE12_Vector_implC2Ev(%"struct.std::_Vector_base<std::pair<int, int>, std::allocator<std::pair<int, int> > >::_Vector_impl"* %0) unnamed_addr #4 comdat align 2 {
  ...
  call void @_ZNSaISt4pairIiiEEC2Ev(%"class.std::allocator.16"* %2) #3
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorISt4pairIiiEEC2Ev(%"class.__gnu_cxx::new_allocator.17"* %0) unnamed_addr #4 comdat align 2 {
  ret void
}

; Function Attrs: noinline uwtable
define linkonce_odr void @_ZSt8_DestroyIPSt4pairIiiES1_EvT_S3_RSaIT0_E(%"struct.std::pair"* %0, %"struct.std::pair"* %1, %"class.std::allocator.16"* dereferenceable(1) %2) #0 comdat {
  call void @_ZSt8_DestroyIPSt4pairIiiEEvT_S3_(%"struct.std::pair"* %0, %"struct.std::pair"* %1)
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(1) %"class.std::allocator.16"* @_ZNSt12_Vector_baseISt4pairIiiESaIS1_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base.15"* %0) #4 comdat align 2 {
  %2 = getelementptr inbounds %"struct.std::_Vector_base.15", %"struct.std::_Vector_base.15"* %0, i32 0, i32 0
  %3 = bitcast %"struct.std::_Vector_base<std::pair<int, int>, std::allocator<std::pair<int, int> > >::_Vector_impl"* %2 to %"class.std::allocator.16"*
  ret %"class.std::allocator.16"* %3
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt12_Vector_baseISt4pairIiiESaIS1_EED2Ev(%"struct.std::_Vector_base.15"* %0) unnamed_addr #4 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %2 = getelementptr inbounds %"struct.std::_Vector_base.15", %"struct.std::_Vector_base.15"* %0, i32 0, i32 0
  ...
  %13 = sub i64 %11, %12
  %14 = sdiv exact i64 %13, 8
  invoke void @_ZNSt12_Vector_baseISt4pairIiiESaIS1_EE13_M_deallocateEPS1_m(%"struct.std::_Vector_base.15"* %0, %"struct.std::pair"* %4, i64 %14)
          to label %15 unwind label %17
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt12_Vector_baseISt4pairIiiESaIS1_EE13_M_deallocateEPS1_m(%"struct.std::_Vector_base.15"* %0, %"struct.std::pair"* %1, i64 %2) #0 comdat align 2 {
...
5:                                                ; preds = %3
  ...
  %7 = bitcast %"struct.std::_Vector_base<std::pair<int, int>, std::allocator<std::pair<int, int> > >::_Vector_impl"* %6 to %"class.std::allocator.16"*
  call void @_ZNSt16allocator_traitsISaISt4pairIiiEEE10deallocateERS2_PS1_m(%"class.std::allocator.16"* dereferenceable(1) %7, %"struct.std::pair"* %1, i64 %2)
  br label %8
...
define linkonce_odr void @_ZNSt12_Vector_baseISt4pairIiiESaIS1_EE12_Vector_implD2Ev(%"struct.std::_Vector_base<std::pair<int, int>, std::allocator<std::pair<int, int> > >::_Vector_impl"* %0) unnamed_addr #4 comdat align 2 {
  %2 = bitcast %"struct.std::_Vector_base<std::pair<int, int>, std::allocator<std::pair<int, int> > >::_Vector_impl"* %0 to %"class.std::allocator.16"*
  call void @_ZNSaISt4pairIiiEED2Ev(%"class.std::allocator.16"* %2) #3
  ret void
}

; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt16allocator_traitsISaISt4pairIiiEEE10deallocateERS2_PS1_m(%"class.std::allocator.16"* dereferenceable(1) %0, %"struct.std::pair"* %1, i64 %2) #0 comdat align 2 {
  %4 = bitcast %"class.std::allocator.16"* %0 to %"class.__gnu_cxx::new_allocator.17"*
  call void @_ZN9__gnu_cxx13new_allocatorISt4pairIiiEE10deallocateEPS2_m(%"class.__gnu_cxx::new_allocator.17"* %4, %"struct.std::pair"* %1, i64 %2)
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorISt4pairIiiEE10deallocateEPS2_m(%"class.__gnu_cxx::new_allocator.17"* %0, %"struct.std::pair"* %1, i64 %2) #4 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorISt4pairIiiEED2Ev(%"class.__gnu_cxx::new_allocator.17"* %0) unnamed_addr #4 comdat align 2 {
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64 @_ZNKSt6vectorISt4pairIiiESaIS1_EE4sizeEv(%"class.std::vector.14"* %0) #4 comdat align 2 {
  %2 = bitcast %"class.std::vector.14"* %0 to %"struct.std::_Vector_base.15"*
  %3 = getelementptr inbounds %"struct.std::_Vector_base.15", %"struct.std::_Vector_base.15"* %2, i32 0, i32 0
...
; Function Attrs: noinline uwtable
define internal void @"_ZN15LazySegmentTreeISt4pairIiiEiZ5solvevE3$_0Z5solvevE3$_1Z5solvevE3$_2E4initEi"(%struct.LazySegmentTree* %0, i32 %1) #0 align 2 {
  %3 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 0
  store i32 1, i32* %3, align 8
  %4 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 1
  store i32 0, i32* %4, align 4
  br label %5

5:                                                ; preds = %9, %2
  %6 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 0
  %7 = load i32, i32* %6, align 8
  %8 = icmp slt i32 %7, %1
  br i1 %8, label %9, label %16

9:                                                ; preds = %5
  %10 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 0
  %11 = load i32, i32* %10, align 8
  %12 = shl i32 %11, 1
  store i32 %12, i32* %10, align 8
  %13 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 1
...
16:                                               ; preds = %5
  %17 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 7
  %18 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 0
  %19 = load i32, i32* %18, align 8
  %20 = mul nsw i32 2, %19
  %21 = sext i32 %20 to i64
  %22 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 5
  call void @_ZNSt6vectorISt4pairIiiESaIS1_EE6assignEmRKS1_(%"class.std::vector.14"* %17, i64 %21, %"struct.std::pair"* dereferenceable(8) %22)
  %23 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 8
  %24 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 0
  %25 = load i32, i32* %24, align 8
  %26 = mul nsw i32 2, %25
  %27 = sext i32 %26 to i64
  %28 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 6
  call void @_ZNSt6vectorIiSaIiEE6assignEmRKi(%"class.std::vector.5"* %23, i64 %27, i32* dereferenceable(4) %28)
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(8) %"struct.std::pair"* @_ZNKSt6vectorISt4pairIiiESaIS1_EEixEm(%"class.std::vector.14"* %0, i64 %1) #4 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(8) %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EEixEm(%"class.std::vector.14"* %0, i64 %1) #4 comdat align 2 {
  %3 = bitcast %"class.std::vector.14"* %0 to %"struct.std::_Vector_base.15"*
  %4 = getelementptr inbounds %"struct.std::_Vector_base.15", %"struct.std::_Vector_base.15"* %3, i32 0, i32 0
  %5 = getelementptr inbounds %"struct.std::_Vector_base<std::pair<int, int>, std::allocator<std::pair<int, int> > >::_Vector_impl", %"struct.std::_Vector_base<std::pair<int, int>, std::allocator<std::pair<int, int> > >::_Vector_impl"* %4, i32 0, i32 0
  %6 = load %"struct.std::pair"*, %"struct.std::pair"** %5, align 8
...
; Function Attrs: noinline uwtable
define internal i64 @"_ZZ5solvevENK3$_0clESt4pairIiiES1_"(%class.anon* %0, i64 %1, i64 %2) #0 align 2 {
  %4 = alloca %"struct.std::pair", align 4
  %5 = alloca %"struct.std::pair", align 4
  %6 = alloca %"struct.std::pair", align 4
  %7 = alloca i32, align 4
  ...
  call void @_ZNSt4pairIiiEC2IiiLb1EEEOT_OT0_(%"struct.std::pair"* %4, i32* dereferenceable(4) %7, i32* dereferenceable(4) %8)
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt6vectorISt4pairIiiESaIS1_EE6assignEmRKS1_(%"class.std::vector.14"* %0, i64 %1, %"struct.std::pair"* dereferenceable(8) %2) #0 comdat align 2 {
  call void @_ZNSt6vectorISt4pairIiiESaIS1_EE14_M_fill_assignEmRKS1_(%"class.std::vector.14"* %0, i64 %1, %"struct.std::pair"* dereferenceable(8) %2)
  ret void
}

; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt6vectorIiSaIiEE6assignEmRKi(%"class.std::vector.5"* %0, i64 %1, i32* dereferenceable(4) %2) #0 comdat align 2 {
  call void @_ZNSt6vectorIiSaIiEE14_M_fill_assignEmRKi(%"class.std::vector.5"* %0, i64 %1, i32* dereferenceable(4) %2)
  ret void
}

; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt6vectorISt4pairIiiESaIS1_EE14_M_fill_assignEmRKS1_(%"class.std::vector.14"* %0, i64 %1, %"struct.std::pair"* dereferenceable(8) %2) #0 comdat align 2 {
  %4 = alloca %"class.std::vector.14", align 8
  %5 = alloca %"class.__gnu_cxx::__normal_iterator.19", align 8
  %6 = alloca %"class.__gnu_cxx::__normal_iterator.19", align 8
  %7 = call i64 @_ZNKSt6vectorISt4pairIiiESaIS1_EE8capacityEv(%"class.std::vector.14"* %0) #3
  %8 = icmp ugt i64 %1, %7
  br i1 %8, label %9, label %16
...
9:                                                ; preds = %3
  %10 = bitcast %"class.std::vector.14"* %0 to %"struct.std::_Vector_base.15"*
  %11 = call dereferenceable(1) %"class.std::allocator.16"* @_ZNSt12_Vector_baseISt4pairIiiESaIS1_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base.15"* %10) #3
  call void @_ZNSt6vectorISt4pairIiiESaIS1_EEC2EmRKS1_RKS2_(%"class.std::vector.14"* %4, i64 %1, %"struct.std::pair"* dereferenceable(8) %2, %"class.std::allocator.16"* dereferenceable(1) %11)
  %12 = bitcast %"class.std::vector.14"* %4 to %"struct.std::_Vector_base.15"*
...
16:                                               ; preds = %3
  %17 = call i64 @_ZNKSt6vectorISt4pairIiiESaIS1_EE4sizeEv(%"class.std::vector.14"* %0) #3
  %18 = icmp ugt i64 %1, %17
  br i1 %18, label %19, label %40

19:                                               ; preds = %16
  %20 = call %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EE5beginEv(%"class.std::vector.14"* %0) #3
  %21 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator.19", %"class.__gnu_cxx::__normal_iterator.19"* %5, i32 0, i32 0
  store %"struct.std::pair"* %20, %"struct.std::pair"** %21, align 8
  %22 = call %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EE3endEv(%"class.std::vector.14"* %0) #3
  %23 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator.19", %"class.__gnu_cxx::__normal_iterator.19"* %6, i32 0, i32 0
  store %"struct.std::pair"* %22, %"struct.std::pair"** %23, align 8
  %24 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator.19", %"class.__gnu_cxx::__normal_iterator.19"* %5, i32 0, i32 0
  %25 = load %"struct.std::pair"*, %"struct.std::pair"** %24, align 8
  %26 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator.19", %"class.__gnu_cxx::__normal_iterator.19"* %6, i32 0, i32 0
  %27 = load %"struct.std::pair"*, %"struct.std::pair"** %26, align 8
  call void @_ZSt4fillIN9__gnu_cxx17__normal_iteratorIPSt4pairIiiESt6vectorIS3_SaIS3_EEEES3_EvT_S9_RKT0_(%"struct.std::pair"* %25, %"struct.std::pair"* %27, %"struct.std::pair"* dereferenceable(8) %2)
  %28 = call i64 @_ZNKSt6vectorISt4pairIiiESaIS1_EE4sizeEv(%"class.std::vector.14"* %0) #3
  %29 = sub i64 %1, %28
  %30 = bitcast %"class.std::vector.14"* %0 to %"struct.std::_Vector_base.15"*
  ...
  %34 = bitcast %"class.std::vector.14"* %0 to %"struct.std::_Vector_base.15"*
  ...
  %36 = call %"struct.std::pair"* @_ZSt24__uninitialized_fill_n_aIPSt4pairIiiEmS1_S1_ET_S3_T0_RKT1_RSaIT2_E(%"struct.std::pair"* %33, i64 %29, %"struct.std::pair"* dereferenceable(8) %2, %"class.std::allocator.16"* dereferenceable(1) %35)
  %37 = bitcast %"class.std::vector.14"* %0 to %"struct.std::_Vector_base.15"*
...
40:                                               ; preds = %16
  %41 = bitcast %"class.std::vector.14"* %0 to %"struct.std::_Vector_base.15"*
  ...
  %45 = call %"struct.std::pair"* @_ZSt6fill_nIPSt4pairIiiEmS1_ET_S3_T0_RKT1_(%"struct.std::pair"* %44, i64 %1, %"struct.std::pair"* dereferenceable(8) %2)
  call void @_ZNSt6vectorISt4pairIiiESaIS1_EE15_M_erase_at_endEPS1_(%"class.std::vector.14"* %0, %"struct.std::pair"* %45) #3
  br label %46
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64 @_ZNKSt6vectorISt4pairIiiESaIS1_EE8capacityEv(%"class.std::vector.14"* %0) #4 comdat align 2 {
  %2 = bitcast %"class.std::vector.14"* %0 to %"struct.std::_Vector_base.15"*
  %3 = getelementptr inbounds %"struct.std::_Vector_base.15", %"struct.std::_Vector_base.15"* %2, i32 0, i32 0
  %4 = getelementptr inbounds %"struct.std::_Vector_base<std::pair<int, int>, std::allocator<std::pair<int, int> > >::_Vector_impl", %"struct.std::_Vector_base<std::pair<int, int>, std::allocator<std::pair<int, int> > >::_Vector_impl"* %3, i32 0, i32 2
  %5 = load %"struct.std::pair"*, %"struct.std::pair"** %4, align 8
  %6 = bitcast %"class.std::vector.14"* %0 to %"struct.std::_Vector_base.15"*
  %7 = getelementptr inbounds %"struct.std::_Vector_base.15", %"struct.std::_Vector_base.15"* %6, i32 0, i32 0
  %8 = getelementptr inbounds %"struct.std::_Vector_base<std::pair<int, int>, std::allocator<std::pair<int, int> > >::_Vector_impl", %"struct.std::_Vector_base<std::pair<int, int>, std::allocator<std::pair<int, int> > >::_Vector_impl"* %7, i32 0, i32 0
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZSt4fillIN9__gnu_cxx17__normal_iteratorIPSt4pairIiiESt6vectorIS3_SaIS3_EEEES3_EvT_S9_RKT0_(%"struct.std::pair"* %0, %"struct.std::pair"* %1, %"struct.std::pair"* dereferenceable(8) %2) #0 comdat {
  ...
  %9 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator.19", %"class.__gnu_cxx::__normal_iterator.19"* %5, i32 0, i32 0
  store %"struct.std::pair"* %1, %"struct.std::pair"** %9, align 8
  %10 = bitcast %"class.__gnu_cxx::__normal_iterator.19"* %6 to i8*
  %11 = bitcast %"class.__gnu_cxx::__normal_iterator.19"* %4 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %10, i8* align 8 %11, i64 8, i1 false)
  ...
  %14 = call %"struct.std::pair"* @_ZSt12__niter_baseIPSt4pairIiiESt6vectorIS1_SaIS1_EEET_N9__gnu_cxx17__normal_iteratorIS6_T0_EE(%"struct.std::pair"* %13)
  ...
  call void @_ZSt8__fill_aIPSt4pairIiiES1_EN9__gnu_cxx11__enable_ifIXntsr11__is_scalarIT0_EE7__valueEvE6__typeET_S8_RKS5_(%"struct.std::pair"* %14, %"struct.std::pair"* %19, %"struct.std::pair"* dereferenceable(8) %2)
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EE5beginEv(%"class.std::vector.14"* %0) #4 comdat align 2 {
  %2 = alloca %"class.__gnu_cxx::__normal_iterator.19", align 8
  %3 = bitcast %"class.std::vector.14"* %0 to %"struct.std::_Vector_base.15"*
  %4 = getelementptr inbounds %"struct.std::_Vector_base.15", %"struct.std::_Vector_base.15"* %3, i32 0, i32 0
  %5 = getelementptr inbounds %"struct.std::_Vector_base<std::pair<int, int>, std::allocator<std::pair<int, int> > >::_Vector_impl", %"struct.std::_Vector_base<std::pair<int, int>, std::allocator<std::pair<int, int> > >::_Vector_impl"* %4, i32 0, i32 0
  call void @_ZN9__gnu_cxx17__normal_iteratorIPSt4pairIiiESt6vectorIS2_SaIS2_EEEC2ERKS3_(%"class.__gnu_cxx::__normal_iterator.19"* %2, %"struct.std::pair"** dereferenceable(8) %5) #3
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EE3endEv(%"class.std::vector.14"* %0) #4 comdat align 2 {
  %2 = alloca %"class.__gnu_cxx::__normal_iterator.19", align 8
  %3 = bitcast %"class.std::vector.14"* %0 to %"struct.std::_Vector_base.15"*
  %4 = getelementptr inbounds %"struct.std::_Vector_base.15", %"struct.std::_Vector_base.15"* %3, i32 0, i32 0
...
; Function Attrs: noinline uwtable
define linkonce_odr %"struct.std::pair"* @_ZSt24__uninitialized_fill_n_aIPSt4pairIiiEmS1_S1_ET_S3_T0_RKT1_RSaIT2_E(%"struct.std::pair"* %0, i64 %1, %"struct.std::pair"* dereferenceable(8) %2, %"class.std::allocator.16"* dereferenceable(1) %3) #0 comdat {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt6vectorISt4pairIiiESaIS1_EE15_M_erase_at_endEPS1_(%"class.std::vector.14"* %0, %"struct.std::pair"* %1) #4 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %3 = bitcast %"class.std::vector.14"* %0 to %"struct.std::_Vector_base.15"*
  %4 = getelementptr inbounds %"struct.std::_Vector_base.15", %"struct.std::_Vector_base.15"* %3, i32 0, i32 0
  %5 = getelementptr inbounds %"struct.std::_Vector_base<std::pair<int, int>, std::allocator<std::pair<int, int> > >::_Vector_impl", %"struct.std::_Vector_base<std::pair<int, int>, std::allocator<std::pair<int, int> > >::_Vector_impl"* %4, i32 0, i32 1
  %6 = load %"struct.std::pair"*, %"struct.std::pair"** %5, align 8
...
12:                                               ; preds = %2
  ...
  %18 = call dereferenceable(1) %"class.std::allocator.16"* @_ZNSt12_Vector_baseISt4pairIiiESaIS1_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base.15"* %17) #3
  invoke void @_ZSt8_DestroyIPSt4pairIiiES1_EvT_S3_RSaIT0_E(%"struct.std::pair"* %1, %"struct.std::pair"* %16, %"class.std::allocator.16"* dereferenceable(1) %18)
          to label %19 unwind label %24

19:                                               ; preds = %12
  %20 = bitcast %"class.std::vector.14"* %0 to %"struct.std::_Vector_base.15"*
...
; Function Attrs: noinline uwtable
define linkonce_odr %"struct.std::pair"* @_ZSt6fill_nIPSt4pairIiiEmS1_ET_S3_T0_RKT1_(%"struct.std::pair"* %0, i64 %1, %"struct.std::pair"* dereferenceable(8) %2) #0 comdat {
  %4 = call %"struct.std::pair"* @_ZSt12__niter_baseIPSt4pairIiiEET_S3_(%"struct.std::pair"* %0)
  %5 = call %"struct.std::pair"* @_ZSt10__fill_n_aIPSt4pairIiiEmS1_EN9__gnu_cxx11__enable_ifIXntsr11__is_scalarIT1_EE7__valueET_E6__typeES6_T0_RKS5_(%"struct.std::pair"* %4, i64 %1, %"struct.std::pair"* dereferenceable(8) %2)
  ret %"struct.std::pair"* %5
}
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZSt8__fill_aIPSt4pairIiiES1_EN9__gnu_cxx11__enable_ifIXntsr11__is_scalarIT0_EE7__valueEvE6__typeET_S8_RKS5_(%"struct.std::pair"* %0, %"struct.std::pair"* %1, %"struct.std::pair"* dereferenceable(8) %2) #0 comdat {
  br label %4
...
6:                                                ; preds = %4
  %7 = call dereferenceable(8) %"struct.std::pair"* @_ZNSt4pairIiiEaSERKS0_(%"struct.std::pair"* %.0, %"struct.std::pair"* dereferenceable(8) %2)
  br label %8
...
define linkonce_odr %"struct.std::pair"* @_ZSt12__niter_baseIPSt4pairIiiESt6vectorIS1_SaIS1_EEET_N9__gnu_cxx17__normal_iteratorIS6_T0_EE(%"struct.std::pair"* %0) #4 comdat {
  ...
  %4 = call dereferenceable(8) %"struct.std::pair"** @_ZNK9__gnu_cxx17__normal_iteratorIPSt4pairIiiESt6vectorIS2_SaIS2_EEE4baseEv(%"class.__gnu_cxx::__normal_iterator.19"* %2) #3
  %5 = load %"struct.std::pair"*, %"struct.std::pair"** %4, align 8
  ret %"struct.std::pair"* %5
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(8) %"struct.std::pair"** @_ZNK9__gnu_cxx17__normal_iteratorIPSt4pairIiiESt6vectorIS2_SaIS2_EEE4baseEv(%"class.__gnu_cxx::__normal_iterator.19"* %0) #4 comdat align 2 {
  %2 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator.19", %"class.__gnu_cxx::__normal_iterator.19"* %0, i32 0, i32 0
  ret %"struct.std::pair"** %2
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx17__normal_iteratorIPSt4pairIiiESt6vectorIS2_SaIS2_EEEC2ERKS3_(%"class.__gnu_cxx::__normal_iterator.19"* %0, %"struct.std::pair"** dereferenceable(8) %1) unnamed_addr #4 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZSt10_ConstructISt4pairIiiEJRKS1_EEvPT_DpOT0_(%"struct.std::pair"* %0, %"struct.std::pair"* dereferenceable(8) %1) #4 comdat {
...
; Function Attrs: noinline uwtable
define linkonce_odr %"struct.std::pair"* @_ZSt10__fill_n_aIPSt4pairIiiEmS1_EN9__gnu_cxx11__enable_ifIXntsr11__is_scalarIT1_EE7__valueET_E6__typeES6_T0_RKS5_(%"struct.std::pair"* %0, i64 %1, %"struct.std::pair"* dereferenceable(8) %2) #0 comdat {
  br label %4
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt6vectorIiSaIiEE14_M_fill_assignEmRKi(%"class.std::vector.5"* %0, i64 %1, i32* dereferenceable(4) %2) #0 comdat align 2 {
  %4 = alloca %"class.std::vector.5", align 8
  %5 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %6 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %7 = call i64 @_ZNKSt6vectorIiSaIiEE8capacityEv(%"class.std::vector.5"* %0) #3
  %8 = icmp ugt i64 %1, %7
  br i1 %8, label %9, label %16
...
9:                                                ; preds = %3
  %10 = bitcast %"class.std::vector.5"* %0 to %"struct.std::_Vector_base.6"*
  %11 = call dereferenceable(1) %"class.std::allocator.7"* @_ZNSt12_Vector_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base.6"* %10) #3
  call void @_ZNSt6vectorIiSaIiEEC2EmRKiRKS0_(%"class.std::vector.5"* %4, i64 %1, i32* dereferenceable(4) %2, %"class.std::allocator.7"* dereferenceable(1) %11)
  %12 = bitcast %"class.std::vector.5"* %4 to %"struct.std::_Vector_base.6"*
  %13 = getelementptr inbounds %"struct.std::_Vector_base.6", %"struct.std::_Vector_base.6"* %12, i32 0, i32 0
  %14 = bitcast %"class.std::vector.5"* %0 to %"struct.std::_Vector_base.6"*
  %15 = getelementptr inbounds %"struct.std::_Vector_base.6", %"struct.std::_Vector_base.6"* %14, i32 0, i32 0
...
16:                                               ; preds = %3
  %17 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector.5"* %0) #3
  %18 = icmp ugt i64 %1, %17
  br i1 %18, label %19, label %40

19:                                               ; preds = %16
  %20 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector.5"* %0) #3
  %21 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %5, i32 0, i32 0
  store i32* %20, i32** %21, align 8
  %22 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector.5"* %0) #3
  ...
  %28 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector.5"* %0) #3
  %29 = sub i64 %1, %28
  ...
  %36 = call i32* @_ZSt24__uninitialized_fill_n_aIPimiiET_S1_T0_RKT1_RSaIT2_E(i32* %33, i64 %29, i32* dereferenceable(4) %2, %"class.std::allocator.7"* dereferenceable(1) %35)
  %37 = bitcast %"class.std::vector.5"* %0 to %"struct.std::_Vector_base.6"*
...
40:                                               ; preds = %16
  ...
  call void @_ZNSt6vectorIiSaIiEE15_M_erase_at_endEPi(%"class.std::vector.5"* %0, i32* %45) #3
  br label %46
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64 @_ZNKSt6vectorIiSaIiEE8capacityEv(%"class.std::vector.5"* %0) #4 comdat align 2 {
  %2 = bitcast %"class.std::vector.5"* %0 to %"struct.std::_Vector_base.6"*
  %3 = getelementptr inbounds %"struct.std::_Vector_base.6", %"struct.std::_Vector_base.6"* %2, i32 0, i32 0
...
define linkonce_odr void @_ZNSt6vectorIiSaIiEEC2EmRKiRKS0_(%"class.std::vector.5"* %0, i64 %1, i32* dereferenceable(4) %2, %"class.std::allocator.7"* dereferenceable(1) %3) unnamed_addr #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  call void @_ZNSt12_Vector_baseIiSaIiEEC2EmRKS0_(%"struct.std::_Vector_base.6"* %5, i64 %1, %"class.std::allocator.7"* dereferenceable(1) %3)
  invoke void @_ZNSt6vectorIiSaIiEE18_M_fill_initializeEmRKi(%"class.std::vector.5"* %0, i64 %1, i32* dereferenceable(4) %2)
          to label %6 unwind label %7
...
7:                                                ; preds = %4
  ...
  call void @_ZNSt12_Vector_baseIiSaIiEED2Ev(%"struct.std::_Vector_base.6"* %11) #3
  br label %12
...
; Function Attrs: noinline uwtable
define linkonce_odr i32* @_ZSt24__uninitialized_fill_n_aIPimiiET_S1_T0_RKT1_RSaIT2_E(i32* %0, i64 %1, i32* dereferenceable(4) %2, %"class.std::allocator.7"* dereferenceable(1) %3) #0 comdat {
  %5 = call i32* @_ZSt20uninitialized_fill_nIPimiET_S1_T0_RKT1_(i32* %0, i64 %1, i32* dereferenceable(4) %2)
  ret i32* %5
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt6vectorIiSaIiEE15_M_erase_at_endEPi(%"class.std::vector.5"* %0, i32* %1) #4 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %3 = bitcast %"class.std::vector.5"* %0 to %"struct.std::_Vector_base.6"*
  %4 = getelementptr inbounds %"struct.std::_Vector_base.6", %"struct.std::_Vector_base.6"* %3, i32 0, i32 0
  %5 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl", %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %4, i32 0, i32 1
  %6 = load i32*, i32** %5, align 8
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt6vectorIiSaIiEE18_M_fill_initializeEmRKi(%"class.std::vector.5"* %0, i64 %1, i32* dereferenceable(4) %2) #0 comdat align 2 {
  %4 = bitcast %"class.std::vector.5"* %0 to %"struct.std::_Vector_base.6"*
  %5 = getelementptr inbounds %"struct.std::_Vector_base.6", %"struct.std::_Vector_base.6"* %4, i32 0, i32 0
  %6 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl", %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %5, i32 0, i32 0
  %7 = load i32*, i32** %6, align 8
  %8 = bitcast %"class.std::vector.5"* %0 to %"struct.std::_Vector_base.6"*
  %9 = call dereferenceable(1) %"class.std::allocator.7"* @_ZNSt12_Vector_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base.6"* %8) #3
  %10 = call i32* @_ZSt24__uninitialized_fill_n_aIPimiiET_S1_T0_RKT1_RSaIT2_E(i32* %7, i64 %1, i32* dereferenceable(4) %2, %"class.std::allocator.7"* dereferenceable(1) %9)
  %11 = bitcast %"class.std::vector.5"* %0 to %"struct.std::_Vector_base.6"*
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt12_Vector_baseISt4pairIiiESaIS1_EEC2EmRKS2_(%"struct.std::_Vector_base.15"* %0, i64 %1, %"class.std::allocator.16"* dereferenceable(1) %2) unnamed_addr #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %4 = getelementptr inbounds %"struct.std::_Vector_base.15", %"struct.std::_Vector_base.15"* %0, i32 0, i32 0
  call void @_ZNSt12_Vector_baseISt4pairIiiESaIS1_EE12_Vector_implC2ERKS2_(%"struct.std::_Vector_base<std::pair<int, int>, std::allocator<std::pair<int, int> > >::_Vector_impl"* %4, %"class.std::allocator.16"* dereferenceable(1) %2) #3
  invoke void @_ZNSt12_Vector_baseISt4pairIiiESaIS1_EE17_M_create_storageEm(%"struct.std::_Vector_base.15"* %0, i64 %1)
          to label %5 unwind label %6
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt6vectorISt4pairIiiESaIS1_EE18_M_fill_initializeEmRKS1_(%"class.std::vector.14"* %0, i64 %1, %"struct.std::pair"* dereferenceable(8) %2) #0 comdat align 2 {
  ...
  %9 = call dereferenceable(1) %"class.std::allocator.16"* @_ZNSt12_Vector_baseISt4pairIiiESaIS1_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base.15"* %8) #3
  %10 = call %"struct.std::pair"* @_ZSt24__uninitialized_fill_n_aIPSt4pairIiiEmS1_S1_ET_S3_T0_RKT1_RSaIT2_E(%"struct.std::pair"* %7, i64 %1, %"struct.std::pair"* dereferenceable(8) %2, %"class.std::allocator.16"* dereferenceable(1) %9)
  %11 = bitcast %"class.std::vector.14"* %0 to %"struct.std::_Vector_base.15"*
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt12_Vector_baseISt4pairIiiESaIS1_EE12_Vector_implC2ERKS2_(%"struct.std::_Vector_base<std::pair<int, int>, std::allocator<std::pair<int, int> > >::_Vector_impl"* %0, %"class.std::allocator.16"* dereferenceable(1) %1) unnamed_addr #4 comdat align 2 {
  %3 = bitcast %"struct.std::_Vector_base<std::pair<int, int>, std::allocator<std::pair<int, int> > >::_Vector_impl"* %0 to %"class.std::allocator.16"*
  call void @_ZNSaISt4pairIiiEEC2ERKS1_(%"class.std::allocator.16"* %3, %"class.std::allocator.16"* dereferenceable(1) %1) #3
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt12_Vector_baseISt4pairIiiESaIS1_EE17_M_create_storageEm(%"struct.std::_Vector_base.15"* %0, i64 %1) #0 comdat align 2 {
  %3 = call %"struct.std::pair"* @_ZNSt12_Vector_baseISt4pairIiiESaIS1_EE11_M_allocateEm(%"struct.std::_Vector_base.15"* %0, i64 %1)
  %4 = getelementptr inbounds %"struct.std::_Vector_base.15", %"struct.std::_Vector_base.15"* %0, i32 0, i32 0
  %5 = getelementptr inbounds %"struct.std::_Vector_base<std::pair<int, int>, std::allocator<std::pair<int, int> > >::_Vector_impl", %"struct.std::_Vector_base<std::pair<int, int>, std::allocator<std::pair<int, int> > >::_Vector_impl"* %4, i32 0, i32 0
  ...
  %9 = getelementptr inbounds %"struct.std::_Vector_base.15", %"struct.std::_Vector_base.15"* %0, i32 0, i32 0
  ...
  %11 = getelementptr inbounds %"struct.std::_Vector_base.15", %"struct.std::_Vector_base.15"* %0, i32 0, i32 0
  ...
  %15 = getelementptr inbounds %"struct.std::_Vector_base.15", %"struct.std::_Vector_base.15"* %0, i32 0, i32 0
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSaISt4pairIiiEEC2ERKS1_(%"class.std::allocator.16"* %0, %"class.std::allocator.16"* dereferenceable(1) %1) unnamed_addr #4 comdat align 2 {
  ...
  call void @_ZN9__gnu_cxx13new_allocatorISt4pairIiiEEC2ERKS3_(%"class.__gnu_cxx::new_allocator.17"* %3, %"class.__gnu_cxx::new_allocator.17"* dereferenceable(1) %4) #3
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorISt4pairIiiEEC2ERKS3_(%"class.__gnu_cxx::new_allocator.17"* %0, %"class.__gnu_cxx::new_allocator.17"* dereferenceable(1) %1) unnamed_addr #4 comdat align 2 {
  ret void
}

; Function Attrs: noinline uwtable
define linkonce_odr %"struct.std::pair"* @_ZNSt12_Vector_baseISt4pairIiiESaIS1_EE11_M_allocateEm(%"struct.std::_Vector_base.15"* %0, i64 %1) #0 comdat align 2 {
  %3 = icmp ne i64 %1, 0
  br i1 %3, label %4, label %8
...
4:                                                ; preds = %2
  ...
  %7 = call %"struct.std::pair"* @_ZNSt16allocator_traitsISaISt4pairIiiEEE8allocateERS2_m(%"class.std::allocator.16"* dereferenceable(1) %6, i64 %1)
  br label %9
...
; Function Attrs: noinline uwtable
define linkonce_odr %"struct.std::pair"* @_ZNSt16allocator_traitsISaISt4pairIiiEEE8allocateERS2_m(%"class.std::allocator.16"* dereferenceable(1) %0, i64 %1) #0 comdat align 2 {
  %3 = bitcast %"class.std::allocator.16"* %0 to %"class.__gnu_cxx::new_allocator.17"*
  %4 = call %"struct.std::pair"* @_ZN9__gnu_cxx13new_allocatorISt4pairIiiEE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.17"* %3, i64 %1, i8* null)
  ret %"struct.std::pair"* %4
}

; Function Attrs: noinline uwtable
define linkonce_odr %"struct.std::pair"* @_ZN9__gnu_cxx13new_allocatorISt4pairIiiEE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.17"* %0, i64 %1, i8* %2) #0 comdat align 2 {
  %4 = call i64 @_ZNK9__gnu_cxx13new_allocatorISt4pairIiiEE8max_sizeEv(%"class.__gnu_cxx::new_allocator.17"* %0) #3
  %5 = icmp ugt i64 %1, %4
  br i1 %5, label %6, label %7
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64 @_ZNK9__gnu_cxx13new_allocatorISt4pairIiiEE8max_sizeEv(%"class.__gnu_cxx::new_allocator.17"* %0) #4 comdat align 2 {
  ret i64 2305843009213693951
}

; Function Attrs: noinline uwtable
define internal void @"_ZN15LazySegmentTreeISt4pairIiiEiZ5solvevE3$_0Z5solvevE3$_1Z5solvevE3$_2E6thrustEi"(%struct.LazySegmentTree* %0, i32 %1) #0 align 2 {
  %3 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 1
  %4 = load i32, i32* %3, align 4
  br label %5
...
7:                                                ; preds = %5
  %8 = ashr i32 %1, %.0
  call void @"_ZN15LazySegmentTreeISt4pairIiiEiZ5solvevE3$_0Z5solvevE3$_1Z5solvevE3$_2E4evalEi"(%struct.LazySegmentTree* %0, i32 %8)
  br label %9
...
; Function Attrs: noinline nounwind uwtable
define internal i32 @"_ZZ5solvevENK3$_2clEii"(%class.anon.12* %0, i32 %1, i32 %2) #4 align 2 {
  %4 = add nsw i32 %1, %2
  ret i32 %4
}

; Function Attrs: noinline uwtable
define internal void @"_ZN15LazySegmentTreeISt4pairIiiEiZ5solvevE3$_0Z5solvevE3$_1Z5solvevE3$_2E6recalcEi"(%struct.LazySegmentTree* %0, i32 %1) #0 align 2 {
  %3 = alloca %"struct.std::pair", align 4
  %4 = alloca %"struct.std::pair", align 4
  %5 = alloca %"struct.std::pair", align 4
  br label %6
...
9:                                                ; preds = %6
  %10 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 2
  %11 = shl i32 %7, 1
  %12 = call i64 @"_ZN15LazySegmentTreeISt4pairIiiEiZ5solvevE3$_0Z5solvevE3$_1Z5solvevE3$_2E7reflectEi"(%struct.LazySegmentTree* %0, i32 %11)
  %13 = bitcast %"struct.std::pair"* %4 to i64*
  store i64 %12, i64* %13, align 4
  %14 = shl i32 %7, 1
  %15 = or i32 %14, 1
  %16 = call i64 @"_ZN15LazySegmentTreeISt4pairIiiEiZ5solvevE3$_0Z5solvevE3$_1Z5solvevE3$_2E7reflectEi"(%struct.LazySegmentTree* %0, i32 %15)
  ...
  %22 = call i64 @"_ZZ5solvevENK3$_0clESt4pairIiiES1_"(%class.anon* %10, i64 %19, i64 %21)
  %23 = bitcast %"struct.std::pair"* %3 to i64*
  store i64 %22, i64* %23, align 4
  %24 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 7
  %25 = sext i32 %7 to i64
  %26 = call dereferenceable(8) %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EEixEm(%"class.std::vector.14"* %24, i64 %25) #3
...
; Function Attrs: noinline uwtable
define internal void @"_ZN15LazySegmentTreeISt4pairIiiEiZ5solvevE3$_0Z5solvevE3$_1Z5solvevE3$_2E4evalEi"(%struct.LazySegmentTree* %0, i32 %1) #0 align 2 {
  %3 = alloca %"struct.std::pair", align 4
  %4 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 8
  %5 = sext i32 %1 to i64
  %6 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.5"* %4, i64 %5) #3
  %7 = load i32, i32* %6, align 4
  %8 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 6
  %9 = load i32, i32* %8, align 4
  %10 = icmp eq i32 %7, %9
  br i1 %10, label %11, label %12
...
12:                                               ; preds = %2
  %13 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 4
  %14 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 8
  %15 = shl i32 %1, 1
  %16 = sext i32 %15 to i64
  %17 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.5"* %14, i64 %16) #3
  %18 = load i32, i32* %17, align 4
  %19 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 8
  %20 = sext i32 %1 to i64
  %21 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.5"* %19, i64 %20) #3
  %22 = load i32, i32* %21, align 4
  %23 = call i32 @"_ZZ5solvevENK3$_2clEii"(%class.anon.12* %13, i32 %18, i32 %22)
  %24 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 8
  %25 = shl i32 %1, 1
  %26 = sext i32 %25 to i64
  %27 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.5"* %24, i64 %26) #3
  store i32 %23, i32* %27, align 4
  %28 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 4
  %29 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 8
  %30 = shl i32 %1, 1
  %31 = or i32 %30, 1
  %32 = sext i32 %31 to i64
  %33 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.5"* %29, i64 %32) #3
  %34 = load i32, i32* %33, align 4
  %35 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 8
  %36 = sext i32 %1 to i64
  %37 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.5"* %35, i64 %36) #3
  %38 = load i32, i32* %37, align 4
  %39 = call i32 @"_ZZ5solvevENK3$_2clEii"(%class.anon.12* %28, i32 %34, i32 %38)
  %40 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 8
  %41 = shl i32 %1, 1
  %42 = or i32 %41, 1
  %43 = sext i32 %42 to i64
  %44 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.5"* %40, i64 %43) #3
  store i32 %39, i32* %44, align 4
  %45 = call i64 @"_ZN15LazySegmentTreeISt4pairIiiEiZ5solvevE3$_0Z5solvevE3$_1Z5solvevE3$_2E7reflectEi"(%struct.LazySegmentTree* %0, i32 %1)
  %46 = bitcast %"struct.std::pair"* %3 to i64*
  store i64 %45, i64* %46, align 4
  %47 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 7
  %48 = sext i32 %1 to i64
  %49 = call dereferenceable(8) %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EEixEm(%"class.std::vector.14"* %47, i64 %48) #3
  %50 = call dereferenceable(8) %"struct.std::pair"* @_ZNSt4pairIiiEaSEOS0_(%"struct.std::pair"* %49, %"struct.std::pair"* dereferenceable(8) %3) #3
  %51 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 6
  %52 = load i32, i32* %51, align 4
  %53 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 8
  %54 = sext i32 %1 to i64
  %55 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.5"* %53, i64 %54) #3
...
; Function Attrs: noinline uwtable
define internal i64 @"_ZN15LazySegmentTreeISt4pairIiiEiZ5solvevE3$_0Z5solvevE3$_1Z5solvevE3$_2E7reflectEi"(%struct.LazySegmentTree* %0, i32 %1) #0 align 2 {
  %3 = alloca %"struct.std::pair", align 4
  %4 = alloca %"struct.std::pair", align 4
  %5 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 8
  %6 = sext i32 %1 to i64
  %7 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.5"* %5, i64 %6) #3
  %8 = load i32, i32* %7, align 4
  %9 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 6
  %10 = load i32, i32* %9, align 4
  %11 = icmp eq i32 %8, %10
...
12:                                               ; preds = %2
  ...
  %15 = call dereferenceable(8) %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EEixEm(%"class.std::vector.14"* %13, i64 %14) #3
...
18:                                               ; preds = %2
  %19 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 3
  %20 = getelementptr inbounds %struct.LazySegmentTree, %struct.LazySegmentTree* %0, i32 0, i32 7
  %21 = sext i32 %1 to i64
  %22 = call dereferenceable(8) %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EEixEm(%"class.std::vector.14"* %20, i64 %21) #3
  ...
  %29 = bitcast %"struct.std::pair"* %4 to i64*
  %30 = load i64, i64* %29, align 4
  %31 = call i64 @"_ZZ5solvevENK3$_1clESt4pairIiiEi"(%class.anon.10* %19, i64 %30, i32 %28)
...
; Function Attrs: noinline uwtable
define internal i64 @"_ZZ5solvevENK3$_1clESt4pairIiiEi"(%class.anon.10* %0, i64 %1, i32 %2) #0 align 2 {
  %4 = alloca %"struct.std::pair", align 4
  %5 = alloca %"struct.std::pair", align 4
  %6 = alloca i32, align 4
  ...
  call void @_ZNSt4pairIiiEC2IiRiLb1EEEOT_OT0_(%"struct.std::pair"* %4, i32* dereferenceable(4) %6, i32* dereferenceable(4) %14)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s226564379.cpp() #0 section ".text.startup" {
