; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01967/s471178665.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01967/s471178665.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s471178665.cpp, i8* null }]
...
79:                                               ; preds = %107, %105, %100, %96, %64, %60, %37, %35, %33
...
110:                                              ; preds = %109, %102, %66
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %5) #3
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %2) #3
  ret i32 0

111:                                              ; preds = %79, %75, %71
  %.02 = phi i32 [ %82, %79 ], [ %78, %75 ], [ %74, %71 ]
  %.01 = phi i8* [ %81, %79 ], [ %77, %75 ], [ %73, %71 ]
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %2) #3
  br label %112

112:                                              ; preds = %111, %67
  %.13 = phi i32 [ %.02, %111 ], [ %70, %67 ]
  %.1 = phi i8* [ %.01, %111 ], [ %69, %67 ]
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s471178665.cpp() #0 section ".text.startup" {
