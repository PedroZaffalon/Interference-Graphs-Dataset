; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03242/s716299310.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03242/s716299310.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s716299310.cpp, i8* null }]
...
17:                                               ; preds = %12
  %18 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 9)
...
24:                                               ; preds = %12
  %25 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 1)
...
28:                                               ; preds = %27
  %29 = call dereferenceable(8) %"class.__gnu_cxx::__normal_iterator"* @_ZN9__gnu_cxx17__normal_iteratorIPcNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEppEv(%"class.__gnu_cxx::__normal_iterator"* %2) #3
  br label %10
...
31:                                               ; preds = %20
  %32 = insertvalue { i8*, i32 } undef, i8* %22, 0
  %33 = insertvalue { i8*, i32 } %32, i32 %23, 1
  resume { i8*, i32 } %33
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s716299310.cpp() #0 section ".text.startup" {
