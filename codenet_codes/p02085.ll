; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02085/s842202933.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02085/s842202933.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s842202933.cpp, i8* null }]
...
5:                                                ; preds = %2
  %6 = sdiv i64 %1, 2
  %7 = call i64 @_Z6modpowxx(i64 %0, i64 %6)
  %8 = and i64 %1, 1
  %9 = icmp ne i64 %8, 0
...
define i32 @main() #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  invoke void @_ZNSt6vectorIxSaIxEEC2EmRKS0_(%"class.std::vector"* %2, i64 %14, %"class.std::allocator"* dereferenceable(1) %5)
...
15:                                               ; preds = %0
  ...
  %18 = invoke dereferenceable(8) i64* @_ZSt3maxIxERKT_S2_S2_(i64* dereferenceable(8) %7, i64* dereferenceable(8) %8)
          to label %19 unwind label %74

19:                                               ; preds = %15
  %20 = load i64, i64* %18, align 8
  call void @_ZNSaIxEC2Ev(%"class.std::allocator"* %9) #3
  invoke void @_ZNSt6vectorIxSaIxEEC2EmRKS0_(%"class.std::vector"* %6, i64 %20, %"class.std::allocator"* dereferenceable(1) %9)
          to label %21 unwind label %78

21:                                               ; preds = %19
  call void @_ZNSaIxED2Ev(%"class.std::allocator"* %9) #3
  %22 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %2, i64 1) #3
  store i64 1, i64* %22, align 8
  %23 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %2, i64 0) #3
  store i64 1, i64* %23, align 8
  %24 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %2, i64 2) #3
  store i64 3, i64* %24, align 8
  %25 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %6, i64 1) #3
  store i64 1, i64* %25, align 8
  %26 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %6, i64 0) #3
  store i64 1, i64* %26, align 8
  %27 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %6, i64 2) #3
  store i64 5, i64* %27, align 8
  %28 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %6, i64 3) #3
  store i64 31, i64* %28, align 8
  br label %29

29:                                               ; preds = %68, %21
  %.03 = phi i64 [ 0, %21 ], [ %69, %68 ]
...
33:                                               ; preds = %29
  ...
  %58 = mul nsw i64 %57, %.03
  %59 = srem i64 %58, 1000000007
  %60 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %6, i64 %.03) #3
...
83:                                               ; preds = %107, %82
  %.05 = phi i64 [ 3, %82 ], [ %108, %107 ]
  %84 = load i64, i64* %1, align 8
  %85 = icmp sle i64 %.05, %84
...
86:                                               ; preds = %83
  ...
  %106 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %2, i64 %.05) #3
  store i64 %105, i64* %106, align 8
  br label %107

107:                                              ; preds = %86
  %108 = add nsw i64 %.05, 1
  br label %83
...
110:                                              ; preds = %116, %109
  %.06 = phi i64 [ 1, %109 ], [ %115, %116 ]
  %.04 = phi i64 [ 1, %109 ], [ %117, %116 ]
  %111 = load i64, i64* %1, align 8
  %112 = icmp sle i64 %.04, %111
  br i1 %112, label %113, label %118

113:                                              ; preds = %110
  %114 = mul nsw i64 %.06, %.04
...
128:                                              ; preds = %118
  ...
  %132 = invoke i64 @_Z6modpowxx(i64 %.06, i64 2)
          to label %133 unwind label %142

133:                                              ; preds = %128
  %134 = invoke i64 @_Z6modpowxx(i64 %132, i64 1000000005)
          to label %135 unwind label %142

135:                                              ; preds = %133
  %136 = mul nsw i64 %131, %134
...
146:                                              ; preds = %142, %78, %74
  %.01 = phi i32 [ %145, %142 ], [ %81, %78 ], [ %77, %74 ]
  %.0 = phi i8* [ %144, %142 ], [ %80, %78 ], [ %76, %74 ]
  call void @_ZNSt6vectorIxSaIxEED2Ev(%"class.std::vector"* %2) #3
  br label %147

147:                                              ; preds = %146, %70
  %.12 = phi i32 [ %.01, %146 ], [ %73, %70 ]
  %.1 = phi i8* [ %.0, %146 ], [ %72, %70 ]
  %148 = insertvalue { i8*, i32 } undef, i8* %.1, 0
  %149 = insertvalue { i8*, i32 } %148, i32 %.12, 1
  resume { i8*, i32 } %149
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s842202933.cpp() #0 section ".text.startup" {
