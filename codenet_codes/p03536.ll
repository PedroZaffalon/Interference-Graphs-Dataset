; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03536/s031347337.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03536/s031347337.c"
...
define i32 @main() #0 {
  ...
  %2 = alloca [8192 x i64], align 16
  %3 = alloca [8192 x %struct.sd], align 16
  %4 = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i32 0, i32 0), i64* %1)
  br label %5

5:                                                ; preds = %9, %0
  %.01 = phi i64 [ 0, %0 ], [ %10, %9 ]
  %6 = icmp slt i64 %.01, 8192
  br i1 %6, label %7, label %11

7:                                                ; preds = %5
  %8 = getelementptr inbounds [8192 x i64], [8192 x i64]* %2, i64 0, i64 %.01
  store i64 4154118101919364364, i64* %8, align 8
  br label %9
...
11:                                               ; preds = %5
  %12 = getelementptr inbounds [8192 x i64], [8192 x i64]* %2, i64 0, i64 0
  store i64 0, i64* %12, align 16
  br label %13

13:                                               ; preds = %29, %11
  %.1 = phi i64 [ 0, %11 ], [ %30, %29 ]
  %14 = load i64, i64* %1, align 8
  %15 = icmp slt i64 %.1, %14
  br i1 %15, label %16, label %31

16:                                               ; preds = %13
  %17 = getelementptr inbounds [8192 x %struct.sd], [8192 x %struct.sd]* %3, i64 0, i64 %.1
  %18 = getelementptr inbounds %struct.sd, %struct.sd* %17, i32 0, i32 0
  %19 = getelementptr inbounds [8192 x %struct.sd], [8192 x %struct.sd]* %3, i64 0, i64 %.1
  %20 = getelementptr inbounds %struct.sd, %struct.sd* %19, i32 0, i32 1
  %21 = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.4, i32 0, i32 0), i32* %18, i32* %20)
  %22 = getelementptr inbounds [8192 x %struct.sd], [8192 x %struct.sd]* %3, i64 0, i64 %.1
  %23 = getelementptr inbounds %struct.sd, %struct.sd* %22, i32 0, i32 1
  %24 = load i32, i32* %23, align 4
  %25 = getelementptr inbounds [8192 x %struct.sd], [8192 x %struct.sd]* %3, i64 0, i64 %.1
...
36:                                               ; preds = %62, %35
  %.02 = phi i64 [ %.2, %35 ], [ %63, %62 ]
  %37 = icmp sge i64 %.02, 0
  br i1 %37, label %38, label %64

38:                                               ; preds = %36
  %39 = getelementptr inbounds [8192 x i64], [8192 x i64]* %2, i64 0, i64 %.02
  %40 = load i64, i64* %39, align 8
  %41 = getelementptr inbounds [8192 x %struct.sd], [8192 x %struct.sd]* %3, i64 0, i64 %.2
  %42 = getelementptr inbounds %struct.sd, %struct.sd* %41, i32 0, i32 1
  %43 = load i32, i32* %42, align 4
  %44 = sext i32 %43 to i64
  %45 = add nsw i64 %40, %44
  %46 = getelementptr inbounds [8192 x %struct.sd], [8192 x %struct.sd]* %3, i64 0, i64 %.2
...
51:                                               ; preds = %38
  %52 = getelementptr inbounds [8192 x i64], [8192 x i64]* %2, i64 0, i64 %.02
  %53 = load i64, i64* %52, align 8
  %54 = getelementptr inbounds [8192 x %struct.sd], [8192 x %struct.sd]* %3, i64 0, i64 %.2
  %55 = getelementptr inbounds %struct.sd, %struct.sd* %54, i32 0, i32 1
  %56 = load i32, i32* %55, align 4
  %57 = sext i32 %56 to i64
  %58 = add nsw i64 %53, %57
  %59 = add nsw i64 %.02, 1
  %60 = getelementptr inbounds [8192 x i64], [8192 x i64]* %2, i64 0, i64 %59
...
69:                                               ; preds = %78, %67
  %.3 = phi i64 [ %68, %67 ], [ %79, %78 ]
  %70 = icmp sge i64 %.3, 0
  br i1 %70, label %71, label %80

71:                                               ; preds = %69
  %72 = getelementptr inbounds [8192 x i64], [8192 x i64]* %2, i64 0, i64 %.3
  %73 = load i64, i64* %72, align 8
  %74 = icmp ne i64 %73, 4154118101919364364
  br i1 %74, label %75, label %77

75:                                               ; preds = %71
  %76 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.5, i32 0, i32 0), i64 %.3)
  br label %81
