; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00799/s890587805.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00799/s890587805.cpp"
...
11:                                               ; preds = %7
  %12 = getelementptr inbounds [100 x %"class.std::vector"], [100 x %"class.std::vector"]* %3, i32 0, i32 0
  %13 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %12, i64 100
  br label %14

14:                                               ; preds = %14, %11
  %15 = phi %"class.std::vector"* [ %12, %11 ], [ %16, %14 ]
  call void @_ZNSt6vectorIiSaIiEEC2Ev(%"class.std::vector"* %15) #10
...
24:                                               ; preds = %23
  %25 = invoke i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i32 0, i32 0), i32* %4)
...
30:                                               ; preds = %141, %36, %24
  ...
  %34 = getelementptr inbounds [100 x %"class.std::vector"], [100 x %"class.std::vector"]* %3, i32 0, i32 0
  %35 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %34, i64 100
  br label %151

36:                                               ; preds = %26
  %37 = sext i32 %.01 to i64
  %38 = getelementptr inbounds [100 x %"class.std::vector"], [100 x %"class.std::vector"]* %3, i64 0, i64 %37
...
43:                                               ; preds = %19
  ...
  call void @llvm.memset.p0i8.i64(i8* align 16 %44, i8 0, i64 400, i1 false)
  %45 = bitcast [100 x i32]* %6 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %45, i8 0, i64 400, i1 false)
  br label %46

46:                                               ; preds = %140, %43
  %.03 = phi i32 [ 0, %43 ], [ %.14, %140 ]
  %.02 = phi i32 [ -1, %43 ], [ %.6, %140 ]
...
51:                                               ; preds = %103, %50
  %.14 = phi i32 [ %.03, %50 ], [ %.47, %103 ]
  %.1 = phi i32 [ %.02, %50 ], [ %.4, %103 ]
  %.0 = phi i32 [ 0, %50 ], [ %104, %103 ]
...
62:                                               ; preds = %56
  ...
  %71 = getelementptr inbounds [100 x %"class.std::vector"], [100 x %"class.std::vector"]* %3, i64 0, i64 %70
  %72 = sext i32 %.0 to i64
  %73 = getelementptr inbounds [100 x i32], [100 x i32]* %5, i64 0, i64 %72
  %74 = load i32, i32* %73, align 4
  %75 = sext i32 %74 to i64
  %76 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %71, i64 %75) #10
...
79:                                               ; preds = %62
  ...
  %86 = getelementptr inbounds [100 x %"class.std::vector"], [100 x %"class.std::vector"]* %3, i64 0, i64 %85
  %87 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* %86) #10
  %88 = urem i64 %84, %87
...
100:                                              ; preds = %98, %97
  %.25 = phi i32 [ %.14, %97 ], [ %99, %98 ]
  %.2 = phi i32 [ %.0, %97 ], [ %.1, %98 ]
  br label %101

101:                                              ; preds = %100, %94
  %.36 = phi i32 [ %.14, %94 ], [ %.25, %100 ]
  %.3 = phi i32 [ %.1, %94 ], [ %.2, %100 ]
  br label %102

102:                                              ; preds = %101, %54
  %.47 = phi i32 [ %.36, %101 ], [ %.14, %54 ]
  %.4 = phi i32 [ %.3, %101 ], [ %.1, %54 ]
  br label %103
...
107:                                              ; preds = %105
  ...
  %116 = getelementptr inbounds [100 x %"class.std::vector"], [100 x %"class.std::vector"]* %3, i64 0, i64 %115
  %117 = sext i32 %.1 to i64
  %118 = getelementptr inbounds [100 x i32], [100 x i32]* %5, i64 0, i64 %117
  %119 = load i32, i32* %118, align 4
  %120 = sext i32 %119 to i64
  %121 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %116, i64 %120) #10
...
124:                                              ; preds = %107
  ...
  %131 = getelementptr inbounds [100 x %"class.std::vector"], [100 x %"class.std::vector"]* %3, i64 0, i64 %130
  %132 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* %131) #10
...
139:                                              ; preds = %124, %107
  %.5 = phi i32 [ -1, %124 ], [ %.1, %107 ]
  br label %140

140:                                              ; preds = %139, %105
  %.6 = phi i32 [ %.5, %139 ], [ %.1, %105 ]
  br label %46

141:                                              ; preds = %46
  %142 = invoke i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i32 0, i32 0), i32 %.03)
          to label %143 unwind label %30

143:                                              ; preds = %141
  %144 = getelementptr inbounds [100 x %"class.std::vector"], [100 x %"class.std::vector"]* %3, i32 0, i32 0
  %145 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %144, i64 100
  br label %146

146:                                              ; preds = %146, %143
  %147 = phi %"class.std::vector"* [ %145, %143 ], [ %148, %146 ]
  %148 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %147, i64 -1
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %148) #10
...
151:                                              ; preds = %151, %30
  %152 = phi %"class.std::vector"* [ %35, %30 ], [ %153, %151 ]
  %153 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %152, i64 -1
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %153) #10
  %154 = icmp eq %"class.std::vector"* %153, %34
...
157:                                              ; preds = %155
  %158 = insertvalue { i8*, i32 } undef, i8* %32, 0
  %159 = insertvalue { i8*, i32 } %158, i32 %33, 1
  resume { i8*, i32 } %159
}
