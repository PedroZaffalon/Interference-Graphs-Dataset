; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02959/s575285319.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02959/s575285319.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s575285319.cpp, i8* null }]
...
18:                                               ; preds = %14
  ...
  %20 = invoke dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEE2atEm(%"class.std::vector"* %2, i64 %19)
...
34:                                               ; preds = %128, %126, %114, %105, %100, %97, %90, %84, %80, %74, %71, %64, %57, %54, %45, %42, %21, %18
...
51:                                               ; preds = %124, %50
  %.07 = phi i32 [ 0, %50 ], [ %125, %124 ]
  %.05 = phi i64 [ 0, %50 ], [ %.2, %124 ]
...
67:                                               ; preds = %64
  ...
  %70 = add nsw i64 %.05, %69
  br label %124

71:                                               ; preds = %61
  %72 = sext i32 %.07 to i64
  %73 = invoke dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEE2atEm(%"class.std::vector"* %2, i64 %72)
          to label %74 unwind label %34

74:                                               ; preds = %71
  %75 = load i32, i32* %73, align 4
  %76 = sext i32 %75 to i64
  %77 = add nsw i64 %.05, %76
  %78 = sext i32 %.07 to i64
  %79 = invoke dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEE2atEm(%"class.std::vector"* %2, i64 %78)
...
110:                                              ; preds = %105
  ...
  %113 = add nsw i64 %77, %112
  br label %122

114:                                              ; preds = %94
  %115 = add nsw i32 %.07, 1
  %116 = sext i32 %115 to i64
  %117 = invoke dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEE2atEm(%"class.std::vector"* %2, i64 %116)
          to label %118 unwind label %34

118:                                              ; preds = %114
  %119 = load i32, i32* %117, align 4
  %120 = sext i32 %119 to i64
  %121 = add nsw i64 %77, %120
  br label %122

122:                                              ; preds = %118, %110
  %.16 = phi i64 [ %113, %110 ], [ %121, %118 ]
  br label %123
...
124:                                              ; preds = %123, %67
  %.2 = phi i64 [ %70, %67 ], [ %.16, %123 ]
  %125 = add nsw i32 %.07, 1
  br label %51

126:                                              ; preds = %51
  %127 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEx(%"class.std::basic_ostream"* @_ZSt4cout, i64 %.05)
...
132:                                              ; preds = %131, %26
  %.12 = phi i32 [ %.01, %131 ], [ %29, %26 ]
  %.1 = phi i8* [ %.0, %131 ], [ %28, %26 ]
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s575285319.cpp() #0 section ".text.startup" {
