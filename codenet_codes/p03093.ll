; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03093/s803048833.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03093/s803048833.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s803048833.cpp, i8* null }]
...
define zeroext i1 @_Z5judgeii(i32 %0, i32 %1) #4 {
  br label %3
...
9:                                                ; preds = %3
  ...
  %12 = getelementptr inbounds [200010 x i32], [200010 x i32]* @A, i64 0, i64 %11
...
24:                                               ; preds = %9
  %25 = icmp sle i32 %22, %1
  br label %26

26:                                               ; preds = %24, %9
  %27 = phi i1 [ false, %9 ], [ %25, %24 ]
  %28 = zext i1 %27 to i32
  %29 = trunc i8 %.01 to i1
...
22:                                               ; preds = %13
  ...
  %25 = getelementptr inbounds i32, i32* getelementptr inbounds ([200010 x i32], [200010 x i32]* @A, i32 0, i64 1), i64 %24
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([200010 x i32], [200010 x i32]* @A, i32 0, i64 1), i32* %25)
  %26 = load i32, i32* @M, align 4
  %27 = sub nsw i32 %26, 1
  br label %28

28:                                               ; preds = %95, %22
  %.05 = phi i32 [ %27, %22 ], [ %.16, %95 ]
  %.03 = phi i32 [ %27, %22 ], [ %.14, %95 ]
  %.02 = phi i32 [ 0, %22 ], [ %.1, %95 ]
  %29 = icmp sle i32 %.02, %.03
...
34:                                               ; preds = %56, %30
  %.09 = phi i32 [ 0, %30 ], [ %.110, %56 ]
  %.07 = phi i32 [ %33, %30 ], [ %.18, %56 ]
  %35 = mul nsw i32 %.09, 2
  %36 = icmp sgt i32 %.07, %35
  br i1 %36, label %37, label %57

37:                                               ; preds = %34
  %38 = add nsw i32 %.09, 1
  %39 = sub nsw i32 %.07, %.09
...
56:                                               ; preds = %54, %52
  %.110 = phi i32 [ %53, %52 ], [ %.09, %54 ]
  %.18 = phi i32 [ %.07, %52 ], [ %55, %54 ]
  br label %34

57:                                               ; preds = %34
  %58 = mul nsw i32 %.09, 2
  %59 = icmp eq i32 %.07, %58
  %60 = zext i1 %59 to i8
  %61 = icmp ne i32 %.07, 0
  br i1 %61, label %62, label %75

62:                                               ; preds = %57
  %63 = load i32, i32* getelementptr inbounds ([200010 x i32], [200010 x i32]* @A, i64 0, i64 1), align 4
...
75:                                               ; preds = %62, %57
  %.0 = phi i8 [ %74, %62 ], [ %60, %57 ]
  %76 = call zeroext i1 @_Z5judgeii(i32 %.07, i32 %32)
  ...
  %81 = icmp ne i32 %80, 0
  %82 = zext i1 %81 to i8
  %83 = call zeroext i1 @_Z5judgeii(i32 0, i32 %32)
...
95:                                               ; preds = %93, %91
  %.16 = phi i32 [ %32, %91 ], [ %.05, %93 ]
  %.14 = phi i32 [ %92, %91 ], [ %.03, %93 ]
  %.1 = phi i32 [ %.02, %91 ], [ %94, %93 ]
  br label %28

96:                                               ; preds = %28
  %97 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %.05)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s803048833.cpp() #0 section ".text.startup" {
