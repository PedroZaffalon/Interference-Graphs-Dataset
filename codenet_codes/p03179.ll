; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03179/s990696726.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03179/s990696726.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s990696726.cpp, i8* null }]
...
37:                                               ; preds = %119, %36
  %.0 = phi i32 [ 1, %36 ], [ %120, %119 ]
  %38 = icmp sle i32 %.0, %.01
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s990696726.cpp() #0 section ".text.startup" {
