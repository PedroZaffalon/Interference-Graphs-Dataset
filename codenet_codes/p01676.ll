; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01676/s181857760.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01676/s181857760.cpp"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

%"class.std::ios_base::Init" = type { i8 }
%struct.UF = type { [500 x i32], [500 x i32], [500 x i32] }
...
@BUF = global [3500000 x i8] zeroinitializer, align 16
@uf = global %struct.UF zeroinitializer, align 4
@n = global i32 0, align 4
@m = global i32 0, align 4
@e = global [500 x %"class.std::vector"] zeroinitializer, align 16
@saw = global [500 x i8] zeroinitializer, align 16
@_ZSt3cin = external global %"class.std::basic_istream", align 8
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@.str = private unnamed_addr constant [5 x i8] c"%d%d\00", align 1
@.str.2 = private unnamed_addr constant [26 x i8] c"vector::_M_realloc_insert\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s181857760.cpp, i8* null }]
...
1:                                                ; preds = %1, %0
  %2 = phi %"class.std::vector"* [ getelementptr inbounds ([500 x %"class.std::vector"], [500 x %"class.std::vector"]* @e, i32 0, i32 0), %0 ], [ %3, %1 ]
  call void @_ZNSt6vectorIiSaIiEEC2Ev(%"class.std::vector"* %2) #3
  %3 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %2, i64 1
  %4 = icmp eq %"class.std::vector"* %3, getelementptr inbounds ([500 x %"class.std::vector"], [500 x %"class.std::vector"]* @e, i64 1, i64 0)
...
2:                                                ; preds = %2, %1
  %3 = phi %"class.std::vector"* [ getelementptr inbounds ([500 x %"class.std::vector"], [500 x %"class.std::vector"]* @e, i64 1, i64 0), %1 ], [ %4, %2 ]
  %4 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %3, i64 -1
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %4) #3
  %5 = icmp eq %"class.std::vector"* %4, getelementptr inbounds ([500 x %"class.std::vector"], [500 x %"class.std::vector"]* @e, i32 0, i32 0)
...
define i32 @_Z3dfsi(i32 %0) #0 {
  %2 = sext i32 %0 to i64
  %3 = getelementptr inbounds [500 x i8], [500 x i8]* @saw, i64 0, i64 %2
...
4:                                                ; preds = %31, %1
  ...
  %5 = sext i32 %.0 to i64
  %6 = sext i32 %0 to i64
  %7 = getelementptr inbounds [500 x %"class.std::vector"], [500 x %"class.std::vector"]* @e, i64 0, i64 %6
...
10:                                               ; preds = %4
  ...
  %12 = getelementptr inbounds [500 x %"class.std::vector"], [500 x %"class.std::vector"]* @e, i64 0, i64 %11
  %13 = sext i32 %.0 to i64
  %14 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %12, i64 %13) #3
  %15 = load i32, i32* %14, align 4
  %16 = sext i32 %15 to i64
  %17 = getelementptr inbounds [500 x i8], [500 x i8]* @saw, i64 0, i64 %16
...
22:                                               ; preds = %10
  ...
  %24 = getelementptr inbounds [500 x %"class.std::vector"], [500 x %"class.std::vector"]* @e, i64 0, i64 %23
  %25 = sext i32 %.0 to i64
  %26 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %24, i64 %25) #3
  %27 = load i32, i32* %26, align 4
  %28 = call i32 @_Z3dfsi(i32 %27)
  %29 = add nsw i32 %.01, %28
  br label %30

30:                                               ; preds = %22, %20
  %.1 = phi i32 [ %21, %20 ], [ %29, %22 ]
  br label %31
...
define i32 @main() #5 {
  ...
  call void @_Z1IRiS_(i32* dereferenceable(4) @n, i32* dereferenceable(4) @m)
...
7:                                                ; preds = %4
  ...
  %16 = getelementptr inbounds [500 x %"class.std::vector"], [500 x %"class.std::vector"]* @e, i64 0, i64 %15
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %16, i32* dereferenceable(4) %2)
  %17 = load i32, i32* %1, align 4
  %18 = load i32, i32* %2, align 4
  call void @_ZN2UF5uniteEii(%struct.UF* @uf, i32 %17, i32 %18)
  br label %19
...
21:                                               ; preds = %4
  %22 = call i32 @_Z3dfsi(i32 0)
  %23 = add nsw i32 %22, -1
  br label %24

24:                                               ; preds = %35, %21
  %.02 = phi i32 [ %23, %21 ], [ %.1, %35 ]
...
27:                                               ; preds = %24
  ...
  %29 = getelementptr inbounds [500 x i32], [500 x i32]* getelementptr inbounds (%struct.UF, %struct.UF* @uf, i32 0, i32 0), i64 0, i64 %28
...
37:                                               ; preds = %24
  %38 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %.02)
  %39 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEPFRSoS_E(%"class.std::basic_ostream"* %38, %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  ret i32 0
}

; Function Attrs: noinline uwtable
define linkonce_odr void @_Z1IRiS_(i32* dereferenceable(4) %0, i32* dereferenceable(4) %1) #0 comdat {
  %3 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0), i32* %0, i32* %1)
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN2UF4initEi(%struct.UF* %0, i32 %1) #4 comdat align 2 {
  br label %3
...
5:                                                ; preds = %3
  ...
  %7 = sext i32 %.0 to i64
  %8 = getelementptr inbounds [500 x i32], [500 x i32]* %6, i64 0, i64 %7
  store i32 %.0, i32* %8, align 4
  %9 = getelementptr inbounds %struct.UF, %struct.UF* %0, i32 0, i32 1
  %10 = sext i32 %.0 to i64
  %11 = getelementptr inbounds [500 x i32], [500 x i32]* %9, i64 0, i64 %10
  store i32 0, i32* %11, align 4
  %12 = getelementptr inbounds %struct.UF, %struct.UF* %0, i32 0, i32 2
  %13 = sext i32 %.0 to i64
  %14 = getelementptr inbounds [500 x i32], [500 x i32]* %12, i64 0, i64 %13
...
8:                                                ; preds = %3
  ...
  %15 = getelementptr inbounds [500 x i32], [500 x i32]* %13, i64 0, i64 %14
...
18:                                               ; preds = %8
  ...
  %21 = getelementptr inbounds [500 x i32], [500 x i32]* %19, i64 0, i64 %20
  ...
  %28 = getelementptr inbounds [500 x i32], [500 x i32]* %26, i64 0, i64 %27
...
31:                                               ; preds = %8
  ...
  %34 = getelementptr inbounds [500 x i32], [500 x i32]* %32, i64 0, i64 %33
  store i32 %4, i32* %34, align 4
  %35 = getelementptr inbounds %struct.UF, %struct.UF* %0, i32 0, i32 1
  %36 = sext i32 %4 to i64
  %37 = getelementptr inbounds [500 x i32], [500 x i32]* %35, i64 0, i64 %36
  %38 = load i32, i32* %37, align 4
  %39 = getelementptr inbounds %struct.UF, %struct.UF* %0, i32 0, i32 1
  %40 = sext i32 %5 to i64
  %41 = getelementptr inbounds [500 x i32], [500 x i32]* %39, i64 0, i64 %40
...
44:                                               ; preds = %31
  ...
  %47 = getelementptr inbounds [500 x i32], [500 x i32]* %45, i64 0, i64 %46
...
50:                                               ; preds = %44, %31
  ...
  %53 = getelementptr inbounds [500 x i32], [500 x i32]* %51, i64 0, i64 %52
  %54 = load i32, i32* %53, align 4
  %55 = getelementptr inbounds %struct.UF, %struct.UF* %0, i32 0, i32 2
  %56 = sext i32 %4 to i64
  %57 = getelementptr inbounds [500 x i32], [500 x i32]* %55, i64 0, i64 %56
...
define linkonce_odr i32 @_ZN2UF4findEi(%struct.UF* %0, i32 %1) #0 comdat align 2 {
  ...
  %4 = sext i32 %1 to i64
  %5 = getelementptr inbounds [500 x i32], [500 x i32]* %3, i64 0, i64 %4
...
9:                                                ; preds = %2
  ...
  %12 = getelementptr inbounds [500 x i32], [500 x i32]* %10, i64 0, i64 %11
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s181857760.cpp() #0 section ".text.startup" {
