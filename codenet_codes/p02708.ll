; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02708/s079791928.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02708/s079791928.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s079791928.cpp, i8* null }]
...
define i32 @main() #5 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %9 = mul nsw i64 %6, %8
  %10 = sdiv i64 %9, 2
  call void @_ZNSt13unordered_setIxSt4hashIxESt8equal_toIxESaIxEEC2Ev(%"class.std::unordered_set"* %3) #3
...
18:                                               ; preds = %32, %16
  %.01 = phi i64 [ 0, %16 ], [ %31, %32 ]
  %.0 = phi i64 [ %17, %16 ], [ %33, %32 ]
  %19 = load i64, i64* %1, align 8
  %20 = icmp sle i64 %.0, %19
  br i1 %20, label %21, label %38

21:                                               ; preds = %18
  %22 = invoke i64 @_Z1fx(i64 %.0)
          to label %23 unwind label %34

23:                                               ; preds = %21
  %24 = load i64, i64* %1, align 8
  %25 = sub nsw i64 %24, %.0
  %26 = invoke i64 @_Z2fmx(i64 %25)
          to label %27 unwind label %34

27:                                               ; preds = %23
  %28 = sub nsw i64 %10, %26
  %29 = sub nsw i64 %28, %22
  %30 = add nsw i64 %29, 1
  %31 = add nsw i64 %.01, %30
  br label %32
...
34:                                               ; preds = %42, %39, %23, %21
  %35 = landingpad { i8*, i32 }
          cleanup
  %36 = extractvalue { i8*, i32 } %35, 0
  %37 = extractvalue { i8*, i32 } %35, 1
  call void @_ZNSt13unordered_setIxSt4hashIxESt8equal_toIxESaIxEED2Ev(%"class.std::unordered_set"* %3) #3
  br label %49
...
39:                                               ; preds = %38, %15
  %.1 = phi i64 [ 0, %15 ], [ %.01, %38 ]
  %40 = add nsw i64 %.1, 1
  %41 = invoke double @_ZSt3powIiiEN9__gnu_cxx11__promote_2IT_T0_NS0_9__promoteIS2_Xsr3std12__is_integerIS2_EE7__valueEE6__typeENS4_IS3_Xsr3std12__is_integerIS3_EE7__valueEE6__typeEE6__typeES2_S3_(i32 10, i32 9)
          to label %42 unwind label %34

42:                                               ; preds = %39
  %43 = fadd double %41, 7.000000e+00
...
49:                                               ; preds = %34
  %50 = insertvalue { i8*, i32 } undef, i8* %36, 0
  %51 = insertvalue { i8*, i32 } %50, i32 %37, 1
  resume { i8*, i32 } %51
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s079791928.cpp() #0 section ".text.startup" {
