; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02174/s822287587.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02174/s822287587.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s822287587.cpp, i8* null }]
...
define i32 @main() #5 {
  ...
  call void @_ZNSt6vectorIiSaIiEE6resizeEm(%"class.std::vector"* @x, i64 %2)
  br label %3
...
7:                                                ; preds = %3
  %8 = sext i32 %.0 to i64
  %9 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* @x, i64 %8) #3
...
5:                                                ; preds = %1
  ...
  %8 = sub nsw i64 %6, %7
  %9 = sub nsw i64 %8, 1
  %10 = call i64 @_Z7mod_powxx(i64 2, i64 %9)
  %11 = sext i32 %.01 to i64
  %12 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* @x, i64 %11) #3
  %13 = load i32, i32* %12, align 4
  %14 = sext i32 %13 to i64
  %15 = mul nsw i64 %10, %14
  %16 = srem i64 %15, 998244353
  %17 = sext i32 %.01 to i64
  %18 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* @x, i64 %17) #3
  %19 = load i32, i32* %18, align 4
  %20 = add nsw i32 %19, 1
  %21 = sext i32 %20 to i64
  %22 = sext i32 %.01 to i64
  %23 = call i64 @_Z7mod_powxx(i64 %21, i64 %22)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s822287587.cpp() #0 section ".text.startup" {
