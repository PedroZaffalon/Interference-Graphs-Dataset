; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01061/s520286017.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01061/s520286017.cpp"
...
@Par = global [1010 x i32] zeroinitializer, align 16
@Rank = global [1010 x i32] zeroinitializer, align 16
@N = global i32 0, align 4
@M = global i32 0, align 4
@deg = global [1010 x i32] zeroinitializer, align 16
@_ZSt3cin = external global %"class.std::basic_istream", align 8
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s520286017.cpp, i8* null }]
...
4:                                                ; preds = %2
  %5 = sext i32 %.0 to i64
  %6 = getelementptr inbounds [1010 x i32], [1010 x i32]* @Par, i64 0, i64 %5
  store i32 %.0, i32* %6, align 4
  %7 = sext i32 %.0 to i64
  %8 = getelementptr inbounds [1010 x i32], [1010 x i32]* @Rank, i64 0, i64 %7
...
define i32 @_Z4findi(i32 %0) #0 {
  %2 = sext i32 %0 to i64
  %3 = getelementptr inbounds [1010 x i32], [1010 x i32]* @Par, i64 0, i64 %2
...
7:                                                ; preds = %1
  %8 = sext i32 %0 to i64
  %9 = getelementptr inbounds [1010 x i32], [1010 x i32]* @Par, i64 0, i64 %8
  %10 = load i32, i32* %9, align 4
  %11 = call i32 @_Z4findi(i32 %10)
  %12 = sext i32 %0 to i64
  %13 = getelementptr inbounds [1010 x i32], [1010 x i32]* @Par, i64 0, i64 %12
...
; Function Attrs: noinline uwtable
define void @_Z4unitii(i32 %0, i32 %1) #0 {
...
7:                                                ; preds = %2
  %8 = sext i32 %3 to i64
  %9 = getelementptr inbounds [1010 x i32], [1010 x i32]* @Rank, i64 0, i64 %8
  %10 = load i32, i32* %9, align 4
  %11 = sext i32 %4 to i64
  %12 = getelementptr inbounds [1010 x i32], [1010 x i32]* @Rank, i64 0, i64 %11
...
15:                                               ; preds = %7
  ...
  %17 = getelementptr inbounds [1010 x i32], [1010 x i32]* @Par, i64 0, i64 %16
  store i32 %4, i32* %17, align 4
  br label %34

18:                                               ; preds = %7
  %19 = sext i32 %4 to i64
  %20 = getelementptr inbounds [1010 x i32], [1010 x i32]* @Par, i64 0, i64 %19
  store i32 %3, i32* %20, align 4
  %21 = sext i32 %3 to i64
  %22 = getelementptr inbounds [1010 x i32], [1010 x i32]* @Rank, i64 0, i64 %21
  %23 = load i32, i32* %22, align 4
  %24 = sext i32 %4 to i64
  %25 = getelementptr inbounds [1010 x i32], [1010 x i32]* @Rank, i64 0, i64 %24
...
28:                                               ; preds = %18
  ...
  %30 = getelementptr inbounds [1010 x i32], [1010 x i32]* @Rank, i64 0, i64 %29
...
12:                                               ; preds = %9
  ...
  call void @_Z4unitii(i32 %19, i32 %20)
  %21 = load i32, i32* %1, align 4
  %22 = sext i32 %21 to i64
  %23 = getelementptr inbounds [1010 x i32], [1010 x i32]* @deg, i64 0, i64 %22
  %24 = load i32, i32* %23, align 4
  %25 = add nsw i32 %24, 1
  store i32 %25, i32* %23, align 4
  %26 = load i32, i32* %2, align 4
  %27 = sext i32 %26 to i64
  %28 = getelementptr inbounds [1010 x i32], [1010 x i32]* @deg, i64 0, i64 %27
...
34:                                               ; preds = %59, %33
  %.02 = phi i32 [ 0, %33 ], [ %.1, %59 ]
  %.0 = phi i32 [ 0, %33 ], [ %60, %59 ]
...
37:                                               ; preds = %34
  ...
  %39 = getelementptr inbounds [1010 x i32], [1010 x i32]* @deg, i64 0, i64 %38
  %40 = load i32, i32* %39, align 4
  %41 = icmp ne i32 %40, 0
  br i1 %41, label %42, label %56

42:                                               ; preds = %37
  %43 = invoke i32 @_Z4findi(i32 %.0)
          to label %44 unwind label %52

44:                                               ; preds = %42
  store i32 %43, i32* %4, align 4
  %45 = invoke { %"struct.std::_Rb_tree_node_base"*, i8 } @_ZNSt3setIiSt4lessIiESaIiEE6insertERKi(%"class.std::set"* %3, i32* dereferenceable(4) %4)
...
61:                                               ; preds = %34
  %62 = call i64 @_ZNKSt3setIiSt4lessIiESaIiEE4sizeEv(%"class.std::set"* %3) #3
  %63 = trunc i64 %62 to i32
  %64 = sub nsw i32 %.02, %63
...
70:                                               ; preds = %52
  %71 = insertvalue { i8*, i32 } undef, i8* %54, 0
  %72 = insertvalue { i8*, i32 } %71, i32 %55, 1
  resume { i8*, i32 } %72
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s520286017.cpp() #0 section ".text.startup" {
