; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00892/s801048472.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00892/s801048472.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s801048472.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define double @_Z1WRKSt6vectorIiSaIiEES3_d(%"class.std::vector"* dereferenceable(24) %0, %"class.std::vector"* dereferenceable(24) %1, double %2) #0 {
...
13:                                               ; preds = %11
  ...
  %15 = call dereferenceable(4) i32* @_ZNKSt6vectorIiSaIiEEixEm(%"class.std::vector"* %0, i64 %14) #3
  %16 = load i32, i32* %15, align 4
  %17 = sitofp i32 %16 to double
  %18 = sext i32 %.0 to i64
  %19 = call dereferenceable(4) i32* @_ZNKSt6vectorIiSaIiEEixEm(%"class.std::vector"* %1, i64 %18) #3
  %20 = load i32, i32* %19, align 4
  %21 = sitofp i32 %20 to double
  %22 = add nsw i32 %.0, 1
  %23 = srem i32 %22, %10
  %24 = sext i32 %23 to i64
  %25 = call dereferenceable(4) i32* @_ZNKSt6vectorIiSaIiEEixEm(%"class.std::vector"* %0, i64 %24) #3
  %26 = load i32, i32* %25, align 4
  %27 = sitofp i32 %26 to double
  %28 = add nsw i32 %.0, 1
  %29 = srem i32 %28, %10
  %30 = sext i32 %29 to i64
  %31 = call dereferenceable(4) i32* @_ZNKSt6vectorIiSaIiEEixEm(%"class.std::vector"* %1, i64 %30) #3
...
38:                                               ; preds = %13
  %39 = fcmp une double %17, %27
  br i1 %39, label %40, label %51

40:                                               ; preds = %38
  %41 = fsub double %33, %21
  %42 = fsub double %2, %17
  %43 = fmul double %41, %42
  %44 = fsub double %27, %17
  %45 = fdiv double %43, %44
  %46 = fadd double %21, %45
  store double %46, double* %6, align 8
  %47 = call dereferenceable(8) double* @_ZSt3minIdERKT_S2_S2_(double* dereferenceable(8) %4, double* dereferenceable(8) %6)
  %48 = load double, double* %47, align 8
  store double %48, double* %4, align 8
  %49 = call dereferenceable(8) double* @_ZSt3maxIdERKT_S2_S2_(double* dereferenceable(8) %5, double* dereferenceable(8) %6)
...
54:                                               ; preds = %11
  ...
  %58 = call dereferenceable(8) double* @_ZSt3maxIdERKT_S2_S2_(double* dereferenceable(8) %7, double* dereferenceable(8) %8)
...
44:                                               ; preds = %40
  ...
  %47 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* %43, i32* dereferenceable(4) %46)
...
79:                                               ; preds = %75
  ...
  %82 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* %78, i32* dereferenceable(4) %81)
...
90:                                               ; preds = %87
  ...
  %93 = invoke dereferenceable(4) i32* @_ZSt3minIiERKT_S2_S2_(i32* dereferenceable(4) %11, i32* dereferenceable(4) %92)
...
99:                                               ; preds = %94
  ...
  invoke void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %15, i32* dereferenceable(4) %102)
...
106:                                              ; preds = %209, %207, %202, %200, %198, %184, %181, %179, %176, %174, %172, %130, %123, %118, %114, %99, %94, %90
...
111:                                              ; preds = %128, %110
  %.010 = phi i32 [ 0, %110 ], [ %129, %128 ]
  %112 = load i32, i32* %2, align 4
  %113 = icmp slt i32 %.010, %112
  br i1 %113, label %114, label %130

114:                                              ; preds = %111
  %115 = sext i32 %.010 to i64
  %116 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %5, i64 %115) #3
  %117 = invoke dereferenceable(4) i32* @_ZSt3minIiERKT_S2_S2_(i32* dereferenceable(4) %13, i32* dereferenceable(4) %116)
...
118:                                              ; preds = %114
  ...
  %122 = invoke dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* dereferenceable(4) %14, i32* dereferenceable(4) %121)
...
123:                                              ; preds = %118
  ...
  invoke void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %15, i32* dereferenceable(4) %126)
...
130:                                              ; preds = %111
  %131 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector"* %15) #3
  %132 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %16, i32 0, i32 0
  store i32* %131, i32** %132, align 8
  %133 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector"* %15) #3
...
140:                                              ; preds = %196, %139
  %.011 = phi double [ 0.000000e+00, %139 ], [ %.112, %196 ]
  %.0 = phi i32 [ 0, %139 ], [ %197, %196 ]
  %141 = sext i32 %.0 to i64
  %142 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* %15) #3
  %143 = sub i64 %142, 1
...
164:                                              ; preds = %160
  ...
  %167 = fcmp ole double %166, %156
  br i1 %167, label %168, label %195

168:                                              ; preds = %164
  %169 = load i32, i32* %14, align 4
  %170 = sitofp i32 %169 to double
  %171 = fcmp ole double %156, %170
  br i1 %171, label %172, label %195

172:                                              ; preds = %168
  %173 = invoke double @_Z1WRKSt6vectorIiSaIiEES3_d(%"class.std::vector"* dereferenceable(24) %3, %"class.std::vector"* dereferenceable(24) %7, double %149)
          to label %174 unwind label %106

174:                                              ; preds = %172
  %175 = invoke double @_Z1WRKSt6vectorIiSaIiEES3_d(%"class.std::vector"* dereferenceable(24) %5, %"class.std::vector"* dereferenceable(24) %9, double %149)
          to label %176 unwind label %106

176:                                              ; preds = %174
  %177 = fmul double %173, %175
  %178 = invoke double @_Z1WRKSt6vectorIiSaIiEES3_d(%"class.std::vector"* dereferenceable(24) %3, %"class.std::vector"* dereferenceable(24) %7, double %154)
          to label %179 unwind label %106

179:                                              ; preds = %176
  %180 = invoke double @_Z1WRKSt6vectorIiSaIiEES3_d(%"class.std::vector"* dereferenceable(24) %5, %"class.std::vector"* dereferenceable(24) %9, double %154)
          to label %181 unwind label %106

181:                                              ; preds = %179
  %182 = fmul double %178, %180
  %183 = invoke double @_Z1WRKSt6vectorIiSaIiEES3_d(%"class.std::vector"* dereferenceable(24) %3, %"class.std::vector"* dereferenceable(24) %7, double %156)
          to label %184 unwind label %106

184:                                              ; preds = %181
  %185 = invoke double @_Z1WRKSt6vectorIiSaIiEES3_d(%"class.std::vector"* dereferenceable(24) %5, %"class.std::vector"* dereferenceable(24) %9, double %156)
          to label %186 unwind label %106

186:                                              ; preds = %184
  %187 = fmul double %183, %185
  %188 = fsub double %154, %149
  %189 = fdiv double %188, 6.000000e+00
  %190 = fmul double 4.000000e+00, %187
  %191 = fadd double %177, %190
  %192 = fadd double %191, %182
  %193 = fmul double %189, %192
  %194 = fadd double %.011, %193
  br label %195

195:                                              ; preds = %186, %168, %164, %160, %145
  %.112 = phi double [ %194, %186 ], [ %.011, %168 ], [ %.011, %164 ], [ %.011, %160 ], [ %.011, %145 ]
  br label %196
...
198:                                              ; preds = %140
  %199 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEPFRSt8ios_baseS0_E(%"class.std::basic_ostream"* @_ZSt4cout, %"class.std::ios_base"* (%"class.std::ios_base"*)* @_ZSt5fixedRSt8ios_base)
          to label %200 unwind label %106

200:                                              ; preds = %198
  %201 = invoke i32 @_ZSt12setprecisioni(i32 10)
...
202:                                              ; preds = %200
  ...
  %206 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_St13_Setprecision(%"class.std::basic_ostream"* dereferenceable(272) %199, i32 %205)
          to label %207 unwind label %106

207:                                              ; preds = %202
  %208 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEd(%"class.std::basic_ostream"* %206, double %.011)
...
212:                                              ; preds = %106, %67
  %.02 = phi i32 [ %70, %67 ], [ %109, %106 ]
  %.01 = phi i8* [ %69, %67 ], [ %108, %106 ]
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %9) #3
  br label %213

213:                                              ; preds = %212, %63
  %.13 = phi i32 [ %.02, %212 ], [ %66, %63 ]
  %.1 = phi i8* [ %.01, %212 ], [ %65, %63 ]
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %7) #3
  br label %214

214:                                              ; preds = %213, %59
  %.24 = phi i32 [ %.13, %213 ], [ %62, %59 ]
  %.2 = phi i8* [ %.1, %213 ], [ %61, %59 ]
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %5) #3
  br label %215

215:                                              ; preds = %214, %55
  %.35 = phi i32 [ %.24, %214 ], [ %58, %55 ]
  %.3 = phi i8* [ %.2, %214 ], [ %57, %55 ]
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %3) #3
  br label %217
...
217:                                              ; preds = %215, %51
  %.46 = phi i32 [ %.35, %215 ], [ %54, %51 ]
  %.4 = phi i8* [ %.3, %215 ], [ %53, %51 ]
  %218 = insertvalue { i8*, i32 } undef, i8* %.4, 0
  %219 = insertvalue { i8*, i32 } %218, i32 %.46, 1
  resume { i8*, i32 } %219
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s801048472.cpp() #0 section ".text.startup" {
