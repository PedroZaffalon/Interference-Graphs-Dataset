; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01560/s528418725.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01560/s528418725.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s528418725.cpp, i8* null }]
...
define i64 @_Z3lcmxx(i64 %0, i64 %1) #0 {
  ...
  %4 = sdiv i64 %0, %3
  %5 = sdiv i64 2000000000000000005, %1
  %6 = icmp sgt i64 %4, %5
...
8:                                                ; preds = %2
  %9 = call i64 @_Z3gcdxx(i64 %0, i64 %1)
  %10 = sdiv i64 %0, %9
  %11 = mul nsw i64 %10, %1
  br label %12

12:                                               ; preds = %8, %7
  %.0 = phi i64 [ 2000000000000000005, %7 ], [ %11, %8 ]
  ret i64 %.0
}

; Function Attrs: noinline nounwind uwtable
define void @_Z15MeviusTransformRSt6vectorIxSaIxEEx(%"class.std::vector"* dereferenceable(24) %0, i64 %1) #4 {
  br label %3
...
37:                                               ; preds = %44, %36
  %.07 = phi i64 [ 0, %36 ], [ %45, %44 ]
  %38 = load i64, i64* %4, align 8
  %39 = icmp slt i64 %.07, %38
  br i1 %39, label %40, label %54

40:                                               ; preds = %37
  %41 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %6, i64 %.07) #3
...
54:                                               ; preds = %37
  ...
  call void @_ZNSaIdEC2Ev(%"class.std::allocator.2"* %9) #3
  invoke void @_ZNSt6vectorIdSaIdEEC2EmRKS0_(%"class.std::vector.0"* %8, i64 %55, %"class.std::allocator.2"* dereferenceable(1) %9)
          to label %56 unwind label %69

56:                                               ; preds = %54
  call void @_ZNSaIdED2Ev(%"class.std::allocator.2"* %9) #3
  br label %57

57:                                               ; preds = %67, %56
  %.08 = phi i64 [ 0, %56 ], [ %68, %67 ]
  %58 = load i64, i64* %4, align 8
  %59 = icmp slt i64 %.08, %58
  br i1 %59, label %60, label %77

60:                                               ; preds = %57
  %61 = call dereferenceable(8) double* @_ZNSt6vectorIdSaIdEEixEm(%"class.std::vector.0"* %8, i64 %.08) #3
...
63:                                               ; preds = %60
  %64 = call dereferenceable(8) double* @_ZNSt6vectorIdSaIdEEixEm(%"class.std::vector.0"* %8, i64 %.08) #3
...
81:                                               ; preds = %116, %80
  %.09 = phi i64 [ 0, %80 ], [ %117, %116 ]
  %82 = load i64, i64* %4, align 8
  %83 = shl i64 1, %82
  %84 = icmp slt i64 %.09, %83
...
93:                                               ; preds = %110, %92
  %.012 = phi i64 [ 0, %92 ], [ %111, %110 ]
  %.010 = phi i64 [ 1, %92 ], [ %.111, %110 ]
  %94 = load i64, i64* %4, align 8
  %95 = icmp slt i64 %.012, %94
...
100:                                              ; preds = %96
  %101 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %6, i64 %.012) #3
  %102 = load i64, i64* %101, align 8
  %103 = invoke i64 @_Z3lcmxx(i64 %.010, i64 %102)
          to label %104 unwind label %105

104:                                              ; preds = %100
  br label %109

105:                                              ; preds = %157, %155, %145, %118, %100
...
112:                                              ; preds = %93
  ...
  %114 = sdiv i64 %113, %.010
  %115 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %10, i64 %.09) #3
  store i64 %114, i64* %115, align 8
  br label %116

116:                                              ; preds = %112, %87
  %117 = add nsw i64 %.09, 1
  br label %81

118:                                              ; preds = %81
  %119 = load i64, i64* %4, align 8
  invoke void @_Z15MeviusTransformRSt6vectorIxSaIxEEx(%"class.std::vector"* dereferenceable(24) %10, i64 %119)
...
121:                                              ; preds = %153, %120
  %.013 = phi double [ 0.000000e+00, %120 ], [ %152, %153 ]
  %.02 = phi i64 [ 0, %120 ], [ %154, %153 ]
  %122 = load i64, i64* %4, align 8
  %123 = shl i64 1, %122
  %124 = icmp slt i64 %.02, %123
...
126:                                              ; preds = %143, %125
  %.01 = phi double [ 1.000000e+00, %125 ], [ %142, %143 ]
  %.0 = phi i64 [ 0, %125 ], [ %144, %143 ]
...
133:                                              ; preds = %129
  %134 = call dereferenceable(8) double* @_ZNSt6vectorIdSaIdEEixEm(%"class.std::vector.0"* %8, i64 %.0) #3
  %135 = load double, double* %134, align 8
  br label %140

136:                                              ; preds = %129
  %137 = call dereferenceable(8) double* @_ZNSt6vectorIdSaIdEEixEm(%"class.std::vector.0"* %8, i64 %.0) #3
  %138 = load double, double* %137, align 8
  %139 = fsub double 1.000000e+00, %138
  br label %140

140:                                              ; preds = %136, %133
  %141 = phi double [ %135, %133 ], [ %139, %136 ]
  %142 = fmul double %.01, %141
  br label %143
...
145:                                              ; preds = %126
  %146 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %10, i64 %.02) #3
...
149:                                              ; preds = %145
  ...
  %151 = fmul double %.01, %150
  %152 = fadd double %.013, %151
  br label %153

153:                                              ; preds = %149
  %154 = add nsw i64 %.02, 1
  br label %121

155:                                              ; preds = %121
  %156 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEd(%"class.std::basic_ostream"* @_ZSt4cout, double %.013)
...
160:                                              ; preds = %105, %88, %73
  %.04 = phi i32 [ %76, %73 ], [ %108, %105 ], [ %91, %88 ]
  %.03 = phi i8* [ %75, %73 ], [ %107, %105 ], [ %90, %88 ]
  call void @_ZNSt6vectorIdSaIdEED2Ev(%"class.std::vector.0"* %8) #3
  br label %161

161:                                              ; preds = %160, %69, %50
  %.15 = phi i32 [ %53, %50 ], [ %.04, %160 ], [ %72, %69 ]
  %.1 = phi i8* [ %52, %50 ], [ %.03, %160 ], [ %71, %69 ]
  call void @_ZNSt6vectorIxSaIxEED2Ev(%"class.std::vector"* %6) #3
  br label %162

162:                                              ; preds = %161, %46
  %.26 = phi i32 [ %.15, %161 ], [ %49, %46 ]
  %.2 = phi i8* [ %.1, %161 ], [ %48, %46 ]
  %163 = insertvalue { i8*, i32 } undef, i8* %.2, 0
  %164 = insertvalue { i8*, i32 } %163, i32 %.26, 1
  resume { i8*, i32 } %164
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSaIdEC2Ev(%"class.std::allocator.2"* %0) unnamed_addr #4 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSaIdED2Ev(%"class.std::allocator.2"* %0) unnamed_addr #4 comdat align 2 {
  %2 = bitcast %"class.std::allocator.2"* %0 to %"class.__gnu_cxx::new_allocator.3"*
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(8) double* @_ZNSt6vectorIdSaIdEEixEm(%"class.std::vector.0"* %0, i64 %1) #4 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt6vectorIdSaIdEED2Ev(%"class.std::vector.0"* %0) unnamed_addr #4 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorIdEC2Ev(%"class.__gnu_cxx::new_allocator.3"* %0) unnamed_addr #4 comdat align 2 {
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorIdED2Ev(%"class.__gnu_cxx::new_allocator.3"* %0) unnamed_addr #4 comdat align 2 {
  ret void
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt12_Vector_baseIdSaIdEED2Ev(%"struct.std::_Vector_base.1"* %0) unnamed_addr #4 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt12_Vector_baseIdSaIdEE12_Vector_implC2ERKS0_(%"struct.std::_Vector_base<double, std::allocator<double> >::_Vector_impl"* %0, %"class.std::allocator.2"* dereferenceable(1) %1) unnamed_addr #4 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSaIdEC2ERKS_(%"class.std::allocator.2"* %0, %"class.std::allocator.2"* dereferenceable(1) %1) unnamed_addr #4 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorIdEC2ERKS1_(%"class.__gnu_cxx::new_allocator.3"* %0, %"class.__gnu_cxx::new_allocator.3"* dereferenceable(1) %1) unnamed_addr #4 comdat align 2 {
  ret void
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64 @_ZNK9__gnu_cxx13new_allocatorIdE8max_sizeEv(%"class.__gnu_cxx::new_allocator.3"* %0) #4 comdat align 2 {
  ret i64 2305843009213693951
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(1) %"class.std::allocator.2"* @_ZNSt12_Vector_baseIdSaIdEE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base.1"* %0) #4 comdat align 2 {
  %2 = getelementptr inbounds %"struct.std::_Vector_base.1", %"struct.std::_Vector_base.1"* %0, i32 0, i32 0
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorIdE10deallocateEPdm(%"class.__gnu_cxx::new_allocator.3"* %0, double* %1, i64 %2) #4 comdat align 2 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s528418725.cpp() #0 section ".text.startup" {
