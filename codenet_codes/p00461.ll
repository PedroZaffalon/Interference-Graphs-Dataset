; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00461/s044460653.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00461/s044460653.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s044460653.cpp, i8* null }]
...
43:                                               ; preds = %40
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* @l, i32* dereferenceable(4) %1)
  store i32 0, i32* %1, align 4
  br label %44
...
52:                                               ; preds = %51, %48
  %53 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector"* @l) #3
...
55:                                               ; preds = %72, %52
  %.0 = phi i32 [ 0, %52 ], [ %.1, %72 ]
  %56 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector"* @l) #3
...
64:                                               ; preds = %59
  %65 = call dereferenceable(4) i32* @_ZNK9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEdeEv(%"class.__gnu_cxx::__normal_iterator"* %2) #3
...
71:                                               ; preds = %64, %59
  %.1 = phi i32 [ %70, %64 ], [ %.0, %59 ]
  br label %72

72:                                               ; preds = %71
  %73 = call i32* @_ZN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEppEi(%"class.__gnu_cxx::__normal_iterator"* %2, i32 0) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s044460653.cpp() #0 section ".text.startup" {
