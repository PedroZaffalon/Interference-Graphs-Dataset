; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00166/s916196205.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00166/s916196205.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s916196205.cpp, i8* null }]
...
11:                                               ; preds = %27, %10
  %.03 = phi double [ 3.600000e+02, %10 ], [ %17, %27 ]
  %.02 = phi i32 [ 0, %10 ], [ %28, %27 ]
  %.01 = phi double [ 0.000000e+00, %10 ], [ %24, %27 ]
  %12 = sub nsw i32 %8, 1
...
14:                                               ; preds = %11
  ...
  %17 = fsub double %.03, %16
  %18 = load double, double* %2, align 8
  %19 = fdiv double %18, 1.800000e+02
  %20 = call double @atan(double 1.000000e+00) #3
...
41:                                               ; preds = %37
  %42 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERd(%"class.std::basic_istream"* @_ZSt3cin, double* dereferenceable(8) %2)
  %43 = load double, double* %2, align 8
  %44 = fsub double %.14, %43
  %45 = load double, double* %2, align 8
  %46 = fdiv double %45, 1.800000e+02
  %47 = call double @atan(double 1.000000e+00) #3
...
54:                                               ; preds = %37
  %55 = fdiv double %.14, 1.800000e+02
  %56 = call double @atan(double 1.000000e+00) #3
  %57 = fmul double %55, %56
  %58 = fmul double %57, 4.000000e+00
  %59 = call double @sin(double %58) #3
  %60 = fadd double %.0, %59
  %61 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEd(%"class.std::basic_ostream"* @_ZSt4cout, double %35)
  ...
  %63 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEd(%"class.std::basic_ostream"* %62, double %60)
  %64 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEPFRSoS_E(%"class.std::basic_ostream"* %63, %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  %65 = fsub double %35, %60
  %66 = call double @llvm.fabs.f64(double %65)
  %67 = fcmp ole double %66, 1.000000e-09
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s916196205.cpp() #0 section ".text.startup" {
