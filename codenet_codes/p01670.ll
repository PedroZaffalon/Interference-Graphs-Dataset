; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01670/s902200415.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01670/s902200415.cpp"
...
@tmppos = global i32 0, align 4
@cov = global [3005 x i8] zeroinitializer, align 16
@a = global i32 0, align 4
@b = global i32 0, align 4
@edg = global [30005 x %"struct.std::pair"] zeroinitializer, align 16
@_ZSt3cin = external global %"class.std::basic_istream", align 8
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@.str = private unnamed_addr constant [12 x i8] c"Impossible\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s902200415.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define void @_Z3rekii(i32 %0, i32 %1) #0 {
  %3 = sext i32 %1 to i64
  %4 = getelementptr inbounds [3005 x i8], [3005 x i8]* @cov, i64 0, i64 %3
...
11:                                               ; preds = %39, %10
  %12 = load i32, i32* @tmppos, align 4
  %13 = load i32, i32* @m, align 4
  %14 = icmp slt i32 %12, %13
  br i1 %14, label %15, label %37

15:                                               ; preds = %11
  %16 = load i32, i32* @tmppos, align 4
  %17 = sext i32 %16 to i64
  %18 = getelementptr inbounds [30005 x %"struct.std::pair"], [30005 x %"struct.std::pair"]* @edg, i64 0, i64 %17
  %19 = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* %18, i32 0, i32 0
  %20 = load i32, i32* %19, align 8
  %21 = sext i32 %20 to i64
  %22 = getelementptr inbounds [3005 x i8], [3005 x i8]* @cov, i64 0, i64 %21
  %23 = load i8, i8* %22, align 1
  %24 = trunc i8 %23 to i1
  br i1 %24, label %35, label %25

25:                                               ; preds = %15
  %26 = load i32, i32* @tmppos, align 4
  %27 = sext i32 %26 to i64
  %28 = getelementptr inbounds [30005 x %"struct.std::pair"], [30005 x %"struct.std::pair"]* @edg, i64 0, i64 %27
  %29 = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* %28, i32 0, i32 1
  %30 = load i32, i32* %29, align 4
  %31 = sext i32 %30 to i64
  %32 = getelementptr inbounds [3005 x i8], [3005 x i8]* @cov, i64 0, i64 %31
  %33 = load i8, i8* %32, align 1
  %34 = trunc i8 %33 to i1
  br label %35

35:                                               ; preds = %25, %15
  %36 = phi i1 [ true, %15 ], [ %34, %25 ]
  br label %37
...
39:                                               ; preds = %37
  ...
  %41 = add nsw i32 %40, 1
  store i32 %41, i32* @tmppos, align 4
  br label %11

42:                                               ; preds = %37
  %43 = load i32, i32* @tmppos, align 4
...
56:                                               ; preds = %42
  %57 = load i32, i32* @tmppos, align 4
  %58 = add nsw i32 %57, 1
  %59 = load i32, i32* @tmppos, align 4
  %60 = sext i32 %59 to i64
  %61 = getelementptr inbounds [30005 x %"struct.std::pair"], [30005 x %"struct.std::pair"]* @edg, i64 0, i64 %60
  %62 = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* %61, i32 0, i32 0
  %63 = load i32, i32* %62, align 8
  call void @_Z3rekii(i32 %58, i32 %63)
  %64 = load i32, i32* @tmppos, align 4
  %65 = add nsw i32 %64, 1
  %66 = load i32, i32* @tmppos, align 4
  %67 = sext i32 %66 to i64
  %68 = getelementptr inbounds [30005 x %"struct.std::pair"], [30005 x %"struct.std::pair"]* @edg, i64 0, i64 %67
  %69 = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* %68, i32 0, i32 1
  %70 = load i32, i32* %69, align 4
  call void @_Z3rekii(i32 %65, i32 %70)
  br label %71
...
72:                                               ; preds = %71, %2
  ...
  %76 = getelementptr inbounds [3005 x i8], [3005 x i8]* @cov, i64 0, i64 %75
...
16:                                               ; preds = %13
  ...
  %19 = call i64 @_ZSt9make_pairIRiS0_ESt4pairINSt17__decay_and_stripIT_E6__typeENS2_IT0_E6__typeEEOS3_OS6_(i32* dereferenceable(4) @a, i32* dereferenceable(4) @b)
  %20 = bitcast %"struct.std::pair"* %1 to i64*
  store i64 %19, i64* %20, align 4
  %21 = sext i32 %.0 to i64
  %22 = getelementptr inbounds [30005 x %"struct.std::pair"], [30005 x %"struct.std::pair"]* @edg, i64 0, i64 %21
  %23 = call dereferenceable(8) %"struct.std::pair"* @_ZNSt4pairIiiEaSEOS0_(%"struct.std::pair"* %22, %"struct.std::pair"* dereferenceable(8) %1) #3
  br label %24
...
26:                                               ; preds = %13
  call void @llvm.memset.p0i8.i64(i8* align 16 getelementptr inbounds ([3005 x i8], [3005 x i8]* @cov, i32 0, i32 0), i8 0, i64 3005, i1 false)
  store i32 100000, i32* @ans, align 4
  store i32 0, i32* @tmp, align 4
  %27 = load i32, i32* getelementptr inbounds ([30005 x %"struct.std::pair"], [30005 x %"struct.std::pair"]* @edg, i64 0, i64 0, i32 0), align 16
  call void @_Z3rekii(i32 0, i32 %27)
  %28 = load i32, i32* getelementptr inbounds ([30005 x %"struct.std::pair"], [30005 x %"struct.std::pair"]* @edg, i64 0, i64 0, i32 1), align 4
  call void @_Z3rekii(i32 0, i32 %28)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s902200415.cpp() #0 section ".text.startup" {
