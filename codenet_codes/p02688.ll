; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02688/s167844758.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02688/s167844758.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s167844758.cpp, i8* null }]
...
45:                                               ; preds = %57, %44
  %.05 = phi i32 [ 0, %44 ], [ %.1, %57 ]
  %.0 = phi i32 [ 1, %44 ], [ %58, %57 ]
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s167844758.cpp() #0 section ".text.startup" {
