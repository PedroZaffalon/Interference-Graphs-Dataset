; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02271/s095129461.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02271/s095129461.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s095129461.cpp, i8* null }]
...
10:                                               ; preds = %9
  %11 = add nsw i32 %0, 1
  %12 = call i32 @_Z5solveii(i32 %11, i32 %1)
  %13 = icmp ne i32 %12, 0
...
14:                                               ; preds = %10
  ...
  %19 = sub nsw i32 %1, %18
  %20 = call i32 @_Z5solveii(i32 %15, i32 %19)
  %21 = icmp ne i32 %20, 0
  br label %22

22:                                               ; preds = %14, %10
  %23 = phi i1 [ true, %10 ], [ %21, %14 ]
  %24 = zext i1 %23 to i32
  br label %25

25:                                               ; preds = %22, %8, %4
  %.0 = phi i32 [ 1, %4 ], [ 0, %8 ], [ %24, %22 ]
  ret i32 %.0
}
...
18:                                               ; preds = %15
  ...
  %21 = call i32 @_Z5solveii(i32 0, i32 %20)
  %22 = icmp ne i32 %21, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s095129461.cpp() #0 section ".text.startup" {
