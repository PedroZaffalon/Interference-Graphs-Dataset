; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00060/s451549247.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00060/s451549247.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s451549247.cpp, i8* null }]
...
18:                                               ; preds = %5
  %19 = bitcast [11 x i8]* %4 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 1 %19, i8 0, i64 11, i1 false)
...
29:                                               ; preds = %45, %18
  %.01 = phi i32 [ 0, %18 ], [ %.1, %45 ]
  %.0 = phi i32 [ 1, %18 ], [ %46, %45 ]
  %30 = icmp sle i32 %.0, 10
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s451549247.cpp() #0 section ".text.startup" {
