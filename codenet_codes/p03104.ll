; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03104/s793651709.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03104/s793651709.c"
...
; Function Attrs: noinline nounwind uwtable
define i64 @pibit(i64 %0, i64 %1) #0 {
  %3 = shl i64 1, %1
  %4 = sdiv i64 %0, %3
  %5 = srem i64 %0, %3
  %6 = sub nsw i64 %1, 1
  ...
  %14 = call i64 @llmax(i64 0, i64 %13)
  %15 = add nsw i64 %9, %14
  %16 = srem i64 %15, 2
  ret i64 %16
}
...
define i32 @main() #0 {
  ...
  %3 = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.3, i32 0, i32 0), i64* %1, i64* %2)
  br label %4
...
6:                                                ; preds = %4
  ...
  %8 = sub nsw i64 %7, 1
  %9 = call i64 @pibit(i64 %8, i64 %.01)
  %10 = load i64, i64* %2, align 8
  %11 = call i64 @pibit(i64 %10, i64 %.01)
  %12 = xor i64 %9, %11
  %13 = sub nsw i64 %.01, 1
  %14 = shl i64 1, %13
...
19:                                               ; preds = %4
  %20 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.4, i32 0, i32 0), i64 %.0)
  ret i32 0
}
