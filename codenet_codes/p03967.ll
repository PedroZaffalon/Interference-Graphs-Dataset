; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03967/s697399253.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03967/s697399253.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s697399253.cpp, i8* null }]
...
10:                                               ; preds = %0
  ...
  invoke void @_ZNSt6vectorIxSaIxEEC2EmRKxRKS0_(%"class.std::vector"* %2, i64 %11, i64* dereferenceable(8) %3, %"class.std::allocator.0"* dereferenceable(1) %4)
...
12:                                               ; preds = %10
  ...
  invoke void @_ZNSt6vectorIxSaIxEEC2EmRKxRKS0_(%"class.std::vector"* %5, i64 %11, i64* dereferenceable(8) %6, %"class.std::allocator.0"* dereferenceable(1) %7)
...
101:                                              ; preds = %90
  ...
  %108 = invoke dereferenceable(8) i64* @_ZSt3minIxERKT_S2_S2_(i64* dereferenceable(8) %8, i64* dereferenceable(8) %107)
          to label %109 unwind label %51

109:                                              ; preds = %101
  %110 = load i64, i64* %108, align 8
  %111 = sub nsw i64 %11, 1
...
132:                                              ; preds = %131, %43, %39
  %.12 = phi i32 [ %.01, %131 ], [ %46, %43 ], [ %42, %39 ]
  %.1 = phi i8* [ %.0, %131 ], [ %45, %43 ], [ %41, %39 ]
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED1Ev(%"class.std::__cxx11::basic_string"* %1) #3
  br label %133

133:                                              ; preds = %132
  %134 = insertvalue { i8*, i32 } undef, i8* %.1, 0
  %135 = insertvalue { i8*, i32 } %134, i32 %.12, 1
  resume { i8*, i32 } %135
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s697399253.cpp() #0 section ".text.startup" {
