; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00137/s140799593.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00137/s140799593.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s140799593.cpp, i8* null }]
...
16:                                               ; preds = %14
  ...
  %18 = call i32 @_Z8makerandi(i32 %17)
...
define i32 @_Z8makerandi(i32 %0) #5 {
  %2 = mul nsw i32 %0, %0
  br label %3

3:                                                ; preds = %12, %1
  %.03 = phi i32 [ 100, %1 ], [ %10, %12 ]
  %.02 = phi i32 [ 0, %1 ], [ %9, %12 ]
  %.01 = phi i32 [ 1, %1 ], [ %11, %12 ]
  %.0 = phi i32 [ 0, %1 ], [ %13, %12 ]
  %4 = icmp slt i32 %.0, 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s140799593.cpp() #0 section ".text.startup" {
