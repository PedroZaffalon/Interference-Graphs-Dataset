; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02451/s069426184.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02451/s069426184.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s069426184.cpp, i8* null }]
...
24:                                               ; preds = %20
  ...
  %29 = call i32* @_ZSt11lower_boundIPiiET_S1_S1_RKT0_(i32* %8, i32* %28, i32* dereferenceable(4) %3)
  %30 = ptrtoint i32* %29 to i64
  %31 = ptrtoint i32* %8 to i64
  %32 = sub i64 %30, %31
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr zeroext i1 @_ZNK9__gnu_cxx5__ops14_Iter_less_valclIPiKiEEbT_RT0_(%"struct.__gnu_cxx::__ops::_Iter_less_val"* %0, i32* %1, i32* dereferenceable(4) %2) #6 comdat align 2 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s069426184.cpp() #0 section ".text.startup" {
