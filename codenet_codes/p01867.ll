; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01867/s142272632.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01867/s142272632.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s142272632.cpp, i8* null }]
...
10:                                               ; preds = %8
  ...
  invoke void @_ZNSt6vectorIiSaIiEEC2EmRKS0_(%"class.std::vector"* %3, i64 26, %"class.std::allocator.0"* dereferenceable(1) %4)
...
42:                                               ; preds = %52, %41
  %.04 = phi i32 [ 0, %41 ], [ %53, %52 ]
  %43 = icmp slt i32 %.04, 26
...
58:                                               ; preds = %42
  %59 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %5, i64 1) #3
  %60 = load i32, i32* %59, align 4
  %61 = mul nsw i32 2, %60
  br label %62

62:                                               ; preds = %86, %58
  %.07 = phi i32 [ 2, %58 ], [ %87, %86 ]
  %.05 = phi i32 [ %61, %58 ], [ %.2, %86 ]
  %63 = icmp sle i32 %.07, 9
...
76:                                               ; preds = %71
  ...
  %81 = add nsw i32 5, %80
  %82 = sub nsw i32 %81, 1
  %83 = add nsw i32 %.05, %82
  br label %84

84:                                               ; preds = %76, %71
  %.16 = phi i32 [ %83, %76 ], [ %.05, %71 ]
  br label %85

85:                                               ; preds = %84, %69
  %.2 = phi i32 [ %70, %69 ], [ %.16, %84 ]
  br label %86
...
98:                                               ; preds = %94, %54, %36
  %.01 = phi i32 [ %39, %36 ], [ %97, %94 ], [ %57, %54 ]
  %.0 = phi i8* [ %38, %36 ], [ %96, %94 ], [ %56, %54 ]
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %3) #3
  br label %99

99:                                               ; preds = %98, %32, %28
  %.12 = phi i32 [ %.01, %98 ], [ %35, %32 ], [ %31, %28 ]
  %.1 = phi i8* [ %.0, %98 ], [ %34, %32 ], [ %30, %28 ]
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED1Ev(%"class.std::__cxx11::basic_string"* %2) #3
  br label %100

100:                                              ; preds = %99
  %101 = insertvalue { i8*, i32 } undef, i8* %.1, 0
  %102 = insertvalue { i8*, i32 } %101, i32 %.12, 1
  resume { i8*, i32 } %102
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s142272632.cpp() #0 section ".text.startup" {
