; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02042/s000413905.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02042/s000413905.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s000413905.cpp, i8* null }]
...
18:                                               ; preds = %0
  ...
  %19 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector"* %3) #3
  %20 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %5, i32 0, i32 0
  store i32* %19, i32** %20, align 8
  %21 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector"* %3) #3
...
39:                                               ; preds = %23
  invoke void @_ZNSt14priority_queueIiSt6vectorIiSaIiEESt4lessIiEEC2IS2_vEEv(%"class.std::priority_queue"* %7)
          to label %40 unwind label %35

40:                                               ; preds = %39
  invoke void @_ZNSt14priority_queueIiSt6vectorIiSaIiEESt4lessIiEEC2IS2_vEEv(%"class.std::priority_queue"* %8)
...
53:                                               ; preds = %46
  ...
  invoke void @_ZNSt14priority_queueIiSt6vectorIiSaIiEESt4lessIiEE4pushEOi(%"class.std::priority_queue"* %7, i32* dereferenceable(4) %10)
...
56:                                               ; preds = %53
  ...
  invoke void @_ZNSt14priority_queueIiSt6vectorIiSaIiEESt4lessIiEE4pushERKi(%"class.std::priority_queue"* %8, i32* dereferenceable(4) %59)
...
65:                                               ; preds = %133, %131, %127, %121, %117, %115, %104, %102, %100, %98, %96, %94, %87, %85, %75, %69, %56, %53
  %66 = landingpad { i8*, i32 }
          cleanup
  %67 = extractvalue { i8*, i32 } %66, 0
  %68 = extractvalue { i8*, i32 } %66, 1
  call void @_ZNSt14priority_queueIiSt6vectorIiSaIiEESt4lessIiEED2Ev(%"class.std::priority_queue"* %8) #3
  br label %136
...
69:                                               ; preds = %46
  ...
  invoke void @_ZNSt14priority_queueIiSt6vectorIiSaIiEESt4lessIiEE4pushEOi(%"class.std::priority_queue"* %7, i32* dereferenceable(4) %11)
          to label %75 unwind label %65

75:                                               ; preds = %69
  invoke void @_ZNSt14priority_queueIiSt6vectorIiSaIiEESt4lessIiEE4pushERKi(%"class.std::priority_queue"* %8, i32* dereferenceable(4) %9)
...
82:                                               ; preds = %109, %81
  %.06 = phi i32 [ 0, %81 ], [ %110, %109 ]
  %83 = load i32, i32* %2, align 4
  %84 = icmp slt i32 %.06, %83
  br i1 %84, label %85, label %111

85:                                               ; preds = %82
  %86 = invoke dereferenceable(4) i32* @_ZNKSt14priority_queueIiSt6vectorIiSaIiEESt4lessIiEE3topEv(%"class.std::priority_queue"* %8)
          to label %87 unwind label %65

87:                                               ; preds = %85
  %88 = load i32, i32* %86, align 4
  %89 = invoke dereferenceable(4) i32* @_ZNKSt14priority_queueIiSt6vectorIiSaIiEESt4lessIiEE3topEv(%"class.std::priority_queue"* %7)
...
94:                                               ; preds = %90
  %95 = invoke dereferenceable(4) i32* @_ZNKSt14priority_queueIiSt6vectorIiSaIiEESt4lessIiEE3topEv(%"class.std::priority_queue"* %8)
          to label %96 unwind label %65

96:                                               ; preds = %94
  %97 = load i32, i32* %95, align 4
  invoke void @_ZNSt14priority_queueIiSt6vectorIiSaIiEESt4lessIiEE3popEv(%"class.std::priority_queue"* %8)
          to label %98 unwind label %65

98:                                               ; preds = %96
  %99 = invoke dereferenceable(4) i32* @_ZNKSt14priority_queueIiSt6vectorIiSaIiEESt4lessIiEE3topEv(%"class.std::priority_queue"* %7)
          to label %100 unwind label %65

100:                                              ; preds = %98
  %101 = load i32, i32* %99, align 4
  invoke void @_ZNSt14priority_queueIiSt6vectorIiSaIiEESt4lessIiEE3popEv(%"class.std::priority_queue"* %7)
          to label %102 unwind label %65

102:                                              ; preds = %100
  %103 = sub nsw i32 0, %101
  store i32 %103, i32* %12, align 4
  invoke void @_ZNSt14priority_queueIiSt6vectorIiSaIiEESt4lessIiEE4pushEOi(%"class.std::priority_queue"* %8, i32* dereferenceable(4) %12)
          to label %104 unwind label %65

104:                                              ; preds = %102
  %105 = sub nsw i32 0, %97
  store i32 %105, i32* %13, align 4
  invoke void @_ZNSt14priority_queueIiSt6vectorIiSaIiEESt4lessIiEE4pushEOi(%"class.std::priority_queue"* %7, i32* dereferenceable(4) %13)
...
112:                                              ; preds = %129, %111
  %.05 = phi i64 [ 0, %111 ], [ %126, %129 ]
  %.0 = phi i32 [ 0, %111 ], [ %130, %129 ]
  %113 = load i32, i32* %1, align 4
  %114 = icmp slt i32 %.0, %113
  br i1 %114, label %115, label %131

115:                                              ; preds = %112
  %116 = invoke dereferenceable(4) i32* @_ZNKSt14priority_queueIiSt6vectorIiSaIiEESt4lessIiEE3topEv(%"class.std::priority_queue"* %8)
          to label %117 unwind label %65

117:                                              ; preds = %115
  %118 = load i32, i32* %116, align 4
  %119 = sub nsw i32 0, %118
  %120 = invoke dereferenceable(4) i32* @_ZNKSt14priority_queueIiSt6vectorIiSaIiEESt4lessIiEE3topEv(%"class.std::priority_queue"* %7)
...
131:                                              ; preds = %112
  %132 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEx(%"class.std::basic_ostream"* @_ZSt4cout, i64 %.05)
...
135:                                              ; preds = %133
  call void @_ZNSt14priority_queueIiSt6vectorIiSaIiEESt4lessIiEED2Ev(%"class.std::priority_queue"* %8) #3
  call void @_ZNSt14priority_queueIiSt6vectorIiSaIiEESt4lessIiEED2Ev(%"class.std::priority_queue"* %7) #3
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %3) #3
  ret i32 0

136:                                              ; preds = %65, %61
  %.02 = phi i32 [ %68, %65 ], [ %64, %61 ]
  %.01 = phi i8* [ %67, %65 ], [ %63, %61 ]
  call void @_ZNSt14priority_queueIiSt6vectorIiSaIiEESt4lessIiEED2Ev(%"class.std::priority_queue"* %7) #3
  br label %137

137:                                              ; preds = %136, %35
  %.13 = phi i32 [ %38, %35 ], [ %.02, %136 ]
  %.1 = phi i8* [ %37, %35 ], [ %.01, %136 ]
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %3) #3
  br label %138

138:                                              ; preds = %137, %31
  %.24 = phi i32 [ %.13, %137 ], [ %34, %31 ]
  %.2 = phi i8* [ %.1, %137 ], [ %33, %31 ]
  %139 = insertvalue { i8*, i32 } undef, i8* %.2, 0
  %140 = insertvalue { i8*, i32 } %139, i32 %.24, 1
  resume { i8*, i32 } %140
}
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt14priority_queueIiSt6vectorIiSaIiEESt4lessIiEE4pushEOi(%"class.std::priority_queue"* %0, i32* dereferenceable(4) %1) #0 comdat align 2 {
  ...
  call void @_ZNSt6vectorIiSaIiEE9push_backEOi(%"class.std::vector"* %5, i32* dereferenceable(4) %6)
  ...
  call void @_ZSt9push_heapIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEESt4lessIiEEvT_S9_T0_(i32* %15, i32* %17)
  ret void
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s000413905.cpp() #0 section ".text.startup" {
