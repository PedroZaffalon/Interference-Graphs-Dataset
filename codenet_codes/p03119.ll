; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03119/s052160325.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03119/s052160325.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s052160325.cpp, i8* null }]
...
1:                                                ; preds = %1, %0
  ...
  %4 = icmp eq %"class.std::vector"* %3, getelementptr inbounds ([1000020 x %"class.std::vector"], [1000020 x %"class.std::vector"]* @g, i64 1, i64 0)
...
2:                                                ; preds = %2, %1
  %3 = phi %"class.std::vector"* [ getelementptr inbounds ([1000020 x %"class.std::vector"], [1000020 x %"class.std::vector"]* @g, i64 1, i64 0), %1 ], [ %4, %2 ]
  %4 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %3, i64 -1
  call void @_ZNSt6vectorIxSaIxEED2Ev(%"class.std::vector"* %4) #3
  %5 = icmp eq %"class.std::vector"* %4, getelementptr inbounds ([1000020 x %"class.std::vector"], [1000020 x %"class.std::vector"]* @g, i32 0, i32 0)
...
2:                                                ; preds = %0
  ...
  %3 = call i32 @__cxa_atexit(void (i8*)* bitcast (void (%"class.std::vector"*)* @_ZNSt6vectorIxSaIxEED2Ev to void (i8*)*), i8* bitcast (%"class.std::vector"* @vis to i8*), i8* @__dso_handle) #3
  ret void
...
28:                                               ; preds = %37, %22
  %.03 = phi i64 [ 0, %22 ], [ %38, %37 ]
  %29 = load i64, i64* %1, align 8
  %30 = icmp slt i64 %.03, %29
  br i1 %30, label %31, label %39

31:                                               ; preds = %28
  %32 = getelementptr inbounds i64, i64* %27, i64 %.03
  %33 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERx(%"class.std::basic_istream"* @_ZSt3cin, i64* dereferenceable(8) %32)
  %34 = getelementptr inbounds i64, i64* %27, i64 %.03
  %35 = call dereferenceable(8) i64* @_ZSt3minIxERKT_S2_S2_(i64* dereferenceable(8) %3, i64* dereferenceable(8) %34)
...
46:                                               ; preds = %59, %45
  %.05 = phi i64 [ 0, %45 ], [ %60, %59 ]
  %47 = load i64, i64* %3, align 8
  %48 = icmp slt i64 %.05, %47
...
50:                                               ; preds = %56, %49
  %.02 = phi i64 [ 1, %49 ], [ %57, %56 ]
  %51 = load i64, i64* %1, align 8
  %52 = icmp sle i64 %.02, %51
  br i1 %52, label %53, label %58

53:                                               ; preds = %50
  %54 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEx(%"class.std::basic_ostream"* @_ZSt4cout, i64 %.02)
...
63:                                               ; preds = %61, %43
  %.04 = phi i32 [ 1, %43 ], [ 0, %61 ]
  %.1 = phi i32 [ 0, %43 ], [ %.0, %61 ]
  call void @llvm.stackrestore(i8* %26)
  switch i32 %.04, label %66 [
    i32 0, label %64
    i32 1, label %65
  ]
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s052160325.cpp() #0 section ".text.startup" {
