; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00962/s785553305.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00962/s785553305.cpp"
...
%"struct.std::_Vector_base.4" = type { %"struct.std::_Vector_base<Data, std::allocator<Data> >::_Vector_impl" }
...
%"class.__gnu_cxx::__normal_iterator.11" = type { %struct.Info* }
%"class.std::move_iterator.12" = type { %struct.Info* }
...
@order = global [100000 x i32] zeroinitializer, align 16
@lowlink = global [100000 x i32] zeroinitializer, align 16
@min_cost = global [100000 x i64] zeroinitializer, align 16
@rev_min_cost = global [100000 x i64] zeroinitializer, align 16
@visited = global [100000 x i8] zeroinitializer, align 16
@in_MIN_PATH = global [100000 x i8] zeroinitializer, align 16
@edge = global [100000 x %struct.Edge] zeroinitializer, align 16
@G = global [100000 x %"class.std::vector"] zeroinitializer, align 16
@rev_G = global [100000 x %"class.std::vector"] zeroinitializer, align 16
@MIN_G = global [100000 x %"class.std::vector"] zeroinitializer, align 16
@.str = private unnamed_addr constant [6 x i8] c"%d %d\00", align 1
@.str.7 = private unnamed_addr constant [11 x i8] c"%d %d %lld\00", align 1
@.str.8 = private unnamed_addr constant [7 x i8] c"HAPPY\0A\00", align 1
@.str.9 = private unnamed_addr constant [6 x i8] c"SOSO\0A\00", align 1
@.str.10 = private unnamed_addr constant [5 x i8] c"SAD\0A\00", align 1
@.str.11 = private unnamed_addr constant [26 x i8] c"vector::_M_realloc_insert\00", align 1
@_ZStL19piecewise_construct = internal constant %"struct.std::piecewise_construct_t" undef, align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s785553305.cpp, i8* null }]
...
define internal void @__cxx_global_var_init.1() #0 section ".text.startup" {
  call void @_ZNSt3mapIxiSt4lessIxESaISt4pairIKxiEEEC2Ev(%"class.std::map"* @MAP) #3
  %1 = call i32 @__cxa_atexit(void (i8*)* bitcast (void (%"class.std::map"*)* @_ZNSt3mapIxiSt4lessIxESaISt4pairIKxiEEED2Ev to void (i8*)*), i8* getelementptr inbounds (%"class.std::map", %"class.std::map"* @MAP, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0), i8* @__dso_handle) #3
  ret void
}
...
define linkonce_odr void @_ZNSt6vectorI4InfoSaIS0_EED2Ev(%"class.std::vector"* %0) unnamed_addr #4 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %11 = call dereferenceable(1) %"class.std::allocator.0"* @_ZNSt12_Vector_baseI4InfoSaIS0_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %10) #3
  invoke void @_ZSt8_DestroyIP4InfoS0_EvT_S2_RSaIT0_E(%struct.Info* %5, %struct.Info* %9, %"class.std::allocator.0"* dereferenceable(1) %11)
...
1:                                                ; preds = %1, %0
  %2 = phi %"class.std::vector"* [ getelementptr inbounds ([100000 x %"class.std::vector"], [100000 x %"class.std::vector"]* @rev_G, i32 0, i32 0), %0 ], [ %3, %1 ]
  call void @_ZNSt6vectorI4InfoSaIS0_EEC2Ev(%"class.std::vector"* %2) #3
  %3 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %2, i64 1
  %4 = icmp eq %"class.std::vector"* %3, getelementptr inbounds ([100000 x %"class.std::vector"], [100000 x %"class.std::vector"]* @rev_G, i64 1, i64 0)
  br i1 %4, label %5, label %1
...
2:                                                ; preds = %2, %1
  %3 = phi %"class.std::vector"* [ getelementptr inbounds ([100000 x %"class.std::vector"], [100000 x %"class.std::vector"]* @rev_G, i64 1, i64 0), %1 ], [ %4, %2 ]
  %4 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %3, i64 -1
  call void @_ZNSt6vectorI4InfoSaIS0_EED2Ev(%"class.std::vector"* %4) #3
  %5 = icmp eq %"class.std::vector"* %4, getelementptr inbounds ([100000 x %"class.std::vector"], [100000 x %"class.std::vector"]* @rev_G, i32 0, i32 0)
  br i1 %5, label %6, label %2
...
1:                                                ; preds = %1, %0
  %2 = phi %"class.std::vector"* [ getelementptr inbounds ([100000 x %"class.std::vector"], [100000 x %"class.std::vector"]* @MIN_G, i32 0, i32 0), %0 ], [ %3, %1 ]
  call void @_ZNSt6vectorI4InfoSaIS0_EEC2Ev(%"class.std::vector"* %2) #3
  %3 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %2, i64 1
  %4 = icmp eq %"class.std::vector"* %3, getelementptr inbounds ([100000 x %"class.std::vector"], [100000 x %"class.std::vector"]* @MIN_G, i64 1, i64 0)
  br i1 %4, label %5, label %1
...
2:                                                ; preds = %2, %1
  %3 = phi %"class.std::vector"* [ getelementptr inbounds ([100000 x %"class.std::vector"], [100000 x %"class.std::vector"]* @MIN_G, i64 1, i64 0), %1 ], [ %4, %2 ]
  %4 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %3, i64 -1
  call void @_ZNSt6vectorI4InfoSaIS0_EED2Ev(%"class.std::vector"* %4) #3
  %5 = icmp eq %"class.std::vector"* %4, getelementptr inbounds ([100000 x %"class.std::vector"], [100000 x %"class.std::vector"]* @MIN_G, i32 0, i32 0)
  br i1 %5, label %6, label %2
...
define void @_Z9recursivei(i32 %0) #0 {
  ...
  %4 = sext i32 %0 to i64
  %5 = getelementptr inbounds [100000 x i32], [100000 x i32]* @order, i64 0, i64 %4
  store i32 %2, i32* %5, align 4
  %6 = sext i32 %0 to i64
  %7 = getelementptr inbounds [100000 x i32], [100000 x i32]* @order, i64 0, i64 %6
  %8 = load i32, i32* %7, align 4
  %9 = sext i32 %0 to i64
  %10 = getelementptr inbounds [100000 x i32], [100000 x i32]* @lowlink, i64 0, i64 %9
...
11:                                               ; preds = %69, %1
  ...
  %14 = getelementptr inbounds [100000 x %"class.std::vector"], [100000 x %"class.std::vector"]* @MIN_G, i64 0, i64 %13
  %15 = call i64 @_ZNKSt6vectorI4InfoSaIS0_EE4sizeEv(%"class.std::vector"* %14) #3
  %16 = icmp ult i64 %12, %15
  br i1 %16, label %17, label %71

17:                                               ; preds = %11
  %18 = sext i32 %0 to i64
  %19 = getelementptr inbounds [100000 x %"class.std::vector"], [100000 x %"class.std::vector"]* @MIN_G, i64 0, i64 %18
  %20 = sext i32 %.0 to i64
  %21 = call dereferenceable(16) %struct.Info* @_ZNSt6vectorI4InfoSaIS0_EEixEm(%"class.std::vector"* %19, i64 %20) #3
  %22 = getelementptr inbounds %struct.Info, %struct.Info* %21, i32 0, i32 0
  %23 = load i32, i32* %22, align 8
  %24 = sext i32 %23 to i64
  %25 = getelementptr inbounds [100000 x i32], [100000 x i32]* @order, i64 0, i64 %24
...
28:                                               ; preds = %17
  ...
  %30 = getelementptr inbounds [100000 x %"class.std::vector"], [100000 x %"class.std::vector"]* @MIN_G, i64 0, i64 %29
  %31 = sext i32 %.0 to i64
  %32 = call dereferenceable(16) %struct.Info* @_ZNSt6vectorI4InfoSaIS0_EEixEm(%"class.std::vector"* %30, i64 %31) #3
  %33 = getelementptr inbounds %struct.Info, %struct.Info* %32, i32 0, i32 1
  %34 = load i32, i32* %33, align 4
  %35 = sext i32 %34 to i64
  %36 = getelementptr inbounds [100000 x i8], [100000 x i8]* @visited, i64 0, i64 %35
  store i8 1, i8* %36, align 1
  call void @_Z9recursivei(i32 %23)
  %37 = sext i32 %0 to i64
  %38 = getelementptr inbounds [100000 x i32], [100000 x i32]* @lowlink, i64 0, i64 %37
  %39 = sext i32 %23 to i64
  %40 = getelementptr inbounds [100000 x i32], [100000 x i32]* @lowlink, i64 0, i64 %39
  %41 = call dereferenceable(4) i32* @_ZSt3minIiERKT_S2_S2_(i32* dereferenceable(4) %38, i32* dereferenceable(4) %40)
  %42 = load i32, i32* %41, align 4
  %43 = sext i32 %0 to i64
  %44 = getelementptr inbounds [100000 x i32], [100000 x i32]* @lowlink, i64 0, i64 %43
  store i32 %42, i32* %44, align 4
  br label %68

45:                                               ; preds = %17
  %46 = sext i32 %0 to i64
  %47 = getelementptr inbounds [100000 x %"class.std::vector"], [100000 x %"class.std::vector"]* @MIN_G, i64 0, i64 %46
  %48 = sext i32 %.0 to i64
  %49 = call dereferenceable(16) %struct.Info* @_ZNSt6vectorI4InfoSaIS0_EEixEm(%"class.std::vector"* %47, i64 %48) #3
  %50 = getelementptr inbounds %struct.Info, %struct.Info* %49, i32 0, i32 1
  %51 = load i32, i32* %50, align 4
  %52 = sext i32 %51 to i64
  %53 = getelementptr inbounds [100000 x i8], [100000 x i8]* @visited, i64 0, i64 %52
...
58:                                               ; preds = %45
  ...
  %60 = getelementptr inbounds [100000 x i32], [100000 x i32]* @lowlink, i64 0, i64 %59
  %61 = sext i32 %23 to i64
  %62 = getelementptr inbounds [100000 x i32], [100000 x i32]* @order, i64 0, i64 %61
  %63 = call dereferenceable(4) i32* @_ZSt3minIiERKT_S2_S2_(i32* dereferenceable(4) %60, i32* dereferenceable(4) %62)
  %64 = load i32, i32* %63, align 4
  %65 = sext i32 %0 to i64
  %66 = getelementptr inbounds [100000 x i32], [100000 x i32]* @lowlink, i64 0, i64 %65
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(16) %struct.Info* @_ZNSt6vectorI4InfoSaIS0_EEixEm(%"class.std::vector"* %0, i64 %1) #4 comdat align 2 {
...
; Function Attrs: noinline uwtable
define void @_Z15dijkstra_NORMALv() #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
...
7:                                                ; preds = %4
  ...
  %9 = getelementptr inbounds [100000 x i64], [100000 x i64]* @min_cost, i64 0, i64 %8
  store i64 999999999999, i64* %9, align 8
  br label %10
...
12:                                               ; preds = %4
  %13 = sext i32 0 to i64
  %14 = getelementptr inbounds [100000 x i64], [100000 x i64]* @min_cost, i64 0, i64 %13
  store i64 0, i64* %14, align 8
  call void @_ZNSt14priority_queueI4DataSt6vectorIS0_SaIS0_EESt4lessIS0_EEC2IS3_vEEv(%"class.std::priority_queue"* %1)
  invoke void @_ZN4DataC2Eix(%struct.Data* %2, i32 0, i64 0)
...
17:                                               ; preds = %118, %16
  %18 = invoke zeroext i1 @_ZNKSt14priority_queueI4DataSt6vectorIS0_SaIS0_EESt4lessIS0_EE5emptyEv(%"class.std::priority_queue"* %1)
...
21:                                               ; preds = %19
  %22 = invoke dereferenceable(16) %struct.Data* @_ZNKSt14priority_queueI4DataSt6vectorIS0_SaIS0_EESt4lessIS0_EE3topEv(%"class.std::priority_queue"* %1)
          to label %23 unwind label %29

23:                                               ; preds = %21
  %24 = getelementptr inbounds %struct.Data, %struct.Data* %22, i32 0, i32 0
...
29:                                               ; preds = %115, %110, %95, %91, %89, %74, %61, %59, %49, %46, %35, %33, %27, %21, %17, %15, %12
...
33:                                               ; preds = %23
  %34 = invoke dereferenceable(16) %struct.Data* @_ZNKSt14priority_queueI4DataSt6vectorIS0_SaIS0_EESt4lessIS0_EE3topEv(%"class.std::priority_queue"* %1)
          to label %35 unwind label %29

35:                                               ; preds = %33
  %36 = getelementptr inbounds %struct.Data, %struct.Data* %34, i32 0, i32 1
  %37 = load i64, i64* %36, align 8
  %38 = invoke dereferenceable(16) %struct.Data* @_ZNKSt14priority_queueI4DataSt6vectorIS0_SaIS0_EESt4lessIS0_EE3topEv(%"class.std::priority_queue"* %1)
          to label %39 unwind label %29

39:                                               ; preds = %35
  %40 = getelementptr inbounds %struct.Data, %struct.Data* %38, i32 0, i32 0
  %41 = load i32, i32* %40, align 8
  %42 = sext i32 %41 to i64
  %43 = getelementptr inbounds [100000 x i64], [100000 x i64]* @min_cost, i64 0, i64 %42
...
49:                                               ; preds = %113, %48
  %.0 = phi i32 [ 0, %48 ], [ %114, %113 ]
  %50 = sext i32 %.0 to i64
  %51 = invoke dereferenceable(16) %struct.Data* @_ZNKSt14priority_queueI4DataSt6vectorIS0_SaIS0_EESt4lessIS0_EE3topEv(%"class.std::priority_queue"* %1)
          to label %52 unwind label %29

52:                                               ; preds = %49
  %53 = getelementptr inbounds %struct.Data, %struct.Data* %51, i32 0, i32 0
  %54 = load i32, i32* %53, align 8
  %55 = sext i32 %54 to i64
  %56 = getelementptr inbounds [100000 x %"class.std::vector"], [100000 x %"class.std::vector"]* @G, i64 0, i64 %55
  %57 = call i64 @_ZNKSt6vectorI4InfoSaIS0_EE4sizeEv(%"class.std::vector"* %56) #3
  %58 = icmp ult i64 %50, %57
  br i1 %58, label %59, label %115

59:                                               ; preds = %52
  %60 = invoke dereferenceable(16) %struct.Data* @_ZNKSt14priority_queueI4DataSt6vectorIS0_SaIS0_EESt4lessIS0_EE3topEv(%"class.std::priority_queue"* %1)
          to label %61 unwind label %29

61:                                               ; preds = %59
  %62 = getelementptr inbounds %struct.Data, %struct.Data* %60, i32 0, i32 0
  %63 = load i32, i32* %62, align 8
  %64 = sext i32 %63 to i64
  %65 = getelementptr inbounds [100000 x %"class.std::vector"], [100000 x %"class.std::vector"]* @G, i64 0, i64 %64
  %66 = sext i32 %.0 to i64
  %67 = call dereferenceable(16) %struct.Info* @_ZNSt6vectorI4InfoSaIS0_EEixEm(%"class.std::vector"* %65, i64 %66) #3
  %68 = getelementptr inbounds %struct.Info, %struct.Info* %67, i32 0, i32 0
  %69 = load i32, i32* %68, align 8
  %70 = sext i32 %69 to i64
  %71 = getelementptr inbounds [100000 x i64], [100000 x i64]* @min_cost, i64 0, i64 %70
  %72 = load i64, i64* %71, align 8
  %73 = invoke dereferenceable(16) %struct.Data* @_ZNKSt14priority_queueI4DataSt6vectorIS0_SaIS0_EESt4lessIS0_EE3topEv(%"class.std::priority_queue"* %1)
          to label %74 unwind label %29

74:                                               ; preds = %61
  %75 = getelementptr inbounds %struct.Data, %struct.Data* %73, i32 0, i32 1
  %76 = load i64, i64* %75, align 8
  %77 = invoke dereferenceable(16) %struct.Data* @_ZNKSt14priority_queueI4DataSt6vectorIS0_SaIS0_EESt4lessIS0_EE3topEv(%"class.std::priority_queue"* %1)
          to label %78 unwind label %29

78:                                               ; preds = %74
  %79 = getelementptr inbounds %struct.Data, %struct.Data* %77, i32 0, i32 0
  %80 = load i32, i32* %79, align 8
  %81 = sext i32 %80 to i64
  %82 = getelementptr inbounds [100000 x %"class.std::vector"], [100000 x %"class.std::vector"]* @G, i64 0, i64 %81
  %83 = sext i32 %.0 to i64
  %84 = call dereferenceable(16) %struct.Info* @_ZNSt6vectorI4InfoSaIS0_EEixEm(%"class.std::vector"* %82, i64 %83) #3
...
89:                                               ; preds = %78
  %90 = invoke dereferenceable(16) %struct.Data* @_ZNKSt14priority_queueI4DataSt6vectorIS0_SaIS0_EESt4lessIS0_EE3topEv(%"class.std::priority_queue"* %1)
          to label %91 unwind label %29

91:                                               ; preds = %89
  %92 = getelementptr inbounds %struct.Data, %struct.Data* %90, i32 0, i32 1
  %93 = load i64, i64* %92, align 8
  %94 = invoke dereferenceable(16) %struct.Data* @_ZNKSt14priority_queueI4DataSt6vectorIS0_SaIS0_EESt4lessIS0_EE3topEv(%"class.std::priority_queue"* %1)
          to label %95 unwind label %29

95:                                               ; preds = %91
  %96 = getelementptr inbounds %struct.Data, %struct.Data* %94, i32 0, i32 0
  %97 = load i32, i32* %96, align 8
  %98 = sext i32 %97 to i64
  %99 = getelementptr inbounds [100000 x %"class.std::vector"], [100000 x %"class.std::vector"]* @G, i64 0, i64 %98
  %100 = sext i32 %.0 to i64
  %101 = call dereferenceable(16) %struct.Info* @_ZNSt6vectorI4InfoSaIS0_EEixEm(%"class.std::vector"* %99, i64 %100) #3
  %102 = getelementptr inbounds %struct.Info, %struct.Info* %101, i32 0, i32 2
  %103 = load i64, i64* %102, align 8
  %104 = add nsw i64 %93, %103
  %105 = sext i32 %69 to i64
  %106 = getelementptr inbounds [100000 x i64], [100000 x i64]* @min_cost, i64 0, i64 %105
  store i64 %104, i64* %106, align 8
  %107 = sext i32 %69 to i64
  %108 = getelementptr inbounds [100000 x i64], [100000 x i64]* @min_cost, i64 0, i64 %107
  %109 = load i64, i64* %108, align 8
  invoke void @_ZN4DataC2Eix(%struct.Data* %3, i32 %69, i64 %109)
          to label %110 unwind label %29

110:                                              ; preds = %95
  invoke void @_ZNSt14priority_queueI4DataSt6vectorIS0_SaIS0_EESt4lessIS0_EE4pushEOS0_(%"class.std::priority_queue"* %1, %struct.Data* dereferenceable(16) %3)
...
120:                                              ; preds = %29
  %121 = insertvalue { i8*, i32 } undef, i8* %31, 0
  %122 = insertvalue { i8*, i32 } %121, i32 %32, 1
  resume { i8*, i32 } %122
}
...
define linkonce_odr void @_ZNSt14priority_queueI4DataSt6vectorIS0_SaIS0_EESt4lessIS0_EEC2IS3_vEEv(%"class.std::priority_queue"* %0) unnamed_addr #4 comdat align 2 {
  ...
  call void @_ZNSt6vectorI4DataSaIS0_EEC2Ev(%"class.std::vector.3"* %2) #3
...
define linkonce_odr void @_ZNSt14priority_queueI4DataSt6vectorIS0_SaIS0_EESt4lessIS0_EE4pushEOS0_(%"class.std::priority_queue"* %0, %struct.Data* dereferenceable(16) %1) #0 comdat align 2 {
  ...
  call void @_ZNSt6vectorI4DataSaIS0_EE9push_backEOS0_(%"class.std::vector.3"* %5, %struct.Data* dereferenceable(16) %6)
  %7 = getelementptr inbounds %"class.std::priority_queue", %"class.std::priority_queue"* %0, i32 0, i32 0
  %8 = call %struct.Data* @_ZNSt6vectorI4DataSaIS0_EE5beginEv(%"class.std::vector.3"* %7) #3
  ...
  %11 = call %struct.Data* @_ZNSt6vectorI4DataSaIS0_EE3endEv(%"class.std::vector.3"* %10) #3
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN4DataC2Eix(%struct.Data* %0, i32 %1, i64 %2) unnamed_addr #4 comdat align 2 {
...
define linkonce_odr zeroext i1 @_ZNKSt14priority_queueI4DataSt6vectorIS0_SaIS0_EESt4lessIS0_EE5emptyEv(%"class.std::priority_queue"* %0) #4 comdat align 2 {
  %2 = getelementptr inbounds %"class.std::priority_queue", %"class.std::priority_queue"* %0, i32 0, i32 0
  %3 = call zeroext i1 @_ZNKSt6vectorI4DataSaIS0_EE5emptyEv(%"class.std::vector.3"* %2) #3
  ret i1 %3
}
...
define linkonce_odr dereferenceable(16) %struct.Data* @_ZNKSt14priority_queueI4DataSt6vectorIS0_SaIS0_EESt4lessIS0_EE3topEv(%"class.std::priority_queue"* %0) #4 comdat align 2 {
  %2 = getelementptr inbounds %"class.std::priority_queue", %"class.std::priority_queue"* %0, i32 0, i32 0
  %3 = call dereferenceable(16) %struct.Data* @_ZNKSt6vectorI4DataSaIS0_EE5frontEv(%"class.std::vector.3"* %2) #3
  ret %struct.Data* %3
}
...
define linkonce_odr void @_ZNSt14priority_queueI4DataSt6vectorIS0_SaIS0_EESt4lessIS0_EE3popEv(%"class.std::priority_queue"* %0) #0 comdat align 2 {
  ...
  %5 = call %struct.Data* @_ZNSt6vectorI4DataSaIS0_EE5beginEv(%"class.std::vector.3"* %4) #3
  %6 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %2, i32 0, i32 0
  store %struct.Data* %5, %struct.Data** %6, align 8
  %7 = getelementptr inbounds %"class.std::priority_queue", %"class.std::priority_queue"* %0, i32 0, i32 0
  %8 = call %struct.Data* @_ZNSt6vectorI4DataSaIS0_EE3endEv(%"class.std::vector.3"* %7) #3
  %9 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %3, i32 0, i32 0
  store %struct.Data* %8, %struct.Data** %9, align 8
  ...
  call void @_ZNSt6vectorI4DataSaIS0_EE8pop_backEv(%"class.std::vector.3"* %15) #3
  ret void
}
...
define linkonce_odr void @_ZNSt14priority_queueI4DataSt6vectorIS0_SaIS0_EESt4lessIS0_EED2Ev(%"class.std::priority_queue"* %0) unnamed_addr #4 comdat align 2 {
  %2 = getelementptr inbounds %"class.std::priority_queue", %"class.std::priority_queue"* %0, i32 0, i32 0
  call void @_ZNSt6vectorI4DataSaIS0_EED2Ev(%"class.std::vector.3"* %2) #3
  ret void
}

; Function Attrs: noinline uwtable
define void @_Z16dijkstra_REVERSEv() #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %1 = alloca %"class.std::priority_queue", align 8
  %2 = alloca %struct.Data, align 8
  %3 = alloca %struct.Data, align 8
  br label %4
...
7:                                                ; preds = %4
  %8 = sext i32 %.01 to i64
  %9 = getelementptr inbounds [100000 x i64], [100000 x i64]* @rev_min_cost, i64 0, i64 %8
  store i64 999999999999, i64* %9, align 8
  br label %10
...
12:                                               ; preds = %4
  ...
  %14 = getelementptr inbounds [100000 x i64], [100000 x i64]* @rev_min_cost, i64 0, i64 %13
  store i64 0, i64* %14, align 8
  call void @_ZNSt14priority_queueI4DataSt6vectorIS0_SaIS0_EESt4lessIS0_EEC2IS3_vEEv(%"class.std::priority_queue"* %1)
  invoke void @_ZN4DataC2Eix(%struct.Data* %2, i32 1, i64 0)
          to label %15 unwind label %29
...
39:                                               ; preds = %35
  ...
  %41 = load i32, i32* %40, align 8
  %42 = sext i32 %41 to i64
  %43 = getelementptr inbounds [100000 x i64], [100000 x i64]* @rev_min_cost, i64 0, i64 %42
  %44 = load i64, i64* %43, align 8
  %45 = icmp sgt i64 %37, %44
  br i1 %45, label %46, label %48
...
52:                                               ; preds = %49
  ...
  %54 = load i32, i32* %53, align 8
  %55 = sext i32 %54 to i64
  %56 = getelementptr inbounds [100000 x %"class.std::vector"], [100000 x %"class.std::vector"]* @rev_G, i64 0, i64 %55
  %57 = call i64 @_ZNKSt6vectorI4InfoSaIS0_EE4sizeEv(%"class.std::vector"* %56) #3
  %58 = icmp ult i64 %50, %57
  br i1 %58, label %59, label %115
...
61:                                               ; preds = %59
  ...
  %63 = load i32, i32* %62, align 8
  %64 = sext i32 %63 to i64
  %65 = getelementptr inbounds [100000 x %"class.std::vector"], [100000 x %"class.std::vector"]* @rev_G, i64 0, i64 %64
  %66 = sext i32 %.0 to i64
  %67 = call dereferenceable(16) %struct.Info* @_ZNSt6vectorI4InfoSaIS0_EEixEm(%"class.std::vector"* %65, i64 %66) #3
  %68 = getelementptr inbounds %struct.Info, %struct.Info* %67, i32 0, i32 0
  %69 = load i32, i32* %68, align 8
  %70 = sext i32 %69 to i64
  %71 = getelementptr inbounds [100000 x i64], [100000 x i64]* @rev_min_cost, i64 0, i64 %70
  %72 = load i64, i64* %71, align 8
  %73 = invoke dereferenceable(16) %struct.Data* @_ZNKSt14priority_queueI4DataSt6vectorIS0_SaIS0_EESt4lessIS0_EE3topEv(%"class.std::priority_queue"* %1)
          to label %74 unwind label %29
...
78:                                               ; preds = %74
  ...
  %80 = load i32, i32* %79, align 8
  %81 = sext i32 %80 to i64
  %82 = getelementptr inbounds [100000 x %"class.std::vector"], [100000 x %"class.std::vector"]* @rev_G, i64 0, i64 %81
  %83 = sext i32 %.0 to i64
  %84 = call dereferenceable(16) %struct.Info* @_ZNSt6vectorI4InfoSaIS0_EEixEm(%"class.std::vector"* %82, i64 %83) #3
  %85 = getelementptr inbounds %struct.Info, %struct.Info* %84, i32 0, i32 2
  %86 = load i64, i64* %85, align 8
...
95:                                               ; preds = %91
  ...
  %97 = load i32, i32* %96, align 8
  %98 = sext i32 %97 to i64
  %99 = getelementptr inbounds [100000 x %"class.std::vector"], [100000 x %"class.std::vector"]* @rev_G, i64 0, i64 %98
  %100 = sext i32 %.0 to i64
  %101 = call dereferenceable(16) %struct.Info* @_ZNSt6vectorI4InfoSaIS0_EEixEm(%"class.std::vector"* %99, i64 %100) #3
  %102 = getelementptr inbounds %struct.Info, %struct.Info* %101, i32 0, i32 2
  %103 = load i64, i64* %102, align 8
  %104 = add nsw i64 %93, %103
  %105 = sext i32 %69 to i64
  %106 = getelementptr inbounds [100000 x i64], [100000 x i64]* @rev_min_cost, i64 0, i64 %105
  store i64 %104, i64* %106, align 8
  %107 = sext i32 %69 to i64
  %108 = getelementptr inbounds [100000 x i64], [100000 x i64]* @rev_min_cost, i64 0, i64 %107
  %109 = load i64, i64* %108, align 8
  invoke void @_ZN4DataC2Eix(%struct.Data* %3, i32 %69, i64 %109)
          to label %110 unwind label %29
...
define i32 @main() #5 {
  ...
  %10 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i32 0, i32 0), i32* @V, i32* @E)
  br label %11

11:                                               ; preds = %63, %0
  %.01 = phi i32 [ 0, %0 ], [ %64, %63 ]
...
14:                                               ; preds = %11
  ...
  %16 = getelementptr inbounds [100000 x %struct.Edge], [100000 x %struct.Edge]* @edge, i64 0, i64 %15
  %17 = getelementptr inbounds %struct.Edge, %struct.Edge* %16, i32 0, i32 0
  %18 = sext i32 %.01 to i64
  %19 = getelementptr inbounds [100000 x %struct.Edge], [100000 x %struct.Edge]* @edge, i64 0, i64 %18
  %20 = getelementptr inbounds %struct.Edge, %struct.Edge* %19, i32 0, i32 1
  %21 = sext i32 %.01 to i64
  %22 = getelementptr inbounds [100000 x %struct.Edge], [100000 x %struct.Edge]* @edge, i64 0, i64 %21
  %23 = getelementptr inbounds %struct.Edge, %struct.Edge* %22, i32 0, i32 2
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.7, i32 0, i32 0), i32* %17, i32* %20, i64* %23)
  %25 = sext i32 %.01 to i64
  %26 = getelementptr inbounds [100000 x %struct.Edge], [100000 x %struct.Edge]* @edge, i64 0, i64 %25
  %27 = getelementptr inbounds %struct.Edge, %struct.Edge* %26, i32 0, i32 0
  %28 = load i32, i32* %27, align 16
  %29 = add nsw i32 %28, -1
  store i32 %29, i32* %27, align 16
  %30 = sext i32 %.01 to i64
  %31 = getelementptr inbounds [100000 x %struct.Edge], [100000 x %struct.Edge]* @edge, i64 0, i64 %30
  %32 = getelementptr inbounds %struct.Edge, %struct.Edge* %31, i32 0, i32 1
  %33 = load i32, i32* %32, align 4
  %34 = add nsw i32 %33, -1
  store i32 %34, i32* %32, align 4
  %35 = sext i32 %.01 to i64
  %36 = getelementptr inbounds [100000 x %struct.Edge], [100000 x %struct.Edge]* @edge, i64 0, i64 %35
  ...
  %42 = getelementptr inbounds [100000 x %struct.Edge], [100000 x %struct.Edge]* @edge, i64 0, i64 %41
  %43 = getelementptr inbounds %struct.Edge, %struct.Edge* %42, i32 0, i32 1
  %44 = load i32, i32* %43, align 4
  %45 = sext i32 %.01 to i64
  %46 = getelementptr inbounds [100000 x %struct.Edge], [100000 x %struct.Edge]* @edge, i64 0, i64 %45
  %47 = getelementptr inbounds %struct.Edge, %struct.Edge* %46, i32 0, i32 2
  %48 = load i64, i64* %47, align 8
  call void @_ZN4InfoC2Eixi(%struct.Info* %1, i32 %44, i64 %48, i32 %.01)
  call void @_ZNSt6vectorI4InfoSaIS0_EE9push_backEOS0_(%"class.std::vector"* %40, %struct.Info* dereferenceable(16) %1)
  %49 = sext i32 %.01 to i64
  %50 = getelementptr inbounds [100000 x %struct.Edge], [100000 x %struct.Edge]* @edge, i64 0, i64 %49
  %51 = getelementptr inbounds %struct.Edge, %struct.Edge* %50, i32 0, i32 1
  %52 = load i32, i32* %51, align 4
  %53 = sext i32 %52 to i64
  %54 = getelementptr inbounds [100000 x %"class.std::vector"], [100000 x %"class.std::vector"]* @rev_G, i64 0, i64 %53
  %55 = sext i32 %.01 to i64
  %56 = getelementptr inbounds [100000 x %struct.Edge], [100000 x %struct.Edge]* @edge, i64 0, i64 %55
  %57 = getelementptr inbounds %struct.Edge, %struct.Edge* %56, i32 0, i32 0
  %58 = load i32, i32* %57, align 16
  %59 = sext i32 %.01 to i64
  %60 = getelementptr inbounds [100000 x %struct.Edge], [100000 x %struct.Edge]* @edge, i64 0, i64 %59
  %61 = getelementptr inbounds %struct.Edge, %struct.Edge* %60, i32 0, i32 2
  %62 = load i64, i64* %61, align 8
  call void @_ZN4InfoC2Eixi(%struct.Info* %2, i32 %58, i64 %62, i32 %.01)
  call void @_ZNSt6vectorI4InfoSaIS0_EE9push_backEOS0_(%"class.std::vector"* %54, %struct.Info* dereferenceable(16) %2)
  br label %63
...
65:                                               ; preds = %11
  call void @_Z15dijkstra_NORMALv()
  call void @_Z16dijkstra_REVERSEv()
  br label %66

66:                                               ; preds = %72, %65
  %.03 = phi i32 [ 0, %65 ], [ %73, %72 ]
...
69:                                               ; preds = %66
  ...
  %71 = getelementptr inbounds [100000 x i8], [100000 x i8]* @in_MIN_PATH, i64 0, i64 %70
...
78:                                               ; preds = %75
  ...
  %80 = getelementptr inbounds [100000 x %struct.Edge], [100000 x %struct.Edge]* @edge, i64 0, i64 %79
  %81 = getelementptr inbounds %struct.Edge, %struct.Edge* %80, i32 0, i32 0
  %82 = load i32, i32* %81, align 16
  %83 = sext i32 %82 to i64
  %84 = getelementptr inbounds [100000 x i64], [100000 x i64]* @min_cost, i64 0, i64 %83
  %85 = load i64, i64* %84, align 8
  %86 = sext i32 %.04 to i64
  %87 = getelementptr inbounds [100000 x %struct.Edge], [100000 x %struct.Edge]* @edge, i64 0, i64 %86
  %88 = getelementptr inbounds %struct.Edge, %struct.Edge* %87, i32 0, i32 2
  %89 = load i64, i64* %88, align 8
  %90 = add nsw i64 %85, %89
  %91 = sext i32 %.04 to i64
  %92 = getelementptr inbounds [100000 x %struct.Edge], [100000 x %struct.Edge]* @edge, i64 0, i64 %91
  %93 = getelementptr inbounds %struct.Edge, %struct.Edge* %92, i32 0, i32 1
  %94 = load i32, i32* %93, align 4
  %95 = sext i32 %94 to i64
  %96 = getelementptr inbounds [100000 x i64], [100000 x i64]* @rev_min_cost, i64 0, i64 %95
  %97 = load i64, i64* %96, align 8
  %98 = add nsw i64 %90, %97
  %99 = sext i32 1 to i64
  %100 = getelementptr inbounds [100000 x i64], [100000 x i64]* @min_cost, i64 0, i64 %99
...
103:                                              ; preds = %78
  ...
  %105 = getelementptr inbounds [100000 x i8], [100000 x i8]* @in_MIN_PATH, i64 0, i64 %104
  store i8 1, i8* %105, align 1
  %106 = sext i32 %.04 to i64
  %107 = getelementptr inbounds [100000 x %struct.Edge], [100000 x %struct.Edge]* @edge, i64 0, i64 %106
  %108 = getelementptr inbounds %struct.Edge, %struct.Edge* %107, i32 0, i32 0
  %109 = load i32, i32* %108, align 16
  %110 = sext i32 %109 to i64
  %111 = getelementptr inbounds [100000 x %"class.std::vector"], [100000 x %"class.std::vector"]* @MIN_G, i64 0, i64 %110
  %112 = sext i32 %.04 to i64
  %113 = getelementptr inbounds [100000 x %struct.Edge], [100000 x %struct.Edge]* @edge, i64 0, i64 %112
  %114 = getelementptr inbounds %struct.Edge, %struct.Edge* %113, i32 0, i32 1
  %115 = load i32, i32* %114, align 4
  %116 = sext i32 %.04 to i64
  %117 = getelementptr inbounds [100000 x %struct.Edge], [100000 x %struct.Edge]* @edge, i64 0, i64 %116
  %118 = getelementptr inbounds %struct.Edge, %struct.Edge* %117, i32 0, i32 2
  %119 = load i64, i64* %118, align 8
  call void @_ZN4InfoC2Eixi(%struct.Info* %4, i32 %115, i64 %119, i32 %.04)
  call void @_ZNSt6vectorI4InfoSaIS0_EE9push_backEOS0_(%"class.std::vector"* %111, %struct.Info* dereferenceable(16) %4)
  %120 = sext i32 %.04 to i64
  %121 = getelementptr inbounds [100000 x %struct.Edge], [100000 x %struct.Edge]* @edge, i64 0, i64 %120
  %122 = getelementptr inbounds %struct.Edge, %struct.Edge* %121, i32 0, i32 1
  %123 = load i32, i32* %122, align 4
  %124 = sext i32 %123 to i64
  %125 = getelementptr inbounds [100000 x %"class.std::vector"], [100000 x %"class.std::vector"]* @MIN_G, i64 0, i64 %124
  %126 = sext i32 %.04 to i64
  %127 = getelementptr inbounds [100000 x %struct.Edge], [100000 x %struct.Edge]* @edge, i64 0, i64 %126
  %128 = getelementptr inbounds %struct.Edge, %struct.Edge* %127, i32 0, i32 0
  %129 = load i32, i32* %128, align 16
  %130 = sext i32 %.04 to i64
  %131 = getelementptr inbounds [100000 x %struct.Edge], [100000 x %struct.Edge]* @edge, i64 0, i64 %130
  %132 = getelementptr inbounds %struct.Edge, %struct.Edge* %131, i32 0, i32 2
  %133 = load i64, i64* %132, align 8
  call void @_ZN4InfoC2Eixi(%struct.Info* %5, i32 %129, i64 %133, i32 %.04)
  call void @_ZNSt6vectorI4InfoSaIS0_EE9push_backEOS0_(%"class.std::vector"* %125, %struct.Info* dereferenceable(16) %5)
  %134 = sext i32 %.04 to i64
  %135 = getelementptr inbounds [100000 x %struct.Edge], [100000 x %struct.Edge]* @edge, i64 0, i64 %134
  %136 = getelementptr inbounds %struct.Edge, %struct.Edge* %135, i32 0, i32 0
  %137 = load i32, i32* %136, align 16
  %138 = mul nsw i32 %137, 1000000000
  %139 = sext i32 %.04 to i64
  %140 = getelementptr inbounds [100000 x %struct.Edge], [100000 x %struct.Edge]* @edge, i64 0, i64 %139
  %141 = getelementptr inbounds %struct.Edge, %struct.Edge* %140, i32 0, i32 1
  %142 = load i32, i32* %141, align 4
  %143 = add nsw i32 %138, %142
  %144 = sext i32 %143 to i64
  store i64 %144, i64* %3, align 8
  %145 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt3mapIxiSt4lessIxESaISt4pairIKxiEEE4findERS3_(%"class.std::map"* @MAP, i64* dereferenceable(8) %3)
  ...
  %147 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt3mapIxiSt4lessIxESaISt4pairIKxiEEE3endEv(%"class.std::map"* @MAP) #3
  ...
  %149 = call zeroext i1 @_ZNKSt17_Rb_tree_iteratorISt4pairIKxiEEneERKS3_(%"struct.std::_Rb_tree_iterator"* %6, %"struct.std::_Rb_tree_iterator"* dereferenceable(8) %7) #3
  br i1 %149, label %150, label %154

150:                                              ; preds = %103
  %151 = call dereferenceable(4) i32* @_ZNSt3mapIxiSt4lessIxESaISt4pairIKxiEEEixERS3_(%"class.std::map"* @MAP, i64* dereferenceable(8) %3)
...
154:                                              ; preds = %103
  %155 = call dereferenceable(4) i32* @_ZNSt3mapIxiSt4lessIxESaISt4pairIKxiEEEixERS3_(%"class.std::map"* @MAP, i64* dereferenceable(8) %3)
...
161:                                              ; preds = %169, %160
  %.05 = phi i32 [ 0, %160 ], [ %170, %169 ]
  %162 = load i32, i32* @V, align 4
  %163 = icmp slt i32 %.05, %162
  br i1 %163, label %164, label %171

164:                                              ; preds = %161
  %165 = sext i32 %.05 to i64
  %166 = getelementptr inbounds [100000 x i32], [100000 x i32]* @order, i64 0, i64 %165
  store i32 -1, i32* %166, align 4
  %167 = sext i32 %.05 to i64
  %168 = getelementptr inbounds [100000 x i32], [100000 x i32]* @lowlink, i64 0, i64 %167
...
172:                                              ; preds = %178, %171
  %.02 = phi i32 [ 0, %171 ], [ %179, %178 ]
  %173 = load i32, i32* @E, align 4
  %174 = icmp slt i32 %.02, %173
  br i1 %174, label %175, label %180

175:                                              ; preds = %172
  %176 = sext i32 %.02 to i64
  %177 = getelementptr inbounds [100000 x i8], [100000 x i8]* @visited, i64 0, i64 %176
...
184:                                              ; preds = %181
  ...
  %186 = getelementptr inbounds [100000 x %struct.Edge], [100000 x %struct.Edge]* @edge, i64 0, i64 %185
  %187 = getelementptr inbounds %struct.Edge, %struct.Edge* %186, i32 0, i32 1
  %188 = load i32, i32* %187, align 4
  %189 = sext i32 %188 to i64
  %190 = getelementptr inbounds [100000 x i64], [100000 x i64]* @min_cost, i64 0, i64 %189
  %191 = load i64, i64* %190, align 8
  %192 = icmp ne i64 %191, 999999999999
  br i1 %192, label %193, label %257

193:                                              ; preds = %184
  %194 = sext i32 %.0 to i64
  %195 = getelementptr inbounds [100000 x %struct.Edge], [100000 x %struct.Edge]* @edge, i64 0, i64 %194
  %196 = getelementptr inbounds %struct.Edge, %struct.Edge* %195, i32 0, i32 0
  %197 = load i32, i32* %196, align 16
  %198 = sext i32 %197 to i64
  %199 = getelementptr inbounds [100000 x i64], [100000 x i64]* @rev_min_cost, i64 0, i64 %198
  %200 = load i64, i64* %199, align 8
  %201 = icmp ne i64 %200, 999999999999
  br i1 %201, label %202, label %257

202:                                              ; preds = %193
  %203 = sext i32 %.0 to i64
  %204 = getelementptr inbounds [100000 x %struct.Edge], [100000 x %struct.Edge]* @edge, i64 0, i64 %203
  %205 = getelementptr inbounds %struct.Edge, %struct.Edge* %204, i32 0, i32 1
  %206 = load i32, i32* %205, align 4
  %207 = sext i32 %206 to i64
  %208 = getelementptr inbounds [100000 x i64], [100000 x i64]* @min_cost, i64 0, i64 %207
  %209 = load i64, i64* %208, align 8
  %210 = sext i32 %.0 to i64
  %211 = getelementptr inbounds [100000 x %struct.Edge], [100000 x %struct.Edge]* @edge, i64 0, i64 %210
  %212 = getelementptr inbounds %struct.Edge, %struct.Edge* %211, i32 0, i32 2
  %213 = load i64, i64* %212, align 8
  %214 = add nsw i64 %209, %213
  %215 = sext i32 %.0 to i64
  %216 = getelementptr inbounds [100000 x %struct.Edge], [100000 x %struct.Edge]* @edge, i64 0, i64 %215
  %217 = getelementptr inbounds %struct.Edge, %struct.Edge* %216, i32 0, i32 0
  %218 = load i32, i32* %217, align 16
  %219 = sext i32 %218 to i64
  %220 = getelementptr inbounds [100000 x i64], [100000 x i64]* @rev_min_cost, i64 0, i64 %219
  %221 = load i64, i64* %220, align 8
  %222 = add nsw i64 %214, %221
  %223 = sext i32 1 to i64
  %224 = getelementptr inbounds [100000 x i64], [100000 x i64]* @min_cost, i64 0, i64 %223
...
227:                                              ; preds = %202
  ...
  %229 = getelementptr inbounds [100000 x %struct.Edge], [100000 x %struct.Edge]* @edge, i64 0, i64 %228
  %230 = getelementptr inbounds %struct.Edge, %struct.Edge* %229, i32 0, i32 1
  %231 = load i32, i32* %230, align 4
  %232 = sext i32 %231 to i64
  %233 = getelementptr inbounds [100000 x i64], [100000 x i64]* @min_cost, i64 0, i64 %232
  %234 = load i64, i64* %233, align 8
  %235 = sext i32 %.0 to i64
  %236 = getelementptr inbounds [100000 x %struct.Edge], [100000 x %struct.Edge]* @edge, i64 0, i64 %235
  %237 = getelementptr inbounds %struct.Edge, %struct.Edge* %236, i32 0, i32 2
  %238 = load i64, i64* %237, align 8
  %239 = add nsw i64 %234, %238
  %240 = sext i32 %.0 to i64
  %241 = getelementptr inbounds [100000 x %struct.Edge], [100000 x %struct.Edge]* @edge, i64 0, i64 %240
  %242 = getelementptr inbounds %struct.Edge, %struct.Edge* %241, i32 0, i32 0
  %243 = load i32, i32* %242, align 16
  %244 = sext i32 %243 to i64
  %245 = getelementptr inbounds [100000 x i64], [100000 x i64]* @rev_min_cost, i64 0, i64 %244
  %246 = load i64, i64* %245, align 8
  %247 = add nsw i64 %239, %246
  %248 = sext i32 1 to i64
  %249 = getelementptr inbounds [100000 x i64], [100000 x i64]* @min_cost, i64 0, i64 %248
  %250 = load i64, i64* %249, align 8
  %251 = icmp slt i64 %247, %250
  br i1 %251, label %252, label %254

252:                                              ; preds = %227
  %253 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.8, i32 0, i32 0))
  br label %256

254:                                              ; preds = %227
  %255 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.9, i32 0, i32 0))
  br label %256

256:                                              ; preds = %254, %252
  br label %316

257:                                              ; preds = %202, %193, %184
  %258 = sext i32 %.0 to i64
  %259 = getelementptr inbounds [100000 x i8], [100000 x i8]* @in_MIN_PATH, i64 0, i64 %258
...
264:                                              ; preds = %257
  %265 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.9, i32 0, i32 0))
  br label %316

266:                                              ; preds = %257
  %267 = sext i32 %.0 to i64
  %268 = getelementptr inbounds [100000 x %struct.Edge], [100000 x %struct.Edge]* @edge, i64 0, i64 %267
  ...
  %273 = getelementptr inbounds [100000 x %struct.Edge], [100000 x %struct.Edge]* @edge, i64 0, i64 %272
  %274 = getelementptr inbounds %struct.Edge, %struct.Edge* %273, i32 0, i32 1
  %275 = load i32, i32* %274, align 4
  %276 = add nsw i32 %271, %275
  %277 = sext i32 %276 to i64
  store i64 %277, i64* %3, align 8
  %278 = call dereferenceable(4) i32* @_ZNSt3mapIxiSt4lessIxESaISt4pairIKxiEEEixERS3_(%"class.std::map"* @MAP, i64* dereferenceable(8) %3)
  %279 = load i32, i32* %278, align 4
  %280 = icmp sgt i32 %279, 1
  br i1 %280, label %281, label %283

281:                                              ; preds = %266
  %282 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.9, i32 0, i32 0))
  br label %316

283:                                              ; preds = %266
  %284 = sext i32 %.0 to i64
  %285 = getelementptr inbounds [100000 x %struct.Edge], [100000 x %struct.Edge]* @edge, i64 0, i64 %284
  ...
  %289 = getelementptr inbounds [100000 x %struct.Edge], [100000 x %struct.Edge]* @edge, i64 0, i64 %288
  %290 = getelementptr inbounds %struct.Edge, %struct.Edge* %289, i32 0, i32 1
  %291 = load i32, i32* %290, align 4
  store i32 %291, i32* %9, align 4
  %292 = load i32, i32* %9, align 4
  %293 = sext i32 %292 to i64
  %294 = getelementptr inbounds [100000 x i32], [100000 x i32]* @order, i64 0, i64 %293
  %295 = load i32, i32* %294, align 4
  %296 = load i32, i32* %8, align 4
  %297 = sext i32 %296 to i64
  %298 = getelementptr inbounds [100000 x i32], [100000 x i32]* @order, i64 0, i64 %297
...
302:                                              ; preds = %301, %283
  ...
  %305 = getelementptr inbounds [100000 x i32], [100000 x i32]* @order, i64 0, i64 %304
  %306 = load i32, i32* %305, align 4
  %307 = load i32, i32* %9, align 4
  %308 = sext i32 %307 to i64
  %309 = getelementptr inbounds [100000 x i32], [100000 x i32]* @lowlink, i64 0, i64 %308
  %310 = load i32, i32* %309, align 4
  %311 = icmp slt i32 %306, %310
  br i1 %311, label %312, label %314

312:                                              ; preds = %302
  %313 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.10, i32 0, i32 0))
  br label %316

314:                                              ; preds = %302
  %315 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.9, i32 0, i32 0))
  br label %316

316:                                              ; preds = %314, %312, %281, %264, %256
  %317 = add nsw i32 %.0, 1
  br label %181
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt6vectorI4InfoSaIS0_EE9push_backEOS0_(%"class.std::vector"* %0, %struct.Info* dereferenceable(16) %1) #0 comdat align 2 {
  %3 = call dereferenceable(16) %struct.Info* @_ZSt4moveIR4InfoEONSt16remove_referenceIT_E4typeEOS3_(%struct.Info* dereferenceable(16) %1) #3
  call void @_ZNSt6vectorI4InfoSaIS0_EE12emplace_backIJS0_EEEvDpOT_(%"class.std::vector"* %0, %struct.Info* dereferenceable(16) %3)
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN4InfoC2Eixi(%struct.Info* %0, i32 %1, i64 %2, i32 %3) unnamed_addr #4 comdat align 2 {
  %5 = getelementptr inbounds %struct.Info, %struct.Info* %0, i32 0, i32 0
  store i32 %1, i32* %5, align 8
  %6 = getelementptr inbounds %struct.Info, %struct.Info* %0, i32 0, i32 2
  store i64 %2, i64* %6, align 8
  %7 = getelementptr inbounds %struct.Info, %struct.Info* %0, i32 0, i32 1
  store i32 %3, i32* %7, align 4
  ret void
}

; Function Attrs: noinline uwtable
define linkonce_odr %"struct.std::_Rb_tree_node_base"* @_ZNSt3mapIxiSt4lessIxESaISt4pairIKxiEEE4findERS3_(%"class.std::map"* %0, i64* dereferenceable(8) %1) #0 comdat align 2 {
  %3 = alloca %"struct.std::_Rb_tree_iterator", align 8
  %4 = getelementptr inbounds %"class.std::map", %"class.std::map"* %0, i32 0, i32 0
  %5 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt8_Rb_treeIxSt4pairIKxiESt10_Select1stIS2_ESt4lessIxESaIS2_EE4findERS1_(%"class.std::_Rb_tree"* %4, i64* dereferenceable(8) %1)
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr zeroext i1 @_ZNKSt17_Rb_tree_iteratorISt4pairIKxiEEneERKS3_(%"struct.std::_Rb_tree_iterator"* %0, %"struct.std::_Rb_tree_iterator"* dereferenceable(8) %1) #4 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr %"struct.std::pair"* @_ZNSt13_Rb_tree_nodeISt4pairIKxiEE9_M_valptrEv(%"struct.std::_Rb_tree_node"* %0) #4 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKxiEEE7destroyIS4_EEvPT_(%"class.__gnu_cxx::new_allocator"* %0, %"struct.std::pair"* %1) #4 comdat align 2 {
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr %"struct.std::pair"* @_ZN9__gnu_cxx16__aligned_membufISt4pairIKxiEE6_M_ptrEv(%"struct.__gnu_cxx::__aligned_membuf"* %0) #4 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt6vectorI4DataSaIS0_EED2Ev(%"class.std::vector.3"* %0) unnamed_addr #4 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %11 = call dereferenceable(1) %"class.std::allocator.5"* @_ZNSt12_Vector_baseI4DataSaIS0_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base.4"* %10) #3
  invoke void @_ZSt8_DestroyIP4DataS0_EvT_S2_RSaIT0_E(%struct.Data* %5, %struct.Data* %9, %"class.std::allocator.5"* dereferenceable(1) %11)
          to label %12 unwind label %14

12:                                               ; preds = %1
  %13 = bitcast %"class.std::vector.3"* %0 to %"struct.std::_Vector_base.4"*
  call void @_ZNSt12_Vector_baseI4DataSaIS0_EED2Ev(%"struct.std::_Vector_base.4"* %13) #3
  ret void
...
14:                                               ; preds = %1
  ...
  call void @_ZNSt12_Vector_baseI4DataSaIS0_EED2Ev(%"struct.std::_Vector_base.4"* %18) #3
  br label %19
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZSt8_DestroyIP4DataS0_EvT_S2_RSaIT0_E(%struct.Data* %0, %struct.Data* %1, %"class.std::allocator.5"* dereferenceable(1) %2) #0 comdat {
  call void @_ZSt8_DestroyIP4DataEvT_S2_(%struct.Data* %0, %struct.Data* %1)
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(1) %"class.std::allocator.5"* @_ZNSt12_Vector_baseI4DataSaIS0_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base.4"* %0) #4 comdat align 2 {
  %2 = getelementptr inbounds %"struct.std::_Vector_base.4", %"struct.std::_Vector_base.4"* %0, i32 0, i32 0
  %3 = bitcast %"struct.std::_Vector_base<Data, std::allocator<Data> >::_Vector_impl"* %2 to %"class.std::allocator.5"*
  ret %"class.std::allocator.5"* %3
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt12_Vector_baseI4DataSaIS0_EED2Ev(%"struct.std::_Vector_base.4"* %0) unnamed_addr #4 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %2 = getelementptr inbounds %"struct.std::_Vector_base.4", %"struct.std::_Vector_base.4"* %0, i32 0, i32 0
  ...
  invoke void @_ZNSt12_Vector_baseI4DataSaIS0_EE13_M_deallocateEPS0_m(%"struct.std::_Vector_base.4"* %0, %struct.Data* %4, i64 %14)
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt12_Vector_baseI4DataSaIS0_EE13_M_deallocateEPS0_m(%"struct.std::_Vector_base.4"* %0, %struct.Data* %1, i64 %2) #0 comdat align 2 {
...
5:                                                ; preds = %3
  ...
  %7 = bitcast %"struct.std::_Vector_base<Data, std::allocator<Data> >::_Vector_impl"* %6 to %"class.std::allocator.5"*
  call void @_ZNSt16allocator_traitsISaI4DataEE10deallocateERS1_PS0_m(%"class.std::allocator.5"* dereferenceable(1) %7, %struct.Data* %1, i64 %2)
  br label %8
...
define linkonce_odr void @_ZNSt12_Vector_baseI4DataSaIS0_EE12_Vector_implD2Ev(%"struct.std::_Vector_base<Data, std::allocator<Data> >::_Vector_impl"* %0) unnamed_addr #4 comdat align 2 {
  %2 = bitcast %"struct.std::_Vector_base<Data, std::allocator<Data> >::_Vector_impl"* %0 to %"class.std::allocator.5"*
  call void @_ZNSaI4DataED2Ev(%"class.std::allocator.5"* %2) #3
  ret void
}

; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt16allocator_traitsISaI4DataEE10deallocateERS1_PS0_m(%"class.std::allocator.5"* dereferenceable(1) %0, %struct.Data* %1, i64 %2) #0 comdat align 2 {
  %4 = bitcast %"class.std::allocator.5"* %0 to %"class.__gnu_cxx::new_allocator.6"*
  call void @_ZN9__gnu_cxx13new_allocatorI4DataE10deallocateEPS1_m(%"class.__gnu_cxx::new_allocator.6"* %4, %struct.Data* %1, i64 %2)
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorI4DataE10deallocateEPS1_m(%"class.__gnu_cxx::new_allocator.6"* %0, %struct.Data* %1, i64 %2) #4 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSaI4DataED2Ev(%"class.std::allocator.5"* %0) unnamed_addr #4 comdat align 2 {
  %2 = bitcast %"class.std::allocator.5"* %0 to %"class.__gnu_cxx::new_allocator.6"*
  call void @_ZN9__gnu_cxx13new_allocatorI4DataED2Ev(%"class.__gnu_cxx::new_allocator.6"* %2) #3
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorI4DataED2Ev(%"class.__gnu_cxx::new_allocator.6"* %0) unnamed_addr #4 comdat align 2 {
  ret void
}
...
define linkonce_odr void @_ZNSt12_Vector_baseI4InfoSaIS0_EE12_Vector_implC2Ev(%"struct.std::_Vector_base<Info, std::allocator<Info> >::_Vector_impl"* %0) unnamed_addr #4 comdat align 2 {
  ...
  call void @_ZNSaI4InfoEC2Ev(%"class.std::allocator.0"* %2) #3
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSaI4InfoEC2Ev(%"class.std::allocator.0"* %0) unnamed_addr #4 comdat align 2 {
  %2 = bitcast %"class.std::allocator.0"* %0 to %"class.__gnu_cxx::new_allocator.1"*
  call void @_ZN9__gnu_cxx13new_allocatorI4InfoEC2Ev(%"class.__gnu_cxx::new_allocator.1"* %2) #3
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorI4InfoEC2Ev(%"class.__gnu_cxx::new_allocator.1"* %0) unnamed_addr #4 comdat align 2 {
  ret void
}

; Function Attrs: noinline uwtable
define linkonce_odr void @_ZSt8_DestroyIP4InfoS0_EvT_S2_RSaIT0_E(%struct.Info* %0, %struct.Info* %1, %"class.std::allocator.0"* dereferenceable(1) %2) #0 comdat {
  call void @_ZSt8_DestroyIP4InfoEvT_S2_(%struct.Info* %0, %struct.Info* %1)
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(1) %"class.std::allocator.0"* @_ZNSt12_Vector_baseI4InfoSaIS0_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %0) #4 comdat align 2 {
  %2 = getelementptr inbounds %"struct.std::_Vector_base", %"struct.std::_Vector_base"* %0, i32 0, i32 0
  %3 = bitcast %"struct.std::_Vector_base<Info, std::allocator<Info> >::_Vector_impl"* %2 to %"class.std::allocator.0"*
...
5:                                                ; preds = %3
  ...
  %7 = bitcast %"struct.std::_Vector_base<Info, std::allocator<Info> >::_Vector_impl"* %6 to %"class.std::allocator.0"*
  call void @_ZNSt16allocator_traitsISaI4InfoEE10deallocateERS1_PS0_m(%"class.std::allocator.0"* dereferenceable(1) %7, %struct.Info* %1, i64 %2)
  br label %8
...
define linkonce_odr void @_ZNSt12_Vector_baseI4InfoSaIS0_EE12_Vector_implD2Ev(%"struct.std::_Vector_base<Info, std::allocator<Info> >::_Vector_impl"* %0) unnamed_addr #4 comdat align 2 {
  %2 = bitcast %"struct.std::_Vector_base<Info, std::allocator<Info> >::_Vector_impl"* %0 to %"class.std::allocator.0"*
  call void @_ZNSaI4InfoED2Ev(%"class.std::allocator.0"* %2) #3
  ret void
}

; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt16allocator_traitsISaI4InfoEE10deallocateERS1_PS0_m(%"class.std::allocator.0"* dereferenceable(1) %0, %struct.Info* %1, i64 %2) #0 comdat align 2 {
  %4 = bitcast %"class.std::allocator.0"* %0 to %"class.__gnu_cxx::new_allocator.1"*
  call void @_ZN9__gnu_cxx13new_allocatorI4InfoE10deallocateEPS1_m(%"class.__gnu_cxx::new_allocator.1"* %4, %struct.Info* %1, i64 %2)
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorI4InfoE10deallocateEPS1_m(%"class.__gnu_cxx::new_allocator.1"* %0, %struct.Info* %1, i64 %2) #4 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSaI4InfoED2Ev(%"class.std::allocator.0"* %0) unnamed_addr #4 comdat align 2 {
  %2 = bitcast %"class.std::allocator.0"* %0 to %"class.__gnu_cxx::new_allocator.1"*
  call void @_ZN9__gnu_cxx13new_allocatorI4InfoED2Ev(%"class.__gnu_cxx::new_allocator.1"* %2) #3
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorI4InfoED2Ev(%"class.__gnu_cxx::new_allocator.1"* %0) unnamed_addr #4 comdat align 2 {
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt6vectorI4DataSaIS0_EEC2Ev(%"class.std::vector.3"* %0) unnamed_addr #4 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %2 = bitcast %"class.std::vector.3"* %0 to %"struct.std::_Vector_base.4"*
  invoke void @_ZNSt12_Vector_baseI4DataSaIS0_EEC2Ev(%"struct.std::_Vector_base.4"* %2)
          to label %3 unwind label %4
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt12_Vector_baseI4DataSaIS0_EEC2Ev(%"struct.std::_Vector_base.4"* %0) unnamed_addr #0 comdat align 2 {
  %2 = getelementptr inbounds %"struct.std::_Vector_base.4", %"struct.std::_Vector_base.4"* %0, i32 0, i32 0
...
define linkonce_odr void @_ZNSt12_Vector_baseI4DataSaIS0_EE12_Vector_implC2Ev(%"struct.std::_Vector_base<Data, std::allocator<Data> >::_Vector_impl"* %0) unnamed_addr #4 comdat align 2 {
  %2 = bitcast %"struct.std::_Vector_base<Data, std::allocator<Data> >::_Vector_impl"* %0 to %"class.std::allocator.5"*
  call void @_ZNSaI4DataEC2Ev(%"class.std::allocator.5"* %2) #3
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSaI4DataEC2Ev(%"class.std::allocator.5"* %0) unnamed_addr #4 comdat align 2 {
  %2 = bitcast %"class.std::allocator.5"* %0 to %"class.__gnu_cxx::new_allocator.6"*
  call void @_ZN9__gnu_cxx13new_allocatorI4DataEC2Ev(%"class.__gnu_cxx::new_allocator.6"* %2) #3
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorI4DataEC2Ev(%"class.__gnu_cxx::new_allocator.6"* %0) unnamed_addr #4 comdat align 2 {
  ret void
}

; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt6vectorI4DataSaIS0_EE9push_backEOS0_(%"class.std::vector.3"* %0, %struct.Data* dereferenceable(16) %1) #0 comdat align 2 {
  ...
  call void @_ZNSt6vectorI4DataSaIS0_EE12emplace_backIJS0_EEEvDpOT_(%"class.std::vector.3"* %0, %struct.Data* dereferenceable(16) %3)
  ret void
}
...
define linkonce_odr void @_ZSt9push_heapIN9__gnu_cxx17__normal_iteratorIP4DataSt6vectorIS2_SaIS2_EEEESt4lessIS2_EEvT_SA_T0_(%struct.Data* %0, %struct.Data* %1) #0 comdat {
  ...
  %13 = call dereferenceable(1) %"struct.std::less.8"* @_ZSt4moveIRSt4lessI4DataEEONSt16remove_referenceIT_E4typeEOS5_(%"struct.std::less.8"* dereferenceable(1) %5) #3
  ...
  %29 = bitcast %struct.Data* %10 to { i32, i64 }*
  ...
  call void @_ZSt11__push_heapIN9__gnu_cxx17__normal_iteratorIP4DataSt6vectorIS2_SaIS2_EEEElS2_NS0_5__ops14_Iter_comp_valISt4lessIS2_EEEEvT_T0_SE_T1_RT2_(%struct.Data* %28, i64 %23, i64 0, i32 %31, i64 %33, %"struct.__gnu_cxx::__ops::_Iter_comp_val"* dereferenceable(1) %6)
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr %struct.Data* @_ZNSt6vectorI4DataSaIS0_EE5beginEv(%"class.std::vector.3"* %0) #4 comdat align 2 {
  %2 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr %struct.Data* @_ZNSt6vectorI4DataSaIS0_EE3endEv(%"class.std::vector.3"* %0) #4 comdat align 2 {
  %2 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %3 = bitcast %"class.std::vector.3"* %0 to %"struct.std::_Vector_base.4"*
  %4 = getelementptr inbounds %"struct.std::_Vector_base.4", %"struct.std::_Vector_base.4"* %3, i32 0, i32 0
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt6vectorI4DataSaIS0_EE12emplace_backIJS0_EEEvDpOT_(%"class.std::vector.3"* %0, %struct.Data* dereferenceable(16) %1) #0 comdat align 2 {
  %3 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
...
13:                                               ; preds = %2
  ...
  %16 = bitcast %"struct.std::_Vector_base<Data, std::allocator<Data> >::_Vector_impl"* %15 to %"class.std::allocator.5"*
  ...
  call void @_ZNSt16allocator_traitsISaI4DataEE9constructIS0_JS0_EEEvRS1_PT_DpOT0_(%"class.std::allocator.5"* dereferenceable(1) %16, %struct.Data* %20, %struct.Data* dereferenceable(16) %21)
...
27:                                               ; preds = %2
  %28 = call %struct.Data* @_ZNSt6vectorI4DataSaIS0_EE3endEv(%"class.std::vector.3"* %0) #3
  ...
  call void @_ZNSt6vectorI4DataSaIS0_EE17_M_realloc_insertIJS0_EEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_(%"class.std::vector.3"* %0, %struct.Data* %32, %struct.Data* dereferenceable(16) %30)
  br label %33
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt16allocator_traitsISaI4DataEE9constructIS0_JS0_EEEvRS1_PT_DpOT0_(%"class.std::allocator.5"* dereferenceable(1) %0, %struct.Data* %1, %struct.Data* dereferenceable(16) %2) #0 comdat align 2 {
  %4 = bitcast %"class.std::allocator.5"* %0 to %"class.__gnu_cxx::new_allocator.6"*
  ...
  call void @_ZN9__gnu_cxx13new_allocatorI4DataE9constructIS1_JS1_EEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator.6"* %4, %struct.Data* %1, %struct.Data* dereferenceable(16) %5)
  ret void
}
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt6vectorI4DataSaIS0_EE17_M_realloc_insertIJS0_EEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_(%"class.std::vector.3"* %0, %struct.Data* %1, %struct.Data* dereferenceable(16) %2) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %4 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %5 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %6 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %4, i32 0, i32 0
  store %struct.Data* %1, %struct.Data** %6, align 8
  %7 = call i64 @_ZNKSt6vectorI4DataSaIS0_EE12_M_check_lenEmPKc(%"class.std::vector.3"* %0, i64 1, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.11, i32 0, i32 0))
  %8 = bitcast %"class.std::vector.3"* %0 to %"struct.std::_Vector_base.4"*
  %9 = getelementptr inbounds %"struct.std::_Vector_base.4", %"struct.std::_Vector_base.4"* %8, i32 0, i32 0
  ...
  %15 = load %struct.Data*, %struct.Data** %14, align 8
  %16 = call %struct.Data* @_ZNSt6vectorI4DataSaIS0_EE5beginEv(%"class.std::vector.3"* %0) #3
  ...
  %20 = call %struct.Data* @_ZNSt12_Vector_baseI4DataSaIS0_EE11_M_allocateEm(%"struct.std::_Vector_base.4"* %19, i64 %7)
  ...
  %23 = bitcast %"struct.std::_Vector_base<Data, std::allocator<Data> >::_Vector_impl"* %22 to %"class.std::allocator.5"*
  ...
  invoke void @_ZNSt16allocator_traitsISaI4DataEE9constructIS0_JS0_EEEvRS1_PT_DpOT0_(%"class.std::allocator.5"* dereferenceable(1) %23, %struct.Data* %24, %struct.Data* dereferenceable(16) %25)
...
26:                                               ; preds = %3
  ...
  %30 = call dereferenceable(1) %"class.std::allocator.5"* @_ZNSt12_Vector_baseI4DataSaIS0_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base.4"* %29) #3
  %31 = invoke %struct.Data* @_ZSt34__uninitialized_move_if_noexcept_aIP4DataS1_SaIS0_EET0_T_S4_S3_RT1_(%struct.Data* %11, %struct.Data* %28, %struct.Data* %20, %"class.std::allocator.5"* dereferenceable(1) %30)
...
32:                                               ; preds = %26
  ...
  %37 = call dereferenceable(1) %"class.std::allocator.5"* @_ZNSt12_Vector_baseI4DataSaIS0_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base.4"* %36) #3
  %38 = invoke %struct.Data* @_ZSt34__uninitialized_move_if_noexcept_aIP4DataS1_SaIS0_EET0_T_S4_S3_RT1_(%struct.Data* %35, %struct.Data* %15, %struct.Data* %33, %"class.std::allocator.5"* dereferenceable(1) %37)
...
47:                                               ; preds = %44
  ...
  %50 = bitcast %"struct.std::_Vector_base<Data, std::allocator<Data> >::_Vector_impl"* %49 to %"class.std::allocator.5"*
  %51 = getelementptr inbounds %struct.Data, %struct.Data* %20, i64 %18
  invoke void @_ZNSt16allocator_traitsISaI4DataEE7destroyIS0_EEvRS1_PT_(%"class.std::allocator.5"* dereferenceable(1) %50, %struct.Data* %51)
...
57:                                               ; preds = %44
  ...
  %59 = call dereferenceable(1) %"class.std::allocator.5"* @_ZNSt12_Vector_baseI4DataSaIS0_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base.4"* %58) #3
  invoke void @_ZSt8_DestroyIP4DataS0_EvT_S2_RSaIT0_E(%struct.Data* %20, %struct.Data* %.0, %"class.std::allocator.5"* dereferenceable(1) %59)
...
61:                                               ; preds = %60, %52
  ...
  invoke void @_ZNSt12_Vector_baseI4DataSaIS0_EE13_M_deallocateEPS0_m(%"struct.std::_Vector_base.4"* %62, %struct.Data* %20, i64 %7)
...
65:                                               ; preds = %39
  ...
  %67 = call dereferenceable(1) %"class.std::allocator.5"* @_ZNSt12_Vector_baseI4DataSaIS0_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base.4"* %66) #3
  call void @_ZSt8_DestroyIP4DataS0_EvT_S2_RSaIT0_E(%struct.Data* %11, %struct.Data* %15, %"class.std::allocator.5"* dereferenceable(1) %67)
  ...
  call void @_ZNSt12_Vector_baseI4DataSaIS0_EE13_M_deallocateEPS0_m(%"struct.std::_Vector_base.4"* %68, %struct.Data* %11, i64 %76)
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorI4DataE9constructIS1_JS1_EEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator.6"* %0, %struct.Data* %1, %struct.Data* dereferenceable(16) %2) #4 comdat align 2 {
  %4 = bitcast %struct.Data* %1 to i8*
...
; Function Attrs: noinline uwtable
define linkonce_odr i64 @_ZNKSt6vectorI4DataSaIS0_EE12_M_check_lenEmPKc(%"class.std::vector.3"* %0, i64 %1, i8* %2) #0 comdat align 2 {
  %4 = alloca i64, align 8
  %5 = alloca i64, align 8
  store i64 %1, i64* %4, align 8
  %6 = call i64 @_ZNKSt6vectorI4DataSaIS0_EE8max_sizeEv(%"class.std::vector.3"* %0) #3
  %7 = call i64 @_ZNKSt6vectorI4DataSaIS0_EE4sizeEv(%"class.std::vector.3"* %0) #3
  %8 = sub i64 %6, %7
...
12:                                               ; preds = %3
  %13 = call i64 @_ZNKSt6vectorI4DataSaIS0_EE4sizeEv(%"class.std::vector.3"* %0) #3
  %14 = call i64 @_ZNKSt6vectorI4DataSaIS0_EE4sizeEv(%"class.std::vector.3"* %0) #3
  store i64 %14, i64* %5, align 8
  %15 = call dereferenceable(8) i64* @_ZSt3maxImERKT_S2_S2_(i64* dereferenceable(8) %5, i64* dereferenceable(8) %4)
  %16 = load i64, i64* %15, align 8
  %17 = add i64 %13, %16
  %18 = call i64 @_ZNKSt6vectorI4DataSaIS0_EE4sizeEv(%"class.std::vector.3"* %0) #3
  %19 = icmp ult i64 %17, %18
  br i1 %19, label %23, label %20

20:                                               ; preds = %12
  %21 = call i64 @_ZNKSt6vectorI4DataSaIS0_EE8max_sizeEv(%"class.std::vector.3"* %0) #3
  %22 = icmp ugt i64 %17, %21
  br i1 %22, label %23, label %25

23:                                               ; preds = %20, %12
  %24 = call i64 @_ZNKSt6vectorI4DataSaIS0_EE8max_sizeEv(%"class.std::vector.3"* %0) #3
  br label %26
...
; Function Attrs: noinline uwtable
define linkonce_odr %struct.Data* @_ZNSt12_Vector_baseI4DataSaIS0_EE11_M_allocateEm(%"struct.std::_Vector_base.4"* %0, i64 %1) #0 comdat align 2 {
  %3 = icmp ne i64 %1, 0
  br i1 %3, label %4, label %8

4:                                                ; preds = %2
  %5 = getelementptr inbounds %"struct.std::_Vector_base.4", %"struct.std::_Vector_base.4"* %0, i32 0, i32 0
  %6 = bitcast %"struct.std::_Vector_base<Data, std::allocator<Data> >::_Vector_impl"* %5 to %"class.std::allocator.5"*
  %7 = call %struct.Data* @_ZNSt16allocator_traitsISaI4DataEE8allocateERS1_m(%"class.std::allocator.5"* dereferenceable(1) %6, i64 %1)
  br label %9
...
; Function Attrs: noinline uwtable
define linkonce_odr %struct.Data* @_ZSt34__uninitialized_move_if_noexcept_aIP4DataS1_SaIS0_EET0_T_S4_S3_RT1_(%struct.Data* %0, %struct.Data* %1, %struct.Data* %2, %"class.std::allocator.5"* dereferenceable(1) %3) #0 comdat {
  ...
  %14 = load %struct.Data*, %struct.Data** %13, align 8
  %15 = call %struct.Data* @_ZSt22__uninitialized_copy_aISt13move_iteratorIP4DataES2_S1_ET0_T_S5_S4_RSaIT1_E(%struct.Data* %12, %struct.Data* %14, %struct.Data* %2, %"class.std::allocator.5"* dereferenceable(1) %3)
  ret %struct.Data* %15
}
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt16allocator_traitsISaI4DataEE7destroyIS0_EEvRS1_PT_(%"class.std::allocator.5"* dereferenceable(1) %0, %struct.Data* %1) #0 comdat align 2 {
  %3 = bitcast %"class.std::allocator.5"* %0 to %"class.__gnu_cxx::new_allocator.6"*
  call void @_ZN9__gnu_cxx13new_allocatorI4DataE7destroyIS1_EEvPT_(%"class.__gnu_cxx::new_allocator.6"* %3, %struct.Data* %1)
  ret void
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64 @_ZNKSt6vectorI4DataSaIS0_EE8max_sizeEv(%"class.std::vector.3"* %0) #4 comdat align 2 {
  %2 = bitcast %"class.std::vector.3"* %0 to %"struct.std::_Vector_base.4"*
  %3 = call dereferenceable(1) %"class.std::allocator.5"* @_ZNKSt12_Vector_baseI4DataSaIS0_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base.4"* %2) #3
  %4 = call i64 @_ZNSt16allocator_traitsISaI4DataEE8max_sizeERKS1_(%"class.std::allocator.5"* dereferenceable(1) %3) #3
  ret i64 %4
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64 @_ZNKSt6vectorI4DataSaIS0_EE4sizeEv(%"class.std::vector.3"* %0) #4 comdat align 2 {
  %2 = bitcast %"class.std::vector.3"* %0 to %"struct.std::_Vector_base.4"*
  %3 = getelementptr inbounds %"struct.std::_Vector_base.4", %"struct.std::_Vector_base.4"* %2, i32 0, i32 0
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64 @_ZNSt16allocator_traitsISaI4DataEE8max_sizeERKS1_(%"class.std::allocator.5"* dereferenceable(1) %0) #4 comdat align 2 {
  %2 = bitcast %"class.std::allocator.5"* %0 to %"class.__gnu_cxx::new_allocator.6"*
  %3 = call i64 @_ZNK9__gnu_cxx13new_allocatorI4DataE8max_sizeEv(%"class.__gnu_cxx::new_allocator.6"* %2) #3
  ret i64 %3
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(1) %"class.std::allocator.5"* @_ZNKSt12_Vector_baseI4DataSaIS0_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base.4"* %0) #4 comdat align 2 {
  %2 = getelementptr inbounds %"struct.std::_Vector_base.4", %"struct.std::_Vector_base.4"* %0, i32 0, i32 0
  %3 = bitcast %"struct.std::_Vector_base<Data, std::allocator<Data> >::_Vector_impl"* %2 to %"class.std::allocator.5"*
  ret %"class.std::allocator.5"* %3
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64 @_ZNK9__gnu_cxx13new_allocatorI4DataE8max_sizeEv(%"class.__gnu_cxx::new_allocator.6"* %0) #4 comdat align 2 {
  ret i64 1152921504606846975
}

; Function Attrs: noinline uwtable
define linkonce_odr %struct.Data* @_ZNSt16allocator_traitsISaI4DataEE8allocateERS1_m(%"class.std::allocator.5"* dereferenceable(1) %0, i64 %1) #0 comdat align 2 {
  %3 = bitcast %"class.std::allocator.5"* %0 to %"class.__gnu_cxx::new_allocator.6"*
  %4 = call %struct.Data* @_ZN9__gnu_cxx13new_allocatorI4DataE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.6"* %3, i64 %1, i8* null)
  ret %struct.Data* %4
}

; Function Attrs: noinline uwtable
define linkonce_odr %struct.Data* @_ZN9__gnu_cxx13new_allocatorI4DataE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.6"* %0, i64 %1, i8* %2) #0 comdat align 2 {
  %4 = call i64 @_ZNK9__gnu_cxx13new_allocatorI4DataE8max_sizeEv(%"class.__gnu_cxx::new_allocator.6"* %0) #3
  %5 = icmp ugt i64 %1, %4
  br i1 %5, label %6, label %7
...
; Function Attrs: noinline uwtable
define linkonce_odr %struct.Data* @_ZSt22__uninitialized_copy_aISt13move_iteratorIP4DataES2_S1_ET0_T_S5_S4_RSaIT1_E(%struct.Data* %0, %struct.Data* %1, %struct.Data* %2, %"class.std::allocator.5"* dereferenceable(1) %3) #0 comdat {
  %5 = alloca %"class.std::move_iterator", align 8
  %6 = alloca %"class.std::move_iterator", align 8
...
8:                                                ; preds = %18, %3
  ...
  %9 = invoke zeroext i1 @_ZStneIP4DataEbRKSt13move_iteratorIT_ES6_(%"class.std::move_iterator"* dereferenceable(8) %4, %"class.std::move_iterator"* dereferenceable(8) %5)
...
11:                                               ; preds = %10
  ...
  %13 = invoke dereferenceable(16) %struct.Data* @_ZNKSt13move_iteratorIP4DataEdeEv(%"class.std::move_iterator"* %4)
...
16:                                               ; preds = %15
  %17 = invoke dereferenceable(8) %"class.std::move_iterator"* @_ZNSt13move_iteratorIP4DataEppEv(%"class.std::move_iterator"* %4)
...
; Function Attrs: noinline uwtable
define linkonce_odr zeroext i1 @_ZStneIP4DataEbRKSt13move_iteratorIT_ES6_(%"class.std::move_iterator"* dereferenceable(8) %0, %"class.std::move_iterator"* dereferenceable(8) %1) #0 comdat {
  %3 = call zeroext i1 @_ZSteqIP4DataEbRKSt13move_iteratorIT_ES6_(%"class.std::move_iterator"* dereferenceable(8) %0, %"class.std::move_iterator"* dereferenceable(8) %1)
  %4 = xor i1 %3, true
  ret i1 %4
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(16) %struct.Data* @_ZNKSt13move_iteratorIP4DataEdeEv(%"class.std::move_iterator"* %0) #4 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(8) %"class.std::move_iterator"* @_ZNSt13move_iteratorIP4DataEppEv(%"class.std::move_iterator"* %0) #4 comdat align 2 {
  %2 = getelementptr inbounds %"class.std::move_iterator", %"class.std::move_iterator"* %0, i32 0, i32 0
  %3 = load %struct.Data*, %struct.Data** %2, align 8
...
; Function Attrs: noinline uwtable
define linkonce_odr zeroext i1 @_ZSteqIP4DataEbRKSt13move_iteratorIT_ES6_(%"class.std::move_iterator"* dereferenceable(8) %0, %"class.std::move_iterator"* dereferenceable(8) %1) #0 comdat {
  %3 = call %struct.Data* @_ZNKSt13move_iteratorIP4DataE4baseEv(%"class.std::move_iterator"* %0)
  %4 = call %struct.Data* @_ZNKSt13move_iteratorIP4DataE4baseEv(%"class.std::move_iterator"* %1)
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorI4DataE7destroyIS1_EEvPT_(%"class.__gnu_cxx::new_allocator.6"* %0, %struct.Data* %1) #4 comdat align 2 {
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(1) %"struct.std::less.8"* @_ZSt4moveIRSt4lessI4DataEEONSt16remove_referenceIT_E4typeEOS5_(%"struct.std::less.8"* dereferenceable(1) %0) #4 comdat {
...
define linkonce_odr void @_ZN9__gnu_cxx5__ops14_Iter_comp_valISt4lessI4DataEEC2ES4_(%"struct.__gnu_cxx::__ops::_Iter_comp_val"* %0) unnamed_addr #4 comdat align 2 {
  ...
  %4 = call dereferenceable(1) %"struct.std::less.8"* @_ZSt4moveIRSt4lessI4DataEEONSt16remove_referenceIT_E4typeEOS5_(%"struct.std::less.8"* dereferenceable(1) %2) #3
  ret void
}
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZSt11__push_heapIN9__gnu_cxx17__normal_iteratorIP4DataSt6vectorIS2_SaIS2_EEEElS2_NS0_5__ops14_Iter_comp_valISt4lessIS2_EEEEvT_T0_SE_T1_RT2_(%struct.Data* %0, i64 %1, i64 %2, i32 %3, i64 %4, %"struct.__gnu_cxx::__ops::_Iter_comp_val"* dereferenceable(1) %5) #0 comdat {
  ...
  %14 = bitcast %struct.Data* %8 to { i32, i64 }*
...
define linkonce_odr zeroext i1 @_ZN9__gnu_cxx5__ops14_Iter_comp_valISt4lessI4DataEEclINS_17__normal_iteratorIPS3_St6vectorIS3_SaIS3_EEEES3_EEbT_RT0_(%"struct.__gnu_cxx::__ops::_Iter_comp_val"* %0, %struct.Data* %1, %struct.Data* dereferenceable(16) %2) #0 comdat align 2 {
  ...
  %8 = call zeroext i1 @_ZNKSt4lessI4DataEclERKS0_S3_(%"struct.std::less.8"* %6, %struct.Data* dereferenceable(16) %7, %struct.Data* dereferenceable(16) %2)
  ret i1 %8
}
...
; Function Attrs: noinline uwtable
define linkonce_odr zeroext i1 @_ZNKSt4lessI4DataEclERKS0_S3_(%"struct.std::less.8"* %0, %struct.Data* dereferenceable(16) %1, %struct.Data* dereferenceable(16) %2) #0 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr zeroext i1 @_ZNKSt6vectorI4DataSaIS0_EE5emptyEv(%"class.std::vector.3"* %0) #4 comdat align 2 {
  %2 = alloca %"class.__gnu_cxx::__normal_iterator.10", align 8
  %3 = alloca %"class.__gnu_cxx::__normal_iterator.10", align 8
  %4 = call %struct.Data* @_ZNKSt6vectorI4DataSaIS0_EE5beginEv(%"class.std::vector.3"* %0) #3
  ...
  %6 = call %struct.Data* @_ZNKSt6vectorI4DataSaIS0_EE3endEv(%"class.std::vector.3"* %0) #3
  ...
  %8 = call zeroext i1 @_ZN9__gnu_cxxeqIPK4DataSt6vectorIS1_SaIS1_EEEEbRKNS_17__normal_iteratorIT_T0_EESC_(%"class.__gnu_cxx::__normal_iterator.10"* dereferenceable(8) %2, %"class.__gnu_cxx::__normal_iterator.10"* dereferenceable(8) %3) #3
  ret i1 %8
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr zeroext i1 @_ZN9__gnu_cxxeqIPK4DataSt6vectorIS1_SaIS1_EEEEbRKNS_17__normal_iteratorIT_T0_EESC_(%"class.__gnu_cxx::__normal_iterator.10"* dereferenceable(8) %0, %"class.__gnu_cxx::__normal_iterator.10"* dereferenceable(8) %1) #4 comdat {
  %3 = call dereferenceable(8) %struct.Data** @_ZNK9__gnu_cxx17__normal_iteratorIPK4DataSt6vectorIS1_SaIS1_EEE4baseEv(%"class.__gnu_cxx::__normal_iterator.10"* %0) #3
  %4 = load %struct.Data*, %struct.Data** %3, align 8
  %5 = call dereferenceable(8) %struct.Data** @_ZNK9__gnu_cxx17__normal_iteratorIPK4DataSt6vectorIS1_SaIS1_EEE4baseEv(%"class.__gnu_cxx::__normal_iterator.10"* %1) #3
  %6 = load %struct.Data*, %struct.Data** %5, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr %struct.Data* @_ZNKSt6vectorI4DataSaIS0_EE5beginEv(%"class.std::vector.3"* %0) #4 comdat align 2 {
  %2 = alloca %"class.__gnu_cxx::__normal_iterator.10", align 8
  %3 = alloca %struct.Data*, align 8
  %4 = bitcast %"class.std::vector.3"* %0 to %"struct.std::_Vector_base.4"*
  %5 = getelementptr inbounds %"struct.std::_Vector_base.4", %"struct.std::_Vector_base.4"* %4, i32 0, i32 0
  ...
  call void @_ZN9__gnu_cxx17__normal_iteratorIPK4DataSt6vectorIS1_SaIS1_EEEC2ERKS3_(%"class.__gnu_cxx::__normal_iterator.10"* %2, %struct.Data** dereferenceable(8) %3) #3
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr %struct.Data* @_ZNKSt6vectorI4DataSaIS0_EE3endEv(%"class.std::vector.3"* %0) #4 comdat align 2 {
  %2 = alloca %"class.__gnu_cxx::__normal_iterator.10", align 8
  %3 = alloca %struct.Data*, align 8
  %4 = bitcast %"class.std::vector.3"* %0 to %"struct.std::_Vector_base.4"*
  %5 = getelementptr inbounds %"struct.std::_Vector_base.4", %"struct.std::_Vector_base.4"* %4, i32 0, i32 0
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(8) %struct.Data** @_ZNK9__gnu_cxx17__normal_iteratorIPK4DataSt6vectorIS1_SaIS1_EEE4baseEv(%"class.__gnu_cxx::__normal_iterator.10"* %0) #4 comdat align 2 {
  %2 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator.10", %"class.__gnu_cxx::__normal_iterator.10"* %0, i32 0, i32 0
  ret %struct.Data** %2
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx17__normal_iteratorIPK4DataSt6vectorIS1_SaIS1_EEEC2ERKS3_(%"class.__gnu_cxx::__normal_iterator.10"* %0, %struct.Data** dereferenceable(8) %1) unnamed_addr #4 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(16) %struct.Data* @_ZNKSt6vectorI4DataSaIS0_EE5frontEv(%"class.std::vector.3"* %0) #4 comdat align 2 {
  %2 = alloca %"class.__gnu_cxx::__normal_iterator.10", align 8
  %3 = call %struct.Data* @_ZNKSt6vectorI4DataSaIS0_EE5beginEv(%"class.std::vector.3"* %0) #3
  ...
  %5 = call dereferenceable(16) %struct.Data* @_ZNK9__gnu_cxx17__normal_iteratorIPK4DataSt6vectorIS1_SaIS1_EEEdeEv(%"class.__gnu_cxx::__normal_iterator.10"* %2) #3
  ret %struct.Data* %5
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(16) %struct.Data* @_ZNK9__gnu_cxx17__normal_iteratorIPK4DataSt6vectorIS1_SaIS1_EEEdeEv(%"class.__gnu_cxx::__normal_iterator.10"* %0) #4 comdat align 2 {
  %2 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator.10", %"class.__gnu_cxx::__normal_iterator.10"* %0, i32 0, i32 0
  %3 = load %struct.Data*, %struct.Data** %2, align 8
  ret %struct.Data* %3
}
...
14:                                               ; preds = %2
  %15 = call dereferenceable(1) %"struct.std::less.8"* @_ZSt4moveIRSt4lessI4DataEEONSt16remove_referenceIT_E4typeEOS5_(%"struct.std::less.8"* dereferenceable(1) %5) #3
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt6vectorI4DataSaIS0_EE8pop_backEv(%"class.std::vector.3"* %0) #4 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %2 = bitcast %"class.std::vector.3"* %0 to %"struct.std::_Vector_base.4"*
  %3 = getelementptr inbounds %"struct.std::_Vector_base.4", %"struct.std::_Vector_base.4"* %2, i32 0, i32 0
  %4 = getelementptr inbounds %"struct.std::_Vector_base<Data, std::allocator<Data> >::_Vector_impl", %"struct.std::_Vector_base<Data, std::allocator<Data> >::_Vector_impl"* %3, i32 0, i32 1
  %5 = load %struct.Data*, %struct.Data** %4, align 8
  ...
  %9 = bitcast %"struct.std::_Vector_base<Data, std::allocator<Data> >::_Vector_impl"* %8 to %"class.std::allocator.5"*
  %10 = bitcast %"class.std::vector.3"* %0 to %"struct.std::_Vector_base.4"*
  ...
  invoke void @_ZNSt16allocator_traitsISaI4DataEE7destroyIS0_EEvRS1_PT_(%"class.std::allocator.5"* dereferenceable(1) %9, %struct.Data* %13)
...
define linkonce_odr void @_ZSt10__pop_heapIN9__gnu_cxx17__normal_iteratorIP4DataSt6vectorIS2_SaIS2_EEEENS0_5__ops15_Iter_comp_iterISt4lessIS2_EEEEvT_SD_SD_RT0_(%struct.Data* %0, %struct.Data* %1, %struct.Data* %2, %"struct.__gnu_cxx::__ops::_Iter_comp_iter"* dereferenceable(1) %3) #0 comdat {
  ...
  %34 = bitcast %struct.Data* %10 to { i32, i64 }*
  ...
  call void @_ZSt13__adjust_heapIN9__gnu_cxx17__normal_iteratorIP4DataSt6vectorIS2_SaIS2_EEEElS2_NS0_5__ops15_Iter_comp_iterISt4lessIS2_EEEEvT_T0_SE_T1_T2_(%struct.Data* %33, i64 0, i64 %26, i32 %36, i64 %38)
  ret void
}

; Function Attrs: noinline uwtable
define linkonce_odr void @_ZSt13__adjust_heapIN9__gnu_cxx17__normal_iteratorIP4DataSt6vectorIS2_SaIS2_EEEElS2_NS0_5__ops15_Iter_comp_iterISt4lessIS2_EEEEvT_T0_SE_T1_T2_(%struct.Data* %0, i64 %1, i64 %2, i32 %3, i64 %4) #0 comdat {
  %6 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %7 = alloca %struct.Data, align 8
  ...
  %19 = bitcast %struct.Data* %7 to { i32, i64 }*
...
72:                                               ; preds = %58, %54, %51
  ...
  %81 = bitcast %struct.Data* %17 to { i32, i64 }*
  %82 = getelementptr inbounds { i32, i64 }, { i32, i64 }* %81, i32 0, i32 0
  %83 = load i32, i32* %82, align 8
  %84 = getelementptr inbounds { i32, i64 }, { i32, i64 }* %81, i32 0, i32 1
  %85 = load i64, i64* %84, align 8
  call void @_ZSt11__push_heapIN9__gnu_cxx17__normal_iteratorIP4DataSt6vectorIS2_SaIS2_EEEElS2_NS0_5__ops14_Iter_comp_valISt4lessIS2_EEEEvT_T0_SE_T1_RT2_(%struct.Data* %80, i64 %.1, i64 %1, i32 %83, i64 %85, %"struct.__gnu_cxx::__ops::_Iter_comp_val"* dereferenceable(1) %15)
  ret void
}
...
define linkonce_odr zeroext i1 @_ZN9__gnu_cxx5__ops15_Iter_comp_iterISt4lessI4DataEEclINS_17__normal_iteratorIPS3_St6vectorIS3_SaIS3_EEEESC_EEbT_T0_(%"struct.__gnu_cxx::__ops::_Iter_comp_iter"* %0, %struct.Data* %1, %struct.Data* %2) #0 comdat align 2 {
  ...
  %11 = call zeroext i1 @_ZNKSt4lessI4DataEclERKS0_S3_(%"struct.std::less.8"* %8, %struct.Data* dereferenceable(16) %9, %struct.Data* dereferenceable(16) %10)
  ret i1 %11
}
...
define linkonce_odr void @_ZN9__gnu_cxx5__ops14_Iter_comp_valISt4lessI4DataEEC2EONS0_15_Iter_comp_iterIS4_EE(%"struct.__gnu_cxx::__ops::_Iter_comp_val"* %0, %"struct.__gnu_cxx::__ops::_Iter_comp_iter"* dereferenceable(1) %1) unnamed_addr #4 comdat align 2 {
  ...
  %5 = call dereferenceable(1) %"struct.std::less.8"* @_ZSt4moveIRSt4lessI4DataEEONSt16remove_referenceIT_E4typeEOS5_(%"struct.std::less.8"* dereferenceable(1) %4) #3
  ret void
}

; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt6vectorI4InfoSaIS0_EE12emplace_backIJS0_EEEvDpOT_(%"class.std::vector"* %0, %struct.Info* dereferenceable(16) %1) #0 comdat align 2 {
...
13:                                               ; preds = %2
  ...
  %16 = bitcast %"struct.std::_Vector_base<Info, std::allocator<Info> >::_Vector_impl"* %15 to %"class.std::allocator.0"*
  ...
  %21 = call dereferenceable(16) %struct.Info* @_ZSt7forwardI4InfoEOT_RNSt16remove_referenceIS1_E4typeE(%struct.Info* dereferenceable(16) %1) #3
  call void @_ZNSt16allocator_traitsISaI4InfoEE9constructIS0_JS0_EEEvRS1_PT_DpOT0_(%"class.std::allocator.0"* dereferenceable(1) %16, %struct.Info* %20, %struct.Info* dereferenceable(16) %21)
...
27:                                               ; preds = %2
  ...
  %30 = call dereferenceable(16) %struct.Info* @_ZSt7forwardI4InfoEOT_RNSt16remove_referenceIS1_E4typeE(%struct.Info* dereferenceable(16) %1) #3
  ...
  call void @_ZNSt6vectorI4InfoSaIS0_EE17_M_realloc_insertIJS0_EEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_(%"class.std::vector"* %0, %struct.Info* %32, %struct.Info* dereferenceable(16) %30)
  br label %33
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(16) %struct.Info* @_ZSt4moveIR4InfoEONSt16remove_referenceIT_E4typeEOS3_(%struct.Info* dereferenceable(16) %0) #4 comdat {
  ret %struct.Info* %0
}

; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt16allocator_traitsISaI4InfoEE9constructIS0_JS0_EEEvRS1_PT_DpOT0_(%"class.std::allocator.0"* dereferenceable(1) %0, %struct.Info* %1, %struct.Info* dereferenceable(16) %2) #0 comdat align 2 {
  %4 = bitcast %"class.std::allocator.0"* %0 to %"class.__gnu_cxx::new_allocator.1"*
  %5 = call dereferenceable(16) %struct.Info* @_ZSt7forwardI4InfoEOT_RNSt16remove_referenceIS1_E4typeE(%struct.Info* dereferenceable(16) %2) #3
  call void @_ZN9__gnu_cxx13new_allocatorI4InfoE9constructIS1_JS1_EEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator.1"* %4, %struct.Info* %1, %struct.Info* dereferenceable(16) %5)
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(16) %struct.Info* @_ZSt7forwardI4InfoEOT_RNSt16remove_referenceIS1_E4typeE(%struct.Info* dereferenceable(16) %0) #4 comdat {
  ret %struct.Info* %0
}

; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt6vectorI4InfoSaIS0_EE17_M_realloc_insertIJS0_EEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_(%"class.std::vector"* %0, %struct.Info* %1, %struct.Info* dereferenceable(16) %2) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %7 = call i64 @_ZNKSt6vectorI4InfoSaIS0_EE12_M_check_lenEmPKc(%"class.std::vector"* %0, i64 1, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.11, i32 0, i32 0))
  %8 = bitcast %"class.std::vector"* %0 to %"struct.std::_Vector_base"*
  %9 = getelementptr inbounds %"struct.std::_Vector_base", %"struct.std::_Vector_base"* %8, i32 0, i32 0
  ...
  %18 = call i64 @_ZN9__gnu_cxxmiIP4InfoSt6vectorIS1_SaIS1_EEEENS_17__normal_iteratorIT_T0_E15difference_typeERKS9_SC_(%"class.__gnu_cxx::__normal_iterator.11"* dereferenceable(8) %4, %"class.__gnu_cxx::__normal_iterator.11"* dereferenceable(8) %5) #3
  ...
  %23 = bitcast %"struct.std::_Vector_base<Info, std::allocator<Info> >::_Vector_impl"* %22 to %"class.std::allocator.0"*
  %24 = getelementptr inbounds %struct.Info, %struct.Info* %20, i64 %18
  %25 = call dereferenceable(16) %struct.Info* @_ZSt7forwardI4InfoEOT_RNSt16remove_referenceIS1_E4typeE(%struct.Info* dereferenceable(16) %2) #3
  invoke void @_ZNSt16allocator_traitsISaI4InfoEE9constructIS0_JS0_EEEvRS1_PT_DpOT0_(%"class.std::allocator.0"* dereferenceable(1) %23, %struct.Info* %24, %struct.Info* dereferenceable(16) %25)
          to label %26 unwind label %40

26:                                               ; preds = %3
  %27 = call dereferenceable(8) %struct.Info** @_ZNK9__gnu_cxx17__normal_iteratorIP4InfoSt6vectorIS1_SaIS1_EEE4baseEv(%"class.__gnu_cxx::__normal_iterator.11"* %4) #3
  %28 = load %struct.Info*, %struct.Info** %27, align 8
  %29 = bitcast %"class.std::vector"* %0 to %"struct.std::_Vector_base"*
  %30 = call dereferenceable(1) %"class.std::allocator.0"* @_ZNSt12_Vector_baseI4InfoSaIS0_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %29) #3
  %31 = invoke %struct.Info* @_ZSt34__uninitialized_move_if_noexcept_aIP4InfoS1_SaIS0_EET0_T_S4_S3_RT1_(%struct.Info* %11, %struct.Info* %28, %struct.Info* %20, %"class.std::allocator.0"* dereferenceable(1) %30)
          to label %32 unwind label %40

32:                                               ; preds = %26
  %33 = getelementptr inbounds %struct.Info, %struct.Info* %31, i32 1
  %34 = call dereferenceable(8) %struct.Info** @_ZNK9__gnu_cxx17__normal_iteratorIP4InfoSt6vectorIS1_SaIS1_EEE4baseEv(%"class.__gnu_cxx::__normal_iterator.11"* %4) #3
  %35 = load %struct.Info*, %struct.Info** %34, align 8
  %36 = bitcast %"class.std::vector"* %0 to %"struct.std::_Vector_base"*
  %37 = call dereferenceable(1) %"class.std::allocator.0"* @_ZNSt12_Vector_baseI4InfoSaIS0_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %36) #3
  %38 = invoke %struct.Info* @_ZSt34__uninitialized_move_if_noexcept_aIP4InfoS1_SaIS0_EET0_T_S4_S3_RT1_(%struct.Info* %35, %struct.Info* %15, %struct.Info* %33, %"class.std::allocator.0"* dereferenceable(1) %37)
          to label %39 unwind label %40
...
47:                                               ; preds = %44
  ...
  %50 = bitcast %"struct.std::_Vector_base<Info, std::allocator<Info> >::_Vector_impl"* %49 to %"class.std::allocator.0"*
  %51 = getelementptr inbounds %struct.Info, %struct.Info* %20, i64 %18
  invoke void @_ZNSt16allocator_traitsISaI4InfoEE7destroyIS0_EEvRS1_PT_(%"class.std::allocator.0"* dereferenceable(1) %50, %struct.Info* %51)
          to label %52 unwind label %53
...
57:                                               ; preds = %44
  ...
  %59 = call dereferenceable(1) %"class.std::allocator.0"* @_ZNSt12_Vector_baseI4InfoSaIS0_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %58) #3
  invoke void @_ZSt8_DestroyIP4InfoS0_EvT_S2_RSaIT0_E(%struct.Info* %20, %struct.Info* %.0, %"class.std::allocator.0"* dereferenceable(1) %59)
          to label %60 unwind label %53
...
65:                                               ; preds = %39
  ...
  %67 = call dereferenceable(1) %"class.std::allocator.0"* @_ZNSt12_Vector_baseI4InfoSaIS0_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %66) #3
  call void @_ZSt8_DestroyIP4InfoS0_EvT_S2_RSaIT0_E(%struct.Info* %11, %struct.Info* %15, %"class.std::allocator.0"* dereferenceable(1) %67)
...
define linkonce_odr %struct.Info* @_ZNSt6vectorI4InfoSaIS0_EE3endEv(%"class.std::vector"* %0) #4 comdat align 2 {
  ...
  call void @_ZN9__gnu_cxx17__normal_iteratorIP4InfoSt6vectorIS1_SaIS1_EEEC2ERKS2_(%"class.__gnu_cxx::__normal_iterator.11"* %2, %struct.Info** dereferenceable(8) %5) #3
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorI4InfoE9constructIS1_JS1_EEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator.1"* %0, %struct.Info* %1, %struct.Info* dereferenceable(16) %2) #4 comdat align 2 {
  %4 = bitcast %struct.Info* %1 to i8*
  %5 = bitcast i8* %4 to %struct.Info*
  %6 = call dereferenceable(16) %struct.Info* @_ZSt7forwardI4InfoEOT_RNSt16remove_referenceIS1_E4typeE(%struct.Info* dereferenceable(16) %2) #3
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64 @_ZN9__gnu_cxxmiIP4InfoSt6vectorIS1_SaIS1_EEEENS_17__normal_iteratorIT_T0_E15difference_typeERKS9_SC_(%"class.__gnu_cxx::__normal_iterator.11"* dereferenceable(8) %0, %"class.__gnu_cxx::__normal_iterator.11"* dereferenceable(8) %1) #4 comdat {
  %3 = call dereferenceable(8) %struct.Info** @_ZNK9__gnu_cxx17__normal_iteratorIP4InfoSt6vectorIS1_SaIS1_EEE4baseEv(%"class.__gnu_cxx::__normal_iterator.11"* %0) #3
  %4 = load %struct.Info*, %struct.Info** %3, align 8
  %5 = call dereferenceable(8) %struct.Info** @_ZNK9__gnu_cxx17__normal_iteratorIP4InfoSt6vectorIS1_SaIS1_EEE4baseEv(%"class.__gnu_cxx::__normal_iterator.11"* %1) #3
  %6 = load %struct.Info*, %struct.Info** %5, align 8
...
4:                                                ; preds = %2
  %5 = getelementptr inbounds %"struct.std::_Vector_base", %"struct.std::_Vector_base"* %0, i32 0, i32 0
  %6 = bitcast %"struct.std::_Vector_base<Info, std::allocator<Info> >::_Vector_impl"* %5 to %"class.std::allocator.0"*
  %7 = call %struct.Info* @_ZNSt16allocator_traitsISaI4InfoEE8allocateERS1_m(%"class.std::allocator.0"* dereferenceable(1) %6, i64 %1)
  br label %9
...
; Function Attrs: noinline uwtable
define linkonce_odr %struct.Info* @_ZSt34__uninitialized_move_if_noexcept_aIP4InfoS1_SaIS0_EET0_T_S4_S3_RT1_(%struct.Info* %0, %struct.Info* %1, %struct.Info* %2, %"class.std::allocator.0"* dereferenceable(1) %3) #0 comdat {
  ...
  %15 = call %struct.Info* @_ZSt22__uninitialized_copy_aISt13move_iteratorIP4InfoES2_S1_ET0_T_S5_S4_RSaIT1_E(%struct.Info* %12, %struct.Info* %14, %struct.Info* %2, %"class.std::allocator.0"* dereferenceable(1) %3)
  ret %struct.Info* %15
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(8) %struct.Info** @_ZNK9__gnu_cxx17__normal_iteratorIP4InfoSt6vectorIS1_SaIS1_EEE4baseEv(%"class.__gnu_cxx::__normal_iterator.11"* %0) #4 comdat align 2 {
  %2 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator.11", %"class.__gnu_cxx::__normal_iterator.11"* %0, i32 0, i32 0
  ret %struct.Info** %2
}

; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt16allocator_traitsISaI4InfoEE7destroyIS0_EEvRS1_PT_(%"class.std::allocator.0"* dereferenceable(1) %0, %struct.Info* %1) #0 comdat align 2 {
  %3 = bitcast %"class.std::allocator.0"* %0 to %"class.__gnu_cxx::new_allocator.1"*
  call void @_ZN9__gnu_cxx13new_allocatorI4InfoE7destroyIS1_EEvPT_(%"class.__gnu_cxx::new_allocator.1"* %3, %struct.Info* %1)
  ret void
}
...
define linkonce_odr i64 @_ZNKSt6vectorI4InfoSaIS0_EE8max_sizeEv(%"class.std::vector"* %0) #4 comdat align 2 {
  %2 = bitcast %"class.std::vector"* %0 to %"struct.std::_Vector_base"*
  %3 = call dereferenceable(1) %"class.std::allocator.0"* @_ZNKSt12_Vector_baseI4InfoSaIS0_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %2) #3
  %4 = call i64 @_ZNSt16allocator_traitsISaI4InfoEE8max_sizeERKS1_(%"class.std::allocator.0"* dereferenceable(1) %3) #3
  ret i64 %4
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64 @_ZNSt16allocator_traitsISaI4InfoEE8max_sizeERKS1_(%"class.std::allocator.0"* dereferenceable(1) %0) #4 comdat align 2 {
  %2 = bitcast %"class.std::allocator.0"* %0 to %"class.__gnu_cxx::new_allocator.1"*
  %3 = call i64 @_ZNK9__gnu_cxx13new_allocatorI4InfoE8max_sizeEv(%"class.__gnu_cxx::new_allocator.1"* %2) #3
  ret i64 %3
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(1) %"class.std::allocator.0"* @_ZNKSt12_Vector_baseI4InfoSaIS0_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %0) #4 comdat align 2 {
  %2 = getelementptr inbounds %"struct.std::_Vector_base", %"struct.std::_Vector_base"* %0, i32 0, i32 0
  %3 = bitcast %"struct.std::_Vector_base<Info, std::allocator<Info> >::_Vector_impl"* %2 to %"class.std::allocator.0"*
  ret %"class.std::allocator.0"* %3
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64 @_ZNK9__gnu_cxx13new_allocatorI4InfoE8max_sizeEv(%"class.__gnu_cxx::new_allocator.1"* %0) #4 comdat align 2 {
  ret i64 1152921504606846975
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx17__normal_iteratorIP4InfoSt6vectorIS1_SaIS1_EEEC2ERKS2_(%"class.__gnu_cxx::__normal_iterator.11"* %0, %struct.Info** dereferenceable(8) %1) unnamed_addr #4 comdat align 2 {
...
; Function Attrs: noinline uwtable
define linkonce_odr %struct.Info* @_ZNSt16allocator_traitsISaI4InfoEE8allocateERS1_m(%"class.std::allocator.0"* dereferenceable(1) %0, i64 %1) #0 comdat align 2 {
  %3 = bitcast %"class.std::allocator.0"* %0 to %"class.__gnu_cxx::new_allocator.1"*
  %4 = call %struct.Info* @_ZN9__gnu_cxx13new_allocatorI4InfoE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.1"* %3, i64 %1, i8* null)
  ret %struct.Info* %4
}

; Function Attrs: noinline uwtable
define linkonce_odr %struct.Info* @_ZN9__gnu_cxx13new_allocatorI4InfoE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.1"* %0, i64 %1, i8* %2) #0 comdat align 2 {
  %4 = call i64 @_ZNK9__gnu_cxx13new_allocatorI4InfoE8max_sizeEv(%"class.__gnu_cxx::new_allocator.1"* %0) #3
  %5 = icmp ugt i64 %1, %4
  br i1 %5, label %6, label %7
...
; Function Attrs: noinline uwtable
define linkonce_odr %struct.Info* @_ZSt22__uninitialized_copy_aISt13move_iteratorIP4InfoES2_S1_ET0_T_S5_S4_RSaIT1_E(%struct.Info* %0, %struct.Info* %1, %struct.Info* %2, %"class.std::allocator.0"* dereferenceable(1) %3) #0 comdat {
  %5 = alloca %"class.std::move_iterator.12", align 8
  %6 = alloca %"class.std::move_iterator.12", align 8
...
define linkonce_odr %struct.Info* @_ZSt32__make_move_if_noexcept_iteratorI4InfoSt13move_iteratorIPS0_EET0_PT_(%struct.Info* %0) #0 comdat {
  ...
  call void @_ZNSt13move_iteratorIP4InfoEC2ES1_(%"class.std::move_iterator.12"* %2, %struct.Info* %0)
...
8:                                                ; preds = %18, %3
  ...
  %9 = invoke zeroext i1 @_ZStneIP4InfoEbRKSt13move_iteratorIT_ES6_(%"class.std::move_iterator.12"* dereferenceable(8) %4, %"class.std::move_iterator.12"* dereferenceable(8) %5)
          to label %10 unwind label %20
...
11:                                               ; preds = %10
  %12 = call %struct.Info* @_ZSt11__addressofI4InfoEPT_RS1_(%struct.Info* dereferenceable(16) %.0) #3
  %13 = invoke dereferenceable(16) %struct.Info* @_ZNKSt13move_iteratorIP4InfoEdeEv(%"class.std::move_iterator.12"* %4)
          to label %14 unwind label %20

14:                                               ; preds = %11
  invoke void @_ZSt10_ConstructI4InfoJS0_EEvPT_DpOT0_(%struct.Info* %12, %struct.Info* dereferenceable(16) %13)
          to label %15 unwind label %20
...
16:                                               ; preds = %15
  %17 = invoke dereferenceable(8) %"class.std::move_iterator.12"* @_ZNSt13move_iteratorIP4InfoEppEv(%"class.std::move_iterator.12"* %4)
          to label %18 unwind label %20
...
; Function Attrs: noinline uwtable
define linkonce_odr zeroext i1 @_ZStneIP4InfoEbRKSt13move_iteratorIT_ES6_(%"class.std::move_iterator.12"* dereferenceable(8) %0, %"class.std::move_iterator.12"* dereferenceable(8) %1) #0 comdat {
  %3 = call zeroext i1 @_ZSteqIP4InfoEbRKSt13move_iteratorIT_ES6_(%"class.std::move_iterator.12"* dereferenceable(8) %0, %"class.std::move_iterator.12"* dereferenceable(8) %1)
  %4 = xor i1 %3, true
  ret i1 %4
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZSt10_ConstructI4InfoJS0_EEvPT_DpOT0_(%struct.Info* %0, %struct.Info* dereferenceable(16) %1) #4 comdat {
  %3 = bitcast %struct.Info* %0 to i8*
  %4 = bitcast i8* %3 to %struct.Info*
  %5 = call dereferenceable(16) %struct.Info* @_ZSt7forwardI4InfoEOT_RNSt16remove_referenceIS1_E4typeE(%struct.Info* dereferenceable(16) %1) #3
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr %struct.Info* @_ZSt11__addressofI4InfoEPT_RS1_(%struct.Info* dereferenceable(16) %0) #4 comdat {
  ret %struct.Info* %0
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(16) %struct.Info* @_ZNKSt13move_iteratorIP4InfoEdeEv(%"class.std::move_iterator.12"* %0) #4 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(8) %"class.std::move_iterator.12"* @_ZNSt13move_iteratorIP4InfoEppEv(%"class.std::move_iterator.12"* %0) #4 comdat align 2 {
  %2 = getelementptr inbounds %"class.std::move_iterator.12", %"class.std::move_iterator.12"* %0, i32 0, i32 0
  %3 = load %struct.Info*, %struct.Info** %2, align 8
...
; Function Attrs: noinline uwtable
define linkonce_odr zeroext i1 @_ZSteqIP4InfoEbRKSt13move_iteratorIT_ES6_(%"class.std::move_iterator.12"* dereferenceable(8) %0, %"class.std::move_iterator.12"* dereferenceable(8) %1) #0 comdat {
  %3 = call %struct.Info* @_ZNKSt13move_iteratorIP4InfoE4baseEv(%"class.std::move_iterator.12"* %0)
  %4 = call %struct.Info* @_ZNKSt13move_iteratorIP4InfoE4baseEv(%"class.std::move_iterator.12"* %1)
  %5 = icmp eq %struct.Info* %3, %4
  ret i1 %5
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr %struct.Info* @_ZNKSt13move_iteratorIP4InfoE4baseEv(%"class.std::move_iterator.12"* %0) #4 comdat align 2 {
  %2 = getelementptr inbounds %"class.std::move_iterator.12", %"class.std::move_iterator.12"* %0, i32 0, i32 0
  %3 = load %struct.Info*, %struct.Info** %2, align 8
  ret %struct.Info* %3
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt13move_iteratorIP4InfoEC2ES1_(%"class.std::move_iterator.12"* %0, %struct.Info* %1) unnamed_addr #4 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorI4InfoE7destroyIS1_EEvPT_(%"class.__gnu_cxx::new_allocator.1"* %0, %struct.Info* %1) #4 comdat align 2 {
  ret void
}

; Function Attrs: noinline uwtable
define linkonce_odr %"struct.std::_Rb_tree_node_base"* @_ZNSt8_Rb_treeIxSt4pairIKxiESt10_Select1stIS2_ESt4lessIxESaIS2_EE4findERS1_(%"class.std::_Rb_tree"* %0, i64* dereferenceable(8) %1) #0 comdat align 2 {
  %3 = alloca %"struct.std::_Rb_tree_iterator", align 8
  %4 = alloca %"struct.std::_Rb_tree_iterator", align 8
  %5 = alloca %"struct.std::_Rb_tree_iterator", align 8
  %6 = call %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIxSt4pairIKxiESt10_Select1stIS2_ESt4lessIxESaIS2_EE8_M_beginEv(%"class.std::_Rb_tree"* %0) #3
  %7 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt8_Rb_treeIxSt4pairIKxiESt10_Select1stIS2_ESt4lessIxESaIS2_EE6_M_endEv(%"class.std::_Rb_tree"* %0) #3
  %8 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt8_Rb_treeIxSt4pairIKxiESt10_Select1stIS2_ESt4lessIxESaIS2_EE14_M_lower_boundEPSt13_Rb_tree_nodeIS2_EPSt18_Rb_tree_node_baseRS1_(%"class.std::_Rb_tree"* %0, %"struct.std::_Rb_tree_node"* %6, %"struct.std::_Rb_tree_node_base"* %7, i64* dereferenceable(8) %1)
  %9 = getelementptr inbounds %"struct.std::_Rb_tree_iterator", %"struct.std::_Rb_tree_iterator"* %4, i32 0, i32 0
  store %"struct.std::_Rb_tree_node_base"* %8, %"struct.std::_Rb_tree_node_base"** %9, align 8
  %10 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt8_Rb_treeIxSt4pairIKxiESt10_Select1stIS2_ESt4lessIxESaIS2_EE3endEv(%"class.std::_Rb_tree"* %0) #3
  %11 = getelementptr inbounds %"struct.std::_Rb_tree_iterator", %"struct.std::_Rb_tree_iterator"* %5, i32 0, i32 0
  store %"struct.std::_Rb_tree_node_base"* %10, %"struct.std::_Rb_tree_node_base"** %11, align 8
  %12 = call zeroext i1 @_ZNKSt17_Rb_tree_iteratorISt4pairIKxiEEeqERKS3_(%"struct.std::_Rb_tree_iterator"* %4, %"struct.std::_Rb_tree_iterator"* dereferenceable(8) %5) #3
...
21:                                               ; preds = %13, %2
  %22 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt8_Rb_treeIxSt4pairIKxiESt10_Select1stIS2_ESt4lessIxESaIS2_EE3endEv(%"class.std::_Rb_tree"* %0) #3
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(8) i64* @_ZNKSt10_Select1stISt4pairIKxiEEclERKS2_(%"struct.std::_Select1st"* %0, %"struct.std::pair"* dereferenceable(16) %1) #4 comdat align 2 {
  %3 = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* %1, i32 0, i32 0
  ret i64* %3
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr %"struct.std::pair"* @_ZNKSt13_Rb_tree_nodeISt4pairIKxiEE9_M_valptrEv(%"struct.std::_Rb_tree_node"* %0) #4 comdat align 2 {
  %2 = getelementptr inbounds %"struct.std::_Rb_tree_node", %"struct.std::_Rb_tree_node"* %0, i32 0, i32 1
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr %"struct.std::pair"* @_ZNK9__gnu_cxx16__aligned_membufISt4pairIKxiEE6_M_ptrEv(%"struct.__gnu_cxx::__aligned_membuf"* %0) #4 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(16) %"struct.std::pair"* @_ZNKSt17_Rb_tree_iteratorISt4pairIKxiEEdeEv(%"struct.std::_Rb_tree_iterator"* %0) #4 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
...
10:                                               ; preds = %5
  ...
  %12 = call dereferenceable(8) %"class.std::tuple"* @_ZSt7forwardISt5tupleIJRKxEEEOT_RNSt16remove_referenceIS4_E4typeE(%"class.std::tuple"* dereferenceable(8) %3) #3
  %13 = call dereferenceable(1) %"class.std::tuple.13"* @_ZSt7forwardISt5tupleIJEEEOT_RNSt16remove_referenceIS2_E4typeE(%"class.std::tuple.13"* dereferenceable(1) %4) #3
  invoke void @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKxiEEEE9constructIS3_JRKSt21piecewise_construct_tSt5tupleIJRS2_EESB_IJEEEEEvRS5_PT_DpOT0_(%"class.std::allocator"* dereferenceable(1) %8, %"struct.std::pair"* %9, %"struct.std::piecewise_construct_t"* dereferenceable(1) %11, %"class.std::tuple"* dereferenceable(8) %12, %"class.std::tuple.13"* dereferenceable(1) %13)
          to label %14 unwind label %15
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKxiEEEE9constructIS3_JRKSt21piecewise_construct_tSt5tupleIJRS2_EESB_IJEEEEEvRS5_PT_DpOT0_(%"class.std::allocator"* dereferenceable(1) %0, %"struct.std::pair"* %1, %"struct.std::piecewise_construct_t"* dereferenceable(1) %2, %"class.std::tuple"* dereferenceable(8) %3, %"class.std::tuple.13"* dereferenceable(1) %4) #0 comdat align 2 {
  ...
  call void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKxiEEE9constructIS4_JRKSt21piecewise_construct_tSt5tupleIJRS3_EESB_IJEEEEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator"* %6, %"struct.std::pair"* %1, %"struct.std::piecewise_construct_t"* dereferenceable(1) %7, %"class.std::tuple"* dereferenceable(8) %8, %"class.std::tuple.13"* dereferenceable(1) %9)
  ret void
}

; Function Attrs: noinline uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKxiEEE9constructIS4_JRKSt21piecewise_construct_tSt5tupleIJRS3_EESB_IJEEEEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator"* %0, %"struct.std::pair"* %1, %"struct.std::piecewise_construct_t"* dereferenceable(1) %2, %"class.std::tuple"* dereferenceable(8) %3, %"class.std::tuple.13"* dereferenceable(1) %4) #0 comdat align 2 {
...
define linkonce_odr void @_ZNSt4pairIKxiEC2IJRS0_EJEEESt21piecewise_construct_tSt5tupleIJDpT_EES5_IJDpT0_EE(%"struct.std::pair"* %0, %"class.std::tuple"* %1) unnamed_addr #0 comdat align 2 {
  ...
  call void @_ZNSt4pairIKxiEC2IJRS0_EJLm0EEJEJEEERSt5tupleIJDpT_EERS4_IJDpT1_EESt12_Index_tupleIJXspT0_EEESD_IJXspT2_EEE(%"struct.std::pair"* %0, %"class.std::tuple"* dereferenceable(8) %1, %"class.std::tuple.13"* dereferenceable(1) %3)
  ret void
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt4pairIKxiEC2IJRS0_EJLm0EEJEJEEERSt5tupleIJDpT_EERS4_IJDpT1_EESt12_Index_tupleIJXspT0_EEESD_IJXspT2_EEE(%"struct.std::pair"* %0, %"class.std::tuple"* dereferenceable(8) %1, %"class.std::tuple.13"* dereferenceable(1) %2) unnamed_addr #4 comdat align 2 {
...
42:                                               ; preds = %38
  call void @_ZNSt4pairIPSt18_Rb_tree_node_baseS1_EC2IRPSt13_Rb_tree_nodeIS_IKxiEERS1_Lb1EEEOT_OT0_(%"struct.std::pair.14"* %3, %"struct.std::_Rb_tree_node"** dereferenceable(8) %4, %"struct.std::_Rb_tree_node_base"** dereferenceable(8) %5)
  br label %57
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt4pairIPSt18_Rb_tree_node_baseS1_EC2IRPSt13_Rb_tree_nodeIS_IKxiEERS1_Lb1EEEOT_OT0_(%"struct.std::pair.14"* %0, %"struct.std::_Rb_tree_node"** dereferenceable(8) %1, %"struct.std::_Rb_tree_node_base"** dereferenceable(8) %2) unnamed_addr #4 comdat align 2 {
  %4 = bitcast %"struct.std::pair.14"* %0 to %"class.std::__pair_base.15"*
  %5 = getelementptr inbounds %"struct.std::pair.14", %"struct.std::pair.14"* %0, i32 0, i32 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s785553305.cpp() #0 section ".text.startup" {
