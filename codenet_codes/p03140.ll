; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03140/s248312134.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03140/s248312134.cpp"
...
$_Z2inIRNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEJS6_S6_EEvOT_DpOT0_ = comdat any

$_Z3outIxEbT_ = comdat any
...
$_Z2inINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEJS5_EEvOT_DpOT0_ = comdat any

$_ZSt4moveIRNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEONSt16remove_referenceIT_E4typeEOS8_ = comdat any

$_Z2inINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEJEEvOT_DpOT0_ = comdat any

@_ZStL8__ioinit = internal global %"class.std::ios_base::Init" zeroinitializer, align 1
@__dso_handle = external hidden global i8
@_ZL4four = internal global %"class.std::vector" zeroinitializer, align 8
@.ref.tmp = private constant [4 x %"struct.std::pair"] [%"struct.std::pair" { i32 -1, i32 0 }, %"struct.std::pair" { i32 0, i32 1 }, %"struct.std::pair" { i32 1, i32 0 }, %"struct.std::pair" { i32 0, i32 -1 }], align 4
@_ZSt3cin = external global %"class.std::basic_istream", align 8
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@llvm.global_ctors = appending global [2 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_Z8SETTINGSv, i8* null }, { i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s248312134.cpp, i8* null }]
...
define internal void @__cxx_global_var_init.1() #0 section ".text.startup" personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  store %"struct.std::pair"* getelementptr inbounds ([4 x %"struct.std::pair"], [4 x %"struct.std::pair"]* @.ref.tmp, i64 0, i64 0), %"struct.std::pair"** %3, align 8
  ...
  %5 = bitcast %"class.std::initializer_list"* %1 to { %"struct.std::pair"*, i64 }*
  %6 = getelementptr inbounds { %"struct.std::pair"*, i64 }, { %"struct.std::pair"*, i64 }* %5, i32 0, i32 0
  %7 = load %"struct.std::pair"*, %"struct.std::pair"** %6, align 8
  %8 = getelementptr inbounds { %"struct.std::pair"*, i64 }, { %"struct.std::pair"*, i64 }* %5, i32 0, i32 1
  %9 = load i64, i64* %8, align 8
  invoke void @_ZNSt6vectorISt4pairIiiESaIS1_EEC2ESt16initializer_listIS1_ERKS2_(%"class.std::vector"* @_ZL4four, %"struct.std::pair"* %7, i64 %9, %"class.std::allocator"* dereferenceable(1) %2)
          to label %10 unwind label %12

10:                                               ; preds = %0
  call void @_ZNSaISt4pairIiiEED2Ev(%"class.std::allocator"* %2) #3
  %11 = call i32 @__cxa_atexit(void (i8*)* bitcast (void (%"class.std::vector"*)* @_ZNSt6vectorISt4pairIiiESaIS1_EED2Ev to void (i8*)*), i8* bitcast (%"class.std::vector"* @_ZL4four to i8*), i8* @__dso_handle) #3
  ret void
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt6vectorISt4pairIiiESaIS1_EEC2ESt16initializer_listIS1_ERKS2_(%"class.std::vector"* %0, %"struct.std::pair"* %1, i64 %2, %"class.std::allocator"* dereferenceable(1) %3) unnamed_addr #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %5 = alloca %"class.std::initializer_list", align 8
  %6 = bitcast %"class.std::initializer_list"* %5 to { %"struct.std::pair"*, i64 }*
  ...
  call void @_ZNSt12_Vector_baseISt4pairIiiESaIS1_EEC2ERKS2_(%"struct.std::_Vector_base"* %9, %"class.std::allocator"* dereferenceable(1) %3) #3
  %10 = call %"struct.std::pair"* @_ZNKSt16initializer_listISt4pairIiiEE5beginEv(%"class.std::initializer_list"* %5) #3
  %11 = call %"struct.std::pair"* @_ZNKSt16initializer_listISt4pairIiiEE3endEv(%"class.std::initializer_list"* %5) #3
  invoke void @_ZNSt6vectorISt4pairIiiESaIS1_EE19_M_range_initializeIPKS1_EEvT_S7_St20forward_iterator_tag(%"class.std::vector"* %0, %"struct.std::pair"* %10, %"struct.std::pair"* %11)
...
define i32 @main() #5 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  call void @_Z2inIRxJEEvOT_DpOT0_(i64* dereferenceable(8) %1)
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1Ev(%"class.std::__cxx11::basic_string"* %2) #3
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1Ev(%"class.std::__cxx11::basic_string"* %3) #3
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1Ev(%"class.std::__cxx11::basic_string"* %4) #3
  invoke void @_Z2inIRNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEJS6_S6_EEvOT_DpOT0_(%"class.std::__cxx11::basic_string"* dereferenceable(32) %2, %"class.std::__cxx11::basic_string"* dereferenceable(32) %3, %"class.std::__cxx11::basic_string"* dereferenceable(32) %4)
...
30:                                               ; preds = %72, %56, %54, %46, %44, %36, %34, %21, %19, %11, %9, %0
...
36:                                               ; preds = %34
  ...
  %39 = invoke dereferenceable(1) i8* @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEixEm(%"class.std::__cxx11::basic_string"* %3, i64 %.0)
...
44:                                               ; preds = %40
  %45 = invoke dereferenceable(1) i8* @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEixEm(%"class.std::__cxx11::basic_string"* %3, i64 %.0)
          to label %46 unwind label %30

46:                                               ; preds = %44
  %47 = load i8, i8* %45, align 1
  %48 = sext i8 %47 to i32
  %49 = invoke dereferenceable(1) i8* @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEixEm(%"class.std::__cxx11::basic_string"* %4, i64 %.0)
...
68:                                               ; preds = %66, %64
  %.1 = phi i64 [ %65, %64 ], [ %67, %66 ]
  br label %69

69:                                               ; preds = %68, %29
  %.2 = phi i64 [ %.01, %29 ], [ %.1, %68 ]
  br label %70
...
72:                                               ; preds = %6
  %73 = invoke zeroext i1 @_Z3outIxEbT_(i64 %.01)
...
75:                                               ; preds = %30
  %76 = insertvalue { i8*, i32 } undef, i8* %32, 0
  %77 = insertvalue { i8*, i32 } %76, i32 %33, 1
  resume { i8*, i32 } %77
}

; Function Attrs: noinline uwtable
define linkonce_odr void @_Z2inIRxJEEvOT_DpOT0_(i64* dereferenceable(8) %0) #0 comdat {
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_Z2inIRNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEJS6_S6_EEvOT_DpOT0_(%"class.std::__cxx11::basic_string"* dereferenceable(32) %0, %"class.std::__cxx11::basic_string"* dereferenceable(32) %1, %"class.std::__cxx11::basic_string"* dereferenceable(32) %2) #0 comdat {
  ...
  %5 = call dereferenceable(32) %"class.std::__cxx11::basic_string"* @_ZSt4moveIRNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEONSt16remove_referenceIT_E4typeEOS8_(%"class.std::__cxx11::basic_string"* dereferenceable(32) %1) #3
  %6 = call dereferenceable(32) %"class.std::__cxx11::basic_string"* @_ZSt4moveIRNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEONSt16remove_referenceIT_E4typeEOS8_(%"class.std::__cxx11::basic_string"* dereferenceable(32) %2) #3
  call void @_Z2inINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEJS5_EEvOT_DpOT0_(%"class.std::__cxx11::basic_string"* dereferenceable(32) %5, %"class.std::__cxx11::basic_string"* dereferenceable(32) %6)
  ret void
}
...
; Function Attrs: noinline uwtable
define linkonce_odr zeroext i1 @_Z3outIxEbT_(i64 %0) #0 comdat {
  %2 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEx(%"class.std::basic_ostream"* @_ZSt4cout, i64 %0)
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt12_Vector_baseISt4pairIiiESaIS1_EEC2ERKS2_(%"struct.std::_Vector_base"* %0, %"class.std::allocator"* dereferenceable(1) %1) unnamed_addr #4 comdat align 2 {
  %3 = getelementptr inbounds %"struct.std::_Vector_base", %"struct.std::_Vector_base"* %0, i32 0, i32 0
  call void @_ZNSt12_Vector_baseISt4pairIiiESaIS1_EE12_Vector_implC2ERKS2_(%"struct.std::_Vector_base<std::pair<int, int>, std::allocator<std::pair<int, int> > >::_Vector_impl"* %3, %"class.std::allocator"* dereferenceable(1) %1) #3
  ret void
}

; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt6vectorISt4pairIiiESaIS1_EE19_M_range_initializeIPKS1_EEvT_S7_St20forward_iterator_tag(%"class.std::vector"* %0, %"struct.std::pair"* %1, %"struct.std::pair"* %2) #0 comdat align 2 {
  %4 = call i64 @_ZSt8distanceIPKSt4pairIiiEENSt15iterator_traitsIT_E15difference_typeES5_S5_(%"struct.std::pair"* %1, %"struct.std::pair"* %2)
  %5 = bitcast %"class.std::vector"* %0 to %"struct.std::_Vector_base"*
  %6 = call %"struct.std::pair"* @_ZNSt12_Vector_baseISt4pairIiiESaIS1_EE11_M_allocateEm(%"struct.std::_Vector_base"* %5, i64 %4)
  ...
  store %"struct.std::pair"* %6, %"struct.std::pair"** %9, align 8
  %10 = bitcast %"class.std::vector"* %0 to %"struct.std::_Vector_base"*
  ...
  %14 = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* %13, i64 %4
  ...
  %23 = call dereferenceable(1) %"class.std::allocator"* @_ZNSt12_Vector_baseISt4pairIiiESaIS1_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %22) #3
  %24 = call %"struct.std::pair"* @_ZSt22__uninitialized_copy_aIPKSt4pairIiiEPS1_S1_ET0_T_S6_S5_RSaIT1_E(%"struct.std::pair"* %1, %"struct.std::pair"* %2, %"struct.std::pair"* %21, %"class.std::allocator"* dereferenceable(1) %23)
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr %"struct.std::pair"* @_ZNKSt16initializer_listISt4pairIiiEE5beginEv(%"class.std::initializer_list"* %0) #4 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr %"struct.std::pair"* @_ZNKSt16initializer_listISt4pairIiiEE3endEv(%"class.std::initializer_list"* %0) #4 comdat align 2 {
  %2 = call %"struct.std::pair"* @_ZNKSt16initializer_listISt4pairIiiEE5beginEv(%"class.std::initializer_list"* %0) #3
  %3 = call i64 @_ZNKSt16initializer_listISt4pairIiiEE4sizeEv(%"class.std::initializer_list"* %0) #3
...
; Function Attrs: noinline uwtable
define linkonce_odr i64 @_ZSt8distanceIPKSt4pairIiiEENSt15iterator_traitsIT_E15difference_typeES5_S5_(%"struct.std::pair"* %0, %"struct.std::pair"* %1) #0 comdat {
  ...
  %5 = call i64 @_ZSt10__distanceIPKSt4pairIiiEENSt15iterator_traitsIT_E15difference_typeES5_S5_St26random_access_iterator_tag(%"struct.std::pair"* %4, %"struct.std::pair"* %1)
  ret i64 %5
}
...
; Function Attrs: noinline uwtable
define linkonce_odr %"struct.std::pair"* @_ZSt22__uninitialized_copy_aIPKSt4pairIiiEPS1_S1_ET0_T_S6_S5_RSaIT1_E(%"struct.std::pair"* %0, %"struct.std::pair"* %1, %"struct.std::pair"* %2, %"class.std::allocator"* dereferenceable(1) %3) #0 comdat {
  %5 = call %"struct.std::pair"* @_ZSt18uninitialized_copyIPKSt4pairIiiEPS1_ET0_T_S6_S5_(%"struct.std::pair"* %0, %"struct.std::pair"* %1, %"struct.std::pair"* %2)
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64 @_ZSt10__distanceIPKSt4pairIiiEENSt15iterator_traitsIT_E15difference_typeES5_S5_St26random_access_iterator_tag(%"struct.std::pair"* %0, %"struct.std::pair"* %1) #4 comdat {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZSt19__iterator_categoryIPKSt4pairIiiEENSt15iterator_traitsIT_E17iterator_categoryERKS5_(%"struct.std::pair"** dereferenceable(8) %0) #4 comdat {
  ret void
}
...
; Function Attrs: noinline uwtable
define linkonce_odr %"struct.std::pair"* @_ZSt18uninitialized_copyIPKSt4pairIiiEPS1_ET0_T_S6_S5_(%"struct.std::pair"* %0, %"struct.std::pair"* %1, %"struct.std::pair"* %2) #0 comdat {
  %4 = call %"struct.std::pair"* @_ZNSt20__uninitialized_copyILb0EE13__uninit_copyIPKSt4pairIiiEPS3_EET0_T_S8_S7_(%"struct.std::pair"* %0, %"struct.std::pair"* %1, %"struct.std::pair"* %2)
  ret %"struct.std::pair"* %4
}

; Function Attrs: noinline uwtable
define linkonce_odr %"struct.std::pair"* @_ZNSt20__uninitialized_copyILb0EE13__uninit_copyIPKSt4pairIiiEPS3_EET0_T_S8_S7_(%"struct.std::pair"* %0, %"struct.std::pair"* %1, %"struct.std::pair"* %2) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  br label %4
...
6:                                                ; preds = %4
  ...
  invoke void @_ZSt10_ConstructISt4pairIiiEJRKS1_EEvPT_DpOT0_(%"struct.std::pair"* %7, %"struct.std::pair"* dereferenceable(8) %.0)
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64 @_ZNKSt16initializer_listISt4pairIiiEE4sizeEv(%"class.std::initializer_list"* %0) #4 comdat align 2 {
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_Z2inINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEJS5_EEvOT_DpOT0_(%"class.std::__cxx11::basic_string"* dereferenceable(32) %0, %"class.std::__cxx11::basic_string"* dereferenceable(32) %1) #0 comdat {
  %3 = call dereferenceable(280) %"class.std::basic_istream"* @_ZStrsIcSt11char_traitsIcESaIcEERSt13basic_istreamIT_T0_ES7_RNSt7__cxx1112basic_stringIS4_S5_T1_EE(%"class.std::basic_istream"* dereferenceable(280) @_ZSt3cin, %"class.std::__cxx11::basic_string"* dereferenceable(32) %0)
  %4 = call dereferenceable(32) %"class.std::__cxx11::basic_string"* @_ZSt4moveIRNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEONSt16remove_referenceIT_E4typeEOS8_(%"class.std::__cxx11::basic_string"* dereferenceable(32) %1) #3
  call void @_Z2inINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEJEEvOT_DpOT0_(%"class.std::__cxx11::basic_string"* dereferenceable(32) %4)
  ret void
}
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_Z2inINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEJEEvOT_DpOT0_(%"class.std::__cxx11::basic_string"* dereferenceable(32) %0) #0 comdat {
  %2 = call dereferenceable(280) %"class.std::basic_istream"* @_ZStrsIcSt11char_traitsIcESaIcEERSt13basic_istreamIT_T0_ES7_RNSt7__cxx1112basic_stringIS4_S5_T1_EE(%"class.std::basic_istream"* dereferenceable(280) @_ZSt3cin, %"class.std::__cxx11::basic_string"* dereferenceable(32) %0)
  call void @_Z2inv()
  ret void
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s248312134.cpp() #0 section ".text.startup" {
