; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01715/s941745800.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01715/s941745800.cpp"
...
@f = global [2002 x [2002 x i64]] zeroinitializer, align 16
@dp = global [2002 x i64] zeroinitializer, align 16
@nx = global [2002 x i64] zeroinitializer, align 16
@midx = global [2002 x i32] zeroinitializer, align 16
@_ZSt3cin = external global %"class.std::basic_istream", align 8
@_ZL3INF = internal constant i64 3074457345618258602, align 8
@.str = private unnamed_addr constant [6 x i8] c"%lld\0A\00", align 1
@.str.1 = private unnamed_addr constant [26 x i8] c"vector::_M_realloc_insert\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s941745800.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define void @_Z6minimaiiii(i32 %0, i32 %1, i32 %2, i32 %3) #0 {
  %5 = icmp sgt i32 %0, %1
...
9:                                                ; preds = %7
  ...
  %11 = getelementptr inbounds [2002 x i64], [2002 x i64]* @dp, i64 0, i64 %10
  %12 = load i64, i64* %11, align 8
  %13 = add nsw i32 %2, 1
  %14 = sext i32 %13 to i64
  %15 = getelementptr inbounds [2002 x [2002 x i64]], [2002 x [2002 x i64]]* @f, i64 0, i64 %14
  %16 = sext i32 %0 to i64
  %17 = getelementptr inbounds [2002 x i64], [2002 x i64]* %15, i64 0, i64 %16
...
21:                                               ; preds = %37, %9
  %.02 = phi i32 [ %2, %9 ], [ %.13, %37 ]
  %.01 = phi i64 [ %19, %9 ], [ %.1, %37 ]
  %.0 = phi i32 [ %20, %9 ], [ %38, %37 ]
  %22 = icmp sle i32 %.0, %3
  br i1 %22, label %23, label %39

23:                                               ; preds = %21
  %24 = sext i32 %.0 to i64
  %25 = getelementptr inbounds [2002 x i64], [2002 x i64]* @dp, i64 0, i64 %24
  %26 = load i64, i64* %25, align 8
  %27 = add nsw i32 %.0, 1
  %28 = sext i32 %27 to i64
  %29 = getelementptr inbounds [2002 x [2002 x i64]], [2002 x [2002 x i64]]* @f, i64 0, i64 %28
  %30 = sext i32 %0 to i64
  %31 = getelementptr inbounds [2002 x i64], [2002 x i64]* %29, i64 0, i64 %30
  %32 = load i64, i64* %31, align 8
  %33 = add nsw i64 %26, %32
  %34 = icmp slt i64 %33, %.01
...
36:                                               ; preds = %35, %23
  %.13 = phi i32 [ %.0, %35 ], [ %.02, %23 ]
  %.1 = phi i64 [ %33, %35 ], [ %.01, %23 ]
  br label %37
...
39:                                               ; preds = %21
  ...
  %41 = getelementptr inbounds [2002 x i64], [2002 x i64]* @nx, i64 0, i64 %40
  store i64 %.01, i64* %41, align 8
  %42 = sext i32 %0 to i64
  %43 = getelementptr inbounds [2002 x i32], [2002 x i32]* @midx, i64 0, i64 %42
  store i32 %.02, i32* %43, align 4
  br label %55

44:                                               ; preds = %7
  %45 = add nsw i32 %0, %1
  %46 = sdiv i32 %45, 2
  call void @_Z6minimaiiii(i32 %46, i32 %46, i32 %2, i32 %3)
  %47 = sub nsw i32 %46, 1
  %48 = sext i32 %46 to i64
  %49 = getelementptr inbounds [2002 x i32], [2002 x i32]* @midx, i64 0, i64 %48
  %50 = load i32, i32* %49, align 4
  call void @_Z6minimaiiii(i32 %0, i32 %47, i32 %2, i32 %50)
  %51 = add nsw i32 %46, 1
  %52 = sext i32 %46 to i64
  %53 = getelementptr inbounds [2002 x i32], [2002 x i32]* @midx, i64 0, i64 %52
  %54 = load i32, i32* %53, align 4
  call void @_Z6minimaiiii(i32 %51, i32 %1, i32 %54, i32 %3)
  br label %55
...
56:                                               ; preds = %124, %109, %103, %98, %70, %61, %60, %44, %42, %40
...
70:                                               ; preds = %61
  ...
  invoke void @_ZSt4fillIPxxEvT_S1_RKT0_(i64* getelementptr inbounds ([2002 x [2002 x i64]], [2002 x [2002 x i64]]* @f, i64 0, i64 0, i32 0), i64* getelementptr inbounds ([2002 x [2002 x i64]], [2002 x [2002 x i64]]* @f, i64 1, i64 0, i32 0), i64* dereferenceable(8) @_ZL3INF)
...
80:                                               ; preds = %93, %76
  %.09 = phi i32 [ %.06, %76 ], [ %94, %93 ]
  %.08 = phi i64 [ 0, %76 ], [ %88, %93 ]
  %81 = icmp sge i32 %.09, 0
  br i1 %81, label %82, label %95

82:                                               ; preds = %80
  %83 = sext i32 %.09 to i64
  %84 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %6, i64 %83) #3
  %85 = load i32, i32* %84, align 4
  %86 = sub nsw i32 %79, %85
  %87 = sext i32 %86 to i64
  %88 = add nsw i64 %.08, %87
  %89 = sext i32 %.09 to i64
  %90 = getelementptr inbounds [2002 x [2002 x i64]], [2002 x [2002 x i64]]* @f, i64 0, i64 %89
  %91 = sext i32 %.06 to i64
  %92 = getelementptr inbounds [2002 x i64], [2002 x i64]* %90, i64 0, i64 %91
...
98:                                               ; preds = %74
  invoke void @_ZSt4fillIPxxEvT_S1_RKT0_(i64* getelementptr inbounds ([2002 x i64], [2002 x i64]* @dp, i32 0, i32 0), i64* getelementptr inbounds ([2002 x i64], [2002 x i64]* @dp, i64 1, i64 0), i64* dereferenceable(8) @_ZL3INF)
          to label %99 unwind label %56

99:                                               ; preds = %98
  store i64 0, i64* getelementptr inbounds ([2002 x i64], [2002 x i64]* @dp, i64 0, i64 0), align 16
  br label %100

100:                                              ; preds = %122, %99
  %.07 = phi i32 [ 0, %99 ], [ %123, %122 ]
  %101 = load i32, i32* %3, align 4
  %102 = icmp slt i32 %.07, %101
  br i1 %102, label %103, label %124

103:                                              ; preds = %100
  %104 = sub nsw i32 %72, 1
  %105 = sub nsw i32 %72, 1
  invoke void @_Z6minimaiiii(i32 0, i32 %104, i32 0, i32 %105)
...
107:                                              ; preds = %119, %106
  %.05 = phi i32 [ 0, %106 ], [ %120, %119 ]
  %108 = icmp slt i32 %.05, 2002
  br i1 %108, label %109, label %121

109:                                              ; preds = %107
  %110 = sext i32 %.05 to i64
  %111 = getelementptr inbounds [2002 x i64], [2002 x i64]* @dp, i64 0, i64 %110
  %112 = sext i32 %.05 to i64
  %113 = getelementptr inbounds [2002 x i64], [2002 x i64]* @nx, i64 0, i64 %112
...
115:                                              ; preds = %109
  ...
  %118 = getelementptr inbounds [2002 x i64], [2002 x i64]* @dp, i64 0, i64 %117
...
124:                                              ; preds = %100
  %125 = sub nsw i32 %72, 1
  %126 = sext i32 %125 to i64
  %127 = getelementptr inbounds [2002 x i64], [2002 x i64]* @dp, i64 0, i64 %126
  %128 = load i64, i64* %127, align 8
  %129 = invoke i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i32 0, i32 0), i64 %128)
...
131:                                              ; preds = %56, %32
  %.01 = phi i32 [ %35, %32 ], [ %59, %56 ]
  %.0 = phi i8* [ %34, %32 ], [ %58, %56 ]
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %4) #3
  br label %132

132:                                              ; preds = %131, %28
  %.12 = phi i32 [ %.01, %131 ], [ %31, %28 ]
  %.1 = phi i8* [ %.0, %131 ], [ %30, %28 ]
  %133 = insertvalue { i8*, i32 } undef, i8* %.1, 0
  %134 = insertvalue { i8*, i32 } %133, i32 %.12, 1
  resume { i8*, i32 } %134
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s941745800.cpp() #0 section ".text.startup" {
