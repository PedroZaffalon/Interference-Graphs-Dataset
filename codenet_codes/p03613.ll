; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03613/s639107769.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03613/s639107769.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s639107769.cpp, i8* null }]
...
30:                                               ; preds = %12
  ...
  invoke void @_ZNSt6vectorIiSaIiEEC2EmRKiRKS0_(%"class.std::vector"* %4, i64 100010, i32* dereferenceable(4) %5, %"class.std::allocator"* dereferenceable(1) %6)
...
66:                                               ; preds = %74, %65
  %.05 = phi i32 [ 0, %65 ], [ %75, %74 ]
  %67 = icmp slt i32 %.05, 100010
  br i1 %67, label %68, label %80

68:                                               ; preds = %66
  %69 = sext i32 %.05 to i64
  %70 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %4, i64 %69) #3
  %71 = invoke dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* dereferenceable(4) %7, i32* dereferenceable(4) %70)
...
86:                                               ; preds = %76, %61, %26
  %.01 = phi i32 [ %29, %26 ], [ %79, %76 ], [ %64, %61 ]
  %.0 = phi i8* [ %28, %26 ], [ %78, %76 ], [ %63, %61 ]
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %2) #3
  br label %87

87:                                               ; preds = %86, %22
  %.12 = phi i32 [ %.01, %86 ], [ %25, %22 ]
  %.1 = phi i8* [ %.0, %86 ], [ %24, %22 ]
  %88 = insertvalue { i8*, i32 } undef, i8* %.1, 0
  %89 = insertvalue { i8*, i32 } %88, i32 %.12, 1
  resume { i8*, i32 } %89
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s639107769.cpp() #0 section ".text.startup" {
