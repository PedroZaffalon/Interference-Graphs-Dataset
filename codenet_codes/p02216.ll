; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02216/s360422852.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02216/s360422852.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s360422852.cpp, i8* null }]
...
define i32 @main() #5 {
  %1 = alloca %class.E, align 1
  call void @_ZN1E5solveERSiRSo(%class.E* %1, %"class.std::basic_istream"* dereferenceable(280) @_ZSt3cin, %"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout)
  ret i32 0
}

; Function Attrs: noinline uwtable
define linkonce_odr void @_ZN1E5solveERSiRSo(%class.E* %0, %"class.std::basic_istream"* dereferenceable(280) %1, %"class.std::basic_ostream"* dereferenceable(272) %2) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %18 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* %1, i32* dereferenceable(4) %4)
...
25:                                               ; preds = %22
  ...
  %28 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERx(%"class.std::basic_istream"* %1, i64* dereferenceable(8) %27)
...
36:                                               ; preds = %99, %97, %94, %92, %73, %65, %63, %60, %58, %25
...
45:                                               ; preds = %53, %44
  %.06 = phi i64 [ 0, %44 ], [ %52, %53 ]
  %.02 = phi i32 [ 0, %44 ], [ %54, %53 ]
...
58:                                               ; preds = %55
  %59 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %2, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i32 0, i32 0))
...
63:                                               ; preds = %55
  %64 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %2, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i32 0, i32 0))
...
70:                                               ; preds = %83, %69
  %.01 = phi i64 [ 0, %69 ], [ %77, %83 ]
  %.0 = phi i32 [ 0, %69 ], [ %84, %83 ]
...
92:                                               ; preds = %89
  %93 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %2, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i32 0, i32 0))
...
97:                                               ; preds = %89, %85
  %98 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %2, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i32 0, i32 0))
...
104:                                              ; preds = %36, %32
  %.04 = phi i32 [ %39, %36 ], [ %35, %32 ]
  %.03 = phi i8* [ %38, %36 ], [ %34, %32 ]
  %105 = insertvalue { i8*, i32 } undef, i8* %.03, 0
  %106 = insertvalue { i8*, i32 } %105, i32 %.04, 1
  resume { i8*, i32 } %106
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s360422852.cpp() #0 section ".text.startup" {
