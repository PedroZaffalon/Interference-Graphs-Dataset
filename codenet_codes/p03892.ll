; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03892/s267873032.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03892/s267873032.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s267873032.cpp, i8* null }]
...
define i32 @main() #4 {
  ...
  %17 = getelementptr inbounds [2 x i64], [2 x i64]* %1, i64 0, i64 1
  %18 = load i64, i64* %17, align 8
  %19 = getelementptr inbounds [2 x i64], [2 x i64]* %1, i64 0, i64 0
  ...
  %26 = getelementptr inbounds [2 x i64], [2 x i64]* %1, i64 0, i64 0
  %27 = load i64, i64* %26, align 16
  %28 = sub nsw i64 %25, %27
  %29 = call i64 @_ZSt3absx(i64 %28)
  %30 = sdiv i64 %23, %29
  %31 = getelementptr inbounds [2 x i64], [2 x i64]* %1, i64 0, i64 0
  %32 = load i64, i64* %31, align 16
  %33 = getelementptr inbounds [2 x i64], [2 x i64]* %1, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s267873032.cpp() #0 section ".text.startup" {
