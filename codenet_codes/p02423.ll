; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02423/s155971112.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02423/s155971112.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s155971112.cpp, i8* null }]
...
47:                                               ; preds = %57, %45
  %.05 = phi i32 [ %46, %45 ], [ %58, %57 ]
  %48 = icmp sge i32 %.05, 0
  br i1 %48, label %49, label %59

49:                                               ; preds = %47
  %50 = sitofp i64 %.01 to double
  %51 = call double @_ZSt3powIiiEN9__gnu_cxx11__promote_2IT_T0_NS0_9__promoteIS2_Xsr3std12__is_integerIS2_EE7__valueEE6__typeENS4_IS3_Xsr3std12__is_integerIS3_EE7__valueEE6__typeEE6__typeES2_S3_(i32 10, i32 %.05)
...
69:                                               ; preds = %61
  %70 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEx(%"class.std::basic_ostream"* @_ZSt4cout, i64 %.01)
  %71 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %70, i32 0)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s155971112.cpp() #0 section ".text.startup" {
