; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03356/s114929254.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03356/s114929254.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s114929254.cpp, i8* null }]
...
define void @_Z5uniteii(i32 %0, i32 %1) #0 {
  ...
  %5 = sext i32 %3 to i64
  %6 = getelementptr inbounds [100005 x i32], [100005 x i32]* @r, i64 0, i64 %5
  %7 = load i32, i32* %6, align 4
  %8 = sext i32 %4 to i64
  %9 = getelementptr inbounds [100005 x i32], [100005 x i32]* @r, i64 0, i64 %8
  %10 = load i32, i32* %9, align 4
...
14:                                               ; preds = %11
  %15 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* @_ZSt3cin, i32* dereferenceable(4) %4)
...
22:                                               ; preds = %68, %66, %53, %34, %32, %30, %16, %14, %0
...
34:                                               ; preds = %32
  ...
  invoke void @_Z5uniteii(i32 %39, i32 %40)
...
45:                                               ; preds = %64, %44
  %.01 = phi i32 [ 0, %44 ], [ %.1, %64 ]
  %.0 = phi i32 [ 0, %44 ], [ %65, %64 ]
...
53:                                               ; preds = %48
  ...
  %57 = invoke zeroext i1 @_Z4sameii(i32 %.0, i32 %56)
...
66:                                               ; preds = %45
  %67 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %.01)
...
71:                                               ; preds = %22
  %72 = insertvalue { i8*, i32 } undef, i8* %24, 0
  %73 = insertvalue { i8*, i32 } %72, i32 %25, 1
  resume { i8*, i32 } %73
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s114929254.cpp() #0 section ".text.startup" {
