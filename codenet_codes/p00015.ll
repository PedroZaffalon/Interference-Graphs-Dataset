; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00015/s165078830.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00015/s165078830.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s165078830.cpp, i8* null }]
...
23:                                               ; preds = %191, %189, %178, %170, %168, %163, %149, %143, %135, %129, %115, %95, %86, %80, %71, %62, %56, %38, %32, %16, %14
...
28:                                               ; preds = %106, %27
  %.04 = phi i8 [ 0, %27 ], [ %.1, %106 ]
  %.03 = phi i32 [ 0, %27 ], [ %107, %106 ]
...
111:                                              ; preds = %159, %108
  %.2 = phi i8 [ %.04, %108 ], [ %.3, %159 ]
  %.02 = phi i32 [ %110, %108 ], [ %160, %159 ]
...
165:                                              ; preds = %164, %161
  %166 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* %4) #3
...
174:                                              ; preds = %187, %173
  %.0 = phi i32 [ 0, %173 ], [ %188, %187 ]
  %175 = sext i32 %.0 to i64
  %176 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* %4) #3
...
189:                                              ; preds = %174
  %190 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8 signext 0)
...
197:                                              ; preds = %23
  %198 = insertvalue { i8*, i32 } undef, i8* %25, 0
  %199 = insertvalue { i8*, i32 } %198, i32 %26, 1
  resume { i8*, i32 } %199
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s165078830.cpp() #0 section ".text.startup" {
