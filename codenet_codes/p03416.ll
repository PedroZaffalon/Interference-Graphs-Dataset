; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03416/s872366042.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03416/s872366042.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s872366042.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define zeroext i1 @_Z10check_loopi(i32 %0) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
...
15:                                               ; preds = %35, %14
  ...
  %17 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* %2) #3
  %18 = udiv i64 %17, 2
...
23:                                               ; preds = %20
  ...
  %25 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* %2) #3
  %26 = sub i64 %25, 1
  %27 = sext i32 %.01 to i64
  %28 = sub i64 %26, %27
  %29 = invoke dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEE2atEm(%"class.std::vector"* %2, i64 %28)
...
39:                                               ; preds = %10
  %40 = insertvalue { i8*, i32 } undef, i8* %12, 0
  %41 = insertvalue { i8*, i32 } %40, i32 %13, 1
  resume { i8*, i32 } %41
}
...
9:                                                ; preds = %6
  %10 = call zeroext i1 @_Z10check_loopi(i32 %.0)
...
16:                                               ; preds = %6
  %17 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %.01)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s872366042.cpp() #0 section ".text.startup" {
