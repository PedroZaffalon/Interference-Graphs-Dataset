; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02288/s780873451.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02288/s780873451.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s780873451.cpp, i8* null }]
...
define i32 @main() #4 {
  ...
  %2 = alloca [500001 x i32], align 16
...
7:                                                ; preds = %4
  ...
  %9 = getelementptr inbounds [500001 x i32], [500001 x i32]* %2, i64 0, i64 %8
...
16:                                               ; preds = %21, %13
  %.02 = phi i32 [ %15, %13 ], [ %22, %21 ]
  %17 = icmp sgt i32 %.02, 0
  br i1 %17, label %18, label %23

18:                                               ; preds = %16
  %19 = load i32, i32* %1, align 4
  %20 = getelementptr inbounds [500001 x i32], [500001 x i32]* %2, i32 0, i32 0
  call void @_Z1fiiPi(i32 %19, i32 %.02, i32* %20)
  br label %21
...
27:                                               ; preds = %24
  ...
  %30 = getelementptr inbounds [500001 x i32], [500001 x i32]* %2, i64 0, i64 %29
...
; Function Attrs: noinline uwtable
define void @_Z1fiiPi(i32 %0, i32 %1, i32* %2) #0 {
  %4 = mul nsw i32 %1, 2
  %5 = mul nsw i32 %1, 2
  %6 = add nsw i32 %5, 1
  %7 = icmp sle i32 %4, %0
...
30:                                               ; preds = %28
  ...
  call void @_ZSt4swapIiENSt9enable_ifIXsr6__and_ISt6__not_ISt15__is_tuple_likeIT_EESt21is_move_constructibleIS3_ESt18is_move_assignableIS3_EEE5valueEvE4typeERS3_SC_(i32* dereferenceable(4) %32, i32* dereferenceable(4) %34) #3
  call void @_Z1fiiPi(i32 %0, i32 %.1, i32* %2)
  br label %35
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s780873451.cpp() #0 section ".text.startup" {
