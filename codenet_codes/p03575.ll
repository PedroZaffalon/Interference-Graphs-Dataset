; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03575/s990036393.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03575/s990036393.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s990036393.cpp, i8* null }]
...
24:                                               ; preds = %22
  ...
  %26 = invoke dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEE2atEm(%"class.std::vector"* %5, i64 %25)
          to label %27 unwind label %40

27:                                               ; preds = %24
  %28 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* %23, i32* dereferenceable(4) %26)
...
45:                                               ; preds = %86, %44
  %.07 = phi i32 [ 0, %44 ], [ %87, %86 ]
  %.05 = phi i32 [ 0, %44 ], [ %.16, %86 ]
...
48:                                               ; preds = %45
  ...
  invoke void @_ZN9UnionFindC2Ei(%struct.UnionFind* %7, i32 %49)
...
51:                                               ; preds = %67, %50
  %.08 = phi i32 [ 0, %50 ], [ %68, %67 ]
  %52 = load i32, i32* %2, align 4
  %53 = icmp slt i32 %.08, %52
  br i1 %53, label %54, label %73

54:                                               ; preds = %51
  %55 = icmp eq i32 %.08, %.07
...
64:                                               ; preds = %60
  ...
  invoke void @_ZN9UnionFind5uniteEii(%struct.UnionFind* %7, i32 %61, i32 %65)
...
74:                                               ; preds = %83, %73
  %.09 = phi i32 [ 2, %73 ], [ %84, %83 ]
  %75 = load i32, i32* %1, align 4
  %76 = icmp sle i32 %.09, %75
  br i1 %76, label %77, label %85

77:                                               ; preds = %74
  %78 = invoke zeroext i1 @_ZN9UnionFind4sameEii(%struct.UnionFind* %7, i32 1, i32 %.09)
...
88:                                               ; preds = %45
  %89 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %.05)
...
93:                                               ; preds = %69, %40
  %.01 = phi i32 [ %43, %40 ], [ %72, %69 ]
  %.0 = phi i8* [ %42, %40 ], [ %71, %69 ]
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %5) #3
  br label %94

94:                                               ; preds = %93, %36
  %.12 = phi i32 [ %.01, %93 ], [ %39, %36 ]
  %.1 = phi i8* [ %.0, %93 ], [ %38, %36 ]
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %3) #3
  br label %95

95:                                               ; preds = %94, %32
  %.23 = phi i32 [ %.12, %94 ], [ %35, %32 ]
  %.2 = phi i8* [ %.1, %94 ], [ %34, %32 ]
  %96 = insertvalue { i8*, i32 } undef, i8* %.2, 0
  %97 = insertvalue { i8*, i32 } %96, i32 %.23, 1
  resume { i8*, i32 } %97
}
...
define linkonce_odr void @_ZN9UnionFindC2Ei(%struct.UnionFind* %0, i32 %1) unnamed_addr #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  invoke void @_ZNSt6vectorIiSaIiEEC2EmRKS0_(%"class.std::vector"* %4, i64 %5, %"class.std::allocator"* dereferenceable(1) %3)
...
20:                                               ; preds = %15
  %21 = insertvalue { i8*, i32 } undef, i8* %17, 0
  %22 = insertvalue { i8*, i32 } %21, i32 %18, 1
  resume { i8*, i32 } %22
}

; Function Attrs: noinline uwtable
define linkonce_odr void @_ZN9UnionFind5uniteEii(%struct.UnionFind* %0, i32 %1, i32 %2) #0 comdat align 2 {
  %4 = call i32 @_ZN9UnionFind4rootEi(%struct.UnionFind* %0, i32 %1)
  %5 = call i32 @_ZN9UnionFind4rootEi(%struct.UnionFind* %0, i32 %2)
  %6 = icmp eq i32 %4, %5
...
5:                                                ; preds = %2
  ...
  call void (i8*, ...) @_ZSt24__throw_out_of_range_fmtPKcz(i8* getelementptr inbounds ([74 x i8], [74 x i8]* @.str, i32 0, i32 0), i64 %1, i64 %6) #11
  unreachable
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s990036393.cpp() #0 section ".text.startup" {
