; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03698/s313177047.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03698/s313177047.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s313177047.cpp, i8* null }]
...
5:                                                ; preds = %0
  ...
  invoke void @_ZSt4sortIN9__gnu_cxx17__normal_iteratorIPcNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEEEvT_SA_(i8* %11, i8* %13)
...
34:                                               ; preds = %50, %48, %45, %43, %23, %20, %5, %0
...
54:                                               ; preds = %34
  %55 = insertvalue { i8*, i32 } undef, i8* %36, 0
  %56 = insertvalue { i8*, i32 } %55, i32 %37, 1
  resume { i8*, i32 } %56
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s313177047.cpp() #0 section ".text.startup" {
