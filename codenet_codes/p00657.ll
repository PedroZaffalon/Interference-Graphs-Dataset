; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00657/s171782235.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00657/s171782235.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s171782235.cpp, i8* null }]
...
30:                                               ; preds = %26, %22
  ...
  %33 = select i1 %31, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i32 0, i32 0)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s171782235.cpp() #0 section ".text.startup" {
