; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03731/s716917771.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03731/s716917771.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s716917771.cpp, i8* null }]
...
10:                                               ; preds = %0
  ...
  %11 = call i64* @_ZNSt6vectorIxSaIxEE5beginEv(%"class.std::vector"* %3) #3
  %12 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %5, i32 0, i32 0
  store i64* %11, i64** %12, align 8
  %13 = call i64* @_ZNSt6vectorIxSaIxEE3endEv(%"class.std::vector"* %3) #3
...
35:                                               ; preds = %63, %31
  %.03 = phi i64 [ %34, %31 ], [ %.1, %63 ]
  %.02 = phi i32 [ 1, %31 ], [ %64, %63 ]
...
50:                                               ; preds = %39
  ...
  %61 = sub nsw i64 %.03, %60
  br label %62

62:                                               ; preds = %50, %39
  %.1 = phi i64 [ %61, %50 ], [ %.03, %39 ]
  br label %63
...
65:                                               ; preds = %35
  %66 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEx(%"class.std::basic_ostream"* @_ZSt4cout, i64 %.03)
...
70:                                               ; preds = %27, %23
  ...
  %71 = insertvalue { i8*, i32 } undef, i8* %.0, 0
  %72 = insertvalue { i8*, i32 } %71, i32 %.01, 1
  resume { i8*, i32 } %72
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s716917771.cpp() #0 section ".text.startup" {
