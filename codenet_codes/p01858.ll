; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01858/s568230465.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01858/s568230465.cpp"
...
@.str = private unnamed_addr constant [7 x i8] c"tameru\00", align 1
@.str.1 = private unnamed_addr constant [10 x i8] c"kougekida\00", align 1
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@.str.2 = private unnamed_addr constant [10 x i8] c"Isono-kun\00", align 1
@.str.3 = private unnamed_addr constant [13 x i8] c"Nakajima-kun\00", align 1
@.str.4 = private unnamed_addr constant [13 x i8] c"Hikiwake-kun\00", align 1
@.str.5 = private unnamed_addr constant [26 x i8] c"vector::_M_default_append\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s568230465.cpp, i8* null }]
...
define i32 @main() #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %9 = getelementptr inbounds [2 x %"class.std::vector"], [2 x %"class.std::vector"]* %3, i32 0, i32 0
  %10 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %9, i64 2
  br label %11

11:                                               ; preds = %11, %0
  %12 = phi %"class.std::vector"* [ %9, %0 ], [ %13, %11 ]
...
15:                                               ; preds = %11
  %16 = getelementptr inbounds [2 x %"class.std::vector"], [2 x %"class.std::vector"]* %3, i64 0, i64 0
  %17 = load i32, i32* %1, align 4
  %18 = sext i32 %17 to i64
  invoke void @_ZNSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EE6resizeEm(%"class.std::vector"* %16, i64 %18)
          to label %19 unwind label %39

19:                                               ; preds = %15
  %20 = getelementptr inbounds [2 x %"class.std::vector"], [2 x %"class.std::vector"]* %3, i64 0, i64 1
  %21 = load i32, i32* %1, align 4
  %22 = sext i32 %21 to i64
  invoke void @_ZNSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EE6resizeEm(%"class.std::vector"* %20, i64 %22)
...
30:                                               ; preds = %27
  ...
  %32 = getelementptr inbounds [2 x %"class.std::vector"], [2 x %"class.std::vector"]* %3, i64 0, i64 %31
  %33 = sext i32 %.03 to i64
  %34 = call dereferenceable(32) %"class.std::__cxx11::basic_string"* @_ZNSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EEixEm(%"class.std::vector"* %32, i64 %33) #3
...
39:                                               ; preds = %161, %159, %156, %154, %149, %147, %100, %93, %84, %72, %62, %55, %30, %19, %15
  %40 = landingpad { i8*, i32 }
          cleanup
  %41 = extractvalue { i8*, i32 } %40, 0
  %42 = extractvalue { i8*, i32 } %40, 1
  %43 = getelementptr inbounds [2 x %"class.std::vector"], [2 x %"class.std::vector"]* %3, i32 0, i32 0
...
53:                                               ; preds = %139, %52
  %.0 = phi i32 [ 0, %52 ], [ %140, %139 ]
  %54 = icmp slt i32 %.0, 2
  br i1 %54, label %55, label %141

55:                                               ; preds = %53
  %56 = sext i32 %.0 to i64
  %57 = getelementptr inbounds [2 x %"class.std::vector"], [2 x %"class.std::vector"]* %3, i64 0, i64 %56
  ...
  %60 = invoke zeroext i1 @_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_(%"class.std::__cxx11::basic_string"* dereferenceable(32) %59, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i32 0, i32 0))
...
62:                                               ; preds = %61
  ...
  %67 = invoke dereferenceable(4) i32* @_ZSt3minIiERKT_S2_S2_(i32* dereferenceable(4) %4, i32* dereferenceable(4) %5)
...
72:                                               ; preds = %61
  ...
  %74 = getelementptr inbounds [2 x %"class.std::vector"], [2 x %"class.std::vector"]* %3, i64 0, i64 %73
  %75 = sext i32 %.01 to i64
  %76 = call dereferenceable(32) %"class.std::__cxx11::basic_string"* @_ZNSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EEixEm(%"class.std::vector"* %74, i64 %75) #3
  %77 = invoke zeroext i1 @_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_(%"class.std::__cxx11::basic_string"* dereferenceable(32) %76, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i32 0, i32 0))
...
84:                                               ; preds = %79
  ...
  %87 = getelementptr inbounds [2 x %"class.std::vector"], [2 x %"class.std::vector"]* %3, i64 0, i64 %86
  %88 = sext i32 %.01 to i64
  %89 = call dereferenceable(32) %"class.std::__cxx11::basic_string"* @_ZNSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EEixEm(%"class.std::vector"* %87, i64 %88) #3
  %90 = invoke zeroext i1 @_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_(%"class.std::__cxx11::basic_string"* dereferenceable(32) %89, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i32 0, i32 0))
...
93:                                               ; preds = %91
  ...
  %95 = getelementptr inbounds [2 x %"class.std::vector"], [2 x %"class.std::vector"]* %3, i64 0, i64 %94
  %96 = sext i32 %.01 to i64
  %97 = call dereferenceable(32) %"class.std::__cxx11::basic_string"* @_ZNSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EEixEm(%"class.std::vector"* %95, i64 %96) #3
  %98 = invoke zeroext i1 @_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_(%"class.std::__cxx11::basic_string"* dereferenceable(32) %97, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i32 0, i32 0))
...
100:                                              ; preds = %99
  ...
  %103 = getelementptr inbounds [2 x %"class.std::vector"], [2 x %"class.std::vector"]* %3, i64 0, i64 %102
  %104 = sext i32 %.01 to i64
  %105 = call dereferenceable(32) %"class.std::__cxx11::basic_string"* @_ZNSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EEixEm(%"class.std::vector"* %103, i64 %104) #3
  %106 = invoke zeroext i1 @_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_(%"class.std::__cxx11::basic_string"* dereferenceable(32) %105, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i32 0, i32 0))
...
117:                                              ; preds = %112, %108
  %118 = getelementptr inbounds [2 x i32], [2 x i32]* %2, i64 0, i64 0
  %119 = load i32, i32* %118, align 4
  %120 = getelementptr inbounds [2 x i32], [2 x i32]* %2, i64 0, i64 1
  %121 = load i32, i32* %120, align 4
  %122 = icmp eq i32 %119, %121
  br i1 %122, label %123, label %126

123:                                              ; preds = %117
  %124 = getelementptr inbounds [2 x i32], [2 x i32]* %2, i64 0, i64 1
...
134:                                              ; preds = %107, %99
  ...
  %136 = getelementptr inbounds [2 x i32], [2 x i32]* %2, i64 0, i64 %135
...
145:                                              ; preds = %144, %126, %92
  %.04 = phi i32 [ %.0, %92 ], [ %133, %126 ], [ -1, %144 ]
  %146 = icmp eq i32 %.04, 0
...
152:                                              ; preds = %145
  %153 = icmp eq i32 %.04, 1
  br i1 %153, label %154, label %159

154:                                              ; preds = %152
  %155 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.3, i32 0, i32 0))
...
159:                                              ; preds = %152
  %160 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.4, i32 0, i32 0))
...
165:                                              ; preds = %164, %151
  %166 = getelementptr inbounds [2 x %"class.std::vector"], [2 x %"class.std::vector"]* %3, i32 0, i32 0
  %167 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %166, i64 2
  br label %168

168:                                              ; preds = %168, %165
  %169 = phi %"class.std::vector"* [ %167, %165 ], [ %170, %168 ]
  %170 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %169, i64 -1
  call void @_ZNSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EED2Ev(%"class.std::vector"* %170) #3
  %171 = icmp eq %"class.std::vector"* %170, %166
...
173:                                              ; preds = %173, %39
  %174 = phi %"class.std::vector"* [ %44, %39 ], [ %175, %173 ]
  %175 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %174, i64 -1
  call void @_ZNSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EED2Ev(%"class.std::vector"* %175) #3
  %176 = icmp eq %"class.std::vector"* %175, %43
...
178:                                              ; preds = %177
  %179 = insertvalue { i8*, i32 } undef, i8* %41, 0
  %180 = insertvalue { i8*, i32 } %179, i32 %42, 1
  resume { i8*, i32 } %180
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EE15_M_erase_at_endEPS5_(%"class.std::vector"* %0, %"class.std::__cxx11::basic_string"* %1) #5 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %3 = bitcast %"class.std::vector"* %0 to %"struct.std::_Vector_base"*
  %4 = getelementptr inbounds %"struct.std::_Vector_base", %"struct.std::_Vector_base"* %3, i32 0, i32 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s568230465.cpp() #0 section ".text.startup" {
