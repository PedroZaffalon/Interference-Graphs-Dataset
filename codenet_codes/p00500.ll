; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00500/s751845529.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00500/s751845529.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s751845529.cpp, i8* null }]
...
define i32 @main() #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %3 = alloca [3 x %"class.std::vector"], align 16
  %4 = alloca [200 x i32], align 16
  %5 = alloca i32, align 4
  %6 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %7 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %8 = getelementptr inbounds [3 x %"class.std::vector"], [3 x %"class.std::vector"]* %3, i32 0, i32 0
  %9 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %8, i64 3
  br label %10

10:                                               ; preds = %10, %0
  %11 = phi %"class.std::vector"* [ %8, %0 ], [ %12, %10 ]
  ...
  %13 = icmp eq %"class.std::vector"* %12, %9
...
21:                                               ; preds = %37, %20
  %.03 = phi i32 [ 0, %20 ], [ %38, %37 ]
  %22 = icmp slt i32 %.03, 3
  br i1 %22, label %23, label %45

23:                                               ; preds = %21
  %24 = sext i32 %.02 to i64
  %25 = getelementptr inbounds [200 x [3 x i32]], [200 x [3 x i32]]* %2, i64 0, i64 %24
  %26 = sext i32 %.03 to i64
  %27 = getelementptr inbounds [3 x i32], [3 x i32]* %25, i64 0, i64 %26
...
29:                                               ; preds = %23
  ...
  %31 = getelementptr inbounds [3 x %"class.std::vector"], [3 x %"class.std::vector"]* %3, i64 0, i64 %30
  %32 = sext i32 %.02 to i64
  %33 = getelementptr inbounds [200 x [3 x i32]], [200 x [3 x i32]]* %2, i64 0, i64 %32
  %34 = sext i32 %.03 to i64
  %35 = getelementptr inbounds [3 x i32], [3 x i32]* %33, i64 0, i64 %34
  invoke void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %31, i32* dereferenceable(4) %35)
...
39:                                               ; preds = %103, %98, %58, %48, %29, %23, %14
  %40 = landingpad { i8*, i32 }
          cleanup
  %41 = extractvalue { i8*, i32 } %40, 0
  %42 = extractvalue { i8*, i32 } %40, 1
  %43 = getelementptr inbounds [3 x %"class.std::vector"], [3 x %"class.std::vector"]* %3, i32 0, i32 0
  %44 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %43, i64 3
  br label %116
...
48:                                               ; preds = %17
  ...
  %50 = invoke i32* @_ZSt6fill_nIPiiiET_S1_T0_RKT1_(i32* %49, i32 200, i32* dereferenceable(4) %5)
...
56:                                               ; preds = %89, %55
  %.01 = phi i32 [ 0, %55 ], [ %90, %89 ]
  %57 = icmp slt i32 %.01, 3
  br i1 %57, label %58, label %91

58:                                               ; preds = %56
  %59 = sext i32 %.01 to i64
  %60 = getelementptr inbounds [3 x %"class.std::vector"], [3 x %"class.std::vector"]* %3, i64 0, i64 %59
  ...
  %64 = getelementptr inbounds [3 x %"class.std::vector"], [3 x %"class.std::vector"]* %3, i64 0, i64 %63
  ...
  %75 = invoke i64 @_ZSt5countIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEiENSt15iterator_traitsIT_E15difference_typeES8_S8_RKT0_(i32* %72, i32* %74, i32* dereferenceable(4) %70)
...
78:                                               ; preds = %76
  ...
  %82 = getelementptr inbounds [3 x i32], [3 x i32]* %80, i64 0, i64 %81
...
108:                                              ; preds = %95
  %109 = getelementptr inbounds [3 x %"class.std::vector"], [3 x %"class.std::vector"]* %3, i32 0, i32 0
  %110 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %109, i64 3
  br label %111

111:                                              ; preds = %111, %108
  %112 = phi %"class.std::vector"* [ %110, %108 ], [ %113, %111 ]
  %113 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %112, i64 -1
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %113) #3
  %114 = icmp eq %"class.std::vector"* %113, %109
...
116:                                              ; preds = %116, %39
  %117 = phi %"class.std::vector"* [ %44, %39 ], [ %118, %116 ]
  ...
  %119 = icmp eq %"class.std::vector"* %118, %43
...
121:                                              ; preds = %120
  %122 = insertvalue { i8*, i32 } undef, i8* %41, 0
  %123 = insertvalue { i8*, i32 } %122, i32 %42, 1
  resume { i8*, i32 } %123
}
...
; Function Attrs: noinline uwtable
define linkonce_odr i64 @_ZSt5countIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEiENSt15iterator_traitsIT_E15difference_typeES8_S8_RKT0_(i32* %0, i32* %1, i32* dereferenceable(4) %2) #0 comdat {
  ...
  %15 = call i32* @_ZN9__gnu_cxx5__ops17__iter_equals_valIKiEENS0_16_Iter_equals_valIT_EERS4_(i32* dereferenceable(4) %2)
  ...
  %23 = call i64 @_ZSt10__count_ifIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops16_Iter_equals_valIKiEEENSt15iterator_traitsIT_E15difference_typeESC_SC_T0_(i32* %18, i32* %20, i32* %22)
  ret i64 %23
}
...
; Function Attrs: noinline uwtable
define linkonce_odr i64 @_ZSt10__count_ifIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops16_Iter_equals_valIKiEEENSt15iterator_traitsIT_E15difference_typeESC_SC_T0_(i32* %0, i32* %1, i32* %2) #0 comdat {
  %4 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %5 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
...
11:                                               ; preds = %22, %3
  %.0 = phi i64 [ 0, %3 ], [ %.1, %22 ]
  %12 = call zeroext i1 @_ZN9__gnu_cxxneIPiSt6vectorIiSaIiEEEEbRKNS_17__normal_iteratorIT_T0_EESA_(%"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %4, %"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %5) #3
...
13:                                               ; preds = %11
  ...
  %17 = load i32*, i32** %16, align 8
  %18 = call zeroext i1 @_ZN9__gnu_cxx5__ops16_Iter_equals_valIKiEclINS_17__normal_iteratorIPiSt6vectorIiSaIiEEEEEEbT_(%"struct.__gnu_cxx::__ops::_Iter_equals_val"* %6, i32* %17)
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr zeroext i1 @_ZN9__gnu_cxx5__ops16_Iter_equals_valIKiEclINS_17__normal_iteratorIPiSt6vectorIiSaIiEEEEEEbT_(%"struct.__gnu_cxx::__ops::_Iter_equals_val"* %0, i32* %1) #5 comdat align 2 {
  %3 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s751845529.cpp() #0 section ".text.startup" {
