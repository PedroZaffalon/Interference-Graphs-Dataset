; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02474/s409831491.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02474/s409831491.c"
...
@buf = common global [5000 x i8] zeroinitializer, align 16
@stdin = external global %struct._IO_FILE*, align 8
@a_minus = common global i32 0, align 4
@a = common global [120 x i32] zeroinitializer, align 16
@b_minus = common global i32 0, align 4
@b = common global [120 x i32] zeroinitializer, align 16
@ab = common global [500 x i32] zeroinitializer, align 16
...
; Function Attrs: noinline nounwind uwtable
define void @mpMul(i32* %0, i32* %1, i32* %2) #0 {
  %4 = load i32, i32* %1, align 4
  %5 = load i32, i32* %2, align 4
  %6 = icmp eq i32 %4, 0
...
20:                                               ; preds = %60, %19
  %.05 = phi i32 [ 1, %19 ], [ %61, %60 ]
  %.02 = phi i32* [ %2, %19 ], [ %23, %60 ]
  %.0 = phi i32 [ undef, %19 ], [ %.1, %60 ]
  %21 = icmp sle i32 %.05, %5
  br i1 %21, label %22, label %62

22:                                               ; preds = %20
  %23 = getelementptr inbounds i32, i32* %.02, i32 1
  br label %24

24:                                               ; preds = %52, %22
  %.14 = phi i32 [ 1, %22 ], [ %53, %52 ]
  %.01 = phi i32* [ %1, %22 ], [ %27, %52 ]
  %.1 = phi i32 [ 0, %22 ], [ %51, %52 ]
  %25 = icmp sle i32 %.14, %4
  br i1 %25, label %26, label %54

26:                                               ; preds = %24
  %27 = getelementptr inbounds i32, i32* %.01, i32 1
...
define i32 @main() #0 {
  ...
  %2 = call i8* @fgets(i8* getelementptr inbounds ([5000 x i8], [5000 x i8]* @buf, i32 0, i32 0), i32 200100, %struct._IO_FILE* %1)
  %3 = load i8, i8* getelementptr inbounds ([5000 x i8], [5000 x i8]* @buf, i32 0, i32 0), align 1
  %4 = sext i8 %3 to i32
  %5 = icmp eq i32 %4, 45
...
6:                                                ; preds = %0
  ...
  %7 = getelementptr inbounds i8, i8* getelementptr inbounds ([5000 x i8], [5000 x i8]* @buf, i32 0, i32 0), i32 1
  br label %8

8:                                                ; preds = %6, %0
  %.0 = phi i8* [ %7, %6 ], [ getelementptr inbounds ([5000 x i8], [5000 x i8]* @buf, i32 0, i32 0), %0 ]
  %9 = call i8* @mpStr2Num(i32* getelementptr inbounds ([120 x i32], [120 x i32]* @a, i32 0, i32 0), i8* %.0)
  br label %10
...
22:                                               ; preds = %20, %16
  %.2 = phi i8* [ %21, %20 ], [ %.1, %16 ]
  %23 = call i8* @mpStr2Num(i32* getelementptr inbounds ([120 x i32], [120 x i32]* @b, i32 0, i32 0), i8* %.2)
  %24 = load i32, i32* @a_minus, align 4
  %25 = load i32, i32* @b_minus, align 4
  %26 = xor i32 %24, %25
  call void @mpMul(i32* getelementptr inbounds ([500 x i32], [500 x i32]* @ab, i32 0, i32 0), i32* getelementptr inbounds ([120 x i32], [120 x i32]* @a, i32 0, i32 0), i32* getelementptr inbounds ([120 x i32], [120 x i32]* @b, i32 0, i32 0))
  %27 = load i32, i32* getelementptr inbounds ([500 x i32], [500 x i32]* @ab, i32 0, i32 0), align 16
  %28 = icmp eq i32 %27, 0
...
34:                                               ; preds = %32, %30
  call void @mpNum2Str(i8* getelementptr inbounds ([5000 x i8], [5000 x i8]* @buf, i32 0, i32 0), i32* getelementptr inbounds ([500 x i32], [500 x i32]* @ab, i32 0, i32 0))
  %35 = call i32 @puts(i8* getelementptr inbounds ([5000 x i8], [5000 x i8]* @buf, i32 0, i32 0))
  ret i32 0
}
