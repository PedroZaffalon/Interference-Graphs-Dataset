; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03363/s369695918.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03363/s369695918.cpp"
...
@vx = global [4 x i32] [i32 0, i32 0, i32 -1, i32 1], align 16
@vy = global [4 x i32] [i32 1, i32 -1, i32 0, i32 0], align 16
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s369695918.cpp, i8* null }]
...
4:                                                ; preds = %2
  %5 = srem i32 %0, %1
  %6 = call i32 @_Z3gcdii(i32 %1, i32 %5)
  br label %8
...
15:                                               ; preds = %6
  ...
  invoke void @_ZNSt6vectorIxSaIxEEC2EmRKS0_(%"class.std::vector"* %1, i64 %18, %"class.std::allocator"* dereferenceable(1) %2)
          to label %19 unwind label %42

19:                                               ; preds = %15
  call void @_ZNSaIxED2Ev(%"class.std::allocator"* %2) #3
  %20 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %1, i64 0) #3
  store i64 0, i64* %20, align 8
  br label %21

21:                                               ; preds = %40, %19
  %.03 = phi i32 [ 1, %19 ], [ %41, %40 ]
...
46:                                               ; preds = %21
  %47 = call i64* @_ZNSt6vectorIxSaIxEE5beginEv(%"class.std::vector"* %1) #3
  %48 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %3, i32 0, i32 0
  store i64* %47, i64** %48, align 8
  %49 = call i64* @_ZNSt6vectorIxSaIxEE3endEv(%"class.std::vector"* %1) #3
...
56:                                               ; preds = %81, %55
  %.05 = phi i32 [ 0, %55 ], [ %82, %81 ]
  %.04 = phi i64 [ 1, %55 ], [ %.1, %81 ]
...
94:                                               ; preds = %70, %42
  %.02 = phi i32 [ %73, %70 ], [ %45, %42 ]
  %.01 = phi i8* [ %72, %70 ], [ %44, %42 ]
  %95 = insertvalue { i8*, i32 } undef, i8* %.01, 0
  %96 = insertvalue { i8*, i32 } %95, i32 %.02, 1
  resume { i8*, i32 } %96
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s369695918.cpp() #0 section ".text.startup" {
