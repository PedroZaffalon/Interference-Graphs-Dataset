; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03378/s940808391.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03378/s940808391.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s940808391.cpp, i8* null }]
...
35:                                               ; preds = %17
  ...
  invoke void @_ZNSt6vectorIiSaIiEEC2EmRKiRKS0_(%"class.std::vector"* %6, i64 %38, i32* dereferenceable(4) %7, %"class.std::allocator"* dereferenceable(1) %8)
...
94:                                               ; preds = %90, %53, %31
  %.03 = phi i32 [ %34, %31 ], [ %93, %90 ], [ %56, %53 ]
  %.01 = phi i8* [ %33, %31 ], [ %92, %90 ], [ %55, %53 ]
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %4) #3
  br label %95

95:                                               ; preds = %94, %27
  %.14 = phi i32 [ %.03, %94 ], [ %30, %27 ]
  %.12 = phi i8* [ %.01, %94 ], [ %29, %27 ]
  %96 = insertvalue { i8*, i32 } undef, i8* %.12, 0
  %97 = insertvalue { i8*, i32 } %96, i32 %.14, 1
  resume { i8*, i32 } %97
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s940808391.cpp() #0 section ".text.startup" {
