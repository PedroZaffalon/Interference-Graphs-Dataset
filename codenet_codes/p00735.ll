; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00735/s020162020.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00735/s020162020.cpp"
...
@isSatNum = global [300001 x i8] zeroinitializer, align 16
@_ZSt3cin = external global %"class.std::basic_istream", align 8
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@.str = private unnamed_addr constant [2 x i8] c":\00", align 1
@.str.2 = private unnamed_addr constant [2 x i8] c" \00", align 1
@.str.3 = private unnamed_addr constant [26 x i8] c"vector::_M_realloc_insert\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s020162020.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define void @_Z6SatNumv() #0 {
  br label %1

1:                                                ; preds = %6, %0
  %.0 = phi i32 [ 0, %0 ], [ %7, %6 ]
  %2 = icmp slt i32 %.0, 300001
  br i1 %2, label %3, label %8

3:                                                ; preds = %1
  %4 = sext i32 %.0 to i64
  %5 = getelementptr inbounds [300001 x i8], [300001 x i8]* @isSatNum, i64 0, i64 %4
...
9:                                                ; preds = %36, %8
  %.01 = phi i32 [ 2, %8 ], [ %37, %36 ]
  %10 = sitofp i32 %.01 to double
  %11 = call double @_ZSt4sqrtIiEN9__gnu_cxx11__enable_ifIXsr12__is_integerIT_EE7__valueEdE6__typeES2_(i32 300000)
...
14:                                               ; preds = %9
  ...
  %16 = getelementptr inbounds [300001 x i8], [300001 x i8]* @isSatNum, i64 0, i64 %15
...
27:                                               ; preds = %32, %25
  %.02 = phi i32 [ %26, %25 ], [ %33, %32 ]
  %28 = icmp slt i32 %.02, 300001
  br i1 %28, label %29, label %34

29:                                               ; preds = %27
  %30 = sext i32 %.02 to i64
  %31 = getelementptr inbounds [300001 x i8], [300001 x i8]* @isSatNum, i64 0, i64 %30
  store i8 0, i8* %31, align 1
  br label %32

32:                                               ; preds = %29
  %33 = add nsw i32 %.02, %.01
  br label %27
...
7:                                                ; preds = %31, %0
  ...
  %9 = icmp slt i32 %8, 300001
  br i1 %9, label %10, label %34

10:                                               ; preds = %7
  %11 = load i32, i32* %2, align 4
  %12 = sext i32 %11 to i64
  %13 = getelementptr inbounds [300001 x i8], [300001 x i8]* @isSatNum, i64 0, i64 %12
...
65:                                               ; preds = %58
  ...
  invoke void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %4, i32* dereferenceable(4) %67)
...
87:                                               ; preds = %83
  %88 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %86, i32 %85)
...
94:                                               ; preds = %69, %26
  %.01 = phi i32 [ %29, %26 ], [ %72, %69 ]
  %.0 = phi i8* [ %28, %26 ], [ %71, %69 ]
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %1) #3
  br label %95

95:                                               ; preds = %94
  %96 = insertvalue { i8*, i32 } undef, i8* %.0, 0
  %97 = insertvalue { i8*, i32 } %96, i32 %.01, 1
  resume { i8*, i32 } %97
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s020162020.cpp() #0 section ".text.startup" {
