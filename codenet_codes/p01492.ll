; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01492/s485792050.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01492/s485792050.cpp"
...
@.str.3 = private unnamed_addr constant [5 x i8] c"0 3\0A\00", align 1
@.str.4 = private unnamed_addr constant [5 x i8] c"0 6\0A\00", align 1
@.str.5 = private unnamed_addr constant [5 x i8] c"3 0\0A\00", align 1
@.str.6 = private unnamed_addr constant [5 x i8] c"6 0\0A\00", align 1
@.str.7 = private unnamed_addr constant [5 x i8] c"2 2\0A\00", align 1
@.str.8 = private unnamed_addr constant [5 x i8] c"2 0\0A\00", align 1
@.str.9 = private unnamed_addr constant [5 x i8] c"0 2\0A\00", align 1
@.str.10 = private unnamed_addr constant [5 x i8] c"1 1\0A\00", align 1
@.str.11 = private unnamed_addr constant [5 x i8] c"4 2\0A\00", align 1
...
@.str.15 = private unnamed_addr constant [5 x i8] c"2 1\0A\00", align 1
@.str.16 = private unnamed_addr constant [26 x i8] c"vector::_M_realloc_insert\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s485792050.cpp, i8* null }]
...
define i32 @main() #3 {
  ...
  %2 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0), i32* @goal)
...
5:                                                ; preds = %0
  ...
  %9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.4, i32 0, i32 0))
  %10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.5, i32 0, i32 0))
  %11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.6, i32 0, i32 0))
  %12 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.7, i32 0, i32 0))
  br label %215

13:                                               ; preds = %0
  %14 = load i32, i32* @goal, align 4
  %15 = icmp eq i32 %14, 9
...
16:                                               ; preds = %13
  ...
  %19 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.8, i32 0, i32 0))
  %20 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.9, i32 0, i32 0))
  %21 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.7, i32 0, i32 0))
  %22 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.10, i32 0, i32 0))
  %23 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.11, i32 0, i32 0))
  br label %215

24:                                               ; preds = %13
  %25 = load i32, i32* @goal, align 4
  %26 = icmp eq i32 %25, 2
  br i1 %26, label %27, label %29

27:                                               ; preds = %24
  %28 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.12, i32 0, i32 0))
  br label %215
...
49:                                               ; preds = %44
  ...
  %54 = sdiv i32 %53, 2
  %55 = load i32, i32* @goal, align 4
  %56 = sub nsw i32 %54, %55
  br label %57

57:                                               ; preds = %67, %49
  %.04 = phi i32 [ 0, %49 ], [ %68, %67 ]
  %58 = mul nsw i32 %.04, 2
...
96:                                               ; preds = %107, %95
  %.06 = phi i32 [ 0, %95 ], [ %108, %107 ]
  %97 = icmp slt i32 %.06, %.04
...
99:                                               ; preds = %102, %98
  %.07 = phi i32 [ 0, %98 ], [ %103, %102 ]
  %100 = icmp slt i32 %.07, 2
...
111:                                              ; preds = %123, %110
  %.08 = phi i32 [ 0, %110 ], [ %124, %123 ]
  %112 = sub nsw i32 %.04, 1
...
115:                                              ; preds = %118, %114
  %.09 = phi i32 [ 0, %114 ], [ %119, %118 ]
  %116 = icmp slt i32 %.09, 2
...
127:                                              ; preds = %138, %126
  %.010 = phi i32 [ 0, %126 ], [ %139, %138 ]
  %128 = icmp slt i32 %.010, %65
...
130:                                              ; preds = %133, %129
  %.011 = phi i32 [ 0, %129 ], [ %134, %133 ]
  %131 = icmp slt i32 %.011, 3
...
140:                                              ; preds = %127
  ...
  %142 = mul nsw i32 %.04, 2
  %143 = sub nsw i32 %141, %142
  %144 = mul nsw i32 3, %65
  %145 = sub nsw i32 %143, %144
  %146 = sub nsw i32 %145, 1
  br label %147

147:                                              ; preds = %158, %140
  %.014 = phi i32 [ 0, %140 ], [ %159, %158 ]
  %148 = load i32, i32* @N, align 4
  %149 = mul nsw i32 %.04, 2
  %150 = sub nsw i32 %148, %149
  %151 = mul nsw i32 3, %65
...
164:                                              ; preds = %160
  ...
  %166 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.13, i32 0, i32 0), i32 %165)
  %167 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.14, i32 0, i32 0), i32 0, i32 0)
  br label %168

168:                                              ; preds = %184, %164
  %.012 = phi i32 [ 0, %164 ], [ %179, %184 ]
  %.05 = phi i32 [ 0, %164 ], [ %183, %184 ]
  %.03 = phi i32 [ 0, %164 ], [ %185, %184 ]
  %169 = sext i32 %.03 to i64
  %170 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* @ans) #2
...
172:                                              ; preds = %168
  ...
  %175 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* @ans, i64 %174) #2
  %176 = load i32, i32* %175, align 4
  %177 = add nsw i32 %.05, %176
  %178 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.14, i32 0, i32 0), i32 %173, i32 %177)
  %179 = add nsw i32 %.012, 1
  %180 = sext i32 %.03 to i64
  %181 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* @ans, i64 %180) #2
  %182 = load i32, i32* %181, align 4
  %183 = add nsw i32 %.05, %182
  br label %184

184:                                              ; preds = %172
  %185 = add nsw i32 %.03, 1
  br label %168
...
187:                                              ; preds = %160
  ...
  %189 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.13, i32 0, i32 0), i32 %188)
  %190 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.14, i32 0, i32 0), i32 0, i32 0)
  br label %191

191:                                              ; preds = %209, %187
  %.113 = phi i32 [ 0, %187 ], [ %203, %209 ]
  %.1 = phi i32 [ 0, %187 ], [ %208, %209 ]
  %.02 = phi i32 [ 0, %187 ], [ %210, %209 ]
  %192 = sext i32 %.02 to i64
  %193 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* @ans) #2
  %194 = icmp ult i64 %192, %193
  br i1 %194, label %195, label %211

195:                                              ; preds = %191
  %196 = add nsw i32 %.113, 2
  %197 = sext i32 %.02 to i64
  %198 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* @ans, i64 %197) #2
  %199 = load i32, i32* %198, align 4
  %200 = mul nsw i32 %199, 2
  %201 = add nsw i32 %.1, %200
  %202 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.14, i32 0, i32 0), i32 %196, i32 %201)
  %203 = add nsw i32 %.113, 2
  %204 = sext i32 %.02 to i64
  %205 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* @ans, i64 %204) #2
...
209:                                              ; preds = %195
  %210 = add nsw i32 %.02, 1
  br label %191

211:                                              ; preds = %191
  %212 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.15, i32 0, i32 0))
  br label %215
...
define linkonce_odr void @_ZNSt6vectorIiSaIiEE17_M_realloc_insertIJRKiEEEvN9__gnu_cxx17__normal_iteratorIPiS1_EEDpOT_(%"class.std::vector"* %0, i32* %1, i32* dereferenceable(4) %2) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %7 = call i64 @_ZNKSt6vectorIiSaIiEE12_M_check_lenEmPKc(%"class.std::vector"* %0, i64 1, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.16, i32 0, i32 0))
  %8 = bitcast %"class.std::vector"* %0 to %"struct.std::_Vector_base"*
  %9 = getelementptr inbounds %"struct.std::_Vector_base", %"struct.std::_Vector_base"* %8, i32 0, i32 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s485792050.cpp() #0 section ".text.startup" {
