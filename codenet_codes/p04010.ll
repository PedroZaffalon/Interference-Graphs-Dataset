; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p04010/s893860583.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p04010/s893860583.cpp"
...
@col = global [100010 x i32] zeroinitializer, align 16
@sum = global [100010 x i32] zeroinitializer, align 16
@K = global [100010 x i32] zeroinitializer, align 16
@que = global [100010 x i32] zeroinitializer, align 16
@res = global i64 0, align 8
@hd = global [100010 x i32] zeroinitializer, align 16
@to = global [200020 x i32] zeroinitializer, align 16
@nxt = global [200020 x i32] zeroinitializer, align 16
@ecnt = global i32 0, align 4
@.str = private unnamed_addr constant [5 x i8] c"%d%d\00", align 1
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s893860583.cpp, i8* null }]
...
define void @_Z4addEii(i32 %0, i32 %1) #4 {
  ...
  %5 = sext i32 %4 to i64
  %6 = getelementptr inbounds [200020 x i32], [200020 x i32]* @to, i64 0, i64 %5
  store i32 %1, i32* %6, align 4
  %7 = sext i32 %0 to i64
  %8 = getelementptr inbounds [100010 x i32], [100010 x i32]* @hd, i64 0, i64 %7
  %9 = load i32, i32* %8, align 4
  %10 = load i32, i32* @ecnt, align 4
  %11 = sext i32 %10 to i64
  %12 = getelementptr inbounds [200020 x i32], [200020 x i32]* @nxt, i64 0, i64 %11
  store i32 %9, i32* %12, align 4
  %13 = load i32, i32* @ecnt, align 4
  %14 = sext i32 %0 to i64
  %15 = getelementptr inbounds [100010 x i32], [100010 x i32]* @hd, i64 0, i64 %14
  store i32 %13, i32* %15, align 4
  ret void
}

; Function Attrs: noinline nounwind uwtable
define void @_Z3daeii(i32 %0, i32 %1) #4 {
...
; Function Attrs: noinline uwtable
define void @_Z4dfs1iiii(i32 %0, i32 %1, i32 %2, i32 %3) #0 {
  %5 = sext i32 %0 to i64
  %6 = getelementptr inbounds [100010 x i32], [100010 x i32]* @dep, i64 0, i64 %5
  store i32 %3, i32* %6, align 4
  %7 = sext i32 %0 to i64
  %8 = getelementptr inbounds [100010 x i32], [100010 x i32]* @col, i64 0, i64 %7
  store i32 %2, i32* %8, align 4
  %9 = sext i32 %0 to i64
  %10 = getelementptr inbounds [100010 x i32], [100010 x i32]* @hd, i64 0, i64 %9
  %11 = load i32, i32* %10, align 4
  br label %12

12:                                               ; preds = %38, %4
  %.0 = phi i32 [ %11, %4 ], [ %41, %38 ]
  %13 = sext i32 %.0 to i64
  %14 = getelementptr inbounds [200020 x i32], [200020 x i32]* @to, i64 0, i64 %13
...
24:                                               ; preds = %19
  %25 = sub nsw i32 0, %2
  %26 = add nsw i32 %3, 1
  call void @_Z4dfs1iiii(i32 %15, i32 %0, i32 %25, i32 %26)
  br label %36

27:                                               ; preds = %19
  store i32 %0, i32* @px, align 4
  store i32 %15, i32* @py, align 4
  %28 = sext i32 %0 to i64
  %29 = getelementptr inbounds [100010 x i32], [100010 x i32]* @dep, i64 0, i64 %28
...
38:                                               ; preds = %37
  ...
  %40 = getelementptr inbounds [200020 x i32], [200020 x i32]* @nxt, i64 0, i64 %39
...
; Function Attrs: noinline nounwind uwtable
define zeroext i1 @_Z7preworkv() #4 {
  br label %1
...
4:                                                ; preds = %1
  ...
  %6 = getelementptr inbounds [100010 x i32], [100010 x i32]* @col, i64 0, i64 %5
...
31:                                               ; preds = %30, %29, %19
  %.0 = phi i1 [ false, %29 ], [ true, %30 ], [ false, %19 ]
  ret i1 %.0
}
...
4:                                                ; preds = %2
  call void @llvm.memset.p0i8.i64(i8* align 16 bitcast ([100010 x i32]* @dep to i8*), i8 0, i64 400040, i1 false)
  br label %5
...
5:                                                ; preds = %4, %2
  ...
  %8 = sext i32 %0 to i64
  %9 = getelementptr inbounds [100010 x i32], [100010 x i32]* @col, i64 0, i64 %8
  %10 = load i32, i32* %9, align 4
  %11 = sext i32 %0 to i64
  %12 = getelementptr inbounds [100010 x i32], [100010 x i32]* @sum, i64 0, i64 %11
  store i32 %10, i32* %12, align 4
  %13 = sext i32 %0 to i64
  %14 = getelementptr inbounds [100010 x i32], [100010 x i32]* @hd, i64 0, i64 %13
  %15 = load i32, i32* %14, align 4
  br label %16

16:                                               ; preds = %42, %5
  %.0 = phi i32 [ %15, %5 ], [ %45, %42 ]
  %17 = sext i32 %.0 to i64
  %18 = getelementptr inbounds [200020 x i32], [200020 x i32]* @to, i64 0, i64 %17
...
21:                                               ; preds = %16
  ...
  %23 = getelementptr inbounds [100010 x i32], [100010 x i32]* @dep, i64 0, i64 %22
  %24 = load i32, i32* %23, align 4
  %25 = icmp ne i32 %24, 0
  br i1 %25, label %41, label %26

26:                                               ; preds = %21
  call void @_Z4dfs2ii(i32 %19, i32 %0)
  %27 = sext i32 %19 to i64
  %28 = getelementptr inbounds [100010 x i32], [100010 x i32]* @sum, i64 0, i64 %27
  %29 = load i32, i32* %28, align 4
  %30 = sext i32 %0 to i64
  %31 = getelementptr inbounds [100010 x i32], [100010 x i32]* @sum, i64 0, i64 %30
  %32 = load i32, i32* %31, align 4
  %33 = add nsw i32 %32, %29
  store i32 %33, i32* %31, align 4
  %34 = sext i32 %19 to i64
  %35 = getelementptr inbounds [100010 x i32], [100010 x i32]* @K, i64 0, i64 %34
  %36 = load i32, i32* %35, align 4
  %37 = sext i32 %0 to i64
  %38 = getelementptr inbounds [100010 x i32], [100010 x i32]* @K, i64 0, i64 %37
...
42:                                               ; preds = %41
  ...
  %44 = getelementptr inbounds [200020 x i32], [200020 x i32]* @nxt, i64 0, i64 %43
...
7:                                                ; preds = %4
  ...
  call void @_Z3daeii(i32 %9, i32 %10)
  br label %11
...
13:                                               ; preds = %4
  call void @_Z4dfs1iiii(i32 1, i32 1, i32 1, i32 1)
  %14 = call zeroext i1 @_Z7preworkv()
...
21:                                               ; preds = %17
  ...
  %27 = getelementptr inbounds [100010 x i32], [100010 x i32]* @sum, i64 0, i64 %26
  %28 = load i32, i32* %27, align 4
  %29 = add nsw i32 %28, %24
  store i32 %29, i32* %27, align 4
  %30 = load i32, i32* @tot, align 4
  %31 = load i32, i32* @py, align 4
  %32 = sext i32 %31 to i64
  %33 = getelementptr inbounds [100010 x i32], [100010 x i32]* @sum, i64 0, i64 %32
  %34 = load i32, i32* %33, align 4
  %35 = sub nsw i32 %34, %30
  store i32 %35, i32* %33, align 4
  %36 = load i32, i32* @tot, align 4
  %37 = call i32 @abs(i32 %36) #10
...
41:                                               ; preds = %17
  %42 = load i32, i32* @px, align 4
  %43 = sext i32 %42 to i64
  %44 = getelementptr inbounds [100010 x i32], [100010 x i32]* @K, i64 0, i64 %43
  %45 = load i32, i32* %44, align 4
  %46 = add nsw i32 %45, 1
  store i32 %46, i32* %44, align 4
  %47 = load i32, i32* @py, align 4
  %48 = sext i32 %47 to i64
  %49 = getelementptr inbounds [100010 x i32], [100010 x i32]* @K, i64 0, i64 %48
...
53:                                               ; preds = %81, %52
  %.03 = phi i32 [ 1, %52 ], [ %82, %81 ]
  %.02 = phi i32 [ 0, %52 ], [ %.1, %81 ]
...
56:                                               ; preds = %53
  ...
  %58 = getelementptr inbounds [100010 x i32], [100010 x i32]* @K, i64 0, i64 %57
...
61:                                               ; preds = %56
  ...
  %63 = getelementptr inbounds [100010 x i32], [100010 x i32]* @sum, i64 0, i64 %62
...
69:                                               ; preds = %56
  ...
  %71 = getelementptr inbounds [100010 x i32], [100010 x i32]* @K, i64 0, i64 %70
  %72 = load i32, i32* %71, align 4
  %73 = sext i32 %.03 to i64
  %74 = getelementptr inbounds [100010 x i32], [100010 x i32]* @sum, i64 0, i64 %73
  %75 = load i32, i32* %74, align 4
  %76 = mul nsw i32 %72, %75
  %77 = add nsw i32 %.02, 1
  %78 = sext i32 %77 to i64
  %79 = getelementptr inbounds [100010 x i32], [100010 x i32]* @que, i64 0, i64 %78
  store i32 %76, i32* %79, align 4
  br label %80

80:                                               ; preds = %69, %61
  %.1 = phi i32 [ %77, %69 ], [ %.02, %61 ]
  br label %81
...
83:                                               ; preds = %53
  ...
  %85 = getelementptr inbounds i32, i32* getelementptr inbounds ([100010 x i32], [100010 x i32]* @que, i32 0, i32 0), i64 %84
  %86 = getelementptr inbounds i32, i32* %85, i64 1
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([100010 x i32], [100010 x i32]* @que, i32 0, i64 1), i32* %86)
  %87 = add nsw i32 %.02, 1
  %88 = ashr i32 %87, 1
  %89 = sext i32 %88 to i64
  %90 = getelementptr inbounds [100010 x i32], [100010 x i32]* @que, i64 0, i64 %89
  %91 = load i32, i32* %90, align 4
  %92 = call i32 @abs(i32 %91) #10
...
96:                                               ; preds = %107, %83
  %.04 = phi i32 [ 1, %83 ], [ %108, %107 ]
  %97 = icmp sle i32 %.04, %.02
  br i1 %97, label %98, label %109

98:                                               ; preds = %96
  %99 = sext i32 %.04 to i64
  %100 = getelementptr inbounds [100010 x i32], [100010 x i32]* @que, i64 0, i64 %99
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s893860583.cpp() #0 section ".text.startup" {
