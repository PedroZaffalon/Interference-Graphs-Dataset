; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02574/s775797713.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02574/s775797713.cpp"
...
@.str.2 = private unnamed_addr constant [11 x i8] c"outputf.in\00", align 1
@.str.3 = private unnamed_addr constant [2 x i8] c"w\00", align 1
@stdout = external global %struct._IO_FILE*, align 8
@.str.4 = private unnamed_addr constant [16 x i8] c"setwise coprime\00", align 1
@.str.5 = private unnamed_addr constant [17 x i8] c"pairwise coprime\00", align 1
@.str.6 = private unnamed_addr constant [12 x i8] c"not coprime\00", align 1
@.str.7 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s775797713.cpp, i8* null }]
...
define i32 @main() #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  invoke void @_ZNSt6vectorIiSaIiEEC2EmRKS0_(%"class.std::vector"* %2, i64 %37, %"class.std::allocator"* dereferenceable(1) %3)
...
57:                                               ; preds = %39
  ...
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1EPKcRKS3_(%"class.std::__cxx11::basic_string"* %4, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.4, i32 0, i32 0), %"class.std::allocator.0"* dereferenceable(1) %5)
...
58:                                               ; preds = %57
  ...
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1EPKcRKS3_(%"class.std::__cxx11::basic_string"* %6, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.5, i32 0, i32 0), %"class.std::allocator.0"* dereferenceable(1) %7)
...
59:                                               ; preds = %58
  ...
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1EPKcRKS3_(%"class.std::__cxx11::basic_string"* %8, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.6, i32 0, i32 0), %"class.std::allocator.0"* dereferenceable(1) %9)
...
60:                                               ; preds = %59
  ...
  invoke void @_ZNSt6vectorIiSaIiEEC2EmRKiRKS0_(%"class.std::vector"* %10, i64 1001, i32* dereferenceable(4) %11, %"class.std::allocator"* dereferenceable(1) %12)
...
61:                                               ; preds = %60
  ...
  %70 = invoke i32* @_ZSt11max_elementIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEET_S7_S7_(i32* %67, i32* %69)
...
75:                                               ; preds = %141, %71
  %.013 = phi i32 [ 0, %71 ], [ %142, %141 ]
  %.09 = phi i32 [ 1, %71 ], [ %.211, %141 ]
...
84:                                               ; preds = %78
  %85 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %10, i64 1) #3
  %86 = load i32, i32* %85, align 4
  %87 = add nsw i32 %86, 1
  store i32 %87, i32* %85, align 4
  %88 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %10, i64 1) #3
...
108:                                              ; preds = %176, %174, %171, %169, %164, %162, %149, %61
...
114:                                              ; preds = %137, %113
  %.014 = phi i32 [ 3, %113 ], [ %138, %137 ]
  %115 = mul nsw i32 %.014, %.014
...
137:                                              ; preds = %136
  %138 = add nsw i32 %.014, 2
  br label %114

139:                                              ; preds = %134, %114
  %.110 = phi i32 [ 0, %134 ], [ %.09, %114 ]
  br label %140

140:                                              ; preds = %139, %112
  %.211 = phi i32 [ %.09, %112 ], [ %.110, %139 ]
  br label %141

141:                                              ; preds = %140
  %142 = add nsw i32 %.013, 1
  br label %75

143:                                              ; preds = %91, %75
  %.312 = phi i32 [ 0, %91 ], [ %.09, %75 ]
  %144 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %2, i64 0) #3
  %145 = load i32, i32* %144, align 4
  br label %146

146:                                              ; preds = %155, %143
  %.015 = phi i32 [ %145, %143 ], [ %153, %155 ]
  %.07 = phi i32 [ 1, %143 ], [ %156, %155 ]
...
149:                                              ; preds = %146
  ...
  %153 = invoke i32 @_ZSt5__gcdIiET_S0_S0_(i32 %.015, i32 %152)
...
155:                                              ; preds = %154
  %156 = add nsw i32 %.07, 1
  br label %146

157:                                              ; preds = %146
  %158 = icmp ne i32 %.015, 1
...
160:                                              ; preds = %159, %157
  %.08 = phi i32 [ 0, %159 ], [ 1, %157 ]
  %161 = icmp ne i32 %.312, 0
  br i1 %161, label %162, label %167

162:                                              ; preds = %160
  %163 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsIcSt11char_traitsIcESaIcEERSt13basic_ostreamIT_T0_ES7_RKNSt7__cxx1112basic_stringIS4_S5_T1_EE(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, %"class.std::__cxx11::basic_string"* dereferenceable(32) %6)
          to label %164 unwind label %108

164:                                              ; preds = %162
  %165 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %163, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.7, i32 0, i32 0))
...
167:                                              ; preds = %160
  %168 = icmp ne i32 %.08, 0
  br i1 %168, label %169, label %174

169:                                              ; preds = %167
  %170 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsIcSt11char_traitsIcESaIcEERSt13basic_ostreamIT_T0_ES7_RKNSt7__cxx1112basic_stringIS4_S5_T1_EE(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, %"class.std::__cxx11::basic_string"* dereferenceable(32) %4)
...
174:                                              ; preds = %167
  %175 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsIcSt11char_traitsIcESaIcEERSt13basic_ostreamIT_T0_ES7_RKNSt7__cxx1112basic_stringIS4_S5_T1_EE(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, %"class.std::__cxx11::basic_string"* dereferenceable(32) %8)
          to label %176 unwind label %108

176:                                              ; preds = %174
  %177 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %175, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.7, i32 0, i32 0))
...
181:                                              ; preds = %108, %104
  ...
  %.0 = phi i8* [ %110, %108 ], [ %106, %104 ]
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED1Ev(%"class.std::__cxx11::basic_string"* %8) #3
  br label %182

182:                                              ; preds = %181, %100
  %.12 = phi i32 [ %.01, %181 ], [ %103, %100 ]
  %.1 = phi i8* [ %.0, %181 ], [ %102, %100 ]
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED1Ev(%"class.std::__cxx11::basic_string"* %6) #3
  br label %183

183:                                              ; preds = %182, %96
  %.23 = phi i32 [ %.12, %182 ], [ %99, %96 ]
  %.2 = phi i8* [ %.1, %182 ], [ %98, %96 ]
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED1Ev(%"class.std::__cxx11::basic_string"* %4) #3
  br label %184

184:                                              ; preds = %183, %92, %53
  %.34 = phi i32 [ %56, %53 ], [ %.23, %183 ], [ %95, %92 ]
  %.3 = phi i8* [ %55, %53 ], [ %.2, %183 ], [ %94, %92 ]
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %2) #3
  br label %185

185:                                              ; preds = %184, %49
  %.45 = phi i32 [ %.34, %184 ], [ %52, %49 ]
  %.4 = phi i8* [ %.3, %184 ], [ %51, %49 ]
  %186 = insertvalue { i8*, i32 } undef, i8* %.4, 0
  %187 = insertvalue { i8*, i32 } %186, i32 %.45, 1
  resume { i8*, i32 } %187
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i32 @_ZSt5__gcdIiET_S0_S0_(i32 %0, i32 %1) #5 comdat {
  br label %3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s775797713.cpp() #0 section ".text.startup" {
