; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00969/s578553011.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00969/s578553011.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s578553011.cpp, i8* null }]
...
38:                                               ; preds = %152, %149, %139, %101, %60, %42, %27
...
60:                                               ; preds = %57
  ...
  %73 = call i32* @_ZNK9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEplEl(%"class.__gnu_cxx::__normal_iterator"* %10, i64 %72) #3
  ...
  %83 = invoke i32* @_ZSt11lower_boundIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEiET_S7_S7_RKT0_(i32* %80, i32* %82, i32* dereferenceable(4) %11)
...
84:                                               ; preds = %60
  ...
  %88 = call i64 @_ZN9__gnu_cxxmiIPiSt6vectorIiSaIiEEEENS_17__normal_iteratorIT_T0_E15difference_typeERKS8_SB_(%"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %7, %"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %12) #3
  %89 = sext i32 %.04 to i64
  %90 = icmp eq i64 %88, %89
  br i1 %90, label %99, label %91

91:                                               ; preds = %84
  %92 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %2, i64 %88) #3
  %93 = load i32, i32* %92, align 4
  %94 = sext i32 %.04 to i64
  %95 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %2, i64 %94) #3
  %96 = load i32, i32* %95, align 4
  %97 = sub nsw i32 %96, %67
...
100:                                              ; preds = %135, %99
  %.0 = phi i32 [ %.05, %99 ], [ %136, %135 ]
  br label %101

101:                                              ; preds = %100
  %102 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector"* %2) #3
  ...
  %105 = call i32* @_ZNK9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEplEl(%"class.__gnu_cxx::__normal_iterator"* %16, i64 %104) #3
  ...
  %117 = invoke i32* @_ZSt11lower_boundIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEiET_S7_S7_RKT0_(i32* %114, i32* %116, i32* dereferenceable(4) %18)
...
118:                                              ; preds = %101
  ...
  %122 = call i64 @_ZN9__gnu_cxxmiIPiSt6vectorIiSaIiEEEENS_17__normal_iteratorIT_T0_E15difference_typeERKS8_SB_(%"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %14, %"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %19) #3
...
126:                                              ; preds = %118
  %127 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %2, i64 %122) #3
...
139:                                              ; preds = %134
  %140 = invoke dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* dereferenceable(4) %6, i32* dereferenceable(4) %13)
...
155:                                              ; preds = %38, %34
  ...
  %156 = insertvalue { i8*, i32 } undef, i8* %.01, 0
  %157 = insertvalue { i8*, i32 } %156, i32 %.02, 1
  resume { i8*, i32 } %157
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s578553011.cpp() #0 section ".text.startup" {
