; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02814/s089950795.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02814/s089950795.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s089950795.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %16 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERx(%"class.std::basic_istream"* @_ZSt3cin, i64* dereferenceable(8) %15)
...
35:                                               ; preds = %61, %32
  %.05 = phi i32 [ 0, %32 ], [ %62, %61 ]
  %.04 = phi i64 [ %34, %32 ], [ %52, %61 ]
...
72:                                               ; preds = %71, %59
  %.06 = phi i32 [ 1, %59 ], [ 0, %71 ]
  call void @_ZNSt6vectorIxSaIxEED2Ev(%"class.std::vector"* %3) #3
  switch i32 %.06, label %77 [
    i32 0, label %73
    i32 1, label %73
  ]
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s089950795.cpp() #0 section ".text.startup" {
