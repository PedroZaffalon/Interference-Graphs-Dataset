; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02483/s409571214.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02483/s409571214.cpp"
...
24:                                               ; preds = %23, %22
  %25 = phi [2 x i8]* [ @.str, %22 ], [ @.str.1, %23 ]
  %26 = getelementptr inbounds [2 x i8], [2 x i8]* %25, i32 0, i32 0
  %27 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %20, i8* %26)
  br label %28
