; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01839/s357492339.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01839/s357492339.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s357492339.cpp, i8* null }]
...
16:                                               ; preds = %14
  %17 = invoke zeroext i1 @_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_(%"class.std::__cxx11::basic_string"* dereferenceable(32) %2, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
...
35:                                               ; preds = %34, %33
  %.04 = phi i32 [ 1, %33 ], [ 0, %34 ]
  %.1 = phi i32 [ 0, %33 ], [ %.0, %34 ]
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED1Ev(%"class.std::__cxx11::basic_string"* %2) #3
  switch i32 %.04, label %47 [
    i32 0, label %36
    i32 1, label %43
  ]
...
43:                                               ; preds = %42, %35, %7
  %.2 = phi i32 [ 0, %7 ], [ %.1, %35 ], [ 0, %42 ]
  ret i32 %.2

44:                                               ; preds = %21
  %45 = insertvalue { i8*, i32 } undef, i8* %23, 0
  %46 = insertvalue { i8*, i32 } %45, i32 %24, 1
  resume { i8*, i32 } %46
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s357492339.cpp() #0 section ".text.startup" {
