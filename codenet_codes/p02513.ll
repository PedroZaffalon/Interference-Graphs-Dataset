; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02513/s417365645.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02513/s417365645.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s417365645.cpp, i8* null }]
...
8:                                                ; preds = %16, %7
  %.02 = phi i32 [ %1, %7 ], [ %.13, %16 ]
  %.01 = phi i32 [ %0, %7 ], [ %.1, %16 ]
  %9 = icmp ne i32 %.01, %.02
  br i1 %9, label %10, label %17

10:                                               ; preds = %8
  %11 = icmp sgt i32 %.01, %.02
  br i1 %11, label %12, label %14

12:                                               ; preds = %10
  %13 = sub nsw i32 %.01, %.02
  br label %16

14:                                               ; preds = %10
  %15 = sub nsw i32 %.02, %.01
  br label %16

16:                                               ; preds = %14, %12
  %.13 = phi i32 [ %.02, %12 ], [ %15, %14 ]
...
7:                                                ; preds = %4
  %8 = call i32 @_Z3gcdii(i32 %0, i32 %1)
  %9 = sdiv i32 %0, %8
  %10 = mul nsw i32 %9, %1
  br label %11
...
39:                                               ; preds = %169, %167, %164, %159, %149, %123, %43, %35, %33
...
57:                                               ; preds = %78, %56
  %.08 = phi i32 [ 0, %56 ], [ %79, %78 ]
  %58 = icmp slt i32 %.08, %.09
...
84:                                               ; preds = %147, %83
  %.07 = phi i32 [ 0, %83 ], [ %148, %147 ]
  %.02 = phi i32 [ %29, %83 ], [ %.35, %147 ]
  %.01 = phi i64 [ %28, %83 ], [ %.3, %147 ]
...
115:                                              ; preds = %144, %93
  %.13 = phi i32 [ %114, %93 ], [ %.24, %144 ]
  %.1 = phi i64 [ %108, %93 ], [ %.2, %144 ]
  %.0 = phi i32 [ 0, %93 ], [ %145, %144 ]
  %116 = icmp slt i32 %.0, %.07
...
123:                                              ; preds = %117
  ...
  %130 = invoke i32 @_Z3lcmii(i32 %126, i32 %129)
...
131:                                              ; preds = %123
  ...
  %143 = add nsw i32 %.13, %142
  br label %144

144:                                              ; preds = %131, %122
  %.24 = phi i32 [ %.13, %122 ], [ %143, %131 ]
  %.2 = phi i64 [ %.1, %122 ], [ %140, %131 ]
  %145 = add nsw i32 %.0, 1
  br label %115
...
147:                                              ; preds = %146, %92
  %.35 = phi i32 [ %.02, %92 ], [ %.13, %146 ]
  %.3 = phi i64 [ %.01, %92 ], [ %.1, %146 ]
  %148 = add nsw i32 %.07, 1
  br label %84
...
149:                                              ; preds = %84
  ...
  %155 = bitcast i8* %154 to %"class.std::ios_base"*
  %156 = invoke i64 @_ZNSt8ios_base9precisionEl(%"class.std::ios_base"* %155, i64 10)
          to label %157 unwind label %39

157:                                              ; preds = %149
  %158 = icmp ne i32 %.02, 0
  br i1 %158, label %159, label %167

159:                                              ; preds = %157
  %160 = sitofp i64 %.01 to double
  %161 = sitofp i32 %.02 to double
...
167:                                              ; preds = %157
  %168 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEd(%"class.std::basic_ostream"* @_ZSt4cout, double 0.000000e+00)
...
173:                                              ; preds = %39
  %174 = insertvalue { i8*, i32 } undef, i8* %41, 0
  %175 = insertvalue { i8*, i32 } %174, i32 %42, 1
  resume { i8*, i32 } %175
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s417365645.cpp() #0 section ".text.startup" {
