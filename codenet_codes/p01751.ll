; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01751/s250299166.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01751/s250299166.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s250299166.cpp, i8* null }]
...
7:                                                ; preds = %31, %0
  ...
  %.01 = phi i32 [ 0, %0 ], [ %30, %31 ]
  %8 = icmp slt i32 %.02, 61
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s250299166.cpp() #0 section ".text.startup" {
