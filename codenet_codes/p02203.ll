; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02203/s161848284.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02203/s161848284.c"
...
1:                                                ; preds = %13, %0
  %.02 = phi i64 [ 0, %0 ], [ %.1, %13 ]
  %.01 = phi i64 [ 20000000000000007, %0 ], [ %12, %13 ]
  %.0 = phi i64 [ 0, %0 ], [ %14, %13 ]
...
4:                                                ; preds = %1
  %5 = getelementptr inbounds [5242880 x i64], [5242880 x i64]* @a, i64 0, i64 %.0
  %6 = load i64, i64* %5, align 8
  %7 = icmp sge i64 %.01, %6
...
10:                                               ; preds = %8, %4
  %.1 = phi i64 [ %9, %8 ], [ %.02, %4 ]
  %11 = getelementptr inbounds [5242880 x i64], [5242880 x i64]* @a, i64 0, i64 %.0
  %12 = load i64, i64* %11, align 8
  br label %13
...
15:                                               ; preds = %1
  %16 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i32 0, i32 0), i64 %.02)
  %17 = load i64, i64* @n, align 8
  %18 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i32 0, i32 0), i64 %17)
  br label %23

19:                                               ; No predecessors!
  %20 = call i32 @puts(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i32 0, i32 0))
  store i64 0, i64* poison, align 8
  br label %23

21:                                               ; No predecessors!
  %22 = call i32 @puts(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i32 0, i32 0))
...
8:                                                ; preds = %4
  %9 = sext i32 %.0 to i64
  %10 = getelementptr inbounds [5242880 x i64], [5242880 x i64]* @a, i64 0, i64 %9
  %11 = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.5, i32 0, i32 0), i64* %10)
  br label %12
