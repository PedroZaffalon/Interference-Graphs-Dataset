; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03694/s890355850.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03694/s890355850.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s890355850.cpp, i8* null }]
...
5:                                                ; preds = %2
  %6 = sext i32 %.0 to i64
  %7 = getelementptr inbounds [110 x i32], [110 x i32]* @a, i64 0, i64 %6
...
11:                                               ; preds = %2
  ...
  %14 = getelementptr inbounds i32, i32* getelementptr inbounds ([110 x i32], [110 x i32]* @a, i32 0, i32 0), i64 %13
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([110 x i32], [110 x i32]* @a, i32 0, i32 0), i32* %14)
  %15 = load i32, i32* @n, align 4
  %16 = sub nsw i32 %15, 1
  %17 = sext i32 %16 to i64
  %18 = getelementptr inbounds [110 x i32], [110 x i32]* @a, i64 0, i64 %17
  %19 = load i32, i32* %18, align 4
  %20 = load i32, i32* getelementptr inbounds ([110 x i32], [110 x i32]* @a, i64 0, i64 0), align 16
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s890355850.cpp() #0 section ".text.startup" {
