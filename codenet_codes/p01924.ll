; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01924/s399354818.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01924/s399354818.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s399354818.cpp, i8* null }]
...
23:                                               ; preds = %30, %22
  %.014 = phi i64 [ 1, %22 ], [ %31, %30 ]
  %24 = load i64, i64* %1, align 8
  %25 = icmp sle i64 %.014, %24
  br i1 %25, label %26, label %40

26:                                               ; preds = %23
  %27 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %4, i64 %.014) #3
...
41:                                               ; preds = %81, %40
  %.09 = phi i64 [ 0, %40 ], [ %.110, %81 ]
  %.06 = phi i64 [ 0, %40 ], [ %.28, %81 ]
  %.02 = phi i64 [ 0, %40 ], [ %.4, %81 ]
  %.01 = phi i8 [ 0, %40 ], [ %.3, %81 ]
  %.0 = phi i32 [ 1, %40 ], [ %82, %81 ]
...
64:                                               ; preds = %60, %55
  %.17 = phi i64 [ %56, %55 ], [ %.06, %60 ]
  %.13 = phi i64 [ %59, %55 ], [ %63, %60 ]
  %.1 = phi i8 [ 1, %55 ], [ %.01, %60 ]
  br label %65

65:                                               ; preds = %64, %45
  %.28 = phi i64 [ %.17, %64 ], [ %.06, %45 ]
  %.24 = phi i64 [ %.13, %64 ], [ %.02, %45 ]
  %.2 = phi i8 [ %.1, %64 ], [ %.01, %45 ]
  %66 = sext i32 %.0 to i64
  %67 = icmp sle i64 %.24, %66
...
77:                                               ; preds = %75, %72
  %.35 = phi i64 [ %76, %75 ], [ %.24, %72 ]
  %78 = sub nsw i64 %.35, %.28
  %79 = add nsw i64 %.09, %78
  br label %80

80:                                               ; preds = %77, %68, %65
  %.110 = phi i64 [ %79, %77 ], [ %.09, %68 ], [ %.09, %65 ]
  %.4 = phi i64 [ %.35, %77 ], [ %.24, %68 ], [ %.24, %65 ]
  %.3 = phi i8 [ 0, %77 ], [ %.2, %68 ], [ %.2, %65 ]
  br label %81
...
83:                                               ; preds = %41
  %84 = trunc i8 %.01 to i1
  br i1 %84, label %85, label %89

85:                                               ; preds = %83
  %86 = load i64, i64* %1, align 8
  %87 = sub nsw i64 %86, %.06
  %88 = add nsw i64 %.09, %87
  br label %89

89:                                               ; preds = %85, %83
  %.211 = phi i64 [ %88, %85 ], [ %.09, %83 ]
  %90 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEx(%"class.std::basic_ostream"* @_ZSt4cout, i64 %.211)
...
95:                                               ; preds = %36, %32
  %.013 = phi i32 [ %39, %36 ], [ %35, %32 ]
  %.012 = phi i8* [ %38, %36 ], [ %34, %32 ]
  %96 = insertvalue { i8*, i32 } undef, i8* %.012, 0
  %97 = insertvalue { i8*, i32 } %96, i32 %.013, 1
  resume { i8*, i32 } %97
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s399354818.cpp() #0 section ".text.startup" {
