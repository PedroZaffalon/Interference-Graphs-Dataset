; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02472/s951030410.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02472/s951030410.c"
...
22:                                               ; preds = %20, %16
  ...
  %26 = call i32 @mpAddSub(i32* getelementptr inbounds ([12000 x i32], [12000 x i32]* @s, i32 0, i32 0), i32* getelementptr inbounds ([12000 x i32], [12000 x i32]* @a, i32 0, i32 0), i32 %24, i32* getelementptr inbounds ([12000 x i32], [12000 x i32]* @b, i32 0, i32 0), i32 %25)
  %27 = icmp ne i32 %26, 0
...
30:                                               ; preds = %28, %22
  ...
  %31 = call i32 @puts(i8* getelementptr inbounds ([200100 x i8], [200100 x i8]* @buf, i32 0, i32 0))
  ret i32 0
}
