; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03386/s030603739.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03386/s030603739.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s030603739.cpp, i8* null }]
...
24:                                               ; preds = %17
  %25 = invoke { %"struct.std::_Rb_tree_node_base"*, i8 } @_ZNSt3setIiSt4lessIiESaIiEE6insertERKi(%"class.std::set"* %4, i32* dereferenceable(4) %5)
          to label %26 unwind label %35

26:                                               ; preds = %24
  %27 = bitcast %"struct.std::pair"* %6 to { %"struct.std::_Rb_tree_node_base"*, i8 }*
...
49:                                               ; preds = %42
  %50 = invoke { %"struct.std::_Rb_tree_node_base"*, i8 } @_ZNSt3setIiSt4lessIiESaIiEE6insertERKi(%"class.std::set"* %4, i32* dereferenceable(4) %7)
...
60:                                               ; preds = %42
  %61 = call %"struct.std::_Rb_tree_node_base"* @_ZNKSt3setIiSt4lessIiESaIiEE5beginEv(%"class.std::set"* %4) #3
...
63:                                               ; preds = %74, %60
  %64 = call %"struct.std::_Rb_tree_node_base"* @_ZNKSt3setIiSt4lessIiESaIiEE3endEv(%"class.std::set"* %4) #3
  ...
  %66 = call zeroext i1 @_ZNKSt23_Rb_tree_const_iteratorIiEneERKS0_(%"struct.std::_Rb_tree_const_iterator"* %9, %"struct.std::_Rb_tree_const_iterator"* dereferenceable(8) %10) #3
  br i1 %66, label %67, label %77

67:                                               ; preds = %63
  %68 = call dereferenceable(4) i32* @_ZNKSt23_Rb_tree_const_iteratorIiEdeEv(%"struct.std::_Rb_tree_const_iterator"* %9) #3
...
78:                                               ; preds = %35
  %79 = insertvalue { i8*, i32 } undef, i8* %37, 0
  %80 = insertvalue { i8*, i32 } %79, i32 %38, 1
  resume { i8*, i32 } %80
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s030603739.cpp() #0 section ".text.startup" {
