; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02434/s816965244.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02434/s816965244.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s816965244.cpp, i8* null }]
...
define i32 @main() #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %11 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* %10, i32* dereferenceable(4) %1)
...
28:                                               ; preds = %63, %61, %56, %49, %34, %32, %20, %18
...
34:                                               ; preds = %32
  ...
  invoke void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector.0"* %37, i32* dereferenceable(4) %7)
...
39:                                               ; preds = %22
  ...
  %45 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector.0"* %42) #3
...
49:                                               ; preds = %47
  ...
  %54 = select i1 %52, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.1, i32 0, i32 0)
...
56:                                               ; preds = %49
  %57 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %55, i32 %51)
...
61:                                               ; preds = %47
  %62 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.1, i32 0, i32 0))
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s816965244.cpp() #0 section ".text.startup" {
