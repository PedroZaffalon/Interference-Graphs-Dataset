; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03611/s642502479.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03611/s642502479.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s642502479.cpp, i8* null }]
...
30:                                               ; preds = %12
  ...
  invoke void @_ZNSt6vectorIiSaIiEEC2EmRKS0_(%"class.std::vector"* %4, i64 100000, %"class.std::allocator"* dereferenceable(1) %5)
...
83:                                               ; preds = %73, %45, %26
  %.02 = phi i32 [ %29, %26 ], [ %76, %73 ], [ %48, %45 ]
  %.01 = phi i8* [ %28, %26 ], [ %75, %73 ], [ %47, %45 ]
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %2) #3
  br label %84

84:                                               ; preds = %83, %22
  %.13 = phi i32 [ %.02, %83 ], [ %25, %22 ]
  %.1 = phi i8* [ %.01, %83 ], [ %24, %22 ]
  %85 = insertvalue { i8*, i32 } undef, i8* %.1, 0
  %86 = insertvalue { i8*, i32 } %85, i32 %.13, 1
  resume { i8*, i32 } %86
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s642502479.cpp() #0 section ".text.startup" {
