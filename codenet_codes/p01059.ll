; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01059/s077455337.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01059/s077455337.cpp"
...
@________init = global %struct.init zeroinitializer, align 1
@_ZSt3cin = external global %"class.std::basic_istream", align 8
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s077455337.cpp, i8* null }]
...
define internal void @__cxx_global_var_init.1() #0 section ".text.startup" {
  call void @_ZN4initC2Ev(%struct.init* @________init)
  ret void
}
...
36:                                               ; preds = %20
  ...
  %44 = invoke dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* dereferenceable(4) %7, i32* dereferenceable(4) %8)
...
45:                                               ; preds = %36
  ...
  %50 = invoke dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* dereferenceable(4) %7, i32* dereferenceable(4) %9)
...
56:                                               ; preds = %53
  ...
  %66 = invoke dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* dereferenceable(4) %7, i32* dereferenceable(4) %10)
...
77:                                               ; preds = %32, %28
  %.01 = phi i32 [ %35, %32 ], [ %31, %28 ]
  %.0 = phi i8* [ %34, %32 ], [ %30, %28 ]
  %78 = insertvalue { i8*, i32 } undef, i8* %.0, 0
  %79 = insertvalue { i8*, i32 } %78, i32 %.01, 1
  resume { i8*, i32 } %79
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s077455337.cpp() #0 section ".text.startup" {
