; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02475/s238249062.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02475/s238249062.c"
...
68:                                               ; preds = %77, %67
  %.02 = phi i32 [ 0, %67 ], [ %.1, %77 ]
  %.01 = phi i32 [ 0, %67 ], [ %78, %77 ]
  %69 = icmp slt i32 %.01, 1010
  br i1 %69, label %70, label %79

70:                                               ; preds = %68
  %71 = sext i32 %.01 to i64
  %72 = getelementptr inbounds [1010 x i32], [1010 x i32]* @ans, i64 0, i64 %71
...
82:                                               ; preds = %79
  %83 = icmp sgt i32 %.02, 0
  br i1 %83, label %87, label %84

84:                                               ; preds = %82
  %85 = load i32, i32* getelementptr inbounds ([1010 x i32], [1010 x i32]* @ans, i64 0, i64 0), align 16
  %86 = icmp ne i32 %85, 0
...
90:                                               ; preds = %97, %89
  %.0 = phi i32 [ %.02, %89 ], [ %98, %97 ]
  %91 = icmp sge i32 %.0, 0
  br i1 %91, label %92, label %99

92:                                               ; preds = %90
  %93 = sext i32 %.0 to i64
  %94 = getelementptr inbounds [1010 x i32], [1010 x i32]* @ans, i64 0, i64 %93
