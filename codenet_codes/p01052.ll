; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01052/s333173203.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01052/s333173203.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s333173203.cpp, i8* null }]
...
15:                                               ; preds = %12
  ...
  %17 = call dereferenceable(8) %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EEixEm(%"class.std::vector"* %2, i64 %16) #3
...
20:                                               ; preds = %15
  ...
  %22 = call dereferenceable(8) %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EEixEm(%"class.std::vector"* %2, i64 %21) #3
  %23 = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* %22, i32 0, i32 1
  %24 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* %19, i32* dereferenceable(4) %23)
...
37:                                               ; preds = %88, %36
  %.04 = phi i32 [ 1, %36 ], [ %89, %88 ]
  %.03 = phi i32 [ 0, %36 ], [ %.1, %88 ]
  %38 = icmp sle i32 %.04, 31
...
40:                                               ; preds = %71, %39
  %.07 = phi i32 [ 0, %39 ], [ %72, %71 ]
  %.05 = phi i32 [ -1, %39 ], [ %.2, %71 ]
  %41 = sext i32 %.07 to i64
  %42 = call i64 @_ZNKSt6vectorISt4pairIiiESaIS1_EE4sizeEv(%"class.std::vector"* %2) #3
  %43 = icmp ult i64 %41, %42
  br i1 %43, label %44, label %73

44:                                               ; preds = %40
  %45 = sext i32 %.07 to i64
  %46 = call dereferenceable(8) %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EEixEm(%"class.std::vector"* %2, i64 %45) #3
  %47 = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* %46, i32 0, i32 0
  %48 = load i32, i32* %47, align 4
  %49 = icmp sle i32 %48, %.04
...
69:                                               ; preds = %68, %58
  %.16 = phi i32 [ %.07, %68 ], [ %.05, %58 ]
  br label %70

70:                                               ; preds = %69, %50, %44
  %.2 = phi i32 [ %.16, %69 ], [ %.05, %50 ], [ %.05, %44 ]
  br label %71
...
75:                                               ; preds = %73
  %76 = call %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EE5beginEv(%"class.std::vector"* %2) #3
  ...
  %81 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator.0", %"class.__gnu_cxx::__normal_iterator.0"* %4, i32 0, i32 0
  %82 = load %"struct.std::pair"*, %"struct.std::pair"** %81, align 8
  %83 = invoke %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EE5eraseEN9__gnu_cxx17__normal_iteratorIPKS1_S3_EE(%"class.std::vector"* %2, %"struct.std::pair"* %82)
...
90:                                               ; preds = %37
  %91 = sub nsw i32 31, %.03
  %92 = mul nsw i32 %91, 50
  %93 = mul nsw i32 %.03, 100
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s333173203.cpp() #0 section ".text.startup" {
