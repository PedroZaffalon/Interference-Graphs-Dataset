; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03727/s106433010.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03727/s106433010.cpp"
...
%struct.prefsum = type { [17 x i32], i32 }
...
$_ZN7prefsumixEi = comdat any

$_ZN7prefsum2idEi = comdat any
...
@e = global [100001 x %"class.std::vector"] zeroinitializer, align 16
@partof = global [1800018 x %"class.std::vector"] zeroinitializer, align 16
@sumof = global [1800018 x %"class.std::vector"] zeroinitializer, align 16
@a = global [1800018 x i32] zeroinitializer, align 16
@ps = global [100001 x %struct.prefsum] zeroinitializer, align 16
@h = global [100001 x i32] zeroinitializer, align 16
@n = global i32 0, align 4
@possible = global [100001 x i32] zeroinitializer, align 16
@pose = global i32 0, align 4
@curt = global i32 0, align 4
@.str = private unnamed_addr constant [17 x i8] c"curt + LG < MAXM\00", align 1
@.str.6 = private unnamed_addr constant [71 x i8] c"/home/pedro/tcc/exDataset/codenet/data/selection/p03727/s106433010.cpp\00", align 1
@__PRETTY_FUNCTION__._Z3dfsii = private unnamed_addr constant [19 x i8] c"void dfs(int, int)\00", align 1
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@_ZSt3cin = external global %"class.std::basic_istream", align 8
@.str.7 = private unnamed_addr constant [14 x i8] c"pose <= n - 1\00", align 1
@__PRETTY_FUNCTION__.main = private unnamed_addr constant [11 x i8] c"int main()\00", align 1
@.str.8 = private unnamed_addr constant [4 x i8] c"YES\00", align 1
@.str.9 = private unnamed_addr constant [3 x i8] c"NO\00", align 1
@.str.10 = private unnamed_addr constant [26 x i8] c"vector::_M_realloc_insert\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s106433010.cpp, i8* null }]
...
1:                                                ; preds = %1, %0
  %2 = phi %"class.std::vector"* [ getelementptr inbounds ([100001 x %"class.std::vector"], [100001 x %"class.std::vector"]* @e, i32 0, i32 0), %0 ], [ %3, %1 ]
  call void @_ZNSt6vectorIiSaIiEEC2Ev(%"class.std::vector"* %2) #3
  %3 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %2, i64 1
  %4 = icmp eq %"class.std::vector"* %3, getelementptr inbounds ([100001 x %"class.std::vector"], [100001 x %"class.std::vector"]* @e, i64 1, i64 0)
...
2:                                                ; preds = %2, %1
  %3 = phi %"class.std::vector"* [ getelementptr inbounds ([100001 x %"class.std::vector"], [100001 x %"class.std::vector"]* @e, i64 1, i64 0), %1 ], [ %4, %2 ]
  %4 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %3, i64 -1
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %4) #3
  %5 = icmp eq %"class.std::vector"* %4, getelementptr inbounds ([100001 x %"class.std::vector"], [100001 x %"class.std::vector"]* @e, i32 0, i32 0)
...
1:                                                ; preds = %1, %0
  %2 = phi %"class.std::vector"* [ getelementptr inbounds ([1800018 x %"class.std::vector"], [1800018 x %"class.std::vector"]* @partof, i32 0, i32 0), %0 ], [ %3, %1 ]
  call void @_ZNSt6vectorIiSaIiEEC2Ev(%"class.std::vector"* %2) #3
  %3 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %2, i64 1
  %4 = icmp eq %"class.std::vector"* %3, getelementptr inbounds ([1800018 x %"class.std::vector"], [1800018 x %"class.std::vector"]* @partof, i64 1, i64 0)
  br i1 %4, label %5, label %1
...
2:                                                ; preds = %2, %1
  %3 = phi %"class.std::vector"* [ getelementptr inbounds ([1800018 x %"class.std::vector"], [1800018 x %"class.std::vector"]* @partof, i64 1, i64 0), %1 ], [ %4, %2 ]
  %4 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %3, i64 -1
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %4) #3
  %5 = icmp eq %"class.std::vector"* %4, getelementptr inbounds ([1800018 x %"class.std::vector"], [1800018 x %"class.std::vector"]* @partof, i32 0, i32 0)
  br i1 %5, label %6, label %2
...
1:                                                ; preds = %1, %0
  %2 = phi %"class.std::vector"* [ getelementptr inbounds ([1800018 x %"class.std::vector"], [1800018 x %"class.std::vector"]* @sumof, i32 0, i32 0), %0 ], [ %3, %1 ]
  call void @_ZNSt6vectorIiSaIiEEC2Ev(%"class.std::vector"* %2) #3
  %3 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %2, i64 1
  %4 = icmp eq %"class.std::vector"* %3, getelementptr inbounds ([1800018 x %"class.std::vector"], [1800018 x %"class.std::vector"]* @sumof, i64 1, i64 0)
  br i1 %4, label %5, label %1
...
2:                                                ; preds = %2, %1
  %3 = phi %"class.std::vector"* [ getelementptr inbounds ([1800018 x %"class.std::vector"], [1800018 x %"class.std::vector"]* @sumof, i64 1, i64 0), %1 ], [ %4, %2 ]
  %4 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %3, i64 -1
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %4) #3
  %5 = icmp eq %"class.std::vector"* %4, getelementptr inbounds ([1800018 x %"class.std::vector"], [1800018 x %"class.std::vector"]* @sumof, i32 0, i32 0)
  br i1 %5, label %6, label %2
...
; Function Attrs: noinline nounwind uwtable
define i32 @_Z5mergeii(i32 %0, i32 %1) #4 {
  %3 = icmp eq i32 %0, 0
...
20:                                               ; preds = %17, %16, %11, %6
  %.0 = phi i32 [ 0, %6 ], [ -1, %11 ], [ 0, %16 ], [ %19, %17 ]
  ret i32 %.0
}

; Function Attrs: noinline nounwind uwtable
define void @_Z3updi(i32 %0) #4 {
  %2 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %3 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %4 = sext i32 %0 to i64
  %5 = getelementptr inbounds [1800018 x i32], [1800018 x i32]* @a, i64 0, i64 %4
  store i32 -1, i32* %5, align 4
  %6 = sext i32 %0 to i64
  %7 = getelementptr inbounds [1800018 x %"class.std::vector"], [1800018 x %"class.std::vector"]* @sumof, i64 0, i64 %6
...
14:                                               ; preds = %12
  ...
  %18 = getelementptr inbounds [1800018 x i32], [1800018 x i32]* @a, i64 0, i64 %17
  %19 = load i32, i32* %18, align 4
  %20 = sext i32 %16 to i64
  %21 = getelementptr inbounds [1800018 x i32], [1800018 x i32]* @a, i64 0, i64 %20
  %22 = load i32, i32* %21, align 4
  %23 = call i32 @_Z5mergeii(i32 %19, i32 %22)
  %24 = sext i32 %0 to i64
  %25 = getelementptr inbounds [1800018 x i32], [1800018 x i32]* @a, i64 0, i64 %24
...
6:                                                ; preds = %1
  %7 = sext i32 %0 to i64
  %8 = getelementptr inbounds [1800018 x i32], [1800018 x i32]* @a, i64 0, i64 %7
  %9 = load i32, i32* %8, align 4
  %10 = icmp ne i32 %9, -1
  br i1 %10, label %11, label %16

11:                                               ; preds = %6
  %12 = load i32, i32* @pose, align 4
  %13 = add nsw i32 %12, 1
  store i32 %13, i32* @pose, align 4
  %14 = sext i32 %12 to i64
  %15 = getelementptr inbounds [100001 x i32], [100001 x i32]* @possible, i64 0, i64 %14
...
17:                                               ; preds = %16, %1
  ...
  %19 = getelementptr inbounds [1800018 x %"class.std::vector"], [1800018 x %"class.std::vector"]* @partof, i64 0, i64 %18
  ...
  %22 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector"* %19) #3
  %23 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %3, i32 0, i32 0
  store i32* %22, i32** %23, align 8
  br label %24

24:                                               ; preds = %35, %17
  %25 = call zeroext i1 @_ZN9__gnu_cxxneIPiSt6vectorIiSaIiEEEEbRKNS_17__normal_iteratorIT_T0_EESA_(%"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %2, %"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %3) #3
...
26:                                               ; preds = %24
  ...
  call void @_Z3updi(i32 %28)
  %29 = sext i32 %28 to i64
  %30 = getelementptr inbounds [1800018 x i32], [1800018 x i32]* @a, i64 0, i64 %29
...
35:                                               ; preds = %34
  %36 = call dereferenceable(8) %"class.__gnu_cxx::__normal_iterator"* @_ZN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEppEv(%"class.__gnu_cxx::__normal_iterator"* %2) #3
  br label %24
...
; Function Attrs: noinline uwtable
define void @_Z6adedgeii(i32 %0, i32 %1) #0 {
  ...
  %9 = sext i32 %8 to i64
  %10 = getelementptr inbounds [1800018 x %"class.std::vector"], [1800018 x %"class.std::vector"]* @partof, i64 0, i64 %9
...
define void @_Z3dfsii(i32 %0, i32 %1) #0 {
  ...
  %8 = add nsw i32 %7, 1
  %9 = sext i32 %0 to i64
  %10 = getelementptr inbounds [100001 x i32], [100001 x i32]* @h, i64 0, i64 %9
  store i32 %8, i32* %10, align 4
  %11 = load i32, i32* @curt, align 4
  %12 = sext i32 %0 to i64
  %13 = getelementptr inbounds [100001 x %struct.prefsum], [100001 x %struct.prefsum]* @ps, i64 0, i64 %12
  %14 = getelementptr inbounds %struct.prefsum, %struct.prefsum* %13, i32 0, i32 1
  store i32 %11, i32* %14, align 4
  %15 = load i32, i32* @curt, align 4
  %16 = add nsw i32 %15, 17
  %17 = icmp slt i32 %16, 1800018
...
19:                                               ; preds = %2
  call void @__assert_fail(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([71 x i8], [71 x i8]* @.str.6, i32 0, i32 0), i32 97, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @__PRETTY_FUNCTION__._Z3dfsii, i32 0, i32 0)) #13
  unreachable
...
21:                                               ; preds = %20, %18
  ...
  %23 = getelementptr inbounds [100001 x %struct.prefsum], [100001 x %struct.prefsum]* @ps, i64 0, i64 %22
  %24 = call dereferenceable(4) i32* @_ZN7prefsumixEi(%struct.prefsum* %23, i32 0)
  store i32 %1, i32* %24, align 4
  %25 = load i32, i32* @curt, align 4
  %26 = load i32, i32* @curt, align 4
  %27 = sext i32 %26 to i64
  %28 = getelementptr inbounds [1800018 x i32], [1800018 x i32]* @a, i64 0, i64 %27
...
31:                                               ; preds = %29
  ...
  %33 = getelementptr inbounds [100001 x %struct.prefsum], [100001 x %struct.prefsum]* @ps, i64 0, i64 %32
  %34 = sub nsw i32 %.0, 1
  %35 = call dereferenceable(4) i32* @_ZN7prefsumixEi(%struct.prefsum* %33, i32 %34)
  %36 = load i32, i32* %35, align 4
  %37 = sext i32 %36 to i64
  %38 = getelementptr inbounds [100001 x %struct.prefsum], [100001 x %struct.prefsum]* @ps, i64 0, i64 %37
  %39 = sub nsw i32 %.0, 1
  %40 = call dereferenceable(4) i32* @_ZN7prefsumixEi(%struct.prefsum* %38, i32 %39)
  %41 = load i32, i32* %40, align 4
  %42 = sext i32 %0 to i64
  %43 = getelementptr inbounds [100001 x %struct.prefsum], [100001 x %struct.prefsum]* @ps, i64 0, i64 %42
  %44 = call dereferenceable(4) i32* @_ZN7prefsumixEi(%struct.prefsum* %43, i32 %.0)
  store i32 %41, i32* %44, align 4
  %45 = sext i32 %0 to i64
  %46 = getelementptr inbounds [100001 x %struct.prefsum], [100001 x %struct.prefsum]* @ps, i64 0, i64 %45
  %47 = call i32 @_ZN7prefsum2idEi(%struct.prefsum* %46, i32 %.0)
  %48 = sext i32 %0 to i64
  %49 = getelementptr inbounds [100001 x %struct.prefsum], [100001 x %struct.prefsum]* @ps, i64 0, i64 %48
  %50 = sub nsw i32 %.0, 1
  %51 = call i32 @_ZN7prefsum2idEi(%struct.prefsum* %49, i32 %50)
  call void @_Z6adedgeii(i32 %47, i32 %51)
  %52 = sext i32 %0 to i64
  %53 = getelementptr inbounds [100001 x %struct.prefsum], [100001 x %struct.prefsum]* @ps, i64 0, i64 %52
  %54 = call i32 @_ZN7prefsum2idEi(%struct.prefsum* %53, i32 %.0)
  %55 = sext i32 %0 to i64
  %56 = getelementptr inbounds [100001 x %struct.prefsum], [100001 x %struct.prefsum]* @ps, i64 0, i64 %55
  %57 = sub nsw i32 %.0, 1
  %58 = call dereferenceable(4) i32* @_ZN7prefsumixEi(%struct.prefsum* %56, i32 %57)
  %59 = load i32, i32* %58, align 4
  %60 = sext i32 %59 to i64
  %61 = getelementptr inbounds [100001 x %struct.prefsum], [100001 x %struct.prefsum]* @ps, i64 0, i64 %60
  %62 = sub nsw i32 %.0, 1
  %63 = call i32 @_ZN7prefsum2idEi(%struct.prefsum* %61, i32 %62)
  call void @_Z6adedgeii(i32 %54, i32 %63)
  br label %64
...
66:                                               ; preds = %29
  %67 = load i32, i32* @curt, align 4
  %68 = add nsw i32 %67, 17
  store i32 %68, i32* @curt, align 4
  %69 = sext i32 %0 to i64
  %70 = getelementptr inbounds [100001 x %"class.std::vector"], [100001 x %"class.std::vector"]* @e, i64 0, i64 %69
  ...
  %73 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector"* %70) #3
  %74 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %4, i32 0, i32 0
  store i32* %73, i32** %74, align 8
  br label %75

75:                                               ; preds = %83, %66
  %76 = call zeroext i1 @_ZN9__gnu_cxxneIPiSt6vectorIiSaIiEEEEbRKNS_17__normal_iteratorIT_T0_EESA_(%"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %3, %"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %4) #3
...
83:                                               ; preds = %82
  %84 = call dereferenceable(8) %"class.__gnu_cxx::__normal_iterator"* @_ZN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEppEv(%"class.__gnu_cxx::__normal_iterator"* %3) #3
  br label %75
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(4) i32* @_ZN7prefsumixEi(%struct.prefsum* %0, i32 %1) #4 comdat align 2 {
  %3 = getelementptr inbounds %struct.prefsum, %struct.prefsum* %0, i32 0, i32 0
  %4 = sext i32 %1 to i64
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i32 @_ZN7prefsum2idEi(%struct.prefsum* %0, i32 %1) #4 comdat align 2 {
  %3 = getelementptr inbounds %struct.prefsum, %struct.prefsum* %0, i32 0, i32 1
...
; Function Attrs: noinline uwtable
define void @_Z7advanceiRii(i32 %0, i32* dereferenceable(4) %1, i32 %2) #0 {
  %4 = load i32, i32* %1, align 4
  %5 = sext i32 %4 to i64
  %6 = getelementptr inbounds [100001 x %struct.prefsum], [100001 x %struct.prefsum]* @ps, i64 0, i64 %5
  %7 = call i32 @_ZN7prefsum2idEi(%struct.prefsum* %6, i32 %2)
  call void @_Z6adedgeii(i32 %0, i32 %7)
  %8 = load i32, i32* %1, align 4
  %9 = sext i32 %8 to i64
  %10 = getelementptr inbounds [100001 x %struct.prefsum], [100001 x %struct.prefsum]* @ps, i64 0, i64 %9
  %11 = call dereferenceable(4) i32* @_ZN7prefsumixEi(%struct.prefsum* %10, i32 %2)
...
define i32 @main() #6 {
  ...
  %12 = call i32 @_ZNSt8ios_base4setfESt13_Ios_Fmtflags(%"class.std::ios_base"* %11, i32 4)
  ...
  %19 = call i64 @_ZNSt8ios_base9precisionEl(%"class.std::ios_base"* %18, i64 20)
  %20 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* @_ZSt3cin, i32* dereferenceable(4) @n)
  call void @llvm.memset.p0i8.i64(i8* align 16 bitcast ([1800018 x i32]* @a to i8*), i8 0, i64 7200072, i1 false)
  br label %21
...
24:                                               ; preds = %21
  ...
  %29 = getelementptr inbounds [100001 x %"class.std::vector"], [100001 x %"class.std::vector"]* @e, i64 0, i64 %28
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %29, i32* dereferenceable(4) %2)
  %30 = load i32, i32* %2, align 4
  %31 = sext i32 %30 to i64
  %32 = getelementptr inbounds [100001 x %"class.std::vector"], [100001 x %"class.std::vector"]* @e, i64 0, i64 %31
...
35:                                               ; preds = %21
  ...
  store i32 %36, i32* @curt, align 4
  call void @_Z3dfsii(i32 1, i32 1)
  br label %37

37:                                               ; preds = %139, %35
  %.02 = phi i32 [ 1, %35 ], [ %140, %139 ]
...
40:                                               ; preds = %37
  ...
  %45 = getelementptr inbounds [100001 x %struct.prefsum], [100001 x %struct.prefsum]* @ps, i64 0, i64 %44
  %46 = call dereferenceable(4) i32* @_ZN7prefsumixEi(%struct.prefsum* %45, i32 0)
...
50:                                               ; preds = %40
  ...
  %56 = getelementptr inbounds [1800018 x i32], [1800018 x i32]* @a, i64 0, i64 %55
  store i32 %54, i32* %56, align 4
  %57 = load i32, i32* @pose, align 4
  %58 = add nsw i32 %57, 1
  store i32 %58, i32* @pose, align 4
  %59 = sext i32 %57 to i64
  %60 = getelementptr inbounds [100001 x i32], [100001 x i32]* @possible, i64 0, i64 %59
  store i32 %.02, i32* %60, align 4
  br label %138

61:                                               ; preds = %40
  %62 = load i32, i32* %4, align 4
  %63 = sext i32 %62 to i64
  %64 = getelementptr inbounds [100001 x %struct.prefsum], [100001 x %struct.prefsum]* @ps, i64 0, i64 %63
  %65 = call dereferenceable(4) i32* @_ZN7prefsumixEi(%struct.prefsum* %64, i32 0)
...
69:                                               ; preds = %61
  ...
  %72 = getelementptr inbounds [100001 x %struct.prefsum], [100001 x %struct.prefsum]* @ps, i64 0, i64 %71
  %73 = call i32 @_ZN7prefsum2idEi(%struct.prefsum* %72, i32 0)
  %74 = sext i32 %.02 to i64
  %75 = getelementptr inbounds [1800018 x i32], [1800018 x i32]* @a, i64 0, i64 %74
  store i32 %73, i32* %75, align 4
  %76 = load i32, i32* @pose, align 4
  %77 = add nsw i32 %76, 1
  store i32 %77, i32* @pose, align 4
  %78 = sext i32 %76 to i64
  %79 = getelementptr inbounds [100001 x i32], [100001 x i32]* @possible, i64 0, i64 %78
...
81:                                               ; preds = %110, %80
  %.03 = phi i32 [ 16, %80 ], [ %111, %110 ]
  %82 = icmp sge i32 %.03, 0
  br i1 %82, label %83, label %112

83:                                               ; preds = %81
  %84 = load i32, i32* %3, align 4
  %85 = sext i32 %84 to i64
  %86 = getelementptr inbounds [100001 x i32], [100001 x i32]* @h, i64 0, i64 %85
  %87 = load i32, i32* %86, align 4
  %88 = load i32, i32* %4, align 4
  %89 = sext i32 %88 to i64
  %90 = getelementptr inbounds [100001 x i32], [100001 x i32]* @h, i64 0, i64 %89
...
95:                                               ; preds = %83
  call void @_Z7advanceiRii(i32 %.02, i32* dereferenceable(4) %3, i32 %.03)
  br label %96

96:                                               ; preds = %95, %83
  %97 = load i32, i32* %4, align 4
  %98 = sext i32 %97 to i64
  %99 = getelementptr inbounds [100001 x i32], [100001 x i32]* @h, i64 0, i64 %98
  %100 = load i32, i32* %99, align 4
  %101 = load i32, i32* %3, align 4
  %102 = sext i32 %101 to i64
  %103 = getelementptr inbounds [100001 x i32], [100001 x i32]* @h, i64 0, i64 %102
...
108:                                              ; preds = %96
  call void @_Z7advanceiRii(i32 %.02, i32* dereferenceable(4) %4, i32 %.03)
  br label %109
...
117:                                              ; preds = %133, %116
  %.04 = phi i32 [ 16, %116 ], [ %134, %133 ]
  %118 = icmp sge i32 %.04, 0
  br i1 %118, label %119, label %135

119:                                              ; preds = %117
  %120 = load i32, i32* %4, align 4
  %121 = sext i32 %120 to i64
  %122 = getelementptr inbounds [100001 x %struct.prefsum], [100001 x %struct.prefsum]* @ps, i64 0, i64 %121
  %123 = call dereferenceable(4) i32* @_ZN7prefsumixEi(%struct.prefsum* %122, i32 %.04)
  %124 = load i32, i32* %123, align 4
  %125 = load i32, i32* %3, align 4
  %126 = sext i32 %125 to i64
  %127 = getelementptr inbounds [100001 x %struct.prefsum], [100001 x %struct.prefsum]* @ps, i64 0, i64 %126
  %128 = call dereferenceable(4) i32* @_ZN7prefsumixEi(%struct.prefsum* %127, i32 %.04)
  %129 = load i32, i32* %128, align 4
  %130 = icmp ne i32 %124, %129
  br i1 %130, label %131, label %132

131:                                              ; preds = %119
  call void @_Z7advanceiRii(i32 %.02, i32* dereferenceable(4) %4, i32 %.04)
  call void @_Z7advanceiRii(i32 %.02, i32* dereferenceable(4) %3, i32 %.04)
  br label %132
...
135:                                              ; preds = %117
  call void @_Z7advanceiRii(i32 %.02, i32* dereferenceable(4) %3, i32 0)
  call void @_Z7advanceiRii(i32 %.02, i32* dereferenceable(4) %4, i32 0)
  br label %136
...
142:                                              ; preds = %157, %141
  %.0 = phi i32 [ 0, %141 ], [ %158, %157 ]
  %143 = load i32, i32* @pose, align 4
  %144 = icmp slt i32 %.0, %143
  br i1 %144, label %145, label %159

145:                                              ; preds = %142
  %146 = sext i32 %.0 to i64
  %147 = getelementptr inbounds [100001 x i32], [100001 x i32]* @possible, i64 0, i64 %146
  %148 = load i32, i32* %147, align 4
  %149 = sext i32 %148 to i64
  %150 = getelementptr inbounds [1800018 x i32], [1800018 x i32]* @a, i64 0, i64 %149
  %151 = load i32, i32* %150, align 4
  %152 = sext i32 %151 to i64
  %153 = getelementptr inbounds [1800018 x i32], [1800018 x i32]* @a, i64 0, i64 %152
  store i32 -1, i32* %153, align 4
  %154 = sext i32 %148 to i64
  %155 = getelementptr inbounds [1800018 x i32], [1800018 x i32]* @a, i64 0, i64 %154
  %156 = load i32, i32* %155, align 4
  call void @_Z2goi(i32 %156)
  br label %157
...
165:                                              ; preds = %159
  call void @__assert_fail(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.7, i32 0, i32 0), i8* getelementptr inbounds ([71 x i8], [71 x i8]* @.str.6, i32 0, i32 0), i32 165, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #13
  unreachable
...
172:                                              ; preds = %167
  %173 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.8, i32 0, i32 0))
  %174 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEPFRSoS_E(%"class.std::basic_ostream"* %173, %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  br label %178

175:                                              ; preds = %167
  %176 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.9, i32 0, i32 0))
...
define linkonce_odr void @_ZNSt6vectorIiSaIiEE17_M_realloc_insertIJRKiEEEvN9__gnu_cxx17__normal_iteratorIPiS1_EEDpOT_(%"class.std::vector"* %0, i32* %1, i32* dereferenceable(4) %2) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %7 = call i64 @_ZNKSt6vectorIiSaIiEE12_M_check_lenEmPKc(%"class.std::vector"* %0, i64 1, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.10, i32 0, i32 0))
  %8 = bitcast %"class.std::vector"* %0 to %"struct.std::_Vector_base"*
  %9 = getelementptr inbounds %"struct.std::_Vector_base", %"struct.std::_Vector_base"* %8, i32 0, i32 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s106433010.cpp() #0 section ".text.startup" {
