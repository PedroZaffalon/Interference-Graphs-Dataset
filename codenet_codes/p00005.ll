; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00005/s847465566.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00005/s847465566.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s847465566.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define i64 @_Z3gcdll(i64 %0, i64 %1) #0 {
...
8:                                                ; preds = %2
  call void @_ZSt4swapIlENSt9enable_ifIXsr6__and_ISt6__not_ISt15__is_tuple_likeIT_EESt21is_move_constructibleIS3_ESt18is_move_assignableIS3_EEE5valueEvE4typeERS3_SC_(i64* dereferenceable(8) %3, i64* dereferenceable(8) %4) #3
  br label %9
...
14:                                               ; preds = %9
  ...
  %18 = srem i64 %16, %17
  %19 = call i64 @_Z3gcdll(i64 %15, i64 %18)
  br label %20

20:                                               ; preds = %14, %12
  %.0 = phi i64 [ %13, %12 ], [ %19, %14 ]
  ret i64 %.0
}
...
1:                                                ; preds = %13, %0
  %2 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERl(%"class.std::basic_istream"* @_ZSt3cin, i64* dereferenceable(8) @a)
  %3 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERl(%"class.std::basic_istream"* %2, i64* dereferenceable(8) @b)
...
13:                                               ; preds = %1
  ...
  %16 = call i64 @_Z3gcdll(i64 %14, i64 %15)
  store i64 %16, i64* @g, align 8
  ...
  %24 = sdiv i64 %22, %23
  %25 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEl(%"class.std::basic_ostream"* %19, i64 %24)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s847465566.cpp() #0 section ".text.startup" {
