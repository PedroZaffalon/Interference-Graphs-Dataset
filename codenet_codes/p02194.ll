; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02194/s896962225.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02194/s896962225.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s896962225.cpp, i8* null }]
...
77:                                               ; preds = %73
  ...
  invoke void @_ZNSt6vectorIxSaIxEEC2EmRKxRKS0_(%"class.std::vector.0"* %7, i64 %81, i64* dereferenceable(8) %8, %"class.std::allocator.2"* dereferenceable(1) %9)
...
83:                                               ; preds = %96, %82
  %.09 = phi i32 [ 1, %82 ], [ %97, %96 ]
  %84 = load i32, i32* %1, align 4
  %85 = add nsw i32 %84, 1
  %86 = icmp slt i32 %.09, %85
...
103:                                              ; preds = %136, %102
  %.010 = phi i32 [ 1, %102 ], [ %137, %136 ]
  %.08 = phi i64 [ %78, %102 ], [ %135, %136 ]
  %104 = shl i32 1, 20
...
107:                                              ; preds = %116, %106
  %.011 = phi i32 [ 0, %106 ], [ %.112, %116 ]
  %.04 = phi i32 [ 0, %106 ], [ %117, %116 ]
  %108 = icmp slt i32 %.04, 20
...
115:                                              ; preds = %113, %109
  %.112 = phi i32 [ %114, %113 ], [ %.011, %109 ]
  br label %116

116:                                              ; preds = %115
  %117 = add nsw i32 %.04, 1
  br label %107
...
138:                                              ; preds = %103
  %139 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEx(%"class.std::basic_ostream"* @_ZSt4cout, i64 %.08)
...
147:                                              ; preds = %143, %98, %42
  %.01 = phi i32 [ %45, %42 ], [ %146, %143 ], [ %101, %98 ]
  %.0 = phi i8* [ %44, %42 ], [ %145, %143 ], [ %100, %98 ]
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %4) #3
  br label %148

148:                                              ; preds = %147, %38
  %.12 = phi i32 [ %.01, %147 ], [ %41, %38 ]
  %.1 = phi i8* [ %.0, %147 ], [ %40, %38 ]
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %2) #3
  br label %149

149:                                              ; preds = %148, %34
  %.23 = phi i32 [ %.12, %148 ], [ %37, %34 ]
  %.2 = phi i8* [ %.1, %148 ], [ %36, %34 ]
  %150 = insertvalue { i8*, i32 } undef, i8* %.2, 0
  %151 = insertvalue { i8*, i32 } %150, i32 %.23, 1
  resume { i8*, i32 } %151
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s896962225.cpp() #0 section ".text.startup" {
