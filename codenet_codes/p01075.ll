; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01075/s726975372.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01075/s726975372.cpp"
...
@side = global [100000 x %"class.std::vector"] zeroinitializer, align 16
@_ZSt3cin = external global %"class.std::basic_istream", align 8
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@.str = private unnamed_addr constant [26 x i8] c"vector::_M_realloc_insert\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s726975372.cpp, i8* null }]
...
1:                                                ; preds = %1, %0
  %2 = phi %"class.std::vector"* [ getelementptr inbounds ([100000 x %"class.std::vector"], [100000 x %"class.std::vector"]* @side, i32 0, i32 0), %0 ], [ %3, %1 ]
  call void @_ZNSt6vectorISt4pairIiiESaIS1_EEC2Ev(%"class.std::vector"* %2) #3
  %3 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %2, i64 1
  %4 = icmp eq %"class.std::vector"* %3, getelementptr inbounds ([100000 x %"class.std::vector"], [100000 x %"class.std::vector"]* @side, i64 1, i64 0)
...
2:                                                ; preds = %2, %1
  %3 = phi %"class.std::vector"* [ getelementptr inbounds ([100000 x %"class.std::vector"], [100000 x %"class.std::vector"]* @side, i64 1, i64 0), %1 ], [ %4, %2 ]
  %4 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %3, i64 -1
  call void @_ZNSt6vectorISt4pairIiiESaIS1_EED2Ev(%"class.std::vector"* %4) #3
  %5 = icmp eq %"class.std::vector"* %4, getelementptr inbounds ([100000 x %"class.std::vector"], [100000 x %"class.std::vector"]* @side, i32 0, i32 0)
...
7:                                                ; preds = %2
  %8 = call dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* dereferenceable(4) @r, i32* dereferenceable(4) %3)
...
11:                                               ; preds = %40, %10
  %.0 = phi i32 [ 0, %10 ], [ %41, %40 ]
  %12 = sext i32 %.0 to i64
  %13 = sext i32 %0 to i64
  %14 = getelementptr inbounds [100000 x %"class.std::vector"], [100000 x %"class.std::vector"]* @side, i64 0, i64 %13
  %15 = call i64 @_ZNKSt6vectorISt4pairIiiESaIS1_EE4sizeEv(%"class.std::vector"* %14) #3
  %16 = icmp ult i64 %12, %15
  br i1 %16, label %17, label %42

17:                                               ; preds = %11
  %18 = sext i32 %0 to i64
  %19 = getelementptr inbounds [100000 x %"class.std::vector"], [100000 x %"class.std::vector"]* @side, i64 0, i64 %18
  %20 = sext i32 %.0 to i64
  %21 = call dereferenceable(8) %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EEixEm(%"class.std::vector"* %19, i64 %20) #3
...
26:                                               ; preds = %17
  ...
  %28 = getelementptr inbounds [100000 x %"class.std::vector"], [100000 x %"class.std::vector"]* @side, i64 0, i64 %27
  %29 = sext i32 %.0 to i64
  %30 = call dereferenceable(8) %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EEixEm(%"class.std::vector"* %28, i64 %29) #3
  %31 = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* %30, i32 0, i32 0
  %32 = load i32, i32* %31, align 4
  %33 = sext i32 %0 to i64
  %34 = getelementptr inbounds [100000 x %"class.std::vector"], [100000 x %"class.std::vector"]* @side, i64 0, i64 %33
  %35 = sext i32 %.0 to i64
  %36 = call dereferenceable(8) %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EEixEm(%"class.std::vector"* %34, i64 %35) #3
  %37 = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* %36, i32 0, i32 1
  %38 = load i32, i32* %37, align 4
  call void @_Z3dfsii(i32 %32, i32 %38)
  br label %39
...
11:                                               ; preds = %8
  ...
  %18 = getelementptr inbounds [100000 x %"class.std::vector"], [100000 x %"class.std::vector"]* @side, i64 0, i64 %17
  %19 = load i32, i32* %2, align 4
  %20 = sub nsw i32 %19, 1
  store i32 %20, i32* %5, align 4
  %21 = call i64 @_ZSt9make_pairIiRiESt4pairINSt17__decay_and_stripIT_E6__typeENS2_IT0_E6__typeEEOS3_OS6_(i32* dereferenceable(4) %5, i32* dereferenceable(4) %3)
  %22 = bitcast %"struct.std::pair"* %4 to i64*
  store i64 %21, i64* %22, align 4
  call void @_ZNSt6vectorISt4pairIiiESaIS1_EE9push_backEOS1_(%"class.std::vector"* %18, %"struct.std::pair"* dereferenceable(8) %4)
  br label %23
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s726975372.cpp() #0 section ".text.startup" {
