; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02160/s810343874.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02160/s810343874.cpp"
...
@prims = global %"class.std::vector" zeroinitializer, align 8
@.str.3 = private unnamed_addr constant [26 x i8] c"vector::_M_realloc_insert\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s810343874.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define void @_Z5printx(i64 %0) #0 {
  %2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i32 0, i32 0), i64 %0)
  ret void
}
...
define internal void @__cxx_global_var_init.2() #0 section ".text.startup" {
  call void @_ZNSt6vectorIxSaIxEEC2Ev(%"class.std::vector"* @prims) #3
  %1 = call i32 @__cxa_atexit(void (i8*)* bitcast (void (%"class.std::vector"*)* @_ZNSt6vectorIxSaIxEED2Ev to void (i8*)*), i8* bitcast (%"class.std::vector"* @prims to i8*), i8* @__dso_handle) #3
  ret void
}
...
16:                                               ; preds = %11
  call void @_ZNSt6vectorIxSaIxEE9push_backERKx(%"class.std::vector"* @prims, i64* dereferenceable(8) %2)
  br label %17
...
34:                                               ; preds = %31
  call void @_ZNSt6vectorIxSaIxEE9push_backERKx(%"class.std::vector"* @prims, i64* dereferenceable(8) %1)
  br label %35
...
; Function Attrs: noinline nounwind uwtable
define i64 @_Z8GetOrderx(i64 %0) #4 {
  %2 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %3 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %4 = load i64, i64* @mod, align 8
  %5 = sub nsw i64 %4, 1
  %6 = call i64* @_ZNSt6vectorIxSaIxEE5beginEv(%"class.std::vector"* @prims) #3
  %7 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %2, i32 0, i32 0
  store i64* %6, i64** %7, align 8
  %8 = call i64* @_ZNSt6vectorIxSaIxEE3endEv(%"class.std::vector"* @prims) #3
...
18:                                               ; preds = %15
  %19 = sdiv i64 %.1, %14
  %20 = call i64 @_Z3powxx(i64 %0, i64 %19)
  %21 = icmp eq i64 %20, 1
...
27:                                               ; preds = %26
  %28 = call dereferenceable(8) %"class.__gnu_cxx::__normal_iterator"* @_ZN9__gnu_cxx17__normal_iteratorIPxSt6vectorIxSaIxEEEppEv(%"class.__gnu_cxx::__normal_iterator"* %2) #3
  br label %10
...
4:                                                ; preds = %2
  %5 = call i64 @_Z4readv()
  %6 = call i64 @_Z8GetOrderx(i64 %5)
  %7 = call i64 @_Z3lcmxx(i64 %.01, i64 %6)
  br label %8
...
10:                                               ; preds = %2
  ...
  %12 = call i64 @_Z8GetOrderx(i64 %11)
  %13 = srem i64 %.01, %12
  %14 = icmp eq i64 %13, 0
...
define i32 @main() #5 {
  %1 = call i64 @_Z4readv()
  store i64 %1, i64* @mod, align 8
  call void @_Z9InitPrimsv()
  %2 = call i64 @_Z4readv()
  br label %3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s810343874.cpp() #0 section ".text.startup" {
