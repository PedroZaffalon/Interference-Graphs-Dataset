; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00854/s725691197.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00854/s725691197.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s725691197.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define i32 @_Z5solveiii(i32 %0, i32 %1, i32 %2) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
...
15:                                               ; preds = %3
  ...
  %16 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector"* %4) #3
  %17 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %6, i32 0, i32 0
  store i32* %16, i32** %17, align 8
  %18 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector"* %4) #3
  ...
  invoke void @_ZSt4iotaIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEiEvT_S7_T0_(i32* %21, i32* %23, i32 1)
...
25:                                               ; preds = %36, %24
  %.01 = phi i32 [ %13, %24 ], [ %40, %36 ]
  %.0 = phi i32 [ %0, %24 ], [ %38, %36 ]
  %26 = icmp ne i32 %.0, 1
...
27:                                               ; preds = %25
  ...
  %31 = call i32* @_ZNK9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEplEl(%"class.__gnu_cxx::__normal_iterator"* %10, i64 %30) #3
  ...
  %35 = invoke i32* @_ZNSt6vectorIiSaIiEE5eraseEN9__gnu_cxx17__normal_iteratorIPKiS1_EE(%"class.std::vector"* %4, i32* %34)
...
52:                                               ; preds = %45, %41
  %.03 = phi i32 [ %48, %45 ], [ %44, %41 ]
  %.02 = phi i8* [ %47, %45 ], [ %43, %41 ]
  %53 = insertvalue { i8*, i32 } undef, i8* %.02, 0
  %54 = insertvalue { i8*, i32 } %53, i32 %.03, 1
  resume { i8*, i32 } %54
}
...
14:                                               ; preds = %4
  ...
  %18 = call i32 @_Z5solveiii(i32 %15, i32 %16, i32 %17)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s725691197.cpp() #0 section ".text.startup" {
