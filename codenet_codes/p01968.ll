; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01968/s104087003.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01968/s104087003.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s104087003.cpp, i8* null }]
...
27:                                               ; preds = %34, %26
  %.03 = phi i64 [ 0, %26 ], [ %35, %34 ]
  %28 = load i64, i64* %1, align 8
  %29 = icmp slt i64 %.03, %28
  br i1 %29, label %30, label %44

30:                                               ; preds = %27
  %31 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %2, i64 %.03) #3
...
57:                                               ; preds = %154, %149, %136, %134, %131, %123, %116, %109, %91, %73, %66, %54
...
73:                                               ; preds = %68
  %74 = invoke dereferenceable(8) i64* @_Z5chminIxERT_S1_RKS0_(i64* dereferenceable(8) %6, i64* dereferenceable(8) %7)
...
89:                                               ; preds = %96, %84
  %.2 = phi i64 [ %.04, %84 ], [ %95, %96 ]
  %90 = call zeroext i1 @_ZN9__gnu_cxxneIPxSt6vectorIxSaIxEEEEbRKNS_17__normal_iteratorIT_T0_EESA_(%"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %8, %"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %9) #3
...
99:                                               ; preds = %80
  ...
  %101 = icmp ne i64 %100, 1073741824
...
107:                                              ; preds = %114, %102
  %.3 = phi i64 [ %.04, %102 ], [ %113, %114 ]
  %108 = call zeroext i1 @_ZN9__gnu_cxxneIPxSt6vectorIxSaIxEEEEbRKNS_17__normal_iteratorIT_T0_EESA_(%"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %11, %"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %12) #3
...
109:                                              ; preds = %107
  ...
  invoke void @_ZNSt6vectorIxSaIxEE9push_backERKx(%"class.std::vector"* %4, i64* dereferenceable(8) %13)
...
114:                                              ; preds = %112
  %115 = call dereferenceable(8) %"class.__gnu_cxx::__normal_iterator"* @_ZN9__gnu_cxx17__normal_iteratorIPxSt6vectorIxSaIxEEEppEv(%"class.__gnu_cxx::__normal_iterator"* %11) #3
  br label %107
...
119:                                              ; preds = %127, %118
  %.07 = phi i64 [ 0, %118 ], [ %128, %127 ]
  %.4 = phi i64 [ %.04, %118 ], [ %126, %127 ]
  %120 = call i64 @_ZNKSt6vectorIxSaIxEE4sizeEv(%"class.std::vector"* %5) #3
  %121 = sub nsw i64 %120, 1
  %122 = icmp slt i64 %.07, %121
  br i1 %122, label %123, label %129

123:                                              ; preds = %119
  %124 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %5, i64 %.07) #3
  invoke void @_ZNSt6vectorIxSaIxEE9push_backERKx(%"class.std::vector"* %4, i64* dereferenceable(8) %124)
...
131:                                              ; preds = %130, %98
  %132 = call i64 @_ZNKSt6vectorIxSaIxEE4sizeEv(%"class.std::vector"* %4) #3
...
146:                                              ; preds = %157, %145
  %.06 = phi i64 [ 0, %145 ], [ %158, %157 ]
  %147 = call i64 @_ZNKSt6vectorIxSaIxEE4sizeEv(%"class.std::vector"* %4) #3
  %148 = icmp slt i64 %.06, %147
  br i1 %148, label %149, label %159

149:                                              ; preds = %146
  %150 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %4, i64 %.06) #3
...
160:                                              ; preds = %57, %40
  %.01 = phi i32 [ %43, %40 ], [ %60, %57 ]
  %.0 = phi i8* [ %42, %40 ], [ %59, %57 ]
  call void @_ZNSt6vectorIxSaIxEED2Ev(%"class.std::vector"* %2) #3
  br label %161

161:                                              ; preds = %160, %36
  %.12 = phi i32 [ %.01, %160 ], [ %39, %36 ]
  %.1 = phi i8* [ %.0, %160 ], [ %38, %36 ]
  %162 = insertvalue { i8*, i32 } undef, i8* %.1, 0
  %163 = insertvalue { i8*, i32 } %162, i32 %.12, 1
  resume { i8*, i32 } %163
}
...
; Function Attrs: noinline uwtable
define linkonce_odr dereferenceable(8) i64* @_Z5chminIxERT_S1_RKS0_(i64* dereferenceable(8) %0, i64* dereferenceable(8) %1) #0 comdat {
  %3 = call dereferenceable(8) i64* @_ZSt3minIxERKT_S2_S2_(i64* dereferenceable(8) %0, i64* dereferenceable(8) %1)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s104087003.cpp() #0 section ".text.startup" {
