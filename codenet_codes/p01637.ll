; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01637/s102821766.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01637/s102821766.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s102821766.cpp, i8* null }]
...
define i32 @main() #4 {
  ...
  %3 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* %2, i32* dereferenceable(4) @D)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s102821766.cpp() #0 section ".text.startup" {
