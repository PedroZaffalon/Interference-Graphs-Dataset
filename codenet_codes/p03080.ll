; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03080/s436478764.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03080/s436478764.c"
...
define i32 @main() #0 {
  ...
  %4 = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0), i32* %1, i8* %3)
  br label %5
