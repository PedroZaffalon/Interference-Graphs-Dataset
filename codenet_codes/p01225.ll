; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01225/s773580359.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01225/s773580359.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s773580359.cpp, i8* null }]
...
13:                                               ; preds = %10
  ...
  invoke void @_ZNSt6vectorIiSaIiEEC2EmRKiRKS0_(%"class.std::vector"* %2, i64 9, i32* dereferenceable(4) %3, %"class.std::allocator"* dereferenceable(1) %4)
...
31:                                               ; preds = %149, %147, %144, %142, %73, %17
...
36:                                               ; preds = %71, %35
  %.06 = phi i32 [ 0, %35 ], [ %72, %71 ]
  %37 = icmp slt i32 %.06, 9
...
40:                                               ; preds = %38
  %41 = call i32 @_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE7compareEPKc(%"class.std::__cxx11::basic_string"* %6, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0)) #3
  %42 = icmp eq i32 %41, 0
...
52:                                               ; preds = %40
  %53 = call i32 @_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE7compareEPKc(%"class.std::__cxx11::basic_string"* %6, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0)) #3
  %54 = icmp eq i32 %53, 0
...
60:                                               ; preds = %52
  %61 = call i32 @_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE7compareEPKc(%"class.std::__cxx11::basic_string"* %6, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0)) #3
  %62 = icmp eq i32 %61, 0
...
73:                                               ; preds = %36
  %74 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector"* %2) #3
...
83:                                               ; preds = %138, %82
  %.07 = phi i32 [ 0, %82 ], [ %.2, %138 ]
  %.0 = phi i32 [ 0, %82 ], [ %139, %138 ]
  %84 = icmp slt i32 %.0, 3
...
110:                                              ; preds = %108, %96, %85
  %.18 = phi i32 [ %109, %108 ], [ %.07, %96 ], [ %.07, %85 ]
  %111 = mul nsw i32 3, %.0
...
137:                                              ; preds = %135, %122, %110
  %.2 = phi i32 [ %136, %135 ], [ %.18, %122 ], [ %.18, %110 ]
  br label %138
...
155:                                              ; preds = %48, %31
  %.03 = phi i32 [ %34, %31 ], [ %51, %48 ]
  %.02 = phi i8* [ %33, %31 ], [ %50, %48 ]
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %2) #3
  br label %157
...
157:                                              ; preds = %155, %27
  %.14 = phi i32 [ %.03, %155 ], [ %30, %27 ]
  %.1 = phi i8* [ %.02, %155 ], [ %29, %27 ]
  %158 = insertvalue { i8*, i32 } undef, i8* %.1, 0
  %159 = insertvalue { i8*, i32 } %158, i32 %.14, 1
  resume { i8*, i32 } %159
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s773580359.cpp() #0 section ".text.startup" {
