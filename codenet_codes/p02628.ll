; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02628/s150209231.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02628/s150209231.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s150209231.cpp, i8* null }]
...
18:                                               ; preds = %9
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* %8, i32* %21)
  br label %22

22:                                               ; preds = %30, %18
  %.02 = phi i32 [ 0, %18 ], [ %29, %30 ]
...
32:                                               ; preds = %22
  %33 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %.02)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s150209231.cpp() #0 section ".text.startup" {
