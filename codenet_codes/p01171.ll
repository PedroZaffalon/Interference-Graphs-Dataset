; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01171/s992866797.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01171/s992866797.cpp"
...
@flg = global [1000100 x i8] zeroinitializer, align 16
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s992866797.cpp, i8* null }]
...
define void @_Z7mkPrimev() #0 {
  ...
  call void @llvm.memset.p0i8.i64(i8* align 16 getelementptr inbounds ([1000100 x i8], [1000100 x i8]* @flg, i32 0, i32 0), i8 1, i64 1000100, i1 false)
  store i8 0, i8* getelementptr inbounds ([1000100 x i8], [1000100 x i8]* @flg, i64 0, i64 1), align 1
  store i8 0, i8* getelementptr inbounds ([1000100 x i8], [1000100 x i8]* @flg, i64 0, i64 0), align 16
  br label %2

2:                                                ; preds = %20, %0
  %.0 = phi i32 [ 2, %0 ], [ %21, %20 ]
  %3 = icmp sle i32 %.0, 1000010
  br i1 %3, label %4, label %22

4:                                                ; preds = %2
  %5 = sext i32 %.0 to i64
  %6 = getelementptr inbounds [1000100 x i8], [1000100 x i8]* @flg, i64 0, i64 %5
...
11:                                               ; preds = %16, %9
  %.01 = phi i32 [ %10, %9 ], [ %17, %16 ]
  %12 = icmp sle i32 %.01, 1000010
  br i1 %12, label %13, label %18

13:                                               ; preds = %11
  %14 = sext i32 %.01 to i64
  %15 = getelementptr inbounds [1000100 x i8], [1000100 x i8]* @flg, i64 0, i64 %14
...
23:                                               ; preds = %34, %22
  ...
  %25 = icmp sle i32 %24, 1000010
  br i1 %25, label %26, label %37

26:                                               ; preds = %23
  %27 = load i32, i32* %1, align 4
  %28 = sext i32 %27 to i64
  %29 = getelementptr inbounds [1000100 x i8], [1000100 x i8]* @flg, i64 0, i64 %28
...
; Function Attrs: noinline nounwind uwtable
define i32 @_Z5solvei(i32 %0) #4 {
  br label %2

2:                                                ; preds = %19, %1
  %.02 = phi i32 [ 0, %1 ], [ %.13, %19 ]
  %.01 = phi i32 [ 0, %1 ], [ %.1, %19 ]
  %.0 = phi i32 [ 0, %1 ], [ %20, %19 ]
  %3 = sext i32 %.0 to i64
  %4 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* @p, i64 %3) #3
...
7:                                                ; preds = %2
  %8 = sext i32 %.0 to i64
  %9 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* @p, i64 %8) #3
...
13:                                               ; preds = %7
  ...
  %15 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* @p, i64 %14) #3
  %16 = load i32, i32* %15, align 4
  %17 = sub nsw i32 %.01, %16
  br label %18

18:                                               ; preds = %13, %7
  %.13 = phi i32 [ %.0, %13 ], [ %.02, %7 ]
  %.1 = phi i32 [ %17, %13 ], [ %.01, %7 ]
  br label %19
...
21:                                               ; preds = %2
  ...
  %23 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* @p, i64 %22) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s992866797.cpp() #0 section ".text.startup" {
