; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02642/s068833790.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02642/s068833790.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s068833790.cpp, i8* null }]
...
define i32 @main() #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  invoke void @_ZNSt6vectorIlSaIlEEC2EmRKlRKS0_(%"class.std::vector"* %2, i64 1000001, i64* dereferenceable(8) %3, %"class.std::allocator"* dereferenceable(1) %4)
...
12:                                               ; preds = %0
  ...
  invoke void @_ZNSt6vectorIlSaIlEEC2EmRKlRKS0_(%"class.std::vector"* %5, i64 1000001, i64* dereferenceable(8) %6, %"class.std::allocator"* dereferenceable(1) %7)
...
13:                                               ; preds = %12
  ...
  invoke void @_ZNSt6vectorIlSaIlEEC2EmRKlRKS0_(%"class.std::vector"* %8, i64 %14, i64* dereferenceable(8) %9, %"class.std::allocator"* dereferenceable(1) %10)
...
16:                                               ; preds = %67, %15
  %.04 = phi i64 [ 0, %15 ], [ %68, %67 ]
  %17 = load i64, i64* %1, align 8
  %18 = icmp slt i64 %.04, %17
  br i1 %18, label %19, label %69

19:                                               ; preds = %16
  %20 = call dereferenceable(8) i64* @_ZNSt6vectorIlSaIlEEixEm(%"class.std::vector"* %8, i64 %.04) #3
  %21 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERl(%"class.std::basic_istream"* @_ZSt3cin, i64* dereferenceable(8) %20)
          to label %22 unwind label %56

22:                                               ; preds = %19
  %23 = call dereferenceable(8) i64* @_ZNSt6vectorIlSaIlEEixEm(%"class.std::vector"* %8, i64 %.04) #3
  %24 = load i64, i64* %23, align 8
  %25 = call dereferenceable(8) i64* @_ZNSt6vectorIlSaIlEEixEm(%"class.std::vector"* %5, i64 %24) #3
  %26 = load i64, i64* %25, align 8
  %27 = icmp ne i64 %26, 0
  br i1 %27, label %61, label %28

28:                                               ; preds = %22
  %29 = call dereferenceable(8) i64* @_ZNSt6vectorIlSaIlEEixEm(%"class.std::vector"* %8, i64 %.04) #3
  %30 = load i64, i64* %29, align 8
  %31 = call dereferenceable(8) i64* @_ZNSt6vectorIlSaIlEEixEm(%"class.std::vector"* %8, i64 %.04) #3
  %32 = load i64, i64* %31, align 8
  %33 = add nsw i64 %30, %32
  br label %34

34:                                               ; preds = %40, %28
  %.05 = phi i64 [ %33, %28 ], [ %43, %40 ]
  %35 = icmp sle i64 %.05, 1000000
  br i1 %35, label %36, label %60

36:                                               ; preds = %34
  %37 = call dereferenceable(8) i64* @_ZNSt6vectorIlSaIlEEixEm(%"class.std::vector"* %2, i64 %.05) #3
...
40:                                               ; preds = %36
  %41 = call dereferenceable(8) i64* @_ZNSt6vectorIlSaIlEEixEm(%"class.std::vector"* %8, i64 %.04) #3
  %42 = load i64, i64* %41, align 8
  %43 = add nsw i64 %.05, %42
  br label %34
...
61:                                               ; preds = %60, %22
  %62 = call dereferenceable(8) i64* @_ZNSt6vectorIlSaIlEEixEm(%"class.std::vector"* %8, i64 %.04) #3
...
70:                                               ; preds = %88, %69
  %.08 = phi i64 [ 0, %69 ], [ %89, %88 ]
  %.06 = phi i64 [ 0, %69 ], [ %.17, %88 ]
  %71 = load i64, i64* %1, align 8
  %72 = icmp slt i64 %.08, %71
  br i1 %72, label %73, label %90

73:                                               ; preds = %70
  %74 = call dereferenceable(8) i64* @_ZNSt6vectorIlSaIlEEixEm(%"class.std::vector"* %8, i64 %.08) #3
  %75 = load i64, i64* %74, align 8
  %76 = call dereferenceable(8) i64* @_ZNSt6vectorIlSaIlEEixEm(%"class.std::vector"* %2, i64 %75) #3
  %77 = load i64, i64* %76, align 8
  %78 = icmp ne i64 %77, 0
  br i1 %78, label %85, label %79

79:                                               ; preds = %73
  %80 = call dereferenceable(8) i64* @_ZNSt6vectorIlSaIlEEixEm(%"class.std::vector"* %8, i64 %.08) #3
  %81 = load i64, i64* %80, align 8
  %82 = call dereferenceable(8) i64* @_ZNSt6vectorIlSaIlEEixEm(%"class.std::vector"* %5, i64 %81) #3
...
97:                                               ; preds = %56, %52
  %.01 = phi i32 [ %59, %56 ], [ %55, %52 ]
  %.0 = phi i8* [ %58, %56 ], [ %54, %52 ]
  call void @_ZNSt6vectorIlSaIlEED2Ev(%"class.std::vector"* %5) #3
  br label %98

98:                                               ; preds = %97, %48
  %.12 = phi i32 [ %.01, %97 ], [ %51, %48 ]
  %.1 = phi i8* [ %.0, %97 ], [ %50, %48 ]
  call void @_ZNSt6vectorIlSaIlEED2Ev(%"class.std::vector"* %2) #3
  br label %99

99:                                               ; preds = %98, %44
  %.23 = phi i32 [ %.12, %98 ], [ %47, %44 ]
  %.2 = phi i8* [ %.1, %98 ], [ %46, %44 ]
  %100 = insertvalue { i8*, i32 } undef, i8* %.2, 0
  %101 = insertvalue { i8*, i32 } %100, i32 %.23, 1
  resume { i8*, i32 } %101
}
...
define linkonce_odr void @_ZNSt6vectorIlSaIlEEC2EmRKlRKS0_(%"class.std::vector"* %0, i64 %1, i64* dereferenceable(8) %2, %"class.std::allocator"* dereferenceable(1) %3) unnamed_addr #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  call void @_ZNSt12_Vector_baseIlSaIlEEC2EmRKS0_(%"struct.std::_Vector_base"* %5, i64 %1, %"class.std::allocator"* dereferenceable(1) %3)
  invoke void @_ZNSt6vectorIlSaIlEE18_M_fill_initializeEmRKl(%"class.std::vector"* %0, i64 %1, i64* dereferenceable(8) %2)
...
7:                                                ; preds = %4
  ...
  call void @_ZNSt12_Vector_baseIlSaIlEED2Ev(%"struct.std::_Vector_base"* %11) #3
  br label %12
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt6vectorIlSaIlEE18_M_fill_initializeEmRKl(%"class.std::vector"* %0, i64 %1, i64* dereferenceable(8) %2) #0 comdat align 2 {
  ...
  %9 = call dereferenceable(1) %"class.std::allocator"* @_ZNSt12_Vector_baseIlSaIlEE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %8) #3
  %10 = call i64* @_ZSt24__uninitialized_fill_n_aIPlmllET_S1_T0_RKT1_RSaIT2_E(i64* %7, i64 %1, i64* dereferenceable(8) %2, %"class.std::allocator"* dereferenceable(1) %9)
  %11 = bitcast %"class.std::vector"* %0 to %"struct.std::_Vector_base"*
  %12 = getelementptr inbounds %"struct.std::_Vector_base", %"struct.std::_Vector_base"* %11, i32 0, i32 0
  %13 = getelementptr inbounds %"struct.std::_Vector_base<long, std::allocator<long> >::_Vector_impl", %"struct.std::_Vector_base<long, std::allocator<long> >::_Vector_impl"* %12, i32 0, i32 1
...
; Function Attrs: noinline uwtable
define linkonce_odr i64* @_ZSt24__uninitialized_fill_n_aIPlmllET_S1_T0_RKT1_RSaIT2_E(i64* %0, i64 %1, i64* dereferenceable(8) %2, %"class.std::allocator"* dereferenceable(1) %3) #0 comdat {
  %5 = call i64* @_ZSt20uninitialized_fill_nIPlmlET_S1_T0_RKT1_(i64* %0, i64 %1, i64* dereferenceable(8) %2)
  ret i64* %5
}
...
; Function Attrs: noinline uwtable
define linkonce_odr i64* @_ZSt20uninitialized_fill_nIPlmlET_S1_T0_RKT1_(i64* %0, i64 %1, i64* dereferenceable(8) %2) #0 comdat {
  %4 = call i64* @_ZNSt22__uninitialized_fill_nILb1EE15__uninit_fill_nIPlmlEET_S3_T0_RKT1_(i64* %0, i64 %1, i64* dereferenceable(8) %2)
  ret i64* %4
}

; Function Attrs: noinline uwtable
define linkonce_odr i64* @_ZNSt22__uninitialized_fill_nILb1EE15__uninit_fill_nIPlmlEET_S3_T0_RKT1_(i64* %0, i64 %1, i64* dereferenceable(8) %2) #0 comdat align 2 {
  %4 = call i64* @_ZSt6fill_nIPlmlET_S1_T0_RKT1_(i64* %0, i64 %1, i64* dereferenceable(8) %2)
  ret i64* %4
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s068833790.cpp() #0 section ".text.startup" {
