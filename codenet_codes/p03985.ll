; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03985/s435626516.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03985/s435626516.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s435626516.cpp, i8* null }]
...
13:                                               ; preds = %10
  ...
  call void @_ZNSt7complexIdEC2Edd(%"struct.std::complex"* %8, double %23, double %27)
  ...
  %66 = fsub double %50, %62
  %67 = fdiv double 1.000000e+00, %66
  %68 = fadd double %50, %62
  %69 = fdiv double 1.000000e+00, %68
  %70 = fadd double %67, %69
  %71 = fdiv double %70, 2.000000e+00
  %72 = fsub double %71, %65
  %73 = fadd double %65, %71
  %74 = fdiv double %72, %73
  %75 = call double @asin(double %74) #3
  %76 = load double, double* @_ZL2pi, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s435626516.cpp() #0 section ".text.startup" {
