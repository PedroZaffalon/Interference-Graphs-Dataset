; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02278/s270741550.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02278/s270741550.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s270741550.cpp, i8* null }]
...
42:                                               ; preds = %121, %41
  %.04 = phi i32 [ 0, %41 ], [ %122, %121 ]
  %.03 = phi i32 [ 0, %41 ], [ %.2, %121 ]
...
65:                                               ; preds = %71, %61
  %.06 = phi i32 [ 0, %61 ], [ %75, %71 ]
  %.05 = phi i32 [ -1, %61 ], [ %76, %71 ]
  %.0 = phi i32 [ %.04, %61 ], [ %88, %71 ]
...
71:                                               ; preds = %65
  ...
  %75 = add nsw i32 %.06, %74
  %76 = add nsw i32 %.05, 1
  %77 = sext i32 %.0 to i64
  %78 = getelementptr inbounds [1000 x i32], [1000 x i32]* %2, i64 0, i64 %77
  %79 = call dereferenceable(4) i32* @_ZSt3minIiERKT_S2_S2_(i32* dereferenceable(4) %6, i32* dereferenceable(4) %78)
...
89:                                               ; preds = %65
  ...
  %91 = sub nsw i32 %.06, %90
  %92 = load i32, i32* %6, align 4
  %93 = mul nsw i32 %92, %.05
  ...
  %102 = getelementptr inbounds [1000 x i32], [1000 x i32]* %3, i64 0, i64 0
  %103 = load i32, i32* %102, align 16
  %104 = sub nsw i32 %101, %103
  %105 = mul nsw i32 %104, %.05
...
120:                                              ; preds = %107, %89
  %.1 = phi i32 [ %119, %107 ], [ %95, %89 ]
  br label %121

121:                                              ; preds = %120, %58
  %.2 = phi i32 [ %.03, %58 ], [ %.1, %120 ]
  %122 = add nsw i32 %.04, 1
  br label %42

123:                                              ; preds = %42
  %124 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %.03)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s270741550.cpp() #0 section ".text.startup" {
