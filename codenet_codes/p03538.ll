; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03538/s404392320.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03538/s404392320.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s404392320.cpp, i8* null }]
...
50:                                               ; preds = %46
  ...
  %60 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %51, i32 %59)
  br label %61
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s404392320.cpp() #0 section ".text.startup" {
