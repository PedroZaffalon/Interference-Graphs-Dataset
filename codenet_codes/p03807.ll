; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03807/s501860393.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03807/s501860393.cpp"
...
$_Z3vinIxEvRSt6vectorIT_SaIS1_EEx = comdat any
...
@.str = private unnamed_addr constant [10 x i8] c"nume >= 0\00", align 1
@.str.1 = private unnamed_addr constant [71 x i8] c"/home/pedro/tcc/exDataset/codenet/data/selection/p03807/s501860393.cpp\00", align 1
@__PRETTY_FUNCTION__._Z5divupxx = private unnamed_addr constant [17 x i8] c"ll divup(ll, ll)\00", align 1
@.str.2 = private unnamed_addr constant [9 x i8] c"deno > 0\00", align 1
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s501860393.cpp, i8* null }]
...
define i64 @_Z5divupxx(i64 %0, i64 %1) #4 {
  %3 = icmp sge i64 %0, 0
...
5:                                                ; preds = %2
  call void @__assert_fail(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([71 x i8], [71 x i8]* @.str.1, i32 0, i32 0), i32 137, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @__PRETTY_FUNCTION__._Z5divupxx, i32 0, i32 0)) #11
  unreachable
...
10:                                               ; preds = %7
  call void @__assert_fail(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([71 x i8], [71 x i8]* @.str.1, i32 0, i32 0), i32 138, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @__PRETTY_FUNCTION__._Z5divupxx, i32 0, i32 0)) #11
  unreachable
...
define void @_Z3Yesv() #0 {
  %1 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i32 0, i32 0))
  ret void
}
...
; Function Attrs: noinline uwtable
define void @_Z3YESv() #0 {
  %1 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.5, i32 0, i32 0))
  ret void
}
...
define void @_Z5solvev() #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  call void @_Z4in_1IxEvRT_(i64* dereferenceable(8) %1)
  %4 = load i64, i64* %1, align 8
  call void @_ZNSaIxEC2Ev(%"class.std::allocator"* %3) #3
  invoke void @_ZNSt6vectorIxSaIxEEC2EmRKS0_(%"class.std::vector"* %2, i64 %4, %"class.std::allocator"* dereferenceable(1) %3)
          to label %5 unwind label %18

5:                                                ; preds = %0
  call void @_ZNSaIxED2Ev(%"class.std::allocator"* %3) #3
  %6 = load i64, i64* %1, align 8
  invoke void @_Z3vinIxEvRSt6vectorIT_SaIS1_EEx(%"class.std::vector"* dereferenceable(24) %2, i64 %6)
...
8:                                                ; preds = %16, %7
  %.03 = phi i64 [ 0, %7 ], [ %17, %16 ]
  %.02 = phi i64 [ 0, %7 ], [ %15, %16 ]
  %9 = load i64, i64* %1, align 8
  %10 = icmp slt i64 %.03, %9
  br i1 %10, label %11, label %26

11:                                               ; preds = %8
  %12 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %2, i64 %.03) #3
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_Z4in_1IxEvRT_(i64* dereferenceable(8) %0) #0 comdat {
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_Z3vinIxEvRSt6vectorIT_SaIS1_EEx(%"class.std::vector"* dereferenceable(24) %0, i64 %1) #0 comdat {
  br label %3
...
define i32 @main() #6 {
  ...
  %17 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEPFRSt8ios_baseS0_E(%"class.std::basic_ostream"* @_ZSt4cerr, %"class.std::ios_base"* (%"class.std::ios_base"*)* @_ZSt5fixedRSt8ios_base)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s501860393.cpp() #0 section ".text.startup" {
