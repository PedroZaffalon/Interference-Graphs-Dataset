; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01452/s040663698.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01452/s040663698.cpp"
...
@.str.1 = private unnamed_addr constant [71 x i8] c"/home/pedro/tcc/exDataset/codenet/data/selection/p01452/s040663698.cpp\00", align 1
@"__PRETTY_FUNCTION__._ZZ4mainENK3$_0clExx" = private unnamed_addr constant [57 x i8] c"auto main()::(anonymous class)::operator()(ll, ll) const\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s040663698.cpp, i8* null }]
...
define i64 @_Z7inversexx(i64 %0, i64 %1) #4 {
...
define i32 @main() #5 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %18 = call i32 @_ZSt12setprecisioni(i32 50)
  ...
  invoke void @_ZNSt6vectorIxSaIxEEC2EmRKS0_(%"class.std::vector"* %6, i64 3000000, %"class.std::allocator"* dereferenceable(1) %7)
          to label %26 unwind label %40

26:                                               ; preds = %0
  call void @_ZNSaIxED2Ev(%"class.std::allocator"* %7) #3
  %27 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %6, i64 0) #3
  store i64 1, i64* %27, align 8
  br label %28

28:                                               ; preds = %38, %26
  %.02 = phi i64 [ 1, %26 ], [ %39, %38 ]
  %29 = icmp slt i64 %.02, 3000000
...
30:                                               ; preds = %28
  ...
  %34 = mul nsw i64 %33, %.02
  %35 = load i64, i64* %5, align 8
  %36 = srem i64 %34, %35
  %37 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %6, i64 %.02) #3
...
44:                                               ; preds = %28
  ...
  store %"class.std::vector"* %6, %"class.std::vector"** %45, align 8
  %46 = getelementptr inbounds %class.anon, %class.anon* %8, i32 0, i32 1
  store i64* %5, i64** %46, align 8
  br label %47

47:                                               ; preds = %116, %44
  %.04 = phi i64 [ 0, %44 ], [ %117, %116 ]
  %.03 = phi i64 [ 0, %44 ], [ %115, %116 ]
  %48 = load i64, i64* %4, align 8
  %49 = add nsw i64 %48, 1
  %50 = icmp slt i64 %.04, %49
...
51:                                               ; preds = %47
  ...
  %61 = invoke i64 @"_ZZ4mainENK3$_0clExx"(%class.anon* %8, i64 %57, i64 %60)
...
62:                                               ; preds = %51
  ...
  %66 = add nsw i64 %65, %.04
  %67 = add nsw i64 %66, 1
  %68 = load i64, i64* %5, align 8
  %69 = invoke i64 @_Z7inversexx(i64 %67, i64 %68)
...
70:                                               ; preds = %62
  ...
  %78 = invoke i64 @"_ZZ4mainENK3$_0clExx"(%class.anon* %8, i64 %77, i64 %.04)
...
79:                                               ; preds = %70
  ...
  %89 = sub nsw i64 %88, %.04
  %90 = add nsw i64 %87, %89
  %91 = add nsw i64 %90, 1
  %92 = load i64, i64* %5, align 8
  %93 = invoke i64 @_Z7inversexx(i64 %91, i64 %92)
...
94:                                               ; preds = %79
  ...
  %101 = sub nsw i64 %100, %.04
  %102 = mul nsw i64 %101, 2
  %103 = add nsw i64 %99, %102
  %104 = load i64, i64* %4, align 8
  %105 = sub nsw i64 %104, %.04
  %106 = invoke i64 @"_ZZ4mainENK3$_0clExx"(%class.anon* %8, i64 %103, i64 %105)
          to label %107 unwind label %118

107:                                              ; preds = %94
  %108 = mul nsw i64 %106, %97
  %109 = load i64, i64* %5, align 8
  %110 = srem i64 %108, %109
  %111 = mul nsw i64 %84, %110
  %112 = srem i64 %111, %98
  %113 = load i64, i64* %5, align 8
  %114 = add nsw i64 %.03, %112
...
118:                                              ; preds = %124, %122, %94, %79, %70, %62, %51
...
122:                                              ; preds = %47
  %123 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEx(%"class.std::basic_ostream"* @_ZSt4cout, i64 %.03)
...
127:                                              ; preds = %118, %40
  %.01 = phi i32 [ %121, %118 ], [ %43, %40 ]
  %.0 = phi i8* [ %120, %118 ], [ %42, %40 ]
  %128 = insertvalue { i8*, i32 } undef, i8* %.0, 0
  %129 = insertvalue { i8*, i32 } %128, i32 %.01, 1
  resume { i8*, i32 } %129
}
...
define internal i64 @"_ZZ4mainENK3$_0clExx"(%class.anon* %0, i64 %1, i64 %2) #4 align 2 {
  ...
  %10 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %9, i64 %2) #3
  ...
  %21 = srem i64 %17, %20
  %22 = getelementptr inbounds %class.anon, %class.anon* %0, i32 0, i32 1
  %23 = load i64*, i64** %22, align 8
  %24 = load i64, i64* %23, align 8
  %25 = call i64 @_Z7inversexx(i64 %21, i64 %24)
  %26 = mul nsw i64 %7, %25
...
33:                                               ; preds = %3
  call void @__assert_fail(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([71 x i8], [71 x i8]* @.str.1, i32 0, i32 0), i32 42, i8* getelementptr inbounds ([57 x i8], [57 x i8]* @"__PRETTY_FUNCTION__._ZZ4mainENK3$_0clExx", i32 0, i32 0)) #11
  unreachable
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s040663698.cpp() #0 section ".text.startup" {
