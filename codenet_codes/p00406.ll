; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00406/s539075531.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00406/s539075531.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s539075531.cpp, i8* null }]
...
24:                                               ; preds = %22
  %25 = invoke i64 @_ZSt9make_pairIRiS0_ESt4pairINSt17__decay_and_stripIT_E6__typeENS2_IT0_E6__typeEEOS3_OS6_(i32* dereferenceable(4) %5, i32* dereferenceable(4) %6)
...
26:                                               ; preds = %24
  ...
  %30 = call dereferenceable(8) %"struct.std::pair"* @_ZNSt4pairIiiEaSEOS0_(%"struct.std::pair"* %29, %"struct.std::pair"* dereferenceable(8) %7) #3
  br label %31
...
37:                                               ; preds = %121, %118, %111, %41, %24, %22, %20
...
87:                                               ; preds = %116, %83
  %.05 = phi i32 [ %86, %83 ], [ %117, %116 ]
  %.04 = phi i32 [ 0, %83 ], [ %112, %116 ]
  %88 = icmp sge i32 %.05, 0
...
111:                                              ; preds = %103, %95
  ...
  %113 = invoke dereferenceable(8) i64* @_ZSt3maxIxERKT_S2_S2_(i64* dereferenceable(8) %10, i64* dereferenceable(8) %11)
...
124:                                              ; preds = %37, %33
  ...
  %125 = insertvalue { i8*, i32 } undef, i8* %.0, 0
  %126 = insertvalue { i8*, i32 } %125, i32 %.01, 1
  resume { i8*, i32 } %126
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s539075531.cpp() #0 section ".text.startup" {
