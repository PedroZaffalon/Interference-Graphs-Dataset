; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01950/s028554933.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01950/s028554933.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s028554933.cpp, i8* null }]
...
44:                                               ; preds = %189, %43
  %.021 = phi i32 [ 0, %43 ], [ %.425, %189 ]
  %.015 = phi i32 [ 1, %43 ], [ %.520, %189 ]
  %.013 = phi i32 [ 0, %43 ], [ %190, %189 ]
  %.010 = phi i8 [ 1, %43 ], [ %.212, %189 ]
  %.06 = phi i8 [ 1, %43 ], [ %.39, %189 ]
  %45 = trunc i8 %.06 to i1
  %46 = zext i1 %45 to i32
  %47 = icmp eq i32 %46, 1
  br i1 %47, label %48, label %52

48:                                               ; preds = %44
  %49 = trunc i8 %.010 to i1
...
62:                                               ; preds = %110, %61
  %.026 = phi i32 [ 0, %61 ], [ %111, %110 ]
  %.122 = phi i32 [ %.021, %61 ], [ %.223, %110 ]
  %.05 = phi i8 [ 0, %61 ], [ %.1, %110 ]
...
70:                                               ; preds = %107, %66
  %.223 = phi i32 [ %.122, %66 ], [ %.324, %107 ]
  %.014 = phi i32 [ 0, %66 ], [ %108, %107 ]
  %.1 = phi i8 [ %.05, %66 ], [ %.2, %107 ]
  %71 = sext i32 %.014 to i64
  %72 = sext i32 %69 to i64
  %73 = getelementptr inbounds [100001 x %"class.std::vector"], [100001 x %"class.std::vector"]* @V, i64 0, i64 %72
...
76:                                               ; preds = %70
  ...
  %78 = getelementptr inbounds [100001 x %"class.std::vector"], [100001 x %"class.std::vector"]* @V, i64 0, i64 %77
  %79 = sext i32 %.014 to i64
  %80 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %78, i64 %79) #3
...
88:                                               ; preds = %76
  ...
  %90 = getelementptr inbounds [100001 x %"class.std::vector"], [100001 x %"class.std::vector"]* @V, i64 0, i64 %89
  ...
  %99 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %97, i64 %98) #3
  invoke void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %6, i32* dereferenceable(4) %99)
...
102:                                              ; preds = %191, %180, %157, %115, %88, %41
...
110:                                              ; preds = %109
  %111 = add nsw i32 %.026, 1
  br label %62

112:                                              ; preds = %62
  %113 = load i32, i32* %1, align 4
  %114 = icmp eq i32 %.122, %113
...
131:                                              ; preds = %175, %130
  %.116 = phi i32 [ %.015, %130 ], [ %.217, %175 ]
  %.3 = phi i8 [ 0, %130 ], [ %.4, %175 ]
  %.02 = phi i32 [ 0, %130 ], [ %176, %175 ]
  %132 = sext i32 %.02 to i64
  %133 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* %6) #3
...
139:                                              ; preds = %172, %135
  %.217 = phi i32 [ %.116, %135 ], [ %.318, %172 ]
  %.4 = phi i8 [ %.3, %135 ], [ %.5, %172 ]
  %.01 = phi i32 [ 0, %135 ], [ %173, %172 ]
  %140 = sext i32 %.01 to i64
  %141 = sext i32 %138 to i64
  %142 = getelementptr inbounds [100001 x %"class.std::vector"], [100001 x %"class.std::vector"]* @V, i64 0, i64 %141
...
145:                                              ; preds = %139
  ...
  %147 = getelementptr inbounds [100001 x %"class.std::vector"], [100001 x %"class.std::vector"]* @V, i64 0, i64 %146
...
157:                                              ; preds = %145
  ...
  %159 = getelementptr inbounds [100001 x %"class.std::vector"], [100001 x %"class.std::vector"]* @V, i64 0, i64 %158
  ...
  %166 = getelementptr inbounds [100001 x %"class.std::vector"], [100001 x %"class.std::vector"]* @V, i64 0, i64 %165
  %167 = sext i32 %.01 to i64
  %168 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %166, i64 %167) #3
  invoke void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %5, i32* dereferenceable(4) %168)
          to label %169 unwind label %102

169:                                              ; preds = %157
  %170 = add nsw i32 %.217, 1
  br label %171

171:                                              ; preds = %169, %145
  %.318 = phi i32 [ %170, %169 ], [ %.217, %145 ]
  %.5 = phi i8 [ 1, %169 ], [ %.4, %145 ]
  br label %172
...
180:                                              ; preds = %177
  %181 = add nsw i32 %.013, 1
  %182 = invoke i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i32 0, i32 0), i32 %181)
...
187:                                              ; preds = %186, %184
  %.17 = phi i8 [ %.06, %184 ], [ 0, %186 ]
  br label %188

188:                                              ; preds = %187, %126, %123
  %.419 = phi i32 [ %.116, %187 ], [ %.015, %126 ], [ %.015, %123 ]
  %.28 = phi i8 [ %.17, %187 ], [ %.06, %126 ], [ %.06, %123 ]
  br label %189

189:                                              ; preds = %188, %122
  %.425 = phi i32 [ %.122, %122 ], [ %.021, %188 ]
  %.520 = phi i32 [ %.015, %122 ], [ %.419, %188 ]
  %.212 = phi i8 [ %.111, %122 ], [ %.010, %188 ]
  %.39 = phi i8 [ %.06, %122 ], [ %.28, %188 ]
  %190 = add nsw i32 %.013, 1
  br label %44

191:                                              ; preds = %52
  %192 = invoke i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i32 0, i32 0))
          to label %193 unwind label %102

193:                                              ; preds = %191
  br label %194

194:                                              ; preds = %193, %183, %118
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %6) #3
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %5) #3
  ret i32 0

195:                                              ; preds = %102
  %196 = insertvalue { i8*, i32 } undef, i8* %104, 0
  %197 = insertvalue { i8*, i32 } %196, i32 %105, 1
  resume { i8*, i32 } %197
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s028554933.cpp() #0 section ".text.startup" {
