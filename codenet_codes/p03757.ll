; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03757/s820535178.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03757/s820535178.cpp"
...
@fw = global [500005 x i64] zeroinitializer, align 16
@fw2 = global [500005 x i64] zeroinitializer, align 16
@children = global [500005 x %"class.std::vector"] zeroinitializer, align 16
@.str = private unnamed_addr constant [5 x i8] c"%d%d\00", align 1
@.str.2 = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.3 = private unnamed_addr constant [7 x i8] c"%d%d%d\00", align 1
@.str.4 = private unnamed_addr constant [6 x i8] c"%lld\0A\00", align 1
@.str.5 = private unnamed_addr constant [26 x i8] c"vector::_M_realloc_insert\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s820535178.cpp, i8* null }]
...
1:                                                ; preds = %1, %0
  %2 = phi %"class.std::vector"* [ getelementptr inbounds ([500005 x %"class.std::vector"], [500005 x %"class.std::vector"]* @children, i32 0, i32 0), %0 ], [ %3, %1 ]
  call void @_ZNSt6vectorIiSaIiEEC2Ev(%"class.std::vector"* %2) #3
  %3 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %2, i64 1
  %4 = icmp eq %"class.std::vector"* %3, getelementptr inbounds ([500005 x %"class.std::vector"], [500005 x %"class.std::vector"]* @children, i64 1, i64 0)
...
2:                                                ; preds = %2, %1
  %3 = phi %"class.std::vector"* [ getelementptr inbounds ([500005 x %"class.std::vector"], [500005 x %"class.std::vector"]* @children, i64 1, i64 0), %1 ], [ %4, %2 ]
  %4 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %3, i64 -1
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %4) #3
  %5 = icmp eq %"class.std::vector"* %4, getelementptr inbounds ([500005 x %"class.std::vector"], [500005 x %"class.std::vector"]* @children, i32 0, i32 0)
...
define i64 @_Z3dfsiii(i32 %0, i32 %1, i32 %2) #0 {
  %4 = sext i32 %0 to i64
  %5 = getelementptr inbounds [500005 x i32], [500005 x i32]* @A, i64 0, i64 %4
  %6 = load i32, i32* %5, align 4
  %7 = add nsw i32 %6, %2
  store i32 %7, i32* %5, align 4
  %8 = sext i32 %0 to i64
  %9 = getelementptr inbounds [500005 x i32], [500005 x i32]* @A, i64 0, i64 %8
...
15:                                               ; preds = %30, %14
  %.02 = phi i64 [ %11, %14 ], [ %29, %30 ]
  %.01 = phi i32 [ 0, %14 ], [ %31, %30 ]
  %16 = sext i32 %.01 to i64
  %17 = sext i32 %0 to i64
  %18 = getelementptr inbounds [500005 x %"class.std::vector"], [500005 x %"class.std::vector"]* @children, i64 0, i64 %17
...
21:                                               ; preds = %15
  ...
  %23 = getelementptr inbounds [500005 x %"class.std::vector"], [500005 x %"class.std::vector"]* @children, i64 0, i64 %22
  %24 = sext i32 %.01 to i64
  %25 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %23, i64 %24) #3
  %26 = load i32, i32* %25, align 4
  %27 = sub nsw i32 %1, 1
  %28 = call i64 @_Z3dfsiii(i32 %26, i32 %27, i32 %2)
  %29 = add nsw i64 %.02, %28
  br label %30
...
; Function Attrs: noinline nounwind uwtable
define void @_Z3updix(i32 %0, i64 %1) #4 {
  %3 = add nsw i32 %0, 1
  br label %4

4:                                                ; preds = %11, %2
  %.0 = phi i32 [ %3, %2 ], [ %14, %11 ]
  %5 = icmp sle i32 %.0, 500000
  br i1 %5, label %6, label %15

6:                                                ; preds = %4
  %7 = sext i32 %.0 to i64
  %8 = getelementptr inbounds [500005 x i64], [500005 x i64]* @fw, i64 0, i64 %7
...
5:                                                ; preds = %3
  %6 = sext i32 %.0 to i64
  %7 = getelementptr inbounds [500005 x i64], [500005 x i64]* @fw, i64 0, i64 %6
...
; Function Attrs: noinline nounwind uwtable
define void @_Z4upd2ix(i32 %0, i64 %1) #4 {
  %3 = add nsw i32 %0, 1
  br label %4
...
6:                                                ; preds = %4
  %7 = sext i32 %.0 to i64
  %8 = getelementptr inbounds [500005 x i64], [500005 x i64]* @fw2, i64 0, i64 %7
  %9 = load i64, i64* %8, align 8
  %10 = add nsw i64 %9, %1
  store i64 %10, i64* %8, align 8
  br label %11
...
5:                                                ; preds = %3
  %6 = sext i32 %.0 to i64
  %7 = getelementptr inbounds [500005 x i64], [500005 x i64]* @fw2, i64 0, i64 %6
  %8 = load i64, i64* %7, align 8
  %9 = add nsw i64 %.01, %8
  br label %10
...
; Function Attrs: noinline nounwind uwtable
define void @_Z6updateiii(i32 %0, i32 %1, i32 %2) #4 {
  %4 = sext i32 %2 to i64
  call void @_Z3updix(i32 %0, i64 %4)
  %5 = add nsw i32 %1, 1
  %6 = sub nsw i32 0, %2
  %7 = sext i32 %6 to i64
  call void @_Z3updix(i32 %5, i64 %7)
  %8 = sub nsw i32 %0, 1
  %9 = sext i32 %8 to i64
  %10 = sext i32 %2 to i64
  %11 = mul nsw i64 %9, %10
  call void @_Z4upd2ix(i32 %0, i64 %11)
  %12 = add nsw i32 %1, 1
  %13 = sub nsw i32 %0, 1
  %14 = sext i32 %13 to i64
  %15 = sext i32 %2 to i64
  %16 = mul nsw i64 %14, %15
  call void @_Z4upd2ix(i32 %12, i64 %16)
  %17 = add nsw i32 %1, 1
  %18 = sub nsw i32 %1, %0
  %19 = add nsw i32 %18, 1
  ...
  call void @_Z4upd2ix(i32 %17, i64 %22)
  ret void
}

; Function Attrs: noinline nounwind uwtable
define i64 @_Z3sumii(i32 %0, i32 %1) #4 {
  %3 = call i64 @_Z5queryi(i32 %1)
  %4 = sext i32 %1 to i64
  %5 = mul nsw i64 %3, %4
  %6 = call i64 @_Z6query2i(i32 %1)
  %7 = add nsw i64 %5, %6
  %8 = call i64 @_Z5queryi(i32 %0)
  %9 = sext i32 %0 to i64
  %10 = mul nsw i64 %8, %9
  %11 = call i64 @_Z6query2i(i32 %0)
...
define i32 @main() #5 {
  ...
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0), i32* @N, i32* @Q)
...
25:                                               ; preds = %21
  %26 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0), i32* %2, i32* %3)
  %27 = load i32, i32* %1, align 4
  %28 = load i32, i32* %1, align 4
  %29 = load i32, i32* %3, align 4
  call void @_Z6updateiii(i32 %27, i32 %28, i32 %29)
...
32:                                               ; preds = %25
  ...
  %35 = getelementptr inbounds [500005 x %"class.std::vector"], [500005 x %"class.std::vector"]* @children, i64 0, i64 %34
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %35, i32* dereferenceable(4) %1)
  br label %36
...
50:                                               ; preds = %21
  ...
  %52 = icmp sle i32 %51, 5000
  br i1 %52, label %53, label %94

53:                                               ; preds = %50
  %54 = load i32, i32* @Q, align 4
  %55 = icmp sle i32 %54, 5000
...
61:                                               ; preds = %57
  %62 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i32 0, i32 0), i32* %4)
  %63 = load i32, i32* %4, align 4
  %64 = icmp eq i32 %63, 1
  br i1 %64, label %65, label %71

65:                                               ; preds = %61
  %66 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i32 0, i32 0), i32* %5, i32* %6, i32* %7)
  %67 = load i32, i32* %5, align 4
  %68 = load i32, i32* %6, align 4
  %69 = load i32, i32* %7, align 4
  %70 = call i64 @_Z3dfsiii(i32 %67, i32 %68, i32 %69)
  br label %92
...
74:                                               ; preds = %71
  %75 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0), i32* %8, i32* %9)
  %76 = load i32, i32* %8, align 4
  %77 = load i32, i32* %9, align 4
  %78 = call i64 @_Z3dfsiii(i32 %76, i32 %77, i32 0)
  %79 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.4, i32 0, i32 0), i64 %78)
  br label %91

80:                                               ; preds = %71
  %81 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0), i32* %10, i32* %11)
  %82 = load i32, i32* %10, align 4
  %83 = sext i32 %82 to i64
  %84 = getelementptr inbounds [500005 x %"class.std::vector"], [500005 x %"class.std::vector"]* @children, i64 0, i64 %83
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %84, i32* dereferenceable(4) @N)
  %85 = load i32, i32* %11, align 4
  %86 = load i32, i32* @N, align 4
  %87 = sext i32 %86 to i64
  %88 = getelementptr inbounds [500005 x i32], [500005 x i32]* @A, i64 0, i64 %87
...
101:                                              ; preds = %97
  %102 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i32 0, i32 0), i32* %12)
  %103 = load i32, i32* %12, align 4
  %104 = icmp eq i32 %103, 1
  br i1 %104, label %105, label %112

105:                                              ; preds = %101
  %106 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i32 0, i32 0), i32* %13, i32* %14, i32* %15)
  %107 = load i32, i32* %13, align 4
  %108 = load i32, i32* %13, align 4
  %109 = load i32, i32* %14, align 4
  %110 = add nsw i32 %108, %109
  %111 = load i32, i32* %15, align 4
  call void @_Z6updateiii(i32 %107, i32 %110, i32 %111)
  br label %131
...
115:                                              ; preds = %112
  %116 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0), i32* %16, i32* %17)
  %117 = load i32, i32* %16, align 4
  %118 = load i32, i32* %16, align 4
  %119 = load i32, i32* %17, align 4
  %120 = add nsw i32 %118, %119
  %121 = call i64 @_Z3sumii(i32 %117, i32 %120)
  %122 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.4, i32 0, i32 0), i64 %121)
  br label %130

123:                                              ; preds = %112
  %124 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0), i32* %18, i32* %19)
  %125 = load i32, i32* @N, align 4
  %126 = load i32, i32* @N, align 4
  %127 = load i32, i32* %19, align 4
  call void @_Z6updateiii(i32 %125, i32 %126, i32 %127)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s820535178.cpp() #0 section ".text.startup" {
