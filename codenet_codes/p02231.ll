; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02231/s914917633.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02231/s914917633.cpp"
...
@.str.1 = private unnamed_addr constant [71 x i8] c"/home/pedro/tcc/exDataset/codenet/data/selection/p02231/s914917633.cpp\00", align 1
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s914917633.cpp, i8* null }]
...
define i32 @main() #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %7 = alloca %"class.procon::UnionFind", align 8
  %8 = call i32 @_Z8read_intv()
  %9 = call i32 @_Z8read_intv()
  %10 = call i32 @_Z8read_intv()
  %11 = sext i32 %9 to i64
  call void @_ZNSaImEC2Ev(%"class.std::allocator"* %2) #3
  invoke void @_ZNSt6vectorImSaImEEC2EmRKS0_(%"class.std::vector"* %1, i64 %11, %"class.std::allocator"* dereferenceable(1) %2)
...
15:                                               ; preds = %22, %14
  %.09 = phi i32 [ 0, %14 ], [ %23, %22 ]
  %16 = icmp slt i32 %.09, %9
  br i1 %16, label %17, label %36

17:                                               ; preds = %15
  %18 = invoke i64 @_Z7read_llv()
          to label %19 unwind label %32

19:                                               ; preds = %17
  %20 = sext i32 %.09 to i64
  %21 = call dereferenceable(8) i64* @_ZNSt6vectorImSaImEEixEm(%"class.std::vector"* %1, i64 %20) #3
...
37:                                               ; preds = %44, %36
  %.02 = phi i32 [ 0, %36 ], [ %45, %44 ]
  %38 = icmp slt i32 %.02, %10
  br i1 %38, label %39, label %46

39:                                               ; preds = %37
  %40 = invoke i32 @_Z8read_intv()
          to label %41 unwind label %32

41:                                               ; preds = %39
  %42 = sext i32 %.02 to i64
  %43 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.0"* %3, i64 %42) #3
...
53:                                               ; preds = %51
  ...
  invoke void @_ZN6procon9UnionFindC2Ei(%"class.procon::UnionFind"* %7, i32 %8)
...
57:                                               ; preds = %107, %56
  %.1 = phi i64 [ %.01, %56 ], [ %.2, %107 ]
  %.0 = phi i32 [ 0, %56 ], [ %108, %107 ]
  %58 = icmp slt i32 %.0, %9
...
59:                                               ; preds = %57
  ...
  %63 = call dereferenceable(8) i64* @_ZNSt6vectorImSaImEEixEm(%"class.std::vector"* %1, i64 %62) #3
  ...
  %73 = icmp sle i32 0, %69
  br i1 %73, label %74, label %76

74:                                               ; preds = %59
  %75 = icmp slt i32 %69, %8
  br label %76
...
79:                                               ; preds = %76
  call void @__assert_fail(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([71 x i8], [71 x i8]* @.str.1, i32 0, i32 0), i32 107, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #13
  unreachable
...
81:                                               ; preds = %80, %78
  %82 = icmp sle i32 0, %72
  br i1 %82, label %83, label %85

83:                                               ; preds = %81
  %84 = icmp slt i32 %72, %8
  br label %85

85:                                               ; preds = %83, %81
  %86 = phi i1 [ false, %81 ], [ %84, %83 ]
...
88:                                               ; preds = %85
  call void @__assert_fail(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([71 x i8], [71 x i8]* @.str.1, i32 0, i32 0), i32 108, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #13
  unreachable
...
92:                                               ; preds = %90
  %93 = mul i64 %.1, 17
  %94 = invoke zeroext i1 @_ZN6procon9UnionFind11is_same_setEii(%"class.procon::UnionFind"* %7, i32 %69, i32 %72)
          to label %95 unwind label %100

95:                                               ; preds = %92
  %96 = zext i1 %94 to i64
  %97 = select i1 %94, i32 1, i32 0
...
100:                                              ; preds = %104, %92
  ...
  call void @_ZN6procon9UnionFindD2Ev(%"class.procon::UnionFind"* %7) #3
  br label %115

104:                                              ; preds = %90
  invoke void @_ZN6procon9UnionFind5uniteEii(%"class.procon::UnionFind"* %7, i32 %69, i32 %72)
...
112:                                              ; preds = %51
  %113 = invoke i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.3, i32 0, i32 0), i64 %.01)
...
115:                                              ; preds = %100, %32
  %.06 = phi i32 [ %35, %32 ], [ %103, %100 ]
  %.03 = phi i8* [ %34, %32 ], [ %102, %100 ]
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector.0"* %3) #3
  br label %116

116:                                              ; preds = %115, %28
  %.17 = phi i32 [ %.06, %115 ], [ %31, %28 ]
  %.14 = phi i8* [ %.03, %115 ], [ %30, %28 ]
  call void @_ZNSt6vectorImSaImEED2Ev(%"class.std::vector"* %1) #3
  br label %117

117:                                              ; preds = %116, %24
  %.28 = phi i32 [ %.17, %116 ], [ %27, %24 ]
  %.25 = phi i8* [ %.14, %116 ], [ %26, %24 ]
  %118 = insertvalue { i8*, i32 } undef, i8* %.25, 0
  %119 = insertvalue { i8*, i32 } %118, i32 %.28, 1
  resume { i8*, i32 } %119
}
...
define linkonce_odr void @_ZNSt6vectorIN6procon9UnionFind8nodeinfoESaIS2_EE17_M_realloc_insertIJS2_EEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_(%"class.std::vector.5"* %0, %"struct.procon::UnionFind::nodeinfo"* %1, %"struct.procon::UnionFind::nodeinfo"* dereferenceable(8) %2) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %7 = call i64 @_ZNKSt6vectorIN6procon9UnionFind8nodeinfoESaIS2_EE12_M_check_lenEmPKc(%"class.std::vector.5"* %0, i64 1, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.5, i32 0, i32 0))
  %8 = bitcast %"class.std::vector.5"* %0 to %"struct.std::_Vector_base.6"*
  %9 = getelementptr inbounds %"struct.std::_Vector_base.6", %"struct.std::_Vector_base.6"* %8, i32 0, i32 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s914917633.cpp() #0 section ".text.startup" {
