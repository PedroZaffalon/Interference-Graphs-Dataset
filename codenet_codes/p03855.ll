; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03855/s034482344.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03855/s034482344.cpp"
...
%class.UnionFind = type { i32, %"class.std::vector", %"class.std::vector", %"class.std::vector" }
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s034482344.cpp, i8* null }]
...
define i32 @main() #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  call void @_ZN9UnionFindC2Ei(%class.UnionFind* %6, i32 %11)
  %12 = load i32, i32* %1, align 4
  invoke void @_ZN9UnionFindC2Ei(%class.UnionFind* %7, i32 %12)
...
21:                                               ; preds = %19
  ...
  invoke void @_ZN9UnionFind5uniteEii(%class.UnionFind* %7, i32 %26, i32 %27)
...
35:                                               ; preds = %78, %73, %67, %56, %47, %45, %43, %21, %19, %17
...
47:                                               ; preds = %45
  ...
  %54 = invoke zeroext i1 @_ZN9UnionFind4sameEii(%class.UnionFind* %7, i32 %52, i32 %53)
...
56:                                               ; preds = %55
  ...
  invoke void @_ZN9UnionFind5uniteEii(%class.UnionFind* %6, i32 %57, i32 %58)
...
64:                                               ; preds = %76, %63
  %.0 = phi i32 [ 0, %63 ], [ %77, %76 ]
  %65 = load i32, i32* %1, align 4
  %66 = icmp slt i32 %.0, %65
  br i1 %66, label %67, label %78

67:                                               ; preds = %64
  %68 = getelementptr inbounds %class.UnionFind, %class.UnionFind* %6, i32 0, i32 3
...
80:                                               ; preds = %78
  call void @_ZN9UnionFindD2Ev(%class.UnionFind* %7) #3
  call void @_ZN9UnionFindD2Ev(%class.UnionFind* %6) #3
  ret i32 0
...
82:                                               ; preds = %81
  %83 = insertvalue { i8*, i32 } undef, i8* %.01, 0
  %84 = insertvalue { i8*, i32 } %83, i32 %.02, 1
  resume { i8*, i32 } %84
}
...
define linkonce_odr void @_ZN9UnionFindC2Ei(%class.UnionFind* %0, i32 %1) unnamed_addr #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = getelementptr inbounds %class.UnionFind, %class.UnionFind* %0, i32 0, i32 1
  call void @_ZNSt6vectorIiSaIiEEC2Ev(%"class.std::vector"* %6) #3
  %7 = getelementptr inbounds %class.UnionFind, %class.UnionFind* %0, i32 0, i32 2
  call void @_ZNSt6vectorIiSaIiEEC2Ev(%"class.std::vector"* %7) #3
  %8 = getelementptr inbounds %class.UnionFind, %class.UnionFind* %0, i32 0, i32 3
  call void @_ZNSt6vectorIiSaIiEEC2Ev(%"class.std::vector"* %8) #3
  %9 = getelementptr inbounds %class.UnionFind, %class.UnionFind* %0, i32 0, i32 0
...
13:                                               ; preds = %10
  %14 = getelementptr inbounds %class.UnionFind, %class.UnionFind* %0, i32 0, i32 1
  invoke void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %14, i32* dereferenceable(4) %3)
          to label %15 unwind label %23

15:                                               ; preds = %13
  %16 = getelementptr inbounds %class.UnionFind, %class.UnionFind* %0, i32 0, i32 2
  store i32 0, i32* %4, align 4
  invoke void @_ZNSt6vectorIiSaIiEE9push_backEOi(%"class.std::vector"* %16, i32* dereferenceable(4) %4)
          to label %17 unwind label %23

17:                                               ; preds = %15
  %18 = getelementptr inbounds %class.UnionFind, %class.UnionFind* %0, i32 0, i32 3
  store i32 1, i32* %5, align 4
  invoke void @_ZNSt6vectorIiSaIiEE9push_backEOi(%"class.std::vector"* %18, i32* dereferenceable(4) %5)
...
28:                                               ; preds = %23
  %29 = insertvalue { i8*, i32 } undef, i8* %25, 0
  %30 = insertvalue { i8*, i32 } %29, i32 %26, 1
  resume { i8*, i32 } %30
}
...
8:                                                ; preds = %3
  %9 = getelementptr inbounds %class.UnionFind, %class.UnionFind* %0, i32 0, i32 3
  %10 = sext i32 %5 to i64
  %11 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %9, i64 %10) #3
  %12 = load i32, i32* %11, align 4
  %13 = getelementptr inbounds %class.UnionFind, %class.UnionFind* %0, i32 0, i32 3
  ...
  %20 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %18, i64 %19) #3
  %21 = load i32, i32* %20, align 4
  %22 = getelementptr inbounds %class.UnionFind, %class.UnionFind* %0, i32 0, i32 3
  %23 = sext i32 %5 to i64
  %24 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %22, i64 %23) #3
  store i32 %21, i32* %24, align 4
  %25 = getelementptr inbounds %class.UnionFind, %class.UnionFind* %0, i32 0, i32 2
  %26 = sext i32 %4 to i64
  %27 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %25, i64 %26) #3
  %28 = load i32, i32* %27, align 4
  %29 = getelementptr inbounds %class.UnionFind, %class.UnionFind* %0, i32 0, i32 2
...
34:                                               ; preds = %8
  %35 = getelementptr inbounds %class.UnionFind, %class.UnionFind* %0, i32 0, i32 1
...
38:                                               ; preds = %8
  %39 = getelementptr inbounds %class.UnionFind, %class.UnionFind* %0, i32 0, i32 1
  ...
  %42 = getelementptr inbounds %class.UnionFind, %class.UnionFind* %0, i32 0, i32 2
  %43 = sext i32 %4 to i64
  %44 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %42, i64 %43) #3
  %45 = load i32, i32* %44, align 4
  %46 = getelementptr inbounds %class.UnionFind, %class.UnionFind* %0, i32 0, i32 2
...
51:                                               ; preds = %38
  %52 = getelementptr inbounds %class.UnionFind, %class.UnionFind* %0, i32 0, i32 2
...
define linkonce_odr void @_ZN9UnionFindD2Ev(%class.UnionFind* %0) unnamed_addr #5 comdat align 2 {
  %2 = getelementptr inbounds %class.UnionFind, %class.UnionFind* %0, i32 0, i32 3
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %2) #3
  %3 = getelementptr inbounds %class.UnionFind, %class.UnionFind* %0, i32 0, i32 2
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %3) #3
  %4 = getelementptr inbounds %class.UnionFind, %class.UnionFind* %0, i32 0, i32 1
...
9:                                                ; preds = %2
  %10 = getelementptr inbounds %class.UnionFind, %class.UnionFind* %0, i32 0, i32 1
  ...
  %15 = getelementptr inbounds %class.UnionFind, %class.UnionFind* %0, i32 0, i32 3
  %16 = sext i32 %14 to i64
  %17 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %15, i64 %16) #3
  %18 = load i32, i32* %17, align 4
  %19 = getelementptr inbounds %class.UnionFind, %class.UnionFind* %0, i32 0, i32 3
  %20 = sext i32 %1 to i64
  %21 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %19, i64 %20) #3
  store i32 %18, i32* %21, align 4
  %22 = getelementptr inbounds %class.UnionFind, %class.UnionFind* %0, i32 0, i32 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s034482344.cpp() #0 section ".text.startup" {
