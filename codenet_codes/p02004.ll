; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02004/s136434023.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02004/s136434023.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s136434023.cpp, i8* null }]
...
23:                                               ; preds = %21, %15
  %.1 = phi i32 [ %16, %15 ], [ %22, %21 ]
  %24 = srem i32 %.1, 4
  %25 = icmp eq i32 %24, 0
  br i1 %25, label %26, label %31

26:                                               ; preds = %23
  %27 = icmp sgt i32 %.1, %.02
...
30:                                               ; preds = %28, %26
  %.15 = phi i32 [ %29, %28 ], [ %.04, %26 ]
  br label %31

31:                                               ; preds = %30, %23
  %.2 = phi i32 [ %.15, %30 ], [ %.04, %23 ]
  %.13 = phi i32 [ %.1, %30 ], [ %.02, %23 ]
  br label %32
...
34:                                               ; preds = %4
  %35 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %.04)
...
39:                                               ; preds = %17
  %40 = insertvalue { i8*, i32 } undef, i8* %19, 0
  %41 = insertvalue { i8*, i32 } %40, i32 %20, 1
  resume { i8*, i32 } %41
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s136434023.cpp() #0 section ".text.startup" {
