; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01905/s465456740.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01905/s465456740.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s465456740.cpp, i8* null }]
...
13:                                               ; preds = %10
  ...
  %15 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %3, i64 %14) #3
...
37:                                               ; preds = %24, %20
  %.01 = phi i32 [ %27, %24 ], [ %23, %20 ]
  %.0 = phi i8* [ %26, %24 ], [ %22, %20 ]
  %38 = insertvalue { i8*, i32 } undef, i8* %.0, 0
  %39 = insertvalue { i8*, i32 } %38, i32 %.01, 1
  resume { i8*, i32 } %39
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s465456740.cpp() #0 section ".text.startup" {
