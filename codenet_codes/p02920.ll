; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02920/s039282978.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02920/s039282978.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s039282978.cpp, i8* null }]
...
20:                                               ; preds = %18
  %21 = call i64* @_ZNSt6vectorIxSaIxEE5beginEv(%"class.std::vector"* %4) #3
  %22 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %6, i32 0, i32 0
  store i64* %21, i64** %22, align 8
  %23 = call i64* @_ZNSt6vectorIxSaIxEE3endEv(%"class.std::vector"* %4) #3
  ...
  invoke void @_ZSt4sortIN9__gnu_cxx17__normal_iteratorIPxSt6vectorIxSaIxEEEEEvT_S7_(i64* %26, i64* %28)
          to label %29 unwind label %65

29:                                               ; preds = %20
  %30 = call i64* @_ZNSt6vectorIxSaIxEE5beginEv(%"class.std::vector"* %4) #3
  %31 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %8, i32 0, i32 0
  store i64* %30, i64** %31, align 8
  %32 = call i64* @_ZNSt6vectorIxSaIxEE3endEv(%"class.std::vector"* %4) #3
  ...
  invoke void @_ZSt7reverseIN9__gnu_cxx17__normal_iteratorIPxSt6vectorIxSaIxEEEEEvT_S7_(i64* %35, i64* %37)
...
39:                                               ; preds = %147, %38
  %.09 = phi i32 [ 0, %38 ], [ %148, %147 ]
  %.0 = phi i32 [ 0, %38 ], [ %.1, %147 ]
...
42:                                               ; preds = %39
  ...
  invoke void @_ZNSt6vectorIiSaIiEEC2EmRKS0_(%"class.std::vector.0"* %10, i64 %44, %"class.std::allocator.2"* dereferenceable(1) %11)
...
52:                                               ; preds = %49
  ...
  %58 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.0"* %10, i64 %57) #3
...
92:                                               ; preds = %78
  %93 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEE4backEv(%"class.std::vector.0"* %10) #3
...
99:                                               ; preds = %112, %98
  %.016 = phi i32 [ 0, %98 ], [ %113, %112 ]
  %.012 = phi i32 [ 0, %98 ], [ %.113, %112 ]
  %100 = shl i32 1, %.09
  %101 = icmp slt i32 %.016, %100
...
102:                                              ; preds = %99
  ...
  %106 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEE4backEv(%"class.std::vector.0"* %10) #3
  %107 = load i32, i32* %106, align 4
  %108 = icmp eq i32 %105, %107
  br i1 %108, label %109, label %111

109:                                              ; preds = %102
  %110 = add nsw i32 %.012, 1
  br label %111

111:                                              ; preds = %109, %102
  %.113 = phi i32 [ %110, %109 ], [ %.012, %102 ]
  br label %112

112:                                              ; preds = %111
  %113 = add nsw i32 %.016, 1
  br label %99
...
115:                                              ; preds = %128, %114
  %.014 = phi i32 [ 0, %114 ], [ %.115, %128 ]
  %.02 = phi i32 [ 0, %114 ], [ %129, %128 ]
  %116 = shl i32 1, %.09
  %117 = icmp slt i32 %.02, %116
...
118:                                              ; preds = %115
  ...
  %122 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEE4backEv(%"class.std::vector.0"* %10) #3
...
145:                                              ; preds = %144, %138
  %.01 = phi i32 [ 1, %138 ], [ 0, %144 ]
  %.1 = phi i32 [ 0, %138 ], [ %.0, %144 ]
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector.0"* %12) #3
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector.0"* %10) #3
  switch i32 %.01, label %155 [
    i32 0, label %146
  ]
...
147:                                              ; preds = %146
  %148 = add nsw i32 %.09, 1
  br label %39

149:                                              ; preds = %139, %73
  %.06 = phi i32 [ %142, %139 ], [ %76, %73 ]
  %.03 = phi i8* [ %141, %139 ], [ %75, %73 ]
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector.0"* %10) #3
  br label %156

150:                                              ; preds = %39
  %151 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i32 0, i32 0))
...
155:                                              ; preds = %154, %145
  %.2 = phi i32 [ %.1, %145 ], [ 0, %154 ]
  call void @_ZNSt6vectorIxSaIxEED2Ev(%"class.std::vector"* %4) #3
  ret i32 %.2

156:                                              ; preds = %149, %69, %65
  %.17 = phi i32 [ %.06, %149 ], [ %72, %69 ], [ %68, %65 ]
  %.14 = phi i8* [ %.03, %149 ], [ %71, %69 ], [ %67, %65 ]
  call void @_ZNSt6vectorIxSaIxEED2Ev(%"class.std::vector"* %4) #3
  br label %157

157:                                              ; preds = %156, %61
  %.28 = phi i32 [ %.17, %156 ], [ %64, %61 ]
  %.25 = phi i8* [ %.14, %156 ], [ %63, %61 ]
  %158 = insertvalue { i8*, i32 } undef, i8* %.25, 0
  %159 = insertvalue { i8*, i32 } %158, i32 %.28, 1
  resume { i8*, i32 } %159
}
...
; Function Attrs: noinline uwtable
define linkonce_odr dereferenceable(280) %"class.std::basic_istream"* @_ZrsIxERSiS0_RSt6vectorIT_SaIS2_EE(%"class.std::basic_istream"* dereferenceable(280) %0, %"class.std::vector"* dereferenceable(24) %1) #0 comdat {
  %3 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %4 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %5 = call i64* @_ZNSt6vectorIxSaIxEE5beginEv(%"class.std::vector"* %1) #3
  %6 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %3, i32 0, i32 0
  store i64* %5, i64** %6, align 8
  %7 = call i64* @_ZNSt6vectorIxSaIxEE3endEv(%"class.std::vector"* %1) #3
  %8 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %4, i32 0, i32 0
  store i64* %7, i64** %8, align 8
  br label %9

9:                                                ; preds = %14, %2
  %10 = call zeroext i1 @_ZN9__gnu_cxxneIPxSt6vectorIxSaIxEEEEbRKNS_17__normal_iteratorIT_T0_EESA_(%"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %3, %"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %4) #3
  br i1 %10, label %11, label %16

11:                                               ; preds = %9
  %12 = call dereferenceable(8) i64* @_ZNK9__gnu_cxx17__normal_iteratorIPxSt6vectorIxSaIxEEEdeEv(%"class.__gnu_cxx::__normal_iterator"* %3) #3
  %13 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERx(%"class.std::basic_istream"* %0, i64* dereferenceable(8) %12)
  br label %14

14:                                               ; preds = %11
  %15 = call dereferenceable(8) %"class.__gnu_cxx::__normal_iterator"* @_ZN9__gnu_cxx17__normal_iteratorIPxSt6vectorIxSaIxEEEppEv(%"class.__gnu_cxx::__normal_iterator"* %3) #3
  br label %9
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEE4backEv(%"class.std::vector.0"* %0) #5 comdat align 2 {
  ...
  %6 = call i32* @_ZNK9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEmiEl(%"class.__gnu_cxx::__normal_iterator.5"* %2, i64 1) #3
  %7 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator.5", %"class.__gnu_cxx::__normal_iterator.5"* %3, i32 0, i32 0
  store i32* %6, i32** %7, align 8
  %8 = call dereferenceable(4) i32* @_ZNK9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEdeEv(%"class.__gnu_cxx::__normal_iterator.5"* %3) #3
  ret i32* %8
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZSt9__reverseIN9__gnu_cxx17__normal_iteratorIPxSt6vectorIxSaIxEEEEEvT_S7_St26random_access_iterator_tag(i64* %0, i64* %1) #5 comdat {
  %3 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %4 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %5 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %6 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s039282978.cpp() #0 section ".text.startup" {
