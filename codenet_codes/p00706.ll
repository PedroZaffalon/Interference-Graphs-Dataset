; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00706/s368368516.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00706/s368368516.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s368368516.cpp, i8* null }]
...
46:                                               ; preds = %92, %43
  %.03 = phi i32 [ 1, %43 ], [ %93, %92 ]
  %.02 = phi i32 [ 0, %43 ], [ %.1, %92 ]
...
50:                                               ; preds = %89, %49
  %.04 = phi i32 [ 1, %49 ], [ %90, %89 ]
  %.1 = phi i32 [ %.02, %49 ], [ %.2, %89 ]
  %51 = load i32, i32* %2, align 4
  %52 = icmp sle i32 %.04, %51
...
54:                                               ; preds = %86, %53
  %.07 = phi i32 [ 0, %53 ], [ %87, %86 ]
  %.05 = phi i32 [ 0, %53 ], [ %.16, %86 ]
  %.2 = phi i32 [ %.1, %53 ], [ %.3, %86 ]
...
63:                                               ; preds = %83, %62
  %.16 = phi i32 [ %.05, %62 ], [ %79, %83 ]
  %.3 = phi i32 [ %.2, %62 ], [ %.4, %83 ]
  %.0 = phi i32 [ 0, %62 ], [ %84, %83 ]
...
94:                                               ; preds = %46
  %95 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %.02)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s368368516.cpp() #0 section ".text.startup" {
