; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00205/s171158354.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00205/s171158354.cpp"
...
@_ZZ5solveRSt6vectorIiSaIiEEE1s = private unnamed_addr constant [3 x i32] [i32 0, i32 1, i32 2], align 4
@_ZZ5solveRSt6vectorIiSaIiEEE1t = private unnamed_addr constant [3 x i32] [i32 1, i32 2, i32 0], align 4
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s171158354.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define void @_Z5solveRSt6vectorIiSaIiEE(%"class.std::vector"* dereferenceable(24) %0) #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %6, i8* align 4 bitcast ([3 x i32]* @_ZZ5solveRSt6vectorIiSaIiEEE1s to i8*), i64 12, i1 false)
  %7 = bitcast [3 x i32]* %4 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %7, i8* align 4 bitcast ([3 x i32]* @_ZZ5solveRSt6vectorIiSaIiEEE1t to i8*), i64 12, i1 false)
  br label %8
...
25:                                               ; preds = %22
  invoke void @_Z5solveRSt6vectorIiSaIiEE(%"class.std::vector"* dereferenceable(24) %1)
...
30:                                               ; preds = %14
  %31 = insertvalue { i8*, i32 } undef, i8* %16, 0
  %32 = insertvalue { i8*, i32 } %31, i32 %17, 1
  resume { i8*, i32 } %32
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s171158354.cpp() #0 section ".text.startup" {
