; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03724/s267664586.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03724/s267664586.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s267664586.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define void @_Z4killv() #0 {
  %1 = load i32, i32* @n, align 4
  %2 = sext i32 %1 to i64
  %3 = getelementptr inbounds i32, i32* getelementptr inbounds ([100100 x i32], [100100 x i32]* @a, i32 0, i32 0), i64 %2
  %4 = call i32* @_ZSt11max_elementIPiET_S1_S1_(i32* getelementptr inbounds ([100100 x i32], [100100 x i32]* @a, i32 0, i32 0), i32* %3)
...
10:                                               ; preds = %0
  %11 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i32 0, i32 0))
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s267664586.cpp() #0 section ".text.startup" {
