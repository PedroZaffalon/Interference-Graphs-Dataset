; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01078/s454676431.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01078/s454676431.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s454676431.cpp, i8* null }]
...
16:                                               ; preds = %0
  ...
  %26 = fdiv double 0x400921FB54442D18, %25
  %27 = load i32, i32* %2, align 4
  %28 = sub nsw i32 %27, 1
  %29 = sitofp i32 %28 to double
  %30 = fmul double %26, %29
  %31 = call double @tan(double %30) #3
  ...
  %39 = fsub double %13, %38
  br label %40

40:                                               ; preds = %16, %0
  %.0 = phi double [ %39, %16 ], [ %13, %0 ]
  %41 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i32 0, i32 0), double %.0)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s454676431.cpp() #0 section ".text.startup" {
