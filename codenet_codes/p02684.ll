; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02684/s301930706.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02684/s301930706.cpp"
...
@ESP = global i64 1000000000000000000, align 8
@INF = global i64 1000000007, align 8
@_ZSt3cin = external global %"class.std::basic_istream", align 8
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@.str = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s301930706.cpp, i8* null }]
...
21:                                               ; preds = %17
  %22 = getelementptr inbounds i64, i64* %16, i64 %.01
...
36:                                               ; preds = %38, %26
  %.02 = phi i64 [ %28, %26 ], [ %40, %38 ]
  %.0 = phi i64 [ %31, %26 ], [ %41, %38 ]
  %37 = icmp slt i64 %.0, %35
  br i1 %37, label %38, label %42

38:                                               ; preds = %36
  %39 = getelementptr inbounds i64, i64* %16, i64 %.02
  %40 = load i64, i64* %39, align 8
  %41 = add nsw i64 %.0, 1
  br label %36

42:                                               ; preds = %36
  %43 = getelementptr inbounds i64, i64* %16, i64 %.02
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s301930706.cpp() #0 section ".text.startup" {
