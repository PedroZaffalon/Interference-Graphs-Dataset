; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02664/s367171780.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02664/s367171780.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s367171780.cpp, i8* null }]
...
30:                                               ; preds = %88, %86, %81, %73, %63, %59, %51, %45, %42, %34, %26, %18, %9, %0
...
86:                                               ; preds = %85, %77
  %87 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsIcSt11char_traitsIcESaIcEERSt13basic_ostreamIT_T0_ES7_RKNSt7__cxx1112basic_stringIS4_S5_T1_EE(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, %"class.std::__cxx11::basic_string"* dereferenceable(32) %1)
...
91:                                               ; preds = %30
  %92 = insertvalue { i8*, i32 } undef, i8* %32, 0
  %93 = insertvalue { i8*, i32 } %92, i32 %33, 1
  resume { i8*, i32 } %93
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s367171780.cpp() #0 section ".text.startup" {
