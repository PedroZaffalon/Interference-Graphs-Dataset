; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02845/s662136848.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02845/s662136848.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s662136848.cpp, i8* null }]
...
14:                                               ; preds = %10
  ...
  %15 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %2, i64 0) #3
  store i32 3, i32* %15, align 4
  br label %16

16:                                               ; preds = %70, %14
  %.05 = phi i32 [ 0, %14 ], [ %71, %70 ]
  %.04 = phi i64 [ 1, %14 ], [ %63, %70 ]
  %17 = load i32, i32* @N, align 4
  %18 = icmp slt i32 %.05, %17
  br i1 %18, label %19, label %72

19:                                               ; preds = %16
  %20 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* @_ZSt3cin, i32* dereferenceable(4) %1)
...
72:                                               ; preds = %16
  %73 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEx(%"class.std::basic_ostream"* @_ZSt4cout, i64 %.04)
...
79:                                               ; preds = %78, %37
  %.13 = phi i32 [ %.02, %78 ], [ %40, %37 ]
  %.1 = phi i8* [ %.01, %78 ], [ %39, %37 ]
  %80 = insertvalue { i8*, i32 } undef, i8* %.1, 0
  %81 = insertvalue { i8*, i32 } %80, i32 %.13, 1
  resume { i8*, i32 } %81
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s662136848.cpp() #0 section ".text.startup" {
