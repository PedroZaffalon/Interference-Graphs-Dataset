; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03002/s380327642.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03002/s380327642.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s380327642.cpp, i8* null }]
...
29:                                               ; preds = %65, %28
  %.07 = phi i64 [ 0, %28 ], [ %60, %65 ]
  %.05 = phi i64 [ 0, %28 ], [ %.16, %65 ]
  %.04 = phi i64 [ 0, %28 ], [ %64, %65 ]
  %.0 = phi i64 [ 0, %28 ], [ %66, %65 ]
...
34:                                               ; preds = %44, %33
  %.16 = phi i64 [ %.05, %33 ], [ %49, %44 ]
  %.1 = phi i64 [ %.04, %33 ], [ %48, %44 ]
...
44:                                               ; preds = %42
  %45 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %3, i64 %.16) #3
...
67:                                               ; preds = %54, %29
  %68 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEx(%"class.std::basic_ostream"* @_ZSt4cout, i64 %.07)
...
72:                                               ; preds = %24, %20
  ...
  %74 = insertvalue { i8*, i32 } %73, i32 %.02, 1
  resume { i8*, i32 } %74
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s380327642.cpp() #0 section ".text.startup" {
