; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p04021/s900425924.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p04021/s900425924.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s900425924.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define i64 @_Z7pow_modxxx(i64 %0, i64 %1, i64 %2) #0 {
  %4 = srem i64 %0, %2
  %5 = icmp sgt i64 %1, 0
...
6:                                                ; preds = %3
  %7 = sdiv i64 %1, 2
  %8 = call i64 @_Z7pow_modxxx(i64 %4, i64 %7, i64 %2)
  %9 = srem i64 %1, 2
  %10 = icmp ne i64 %9, 0
...
81:                                               ; preds = %101, %80
  %.05 = phi i32 [ 1, %80 ], [ %102, %101 ]
  %.04 = phi i32 [ 0, %80 ], [ %.1, %101 ]
...
93:                                               ; preds = %84
  ...
  call void @_ZSt4swapIiENSt9enable_ifIXsr6__and_ISt6__not_ISt15__is_tuple_likeIT_EESt21is_move_constructibleIS3_ESt18is_move_assignableIS3_EEE5valueEvE4typeERS3_SC_(i32* dereferenceable(4) %97, i32* dereferenceable(4) %99) #3
  br label %100

100:                                              ; preds = %93, %84
  %.1 = phi i32 [ %94, %93 ], [ %.04, %84 ]
  br label %101
...
103:                                              ; preds = %81
  %104 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %.04)
...
112:                                              ; preds = %108, %66, %22
  %.02 = phi i32 [ %25, %22 ], [ %111, %108 ], [ %69, %66 ]
  %.01 = phi i8* [ %24, %22 ], [ %110, %108 ], [ %68, %66 ]
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %3) #3
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %2) #3
  br label %113
...
113:                                              ; preds = %112
  ...
  %115 = insertvalue { i8*, i32 } %114, i32 %.02, 1
  resume { i8*, i32 } %115
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s900425924.cpp() #0 section ".text.startup" {
