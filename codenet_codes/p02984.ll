; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02984/s519375772.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02984/s519375772.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s519375772.cpp, i8* null }]
...
define i32 @main() #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  invoke void @_ZNSt6vectorIxSaIxEEC2EmRKS0_(%"class.std::vector"* %2, i64 %6, %"class.std::allocator"* dereferenceable(1) %3)
...
11:                                               ; preds = %8
  ...
  %13 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %2, i64 %12) #3
  %14 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERx(%"class.std::basic_istream"* @_ZSt3cin, i64* dereferenceable(8) %13)
...
38:                                               ; preds = %43, %34
  %.07 = phi i32 [ %37, %34 ], [ %52, %43 ]
  %.06 = phi i64 [ 0, %34 ], [ %49, %43 ]
  %.05 = phi i64 [ %.02, %34 ], [ %48, %43 ]
  %39 = load i32, i32* %1, align 4
  %40 = sdiv i32 %39, 2
  %41 = sext i32 %40 to i64
  %42 = icmp slt i64 %.06, %41
...
53:                                               ; preds = %38
  %54 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEx(%"class.std::basic_ostream"* @_ZSt4cout, i64 %.05)
...
61:                                               ; preds = %26, %22
  ...
  %62 = insertvalue { i8*, i32 } undef, i8* %.0, 0
  %63 = insertvalue { i8*, i32 } %62, i32 %.01, 1
  resume { i8*, i32 } %63
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s519375772.cpp() #0 section ".text.startup" {
