; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01244/s502621904.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01244/s502621904.cpp"
...
$_Z5chmaxIddEvRT_T0_ = comdat any
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s502621904.cpp, i8* null }]
...
define internal void @__cxx_global_var_init.1() #0 section ".text.startup" {
  call void @_ZNSt6vectorIxSaIxEEC2Ev(%"class.std::vector"* @pr) #3
  %1 = call i32 @__cxa_atexit(void (i8*)* bitcast (void (%"class.std::vector"*)* @_ZNSt6vectorIxSaIxEED2Ev to void (i8*)*), i8* bitcast (%"class.std::vector"* @pr to i8*), i8* @__dso_handle) #3
  ret void
}
...
; Function Attrs: noinline nounwind uwtable
define i64 @_Z7isprimex(i64 %0) #4 {
  %2 = icmp sle i64 %0, 1
...
16:                                               ; preds = %15, %11, %3
  %.0 = phi i64 [ 0, %3 ], [ 0, %11 ], [ 1, %15 ]
  ret i64 %.0
}

; Function Attrs: noinline uwtable
define void @_Z3dfsxdxx(i64 %0, double %1, i64 %2, i64 %3) #0 {
...
7:                                                ; preds = %4
  ...
  %9 = fdiv double %1, %8
  call void @_Z5chmaxIddEvRT_T0_(double* dereferenceable(8) @ans, double %9)
  br label %11
...
15:                                               ; preds = %38, %14
  %.02 = phi i64 [ 1, %14 ], [ %37, %38 ]
  %.01 = phi double [ 0.000000e+00, %14 ], [ %24, %38 ]
  %.0 = phi i64 [ 0, %14 ], [ %39, %38 ]
  %16 = icmp sle i64 %.0, %3
...
22:                                               ; preds = %17
  %23 = sitofp i64 %.02 to double
  %24 = fadd double %.01, %23
  %25 = mul nsw i64 %0, %.02
  %26 = fmul double %1, %24
  %27 = add nsw i64 %2, 1
  call void @_Z3dfsxdxx(i64 %25, double %26, i64 %27, i64 %.0)
  %28 = load i64, i64* @k, align 8
  %29 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* @pr, i64 %2) #3
  %30 = load i64, i64* %29, align 8
  %31 = sdiv i64 %28, %30
  %32 = icmp sgt i64 %.02, %31
...
34:                                               ; preds = %22
  %35 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* @pr, i64 %2) #3
  %36 = load i64, i64* %35, align 8
  %37 = mul nsw i64 %.02, %36
  br label %38
...
40:                                               ; preds = %33, %21, %15, %13, %10
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_Z5chmaxIddEvRT_T0_(double* dereferenceable(8) %0, double %1) #4 comdat {
...
14:                                               ; preds = %10
  ...
  %16 = call i64 @_Z7isprimex(i64 %15)
  %17 = icmp ne i64 %16, 0
  br i1 %17, label %18, label %19

18:                                               ; preds = %14
  call void @_ZNSt6vectorIxSaIxEE12emplace_backIJRxEEEvDpOT_(%"class.std::vector"* @pr, i64* dereferenceable(8) %1)
  br label %19
...
24:                                               ; preds = %28, %23
  %25 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERx(%"class.std::basic_istream"* @_ZSt3cin, i64* dereferenceable(8) @k)
  %26 = load i64, i64* @k, align 8
  %27 = icmp ne i64 %26, 0
  br i1 %27, label %28, label %32

28:                                               ; preds = %24
  store double 1.000000e+00, double* @ans, align 8
  call void @_Z3dfsxdxx(i64 1, double 1.000000e+00, i64 0, i64 100)
  %29 = load double, double* @ans, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s502621904.cpp() #0 section ".text.startup" {
