; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02985/s824366295.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02985/s824366295.cpp"
...
@f = global [1000000 x i8] zeroinitializer, align 16
@e = global [1000000 x %"class.std::vector"] zeroinitializer, align 16
@_ZSt3cin = external global %"class.std::basic_istream", align 8
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@.str = private unnamed_addr constant [26 x i8] c"vector::_M_realloc_insert\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s824366295.cpp, i8* null }]
...
1:                                                ; preds = %1, %0
  %2 = phi %"class.std::vector"* [ getelementptr inbounds ([1000000 x %"class.std::vector"], [1000000 x %"class.std::vector"]* @e, i32 0, i32 0), %0 ], [ %3, %1 ]
  call void @_ZNSt6vectorIiSaIiEEC2Ev(%"class.std::vector"* %2) #3
  %3 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %2, i64 1
  %4 = icmp eq %"class.std::vector"* %3, getelementptr inbounds ([1000000 x %"class.std::vector"], [1000000 x %"class.std::vector"]* @e, i64 1, i64 0)
...
2:                                                ; preds = %2, %1
  %3 = phi %"class.std::vector"* [ getelementptr inbounds ([1000000 x %"class.std::vector"], [1000000 x %"class.std::vector"]* @e, i64 1, i64 0), %1 ], [ %4, %2 ]
  %4 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %3, i64 -1
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %4) #3
  %5 = icmp eq %"class.std::vector"* %4, getelementptr inbounds ([1000000 x %"class.std::vector"], [1000000 x %"class.std::vector"]* @e, i32 0, i32 0)
...
define i64 @_Z3dfsii(i32 %0, i32 %1) #0 {
  %3 = sext i32 %0 to i64
  %4 = getelementptr inbounds [1000000 x i8], [1000000 x i8]* @f, i64 0, i64 %3
...
13:                                               ; preds = %10, %7
  %.01 = phi i32 [ %9, %7 ], [ %12, %10 ]
  br label %14

14:                                               ; preds = %42, %13
  %.02 = phi i64 [ 1, %13 ], [ %.13, %42 ]
  %.1 = phi i32 [ %.01, %13 ], [ %.2, %42 ]
  %.0 = phi i32 [ 0, %13 ], [ %43, %42 ]
  %15 = sext i32 %.0 to i64
  %16 = sext i32 %0 to i64
  %17 = getelementptr inbounds [1000000 x %"class.std::vector"], [1000000 x %"class.std::vector"]* @e, i64 0, i64 %16
...
20:                                               ; preds = %14
  ...
  %22 = getelementptr inbounds [1000000 x %"class.std::vector"], [1000000 x %"class.std::vector"]* @e, i64 0, i64 %21
  %23 = sext i32 %.0 to i64
  %24 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %22, i64 %23) #3
  %25 = load i32, i32* %24, align 4
  %26 = sext i32 %25 to i64
  %27 = getelementptr inbounds [1000000 x i8], [1000000 x i8]* @f, i64 0, i64 %26
  %28 = load i8, i8* %27, align 1
  %29 = trunc i8 %28 to i1
  br i1 %29, label %41, label %30

30:                                               ; preds = %20
  %31 = srem i64 %.02, 1000000007
  %32 = sext i32 %0 to i64
  %33 = getelementptr inbounds [1000000 x %"class.std::vector"], [1000000 x %"class.std::vector"]* @e, i64 0, i64 %32
  %34 = sext i32 %.0 to i64
  %35 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %33, i64 %34) #3
  %36 = load i32, i32* %35, align 4
  %37 = call i64 @_Z3dfsii(i32 %36, i32 %.1)
...
41:                                               ; preds = %30, %20
  %.13 = phi i64 [ %.02, %20 ], [ %39, %30 ]
  %.2 = phi i32 [ %.1, %20 ], [ %40, %30 ]
  br label %42
...
12:                                               ; preds = %8
  ...
  %18 = getelementptr inbounds [1000000 x %"class.std::vector"], [1000000 x %"class.std::vector"]* @e, i64 0, i64 %17
  %19 = load i32, i32* %2, align 4
  %20 = sub nsw i32 %19, 1
  store i32 %20, i32* %3, align 4
  call void @_ZNSt6vectorIiSaIiEE9push_backEOi(%"class.std::vector"* %18, i32* dereferenceable(4) %3)
  %21 = load i32, i32* %2, align 4
  %22 = sub nsw i32 %21, 1
  %23 = sext i32 %22 to i64
  %24 = getelementptr inbounds [1000000 x %"class.std::vector"], [1000000 x %"class.std::vector"]* @e, i64 0, i64 %23
  %25 = load i32, i32* %1, align 4
  %26 = sub nsw i32 %25, 1
  store i32 %26, i32* %4, align 4
  call void @_ZNSt6vectorIiSaIiEE9push_backEOi(%"class.std::vector"* %24, i32* dereferenceable(4) %4)
  br label %27
...
29:                                               ; preds = %8
  ...
  %32 = getelementptr inbounds i8, i8* getelementptr inbounds ([1000000 x i8], [1000000 x i8]* @f, i32 0, i32 0), i64 %31
  store i8 0, i8* %5, align 1
  call void @_ZSt4fillIPbbEvT_S1_RKT0_(i8* getelementptr inbounds ([1000000 x i8], [1000000 x i8]* @f, i32 0, i32 0), i8* %32, i8* dereferenceable(1) %5)
  %33 = load i32, i32* @K, align 4
  %34 = call i64 @_Z3dfsii(i32 0, i32 %33)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s824366295.cpp() #0 section ".text.startup" {
