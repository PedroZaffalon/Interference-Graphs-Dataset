; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00300/s655335564.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00300/s655335564.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s655335564.cpp, i8* null }]
...
25:                                               ; preds = %21
  %26 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %17)
...
32:                                               ; preds = %28
  %33 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %17)
...
42:                                               ; preds = %38
  %43 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %17)
...
48:                                               ; preds = %38
  %49 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %17)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s655335564.cpp() #0 section ".text.startup" {
