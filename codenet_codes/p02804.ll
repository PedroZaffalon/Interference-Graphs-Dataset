; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02804/s326012069.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02804/s326012069.cpp"
...
@fct = global [1048581 x i64] zeroinitializer, align 16
@ar = global [1048581 x i64] zeroinitializer, align 16
@_ZSt3cin = external global %"class.std::basic_istream", align 8
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@.str = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s326012069.cpp, i8* null }]
...
define i64 @_Z3pwrxxx(i64 %0, i64 %1, i64 %2) #4 {
  br label %4
...
define i32 @main() #5 {
  ...
  store i64 1, i64* getelementptr inbounds ([1048581 x i64], [1048581 x i64]* @fct, i64 0, i64 0), align 16
  br label %20

20:                                               ; preds = %30, %0
  %.01 = phi i64 [ 1, %0 ], [ %31, %30 ]
  %21 = load i64, i64* %1, align 8
  %22 = icmp sle i64 %.01, %21
  br i1 %22, label %23, label %32

23:                                               ; preds = %20
  %24 = sub nsw i64 %.01, 1
  %25 = getelementptr inbounds [1048581 x i64], [1048581 x i64]* @fct, i64 0, i64 %24
  %26 = load i64, i64* %25, align 8
  %27 = mul nsw i64 %26, %.01
  %28 = srem i64 %27, 1000000007
  %29 = getelementptr inbounds [1048581 x i64], [1048581 x i64]* @fct, i64 0, i64 %.01
...
33:                                               ; preds = %39, %32
  %.12 = phi i64 [ 1, %32 ], [ %40, %39 ]
  %34 = load i64, i64* %1, align 8
  %35 = icmp sle i64 %.12, %34
  br i1 %35, label %36, label %41

36:                                               ; preds = %33
  %37 = getelementptr inbounds [1048581 x i64], [1048581 x i64]* @ar, i64 0, i64 %.12
...
41:                                               ; preds = %33
  ...
  %43 = getelementptr inbounds i64, i64* getelementptr inbounds ([1048581 x i64], [1048581 x i64]* @ar, i32 0, i64 1), i64 %42
  call void @_ZSt4sortIPxEvT_S1_(i64* getelementptr inbounds ([1048581 x i64], [1048581 x i64]* @ar, i32 0, i64 1), i64* %43)
  br label %44

44:                                               ; preds = %79, %41
  %.2 = phi i64 [ 1, %41 ], [ %80, %79 ]
  %.0 = phi i64 [ 0, %41 ], [ %78, %79 ]
  %45 = load i64, i64* %1, align 8
  %46 = load i64, i64* %2, align 8
  %47 = sub nsw i64 %45, %46
  %48 = add nsw i64 %47, 1
  %49 = icmp sle i64 %.2, %48
  br i1 %49, label %50, label %81

50:                                               ; preds = %44
  %51 = load i64, i64* %2, align 8
  %52 = sub nsw i64 %51, 1
  %53 = getelementptr inbounds [1048581 x i64], [1048581 x i64]* @fct, i64 0, i64 %52
  %54 = load i64, i64* %53, align 8
  %55 = call i64 @_Z3pwrxxx(i64 %54, i64 1000000005, i64 1000000007)
  %56 = load i64, i64* %1, align 8
  %57 = sub nsw i64 %56, %.2
  %58 = load i64, i64* %2, align 8
  %59 = sub nsw i64 %57, %58
  %60 = add nsw i64 %59, 1
  %61 = getelementptr inbounds [1048581 x i64], [1048581 x i64]* @fct, i64 0, i64 %60
  %62 = load i64, i64* %61, align 8
  %63 = call i64 @_Z3pwrxxx(i64 %62, i64 1000000005, i64 1000000007)
  %64 = mul nsw i64 %55, %63
  %65 = srem i64 %64, 1000000007
  %66 = load i64, i64* %1, align 8
  %67 = sub nsw i64 %66, %.2
  %68 = getelementptr inbounds [1048581 x i64], [1048581 x i64]* @fct, i64 0, i64 %67
  %69 = load i64, i64* %68, align 8
  %70 = mul nsw i64 %65, %69
  %71 = srem i64 %70, 1000000007
  %72 = getelementptr inbounds [1048581 x i64], [1048581 x i64]* @ar, i64 0, i64 %.2
...
82:                                               ; preds = %93, %81
  %.3 = phi i64 [ 1, %81 ], [ %94, %93 ]
  %83 = load i64, i64* %1, align 8
  %84 = add nsw i64 %83, 1
  %85 = sdiv i64 %84, 2
  %86 = icmp sle i64 %.3, %85
  br i1 %86, label %87, label %95

87:                                               ; preds = %82
  %88 = getelementptr inbounds [1048581 x i64], [1048581 x i64]* @ar, i64 0, i64 %.3
  %89 = load i64, i64* %1, align 8
  %90 = sub nsw i64 %89, %.3
  %91 = add nsw i64 %90, 1
  %92 = getelementptr inbounds [1048581 x i64], [1048581 x i64]* @ar, i64 0, i64 %91
  call void @_ZSt4swapIxENSt9enable_ifIXsr6__and_ISt6__not_ISt15__is_tuple_likeIT_EESt21is_move_constructibleIS3_ESt18is_move_assignableIS3_EEE5valueEvE4typeERS3_SC_(i64* dereferenceable(8) %88, i64* dereferenceable(8) %92) #3
  br label %93
...
96:                                               ; preds = %130, %95
  %.4 = phi i64 [ 1, %95 ], [ %131, %130 ]
  %.1 = phi i64 [ %.0, %95 ], [ %129, %130 ]
  %97 = load i64, i64* %1, align 8
  %98 = load i64, i64* %2, align 8
  %99 = sub nsw i64 %97, %98
  %100 = add nsw i64 %99, 1
  %101 = icmp sle i64 %.4, %100
  br i1 %101, label %102, label %132

102:                                              ; preds = %96
  %103 = load i64, i64* %2, align 8
  %104 = sub nsw i64 %103, 1
  %105 = getelementptr inbounds [1048581 x i64], [1048581 x i64]* @fct, i64 0, i64 %104
  %106 = load i64, i64* %105, align 8
  %107 = call i64 @_Z3pwrxxx(i64 %106, i64 1000000005, i64 1000000007)
  %108 = load i64, i64* %1, align 8
  %109 = sub nsw i64 %108, %.4
  %110 = load i64, i64* %2, align 8
  %111 = sub nsw i64 %109, %110
  %112 = add nsw i64 %111, 1
  %113 = getelementptr inbounds [1048581 x i64], [1048581 x i64]* @fct, i64 0, i64 %112
  %114 = load i64, i64* %113, align 8
  %115 = call i64 @_Z3pwrxxx(i64 %114, i64 1000000005, i64 1000000007)
  %116 = mul nsw i64 %107, %115
  %117 = srem i64 %116, 1000000007
  %118 = load i64, i64* %1, align 8
  %119 = sub nsw i64 %118, %.4
  %120 = getelementptr inbounds [1048581 x i64], [1048581 x i64]* @fct, i64 0, i64 %119
  %121 = load i64, i64* %120, align 8
  %122 = mul nsw i64 %117, %121
  %123 = srem i64 %122, 1000000007
  %124 = getelementptr inbounds [1048581 x i64], [1048581 x i64]* @ar, i64 0, i64 %.4
...
132:                                              ; preds = %96
  %133 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEx(%"class.std::basic_ostream"* @_ZSt4cout, i64 %.1)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s326012069.cpp() #0 section ".text.startup" {
