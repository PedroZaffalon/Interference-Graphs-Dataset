; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00013/s129974276.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00013/s129974276.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s129974276.cpp, i8* null }]
...
3:                                                ; preds = %35, %0
  %4 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* @_ZSt3cin, i32* dereferenceable(4) %2)
...
5:                                                ; preds = %3
  ...
  %14 = invoke zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEEcvbEv(%"class.std::basic_ios"* %13)
...
25:                                               ; preds = %16
  ...
  %27 = sub i64 %26, 1
  %28 = invoke dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEE2atEm(%"class.std::vector"* %1, i64 %27)
...
37:                                               ; preds = %21
  %38 = insertvalue { i8*, i32 } undef, i8* %23, 0
  %39 = insertvalue { i8*, i32 } %38, i32 %24, 1
  resume { i8*, i32 } %39
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s129974276.cpp() #0 section ".text.startup" {
