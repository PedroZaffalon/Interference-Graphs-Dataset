; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02164/s268683606.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02164/s268683606.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s268683606.cpp, i8* null }]
...
define double @_Z4calcdd(double %0, double %1) #4 {
  %3 = fsub double %0, %1
...
define i32 @main() #6 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  invoke void @_ZNSt6vectorIdSaIdEEC2EmRKS0_(%"class.std::vector"* %2, i64 %12, %"class.std::allocator"* dereferenceable(1) %3)
...
13:                                               ; preds = %0
  ...
  invoke void @_ZNSt6vectorIdSaIdEEC2EmRKS0_(%"class.std::vector"* %4, i64 %15, %"class.std::allocator"* dereferenceable(1) %5)
...
20:                                               ; preds = %17
  ...
  %22 = call dereferenceable(8) double* @_ZNSt6vectorIdSaIdEEixEm(%"class.std::vector"* %2, i64 %21) #3
  %23 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERd(%"class.std::basic_istream"* @_ZSt3cin, double* dereferenceable(8) %22)
          to label %24 unwind label %39

24:                                               ; preds = %20
  %25 = sext i32 %.04 to i64
  %26 = call dereferenceable(8) double* @_ZNSt6vectorIdSaIdEEixEm(%"class.std::vector"* %4, i64 %25) #3
  %27 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERd(%"class.std::basic_istream"* %23, double* dereferenceable(8) %26)
...
43:                                               ; preds = %17
  ...
  invoke void @_ZNSt6vectorIiSaIiEEC2EmRKS0_(%"class.std::vector.0"* %6, i64 %45, %"class.std::allocator.2"* dereferenceable(1) %7)
...
50:                                               ; preds = %47
  ...
  %52 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.0"* %6, i64 %51) #3
...
60:                                               ; preds = %107, %59
  %.06 = phi double [ 1.000000e+09, %59 ], [ %96, %107 ]
  br label %61

61:                                               ; preds = %83, %60
  %.011 = phi i32 [ 0, %60 ], [ %84, %83 ]
  %.010 = phi double [ 0.000000e+00, %60 ], [ %76, %83 ]
  %.09 = phi double [ 0.000000e+00, %60 ], [ %70, %83 ]
  %.08 = phi double [ 0.000000e+00, %60 ], [ %79, %83 ]
  %.07 = phi double [ 0.000000e+00, %60 ], [ %82, %83 ]
...
64:                                               ; preds = %61
  ...
  %69 = call dereferenceable(8) double* @_ZNSt6vectorIdSaIdEEixEm(%"class.std::vector"* %2, i64 %68) #3
  ...
  %75 = call dereferenceable(8) double* @_ZNSt6vectorIdSaIdEEixEm(%"class.std::vector"* %4, i64 %74) #3
  %76 = load double, double* %75, align 8
  %77 = fsub double %76, %.010
  %78 = fsub double %70, %.09
  %79 = call double @atan2(double %77, double %78) #3
  %80 = invoke double @_Z4calcdd(double %.08, double %79)
          to label %81 unwind label %85

81:                                               ; preds = %64
  %82 = fadd double %.07, %80
  br label %83
...
89:                                               ; preds = %61
  %90 = fsub double -0.000000e+00, %.010
  %91 = fsub double -0.000000e+00, %.09
  %92 = call double @atan2(double %90, double %91) #3
  %93 = invoke double @_Z4calcdd(double %.08, double %92)
          to label %94 unwind label %85

94:                                               ; preds = %89
  %95 = fadd double %.07, %93
  %96 = call double @llvm.minnum.f64(double %.06, double %95)
  br label %97

97:                                               ; preds = %94
  %98 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector.0"* %6) #3
  %99 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %8, i32 0, i32 0
  store i32* %98, i32** %99, align 8
  %100 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector.0"* %6) #3
...
107:                                              ; preds = %97
  br i1 %106, label %60, label %108

108:                                              ; preds = %107
  %109 = load double, double* @_ZL2pi, align 8
  %110 = fdiv double 1.800000e+02, %109
  %111 = fmul double %96, %110
  %112 = invoke i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i32 0, i32 0), double %111)
...
114:                                              ; preds = %85, %55, %39
  %.01 = phi i32 [ %42, %39 ], [ %88, %85 ], [ %58, %55 ]
  %.0 = phi i8* [ %41, %39 ], [ %87, %85 ], [ %57, %55 ]
  call void @_ZNSt6vectorIdSaIdEED2Ev(%"class.std::vector"* %4) #3
  br label %115

115:                                              ; preds = %114, %35
  %.12 = phi i32 [ %.01, %114 ], [ %38, %35 ]
  %.1 = phi i8* [ %.0, %114 ], [ %37, %35 ]
  call void @_ZNSt6vectorIdSaIdEED2Ev(%"class.std::vector"* %2) #3
  br label %116

116:                                              ; preds = %115, %31
  %.23 = phi i32 [ %.12, %115 ], [ %34, %31 ]
  %.2 = phi i8* [ %.1, %115 ], [ %33, %31 ]
  %117 = insertvalue { i8*, i32 } undef, i8* %.2, 0
  %118 = insertvalue { i8*, i32 } %117, i32 %.23, 1
  resume { i8*, i32 } %118
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s268683606.cpp() #0 section ".text.startup" {
