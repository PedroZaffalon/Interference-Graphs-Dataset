; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00874/s739547884.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00874/s739547884.cpp"
...
20:                                               ; preds = %27, %12
  %.06 = phi i32 [ 0, %12 ], [ %28, %27 ]
  %21 = load i32, i32* %1, align 4
  %22 = icmp slt i32 %.06, %21
...
39:                                               ; preds = %30
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* %16, i32* %42)
  %43 = load i32, i32* %2, align 4
  %44 = sext i32 %43 to i64
  %45 = getelementptr inbounds i32, i32* %19, i64 %44
  call void @_ZSt4sortIPiEvT_S1_(i32* %19, i32* %45)
...
50:                                               ; preds = %110, %39
  %.08 = phi i32 [ %47, %39 ], [ %.412, %110 ]
  %.01 = phi i32 [ %49, %39 ], [ %.45, %110 ]
  %.0 = phi i32 [ 0, %39 ], [ %.4, %110 ]
  %51 = icmp sge i32 %.08, 0
  br i1 %51, label %54, label %52

52:                                               ; preds = %50
  %53 = icmp sge i32 %.01, 0
  br label %54
...
107:                                              ; preds = %101, %95
  %.19 = phi i32 [ %100, %95 ], [ %.08, %101 ]
  %.12 = phi i32 [ %.01, %95 ], [ %106, %101 ]
  %.1 = phi i32 [ %99, %95 ], [ %105, %101 ]
  br label %108

108:                                              ; preds = %107, %80
  %.210 = phi i32 [ %85, %80 ], [ %.19, %107 ]
  %.23 = phi i32 [ %86, %80 ], [ %.12, %107 ]
  %.2 = phi i32 [ %84, %80 ], [ %.1, %107 ]
  br label %109

109:                                              ; preds = %108, %66
  %.311 = phi i32 [ %71, %66 ], [ %.210, %108 ]
  %.34 = phi i32 [ %.01, %66 ], [ %.23, %108 ]
  %.3 = phi i32 [ %70, %66 ], [ %.2, %108 ]
  br label %110

110:                                              ; preds = %109, %58
  %.412 = phi i32 [ %.08, %58 ], [ %.311, %109 ]
  %.45 = phi i32 [ %63, %58 ], [ %.34, %109 ]
  %.4 = phi i32 [ %62, %58 ], [ %.3, %109 ]
  br label %50
