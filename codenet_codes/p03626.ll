; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03626/s209365314.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03626/s209365314.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s209365314.cpp, i8* null }]
...
16:                                               ; preds = %92, %15
  %.01 = phi i32 [ -1, %15 ], [ %.7, %92 ]
  %.0 = phi i32 [ 0, %15 ], [ %93, %92 ]
...
34:                                               ; preds = %30
  store i64 3, i64* @ans, align 8
  br label %40

35:                                               ; preds = %97, %94, %70, %67, %46, %43, %25, %22, %13, %0
...
100:                                              ; preds = %35
  %101 = insertvalue { i8*, i32 } undef, i8* %37, 0
  %102 = insertvalue { i8*, i32 } %101, i32 %38, 1
  resume { i8*, i32 } %102
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s209365314.cpp() #0 section ".text.startup" {
