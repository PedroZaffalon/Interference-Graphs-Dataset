; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00383/s240329832.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00383/s240329832.cpp"
...
$_ZSteqIddEbRKSt4pairIT_T0_ES5_ = comdat any
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s240329832.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define { double, double } @_Z4linexxxx(i64 %0, i64 %1, i64 %2, i64 %3) #0 {
  %5 = alloca %"struct.std::pair", align 8
  call void @_ZNSt4pairIddEC2IddLb1EEEv(%"struct.std::pair"* %5)
  %6 = icmp eq i64 %0, %1
...
27:                                               ; preds = %13, %7
  %28 = bitcast %"struct.std::pair"* %5 to { double, double }*
...
31:                                               ; preds = %28
  %32 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERx(%"class.std::basic_istream"* %27, i64* dereferenceable(8) %30)
...
48:                                               ; preds = %19
  call void @_ZNSt6vectorISt4pairIddESaIS1_EEC2Ev(%"class.std::vector.0"* %7) #3
  br label %49

49:                                               ; preds = %130, %48
  %.06 = phi i32 [ 0, %48 ], [ %131, %130 ]
...
60:                                               ; preds = %56
  invoke void @_ZNSt4pairIddEC2IddLb1EEEv(%"struct.std::pair"* %8)
...
78:                                               ; preds = %74
  ...
  %81 = invoke dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEE2atEm(%"class.std::vector"* %5, i64 %80)
...
86:                                               ; preds = %82
  ...
  %88 = invoke { double, double } @_Z4linexxxx(i64 %75, i64 %79, i64 %83, i64 %87)
          to label %89 unwind label %96

89:                                               ; preds = %86
  %90 = bitcast %"struct.std::pair"* %9 to { double, double }*
  %91 = getelementptr inbounds { double, double }, { double, double }* %90, i32 0, i32 0
  %92 = extractvalue { double, double } %88, 0
  store double %92, double* %91, align 8
  %93 = getelementptr inbounds { double, double }, { double, double }* %90, i32 0, i32 1
  %94 = extractvalue { double, double } %88, 1
  store double %94, double* %93, align 8
  %95 = call dereferenceable(16) %"struct.std::pair"* @_ZNSt4pairIddEaSEOS0_(%"struct.std::pair"* %8, %"struct.std::pair"* dereferenceable(16) %9) #3
  br label %125

96:                                               ; preds = %174, %170, %163, %157, %154, %132, %125, %115, %111, %107, %103, %100, %86, %82, %78, %74, %71, %64, %61, %60
  %97 = landingpad { i8*, i32 }
          cleanup
  %98 = extractvalue { i8*, i32 } %97, 0
  %99 = extractvalue { i8*, i32 } %97, 1
  call void @_ZNSt6vectorISt4pairIddESaIS1_EED2Ev(%"class.std::vector.0"* %7) #3
  br label %177
...
107:                                              ; preds = %103
  ...
  %110 = invoke dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEE2atEm(%"class.std::vector"* %5, i64 %109)
...
115:                                              ; preds = %111
  ...
  %117 = invoke { double, double } @_Z4linexxxx(i64 %104, i64 %108, i64 %112, i64 %116)
          to label %118 unwind label %96

118:                                              ; preds = %115
  %119 = bitcast %"struct.std::pair"* %10 to { double, double }*
  ...
  %124 = call dereferenceable(16) %"struct.std::pair"* @_ZNSt4pairIddEaSEOS0_(%"struct.std::pair"* %8, %"struct.std::pair"* dereferenceable(16) %10) #3
  br label %125

125:                                              ; preds = %118, %89
  invoke void @_ZNSt6vectorISt4pairIddESaIS1_EE9push_backERKS1_(%"class.std::vector.0"* %7, %"struct.std::pair"* dereferenceable(16) %8)
...
132:                                              ; preds = %49
  %133 = call %"struct.std::pair"* @_ZNSt6vectorISt4pairIddESaIS1_EE5beginEv(%"class.std::vector.0"* %7) #3
  ...
  %135 = call %"struct.std::pair"* @_ZNSt6vectorISt4pairIddESaIS1_EE3endEv(%"class.std::vector.0"* %7) #3
  ...
  invoke void @_ZSt4sortIN9__gnu_cxx17__normal_iteratorIPSt4pairIddESt6vectorIS3_SaIS3_EEEEEvT_S9_(%"struct.std::pair"* %138, %"struct.std::pair"* %140)
...
147:                                              ; preds = %168, %141
  %.0 = phi i32 [ 0, %141 ], [ %169, %168 ]
  %148 = sext i32 %.0 to i64
  %149 = call i64 @_ZNKSt6vectorISt4pairIddESaIS1_EE4sizeEv(%"class.std::vector.0"* %7) #3
...
154:                                              ; preds = %147
  ...
  %156 = invoke dereferenceable(16) %"struct.std::pair"* @_ZNSt6vectorISt4pairIddESaIS1_EE2atEm(%"class.std::vector.0"* %7, i64 %155)
...
157:                                              ; preds = %154
  ...
  %162 = invoke dereferenceable(16) %"struct.std::pair"* @_ZNSt6vectorISt4pairIddESaIS1_EE2atEm(%"class.std::vector.0"* %7, i64 %161)
          to label %163 unwind label %96

163:                                              ; preds = %157
  %164 = invoke zeroext i1 @_ZSteqIddEbRKSt4pairIT_T0_ES5_(%"struct.std::pair"* dereferenceable(16) %156, %"struct.std::pair"* dereferenceable(16) %162)
...
170:                                              ; preds = %166, %147
  %.08 = phi i8 [ 1, %166 ], [ 0, %147 ]
  %171 = trunc i8 %.08 to i1
...
177:                                              ; preds = %96, %44
  %.02 = phi i32 [ %47, %44 ], [ %99, %96 ]
  %.01 = phi i8* [ %46, %44 ], [ %98, %96 ]
  call void @_ZNSt6vectorIxSaIxEED2Ev(%"class.std::vector"* %5) #3
  br label %178

178:                                              ; preds = %177, %40
  %.13 = phi i32 [ %.02, %177 ], [ %43, %40 ]
  %.1 = phi i8* [ %.01, %177 ], [ %42, %40 ]
  call void @_ZNSt6vectorIxSaIxEED2Ev(%"class.std::vector"* %3) #3
  br label %179

179:                                              ; preds = %178, %36
  %.24 = phi i32 [ %.13, %178 ], [ %39, %36 ]
  %.2 = phi i8* [ %.1, %178 ], [ %38, %36 ]
  %180 = insertvalue { i8*, i32 } undef, i8* %.2, 0
  %181 = insertvalue { i8*, i32 } %180, i32 %.24, 1
  resume { i8*, i32 } %181
}
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt6vectorISt4pairIddESaIS1_EE9push_backERKS1_(%"class.std::vector.0"* %0, %"struct.std::pair"* dereferenceable(16) %1) #0 comdat align 2 {
...
13:                                               ; preds = %2
  ...
  call void @_ZNSt16allocator_traitsISaISt4pairIddEEE9constructIS1_JRKS1_EEEvRS2_PT_DpOT0_(%"class.std::allocator.2"* dereferenceable(1) %16, %"struct.std::pair"* %20, %"struct.std::pair"* dereferenceable(16) %1)
...
26:                                               ; preds = %2
  %27 = call %"struct.std::pair"* @_ZNSt6vectorISt4pairIddESaIS1_EE3endEv(%"class.std::vector.0"* %0) #3
  ...
  call void @_ZNSt6vectorISt4pairIddESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_(%"class.std::vector.0"* %0, %"struct.std::pair"* %30, %"struct.std::pair"* dereferenceable(16) %1)
  br label %31
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr zeroext i1 @_ZSteqIddEbRKSt4pairIT_T0_ES5_(%"struct.std::pair"* dereferenceable(16) %0, %"struct.std::pair"* dereferenceable(16) %1) #4 comdat {
  %3 = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* %0, i32 0, i32 0
...
; Function Attrs: noinline uwtable
define linkonce_odr dereferenceable(16) %"struct.std::pair"* @_ZNSt6vectorISt4pairIddESaIS1_EE2atEm(%"class.std::vector.0"* %0, i64 %1) #0 comdat align 2 {
  call void @_ZNKSt6vectorISt4pairIddESaIS1_EE14_M_range_checkEm(%"class.std::vector.0"* %0, i64 %1)
  %3 = call dereferenceable(16) %"struct.std::pair"* @_ZNSt6vectorISt4pairIddESaIS1_EEixEm(%"class.std::vector.0"* %0, i64 %1) #3
...
5:                                                ; preds = %2
  ...
  call void (i8*, ...) @_ZSt24__throw_out_of_range_fmtPKcz(i8* getelementptr inbounds ([74 x i8], [74 x i8]* @.str, i32 0, i32 0), i64 %1, i64 %6) #14
  unreachable
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt16allocator_traitsISaISt4pairIddEEE9constructIS1_JRKS1_EEEvRS2_PT_DpOT0_(%"class.std::allocator.2"* dereferenceable(1) %0, %"struct.std::pair"* %1, %"struct.std::pair"* dereferenceable(16) %2) #0 comdat align 2 {
  %4 = bitcast %"class.std::allocator.2"* %0 to %"class.__gnu_cxx::new_allocator.3"*
  ...
  call void @_ZN9__gnu_cxx13new_allocatorISt4pairIddEE9constructIS2_JRKS2_EEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator.3"* %4, %"struct.std::pair"* %1, %"struct.std::pair"* dereferenceable(16) %5)
  ret void
}

; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt6vectorISt4pairIddESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_(%"class.std::vector.0"* %0, %"struct.std::pair"* %1, %"struct.std::pair"* dereferenceable(16) %2) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %4 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %5 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %6 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %4, i32 0, i32 0
  store %"struct.std::pair"* %1, %"struct.std::pair"** %6, align 8
  %7 = call i64 @_ZNKSt6vectorISt4pairIddESaIS1_EE12_M_check_lenEmPKc(%"class.std::vector.0"* %0, i64 1, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.1, i32 0, i32 0))
  %8 = bitcast %"class.std::vector.0"* %0 to %"struct.std::_Vector_base.1"*
  %9 = getelementptr inbounds %"struct.std::_Vector_base.1", %"struct.std::_Vector_base.1"* %8, i32 0, i32 0
  ...
  invoke void @_ZNSt16allocator_traitsISaISt4pairIddEEE9constructIS1_JRKS1_EEEvRS2_PT_DpOT0_(%"class.std::allocator.2"* dereferenceable(1) %23, %"struct.std::pair"* %24, %"struct.std::pair"* dereferenceable(16) %25)
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorISt4pairIddEE9constructIS2_JRKS2_EEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator.3"* %0, %"struct.std::pair"* %1, %"struct.std::pair"* dereferenceable(16) %2) #4 comdat align 2 {
  %4 = bitcast %"struct.std::pair"* %1 to i8*
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNKSt6vectorISt4pairIddESaIS1_EE14_M_range_checkEm(%"class.std::vector.0"* %0, i64 %1) #0 comdat align 2 {
  %3 = call i64 @_ZNKSt6vectorISt4pairIddESaIS1_EE4sizeEv(%"class.std::vector.0"* %0) #3
  %4 = icmp uge i64 %1, %3
  br i1 %4, label %5, label %7

5:                                                ; preds = %2
  %6 = call i64 @_ZNKSt6vectorISt4pairIddESaIS1_EE4sizeEv(%"class.std::vector.0"* %0) #3
  call void (i8*, ...) @_ZSt24__throw_out_of_range_fmtPKcz(i8* getelementptr inbounds ([74 x i8], [74 x i8]* @.str, i32 0, i32 0), i64 %1, i64 %6) #14
  unreachable
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s240329832.cpp() #0 section ".text.startup" {
