; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01233/s276160337.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01233/s276160337.cpp"
...
@.str.1 = private unnamed_addr constant [71 x i8] c"/home/pedro/tcc/exDataset/codenet/data/selection/p01233/s276160337.cpp\00", align 1
@__PRETTY_FUNCTION__._Z10crosspointRKSt6vectorISt7complexIdESaIS1_EES5_ = private unnamed_addr constant [95 x i8] c"complex<double> crosspoint(const vector<complex<double> > &, const vector<complex<double> > &)\00", align 1
@_ZSt3cin = external global %"class.std::basic_istream", align 8
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@.str.2 = private unnamed_addr constant [26 x i8] c"vector::_M_realloc_insert\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s276160337.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define { double, double } @_Z10crosspointRKSt6vectorISt7complexIdESaIS1_EES5_(%"class.std::vector"* dereferenceable(24) %0, %"class.std::vector"* dereferenceable(24) %1) #0 {
  %3 = alloca %"struct.std::complex", align 8
  %4 = alloca %"struct.std::complex", align 8
  ...
  %11 = call dereferenceable(16) %"struct.std::complex"* @_ZNKSt6vectorISt7complexIdESaIS1_EEixEm(%"class.std::vector"* %0, i64 1) #3
  %12 = call dereferenceable(16) %"struct.std::complex"* @_ZNKSt6vectorISt7complexIdESaIS1_EEixEm(%"class.std::vector"* %0, i64 0) #3
  ...
  %19 = call dereferenceable(16) %"struct.std::complex"* @_ZNKSt6vectorISt7complexIdESaIS1_EEixEm(%"class.std::vector"* %1, i64 1) #3
  %20 = call dereferenceable(16) %"struct.std::complex"* @_ZNKSt6vectorISt7complexIdESaIS1_EEixEm(%"class.std::vector"* %1, i64 0) #3
  %21 = call { double, double } @_ZStmiIdESt7complexIT_ERKS2_S4_(%"struct.std::complex"* dereferenceable(16) %19, %"struct.std::complex"* dereferenceable(16) %20)
  ...
  %27 = call double @_Z5crossRKSt7complexIdES2_(%"struct.std::complex"* dereferenceable(16) %4, %"struct.std::complex"* dereferenceable(16) %5)
  %28 = call dereferenceable(16) %"struct.std::complex"* @_ZNKSt6vectorISt7complexIdESaIS1_EEixEm(%"class.std::vector"* %0, i64 1) #3
  %29 = call dereferenceable(16) %"struct.std::complex"* @_ZNKSt6vectorISt7complexIdESaIS1_EEixEm(%"class.std::vector"* %0, i64 0) #3
  %30 = call { double, double } @_ZStmiIdESt7complexIT_ERKS2_S4_(%"struct.std::complex"* dereferenceable(16) %28, %"struct.std::complex"* dereferenceable(16) %29)
  ...
  %36 = call dereferenceable(16) %"struct.std::complex"* @_ZNKSt6vectorISt7complexIdESaIS1_EEixEm(%"class.std::vector"* %0, i64 1) #3
  %37 = call dereferenceable(16) %"struct.std::complex"* @_ZNKSt6vectorISt7complexIdESaIS1_EEixEm(%"class.std::vector"* %1, i64 0) #3
  ...
  %44 = call double @_Z5crossRKSt7complexIdES2_(%"struct.std::complex"* dereferenceable(16) %6, %"struct.std::complex"* dereferenceable(16) %7)
...
50:                                               ; preds = %47
  %51 = call dereferenceable(16) %"struct.std::complex"* @_ZNKSt6vectorISt7complexIdESaIS1_EEixEm(%"class.std::vector"* %1, i64 0) #3
  %52 = bitcast %"struct.std::complex"* %3 to i8*
  %53 = bitcast %"struct.std::complex"* %51 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %52, i8* align 8 %53, i64 16, i1 false)
  br label %81

54:                                               ; preds = %47, %2
  %55 = call double @_ZSt3absd(double %27)
  %56 = fcmp olt double %55, 1.000000e-09
  br i1 %56, label %57, label %58

57:                                               ; preds = %54
  call void @__assert_fail(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([71 x i8], [71 x i8]* @.str.1, i32 0, i32 0), i32 28, i8* getelementptr inbounds ([95 x i8], [95 x i8]* @__PRETTY_FUNCTION__._Z10crosspointRKSt6vectorISt7complexIdESaIS1_EES5_, i32 0, i32 0)) #15
  unreachable

58:                                               ; preds = %54
  %59 = call dereferenceable(16) %"struct.std::complex"* @_ZNKSt6vectorISt7complexIdESaIS1_EEixEm(%"class.std::vector"* %1, i64 0) #3
  %60 = fdiv double %44, %27
  store double %60, double* %9, align 8
  %61 = call dereferenceable(16) %"struct.std::complex"* @_ZNKSt6vectorISt7complexIdESaIS1_EEixEm(%"class.std::vector"* %1, i64 1) #3
  %62 = call dereferenceable(16) %"struct.std::complex"* @_ZNKSt6vectorISt7complexIdESaIS1_EEixEm(%"class.std::vector"* %1, i64 0) #3
  %63 = call { double, double } @_ZStmiIdESt7complexIT_ERKS2_S4_(%"struct.std::complex"* dereferenceable(16) %61, %"struct.std::complex"* dereferenceable(16) %62)
  %64 = getelementptr inbounds %"struct.std::complex", %"struct.std::complex"* %10, i32 0, i32 0
  ...
  %69 = call { double, double } @_ZStmlIdESt7complexIT_ERKS1_RKS2_(double* dereferenceable(8) %9, %"struct.std::complex"* dereferenceable(16) %10)
  %70 = getelementptr inbounds %"struct.std::complex", %"struct.std::complex"* %8, i32 0, i32 0
  ...
  %75 = call { double, double } @_ZStplIdESt7complexIT_ERKS2_S4_(%"struct.std::complex"* dereferenceable(16) %59, %"struct.std::complex"* dereferenceable(16) %8)
  %76 = getelementptr inbounds %"struct.std::complex", %"struct.std::complex"* %3, i32 0, i32 0
...
81:                                               ; preds = %58, %50
  %82 = getelementptr inbounds %"struct.std::complex", %"struct.std::complex"* %3, i32 0, i32 0
...
; Function Attrs: noinline nounwind uwtable
define zeroext i1 @_Z6onlineiiii(i32 %0, i32 %1, i32 %2, i32 %3) #4 {
  %5 = icmp eq i32 %0, %2
...
8:                                                ; preds = %6
  ...
  %11 = call i64 @labs(i64 %10) #16
  %12 = sub nsw i32 %1, %3
  %13 = sext i32 %12 to i64
  %14 = call i64 @labs(i64 %13) #16
  %15 = icmp eq i64 %11, %14
  br label %16

16:                                               ; preds = %8, %6, %4
  %17 = phi i1 [ true, %6 ], [ true, %4 ], [ %15, %8 ]
  ret i1 %17
}
...
define i32 @main() #7 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %2 = alloca %"struct.std::complex", align 8
  %3 = alloca [4 x %"class.std::vector"], align 16
  %4 = alloca [4 x %"class.std::vector"], align 16
  %5 = alloca %"struct.std::complex", align 8
  %6 = alloca %"struct.std::complex", align 8
  %7 = alloca %"struct.std::complex", align 8
  %8 = alloca %"struct.std::complex", align 8
...
23:                                               ; preds = %283, %0
  %.01 = phi i32 [ 0, %0 ], [ %284, %283 ]
  %24 = load i32, i32* @N, align 4
  %25 = icmp slt i32 %.01, %24
  br i1 %25, label %26, label %297

26:                                               ; preds = %23
  %27 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* @_ZSt3cin, i32* dereferenceable(4) @x1)
  %28 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* %27, i32* dereferenceable(4) @Y1)
  %29 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* %28, i32* dereferenceable(4) @x2)
  %30 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* %29, i32* dereferenceable(4) @y2)
  %31 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* %30, i32* dereferenceable(4) @X)
  %32 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* %31, i32* dereferenceable(4) @Y)
...
51:                                               ; preds = %44, %40
  ...
  %56 = call zeroext i1 @_Z6onlineiiii(i32 %52, i32 %53, i32 %54, i32 %55)
...
57:                                               ; preds = %51
  ...
  %62 = call zeroext i1 @_Z6onlineiiii(i32 %58, i32 %59, i32 %60, i32 %61)
...
66:                                               ; preds = %57, %51
  ...
  %71 = call zeroext i1 @_Z6onlineiiii(i32 %67, i32 %68, i32 %69, i32 %70)
...
72:                                               ; preds = %66
  ...
  %77 = call zeroext i1 @_Z6onlineiiii(i32 %73, i32 %74, i32 %75, i32 %76)
...
81:                                               ; preds = %72
  ...
  %86 = call zeroext i1 @_Z6onlineiiii(i32 %82, i32 %83, i32 %84, i32 %85)
...
90:                                               ; preds = %81
  ...
  call void @_ZNSt7complexIdEC2Edd(%"struct.std::complex"* %1, double %92, double %94)
  %95 = load i32, i32* @x2, align 4
  %96 = sitofp i32 %95 to double
  %97 = load i32, i32* @y2, align 4
  %98 = sitofp i32 %97 to double
  call void @_ZNSt7complexIdEC2Edd(%"struct.std::complex"* %2, double %96, double %98)
  %99 = getelementptr inbounds [4 x %"class.std::vector"], [4 x %"class.std::vector"]* %3, i32 0, i32 0
  %100 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %99, i64 4
  br label %101

101:                                              ; preds = %101, %90
  %102 = phi %"class.std::vector"* [ %99, %90 ], [ %103, %101 ]
  call void @_ZNSt6vectorISt7complexIdESaIS1_EEC2Ev(%"class.std::vector"* %102) #3
...
105:                                              ; preds = %101
  %106 = getelementptr inbounds [4 x %"class.std::vector"], [4 x %"class.std::vector"]* %4, i32 0, i32 0
  %107 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %106, i64 4
  br label %108

108:                                              ; preds = %108, %105
  %109 = phi %"class.std::vector"* [ %106, %105 ], [ %110, %108 ]
  call void @_ZNSt6vectorISt7complexIdESaIS1_EEC2Ev(%"class.std::vector"* %109) #3
  %110 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %109, i64 1
  %111 = icmp eq %"class.std::vector"* %110, %107
  br i1 %111, label %112, label %108

112:                                              ; preds = %108
  %113 = getelementptr inbounds [4 x %"class.std::vector"], [4 x %"class.std::vector"]* %3, i64 0, i64 0
  invoke void @_ZNSt6vectorISt7complexIdESaIS1_EE9push_backERKS1_(%"class.std::vector"* %113, %"struct.std::complex"* dereferenceable(16) %1)
          to label %114 unwind label %240

114:                                              ; preds = %112
  %115 = getelementptr inbounds [4 x %"class.std::vector"], [4 x %"class.std::vector"]* %3, i64 0, i64 0
  invoke void @_ZNSt7complexIdEC2Edd(%"struct.std::complex"* %6, double 1.000000e+00, double 0.000000e+00)
          to label %116 unwind label %240

116:                                              ; preds = %114
  %117 = invoke { double, double } @_ZStplIdESt7complexIT_ERKS2_S4_(%"struct.std::complex"* dereferenceable(16) %1, %"struct.std::complex"* dereferenceable(16) %6)
          to label %118 unwind label %240

118:                                              ; preds = %116
  %119 = getelementptr inbounds %"struct.std::complex", %"struct.std::complex"* %5, i32 0, i32 0
  ...
  invoke void @_ZNSt6vectorISt7complexIdESaIS1_EE9push_backEOS1_(%"class.std::vector"* %115, %"struct.std::complex"* dereferenceable(16) %5)
          to label %124 unwind label %240

124:                                              ; preds = %118
  %125 = getelementptr inbounds [4 x %"class.std::vector"], [4 x %"class.std::vector"]* %3, i64 0, i64 1
  invoke void @_ZNSt6vectorISt7complexIdESaIS1_EE9push_backERKS1_(%"class.std::vector"* %125, %"struct.std::complex"* dereferenceable(16) %1)
          to label %126 unwind label %240

126:                                              ; preds = %124
  %127 = getelementptr inbounds [4 x %"class.std::vector"], [4 x %"class.std::vector"]* %3, i64 0, i64 1
  invoke void @_ZNSt7complexIdEC2Edd(%"struct.std::complex"* %8, double 1.000000e+00, double 1.000000e+00)
          to label %128 unwind label %240

128:                                              ; preds = %126
  %129 = invoke { double, double } @_ZStplIdESt7complexIT_ERKS2_S4_(%"struct.std::complex"* dereferenceable(16) %1, %"struct.std::complex"* dereferenceable(16) %8)
          to label %130 unwind label %240

130:                                              ; preds = %128
  %131 = getelementptr inbounds %"struct.std::complex", %"struct.std::complex"* %7, i32 0, i32 0
  ...
  invoke void @_ZNSt6vectorISt7complexIdESaIS1_EE9push_backEOS1_(%"class.std::vector"* %127, %"struct.std::complex"* dereferenceable(16) %7)
          to label %136 unwind label %240

136:                                              ; preds = %130
  %137 = getelementptr inbounds [4 x %"class.std::vector"], [4 x %"class.std::vector"]* %3, i64 0, i64 2
  invoke void @_ZNSt6vectorISt7complexIdESaIS1_EE9push_backERKS1_(%"class.std::vector"* %137, %"struct.std::complex"* dereferenceable(16) %1)
          to label %138 unwind label %240

138:                                              ; preds = %136
  %139 = getelementptr inbounds [4 x %"class.std::vector"], [4 x %"class.std::vector"]* %3, i64 0, i64 2
  invoke void @_ZNSt7complexIdEC2Edd(%"struct.std::complex"* %10, double 0.000000e+00, double 1.000000e+00)
          to label %140 unwind label %240

140:                                              ; preds = %138
  %141 = invoke { double, double } @_ZStplIdESt7complexIT_ERKS2_S4_(%"struct.std::complex"* dereferenceable(16) %1, %"struct.std::complex"* dereferenceable(16) %10)
          to label %142 unwind label %240

142:                                              ; preds = %140
  %143 = getelementptr inbounds %"struct.std::complex", %"struct.std::complex"* %9, i32 0, i32 0
  %144 = getelementptr inbounds { double, double }, { double, double }* %143, i32 0, i32 0
  %145 = extractvalue { double, double } %141, 0
  store double %145, double* %144, align 8
  %146 = getelementptr inbounds { double, double }, { double, double }* %143, i32 0, i32 1
  %147 = extractvalue { double, double } %141, 1
  store double %147, double* %146, align 8
  invoke void @_ZNSt6vectorISt7complexIdESaIS1_EE9push_backEOS1_(%"class.std::vector"* %139, %"struct.std::complex"* dereferenceable(16) %9)
          to label %148 unwind label %240

148:                                              ; preds = %142
  %149 = getelementptr inbounds [4 x %"class.std::vector"], [4 x %"class.std::vector"]* %3, i64 0, i64 3
  invoke void @_ZNSt6vectorISt7complexIdESaIS1_EE9push_backERKS1_(%"class.std::vector"* %149, %"struct.std::complex"* dereferenceable(16) %1)
          to label %150 unwind label %240

150:                                              ; preds = %148
  %151 = getelementptr inbounds [4 x %"class.std::vector"], [4 x %"class.std::vector"]* %3, i64 0, i64 3
  invoke void @_ZNSt7complexIdEC2Edd(%"struct.std::complex"* %12, double -1.000000e+00, double 1.000000e+00)
          to label %152 unwind label %240

152:                                              ; preds = %150
  %153 = invoke { double, double } @_ZStplIdESt7complexIT_ERKS2_S4_(%"struct.std::complex"* dereferenceable(16) %1, %"struct.std::complex"* dereferenceable(16) %12)
          to label %154 unwind label %240

154:                                              ; preds = %152
  %155 = getelementptr inbounds %"struct.std::complex", %"struct.std::complex"* %11, i32 0, i32 0
  ...
  invoke void @_ZNSt6vectorISt7complexIdESaIS1_EE9push_backEOS1_(%"class.std::vector"* %151, %"struct.std::complex"* dereferenceable(16) %11)
          to label %160 unwind label %240

160:                                              ; preds = %154
  %161 = getelementptr inbounds [4 x %"class.std::vector"], [4 x %"class.std::vector"]* %4, i64 0, i64 0
  invoke void @_ZNSt6vectorISt7complexIdESaIS1_EE9push_backERKS1_(%"class.std::vector"* %161, %"struct.std::complex"* dereferenceable(16) %2)
          to label %162 unwind label %240

162:                                              ; preds = %160
  %163 = getelementptr inbounds [4 x %"class.std::vector"], [4 x %"class.std::vector"]* %4, i64 0, i64 0
  invoke void @_ZNSt7complexIdEC2Edd(%"struct.std::complex"* %14, double 1.000000e+00, double 0.000000e+00)
          to label %164 unwind label %240

164:                                              ; preds = %162
  %165 = invoke { double, double } @_ZStplIdESt7complexIT_ERKS2_S4_(%"struct.std::complex"* dereferenceable(16) %2, %"struct.std::complex"* dereferenceable(16) %14)
          to label %166 unwind label %240

166:                                              ; preds = %164
  %167 = getelementptr inbounds %"struct.std::complex", %"struct.std::complex"* %13, i32 0, i32 0
  ...
  invoke void @_ZNSt6vectorISt7complexIdESaIS1_EE9push_backEOS1_(%"class.std::vector"* %163, %"struct.std::complex"* dereferenceable(16) %13)
          to label %172 unwind label %240

172:                                              ; preds = %166
  %173 = getelementptr inbounds [4 x %"class.std::vector"], [4 x %"class.std::vector"]* %4, i64 0, i64 1
  invoke void @_ZNSt6vectorISt7complexIdESaIS1_EE9push_backERKS1_(%"class.std::vector"* %173, %"struct.std::complex"* dereferenceable(16) %2)
          to label %174 unwind label %240

174:                                              ; preds = %172
  %175 = getelementptr inbounds [4 x %"class.std::vector"], [4 x %"class.std::vector"]* %4, i64 0, i64 1
  invoke void @_ZNSt7complexIdEC2Edd(%"struct.std::complex"* %16, double 1.000000e+00, double 1.000000e+00)
          to label %176 unwind label %240

176:                                              ; preds = %174
  %177 = invoke { double, double } @_ZStplIdESt7complexIT_ERKS2_S4_(%"struct.std::complex"* dereferenceable(16) %2, %"struct.std::complex"* dereferenceable(16) %16)
          to label %178 unwind label %240

178:                                              ; preds = %176
  %179 = getelementptr inbounds %"struct.std::complex", %"struct.std::complex"* %15, i32 0, i32 0
  %180 = getelementptr inbounds { double, double }, { double, double }* %179, i32 0, i32 0
  %181 = extractvalue { double, double } %177, 0
  store double %181, double* %180, align 8
  %182 = getelementptr inbounds { double, double }, { double, double }* %179, i32 0, i32 1
  %183 = extractvalue { double, double } %177, 1
  store double %183, double* %182, align 8
  invoke void @_ZNSt6vectorISt7complexIdESaIS1_EE9push_backEOS1_(%"class.std::vector"* %175, %"struct.std::complex"* dereferenceable(16) %15)
          to label %184 unwind label %240

184:                                              ; preds = %178
  %185 = getelementptr inbounds [4 x %"class.std::vector"], [4 x %"class.std::vector"]* %4, i64 0, i64 2
  invoke void @_ZNSt6vectorISt7complexIdESaIS1_EE9push_backERKS1_(%"class.std::vector"* %185, %"struct.std::complex"* dereferenceable(16) %2)
          to label %186 unwind label %240

186:                                              ; preds = %184
  %187 = getelementptr inbounds [4 x %"class.std::vector"], [4 x %"class.std::vector"]* %4, i64 0, i64 2
  invoke void @_ZNSt7complexIdEC2Edd(%"struct.std::complex"* %18, double 0.000000e+00, double 1.000000e+00)
          to label %188 unwind label %240

188:                                              ; preds = %186
  %189 = invoke { double, double } @_ZStplIdESt7complexIT_ERKS2_S4_(%"struct.std::complex"* dereferenceable(16) %2, %"struct.std::complex"* dereferenceable(16) %18)
          to label %190 unwind label %240

190:                                              ; preds = %188
  %191 = getelementptr inbounds %"struct.std::complex", %"struct.std::complex"* %17, i32 0, i32 0
  ...
  invoke void @_ZNSt6vectorISt7complexIdESaIS1_EE9push_backEOS1_(%"class.std::vector"* %187, %"struct.std::complex"* dereferenceable(16) %17)
          to label %196 unwind label %240

196:                                              ; preds = %190
  %197 = getelementptr inbounds [4 x %"class.std::vector"], [4 x %"class.std::vector"]* %4, i64 0, i64 3
  invoke void @_ZNSt6vectorISt7complexIdESaIS1_EE9push_backERKS1_(%"class.std::vector"* %197, %"struct.std::complex"* dereferenceable(16) %2)
          to label %198 unwind label %240

198:                                              ; preds = %196
  %199 = getelementptr inbounds [4 x %"class.std::vector"], [4 x %"class.std::vector"]* %4, i64 0, i64 3
  invoke void @_ZNSt7complexIdEC2Edd(%"struct.std::complex"* %20, double -1.000000e+00, double 1.000000e+00)
          to label %200 unwind label %240

200:                                              ; preds = %198
  %201 = invoke { double, double } @_ZStplIdESt7complexIT_ERKS2_S4_(%"struct.std::complex"* dereferenceable(16) %2, %"struct.std::complex"* dereferenceable(16) %20)
          to label %202 unwind label %240

202:                                              ; preds = %200
  %203 = getelementptr inbounds %"struct.std::complex", %"struct.std::complex"* %19, i32 0, i32 0
  %204 = getelementptr inbounds { double, double }, { double, double }* %203, i32 0, i32 0
  %205 = extractvalue { double, double } %201, 0
  store double %205, double* %204, align 8
  %206 = getelementptr inbounds { double, double }, { double, double }* %203, i32 0, i32 1
  %207 = extractvalue { double, double } %201, 1
  store double %207, double* %206, align 8
  invoke void @_ZNSt6vectorISt7complexIdESaIS1_EE9push_backEOS1_(%"class.std::vector"* %199, %"struct.std::complex"* dereferenceable(16) %19)
...
209:                                              ; preds = %261, %208
  %.02 = phi i32 [ 0, %208 ], [ %262, %261 ]
  %210 = icmp slt i32 %.02, 4
...
212:                                              ; preds = %258, %211
  %.0 = phi i32 [ 0, %211 ], [ %259, %258 ]
  %213 = icmp slt i32 %.0, 4
  br i1 %213, label %214, label %260

214:                                              ; preds = %212
  %215 = icmp ne i32 %.02, %.0
  br i1 %215, label %216, label %257

216:                                              ; preds = %214
  %217 = sext i32 %.02 to i64
  %218 = getelementptr inbounds [4 x %"class.std::vector"], [4 x %"class.std::vector"]* %3, i64 0, i64 %217
  %219 = sext i32 %.0 to i64
  %220 = getelementptr inbounds [4 x %"class.std::vector"], [4 x %"class.std::vector"]* %4, i64 0, i64 %219
  %221 = invoke { double, double } @_Z10crosspointRKSt6vectorISt7complexIdESaIS1_EES5_(%"class.std::vector"* dereferenceable(24) %218, %"class.std::vector"* dereferenceable(24) %220)
          to label %222 unwind label %240

222:                                              ; preds = %216
  %223 = getelementptr inbounds %"struct.std::complex", %"struct.std::complex"* %21, i32 0, i32 0
  ...
  %228 = invoke double @_ZNKSt7complexIdE4realB5cxx11Ev(%"struct.std::complex"* %21)
          to label %229 unwind label %240

229:                                              ; preds = %222
  %230 = invoke double @_ZNKSt7complexIdE4imagB5cxx11Ev(%"struct.std::complex"* %21)
          to label %231 unwind label %240

231:                                              ; preds = %229
  %232 = fadd double %228, 1.000000e-09
  %233 = fptosi double %232 to i32
  %234 = fadd double %230, 1.000000e-09
  %235 = fptosi double %234 to i32
  %236 = sitofp i32 %233 to double
  %237 = fsub double %228, %236
  %238 = fcmp ogt double %237, 4.000000e-01
  br i1 %238, label %239, label %246

239:                                              ; preds = %231
  br label %258

240:                                              ; preds = %265, %263, %253, %251, %246, %229, %222, %216, %202, %200, %198, %196, %190, %188, %186, %184, %178, %176, %174, %172, %166, %164, %162, %160, %154, %152, %150, %148, %142, %140, %138, %136, %130, %128, %126, %124, %118, %116, %114, %112
  %241 = landingpad { i8*, i32 }
          cleanup
  %242 = extractvalue { i8*, i32 } %241, 0
  %243 = extractvalue { i8*, i32 } %241, 1
  %244 = getelementptr inbounds [4 x %"class.std::vector"], [4 x %"class.std::vector"]* %4, i32 0, i32 0
  %245 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %244, i64 4
  br label %285

246:                                              ; preds = %231
  %247 = load i32, i32* @X, align 4
  %248 = load i32, i32* @Y, align 4
  %249 = invoke zeroext i1 @_Z6onlineiiii(i32 %233, i32 %235, i32 %247, i32 %248)
...
251:                                              ; preds = %250
  %252 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 3)
...
261:                                              ; preds = %260
  %262 = add nsw i32 %.02, 1
  br label %209

263:                                              ; preds = %209
  %264 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 4)
...
268:                                              ; preds = %267, %255
  %269 = getelementptr inbounds [4 x %"class.std::vector"], [4 x %"class.std::vector"]* %4, i32 0, i32 0
  %270 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %269, i64 4
  br label %271

271:                                              ; preds = %271, %268
  %272 = phi %"class.std::vector"* [ %270, %268 ], [ %273, %271 ]
  %273 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %272, i64 -1
  call void @_ZNSt6vectorISt7complexIdESaIS1_EED2Ev(%"class.std::vector"* %273) #3
  %274 = icmp eq %"class.std::vector"* %273, %269
  br i1 %274, label %275, label %271

275:                                              ; preds = %271
  %276 = getelementptr inbounds [4 x %"class.std::vector"], [4 x %"class.std::vector"]* %3, i32 0, i32 0
  %277 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %276, i64 4
  br label %278

278:                                              ; preds = %278, %275
  %279 = phi %"class.std::vector"* [ %277, %275 ], [ %280, %278 ]
  %280 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %279, i64 -1
  call void @_ZNSt6vectorISt7complexIdESaIS1_EED2Ev(%"class.std::vector"* %280) #3
  %281 = icmp eq %"class.std::vector"* %280, %276
  br i1 %281, label %282, label %278

282:                                              ; preds = %278
  br label %283

283:                                              ; preds = %282, %87, %78, %63, %48
  %284 = add nsw i32 %.01, 1
  br label %23

285:                                              ; preds = %285, %240
  %286 = phi %"class.std::vector"* [ %245, %240 ], [ %287, %285 ]
  %287 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %286, i64 -1
  call void @_ZNSt6vectorISt7complexIdESaIS1_EED2Ev(%"class.std::vector"* %287) #3
  %288 = icmp eq %"class.std::vector"* %287, %244
  br i1 %288, label %289, label %285

289:                                              ; preds = %285
  %290 = getelementptr inbounds [4 x %"class.std::vector"], [4 x %"class.std::vector"]* %3, i32 0, i32 0
  %291 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %290, i64 4
  br label %292

292:                                              ; preds = %292, %289
  %293 = phi %"class.std::vector"* [ %291, %289 ], [ %294, %292 ]
  %294 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %293, i64 -1
  call void @_ZNSt6vectorISt7complexIdESaIS1_EED2Ev(%"class.std::vector"* %294) #3
...
298:                                              ; preds = %296
  %299 = insertvalue { i8*, i32 } undef, i8* %242, 0
  %300 = insertvalue { i8*, i32 } %299, i32 %243, 1
  resume { i8*, i32 } %300
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s276160337.cpp() #0 section ".text.startup" {
