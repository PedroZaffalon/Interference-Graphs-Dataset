; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03579/s092810869.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03579/s092810869.cpp"
...
@v = global [111111 x %"class.std::vector"] zeroinitializer, align 16
@vis = global [111111 x i32] zeroinitializer, align 16
@col = global [111111 x i32] zeroinitializer, align 16
@n = global i32 0, align 4
@m = global i32 0, align 4
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@.str = private unnamed_addr constant [5 x i8] c"%d%d\00", align 1
@.str.2 = private unnamed_addr constant [26 x i8] c"vector::_M_realloc_insert\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s092810869.cpp, i8* null }]
...
1:                                                ; preds = %1, %0
  %2 = phi %"class.std::vector"* [ getelementptr inbounds ([111111 x %"class.std::vector"], [111111 x %"class.std::vector"]* @v, i32 0, i32 0), %0 ], [ %3, %1 ]
  call void @_ZNSt6vectorIiSaIiEEC2Ev(%"class.std::vector"* %2) #3
  %3 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %2, i64 1
  %4 = icmp eq %"class.std::vector"* %3, getelementptr inbounds ([111111 x %"class.std::vector"], [111111 x %"class.std::vector"]* @v, i64 1, i64 0)
...
2:                                                ; preds = %2, %1
  %3 = phi %"class.std::vector"* [ getelementptr inbounds ([111111 x %"class.std::vector"], [111111 x %"class.std::vector"]* @v, i64 1, i64 0), %1 ], [ %4, %2 ]
  %4 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %3, i64 -1
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %4) #3
  %5 = icmp eq %"class.std::vector"* %4, getelementptr inbounds ([111111 x %"class.std::vector"], [111111 x %"class.std::vector"]* @v, i32 0, i32 0)
...
define void @_Z3dfsi(i32 %0) #0 {
  %2 = sext i32 %0 to i64
  %3 = getelementptr inbounds [111111 x i32], [111111 x i32]* @vis, i64 0, i64 %2
  store i32 1, i32* %3, align 4
  %4 = sext i32 %0 to i64
  %5 = getelementptr inbounds [111111 x %"class.std::vector"], [111111 x %"class.std::vector"]* @v, i64 0, i64 %4
...
10:                                               ; preds = %8
  ...
  %12 = getelementptr inbounds [111111 x %"class.std::vector"], [111111 x %"class.std::vector"]* @v, i64 0, i64 %11
  %13 = sext i32 %.0 to i64
  %14 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %12, i64 %13) #3
  %15 = load i32, i32* %14, align 4
  %16 = sext i32 %15 to i64
  %17 = getelementptr inbounds [111111 x i32], [111111 x i32]* @col, i64 0, i64 %16
  %18 = load i32, i32* %17, align 4
  %19 = sext i32 %0 to i64
  %20 = getelementptr inbounds [111111 x i32], [111111 x i32]* @col, i64 0, i64 %19
...
36:                                               ; preds = %10
  ...
  %38 = getelementptr inbounds [111111 x i32], [111111 x i32]* @vis, i64 0, i64 %37
...
41:                                               ; preds = %36
  ...
  %43 = getelementptr inbounds [111111 x i32], [111111 x i32]* @col, i64 0, i64 %42
  %44 = load i32, i32* %43, align 4
  %45 = xor i32 %44, 1
  %46 = sext i32 %15 to i64
  %47 = getelementptr inbounds [111111 x i32], [111111 x i32]* @col, i64 0, i64 %46
...
7:                                                ; preds = %4
  %8 = sext i32 %.0 to i64
  %9 = getelementptr inbounds [111111 x i32], [111111 x i32]* @col, i64 0, i64 %8
...
13:                                               ; preds = %24, %12
  %.1 = phi i32 [ 1, %12 ], [ %25, %24 ]
  %14 = load i32, i32* @m, align 4
  %15 = icmp sle i32 %.1, %14
  br i1 %15, label %16, label %26

16:                                               ; preds = %13
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0), i32* %1, i32* %2)
  %18 = load i32, i32* %1, align 4
  %19 = sext i32 %18 to i64
  %20 = getelementptr inbounds [111111 x %"class.std::vector"], [111111 x %"class.std::vector"]* @v, i64 0, i64 %19
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %20, i32* dereferenceable(4) %2)
  %21 = load i32, i32* %2, align 4
  %22 = sext i32 %21 to i64
  %23 = getelementptr inbounds [111111 x %"class.std::vector"], [111111 x %"class.std::vector"]* @v, i64 0, i64 %22
...
26:                                               ; preds = %13
  store i32 1, i32* getelementptr inbounds ([111111 x i32], [111111 x i32]* @col, i64 0, i64 1), align 4
...
30:                                               ; preds = %27
  ...
  %32 = getelementptr inbounds [111111 x i32], [111111 x i32]* @col, i64 0, i64 %31
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s092810869.cpp() #0 section ".text.startup" {
