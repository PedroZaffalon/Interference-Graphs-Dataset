; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03944/s957116869.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03944/s957116869.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s957116869.cpp, i8* null }]
...
37:                                               ; preds = %31
  ...
  %39 = call zeroext i1 @_Z5chmaxIiEbRT_S0_(i32* dereferenceable(4) %7, i32 %38)
  br label %40
...
43:                                               ; preds = %40
  ...
  %45 = call zeroext i1 @_Z5chminIiEbRT_S0_(i32* dereferenceable(4) %8, i32 %44)
  br label %46
...
49:                                               ; preds = %46
  ...
  %51 = call zeroext i1 @_Z5chmaxIiEbRT_S0_(i32* dereferenceable(4) %10, i32 %50)
  br label %52
...
55:                                               ; preds = %52
  ...
  %57 = call zeroext i1 @_Z5chminIiEbRT_S0_(i32* dereferenceable(4) %9, i32 %56)
  br label %58
...
61:                                               ; preds = %28
  ...
  %65 = call dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* dereferenceable(4) %11, i32* dereferenceable(4) %12)
  ...
  %70 = call dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* dereferenceable(4) %13, i32* dereferenceable(4) %14)
...
define linkonce_odr zeroext i1 @_Z5chmaxIiEbRT_S0_(i32* dereferenceable(4) %0, i32 %1) #5 comdat {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s957116869.cpp() #0 section ".text.startup" {
