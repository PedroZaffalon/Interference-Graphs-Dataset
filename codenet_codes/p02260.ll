; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02260/s720086207.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02260/s720086207.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s720086207.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define void @_Z5traceRKSt6vectorIiSaIiEE(%"class.std::vector"* dereferenceable(24) %0) #0 {
  br label %2
...
10:                                               ; preds = %8, %6
  ...
  %12 = call dereferenceable(4) i32* @_ZNKSt6vectorIiSaIiEEixEm(%"class.std::vector"* %0, i64 %11) #3
...
; Function Attrs: noinline nounwind uwtable
define i32 @_Z13selectionSortRSt6vectorIiSaIiEE(%"class.std::vector"* dereferenceable(24) %0) #4 {
  br label %2
...
8:                                                ; preds = %30, %7
  %.02 = phi i32 [ %.04, %7 ], [ %.13, %30 ]
  %.1 = phi i32 [ %.01, %7 ], [ %.2, %30 ]
  %.0 = phi i32 [ %.04, %7 ], [ %31, %30 ]
  %9 = sext i32 %.0 to i64
...
21:                                               ; preds = %20, %12
  ...
  call void @_ZSt4swapIiENSt9enable_ifIXsr6__and_ISt6__not_ISt15__is_tuple_likeIT_EESt21is_move_constructibleIS3_ESt18is_move_assignableIS3_EEE5valueEvE4typeERS3_SC_(i32* dereferenceable(4) %23, i32* dereferenceable(4) %25) #3
  %26 = icmp ne i32 %.04, %.13
...
define i32 @main() #5 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  invoke void @_ZNSt6vectorIiSaIiEE7reserveEm(%"class.std::vector"* %1, i64 100)
...
13:                                               ; preds = %11
  invoke void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %1, i32* dereferenceable(4) %3)
          to label %14 unwind label %15

14:                                               ; preds = %13
  br label %7

15:                                               ; preds = %24, %22, %21, %19, %13, %11, %4, %0
...
19:                                               ; preds = %7
  %20 = invoke i32 @_Z13selectionSortRSt6vectorIiSaIiEE(%"class.std::vector"* dereferenceable(24) %1)
          to label %21 unwind label %15

21:                                               ; preds = %19
  invoke void @_Z5traceRKSt6vectorIiSaIiEE(%"class.std::vector"* dereferenceable(24) %1)
          to label %22 unwind label %15

22:                                               ; preds = %21
  %23 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %20)
...
27:                                               ; preds = %15
  %28 = insertvalue { i8*, i32 } undef, i8* %17, 0
  %29 = insertvalue { i8*, i32 } %28, i32 %18, 1
  resume { i8*, i32 } %29
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s720086207.cpp() #0 section ".text.startup" {
