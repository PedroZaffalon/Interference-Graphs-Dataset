; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00136/s230056019.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00136/s230056019.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s230056019.cpp, i8* null }]
...
define i32 @main() #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  invoke void @_ZNSt6vectorIiSaIiEEC2EmRKiRKS0_(%"class.std::vector"* %3, i64 6, i32* dereferenceable(4) %4, %"class.std::allocator"* dereferenceable(1) %5)
...
7:                                                ; preds = %0
  ...
  store double 1.650000e+02, double* %10, align 8
  %11 = getelementptr [5 x double], [5 x double]* %9, i32 0, i32 1
  store double 1.700000e+02, double* %11, align 8
  %12 = getelementptr [5 x double], [5 x double]* %9, i32 0, i32 2
  store double 1.750000e+02, double* %12, align 8
  %13 = getelementptr [5 x double], [5 x double]* %9, i32 0, i32 3
  store double 1.800000e+02, double* %13, align 8
  %14 = getelementptr [5 x double], [5 x double]* %9, i32 0, i32 4
  store double 1.850000e+02, double* %14, align 8
...
20:                                               ; preds = %17
  %21 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERd(%"class.std::basic_istream"* @_ZSt3cin, double* dereferenceable(8) %2)
...
23:                                               ; preds = %51, %22
  %.04 = phi i32 [ 0, %22 ], [ %52, %51 ]
  %24 = icmp slt i32 %.04, 5
  br i1 %24, label %25, label %53

25:                                               ; preds = %23
  %26 = load double, double* %2, align 8
  %27 = sext i32 %.04 to i64
  %28 = getelementptr inbounds [5 x double], [5 x double]* %6, i64 0, i64 %27
...
46:                                               ; preds = %44
  %47 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %3, i64 5) #3
...
57:                                               ; preds = %78, %56
  %.05 = phi i32 [ 1, %56 ], [ %79, %78 ]
  %58 = icmp slt i32 %.05, 7
  br i1 %58, label %59, label %80

59:                                               ; preds = %57
  %60 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %.05)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s230056019.cpp() #0 section ".text.startup" {
