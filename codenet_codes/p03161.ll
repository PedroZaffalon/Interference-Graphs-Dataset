; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03161/s917640694.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03161/s917640694.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s917640694.cpp, i8* null }]
...
13:                                               ; preds = %10
  %14 = getelementptr inbounds i64, i64* %9, i64 %.01
...
23:                                               ; preds = %54, %18
  %.02 = phi i64 [ 2, %18 ], [ %55, %54 ]
  %24 = load i64, i64* %1, align 8
  %25 = icmp sle i64 %.02, %24
  br i1 %25, label %26, label %56

26:                                               ; preds = %23
  %27 = getelementptr inbounds i64, i64* %21, i64 %.02
  store i64 100000000000000000, i64* %27, align 8
  %28 = sub nsw i64 %.02, 1
  br label %29

29:                                               ; preds = %51, %26
  %.0 = phi i64 [ %28, %26 ], [ %52, %51 ]
  %30 = icmp sge i64 %.0, 1
...
37:                                               ; preds = %35
  %38 = getelementptr inbounds i64, i64* %9, i64 %.02
  %39 = load i64, i64* %38, align 8
  %40 = getelementptr inbounds i64, i64* %9, i64 %.0
  %41 = load i64, i64* %40, align 8
  %42 = sub nsw i64 %39, %41
  %43 = call i64 @_ZSt3absx(i64 %42)
  %44 = getelementptr inbounds i64, i64* %21, i64 %.0
  %45 = load i64, i64* %44, align 8
  %46 = add nsw i64 %43, %45
  store i64 %46, i64* %3, align 8
  %47 = getelementptr inbounds i64, i64* %21, i64 %.02
  %48 = call dereferenceable(8) i64* @_ZSt3minIxERKT_S2_S2_(i64* dereferenceable(8) %3, i64* dereferenceable(8) %47)
  %49 = load i64, i64* %48, align 8
  %50 = getelementptr inbounds i64, i64* %21, i64 %.02
...
define i32 @main() #6 {
  ...
  %10 = call %struct._IO_FILE* @freopen(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0), %struct._IO_FILE* %9)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s917640694.cpp() #0 section ".text.startup" {
