; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00168/s899773291.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00168/s899773291.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s899773291.cpp, i8* null }]
...
36:                                               ; preds = %56, %35
  %.03 = phi i32 [ 1, %35 ], [ %57, %56 ]
  %37 = icmp sle i32 %.03, 3
...
61:                                               ; preds = %32
  ...
  %66 = add nsw i64 %65, 3649
  %67 = sdiv i64 %66, 3650
  store i64 %67, i64* %6, align 8
  invoke void @_ZNSt6vectorIxSaIxEE9push_backERKx(%"class.std::vector"* %1, i64* dereferenceable(8) %6)
...
74:                                               ; preds = %86, %73
  %.04 = phi i32 [ 0, %73 ], [ %87, %86 ]
  %75 = call i64 @_ZNKSt6vectorIxSaIxEE4sizeEv(%"class.std::vector"* %1) #3
...
89:                                               ; preds = %69, %51, %22
  %.01 = phi i32 [ %25, %22 ], [ %72, %69 ], [ %54, %51 ]
  %.0 = phi i8* [ %24, %22 ], [ %71, %69 ], [ %53, %51 ]
  call void @_ZNSt6vectorIxSaIxEED2Ev(%"class.std::vector"* %1) #3
  br label %90

90:                                               ; preds = %89
  %91 = insertvalue { i8*, i32 } undef, i8* %.0, 0
  %92 = insertvalue { i8*, i32 } %91, i32 %.01, 1
  resume { i8*, i32 } %92
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s899773291.cpp() #0 section ".text.startup" {
