; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03508/s054995976.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03508/s054995976.cpp"
...
%class.UF = type { i32, %"class.std::vector", %"class.std::vector", %"class.std::vector" }
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s054995976.cpp, i8* null }]
...
define i32 @main() #5 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  call void @_ZN2UFC2Ei(%class.UF* %3, i32 %18)
  br label %19
...
26:                                               ; preds = %24
  ...
  invoke void @_ZN2UF5uniteEii(%class.UF* %3, i32 %31, i32 %32)
...
36:                                               ; preds = %70, %64, %61, %56, %53, %48, %45, %42, %40, %26, %24, %22
  %37 = landingpad { i8*, i32 }
          cleanup
  %38 = extractvalue { i8*, i32 } %37, 0
  %39 = extractvalue { i8*, i32 } %37, 1
  call void @_ZN2UFD2Ev(%class.UF* %3) #3
  br label %73

40:                                               ; preds = %19
  %41 = invoke i32 @_ZN2UF5queryEi(%class.UF* %3, i32 1)
          to label %42 unwind label %36

42:                                               ; preds = %40
  %43 = sext i32 %41 to i64
  %44 = invoke i32 @_ZN2UF5queryEi(%class.UF* %3, i32 0)
          to label %45 unwind label %36

45:                                               ; preds = %42
  %46 = sext i32 %44 to i64
  %47 = invoke i64 @_Z4combx(i64 %43)
...
48:                                               ; preds = %45
  ...
  %52 = invoke i64 @_Z4combx(i64 %51)
          to label %53 unwind label %36

53:                                               ; preds = %48
  %54 = add nsw i64 %47, %52
  store i64 %54, i64* %6, align 8
  %55 = invoke i64 @_Z4combx(i64 %46)
...
56:                                               ; preds = %53
  ...
  %60 = invoke i64 @_Z4combx(i64 %59)
          to label %61 unwind label %36

61:                                               ; preds = %56
  %62 = add nsw i64 %55, %60
  store i64 %62, i64* %7, align 8
  %63 = invoke dereferenceable(8) i64* @_ZSt3maxIxERKT_S2_S2_(i64* dereferenceable(8) %6, i64* dereferenceable(8) %7)
...
73:                                               ; preds = %36
  %74 = insertvalue { i8*, i32 } undef, i8* %38, 0
  %75 = insertvalue { i8*, i32 } %74, i32 %39, 1
  resume { i8*, i32 } %75
}
...
define linkonce_odr void @_ZN2UFC2Ei(%class.UF* %0, i32 %1) unnamed_addr #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %4 = getelementptr inbounds %class.UF, %class.UF* %0, i32 0, i32 2
  call void @_ZNSt6vectorIiSaIiEEC2Ev(%"class.std::vector"* %4) #3
  %5 = getelementptr inbounds %class.UF, %class.UF* %0, i32 0, i32 3
  ...
  %8 = getelementptr inbounds %class.UF, %class.UF* %0, i32 0, i32 0
  %9 = load i32, i32* %8, align 8
  %10 = sext i32 %9 to i64
  invoke void @_ZNSt6vectorIiSaIiEE6resizeEm(%"class.std::vector"* %7, i64 %10)
          to label %11 unwind label %38

11:                                               ; preds = %2
  %12 = getelementptr inbounds %class.UF, %class.UF* %0, i32 0, i32 2
  %13 = getelementptr inbounds %class.UF, %class.UF* %0, i32 0, i32 0
  %14 = load i32, i32* %13, align 8
  %15 = sext i32 %14 to i64
  invoke void @_ZNSt6vectorIiSaIiEE6resizeEm(%"class.std::vector"* %12, i64 %15)
          to label %16 unwind label %38

16:                                               ; preds = %11
  %17 = getelementptr inbounds %class.UF, %class.UF* %0, i32 0, i32 3
  %18 = getelementptr inbounds %class.UF, %class.UF* %0, i32 0, i32 0
  %19 = load i32, i32* %18, align 8
  %20 = sext i32 %19 to i64
  invoke void @_ZNSt6vectorIiSaIiEE6resizeEm(%"class.std::vector"* %17, i64 %20)
...
22:                                               ; preds = %36, %21
  ...
  %23 = getelementptr inbounds %class.UF, %class.UF* %0, i32 0, i32 0
  %24 = load i32, i32* %23, align 8
  %25 = icmp slt i32 %.0, %24
  br i1 %25, label %26, label %42

26:                                               ; preds = %22
  %27 = getelementptr inbounds %class.UF, %class.UF* %0, i32 0, i32 1
  ...
  %33 = getelementptr inbounds %class.UF, %class.UF* %0, i32 0, i32 3
...
define linkonce_odr void @_ZN2UF5uniteEii(%class.UF* %0, i32 %1, i32 %2) #0 comdat align 2 {
  ...
  %7 = call i32 @_ZN2UF4findEi(%class.UF* %0, i32 %6)
  store i32 %7, i32* %4, align 4
  %8 = load i32, i32* %5, align 4
  %9 = call i32 @_ZN2UF4findEi(%class.UF* %0, i32 %8)
...
14:                                               ; preds = %3
  %15 = getelementptr inbounds %class.UF, %class.UF* %0, i32 0, i32 2
  %16 = load i32, i32* %4, align 4
  %17 = sext i32 %16 to i64
  %18 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %15, i64 %17) #3
  %19 = load i32, i32* %18, align 4
  %20 = getelementptr inbounds %class.UF, %class.UF* %0, i32 0, i32 2
...
27:                                               ; preds = %26, %14
  ...
  %29 = getelementptr inbounds %class.UF, %class.UF* %0, i32 0, i32 1
  ...
  %38 = getelementptr inbounds %class.UF, %class.UF* %0, i32 0, i32 3
  ...
  %44 = getelementptr inbounds %class.UF, %class.UF* %0, i32 0, i32 2
  %45 = load i32, i32* %4, align 4
  %46 = sext i32 %45 to i64
  %47 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %44, i64 %46) #3
  %48 = load i32, i32* %47, align 4
  %49 = getelementptr inbounds %class.UF, %class.UF* %0, i32 0, i32 2
...
55:                                               ; preds = %27
  %56 = getelementptr inbounds %class.UF, %class.UF* %0, i32 0, i32 2
...
; Function Attrs: noinline uwtable
define linkonce_odr i32 @_ZN2UF5queryEi(%class.UF* %0, i32 %1) #0 comdat align 2 {
  %3 = call i32 @_ZN2UF4findEi(%class.UF* %0, i32 %1)
  %4 = getelementptr inbounds %class.UF, %class.UF* %0, i32 0, i32 3
  %5 = sext i32 %3 to i64
  %6 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %4, i64 %5) #3
...
define linkonce_odr void @_ZN2UFD2Ev(%class.UF* %0) unnamed_addr #4 comdat align 2 {
  %2 = getelementptr inbounds %class.UF, %class.UF* %0, i32 0, i32 3
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %2) #3
  %3 = getelementptr inbounds %class.UF, %class.UF* %0, i32 0, i32 2
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %3) #3
  %4 = getelementptr inbounds %class.UF, %class.UF* %0, i32 0, i32 1
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %4) #3
  ret void
}
...
9:                                                ; preds = %2
  ...
  %14 = call i32 @_ZN2UF4findEi(%class.UF* %0, i32 %13)
  %15 = getelementptr inbounds %class.UF, %class.UF* %0, i32 0, i32 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s054995976.cpp() #0 section ".text.startup" {
