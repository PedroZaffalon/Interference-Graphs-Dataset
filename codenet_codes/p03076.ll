; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03076/s247615487.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03076/s247615487.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s247615487.cpp, i8* null }]
...
24:                                               ; preds = %22
  ...
  %31 = invoke i64 @_ZSt9make_pairIiRiESt4pairINSt17__decay_and_stripIT_E6__typeENS2_IT0_E6__typeEEOS3_OS6_(i32* dereferenceable(4) %4, i32* dereferenceable(4) %30)
          to label %32 unwind label %44

32:                                               ; preds = %24
  %33 = bitcast %"struct.std::pair"* %3 to i64*
  store i64 %31, i64* %33, align 4
  invoke void @_ZNSt6vectorISt4pairIiiESaIS1_EE9push_backEOS1_(%"class.std::vector"* %2, %"struct.std::pair"* dereferenceable(8) %3)
...
44:                                               ; preds = %83, %77, %51, %32, %24, %18, %15, %12, %9, %0
...
51:                                               ; preds = %22
  %52 = call %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EE5beginEv(%"class.std::vector"* %2) #3
  %53 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %5, i32 0, i32 0
  store %"struct.std::pair"* %52, %"struct.std::pair"** %53, align 8
  %54 = call %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EE3endEv(%"class.std::vector"* %2) #3
...
61:                                               ; preds = %75, %60
  %.01 = phi i32 [ 0, %60 ], [ %74, %75 ]
  %.0 = phi i32 [ 4, %60 ], [ %76, %75 ]
  %62 = icmp sgt i32 %.0, 0
  br i1 %62, label %63, label %77

63:                                               ; preds = %61
  %64 = sext i32 %.0 to i64
  %65 = call dereferenceable(8) %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EEixEm(%"class.std::vector"* %2, i64 %64) #3
...
77:                                               ; preds = %61
  %78 = call dereferenceable(8) %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EEixEm(%"class.std::vector"* %2, i64 0) #3
  %79 = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* %78, i32 0, i32 1
  %80 = load i32, i32* %79, align 4
  %81 = add nsw i32 %.01, %80
...
86:                                               ; preds = %44
  %87 = insertvalue { i8*, i32 } undef, i8* %46, 0
  %88 = insertvalue { i8*, i32 } %87, i32 %47, 1
  resume { i8*, i32 } %88
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s247615487.cpp() #0 section ".text.startup" {
