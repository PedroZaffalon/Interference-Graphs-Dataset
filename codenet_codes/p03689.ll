; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03689/s330442902.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03689/s330442902.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s330442902.cpp, i8* null }]
...
55:                                               ; preds = %54, %49
  ...
  %63 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i32 0, i32 0), i32 %.01, i32 %62)
  br label %64
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s330442902.cpp() #0 section ".text.startup" {
