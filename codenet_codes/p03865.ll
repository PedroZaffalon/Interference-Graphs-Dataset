; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03865/s587925596.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03865/s587925596.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s587925596.cpp, i8* null }]
...
13:                                               ; preds = %11
  ...
  %16 = call dereferenceable(1) i8* @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE4backEv(%"class.std::__cxx11::basic_string"* %1) #3
...
24:                                               ; preds = %20
  %25 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i32 0, i32 0))
...
29:                                               ; preds = %50, %48, %45, %43, %35, %33, %26, %24, %11, %0
...
43:                                               ; preds = %39
  %44 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i32 0, i32 0))
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s587925596.cpp() #0 section ".text.startup" {
