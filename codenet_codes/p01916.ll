; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01916/s053863818.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01916/s053863818.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s053863818.cpp, i8* null }]
...
13:                                               ; preds = %10
  ...
  %16 = getelementptr inbounds [256 x i32], [256 x i32]* %1, i64 0, i64 %15
...
26:                                               ; preds = %34, %25
  ...
  %.0 = phi i32 [ 0, %25 ], [ %33, %34 ]
  %27 = icmp slt i32 %.01, 256
  br i1 %27, label %28, label %36

28:                                               ; preds = %26
  %29 = sext i32 %.01 to i64
  %30 = getelementptr inbounds [256 x i32], [256 x i32]* %1, i64 0, i64 %29
...
42:                                               ; preds = %21
  %43 = insertvalue { i8*, i32 } undef, i8* %23, 0
  %44 = insertvalue { i8*, i32 } %43, i32 %24, 1
  resume { i8*, i32 } %44
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s053863818.cpp() #0 section ".text.startup" {
