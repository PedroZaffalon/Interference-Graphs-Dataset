; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03156/s921858397.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03156/s921858397.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s921858397.cpp, i8* null }]
...
45:                                               ; preds = %11
  %46 = call dereferenceable(4) i32* @_ZSt3minIiERKT_S2_S2_(i32* dereferenceable(4) %7, i32* dereferenceable(4) %6)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s921858397.cpp() #0 section ".text.startup" {
