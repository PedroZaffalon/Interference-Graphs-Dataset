; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03022/s720629669.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03022/s720629669.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s720629669.cpp, i8* null }]
...
43:                                               ; preds = %188, %183, %178, %171, %169, %114, %54, %47, %28
...
54:                                               ; preds = %50
  ...
  %58 = invoke i32 @_Z3mulii(i32 %57, i32 %48)
...
114:                                              ; preds = %110
  ...
  %119 = invoke i32 @_Z3invi(i32 %118)
...
126:                                              ; preds = %167, %125
  %.011 = phi i32 [ 1, %125 ], [ %168, %167 ]
  %127 = load i32, i32* %1, align 4
  %128 = shl i32 1, %127
  %129 = icmp slt i32 %.011, %128
...
131:                                              ; preds = %163, %130
  %.012 = phi i32 [ 0, %130 ], [ %165, %163 ]
  %132 = load i32, i32* %1, align 4
  %133 = shl i32 1, %132
  %134 = icmp slt i32 %.012, %133
...
178:                                              ; preds = %174
  ...
  %181 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %2, i64 0) #3
  %182 = load i32, i32* %181, align 4
  invoke void @_Z3subRii(i32* dereferenceable(4) %180, i32 %182)
...
194:                                              ; preds = %43, %39
  ...
  %195 = insertvalue { i8*, i32 } undef, i8* %.0, 0
  %196 = insertvalue { i8*, i32 } %195, i32 %.01, 1
  resume { i8*, i32 } %196
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i32 @_Z3invi(i32 %0) #5 comdat {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i32 @_Z3mulii(i32 %0, i32 %1) #5 comdat {
  %3 = sext i32 %0 to i64
  %4 = sext i32 %1 to i64
  %5 = mul nsw i64 %3, %4
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_Z3subRii(i32* dereferenceable(4) %0, i32 %1) #5 comdat {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s720629669.cpp() #0 section ".text.startup" {
