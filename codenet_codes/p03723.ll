; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03723/s676921848.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03723/s676921848.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s676921848.cpp, i8* null }]
...
18:                                               ; preds = %16, %0
  %19 = add nsw i64 %10, %14
  br label %20

20:                                               ; preds = %18, %16
  %.02 = phi i64 [ %19, %18 ], [ %14, %16 ]
  %.01 = phi i64 [ %19, %18 ], [ %10, %16 ]
  %21 = icmp eq i64 %.01, 0
...
26:                                               ; preds = %22, %20
  %27 = call i64 @_Z3gcdxx(i64 %.01, i64 %.02)
  br label %28

28:                                               ; preds = %35, %26
  %.03 = phi i64 [ %27, %26 ], [ %32, %35 ]
  %.0 = phi i64 [ 0, %26 ], [ %33, %35 ]
  %29 = srem i64 %.03, 2
  %30 = icmp eq i64 %29, 0
...
36:                                               ; preds = %34
  %37 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEx(%"class.std::basic_ostream"* @_ZSt4cout, i64 %.0)
  br label %38
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s676921848.cpp() #0 section ".text.startup" {
