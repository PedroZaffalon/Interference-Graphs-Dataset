; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02238/s792952468.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02238/s792952468.cpp"
...
@step = global i32 1, align 4
@in = global [105 x i32] zeroinitializer, align 16
@out = global [105 x i32] zeroinitializer, align 16
@book = global [105 x i8] zeroinitializer, align 16
@_ZSt3cin = external global %"class.std::basic_istream", align 8
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@.str = private unnamed_addr constant [2 x i8] c" \00", align 1
@.str.2 = private unnamed_addr constant [26 x i8] c"vector::_M_realloc_insert\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s792952468.cpp, i8* null }]
...
1:                                                ; preds = %1, %0
  ...
  %4 = icmp eq %"class.std::vector"* %3, getelementptr inbounds ([105 x %"class.std::vector"], [105 x %"class.std::vector"]* @v, i64 1, i64 0)
...
2:                                                ; preds = %2, %1
  ...
  %5 = icmp eq %"class.std::vector"* %4, getelementptr inbounds ([105 x %"class.std::vector"], [105 x %"class.std::vector"]* @v, i32 0, i32 0)
...
define void @_Z3dfsi(i32 %0) #0 {
  %2 = sext i32 %0 to i64
  %3 = getelementptr inbounds [105 x i8], [105 x i8]* @book, i64 0, i64 %2
...
7:                                                ; preds = %1
  %8 = sext i32 %0 to i64
  %9 = getelementptr inbounds [105 x i8], [105 x i8]* @book, i64 0, i64 %8
  store i8 1, i8* %9, align 1
  %10 = load i32, i32* @step, align 4
  %11 = add nsw i32 %10, 1
  store i32 %11, i32* @step, align 4
...
14:                                               ; preds = %26, %7
  ...
  %17 = getelementptr inbounds [105 x %"class.std::vector"], [105 x %"class.std::vector"]* @v, i64 0, i64 %16
...
20:                                               ; preds = %14
  ...
  %22 = getelementptr inbounds [105 x %"class.std::vector"], [105 x %"class.std::vector"]* @v, i64 0, i64 %21
...
28:                                               ; preds = %14
  ...
  %30 = add nsw i32 %29, 1
  store i32 %30, i32* @step, align 4
  %31 = sext i32 %0 to i64
  %32 = getelementptr inbounds [105 x i32], [105 x i32]* @out, i64 0, i64 %31
...
17:                                               ; preds = %14
  ...
  %21 = getelementptr inbounds [105 x %"class.std::vector"], [105 x %"class.std::vector"]* @v, i64 0, i64 %20
...
24:                                               ; preds = %14
  ...
  %27 = getelementptr inbounds [105 x %"class.std::vector"], [105 x %"class.std::vector"]* @v, i64 0, i64 %26
  ...
  %32 = getelementptr inbounds [105 x %"class.std::vector"], [105 x %"class.std::vector"]* @v, i64 0, i64 %31
...
45:                                               ; preds = %42
  ...
  %47 = getelementptr inbounds [105 x i32], [105 x i32]* @in, i64 0, i64 %46
...
50:                                               ; preds = %45
  ...
  %54 = getelementptr inbounds [105 x i32], [105 x i32]* @in, i64 0, i64 %53
  ...
  %59 = getelementptr inbounds [105 x i32], [105 x i32]* @out, i64 0, i64 %58
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s792952468.cpp() #0 section ".text.startup" {
