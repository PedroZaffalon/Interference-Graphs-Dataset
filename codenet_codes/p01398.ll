; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01398/s627706210.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01398/s627706210.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s627706210.cpp, i8* null }]
...
define signext i8 @_Z1kc(i8 signext %0) #4 {
  br label %2
...
15:                                               ; preds = %12
  ...
  %20 = invoke i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0), i32* %17, i32* %19)
...
32:                                               ; preds = %98, %96, %87, %81, %79, %65, %47, %41, %15, %9
...
65:                                               ; preds = %47
  ...
  %75 = call i32 @abs(i32 %74) #8
  %76 = add nsw i32 %67, %75
  %77 = trunc i32 %76 to i8
  %78 = invoke signext i8 @_Z1kc(i8 signext %59)
          to label %79 unwind label %32

79:                                               ; preds = %65
  %80 = invoke signext i8 @_Z1kc(i8 signext %77)
...
102:                                              ; preds = %32
  %103 = insertvalue { i8*, i32 } undef, i8* %34, 0
  %104 = insertvalue { i8*, i32 } %103, i32 %35, 1
  resume { i8*, i32 } %104
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s627706210.cpp() #0 section ".text.startup" {
