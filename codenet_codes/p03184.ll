; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03184/s619157756.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03184/s619157756.cpp"
...
@dp = global [3005 x i64] zeroinitializer, align 16
@fact = global [200005 x i64] zeroinitializer, align 16
@ans = global i64 0, align 8
@coor = global [3005 x %"struct.std::pair"] zeroinitializer, align 16
@_ZSt3cin = external global %"class.std::basic_istream", align 8
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s619157756.cpp, i8* null }]
...
define i64 @_Z6binpowxx(i64 %0, i64 %1) #4 {
  br label %3
...
; Function Attrs: noinline nounwind uwtable
define i64 @_Z1Cxx(i64 %0, i64 %1) #4 {
  %3 = getelementptr inbounds [200005 x i64], [200005 x i64]* @fact, i64 0, i64 %1
  ...
  %10 = sub nsw i64 %1, %0
  %11 = getelementptr inbounds [200005 x i64], [200005 x i64]* @fact, i64 0, i64 %10
...
10:                                               ; preds = %7
  %11 = getelementptr inbounds [3005 x %"struct.std::pair"], [3005 x %"struct.std::pair"]* @coor, i64 0, i64 %.01
  ...
  %14 = getelementptr inbounds [3005 x %"struct.std::pair"], [3005 x %"struct.std::pair"]* @coor, i64 0, i64 %.01
  %15 = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* %14, i32 0, i32 1
  %16 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERx(%"class.std::basic_istream"* %13, i64* dereferenceable(8) %15)
  br label %17
...
25:                                               ; preds = %20
  ...
  %31 = getelementptr inbounds [200005 x i64], [200005 x i64]* @fact, i64 0, i64 %.1
...
34:                                               ; preds = %20
  ...
  %36 = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* getelementptr inbounds ([3005 x %"struct.std::pair"], [3005 x %"struct.std::pair"]* @coor, i32 0, i64 1), i64 %35
  call void @_ZSt4sortIPSt4pairIxxEEvT_S3_(%"struct.std::pair"* getelementptr inbounds ([3005 x %"struct.std::pair"], [3005 x %"struct.std::pair"]* @coor, i32 0, i64 1), %"struct.std::pair"* %36)
  ...
  %42 = sub nsw i64 %41, 2
  %43 = call i64 @_Z1Cxx(i64 %38, i64 %42)
  store i64 %43, i64* @ans, align 8
  br label %44

44:                                               ; preds = %136, %34
  %.2 = phi i64 [ 1, %34 ], [ %137, %136 ]
  %45 = load i64, i64* %3, align 8
  %46 = icmp sle i64 %.2, %45
  br i1 %46, label %47, label %138

47:                                               ; preds = %44
  %48 = getelementptr inbounds [3005 x %"struct.std::pair"], [3005 x %"struct.std::pair"]* @coor, i64 0, i64 %.2
  %49 = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* %48, i32 0, i32 0
  %50 = load i64, i64* %49, align 16
  %51 = sub nsw i64 %50, 1
  %52 = getelementptr inbounds [3005 x %"struct.std::pair"], [3005 x %"struct.std::pair"]* @coor, i64 0, i64 %.2
  %53 = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* %52, i32 0, i32 0
  %54 = load i64, i64* %53, align 16
  %55 = getelementptr inbounds [3005 x %"struct.std::pair"], [3005 x %"struct.std::pair"]* @coor, i64 0, i64 %.2
  %56 = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* %55, i32 0, i32 1
  %57 = load i64, i64* %56, align 8
  %58 = add nsw i64 %54, %57
  %59 = sub nsw i64 %58, 2
  %60 = call i64 @_Z1Cxx(i64 %51, i64 %59)
  %61 = getelementptr inbounds [3005 x i64], [3005 x i64]* @dp, i64 0, i64 %.2
  store i64 %60, i64* %61, align 8
  %62 = sub nsw i64 %.2, 1
  br label %63

63:                                               ; preds = %108, %47
  %.0 = phi i64 [ %62, %47 ], [ %109, %108 ]
  %64 = icmp sge i64 %.0, 1
  br i1 %64, label %65, label %110

65:                                               ; preds = %63
  %66 = getelementptr inbounds [3005 x %"struct.std::pair"], [3005 x %"struct.std::pair"]* @coor, i64 0, i64 %.0
  %67 = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* %66, i32 0, i32 1
  %68 = load i64, i64* %67, align 8
  %69 = getelementptr inbounds [3005 x %"struct.std::pair"], [3005 x %"struct.std::pair"]* @coor, i64 0, i64 %.2
...
73:                                               ; preds = %65
  %74 = getelementptr inbounds [3005 x i64], [3005 x i64]* @dp, i64 0, i64 %.2
  %75 = load i64, i64* %74, align 8
  %76 = getelementptr inbounds [3005 x i64], [3005 x i64]* @dp, i64 0, i64 %.0
  %77 = load i64, i64* %76, align 8
  %78 = getelementptr inbounds [3005 x %"struct.std::pair"], [3005 x %"struct.std::pair"]* @coor, i64 0, i64 %.2
  %79 = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* %78, i32 0, i32 1
  %80 = load i64, i64* %79, align 8
  %81 = getelementptr inbounds [3005 x %"struct.std::pair"], [3005 x %"struct.std::pair"]* @coor, i64 0, i64 %.0
  %82 = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* %81, i32 0, i32 1
  %83 = load i64, i64* %82, align 8
  %84 = sub nsw i64 %80, %83
  %85 = getelementptr inbounds [3005 x %"struct.std::pair"], [3005 x %"struct.std::pair"]* @coor, i64 0, i64 %.2
  %86 = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* %85, i32 0, i32 1
  %87 = load i64, i64* %86, align 8
  %88 = getelementptr inbounds [3005 x %"struct.std::pair"], [3005 x %"struct.std::pair"]* @coor, i64 0, i64 %.2
  %89 = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* %88, i32 0, i32 0
  %90 = load i64, i64* %89, align 16
  %91 = add nsw i64 %87, %90
  %92 = getelementptr inbounds [3005 x %"struct.std::pair"], [3005 x %"struct.std::pair"]* @coor, i64 0, i64 %.0
  %93 = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* %92, i32 0, i32 1
  %94 = load i64, i64* %93, align 8
  %95 = sub nsw i64 %91, %94
  %96 = getelementptr inbounds [3005 x %"struct.std::pair"], [3005 x %"struct.std::pair"]* @coor, i64 0, i64 %.0
  %97 = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* %96, i32 0, i32 0
  %98 = load i64, i64* %97, align 16
  %99 = sub nsw i64 %95, %98
  %100 = call i64 @_Z1Cxx(i64 %84, i64 %99)
  %101 = mul nsw i64 %77, %100
  %102 = srem i64 %101, 1000000007
  %103 = sub nsw i64 %75, %102
  %104 = add nsw i64 %103, 1000000007
  %105 = srem i64 %104, 1000000007
  %106 = getelementptr inbounds [3005 x i64], [3005 x i64]* @dp, i64 0, i64 %.2
...
110:                                              ; preds = %63
  ...
  %112 = getelementptr inbounds [3005 x i64], [3005 x i64]* @dp, i64 0, i64 %.2
  %113 = load i64, i64* %112, align 8
  %114 = load i64, i64* %1, align 8
  %115 = getelementptr inbounds [3005 x %"struct.std::pair"], [3005 x %"struct.std::pair"]* @coor, i64 0, i64 %.2
  ...
  %122 = getelementptr inbounds [3005 x %"struct.std::pair"], [3005 x %"struct.std::pair"]* @coor, i64 0, i64 %.2
  ...
  %126 = getelementptr inbounds [3005 x %"struct.std::pair"], [3005 x %"struct.std::pair"]* @coor, i64 0, i64 %.2
  %127 = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* %126, i32 0, i32 1
  %128 = load i64, i64* %127, align 8
  %129 = sub nsw i64 %125, %128
  %130 = call i64 @_Z1Cxx(i64 %118, i64 %129)
  %131 = mul nsw i64 %113, %130
  %132 = sub nsw i64 %111, %131
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s619157756.cpp() #0 section ".text.startup" {
