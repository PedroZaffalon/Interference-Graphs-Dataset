; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02191/s263346878.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02191/s263346878.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s263346878.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define i32 @_Z3bini(i32 %0) #0 {
  br label %2

2:                                                ; preds = %13, %1
  %.02 = phi i32 [ 0, %1 ], [ %14, %13 ]
  %.01 = phi i32 [ 0, %1 ], [ %11, %13 ]
  %.0 = phi i32 [ %0, %1 ], [ %12, %13 ]
  %3 = icmp sgt i32 %.0, 0
...
4:                                                ; preds = %2
  ...
  %8 = call double @_ZSt3powIiiEN9__gnu_cxx11__promote_2IT_T0_NS0_9__promoteIS2_Xsr3std12__is_integerIS2_EE7__valueEE6__typeENS4_IS3_Xsr3std12__is_integerIS3_EE7__valueEE6__typeEE6__typeES2_S3_(i32 10, i32 %.02)
  %9 = fmul double %7, %8
  %10 = fadd double %5, %9
...
; Function Attrs: noinline uwtable
define zeroext i1 @_Z5primei(i32 %0) #0 {
  br label %2

2:                                                ; preds = %12, %1
  %.01 = phi i64 [ 2, %1 ], [ %13, %12 ]
  %3 = sitofp i64 %.01 to double
  %4 = call double @_ZSt4sqrtIiEN9__gnu_cxx11__enable_ifIXsr12__is_integerIT_EE7__valueEdE6__typeES2_(i32 %0)
...
define i32 @_Z3lcmii(i32 %0, i32 %1) #0 {
  %3 = mul nsw i32 %0, %1
  %4 = call i32 @_Z3gcdii(i32 %0, i32 %1)
  %5 = sdiv i32 %3, %4
  ret i32 %5
}

; Function Attrs: noinline uwtable
define i32 @_Z3kaii(i32 %0) #0 {
  %2 = icmp eq i32 %0, 0
...
; Function Attrs: noinline nounwind uwtable
define i32 @_Z7mod_powiii(i32 %0, i32 %1, i32 %2) #4 {
  br label %4

4:                                                ; preds = %12, %3
  %.02 = phi i32 [ 1, %3 ], [ %.1, %12 ]
  %.01 = phi i32 [ %1, %3 ], [ %15, %12 ]
  %.0 = phi i32 [ %0, %3 ], [ %14, %12 ]
  %5 = icmp sgt i32 %.01, 0
...
; Function Attrs: noinline nounwind uwtable
define i64 @_Z3nCrii(i32 %0, i32 %1) #4 {
  %3 = sext i32 %0 to i64
  br label %4

4:                                                ; preds = %12, %2
  %.02 = phi i32 [ 1, %2 ], [ %11, %12 ]
  %.01 = phi i64 [ %3, %2 ], [ %13, %12 ]
  %5 = sub nsw i32 %0, %1
  %6 = sext i32 %5 to i64
  %7 = icmp sgt i64 %.01, %6
...
15:                                               ; preds = %23, %14
  %.1 = phi i32 [ %.02, %14 ], [ %22, %23 ]
  %.0 = phi i64 [ 1, %14 ], [ %24, %23 ]
  %16 = add nsw i32 %1, 1
...
23:                                               ; preds = %32, %22
  %.02 = phi i64 [ 0, %22 ], [ %33, %32 ]
  %24 = load i32, i32* %2, align 4
  %25 = sext i32 %24 to i64
  %26 = icmp slt i64 %.02, %25
  br i1 %26, label %27, label %34

27:                                               ; preds = %23
  %28 = getelementptr inbounds [100010 x i32], [100010 x i32]* @l, i64 0, i64 %.02
  %29 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* @_ZSt3cin, i32* dereferenceable(4) %28)
  %30 = getelementptr inbounds [100010 x i32], [100010 x i32]* @r, i64 0, i64 %.02
...
34:                                               ; preds = %23
  %35 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector"* @a) #3
  %36 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %4, i32 0, i32 0
  store i32* %35, i32** %36, align 8
  %37 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector"* @a) #3
...
47:                                               ; preds = %43
  ...
  %57 = call i32* @_ZSt11upper_boundIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEiET_S7_S7_RKT0_(i32* %54, i32* %56, i32* dereferenceable(4) %52)
  ...
  %63 = getelementptr inbounds [100010 x i32], [100010 x i32]* @l, i64 0, i64 %.0
  ...
  %68 = call i32* @_ZSt11lower_boundIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEiET_S7_S7_RKT0_(i32* %65, i32* %67, i32* dereferenceable(4) %63)
  %69 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %9, i32 0, i32 0
  store i32* %68, i32** %69, align 8
  %70 = call i64 @_ZN9__gnu_cxxmiIPiSt6vectorIiSaIiEEEENS_17__normal_iteratorIT_T0_E15difference_typeERKS8_SB_(%"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %6, %"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %9) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s263346878.cpp() #0 section ".text.startup" {
