; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01028/s016944539.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01028/s016944539.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s016944539.cpp, i8* null }]
...
define i32 @main() #4 {
  ...
  call void @_ZN5SolveC2Ev(%class.Solve* %1)
  ret i32 0
}

; Function Attrs: noinline uwtable
define linkonce_odr void @_ZN5SolveC2Ev(%class.Solve* %0) unnamed_addr #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %8 = getelementptr inbounds %class.Solve, %class.Solve* %0, i32 0, i32 0
...
10:                                               ; preds = %1
  ...
  %11 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector"* %4) #3
  %12 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %6, i32 0, i32 0
  store i32* %11, i32** %12, align 8
  %13 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector"* %4) #3
...
17:                                               ; preds = %15
  ...
  %19 = invoke i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i32 0, i32 0), i32* %18)
...
32:                                               ; preds = %37, %31
  %.06 = phi i32 [ 0, %31 ], [ %38, %37 ]
  %.05 = phi i32 [ 1, %31 ], [ %36, %37 ]
  %33 = load i32, i32* %2, align 4
  %34 = icmp slt i32 %.06, %33
  br i1 %34, label %35, label %39

35:                                               ; preds = %32
  %36 = mul nsw i32 %.05, 10
  br label %37
...
40:                                               ; preds = %63, %39
  %.07 = phi i32 [ 0, %39 ], [ %64, %63 ]
  %41 = icmp slt i32 %.07, %.05
...
43:                                               ; preds = %53, %42
  %.04 = phi i32 [ %.07, %42 ], [ %52, %53 ]
  %.03 = phi i32 [ 0, %42 ], [ %51, %53 ]
  %.02 = phi i32 [ 0, %42 ], [ %54, %53 ]
...
58:                                               ; preds = %55
  ...
  %60 = invoke i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i32 0, i32 0), i32 %59, i32 %.07)
...
65:                                               ; preds = %40
  %66 = invoke i32 @puts(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i32 0, i32 0))
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s016944539.cpp() #0 section ".text.startup" {
