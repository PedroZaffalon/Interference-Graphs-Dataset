; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00355/s494019967.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00355/s494019967.cpp"
...
@app = global [1001 x i64] zeroinitializer, align 16
@_ZSt3cin = external global %"class.std::basic_istream", align 8
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@.str = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s494019967.cpp, i8* null }]
...
20:                                               ; preds = %17
  ...
  %24 = getelementptr inbounds [1001 x i64], [1001 x i64]* @app, i64 0, i64 %23
  %25 = load i64, i64* %24, align 8
  %26 = add nsw i64 %25, 1
  store i64 %26, i64* %24, align 8
  %27 = load i64, i64* %5, align 8
  %28 = getelementptr inbounds [1001 x i64], [1001 x i64]* @app, i64 0, i64 %27
...
34:                                               ; preds = %43, %33
  %.02 = phi i64 [ 1, %33 ], [ %44, %43 ]
  %35 = icmp sle i64 %.02, 1000
  br i1 %35, label %36, label %45

36:                                               ; preds = %34
  %37 = sub nsw i64 %.02, 1
  %38 = getelementptr inbounds [1001 x i64], [1001 x i64]* @app, i64 0, i64 %37
  %39 = load i64, i64* %38, align 8
  %40 = getelementptr inbounds [1001 x i64], [1001 x i64]* @app, i64 0, i64 %.02
...
47:                                               ; preds = %58, %45
  %.03 = phi i64 [ %46, %45 ], [ %59, %58 ]
  %48 = load i64, i64* %2, align 8
  %49 = icmp slt i64 %.03, %48
  br i1 %49, label %50, label %60

50:                                               ; preds = %47
  %51 = getelementptr inbounds [1001 x i64], [1001 x i64]* @app, i64 0, i64 %.03
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s494019967.cpp() #0 section ".text.startup" {
