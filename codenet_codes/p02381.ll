; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02381/s921917312.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02381/s921917312.cpp"
...
$_ZSt10accumulateIPidET0_T_S2_S1_ = comdat any
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s921917312.cpp, i8* null }]
...
27:                                               ; preds = %31, %19
  %.02 = phi i32* [ %23, %19 ], [ %32, %31 ]
  %28 = icmp ne i32* %.02, %26
  br i1 %28, label %29, label %33

29:                                               ; preds = %27
  %30 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* @_ZSt3cin, i32* dereferenceable(4) %.02)
  br label %31

31:                                               ; preds = %29
  %32 = getelementptr inbounds i32, i32* %.02, i32 1
  br label %27
...
33:                                               ; preds = %27
  ...
  %37 = call double @_ZSt10accumulateIPidET0_T_S2_S1_(i32* %23, i32* %36, double 0.000000e+00)
...
44:                                               ; preds = %55, %33
  %.01 = phi double [ 0.000000e+00, %33 ], [ %54, %55 ]
  %.0 = phi i32* [ %23, %33 ], [ %56, %55 ]
  %45 = icmp ne i32* %.0, %43
...
55:                                               ; preds = %46
  %56 = getelementptr inbounds i32, i32* %.0, i32 1
  br label %44
...
57:                                               ; preds = %44
  ...
  %59 = call i32 @_ZSt12setprecisioni(i32 10)
...
define linkonce_odr double @_ZSt10accumulateIPidET0_T_S2_S1_(i32* %0, i32* %1, double %2) #6 comdat {
  br label %4

4:                                                ; preds = %10, %3
  %.01 = phi double [ %2, %3 ], [ %9, %10 ]
  %.0 = phi i32* [ %0, %3 ], [ %11, %10 ]
  %5 = icmp ne i32* %.0, %1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s921917312.cpp() #0 section ".text.startup" {
