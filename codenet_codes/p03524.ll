; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03524/s625383961.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03524/s625383961.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s625383961.cpp, i8* null }]
...
7:                                                ; preds = %20, %6
  %.03 = phi i64 [ 0, %6 ], [ %21, %20 ]
  %8 = call i64 @_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE4sizeEv(%"class.std::__cxx11::basic_string"* %1) #3
  %9 = icmp ult i64 %.03, %8
  br i1 %9, label %10, label %34

10:                                               ; preds = %7
  %11 = invoke dereferenceable(1) i8* @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEixEm(%"class.std::__cxx11::basic_string"* %1, i64 %.03)
...
35:                                               ; preds = %45, %34
  %.04 = phi i64 [ 0, %34 ], [ %.1, %45 ]
  %.0 = phi i64 [ 0, %34 ], [ %46, %45 ]
  %36 = icmp slt i64 %.0, 26
  br i1 %36, label %37, label %47

37:                                               ; preds = %35
  %38 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %2, i64 %.0) #3
...
61:                                               ; preds = %60
  %62 = insertvalue { i8*, i32 } undef, i8* %.01, 0
  %63 = insertvalue { i8*, i32 } %62, i32 %.02, 1
  resume { i8*, i32 } %63
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s625383961.cpp() #0 section ".text.startup" {
