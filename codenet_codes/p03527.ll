; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03527/s717541216.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03527/s717541216.cpp"
...
@pare = global [100010 x i32] zeroinitializer, align 16
@num = global [100010 x i32] zeroinitializer, align 16
@_ZSt3cin = external global %"class.std::basic_istream", align 8
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@.str = private unnamed_addr constant [3 x i8] c"NO\00", align 1
@.str.1 = private unnamed_addr constant [4 x i8] c"YES\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s717541216.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define i32 @_Z4rooti(i32 %0) #0 {
  %2 = sext i32 %0 to i64
  %3 = getelementptr inbounds [100010 x i32], [100010 x i32]* @pare, i64 0, i64 %2
...
7:                                                ; preds = %1
  %8 = sext i32 %0 to i64
  %9 = getelementptr inbounds [100010 x i32], [100010 x i32]* @pare, i64 0, i64 %8
  %10 = load i32, i32* %9, align 4
  %11 = call i32 @_Z4rooti(i32 %10)
  %12 = sext i32 %0 to i64
  %13 = getelementptr inbounds [100010 x i32], [100010 x i32]* @pare, i64 0, i64 %12
...
13:                                               ; preds = %2
  ...
  %16 = getelementptr inbounds [100010 x i32], [100010 x i32]* @pare, i64 0, i64 %15
  %17 = load i32, i32* %16, align 4
  %18 = load i32, i32* %3, align 4
  %19 = sext i32 %18 to i64
  %20 = getelementptr inbounds [100010 x i32], [100010 x i32]* @pare, i64 0, i64 %19
...
24:                                               ; preds = %23, %13
  ...
  %27 = getelementptr inbounds [100010 x i32], [100010 x i32]* @pare, i64 0, i64 %26
  %28 = load i32, i32* %27, align 4
  %29 = load i32, i32* %3, align 4
  %30 = sext i32 %29 to i64
  %31 = getelementptr inbounds [100010 x i32], [100010 x i32]* @pare, i64 0, i64 %30
  %32 = load i32, i32* %31, align 4
  %33 = add nsw i32 %32, %28
  store i32 %33, i32* %31, align 4
  %34 = load i32, i32* %3, align 4
  %35 = sext i32 %34 to i64
  %36 = getelementptr inbounds [100010 x i32], [100010 x i32]* @num, i64 0, i64 %35
  %37 = load i32, i32* %36, align 4
  %38 = load i32, i32* %4, align 4
  %39 = sext i32 %38 to i64
  %40 = getelementptr inbounds [100010 x i32], [100010 x i32]* @num, i64 0, i64 %39
  %41 = load i32, i32* %40, align 4
  %42 = add nsw i32 %37, %41
  %43 = srem i32 %42, 26
  %44 = load i32, i32* %3, align 4
  %45 = sext i32 %44 to i64
  %46 = getelementptr inbounds [100010 x i32], [100010 x i32]* @num, i64 0, i64 %45
  store i32 %43, i32* %46, align 4
  %47 = load i32, i32* %3, align 4
  %48 = load i32, i32* %4, align 4
  %49 = sext i32 %48 to i64
  %50 = getelementptr inbounds [100010 x i32], [100010 x i32]* @pare, i64 0, i64 %49
...
define zeroext i1 @_Z6issameii(i32 %0, i32 %1) #0 {
  %3 = call i32 @_Z4rooti(i32 %0)
  %4 = call i32 @_Z4rooti(i32 %1)
  %5 = icmp eq i32 %3, %4
  ret i1 %5
}
...
8:                                                ; preds = %6
  ...
  store i32 %11, i32* getelementptr inbounds ([100010 x i32], [100010 x i32]* @num, i64 0, i64 0), align 16
...
36:                                               ; preds = %31
  ...
  %44 = getelementptr inbounds [100010 x i32], [100010 x i32]* @num, i64 0, i64 %43
...
47:                                               ; preds = %117, %115, %109, %107, %99, %86, %84, %82, %76, %68, %31, %27, %8, %6, %0
...
57:                                               ; preds = %52
  ...
  %59 = getelementptr inbounds [100010 x i32], [100010 x i32]* @pare, i64 0, i64 %58
...
68:                                               ; preds = %63
  ...
  invoke void @_Z5uniteii(i32 %.04, i32 %72)
...
84:                                               ; preds = %82
  %85 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* %83, i32* dereferenceable(4) %4)
...
86:                                               ; preds = %84
  ...
  invoke void @_Z5uniteii(i32 %88, i32 %89)
...
121:                                              ; preds = %47
  %122 = insertvalue { i8*, i32 } undef, i8* %49, 0
  %123 = insertvalue { i8*, i32 } %122, i32 %50, 1
  resume { i8*, i32 } %123
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s717541216.cpp() #0 section ".text.startup" {
