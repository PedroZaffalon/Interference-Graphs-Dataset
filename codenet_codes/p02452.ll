; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02452/s357505217.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02452/s357505217.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s357505217.cpp, i8* null }]
...
define internal void @__cxx_global_var_init.1() #0 section ".text.startup" {
  call void @_ZNSt3setIiSt4lessIiESaIiEEC2Ev(%"class.std::set"* @se) #3
  %1 = call i32 @__cxa_atexit(void (i8*)* bitcast (void (%"class.std::set"*)* @_ZNSt3setIiSt4lessIiESaIiEED2Ev to void (i8*)*), i8* getelementptr inbounds (%"class.std::set", %"class.std::set"* @se, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0), i8* @__dso_handle) #3
  ret void
}
...
6:                                                ; preds = %3
  ...
  %8 = call { %"struct.std::_Rb_tree_node_base"*, i8 } @_ZNSt3setIiSt4lessIiESaIiEE6insertERKi(%"class.std::set"* @se, i32* dereferenceable(4) @a)
  %9 = bitcast %"struct.std::pair"* %1 to { %"struct.std::_Rb_tree_node_base"*, i8 }*
...
21:                                               ; preds = %18
  ...
  %23 = call i64 @_ZNKSt3setIiSt4lessIiESaIiEE5countERKi(%"class.std::set"* @se, i32* dereferenceable(4) @k)
  %24 = icmp ne i64 %23, 0
...
29:                                               ; preds = %18
  %30 = load i8, i8* @flag, align 1
  %31 = trunc i8 %30 to i1
  %32 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEb(%"class.std::basic_ostream"* @_ZSt4cout, i1 zeroext %31)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s357505217.cpp() #0 section ".text.startup" {
