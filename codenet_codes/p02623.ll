; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02623/s223584938.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02623/s223584938.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s223584938.cpp, i8* null }]
...
25:                                               ; preds = %20
  %26 = getelementptr inbounds i64, i64* %19, i64 %.01
...
30:                                               ; preds = %20
  ...
  call void @_ZSt4sortIPxEvT_S1_(i64* %19, i64* %34)
  br label %35

35:                                               ; preds = %53, %30
  %.03 = phi i64 [ 0, %30 ], [ %.14, %53 ]
  %.02 = phi i64 [ 0, %30 ], [ %43, %53 ]
  %.0 = phi i64 [ 0, %30 ], [ %.1, %53 ]
  %36 = load i64, i64* %1, align 8
  %37 = load i64, i64* %2, align 8
  %38 = add nsw i64 %36, %37
  %39 = icmp slt i64 %.03, %38
  br i1 %39, label %40, label %54

40:                                               ; preds = %35
  %41 = getelementptr inbounds i64, i64* %19, i64 %.03
...
49:                                               ; preds = %46, %40
  %.14 = phi i64 [ %48, %46 ], [ %.03, %40 ]
  %.1 = phi i64 [ %47, %46 ], [ %.0, %40 ]
...
54:                                               ; preds = %52, %35
  %.2 = phi i64 [ %.1, %52 ], [ %.0, %35 ]
  %55 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEx(%"class.std::basic_ostream"* @_ZSt4cout, i64 %.2)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s223584938.cpp() #0 section ".text.startup" {
