; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02267/s186888654.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02267/s186888654.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s186888654.cpp, i8* null }]
...
50:                                               ; preds = %27
  %51 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %.01)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s186888654.cpp() #0 section ".text.startup" {
