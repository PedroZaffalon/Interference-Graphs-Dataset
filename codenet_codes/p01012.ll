; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01012/s876977217.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01012/s876977217.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s876977217.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define x86_fp80 @_Z6getanseeie(x86_fp80 %0, x86_fp80 %1, i32 %2, x86_fp80 %3) #0 {
  %5 = icmp eq i32 %2, 0
...
6:                                                ; preds = %4
  ...
  %9 = fcmp olt x86_fp80 %8, 0xK3FE7D6BF94D5E57A4000
  br i1 %9, label %10, label %14

10:                                               ; preds = %6, %4
  %11 = fsub x86_fp80 0xK3FFF8000000000000000, %0
  %12 = fsub x86_fp80 %1, %0
  %13 = fmul x86_fp80 %11, %12
  br label %28

14:                                               ; preds = %6
  %15 = fsub x86_fp80 0xK3FFF8000000000000000, %3
  %16 = fmul x86_fp80 %15, %0
  %17 = fmul x86_fp80 %3, %1
  %18 = fadd x86_fp80 %16, %17
  %19 = sub nsw i32 %2, 1
  %20 = call x86_fp80 @_Z6getanseeie(x86_fp80 %0, x86_fp80 %18, i32 %19, x86_fp80 %3)
  %21 = fsub x86_fp80 0xK3FFF8000000000000000, %3
  %22 = fmul x86_fp80 %21, %0
  %23 = fmul x86_fp80 %3, %1
  %24 = fadd x86_fp80 %22, %23
  %25 = sub nsw i32 %2, 1
  %26 = call x86_fp80 @_Z6getanseeie(x86_fp80 %24, x86_fp80 %1, i32 %25, x86_fp80 %3)
  %27 = fadd x86_fp80 %20, %26
  br label %28

28:                                               ; preds = %14, %10
  %.0 = phi x86_fp80 [ %13, %10 ], [ %27, %14 ]
  ret x86_fp80 %.0
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr x86_fp80 @_ZSt3abse(x86_fp80 %0) #4 comdat {
  %2 = call x86_fp80 @llvm.fabs.f80(x86_fp80 %0)
  ret x86_fp80 %2
}

; Function Attrs: noinline uwtable
define x86_fp80 @_Z3getv() #0 {
  ...
  %14 = fdiv x86_fp80 %9, %13
  store i32 40, i32* %4, align 4
  %15 = call dereferenceable(4) i32* @_ZSt3minIiERKT_S2_S2_(i32* dereferenceable(4) %3, i32* dereferenceable(4) %4)
  %16 = load i32, i32* %15, align 4
  store i32 %16, i32* %3, align 4
  %17 = load i32, i32* %3, align 4
  %18 = call x86_fp80 @_Z6getanseeie(x86_fp80 0xK00000000000000000000, x86_fp80 0xK3FFF8000000000000000, i32 %17, x86_fp80 %14)
  ret x86_fp80 %18
}
...
define i32 @main() #5 {
  ...
  %2 = call x86_fp80 @_Z3getv()
  %3 = call x86_fp80 @_Z3getv()
  ...
  %10 = fmul x86_fp80 %2, %3
  %11 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEe(%"class.std::basic_ostream"* %9, x86_fp80 %10)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s876977217.cpp() #0 section ".text.startup" {
