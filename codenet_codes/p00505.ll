; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00505/s222324616.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00505/s222324616.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s222324616.cpp, i8* null }]
...
2:                                                ; preds = %64, %0
  %.03 = phi i32 [ 0, %0 ], [ %.25, %64 ]
  %.01 = phi i32 [ 0, %0 ], [ %.12, %64 ]
  %.0 = phi i32 [ 0, %0 ], [ %.2, %64 ]
  ...
  %6 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i32 0, i32 0), i32* %3, i32* %4, i32* %5)
  %7 = icmp ne i32 %6, -1
...
41:                                               ; preds = %21
  ...
  %44 = getelementptr inbounds [3 x i32], [3 x i32]* %1, i64 0, i64 2
  %45 = load i32, i32* %44, align 4
  %46 = mul nsw i32 %43, %45
  %47 = getelementptr inbounds [3 x i32], [3 x i32]* %1, i64 0, i64 0
  %48 = load i32, i32* %47, align 4
  %49 = getelementptr inbounds [3 x i32], [3 x i32]* %1, i64 0, i64 0
  %50 = load i32, i32* %49, align 4
  %51 = mul nsw i32 %48, %50
  %52 = getelementptr inbounds [3 x i32], [3 x i32]* %1, i64 0, i64 1
  %53 = load i32, i32* %52, align 4
  %54 = getelementptr inbounds [3 x i32], [3 x i32]* %1, i64 0, i64 1
...
63:                                               ; preds = %61, %59
  %.14 = phi i32 [ %60, %59 ], [ %.03, %61 ]
  %.1 = phi i32 [ %.0, %59 ], [ %62, %61 ]
  br label %64

64:                                               ; preds = %63, %39
  %.25 = phi i32 [ %.03, %39 ], [ %.14, %63 ]
  %.12 = phi i32 [ %40, %39 ], [ %.01, %63 ]
  %.2 = phi i32 [ %.0, %39 ], [ %.1, %63 ]
  br label %2

65:                                               ; preds = %20, %2
  %66 = add nsw i32 %.01, %.03
  %67 = add nsw i32 %66, %.0
  %68 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i32 0, i32 0), i32 %67, i32 %.01, i32 %.03, i32 %.0)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s222324616.cpp() #0 section ".text.startup" {
