; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03658/s657505339.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03658/s657505339.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s657505339.cpp, i8* null }]
...
11:                                               ; preds = %2
  ...
  %14 = getelementptr inbounds i32, i32* getelementptr inbounds ([100010 x i32], [100010 x i32]* @a, i32 0, i32 0), i64 %13
  %15 = getelementptr inbounds i32, i32* %14, i64 1
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([100010 x i32], [100010 x i32]* @a, i32 0, i64 1), i32* %15)
  %16 = load i32, i32* @n, align 4
  br label %17

17:                                               ; preds = %38, %11
  %.02 = phi i64 [ 0, %11 ], [ %37, %38 ]
  %.0 = phi i32 [ %16, %11 ], [ %39, %38 ]
...
40:                                               ; preds = %29
  %41 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEx(%"class.std::basic_ostream"* @_ZSt4cout, i64 %.02)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s657505339.cpp() #0 section ".text.startup" {
