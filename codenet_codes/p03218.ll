; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03218/s633072329.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03218/s633072329.cpp"
...
@li = global [100005 x i32] zeroinitializer, align 16
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s633072329.cpp, i8* null }]
...
5:                                                ; preds = %2
  %6 = sext i32 %.0 to i64
  %7 = getelementptr inbounds [100005 x i32], [100005 x i32]* @li, i64 0, i64 %6
...
11:                                               ; preds = %2
  ...
  %14 = getelementptr inbounds i32, i32* getelementptr inbounds ([100005 x i32], [100005 x i32]* @li, i32 0, i32 0), i64 %13
  %15 = getelementptr inbounds i32, i32* %14, i64 1
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([100005 x i32], [100005 x i32]* @li, i32 0, i64 1), i32* %15)
  %16 = load i32, i32* getelementptr inbounds ([100005 x i32], [100005 x i32]* @li, i64 0, i64 1), align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s633072329.cpp() #0 section ".text.startup" {
