; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00836/s013878278.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00836/s013878278.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s013878278.cpp, i8* null }]
...
13:                                               ; preds = %6
  %14 = getelementptr inbounds [10001 x i8], [10001 x i8]* %2, i64 0, i64 1
...
24:                                               ; preds = %19
  %25 = mul nsw i32 %.01, %.01
  br label %26

26:                                               ; preds = %31, %24
  %.02 = phi i32 [ %25, %24 ], [ %33, %31 ]
  %27 = icmp sle i32 %.02, 10000
...
59:                                               ; preds = %105, %58
  %60 = invoke i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0), i32* %1)
...
69:                                               ; preds = %101, %68
  %.07 = phi i32 [ 0, %68 ], [ %100, %101 ]
  %.05 = phi i32 [ 0, %68 ], [ %.16, %101 ]
  %.04 = phi i32 [ 0, %68 ], [ %.1, %101 ]
  %.03 = phi i32 [ 0, %68 ], [ %102, %101 ]
  %70 = icmp sle i32 %.03, %.04
...
72:                                               ; preds = %85, %71
  %.18 = phi i32 [ %.07, %71 ], [ %90, %85 ]
  %.1 = phi i32 [ %.04, %71 ], [ %86, %85 ]
...
103:                                              ; preds = %69
  %104 = invoke i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i32 0, i32 0), i32 %.05)
...
107:                                              ; preds = %50
  %108 = insertvalue { i8*, i32 } undef, i8* %52, 0
  %109 = insertvalue { i8*, i32 } %108, i32 %53, 1
  resume { i8*, i32 } %109
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s013878278.cpp() #0 section ".text.startup" {
