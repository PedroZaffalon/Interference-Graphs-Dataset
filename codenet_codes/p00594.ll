; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00594/s287782926.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00594/s287782926.cpp"
...
@.str = private unnamed_addr constant [9 x i8] c"NO COLOR\00", align 1
@_ZStL19piecewise_construct = internal constant %"struct.std::piecewise_construct_t" undef, align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s287782926.cpp, i8* null }]
...
41:                                               ; preds = %37
  ...
  %44 = invoke dereferenceable(4) i32* @_ZNSt3mapIiiSt4lessIiESaISt4pairIKiiEEEixERS3_(%"class.std::map"* %6, i32* dereferenceable(4) %43)
...
50:                                               ; preds = %37
  %51 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt3mapIiiSt4lessIiESaISt4pairIKiiEEE5beginEv(%"class.std::map"* %6) #3
  %52 = getelementptr inbounds %"struct.std::_Rb_tree_iterator", %"struct.std::_Rb_tree_iterator"* %7, i32 0, i32 0
  store %"struct.std::_Rb_tree_node_base"* %51, %"struct.std::_Rb_tree_node_base"** %52, align 8
  %53 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt3mapIiiSt4lessIiESaISt4pairIKiiEEE3endEv(%"class.std::map"* %6) #3
...
55:                                               ; preds = %71, %50
  %.0 = phi i32 [ -1, %50 ], [ %.1, %71 ]
  %56 = call zeroext i1 @_ZNKSt17_Rb_tree_iteratorISt4pairIKiiEEneERKS3_(%"struct.std::_Rb_tree_iterator"* %7, %"struct.std::_Rb_tree_iterator"* dereferenceable(8) %8) #3
  br i1 %56, label %57, label %73

57:                                               ; preds = %55
  %58 = call dereferenceable(8) %"struct.std::pair"* @_ZNKSt17_Rb_tree_iteratorISt4pairIKiiEEdeEv(%"struct.std::_Rb_tree_iterator"* %7) #3
...
70:                                               ; preds = %67, %57
  %.1 = phi i32 [ %69, %67 ], [ %.0, %57 ]
  br label %71

71:                                               ; preds = %70
  %72 = call dereferenceable(8) %"struct.std::_Rb_tree_iterator"* @_ZNSt17_Rb_tree_iteratorISt4pairIKiiEEppEv(%"struct.std::_Rb_tree_iterator"* %7) #3
  br label %55
...
75:                                               ; preds = %73
  %76 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i32 0, i32 0))
...
87:                                               ; preds = %32, %28
  %.04 = phi i32 [ %35, %32 ], [ %31, %28 ]
  %.03 = phi i8* [ %34, %32 ], [ %30, %28 ]
  %88 = insertvalue { i8*, i32 } undef, i8* %.03, 0
  %89 = insertvalue { i8*, i32 } %88, i32 %.04, 1
  resume { i8*, i32 } %89
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s287782926.cpp() #0 section ".text.startup" {
