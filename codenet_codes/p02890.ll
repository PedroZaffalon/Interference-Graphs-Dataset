; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02890/s541168190.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02890/s541168190.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s541168190.cpp, i8* null }]
...
define i64 @_Z3kaixxx(i64 %0, i64 %1, i64 %2) #4 {
  %4 = sub nsw i64 %0, %1
  %5 = add nsw i64 %4, 1
  br label %6

6:                                                ; preds = %11, %3
  %.01 = phi i64 [ 1, %3 ], [ %10, %11 ]
  %.0 = phi i64 [ %5, %3 ], [ %12, %11 ]
  %7 = icmp sle i64 %.0, %0
...
; Function Attrs: noinline nounwind uwtable
define i64 @_Z4combxxx(i64 %0, i64 %1, i64 %2) #4 {
  %4 = icmp sgt i64 %1, %0
...
6:                                                ; preds = %3
  %7 = call i64 @_Z3kaixxx(i64 %0, i64 %1, i64 %2)
  %8 = call i64 @_Z3kaixxx(i64 %1, i64 %1, i64 %2)
  %9 = sub nsw i64 %2, 2
...
6:                                                ; preds = %3
  ...
  %9 = sext i32 %8 to i64
  %10 = getelementptr inbounds [300010 x i32], [300010 x i32]* @cnt, i64 0, i64 %9
...
15:                                               ; preds = %3
  ...
  %18 = getelementptr inbounds i32, i32* getelementptr inbounds ([300010 x i32], [300010 x i32]* @cnt, i32 0, i32 0), i64 %17
  %19 = getelementptr inbounds i32, i32* %18, i64 1
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([300010 x i32], [300010 x i32]* @cnt, i32 0, i32 0), i32* %19)
  %20 = load i32, i32* @n, align 4
  %21 = sext i32 %20 to i64
  %22 = getelementptr inbounds i32, i32* getelementptr inbounds ([300010 x i32], [300010 x i32]* @cnt, i32 0, i32 0), i64 %21
  %23 = getelementptr inbounds i32, i32* %22, i64 1
  call void @_ZSt7reverseIPiEvT_S1_(i32* getelementptr inbounds ([300010 x i32], [300010 x i32]* @cnt, i32 0, i32 0), i32* %23)
  br label %24

24:                                               ; preds = %52, %15
  %.0 = phi i32 [ 1, %15 ], [ %53, %52 ]
...
27:                                               ; preds = %24
  ...
  %29 = load i32, i32* getelementptr inbounds ([300010 x i32], [300010 x i32]* @cnt, i64 0, i64 0), align 16
  %30 = sub nsw i32 %28, %29
  %31 = sext i32 %30 to i64
  %32 = load i32, i32* getelementptr inbounds ([300010 x i32], [300010 x i32]* @cnt, i64 0, i64 0), align 16
...
43:                                               ; preds = %27
  ...
  %45 = load i32, i32* getelementptr inbounds ([300010 x i32], [300010 x i32]* @cnt, i64 0, i64 0), align 16
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s541168190.cpp() #0 section ".text.startup" {
