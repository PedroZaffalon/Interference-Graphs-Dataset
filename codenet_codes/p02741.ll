; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02741/s542182837.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02741/s542182837.cpp"
...
@x = global [33 x i32] [i32 0, i32 1, i32 1, i32 1, i32 2, i32 1, i32 2, i32 1, i32 5, i32 2, i32 2, i32 1, i32 5, i32 1, i32 2, i32 1, i32 14, i32 1, i32 5, i32 1, i32 5, i32 2, i32 2, i32 1, i32 15, i32 2, i32 2, i32 5, i32 4, i32 1, i32 4, i32 1, i32 51], align 16
@_ZSt3cin = external global %"class.std::basic_istream", align 8
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s542182837.cpp, i8* null }]
...
define void @_Z8run_casev() #0 {
  ...
  %4 = sext i32 %3 to i64
  %5 = getelementptr inbounds [33 x i32], [33 x i32]* @x, i64 0, i64 %4
...
define i32 @main() #4 {
  ...
  %15 = call i32 @_ZNSt8ios_base5flagsESt13_Ios_Fmtflags(%"class.std::ios_base"* %14, i32 4)
...
define linkonce_odr i32 @_ZNSt8ios_base5flagsESt13_Ios_Fmtflags(%"class.std::ios_base"* %0, i32 %1) #5 comdat align 2 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s542182837.cpp() #0 section ".text.startup" {
