; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02785/s929622638.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02785/s929622638.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s929622638.cpp, i8* null }]
...
13:                                               ; preds = %3
  ...
  call void @_ZSt4sortIPxEvT_S1_(i64* getelementptr inbounds ([100005 x i64], [100005 x i64]* @a, i32 0, i64 1), i64* %16)
  %17 = load i64, i64* @n, align 8
  %18 = trunc i64 %17 to i32
  br label %19

19:                                               ; preds = %25, %13
  %.02 = phi i32 [ %18, %13 ], [ %28, %25 ]
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s929622638.cpp() #0 section ".text.startup" {
