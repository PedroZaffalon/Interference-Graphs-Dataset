; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02898/s707780454.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02898/s707780454.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s707780454.cpp, i8* null }]
...
define i32 @main() #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  invoke void @_ZNSt6vectorIiSaIiEEC2EmRKS0_(%"class.std::vector"* %3, i64 %8, %"class.std::allocator"* dereferenceable(1) %4)
...
13:                                               ; preds = %10
  ...
  %15 = invoke dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEE2atEm(%"class.std::vector"* %3, i64 %14)
          to label %16 unwind label %31

16:                                               ; preds = %13
  %17 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* @_ZSt3cin, i32* dereferenceable(4) %15)
          to label %18 unwind label %31

18:                                               ; preds = %16
  %19 = sext i32 %.0 to i64
  %20 = invoke dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEE2atEm(%"class.std::vector"* %3, i64 %19)
...
38:                                               ; preds = %10
  %39 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %.01)
...
43:                                               ; preds = %31, %27
  %.03 = phi i32 [ %34, %31 ], [ %30, %27 ]
  %.02 = phi i8* [ %33, %31 ], [ %29, %27 ]
  %44 = insertvalue { i8*, i32 } undef, i8* %.02, 0
  %45 = insertvalue { i8*, i32 } %44, i32 %.03, 1
  resume { i8*, i32 } %45
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s707780454.cpp() #0 section ".text.startup" {
