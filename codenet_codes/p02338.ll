; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02338/s204479503.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02338/s204479503.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s204479503.cpp, i8* null }]
...
define i32 @main(i32 %0, i8** %1) #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  call void @_ZN9FactorialC2Ei(%struct.Factorial* %5, i32 %19)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s204479503.cpp() #0 section ".text.startup" {
