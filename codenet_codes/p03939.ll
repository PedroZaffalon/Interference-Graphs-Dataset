; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03939/s010540585.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03939/s010540585.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s010540585.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define double @_Z4calcidd(i32 %0, double %1, double %2) #0 {
  %4 = sub nsw i32 %0, 1
...
11:                                               ; preds = %3
  ...
  %25 = call double @_Z4calcidd(i32 %12, double %19, double %24)
  br label %26

26:                                               ; preds = %11, %10
  %27 = phi double [ 0.000000e+00, %10 ], [ %25, %11 ]
  %28 = fadd double %8, %27
  ret double %28
}
...
define i32 @main() #4 {
  ...
  %19 = call double @_Z4calcidd(i32 %14, double %16, double %18)
  %20 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEd(%"class.std::basic_ostream"* %12, double %19)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s010540585.cpp() #0 section ".text.startup" {
