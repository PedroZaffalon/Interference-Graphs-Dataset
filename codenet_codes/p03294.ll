; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03294/s473431670.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03294/s473431670.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s473431670.cpp, i8* null }]
...
4:                                                ; preds = %2
  %5 = call i64 @_Z3gcdxx(i64 %0, i64 %1)
  %6 = sdiv i64 %0, %5
  %7 = mul nsw i64 %6, %1
  br label %9
...
35:                                               ; preds = %45, %34
  %.05 = phi i32 [ 0, %34 ], [ %46, %45 ]
  %.04 = phi i64 [ 0, %34 ], [ %43, %45 ]
...
38:                                               ; preds = %35
  ...
  %43 = invoke i64 @_Z3lcmxx(i64 %42, i64 %.04)
...
61:                                               ; preds = %49
  %62 = invoke i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i32 0, i32 0), i64 %.06)
...
64:                                               ; preds = %30, %26
  ...
  %66 = insertvalue { i8*, i32 } %65, i32 %.02, 1
  resume { i8*, i32 } %66
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s473431670.cpp() #0 section ".text.startup" {
