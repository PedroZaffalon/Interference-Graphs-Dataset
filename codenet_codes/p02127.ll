; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02127/s869524286.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02127/s869524286.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s869524286.cpp, i8* null }]
...
4:                                                ; preds = %0
  %5 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZStrsIcSt11char_traitsIcESaIcEERSt13basic_istreamIT_T0_ES7_RNSt7__cxx1112basic_stringIS4_S5_T1_EE(%"class.std::basic_istream"* dereferenceable(280) %3, %"class.std::__cxx11::basic_string"* dereferenceable(32) %2)
...
6:                                                ; preds = %4
  ...
  %9 = call i64 @_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6lengthEv(%"class.std::__cxx11::basic_string"* %2) #3
  %10 = trunc i64 %9 to i32
  br label %11

11:                                               ; preds = %36, %6
  %.05 = phi i32 [ 0, %6 ], [ %.27, %36 ]
  %.03 = phi i32 [ 0, %6 ], [ %.2, %36 ]
...
34:                                               ; preds = %28, %25
  %.16 = phi i32 [ 0, %28 ], [ %26, %25 ]
  %.14 = phi i32 [ %29, %28 ], [ %.03, %25 ]
  br label %35

35:                                               ; preds = %34, %21
  %.27 = phi i32 [ %.16, %34 ], [ %.05, %21 ]
  %.2 = phi i32 [ %.14, %34 ], [ %.03, %21 ]
  br label %36
...
39:                                               ; preds = %47, %38
  %.01 = phi i32 [ 0, %38 ], [ %.1, %47 ]
  %.0 = phi i32 [ 0, %38 ], [ %48, %47 ]
  %40 = icmp slt i32 %.0, 20
  br i1 %40, label %41, label %49

41:                                               ; preds = %39
  %42 = shl i32 1, %.0
  %43 = sub nsw i32 %42, 1
  %44 = icmp sge i32 %.03, %43
...
49:                                               ; preds = %39
  %50 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %.01)
...
54:                                               ; preds = %30
  %55 = insertvalue { i8*, i32 } undef, i8* %32, 0
  %56 = insertvalue { i8*, i32 } %55, i32 %33, 1
  resume { i8*, i32 } %56
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s869524286.cpp() #0 section ".text.startup" {
