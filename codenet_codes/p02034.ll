; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02034/s786983803.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02034/s786983803.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s786983803.cpp, i8* null }]
...
define i32 @main() #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  invoke void @_Z14MACRO_VAR_ScanINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEvRT_(%"class.std::__cxx11::basic_string"* dereferenceable(32) %2)
...
20:                                               ; preds = %83, %19
  %.05 = phi i64 [ 0, %19 ], [ %85, %83 ]
  %.04 = phi i64 [ 0, %19 ], [ %84, %83 ]
...
43:                                               ; preds = %39, %27, %24
  %44 = phi i1 [ false, %27 ], [ false, %24 ], [ %42, %39 ]
...
83:                                               ; preds = %74
  %84 = add nsw i64 %.04, %.07
  %85 = sub nsw i64 %.16, %.07
  br label %20
...
87:                                               ; preds = %100, %86
  %.08 = phi i64 [ 0, %86 ], [ %101, %100 ]
  %88 = load i64, i64* %1, align 8
  %89 = icmp slt i64 %.08, %88
  br i1 %89, label %90, label %102

90:                                               ; preds = %87
  %91 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %3, i64 %.08) #3
  %92 = load i64, i64* %91, align 8
  %93 = add nsw i64 %.08, %92
...
96:                                               ; preds = %90
  %97 = add nsw i64 %.08, 1
  %98 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %3, i64 %.08) #3
...
102:                                              ; preds = %87
  ...
  invoke void @_ZNSt6vectorIxSaIxEEC2EmRKS0_(%"class.std::vector"* %5, i64 %103, %"class.std::allocator.0"* dereferenceable(1) %6)
...
107:                                              ; preds = %161, %141, %104
  %.010 = phi i64 [ 0, %104 ], [ %.111, %141 ], [ %163, %161 ]
  %.09 = phi i64 [ 1, %104 ], [ %142, %141 ], [ %162, %161 ]
  %108 = call i64 @_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE4sizeEv(%"class.std::__cxx11::basic_string"* %2) #3
  %109 = icmp ult i64 %.09, %108
...
111:                                              ; preds = %128, %110
  %.111 = phi i64 [ %.010, %110 ], [ %129, %128 ]
  %112 = add nsw i64 %.09, %.111
  %113 = call i64 @_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE4sizeEv(%"class.std::__cxx11::basic_string"* %2) #3
  %114 = icmp ult i64 %112, %113
  br i1 %114, label %115, label %126

115:                                              ; preds = %111
  %116 = invoke dereferenceable(1) i8* @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEixEm(%"class.std::__cxx11::basic_string"* %2, i64 %.111)
          to label %117 unwind label %134

117:                                              ; preds = %115
  %118 = load i8, i8* %116, align 1
  %119 = sext i8 %118 to i32
  %120 = add nsw i64 %.09, %.111
...
138:                                              ; preds = %126
  %139 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %5, i64 %.09) #3
...
144:                                              ; preds = %155, %143
  %.012 = phi i64 [ 1, %143 ], [ %160, %155 ]
  %145 = add nsw i64 %.09, %.012
  %146 = call i64 @_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE4sizeEv(%"class.std::__cxx11::basic_string"* %2) #3
  %147 = icmp ult i64 %145, %146
  br i1 %147, label %148, label %153

148:                                              ; preds = %144
  %149 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %5, i64 %.012) #3
  %150 = load i64, i64* %149, align 8
  %151 = add nsw i64 %.012, %150
  %152 = icmp slt i64 %151, %.111
  br label %153
...
155:                                              ; preds = %153
  %156 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %5, i64 %.012) #3
  %157 = load i64, i64* %156, align 8
  %158 = add nsw i64 %.09, %.012
...
161:                                              ; preds = %153
  %162 = add nsw i64 %.09, %.012
  %163 = sub nsw i64 %.111, %.012
  br label %107
...
165:                                              ; preds = %207, %164
  %.013 = phi i64 [ 2, %164 ], [ %208, %207 ]
  %166 = load i64, i64* %1, align 8
  %167 = add nsw i64 %166, 1
  %168 = icmp slt i64 %.013, %167
  br i1 %168, label %169, label %209

169:                                              ; preds = %165
  %170 = mul nsw i64 2, %.013
  %171 = sub nsw i64 %170, 2
  br label %172

172:                                              ; preds = %188, %169
  %.015 = phi i64 [ %171, %169 ], [ %191, %188 ]
  %173 = load i64, i64* %1, align 8
  %174 = icmp slt i64 %.015, %173
  br i1 %174, label %175, label %192

175:                                              ; preds = %172
  %176 = load i64, i64* %1, align 8
  %177 = sub nsw i64 %176, %.015
  store i64 %177, i64* %7, align 8
  %178 = mul nsw i64 2, %.013
  %179 = sub nsw i64 %178, 2
  store i64 %179, i64* %8, align 8
  %180 = invoke dereferenceable(8) i64* @_ZSt3minIxERKT_S2_S2_(i64* dereferenceable(8) %7, i64* dereferenceable(8) %8)
          to label %181 unwind label %134

181:                                              ; preds = %175
  %182 = load i64, i64* %180, align 8
  %183 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %5, i64 %.015) #3
...
188:                                              ; preds = %187
  %189 = mul nsw i64 2, %.013
  %190 = sub nsw i64 %189, 2
  %191 = add nsw i64 %.015, %190
  br label %172

192:                                              ; preds = %186, %172
  %.014 = phi i8 [ 0, %186 ], [ 1, %172 ]
...
195:                                              ; preds = %192
  %196 = sub nsw i64 %.013, 1
  %197 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %3, i64 %196) #3
  %198 = load i64, i64* %197, align 8
  %199 = sub nsw i64 %.013, 1
  %200 = icmp sge i64 %198, %199
  br i1 %200, label %201, label %206

201:                                              ; preds = %195
  %202 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEx(%"class.std::basic_ostream"* @_ZSt4cout, i64 %.013)
...
211:                                              ; preds = %134, %130, %55
  %.02 = phi i32 [ %58, %55 ], [ %137, %134 ], [ %133, %130 ]
  %.01 = phi i8* [ %57, %55 ], [ %136, %134 ], [ %132, %130 ]
  call void @_ZNSt6vectorIxSaIxEED2Ev(%"class.std::vector"* %3) #3
  br label %212

212:                                              ; preds = %211, %51, %47
  %.13 = phi i32 [ %.02, %211 ], [ %54, %51 ], [ %50, %47 ]
  %.1 = phi i8* [ %.01, %211 ], [ %53, %51 ], [ %49, %47 ]
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED1Ev(%"class.std::__cxx11::basic_string"* %2) #3
  br label %213

213:                                              ; preds = %212
  %214 = insertvalue { i8*, i32 } undef, i8* %.1, 0
  %215 = insertvalue { i8*, i32 } %214, i32 %.13, 1
  resume { i8*, i32 } %215
}
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_Z14MACRO_VAR_ScanINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEvRT_(%"class.std::__cxx11::basic_string"* dereferenceable(32) %0) #0 comdat {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s786983803.cpp() #0 section ".text.startup" {
