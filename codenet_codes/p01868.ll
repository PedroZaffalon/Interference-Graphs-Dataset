; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01868/s013514352.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01868/s013514352.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s013514352.cpp, i8* null }]
...
13:                                               ; preds = %4
  ...
  %16 = getelementptr inbounds i32, i32* getelementptr inbounds ([100 x i32], [100 x i32]* @V, i32 0, i32 0), i64 %15
  call void @_ZSt4sortIPiSt7greaterIiEEvT_S3_T0_(i32* getelementptr inbounds ([100 x i32], [100 x i32]* @V, i32 0, i32 0), i32* %16)
  %17 = load i32, i32* getelementptr inbounds ([100 x i32], [100 x i32]* @V, i64 0, i64 0), align 16
  store i32 %17, i32* getelementptr inbounds ([3 x i32], [3 x i32]* @S, i64 0, i64 0), align 4
  %18 = load i32, i32* getelementptr inbounds ([100 x i32], [100 x i32]* @V, i64 0, i64 1), align 4
  store i32 %18, i32* getelementptr inbounds ([3 x i32], [3 x i32]* @S, i64 0, i64 1), align 4
  %19 = load i32, i32* getelementptr inbounds ([100 x i32], [100 x i32]* @V, i64 0, i64 2), align 8
  store i32 %19, i32* getelementptr inbounds ([3 x i32], [3 x i32]* @S, i64 0, i64 2), align 4
  store i32 0, i32* getelementptr inbounds ([100 x i32], [100 x i32]* @V, i64 0, i64 2), align 8
  store i32 0, i32* getelementptr inbounds ([100 x i32], [100 x i32]* @V, i64 0, i64 1), align 4
  store i32 0, i32* getelementptr inbounds ([100 x i32], [100 x i32]* @V, i64 0, i64 0), align 16
  br label %20

20:                                               ; preds = %72, %13
  %.01 = phi i32 [ %3, %13 ], [ %73, %72 ]
  %21 = icmp ne i32 %.01, 0
...
22:                                               ; preds = %20
  ...
  %25 = getelementptr inbounds i32, i32* getelementptr inbounds ([100 x i32], [100 x i32]* @V, i32 0, i32 0), i64 %24
  call void @_ZSt4sortIPiSt7greaterIiEEvT_S3_T0_(i32* getelementptr inbounds ([100 x i32], [100 x i32]* @V, i32 0, i32 0), i32* %25)
  call void @_ZSt4sortIPiSt7greaterIiEEvT_S3_T0_(i32* getelementptr inbounds ([3 x i32], [3 x i32]* @S, i32 0, i32 0), i32* getelementptr inbounds ([3 x i32], [3 x i32]* @S, i64 1, i64 0))
  br label %26

26:                                               ; preds = %64, %22
  %.03 = phi i32 [ 0, %22 ], [ %.1, %64 ]
  %.0 = phi i32 [ 2, %22 ], [ %65, %64 ]
  %27 = icmp sge i32 %.0, 0
  br i1 %27, label %28, label %66

28:                                               ; preds = %26
  %29 = sext i32 %.03 to i64
  %30 = getelementptr inbounds [100 x i32], [100 x i32]* @V, i64 0, i64 %29
  %31 = load i32, i32* %30, align 4
  %32 = sext i32 %.0 to i64
  %33 = getelementptr inbounds [3 x i32], [3 x i32]* @S, i64 0, i64 %32
  %34 = load i32, i32* %33, align 4
  %35 = add nsw i32 %34, %31
  store i32 %35, i32* %33, align 4
  %36 = sext i32 %.03 to i64
  %37 = getelementptr inbounds [100 x i32], [100 x i32]* @V, i64 0, i64 %36
  store i32 0, i32* %37, align 4
  %38 = add nsw i32 %.03, 1
  br label %39

39:                                               ; preds = %52, %28
  %.1 = phi i32 [ %38, %28 ], [ %62, %52 ]
  %40 = sext i32 %.0 to i64
  %41 = getelementptr inbounds [3 x i32], [3 x i32]* @S, i64 0, i64 %40
  %42 = load i32, i32* %41, align 4
  %43 = load i32, i32* getelementptr inbounds ([3 x i32], [3 x i32]* @S, i64 0, i64 0), align 4
...
52:                                               ; preds = %46
  ...
  %54 = getelementptr inbounds [100 x i32], [100 x i32]* @V, i64 0, i64 %53
  %55 = load i32, i32* %54, align 4
  %56 = sext i32 %.0 to i64
  %57 = getelementptr inbounds [3 x i32], [3 x i32]* @S, i64 0, i64 %56
...
66:                                               ; preds = %26
  ...
  %68 = getelementptr inbounds [100 x i32], [100 x i32]* @V, i64 0, i64 %67
...
74:                                               ; preds = %71, %20
  call void @_ZSt4sortIPiSt7greaterIiEEvT_S3_T0_(i32* getelementptr inbounds ([3 x i32], [3 x i32]* @S, i32 0, i32 0), i32* getelementptr inbounds ([3 x i32], [3 x i32]* @S, i64 1, i64 0))
  %75 = load i32, i32* getelementptr inbounds ([3 x i32], [3 x i32]* @S, i64 0, i64 0), align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s013514352.cpp() #0 section ".text.startup" {
