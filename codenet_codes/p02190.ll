; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02190/s575316211.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02190/s575316211.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s575316211.cpp, i8* null }]
...
20:                                               ; preds = %18
  %21 = invoke { %"struct.std::_Rb_tree_node_base"*, i8 } @_ZNSt3setIiSt4lessIiESaIiEE6insertERKi(%"class.std::set"* %2, i32* dereferenceable(4) %3)
          to label %22 unwind label %28

22:                                               ; preds = %20
  %23 = bitcast %"struct.std::pair"* %4 to { %"struct.std::_Rb_tree_node_base"*, i8 }*
...
32:                                               ; preds = %14
  %33 = call i64 @_ZNKSt3setIiSt4lessIiESaIiEE4sizeEv(%"class.std::set"* %2) #3
...
38:                                               ; preds = %28
  %39 = insertvalue { i8*, i32 } undef, i8* %30, 0
  %40 = insertvalue { i8*, i32 } %39, i32 %31, 1
  resume { i8*, i32 } %40
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s575316211.cpp() #0 section ".text.startup" {
