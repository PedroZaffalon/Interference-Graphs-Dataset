; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02380/s774038224.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02380/s774038224.cpp"
...
@.str = private unnamed_addr constant [13 x i8] c"%lf %lf %lf\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s774038224.cpp, i8* null }]
...
define double @_Z3radi(i32 %0) #4 {
  %2 = call double @acos(double -1.000000e+00) #3
...
define i32 @main() #5 {
  ...
  %24 = call double @_ZSt3powIiiEN9__gnu_cxx11__promote_2IT_T0_NS0_9__promoteIS2_Xsr3std12__is_integerIS2_EE7__valueEE6__typeENS4_IS3_Xsr3std12__is_integerIS3_EE7__valueEE6__typeEE6__typeES2_S3_(i32 %23, i32 2)
  ...
  %41 = call double @_Z3radi(i32 %40)
  %42 = call double @sin(double %41) #3
  %43 = fmul double %39, %42
  %44 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i32 0, i32 0), double %16, double %37, double %43)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s774038224.cpp() #0 section ".text.startup" {
