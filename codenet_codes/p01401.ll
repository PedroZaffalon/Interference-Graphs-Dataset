; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01401/s561298281.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01401/s561298281.cpp"
...
%"struct.std::_Vector_base<std::pair<std::pair<int, int>, int>, std::allocator<std::pair<std::pair<int, int>, int> > >::_Vector_impl" = type { %"struct.std::pair.0"*, %"struct.std::pair.0"*, %"struct.std::pair.0"* }
...
$_ZNSt4pairIS_IiiEiEC2IS0_Lb1EEEOT_RKi = comdat any

$_ZSt3maxIiERKT_S2_S2_ = comdat any

$_ZNSt4pairIS_IiiEiEC2IRS0_Lb1EEEOT_RKi = comdat any
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s561298281.cpp, i8* null }]
...
define i32 @_Z4distSt4pairIiiES0_(i64 %0, i64 %1) #4 {
...
define i32 @main() #6 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %3 = alloca %"struct.std::pair", align 4
  %4 = alloca [2500 x %"class.std::vector"], align 16
...
25:                                               ; preds = %20
  %26 = getelementptr inbounds [2500 x %"class.std::vector"], [2500 x %"class.std::vector"]* %4, i32 0, i32 0
  %27 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %26, i64 2500
  br label %28

28:                                               ; preds = %28, %25
  %29 = phi %"class.std::vector"* [ %26, %25 ], [ %30, %28 ]
  call void @_ZNSt6vectorISt4pairIS0_IiiEiESaIS2_EEC2Ev(%"class.std::vector"* %29) #3
...
42:                                               ; preds = %38
  ...
  %43 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZStrsIcSt11char_traitsIcESaIcEERSt13basic_istreamIT_T0_ES7_RNSt7__cxx1112basic_stringIS4_S5_T1_EE(%"class.std::basic_istream"* dereferenceable(280) @_ZSt3cin, %"class.std::__cxx11::basic_string"* dereferenceable(32) %9)
          to label %44 unwind label %55

44:                                               ; preds = %42
  %45 = invoke zeroext i1 @_ZStneIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_(%"class.std::__cxx11::basic_string"* dereferenceable(32) %9, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0))
...
47:                                               ; preds = %46
  %48 = invoke zeroext i1 @_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_(%"class.std::__cxx11::basic_string"* dereferenceable(32) %9, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
...
50:                                               ; preds = %49
  %51 = getelementptr inbounds [2500 x %"class.std::vector"], [2500 x %"class.std::vector"]* %4, i64 0, i64 0
  invoke void @_ZNSt4pairIiiEC2IRiS2_Lb1EEEOT_OT0_(%"struct.std::pair"* %11, i32* dereferenceable(4) %7, i32* dereferenceable(4) %8)
          to label %52 unwind label %55

52:                                               ; preds = %50
  store i32 0, i32* %12, align 4
  invoke void @_ZNSt4pairIS_IiiEiEC2IS0_iLb1EEEOT_OT0_(%"struct.std::pair.0"* %10, %"struct.std::pair"* dereferenceable(8) %11, i32* dereferenceable(4) %12)
          to label %53 unwind label %55

53:                                               ; preds = %52
  invoke void @_ZNSt6vectorISt4pairIS0_IiiEiESaIS2_EE9push_backEOS2_(%"class.std::vector"* %51, %"struct.std::pair.0"* dereferenceable(12) %10)
          to label %54 unwind label %55

54:                                               ; preds = %53
  br label %77

55:                                               ; preds = %72, %71, %70, %65, %62, %59, %53, %52, %50, %47, %44, %42
...
59:                                               ; preds = %49
  %60 = invoke zeroext i1 @_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_(%"class.std::__cxx11::basic_string"* dereferenceable(32) %9, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0))
...
62:                                               ; preds = %61
  invoke void @_ZNSt4pairIiiEC2IRiS2_Lb1EEEOT_OT0_(%"struct.std::pair"* %13, i32* dereferenceable(4) %7, i32* dereferenceable(4) %8)
          to label %63 unwind label %55

63:                                               ; preds = %62
  %64 = call dereferenceable(8) %"struct.std::pair"* @_ZNSt4pairIiiEaSEOS0_(%"struct.std::pair"* %3, %"struct.std::pair"* dereferenceable(8) %13) #3
  br label %76

65:                                               ; preds = %61
  %66 = call i8* @_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE5c_strEv(%"class.std::__cxx11::basic_string"* %9) #3
  %67 = call i32 @atoi(i8* %66) #15
  store i32 %67, i32* %6, align 4
  %68 = sext i32 %67 to i64
  %69 = getelementptr inbounds [2500 x %"class.std::vector"], [2500 x %"class.std::vector"]* %4, i64 0, i64 %68
  invoke void @_ZNSt4pairIiiEC2IRiS2_Lb1EEEOT_OT0_(%"struct.std::pair"* %15, i32* dereferenceable(4) %7, i32* dereferenceable(4) %8)
          to label %70 unwind label %55

70:                                               ; preds = %65
  invoke void @_ZNSt4pairIS_IiiEiEC2IS0_Lb1EEEOT_RKi(%"struct.std::pair.0"* %14, %"struct.std::pair"* dereferenceable(8) %15, i32* dereferenceable(4) @_ZL3INF)
          to label %71 unwind label %55

71:                                               ; preds = %70
  invoke void @_ZNSt6vectorISt4pairIS0_IiiEiESaIS2_EE9push_backEOS2_(%"class.std::vector"* %69, %"struct.std::pair.0"* dereferenceable(12) %14)
...
86:                                               ; preds = %33
  ...
  %90 = getelementptr inbounds [2500 x %"class.std::vector"], [2500 x %"class.std::vector"]* %4, i64 0, i64 %89
  invoke void @_ZNSt4pairIS_IiiEiEC2IRS0_Lb1EEEOT_RKi(%"struct.std::pair.0"* %16, %"struct.std::pair"* dereferenceable(8) %3, i32* dereferenceable(4) @_ZL3INF)
          to label %91 unwind label %158

91:                                               ; preds = %86
  invoke void @_ZNSt6vectorISt4pairIS0_IiiEiESaIS2_EE9push_backEOS2_(%"class.std::vector"* %90, %"struct.std::pair.0"* dereferenceable(12) %16)
...
93:                                               ; preds = %166, %92
  %.03 = phi i32 [ 1, %92 ], [ %167, %166 ]
  %94 = load i32, i32* %5, align 4
  %95 = icmp sle i32 %.03, %94
  br i1 %95, label %96, label %168

96:                                               ; preds = %93
  %97 = sext i32 %.03 to i64
  %98 = getelementptr inbounds [2500 x %"class.std::vector"], [2500 x %"class.std::vector"]* %4, i64 0, i64 %97
  %99 = call i64 @_ZNKSt6vectorISt4pairIS0_IiiEiESaIS2_EE4sizeEv(%"class.std::vector"* %98) #3
  %100 = sub i64 %99, 1
  %101 = trunc i64 %100 to i32
  br label %102

102:                                              ; preds = %163, %96
  %.04 = phi i32 [ %101, %96 ], [ %164, %163 ]
  %103 = icmp sge i32 %.04, 0
  br i1 %103, label %104, label %165

104:                                              ; preds = %102
  %105 = sub nsw i32 %.03, 1
  %106 = sext i32 %105 to i64
  %107 = getelementptr inbounds [2500 x %"class.std::vector"], [2500 x %"class.std::vector"]* %4, i64 0, i64 %106
  %108 = call i64 @_ZNKSt6vectorISt4pairIS0_IiiEiESaIS2_EE4sizeEv(%"class.std::vector"* %107) #3
  %109 = sub i64 %108, 1
  %110 = trunc i64 %109 to i32
  br label %111

111:                                              ; preds = %156, %104
  %.0 = phi i32 [ %110, %104 ], [ %157, %156 ]
  %112 = icmp sge i32 %.0, 0
  br i1 %112, label %113, label %162

113:                                              ; preds = %111
  %114 = sext i32 %.03 to i64
  %115 = getelementptr inbounds [2500 x %"class.std::vector"], [2500 x %"class.std::vector"]* %4, i64 0, i64 %114
  %116 = sext i32 %.04 to i64
  %117 = call dereferenceable(12) %"struct.std::pair.0"* @_ZNSt6vectorISt4pairIS0_IiiEiESaIS2_EEixEm(%"class.std::vector"* %115, i64 %116) #3
  %118 = getelementptr inbounds %"struct.std::pair.0", %"struct.std::pair.0"* %117, i32 0, i32 1
  %119 = sub nsw i32 %.03, 1
  %120 = sext i32 %119 to i64
  %121 = getelementptr inbounds [2500 x %"class.std::vector"], [2500 x %"class.std::vector"]* %4, i64 0, i64 %120
  %122 = sext i32 %.0 to i64
  %123 = call dereferenceable(12) %"struct.std::pair.0"* @_ZNSt6vectorISt4pairIS0_IiiEiESaIS2_EEixEm(%"class.std::vector"* %121, i64 %122) #3
  %124 = getelementptr inbounds %"struct.std::pair.0", %"struct.std::pair.0"* %123, i32 0, i32 1
  %125 = load i32, i32* %124, align 4
  %126 = sub nsw i32 %.03, 1
  %127 = sext i32 %126 to i64
  %128 = getelementptr inbounds [2500 x %"class.std::vector"], [2500 x %"class.std::vector"]* %4, i64 0, i64 %127
  %129 = sext i32 %.0 to i64
  %130 = call dereferenceable(12) %"struct.std::pair.0"* @_ZNSt6vectorISt4pairIS0_IiiEiESaIS2_EEixEm(%"class.std::vector"* %128, i64 %129) #3
  ...
  %135 = getelementptr inbounds [2500 x %"class.std::vector"], [2500 x %"class.std::vector"]* %4, i64 0, i64 %134
  %136 = sext i32 %.04 to i64
  %137 = call dereferenceable(12) %"struct.std::pair.0"* @_ZNSt6vectorISt4pairIS0_IiiEiESaIS2_EEixEm(%"class.std::vector"* %135, i64 %136) #3
  ...
  %141 = bitcast %"struct.std::pair"* %18 to i64*
  %142 = load i64, i64* %141, align 4
  %143 = bitcast %"struct.std::pair"* %19 to i64*
  %144 = load i64, i64* %143, align 4
  %145 = invoke i32 @_Z4distSt4pairIiiES0_(i64 %142, i64 %144)
          to label %146 unwind label %158

146:                                              ; preds = %113
  %147 = add nsw i32 %125, %145
  store i32 %147, i32* %17, align 4
  %148 = invoke dereferenceable(4) i32* @_ZSt3minIiERKT_S2_S2_(i32* dereferenceable(4) %118, i32* dereferenceable(4) %17)
          to label %149 unwind label %158

149:                                              ; preds = %146
  %150 = load i32, i32* %148, align 4
  %151 = sext i32 %.03 to i64
  %152 = getelementptr inbounds [2500 x %"class.std::vector"], [2500 x %"class.std::vector"]* %4, i64 0, i64 %151
  %153 = sext i32 %.04 to i64
  %154 = call dereferenceable(12) %"struct.std::pair.0"* @_ZNSt6vectorISt4pairIS0_IiiEiESaIS2_EEixEm(%"class.std::vector"* %152, i64 %153) #3
...
158:                                              ; preds = %176, %168, %146, %113, %91, %86
...
168:                                              ; preds = %93
  ...
  %171 = getelementptr inbounds [2500 x %"class.std::vector"], [2500 x %"class.std::vector"]* %4, i64 0, i64 %170
  %172 = call dereferenceable(12) %"struct.std::pair.0"* @_ZNSt6vectorISt4pairIS0_IiiEiESaIS2_EEixEm(%"class.std::vector"* %171, i64 0) #3
...
178:                                              ; preds = %176
  %179 = getelementptr inbounds [2500 x %"class.std::vector"], [2500 x %"class.std::vector"]* %4, i32 0, i32 0
  %180 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %179, i64 2500
  br label %181

181:                                              ; preds = %181, %178
  %182 = phi %"class.std::vector"* [ %180, %178 ], [ %183, %181 ]
  %183 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %182, i64 -1
  call void @_ZNSt6vectorISt4pairIS0_IiiEiESaIS2_EED2Ev(%"class.std::vector"* %183) #3
...
186:                                              ; preds = %158, %55
  %.02 = phi i32 [ %58, %55 ], [ %161, %158 ]
  %.01 = phi i8* [ %57, %55 ], [ %160, %158 ]
  %187 = getelementptr inbounds [2500 x %"class.std::vector"], [2500 x %"class.std::vector"]* %4, i32 0, i32 0
  %188 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %187, i64 2500
  br label %189

189:                                              ; preds = %189, %186
  %190 = phi %"class.std::vector"* [ %188, %186 ], [ %191, %189 ]
  %191 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %190, i64 -1
  call void @_ZNSt6vectorISt4pairIS0_IiiEiESaIS2_EED2Ev(%"class.std::vector"* %191) #3
...
195:                                              ; preds = %193
  %196 = insertvalue { i8*, i32 } undef, i8* %.01, 0
  %197 = insertvalue { i8*, i32 } %196, i32 %.02, 1
  resume { i8*, i32 } %197
}
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt6vectorISt4pairIS0_IiiEiESaIS2_EE9push_backEOS2_(%"class.std::vector"* %0, %"struct.std::pair.0"* dereferenceable(12) %1) #0 comdat align 2 {
  %3 = call dereferenceable(12) %"struct.std::pair.0"* @_ZSt4moveIRSt4pairIS0_IiiEiEEONSt16remove_referenceIT_E4typeEOS5_(%"struct.std::pair.0"* dereferenceable(12) %1) #3
  call void @_ZNSt6vectorISt4pairIS0_IiiEiESaIS2_EE12emplace_backIJS2_EEEvDpOT_(%"class.std::vector"* %0, %"struct.std::pair.0"* dereferenceable(12) %3)
  ret void
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt4pairIS_IiiEiEC2IS0_iLb1EEEOT_OT0_(%"struct.std::pair.0"* %0, %"struct.std::pair"* dereferenceable(8) %1, i32* dereferenceable(4) %2) unnamed_addr #4 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt4pairIS_IiiEiEC2IS0_Lb1EEEOT_RKi(%"struct.std::pair.0"* %0, %"struct.std::pair"* dereferenceable(8) %1, i32* dereferenceable(4) %2) unnamed_addr #4 comdat align 2 {
  %4 = bitcast %"struct.std::pair.0"* %0 to %"class.std::__pair_base.1"*
  %5 = getelementptr inbounds %"struct.std::pair.0", %"struct.std::pair.0"* %0, i32 0, i32 0
  %6 = call dereferenceable(8) %"struct.std::pair"* @_ZSt7forwardISt4pairIiiEEOT_RNSt16remove_referenceIS2_E4typeE(%"struct.std::pair"* dereferenceable(8) %1) #3
  %7 = bitcast %"struct.std::pair"* %5 to i8*
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt4pairIS_IiiEiEC2IRS0_Lb1EEEOT_RKi(%"struct.std::pair.0"* %0, %"struct.std::pair"* dereferenceable(8) %1, i32* dereferenceable(4) %2) unnamed_addr #4 comdat align 2 {
  %4 = bitcast %"struct.std::pair.0"* %0 to %"class.std::__pair_base.1"*
  %5 = getelementptr inbounds %"struct.std::pair.0", %"struct.std::pair.0"* %0, i32 0, i32 0
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(12) %"struct.std::pair.0"* @_ZNSt6vectorISt4pairIS0_IiiEiESaIS2_EEixEm(%"class.std::vector"* %0, i64 %1) #4 comdat align 2 {
...
define linkonce_odr void @_ZNSt6vectorISt4pairIS0_IiiEiESaIS2_EED2Ev(%"class.std::vector"* %0) unnamed_addr #4 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  invoke void @_ZSt8_DestroyIPSt4pairIS0_IiiEiES2_EvT_S4_RSaIT0_E(%"struct.std::pair.0"* %5, %"struct.std::pair.0"* %9, %"class.std::allocator"* dereferenceable(1) %11)
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZSt8_DestroyIPSt4pairIS0_IiiEiES2_EvT_S4_RSaIT0_E(%"struct.std::pair.0"* %0, %"struct.std::pair.0"* %1, %"class.std::allocator"* dereferenceable(1) %2) #0 comdat {
  call void @_ZSt8_DestroyIPSt4pairIS0_IiiEiEEvT_S4_(%"struct.std::pair.0"* %0, %"struct.std::pair.0"* %1)
  ret void
}
...
define linkonce_odr void @_ZNSt12_Vector_baseISt4pairIS0_IiiEiESaIS2_EED2Ev(%"struct.std::_Vector_base"* %0) unnamed_addr #4 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  invoke void @_ZNSt12_Vector_baseISt4pairIS0_IiiEiESaIS2_EE13_M_deallocateEPS2_m(%"struct.std::_Vector_base"* %0, %"struct.std::pair.0"* %4, i64 %14)
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZSt8_DestroyIPSt4pairIS0_IiiEiEEvT_S4_(%"struct.std::pair.0"* %0, %"struct.std::pair.0"* %1) #0 comdat {
  call void @_ZNSt12_Destroy_auxILb1EE9__destroyIPSt4pairIS2_IiiEiEEEvT_S6_(%"struct.std::pair.0"* %0, %"struct.std::pair.0"* %1)
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt12_Destroy_auxILb1EE9__destroyIPSt4pairIS2_IiiEiEEEvT_S6_(%"struct.std::pair.0"* %0, %"struct.std::pair.0"* %1) #4 comdat align 2 {
  ret void
}

; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt12_Vector_baseISt4pairIS0_IiiEiESaIS2_EE13_M_deallocateEPS2_m(%"struct.std::_Vector_base"* %0, %"struct.std::pair.0"* %1, i64 %2) #0 comdat align 2 {
...
5:                                                ; preds = %3
  ...
  call void @_ZNSt16allocator_traitsISaISt4pairIS0_IiiEiEEE10deallocateERS3_PS2_m(%"class.std::allocator"* dereferenceable(1) %7, %"struct.std::pair.0"* %1, i64 %2)
  br label %8
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt16allocator_traitsISaISt4pairIS0_IiiEiEEE10deallocateERS3_PS2_m(%"class.std::allocator"* dereferenceable(1) %0, %"struct.std::pair.0"* %1, i64 %2) #0 comdat align 2 {
  %4 = bitcast %"class.std::allocator"* %0 to %"class.__gnu_cxx::new_allocator"*
  call void @_ZN9__gnu_cxx13new_allocatorISt4pairIS1_IiiEiEE10deallocateEPS3_m(%"class.__gnu_cxx::new_allocator"* %4, %"struct.std::pair.0"* %1, i64 %2)
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorISt4pairIS1_IiiEiEE10deallocateEPS3_m(%"class.__gnu_cxx::new_allocator"* %0, %"struct.std::pair.0"* %1, i64 %2) #4 comdat align 2 {
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt6vectorISt4pairIS0_IiiEiESaIS2_EE12emplace_backIJS2_EEEvDpOT_(%"class.std::vector"* %0, %"struct.std::pair.0"* dereferenceable(12) %1) #0 comdat align 2 {
...
13:                                               ; preds = %2
  ...
  %21 = call dereferenceable(12) %"struct.std::pair.0"* @_ZSt7forwardISt4pairIS0_IiiEiEEOT_RNSt16remove_referenceIS3_E4typeE(%"struct.std::pair.0"* dereferenceable(12) %1) #3
  call void @_ZNSt16allocator_traitsISaISt4pairIS0_IiiEiEEE9constructIS2_JS2_EEEvRS3_PT_DpOT0_(%"class.std::allocator"* dereferenceable(1) %16, %"struct.std::pair.0"* %20, %"struct.std::pair.0"* dereferenceable(12) %21)
...
27:                                               ; preds = %2
  %28 = call %"struct.std::pair.0"* @_ZNSt6vectorISt4pairIS0_IiiEiESaIS2_EE3endEv(%"class.std::vector"* %0) #3
  %29 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %3, i32 0, i32 0
  store %"struct.std::pair.0"* %28, %"struct.std::pair.0"** %29, align 8
  %30 = call dereferenceable(12) %"struct.std::pair.0"* @_ZSt7forwardISt4pairIS0_IiiEiEEOT_RNSt16remove_referenceIS3_E4typeE(%"struct.std::pair.0"* dereferenceable(12) %1) #3
  %31 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %3, i32 0, i32 0
  %32 = load %"struct.std::pair.0"*, %"struct.std::pair.0"** %31, align 8
  call void @_ZNSt6vectorISt4pairIS0_IiiEiESaIS2_EE17_M_realloc_insertIJS2_EEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_(%"class.std::vector"* %0, %"struct.std::pair.0"* %32, %"struct.std::pair.0"* dereferenceable(12) %30)
  br label %33
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(12) %"struct.std::pair.0"* @_ZSt4moveIRSt4pairIS0_IiiEiEEONSt16remove_referenceIT_E4typeEOS5_(%"struct.std::pair.0"* dereferenceable(12) %0) #4 comdat {
  ret %"struct.std::pair.0"* %0
}

; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt16allocator_traitsISaISt4pairIS0_IiiEiEEE9constructIS2_JS2_EEEvRS3_PT_DpOT0_(%"class.std::allocator"* dereferenceable(1) %0, %"struct.std::pair.0"* %1, %"struct.std::pair.0"* dereferenceable(12) %2) #0 comdat align 2 {
  %4 = bitcast %"class.std::allocator"* %0 to %"class.__gnu_cxx::new_allocator"*
  %5 = call dereferenceable(12) %"struct.std::pair.0"* @_ZSt7forwardISt4pairIS0_IiiEiEEOT_RNSt16remove_referenceIS3_E4typeE(%"struct.std::pair.0"* dereferenceable(12) %2) #3
  call void @_ZN9__gnu_cxx13new_allocatorISt4pairIS1_IiiEiEE9constructIS3_JS3_EEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator"* %4, %"struct.std::pair.0"* %1, %"struct.std::pair.0"* dereferenceable(12) %5)
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(12) %"struct.std::pair.0"* @_ZSt7forwardISt4pairIS0_IiiEiEEOT_RNSt16remove_referenceIS3_E4typeE(%"struct.std::pair.0"* dereferenceable(12) %0) #4 comdat {
  ret %"struct.std::pair.0"* %0
}

; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt6vectorISt4pairIS0_IiiEiESaIS2_EE17_M_realloc_insertIJS2_EEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_(%"class.std::vector"* %0, %"struct.std::pair.0"* %1, %"struct.std::pair.0"* dereferenceable(12) %2) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %4 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %5 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %6 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %4, i32 0, i32 0
  store %"struct.std::pair.0"* %1, %"struct.std::pair.0"** %6, align 8
  %7 = call i64 @_ZNKSt6vectorISt4pairIS0_IiiEiESaIS2_EE12_M_check_lenEmPKc(%"class.std::vector"* %0, i64 1, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.3, i32 0, i32 0))
  %8 = bitcast %"class.std::vector"* %0 to %"struct.std::_Vector_base"*
  %9 = getelementptr inbounds %"struct.std::_Vector_base", %"struct.std::_Vector_base"* %8, i32 0, i32 0
  ...
  %16 = call %"struct.std::pair.0"* @_ZNSt6vectorISt4pairIS0_IiiEiESaIS2_EE5beginEv(%"class.std::vector"* %0) #3
  ...
  %20 = call %"struct.std::pair.0"* @_ZNSt12_Vector_baseISt4pairIS0_IiiEiESaIS2_EE11_M_allocateEm(%"struct.std::_Vector_base"* %19, i64 %7)
  ...
  %25 = call dereferenceable(12) %"struct.std::pair.0"* @_ZSt7forwardISt4pairIS0_IiiEiEEOT_RNSt16remove_referenceIS3_E4typeE(%"struct.std::pair.0"* dereferenceable(12) %2) #3
  invoke void @_ZNSt16allocator_traitsISaISt4pairIS0_IiiEiEEE9constructIS2_JS2_EEEvRS3_PT_DpOT0_(%"class.std::allocator"* dereferenceable(1) %23, %"struct.std::pair.0"* %24, %"struct.std::pair.0"* dereferenceable(12) %25)
          to label %26 unwind label %40

26:                                               ; preds = %3
  %27 = call dereferenceable(8) %"struct.std::pair.0"** @_ZNK9__gnu_cxx17__normal_iteratorIPSt4pairIS1_IiiEiESt6vectorIS3_SaIS3_EEE4baseEv(%"class.__gnu_cxx::__normal_iterator"* %4) #3
  ...
  %31 = invoke %"struct.std::pair.0"* @_ZSt34__uninitialized_move_if_noexcept_aIPSt4pairIS0_IiiEiES3_SaIS2_EET0_T_S6_S5_RT1_(%"struct.std::pair.0"* %11, %"struct.std::pair.0"* %28, %"struct.std::pair.0"* %20, %"class.std::allocator"* dereferenceable(1) %30)
          to label %32 unwind label %40

32:                                               ; preds = %26
  %33 = getelementptr inbounds %"struct.std::pair.0", %"struct.std::pair.0"* %31, i32 1
  %34 = call dereferenceable(8) %"struct.std::pair.0"** @_ZNK9__gnu_cxx17__normal_iteratorIPSt4pairIS1_IiiEiESt6vectorIS3_SaIS3_EEE4baseEv(%"class.__gnu_cxx::__normal_iterator"* %4) #3
  ...
  %38 = invoke %"struct.std::pair.0"* @_ZSt34__uninitialized_move_if_noexcept_aIPSt4pairIS0_IiiEiES3_SaIS2_EET0_T_S6_S5_RT1_(%"struct.std::pair.0"* %35, %"struct.std::pair.0"* %15, %"struct.std::pair.0"* %33, %"class.std::allocator"* dereferenceable(1) %37)
...
47:                                               ; preds = %44
  ...
  invoke void @_ZNSt16allocator_traitsISaISt4pairIS0_IiiEiEEE7destroyIS2_EEvRS3_PT_(%"class.std::allocator"* dereferenceable(1) %50, %"struct.std::pair.0"* %51)
...
57:                                               ; preds = %44
  ...
  invoke void @_ZSt8_DestroyIPSt4pairIS0_IiiEiES2_EvT_S4_RSaIT0_E(%"struct.std::pair.0"* %20, %"struct.std::pair.0"* %.0, %"class.std::allocator"* dereferenceable(1) %59)
...
61:                                               ; preds = %60, %52
  ...
  invoke void @_ZNSt12_Vector_baseISt4pairIS0_IiiEiESaIS2_EE13_M_deallocateEPS2_m(%"struct.std::_Vector_base"* %62, %"struct.std::pair.0"* %20, i64 %7)
...
65:                                               ; preds = %39
  ...
  call void @_ZSt8_DestroyIPSt4pairIS0_IiiEiES2_EvT_S4_RSaIT0_E(%"struct.std::pair.0"* %11, %"struct.std::pair.0"* %15, %"class.std::allocator"* dereferenceable(1) %67)
  ...
  call void @_ZNSt12_Vector_baseISt4pairIS0_IiiEiESaIS2_EE13_M_deallocateEPS2_m(%"struct.std::_Vector_base"* %68, %"struct.std::pair.0"* %11, i64 %76)
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr %"struct.std::pair.0"* @_ZNSt6vectorISt4pairIS0_IiiEiESaIS2_EE3endEv(%"class.std::vector"* %0) #4 comdat align 2 {
  ...
  call void @_ZN9__gnu_cxx17__normal_iteratorIPSt4pairIS1_IiiEiESt6vectorIS3_SaIS3_EEEC2ERKS4_(%"class.__gnu_cxx::__normal_iterator"* %2, %"struct.std::pair.0"** dereferenceable(8) %5) #3
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorISt4pairIS1_IiiEiEE9constructIS3_JS3_EEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator"* %0, %"struct.std::pair.0"* %1, %"struct.std::pair.0"* dereferenceable(12) %2) #4 comdat align 2 {
  %4 = bitcast %"struct.std::pair.0"* %1 to i8*
  %5 = bitcast i8* %4 to %"struct.std::pair.0"*
  %6 = call dereferenceable(12) %"struct.std::pair.0"* @_ZSt7forwardISt4pairIS0_IiiEiEEOT_RNSt16remove_referenceIS3_E4typeE(%"struct.std::pair.0"* dereferenceable(12) %2) #3
...
define linkonce_odr i64 @_ZN9__gnu_cxxmiIPSt4pairIS1_IiiEiESt6vectorIS3_SaIS3_EEEENS_17__normal_iteratorIT_T0_E15difference_typeERKSB_SE_(%"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %0, %"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %1) #4 comdat {
  %3 = call dereferenceable(8) %"struct.std::pair.0"** @_ZNK9__gnu_cxx17__normal_iteratorIPSt4pairIS1_IiiEiESt6vectorIS3_SaIS3_EEE4baseEv(%"class.__gnu_cxx::__normal_iterator"* %0) #3
  %4 = load %"struct.std::pair.0"*, %"struct.std::pair.0"** %3, align 8
  %5 = call dereferenceable(8) %"struct.std::pair.0"** @_ZNK9__gnu_cxx17__normal_iteratorIPSt4pairIS1_IiiEiESt6vectorIS3_SaIS3_EEE4baseEv(%"class.__gnu_cxx::__normal_iterator"* %1) #3
  %6 = load %"struct.std::pair.0"*, %"struct.std::pair.0"** %5, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr %"struct.std::pair.0"* @_ZNSt6vectorISt4pairIS0_IiiEiESaIS2_EE5beginEv(%"class.std::vector"* %0) #4 comdat align 2 {
  %2 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %3 = bitcast %"class.std::vector"* %0 to %"struct.std::_Vector_base"*
  %4 = getelementptr inbounds %"struct.std::_Vector_base", %"struct.std::_Vector_base"* %3, i32 0, i32 0
  %5 = getelementptr inbounds %"struct.std::_Vector_base<std::pair<std::pair<int, int>, int>, std::allocator<std::pair<std::pair<int, int>, int> > >::_Vector_impl", %"struct.std::_Vector_base<std::pair<std::pair<int, int>, int>, std::allocator<std::pair<std::pair<int, int>, int> > >::_Vector_impl"* %4, i32 0, i32 0
...
; Function Attrs: noinline uwtable
define linkonce_odr %"struct.std::pair.0"* @_ZNSt12_Vector_baseISt4pairIS0_IiiEiESaIS2_EE11_M_allocateEm(%"struct.std::_Vector_base"* %0, i64 %1) #0 comdat align 2 {
  %3 = icmp ne i64 %1, 0
...
4:                                                ; preds = %2
  ...
  %7 = call %"struct.std::pair.0"* @_ZNSt16allocator_traitsISaISt4pairIS0_IiiEiEEE8allocateERS3_m(%"class.std::allocator"* dereferenceable(1) %6, i64 %1)
  br label %9
...
; Function Attrs: noinline uwtable
define linkonce_odr %"struct.std::pair.0"* @_ZSt34__uninitialized_move_if_noexcept_aIPSt4pairIS0_IiiEiES3_SaIS2_EET0_T_S6_S5_RT1_(%"struct.std::pair.0"* %0, %"struct.std::pair.0"* %1, %"struct.std::pair.0"* %2, %"class.std::allocator"* dereferenceable(1) %3) #0 comdat {
  %5 = alloca %"class.std::move_iterator", align 8
  %6 = alloca %"class.std::move_iterator", align 8
  %7 = call %"struct.std::pair.0"* @_ZSt32__make_move_if_noexcept_iteratorISt4pairIS0_IiiEiESt13move_iteratorIPS2_EET0_PT_(%"struct.std::pair.0"* %0)
  %8 = getelementptr inbounds %"class.std::move_iterator", %"class.std::move_iterator"* %5, i32 0, i32 0
  store %"struct.std::pair.0"* %7, %"struct.std::pair.0"** %8, align 8
  %9 = call %"struct.std::pair.0"* @_ZSt32__make_move_if_noexcept_iteratorISt4pairIS0_IiiEiESt13move_iteratorIPS2_EET0_PT_(%"struct.std::pair.0"* %1)
  ...
  %15 = call %"struct.std::pair.0"* @_ZSt22__uninitialized_copy_aISt13move_iteratorIPSt4pairIS1_IiiEiEES4_S3_ET0_T_S7_S6_RSaIT1_E(%"struct.std::pair.0"* %12, %"struct.std::pair.0"* %14, %"struct.std::pair.0"* %2, %"class.std::allocator"* dereferenceable(1) %3)
  ret %"struct.std::pair.0"* %15
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(8) %"struct.std::pair.0"** @_ZNK9__gnu_cxx17__normal_iteratorIPSt4pairIS1_IiiEiESt6vectorIS3_SaIS3_EEE4baseEv(%"class.__gnu_cxx::__normal_iterator"* %0) #4 comdat align 2 {
  %2 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %0, i32 0, i32 0
  ret %"struct.std::pair.0"** %2
}

; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt16allocator_traitsISaISt4pairIS0_IiiEiEEE7destroyIS2_EEvRS3_PT_(%"class.std::allocator"* dereferenceable(1) %0, %"struct.std::pair.0"* %1) #0 comdat align 2 {
  %3 = bitcast %"class.std::allocator"* %0 to %"class.__gnu_cxx::new_allocator"*
  call void @_ZN9__gnu_cxx13new_allocatorISt4pairIS1_IiiEiEE7destroyIS3_EEvPT_(%"class.__gnu_cxx::new_allocator"* %3, %"struct.std::pair.0"* %1)
  ret void
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx17__normal_iteratorIPSt4pairIS1_IiiEiESt6vectorIS3_SaIS3_EEEC2ERKS4_(%"class.__gnu_cxx::__normal_iterator"* %0, %"struct.std::pair.0"** dereferenceable(8) %1) unnamed_addr #4 comdat align 2 {
...
; Function Attrs: noinline uwtable
define linkonce_odr %"struct.std::pair.0"* @_ZNSt16allocator_traitsISaISt4pairIS0_IiiEiEEE8allocateERS3_m(%"class.std::allocator"* dereferenceable(1) %0, i64 %1) #0 comdat align 2 {
  %3 = bitcast %"class.std::allocator"* %0 to %"class.__gnu_cxx::new_allocator"*
  %4 = call %"struct.std::pair.0"* @_ZN9__gnu_cxx13new_allocatorISt4pairIS1_IiiEiEE8allocateEmPKv(%"class.__gnu_cxx::new_allocator"* %3, i64 %1, i8* null)
  ret %"struct.std::pair.0"* %4
}

; Function Attrs: noinline uwtable
define linkonce_odr %"struct.std::pair.0"* @_ZN9__gnu_cxx13new_allocatorISt4pairIS1_IiiEiEE8allocateEmPKv(%"class.__gnu_cxx::new_allocator"* %0, i64 %1, i8* %2) #0 comdat align 2 {
...
; Function Attrs: noinline uwtable
define linkonce_odr %"struct.std::pair.0"* @_ZSt22__uninitialized_copy_aISt13move_iteratorIPSt4pairIS1_IiiEiEES4_S3_ET0_T_S7_S6_RSaIT1_E(%"struct.std::pair.0"* %0, %"struct.std::pair.0"* %1, %"struct.std::pair.0"* %2, %"class.std::allocator"* dereferenceable(1) %3) #0 comdat {
  %5 = alloca %"class.std::move_iterator", align 8
  %6 = alloca %"class.std::move_iterator", align 8
  ...
  %19 = call %"struct.std::pair.0"* @_ZSt18uninitialized_copyISt13move_iteratorIPSt4pairIS1_IiiEiEES4_ET0_T_S7_S6_(%"struct.std::pair.0"* %16, %"struct.std::pair.0"* %18, %"struct.std::pair.0"* %2)
  ret %"struct.std::pair.0"* %19
}

; Function Attrs: noinline uwtable
define linkonce_odr %"struct.std::pair.0"* @_ZSt32__make_move_if_noexcept_iteratorISt4pairIS0_IiiEiESt13move_iteratorIPS2_EET0_PT_(%"struct.std::pair.0"* %0) #0 comdat {
  %2 = alloca %"class.std::move_iterator", align 8
  call void @_ZNSt13move_iteratorIPSt4pairIS0_IiiEiEEC2ES3_(%"class.std::move_iterator"* %2, %"struct.std::pair.0"* %0)
...
; Function Attrs: noinline uwtable
define linkonce_odr %"struct.std::pair.0"* @_ZSt18uninitialized_copyISt13move_iteratorIPSt4pairIS1_IiiEiEES4_ET0_T_S7_S6_(%"struct.std::pair.0"* %0, %"struct.std::pair.0"* %1, %"struct.std::pair.0"* %2) #0 comdat {
  ...
  %18 = call %"struct.std::pair.0"* @_ZNSt20__uninitialized_copyILb0EE13__uninit_copyISt13move_iteratorIPSt4pairIS3_IiiEiEES6_EET0_T_S9_S8_(%"struct.std::pair.0"* %15, %"struct.std::pair.0"* %17, %"struct.std::pair.0"* %2)
  ret %"struct.std::pair.0"* %18
}

; Function Attrs: noinline uwtable
define linkonce_odr %"struct.std::pair.0"* @_ZNSt20__uninitialized_copyILb0EE13__uninit_copyISt13move_iteratorIPSt4pairIS3_IiiEiEES6_EET0_T_S9_S8_(%"struct.std::pair.0"* %0, %"struct.std::pair.0"* %1, %"struct.std::pair.0"* %2) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %4 = alloca %"class.std::move_iterator", align 8
  %5 = alloca %"class.std::move_iterator", align 8
...
11:                                               ; preds = %10
  %12 = call %"struct.std::pair.0"* @_ZSt11__addressofISt4pairIS0_IiiEiEEPT_RS3_(%"struct.std::pair.0"* dereferenceable(12) %.0) #3
  %13 = invoke dereferenceable(12) %"struct.std::pair.0"* @_ZNKSt13move_iteratorIPSt4pairIS0_IiiEiEEdeEv(%"class.std::move_iterator"* %4)
          to label %14 unwind label %20

14:                                               ; preds = %11
  invoke void @_ZSt10_ConstructISt4pairIS0_IiiEiEJS2_EEvPT_DpOT0_(%"struct.std::pair.0"* %12, %"struct.std::pair.0"* dereferenceable(12) %13)
...
24:                                               ; preds = %20
  ...
  invoke void @_ZSt8_DestroyIPSt4pairIS0_IiiEiEEvT_S4_(%"struct.std::pair.0"* %2, %"struct.std::pair.0"* %.0)
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZSt10_ConstructISt4pairIS0_IiiEiEJS2_EEvPT_DpOT0_(%"struct.std::pair.0"* %0, %"struct.std::pair.0"* dereferenceable(12) %1) #4 comdat {
  %3 = bitcast %"struct.std::pair.0"* %0 to i8*
  %4 = bitcast i8* %3 to %"struct.std::pair.0"*
  %5 = call dereferenceable(12) %"struct.std::pair.0"* @_ZSt7forwardISt4pairIS0_IiiEiEEOT_RNSt16remove_referenceIS3_E4typeE(%"struct.std::pair.0"* dereferenceable(12) %1) #3
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr %"struct.std::pair.0"* @_ZSt11__addressofISt4pairIS0_IiiEiEEPT_RS3_(%"struct.std::pair.0"* dereferenceable(12) %0) #4 comdat {
  ret %"struct.std::pair.0"* %0
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(12) %"struct.std::pair.0"* @_ZNKSt13move_iteratorIPSt4pairIS0_IiiEiEEdeEv(%"class.std::move_iterator"* %0) #4 comdat align 2 {
...
define linkonce_odr zeroext i1 @_ZSteqIPSt4pairIS0_IiiEiEEbRKSt13move_iteratorIT_ES8_(%"class.std::move_iterator"* dereferenceable(8) %0, %"class.std::move_iterator"* dereferenceable(8) %1) #0 comdat {
  %3 = call %"struct.std::pair.0"* @_ZNKSt13move_iteratorIPSt4pairIS0_IiiEiEE4baseEv(%"class.std::move_iterator"* %0)
  %4 = call %"struct.std::pair.0"* @_ZNKSt13move_iteratorIPSt4pairIS0_IiiEiEE4baseEv(%"class.std::move_iterator"* %1)
  %5 = icmp eq %"struct.std::pair.0"* %3, %4
  ret i1 %5
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr %"struct.std::pair.0"* @_ZNKSt13move_iteratorIPSt4pairIS0_IiiEiEE4baseEv(%"class.std::move_iterator"* %0) #4 comdat align 2 {
  %2 = getelementptr inbounds %"class.std::move_iterator", %"class.std::move_iterator"* %0, i32 0, i32 0
  %3 = load %"struct.std::pair.0"*, %"struct.std::pair.0"** %2, align 8
  ret %"struct.std::pair.0"* %3
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt13move_iteratorIPSt4pairIS0_IiiEiEEC2ES3_(%"class.std::move_iterator"* %0, %"struct.std::pair.0"* %1) unnamed_addr #4 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorISt4pairIS1_IiiEiEE7destroyIS3_EEvPT_(%"class.__gnu_cxx::new_allocator"* %0, %"struct.std::pair.0"* %1) #4 comdat align 2 {
  ret void
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s561298281.cpp() #0 section ".text.startup" {
