; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00014/s872558902.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00014/s872558902.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s872558902.cpp, i8* null }]
...
33:                                               ; preds = %44, %27
  %.02 = phi i32 [ 0, %27 ], [ %43, %44 ]
  %.0 = phi i32 [ 0, %27 ], [ %45, %44 ]
  %34 = icmp slt i32 %.0, %32
...
46:                                               ; preds = %33
  %47 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %.02)
...
54:                                               ; preds = %18
  %55 = insertvalue { i8*, i32 } undef, i8* %20, 0
  %56 = insertvalue { i8*, i32 } %55, i32 %21, 1
  resume { i8*, i32 } %56
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s872558902.cpp() #0 section ".text.startup" {
