; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03820/s737480905.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03820/s737480905.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s737480905.cpp, i8* null }]
...
25:                                               ; preds = %22
  ...
  call void @_Z6reduceRi(i32* dereferenceable(4) %32)
  br label %35
...
define linkonce_odr void @_Z6reduceRi(i32* dereferenceable(4) %0) #5 comdat {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s737480905.cpp() #0 section ".text.startup" {
