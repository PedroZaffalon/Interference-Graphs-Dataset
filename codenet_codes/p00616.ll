; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00616/s398008126.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00616/s398008126.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s398008126.cpp, i8* null }]
...
define void @_Z5checkiiiPiRi(i32 %0, i32 %1, i32 %2, i32* %3, i32* dereferenceable(4) %4) #4 {
  br label %6
...
9:                                                ; preds = %6
  ...
  %13 = mul nsw i32 %0, 1000000
  %14 = mul nsw i32 %1, 1000
...
24:                                               ; preds = %22
  %25 = mul nsw i32 %0, 1000000
  %26 = mul nsw i32 %1, 1000
...
24:                                               ; preds = %20
  ...
  %25 = bitcast [100000 x i32]* %4 to i8*
...
37:                                               ; preds = %73, %36
  %.0 = phi i32 [ 0, %36 ], [ %74, %73 ]
  %38 = load i32, i32* %1, align 4
  %39 = icmp slt i32 %.0, %38
  br i1 %39, label %40, label %75

40:                                               ; preds = %37
  %41 = invoke zeroext i1 @_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_(%"class.std::__cxx11::basic_string"* dereferenceable(32) %7, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0))
...
43:                                               ; preds = %42
  ...
  %47 = sub nsw i32 %46, 1
  %48 = getelementptr inbounds [100000 x i32], [100000 x i32]* %4, i32 0, i32 0
  invoke void @_Z5checkiiiPiRi(i32 %45, i32 %47, i32 %.0, i32* %48, i32* dereferenceable(4) %3)
          to label %49 unwind label %50

49:                                               ; preds = %43
  br label %72

50:                                               ; preds = %64, %57, %54, %43, %40, %34, %32, %30
...
54:                                               ; preds = %42
  %55 = invoke zeroext i1 @_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_(%"class.std::__cxx11::basic_string"* dereferenceable(32) %7, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i32 0, i32 0))
...
57:                                               ; preds = %56
  ...
  %61 = sub nsw i32 %60, 1
  %62 = getelementptr inbounds [100000 x i32], [100000 x i32]* %4, i32 0, i32 0
  invoke void @_Z5checkiiiPiRi(i32 %59, i32 %.0, i32 %61, i32* %62, i32* dereferenceable(4) %3)
...
64:                                               ; preds = %56
  ...
  %68 = sub nsw i32 %67, 1
  %69 = getelementptr inbounds [100000 x i32], [100000 x i32]* %4, i32 0, i32 0
  invoke void @_Z5checkiiiPiRi(i32 %.0, i32 %66, i32 %68, i32* %69, i32* dereferenceable(4) %3)
...
87:                                               ; preds = %50
  %88 = insertvalue { i8*, i32 } undef, i8* %52, 0
  %89 = insertvalue { i8*, i32 } %88, i32 %53, 1
  resume { i8*, i32 } %89
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s398008126.cpp() #0 section ".text.startup" {
