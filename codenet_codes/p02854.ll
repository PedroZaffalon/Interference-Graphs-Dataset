; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02854/s800944121.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02854/s800944121.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s800944121.cpp, i8* null }]
...
define i32 @main() #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  invoke void @_ZNSt6vectorIlSaIlEEC2EmRKS0_(%"class.std::vector"* %2, i64 %7, %"class.std::allocator"* dereferenceable(1) %3)
...
13:                                               ; preds = %9
  ...
  %15 = call dereferenceable(8) i64* @_ZNSt6vectorIlSaIlEEixEm(%"class.std::vector"* %2, i64 %14) #3
  %16 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERl(%"class.std::basic_istream"* @_ZSt3cin, i64* dereferenceable(8) %15)
          to label %17 unwind label %28

17:                                               ; preds = %13
  %18 = sext i32 %.011 to i64
  %19 = call dereferenceable(8) i64* @_ZNSt6vectorIlSaIlEEixEm(%"class.std::vector"* %2, i64 %18) #3
  %20 = load i64, i64* %19, align 8
  %21 = add nsw i64 %.05, %20
  br label %22

22:                                               ; preds = %17
  %23 = add nsw i32 %.011, 1
  br label %9
...
33:                                               ; preds = %51, %32
  %.012 = phi i32 [ 0, %32 ], [ %52, %51 ]
  %.06 = phi i64 [ 0, %32 ], [ %41, %51 ]
...
37:                                               ; preds = %33
  ...
  %39 = call dereferenceable(8) i64* @_ZNSt6vectorIlSaIlEEixEm(%"class.std::vector"* %2, i64 %38) #3
...
44:                                               ; preds = %37
  ...
  %46 = call dereferenceable(8) i64* @_ZNSt6vectorIlSaIlEEixEm(%"class.std::vector"* %2, i64 %45) #3
...
53:                                               ; preds = %44, %33
  %.08 = phi i64 [ %41, %44 ], [ undef, %33 ]
  %.17 = phi i64 [ %48, %44 ], [ %.06, %33 ]
  %.04 = phi i64 [ %49, %44 ], [ undef, %33 ]
  br label %54

54:                                               ; preds = %74, %53
  %.03 = phi i32 [ 0, %53 ], [ %75, %74 ]
  %.01 = phi i64 [ 0, %53 ], [ %.12, %74 ]
  %.0 = phi i64 [ 0, %53 ], [ %.1, %74 ]
...
58:                                               ; preds = %54
  ...
  %60 = icmp slt i64 %59, %.04
  br i1 %60, label %61, label %67

61:                                               ; preds = %58
  %62 = sext i32 %.03 to i64
  %63 = call dereferenceable(8) i64* @_ZNSt6vectorIlSaIlEEixEm(%"class.std::vector"* %2, i64 %62) #3
...
67:                                               ; preds = %58
  ...
  %69 = call dereferenceable(8) i64* @_ZNSt6vectorIlSaIlEEixEm(%"class.std::vector"* %2, i64 %68) #3
  %70 = load i64, i64* %69, align 8
  %71 = sub nsw i64 %70, 1
  %72 = add nsw i64 %.01, %71
  br label %73

73:                                               ; preds = %67, %61
  %.12 = phi i64 [ %.01, %61 ], [ %72, %67 ]
  %.1 = phi i64 [ %66, %61 ], [ %.0, %67 ]
  br label %74
...
80:                                               ; preds = %76
  ...
  %81 = sub nsw i64 %.05, %.08
  %82 = sub nsw i64 %.08, %81
  %83 = invoke i64 @_ZSt3absl(i64 %82)
          to label %84 unwind label %28

84:                                               ; preds = %80
  store i64 %83, i64* %5, align 8
  %85 = invoke dereferenceable(8) i64* @_ZSt3minIlERKT_S2_S2_(i64* dereferenceable(8) %4, i64* dereferenceable(8) %5)
...
92:                                               ; preds = %28, %24
  %.010 = phi i32 [ %31, %28 ], [ %27, %24 ]
  %.09 = phi i8* [ %30, %28 ], [ %26, %24 ]
  %93 = insertvalue { i8*, i32 } undef, i8* %.09, 0
  %94 = insertvalue { i8*, i32 } %93, i32 %.010, 1
  resume { i8*, i32 } %94
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64 @_ZSt3absl(i64 %0) #5 comdat {
  %2 = sub i64 0, %0
  %3 = icmp sge i64 %0, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s800944121.cpp() #0 section ".text.startup" {
