; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03688/s399761440.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03688/s399761440.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s399761440.cpp, i8* null }]
...
4:                                                ; preds = %31, %0
  %.09 = phi i32 [ 0, %0 ], [ %32, %31 ]
  %.06 = phi i32 [ 0, %0 ], [ %.28, %31 ]
  %.04 = phi i32 [ 0, %0 ], [ %.2, %31 ]
  %.02 = phi i32 [ 1061109567, %0 ], [ %.13, %31 ]
  %.01 = phi i32 [ 0, %0 ], [ %.1, %31 ]
...
18:                                               ; preds = %16, %13
  %.15 = phi i32 [ %17, %16 ], [ %.04, %13 ]
  br label %19

19:                                               ; preds = %18, %11
  %.2 = phi i32 [ 1, %11 ], [ %.15, %18 ]
  %.1 = phi i32 [ %12, %11 ], [ %.01, %18 ]
  %20 = load i32, i32* %2, align 4
  %21 = icmp slt i32 %20, %.02
...
29:                                               ; preds = %27, %24
  %.17 = phi i32 [ %28, %27 ], [ %.06, %24 ]
  br label %30

30:                                               ; preds = %29, %22
  %.28 = phi i32 [ 1, %22 ], [ %.17, %29 ]
  %.13 = phi i32 [ %23, %22 ], [ %.02, %29 ]
  br label %31
...
103:                                              ; preds = %102, %95, %86, %78, %71, %64, %58
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s399761440.cpp() #0 section ".text.startup" {
