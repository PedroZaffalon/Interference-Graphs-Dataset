; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03552/s942983249.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03552/s942983249.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s942983249.cpp, i8* null }]
...
17:                                               ; preds = %14
  ...
  %19 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %4, i64 %18) #3
...
68:                                               ; preds = %66, %35
  %.03 = phi i32 [ %43, %35 ], [ %67, %66 ]
  %69 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %.03)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s942983249.cpp() #0 section ".text.startup" {
