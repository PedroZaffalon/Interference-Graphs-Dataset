; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00348/s461389343.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00348/s461389343.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s461389343.cpp, i8* null }]
...
6:                                                ; preds = %2
  %7 = sext i32 %.0 to i64
  %8 = getelementptr inbounds [200005 x %"struct.std::pair"], [200005 x %"struct.std::pair"]* @a, i64 0, i64 %7
...
define void @_Z5solvev() #0 {
  ...
  %2 = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* getelementptr inbounds ([200005 x %"struct.std::pair"], [200005 x %"struct.std::pair"]* @a, i32 0, i32 0), i64 %1
  %3 = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* %2, i64 1
  call void @_ZSt4sortIPSt4pairIiiEEvT_S3_(%"struct.std::pair"* getelementptr inbounds ([200005 x %"struct.std::pair"], [200005 x %"struct.std::pair"]* @a, i32 0, i64 1), %"struct.std::pair"* %3)
  store i32 0, i32* getelementptr inbounds ([200005 x %"struct.std::pair"], [200005 x %"struct.std::pair"]* @a, i64 0, i64 0, i32 1), align 4
  store i64 0, i64* @ans, align 8
  %4 = load i64, i64* @n, align 8
  %5 = trunc i64 %4 to i32
  store i32 %5, i32* @dd, align 4
  br label %6

6:                                                ; preds = %111, %0
  %.0 = phi i32 [ 1, %0 ], [ %112, %111 ]
  %7 = sext i32 %.0 to i64
...
10:                                               ; preds = %6
  ...
  %17 = getelementptr inbounds [200005 x %"struct.std::pair"], [200005 x %"struct.std::pair"]* @a, i64 0, i64 %16
...
91:                                               ; preds = %81
  %92 = load i32, i32* @dd, align 4
  %93 = add nsw i32 %92, 1
  store i32 %93, i32* @dd, align 4
...
100:                                              ; preds = %77
  %101 = load i32, i32* @dd, align 4
  %102 = add nsw i32 %101, 1
  store i32 %102, i32* @dd, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s461389343.cpp() #0 section ".text.startup" {
