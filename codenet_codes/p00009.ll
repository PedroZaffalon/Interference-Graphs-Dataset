; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00009/s380109213.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00009/s380109213.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s380109213.cpp, i8* null }]
...
15:                                               ; preds = %33, %14
  %.03 = phi i32 [ 2, %14 ], [ %34, %33 ]
  %.02 = phi i32 [ 0, %14 ], [ %.1, %33 ]
...
32:                                               ; preds = %30, %27, %24, %21, %18
  %.1 = phi i32 [ %31, %30 ], [ %.02, %27 ], [ %.02, %24 ], [ %.02, %21 ], [ %.02, %18 ]
  br label %33
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s380109213.cpp() #0 section ".text.startup" {
