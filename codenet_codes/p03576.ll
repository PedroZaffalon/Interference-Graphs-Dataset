; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03576/s943648300.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03576/s943648300.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s943648300.cpp, i8* null }]
...
30:                                               ; preds = %26
  ...
  %33 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* %29, i32* dereferenceable(4) %32)
          to label %34 unwind label %51

34:                                               ; preds = %30
  %35 = sext i32 %.04 to i64
  %36 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %3, i64 %35) #3
  invoke void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %7, i32* dereferenceable(4) %36)
          to label %37 unwind label %51

37:                                               ; preds = %34
  %38 = sext i32 %.04 to i64
  %39 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %5, i64 %38) #3
  invoke void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %8, i32* dereferenceable(4) %39)
...
51:                                               ; preds = %190, %187, %167, %71, %68, %66, %60, %57, %55, %37, %34, %30, %26
...
55:                                               ; preds = %23
  %56 = invoke i32* @_ZSt5beginISt6vectorIiSaIiEEEDTcldtfp_5beginEERT_(%"class.std::vector"* dereferenceable(24) %7)
          to label %57 unwind label %51

57:                                               ; preds = %55
  %58 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %9, i32 0, i32 0
  store i32* %56, i32** %58, align 8
  %59 = invoke i32* @_ZSt3endISt6vectorIiSaIiEEEDTcldtfp_3endEERT_(%"class.std::vector"* dereferenceable(24) %7)
...
66:                                               ; preds = %60
  %67 = invoke i32* @_ZSt5beginISt6vectorIiSaIiEEEDTcldtfp_5beginEERT_(%"class.std::vector"* dereferenceable(24) %8)
...
68:                                               ; preds = %66
  ...
  %70 = invoke i32* @_ZSt3endISt6vectorIiSaIiEEEDTcldtfp_3endEERT_(%"class.std::vector"* dereferenceable(24) %8)
...
98:                                               ; preds = %185, %77
  %.05 = phi i32 [ 0, %77 ], [ %186, %185 ]
  %99 = load i32, i32* %1, align 4
  %100 = icmp slt i32 %.05, %99
...
107:                                              ; preds = %179, %106
  %.07 = phi i32 [ 0, %106 ], [ %180, %179 ]
  %108 = load i32, i32* %1, align 4
  %109 = icmp slt i32 %.07, %108
  br i1 %109, label %110, label %181

110:                                              ; preds = %107
  %111 = add nsw i32 %.07, 1
  br label %112

112:                                              ; preds = %176, %110
  %.08 = phi i32 [ %111, %110 ], [ %177, %176 ]
  %113 = load i32, i32* %1, align 4
  %114 = icmp slt i32 %.08, %113
...
132:                                              ; preds = %162, %115
  %.09 = phi i32 [ 0, %115 ], [ %.110, %162 ]
  %.0 = phi i32 [ 0, %115 ], [ %163, %162 ]
...
161:                                              ; preds = %159, %153, %147, %141, %135
  %.110 = phi i32 [ %160, %159 ], [ %.09, %153 ], [ %.09, %147 ], [ %.09, %141 ], [ %.09, %135 ]
  br label %162
...
164:                                              ; preds = %132
  ...
  %166 = icmp sge i32 %.09, %165
  br i1 %166, label %167, label %175

167:                                              ; preds = %164
  %168 = sub nsw i64 %123, %119
  %169 = mul nsw i64 1, %168
  %170 = sub nsw i64 %131, %127
  %171 = mul nsw i64 %169, %170
  store i64 %171, i64* %14, align 8
  %172 = invoke dereferenceable(8) i64* @_ZSt3minIxERKT_S2_S2_(i64* dereferenceable(8) %13, i64* dereferenceable(8) %14)
...
194:                                              ; preds = %193, %43
  %.13 = phi i32 [ %.02, %193 ], [ %46, %43 ]
  %.1 = phi i8* [ %.01, %193 ], [ %45, %43 ]
  %195 = insertvalue { i8*, i32 } undef, i8* %.1, 0
  %196 = insertvalue { i8*, i32 } %195, i32 %.13, 1
  resume { i8*, i32 } %196
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s943648300.cpp() #0 section ".text.startup" {
