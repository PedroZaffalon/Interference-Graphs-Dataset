; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00964/s711423217.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00964/s711423217.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s711423217.cpp, i8* null }]
...
16:                                               ; preds = %15, %14
  %.1 = phi i32 [ -1, %14 ], [ %.01, %15 ]
  %17 = phi i32 [ -1, %14 ], [ 0, %15 ]
  %18 = call i32 @getchar()
...
21:                                               ; preds = %29, %20
  %.13 = phi i8 [ %.02, %20 ], [ %35, %29 ]
  %.0 = phi i32 [ 0, %20 ], [ %33, %29 ]
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s711423217.cpp() #0 section ".text.startup" {
