; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00631/s451819423.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00631/s451819423.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s451819423.cpp, i8* null }]
...
19:                                               ; preds = %10
  %20 = getelementptr inbounds [20 x i32], [20 x i32]* %2, i32 0, i32 0
  ...
  call void @_ZSt7reverseIPiEvT_S1_(i32* %25, i32* %29)
  br label %30

30:                                               ; preds = %46, %19
  %.05 = phi i32 [ 0, %19 ], [ %47, %46 ]
  %.02 = phi i32 [ 0, %19 ], [ %.13, %46 ]
  %.01 = phi i32 [ 0, %19 ], [ %.1, %46 ]
  %31 = load i32, i32* %1, align 4
  %32 = icmp slt i32 %.05, %31
  br i1 %32, label %33, label %48

33:                                               ; preds = %30
  %34 = icmp sgt i32 %.01, %.02
...
45:                                               ; preds = %40, %35
  %.13 = phi i32 [ %39, %35 ], [ %.02, %40 ]
  %.1 = phi i32 [ %.01, %35 ], [ %44, %40 ]
  br label %46
...
48:                                               ; preds = %30
  %49 = sub nsw i32 %.01, %.02
  %50 = call i32 @abs(i32 %49) #14
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s451819423.cpp() #0 section ".text.startup" {
