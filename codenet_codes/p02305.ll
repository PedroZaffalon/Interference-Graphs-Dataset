; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02305/s173181672.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02305/s173181672.cpp"
...
$_ZSt4swapI1CENSt9enable_ifIXsr6__and_ISt6__not_ISt15__is_tuple_likeIT_EESt21is_move_constructibleIS4_ESt18is_move_assignableIS4_EEE5valueEvE4typeERS4_SD_ = comdat any
...
$_ZN1CC2ERKSt7complexIdEd = comdat any
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s173181672.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define i32 @_Z12intersectionR1CS0_(%struct.C* dereferenceable(24) %0, %struct.C* dereferenceable(24) %1) #0 {
  %3 = alloca %"struct.std::complex", align 8
  %4 = alloca %"struct.std::complex", align 8
  %5 = alloca %"struct.std::complex", align 8
  %6 = getelementptr inbounds %struct.C, %struct.C* %0, i32 0, i32 1
  %7 = load double, double* %6, align 8
  %8 = getelementptr inbounds %struct.C, %struct.C* %1, i32 0, i32 1
  %9 = load double, double* %8, align 8
  %10 = fcmp ogt double %7, %9
  br i1 %10, label %11, label %12

11:                                               ; preds = %2
  call void @_ZSt4swapI1CENSt9enable_ifIXsr6__and_ISt6__not_ISt15__is_tuple_likeIT_EESt21is_move_constructibleIS4_ESt18is_move_assignableIS4_EEE5valueEvE4typeERS4_SD_(%struct.C* dereferenceable(24) %0, %struct.C* dereferenceable(24) %1) #3
  br label %12

12:                                               ; preds = %11, %2
  %13 = getelementptr inbounds %struct.C, %struct.C* %0, i32 0, i32 0
  %14 = bitcast %"struct.std::complex"* %3 to i8*
  %15 = bitcast %"struct.std::complex"* %13 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %14, i8* align 8 %15, i64 16, i1 false)
  %16 = getelementptr inbounds %struct.C, %struct.C* %1, i32 0, i32 0
  %17 = bitcast %"struct.std::complex"* %4 to i8*
  %18 = bitcast %"struct.std::complex"* %16 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %17, i8* align 8 %18, i64 16, i1 false)
  %19 = getelementptr inbounds %struct.C, %struct.C* %0, i32 0, i32 1
  %20 = load double, double* %19, align 8
  %21 = getelementptr inbounds %struct.C, %struct.C* %1, i32 0, i32 1
  %22 = load double, double* %21, align 8
  %23 = call { double, double } @_ZStmiIdESt7complexIT_ERKS2_S4_(%"struct.std::complex"* dereferenceable(16) %3, %"struct.std::complex"* dereferenceable(16) %4)
  %24 = getelementptr inbounds %"struct.std::complex", %"struct.std::complex"* %5, i32 0, i32 0
  ...
  %29 = call double @_ZSt4normIdET_RKSt7complexIS0_E(%"struct.std::complex"* dereferenceable(16) %5)
  %30 = call double @sqrt(double %29) #3
  %31 = fadd double %20, %22
  %32 = fsub double %30, 1.000000e-08
...
41:                                               ; preds = %35
  %42 = fadd double %20, %22
  %43 = fadd double %30, 1.000000e-08
  %44 = fcmp ogt double %42, %43
  br i1 %44, label %45, label %62

45:                                               ; preds = %41
  %46 = fsub double %22, %20
  %47 = fsub double %30, 1.000000e-08
...
50:                                               ; preds = %45
  %51 = fsub double %22, %20
  %52 = fsub double %51, %30
  %53 = call double @_ZSt3absd(double %52)
  %54 = fcmp ole double %53, 1.000000e-08
...
56:                                               ; preds = %50
  %57 = fsub double %22, %20
  %58 = fadd double %30, 1.000000e-08
...
63:                                               ; preds = %60, %55, %49, %40, %34
  %.0 = phi i32 [ 4, %34 ], [ 3, %40 ], [ 2, %49 ], [ 1, %55 ], [ 0, %60 ]
  ret i32 %.0
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZSt4swapI1CENSt9enable_ifIXsr6__and_ISt6__not_ISt15__is_tuple_likeIT_EESt21is_move_constructibleIS4_ESt18is_move_assignableIS4_EEE5valueEvE4typeERS4_SD_(%struct.C* dereferenceable(24) %0, %struct.C* dereferenceable(24) %1) #4 comdat {
  %3 = alloca %struct.C, align 8
  %4 = call dereferenceable(24) %struct.C* @_ZSt4moveIR1CEONSt16remove_referenceIT_E4typeEOS3_(%struct.C* dereferenceable(24) %0) #3
  %5 = bitcast %struct.C* %3 to i8*
  %6 = bitcast %struct.C* %4 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %5, i8* align 8 %6, i64 24, i1 false)
  %7 = call dereferenceable(24) %struct.C* @_ZSt4moveIR1CEONSt16remove_referenceIT_E4typeEOS3_(%struct.C* dereferenceable(24) %1) #3
  ...
  %10 = call dereferenceable(24) %struct.C* @_ZSt4moveIR1CEONSt16remove_referenceIT_E4typeEOS3_(%struct.C* dereferenceable(24) %3) #3
  %11 = bitcast %struct.C* %1 to i8*
  %12 = bitcast %struct.C* %10 to i8*
...
define i32 @main() #6 {
  ...
  call void @_ZNSt7complexIdEC2Edd(%"struct.std::complex"* %7, double %17, double %18)
  %19 = load double, double* %4, align 8
  %20 = load double, double* %5, align 8
  call void @_ZNSt7complexIdEC2Edd(%"struct.std::complex"* %8, double %19, double %20)
  %21 = load double, double* %3, align 8
  call void @_ZN1CC2ERKSt7complexIdEd(%struct.C* %9, %"struct.std::complex"* dereferenceable(16) %7, double %21)
  %22 = load double, double* %6, align 8
  call void @_ZN1CC2ERKSt7complexIdEd(%struct.C* %10, %"struct.std::complex"* dereferenceable(16) %8, double %22)
  %23 = call i32 @_Z12intersectionR1CS0_(%struct.C* dereferenceable(24) %9, %struct.C* dereferenceable(24) %10)
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN1CC2ERKSt7complexIdEd(%struct.C* %0, %"struct.std::complex"* dereferenceable(16) %1, double %2) unnamed_addr #4 comdat align 2 {
  %4 = getelementptr inbounds %struct.C, %struct.C* %0, i32 0, i32 0
  %5 = bitcast %"struct.std::complex"* %4 to i8*
  %6 = bitcast %"struct.std::complex"* %1 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %5, i8* align 8 %6, i64 16, i1 false)
  %7 = getelementptr inbounds %struct.C, %struct.C* %0, i32 0, i32 1
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(24) %struct.C* @_ZSt4moveIR1CEONSt16remove_referenceIT_E4typeEOS3_(%struct.C* dereferenceable(24) %0) #4 comdat {
  ret %struct.C* %0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s173181672.cpp() #0 section ".text.startup" {
