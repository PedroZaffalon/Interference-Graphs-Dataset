; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03440/s898846699.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03440/s898846699.cpp"
...
@sz = global [100010 x i32] zeroinitializer, align 16
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s898846699.cpp, i8* null }]
...
define i32 @_Z3powii(i32 %0, i32 %1) #4 {
  br label %3
...
define i32 @_Z4findi(i32 %0) #0 {
  %2 = sext i32 %0 to i64
  %3 = getelementptr inbounds [100010 x i32], [100010 x i32]* @f, i64 0, i64 %2
...
7:                                                ; preds = %1
  %8 = sext i32 %0 to i64
  %9 = getelementptr inbounds [100010 x i32], [100010 x i32]* @f, i64 0, i64 %8
...
; Function Attrs: noinline nounwind uwtable
define void @_Z5mergeii(i32 %0, i32 %1) #4 {
  ...
  %6 = sext i32 %5 to i64
  %7 = getelementptr inbounds [100010 x i32], [100010 x i32]* @sz, i64 0, i64 %6
  %8 = load i32, i32* %7, align 4
  %9 = load i32, i32* %4, align 4
  %10 = sext i32 %9 to i64
  %11 = getelementptr inbounds [100010 x i32], [100010 x i32]* @sz, i64 0, i64 %10
...
15:                                               ; preds = %14, %2
  ...
  %18 = getelementptr inbounds [100010 x i32], [100010 x i32]* @sz, i64 0, i64 %17
  %19 = load i32, i32* %18, align 4
  %20 = load i32, i32* %3, align 4
  %21 = sext i32 %20 to i64
  %22 = getelementptr inbounds [100010 x i32], [100010 x i32]* @sz, i64 0, i64 %21
  ...
  %28 = getelementptr inbounds [100010 x i32], [100010 x i32]* @f, i64 0, i64 %27
...
2:                                                ; preds = %2, %1
  ...
  %5 = icmp eq %"class.std::vector"* %4, getelementptr inbounds ([100010 x %"class.std::vector"], [100010 x %"class.std::vector"]* @v, i32 0, i32 0)
...
14:                                               ; preds = %11
  ...
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i32 0, i32 0), i32* %16)
  br label %18
...
24:                                               ; preds = %21
  ...
  store i32 %.06, i32* %26, align 4
  %27 = sext i32 %.06 to i64
  %28 = getelementptr inbounds [100010 x i32], [100010 x i32]* @sz, i64 0, i64 %27
...
36:                                               ; preds = %32
  %37 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0), i32* %2, i32* %1)
...
45:                                               ; preds = %36
  ...
  call void @_Z5mergeii(i32 %46, i32 %47)
  br label %48
...
50:                                               ; preds = %83, %49
  %.010 = phi i32 [ 0, %49 ], [ %84, %83 ]
  %.07 = phi i64 [ 0, %49 ], [ %.29, %83 ]
  %.04 = phi i32 [ 0, %49 ], [ %.2, %83 ]
  %51 = load i32, i32* %3, align 4
  %52 = icmp slt i32 %.010, %51
  br i1 %52, label %53, label %85

53:                                               ; preds = %50
  %54 = call i32 @_Z4findi(i32 %.010)
  %55 = icmp eq i32 %54, %.010
  br i1 %55, label %56, label %76

56:                                               ; preds = %53
  %57 = sext i32 %.010 to i64
  %58 = getelementptr inbounds [100010 x i32], [100010 x i32]* @sz, i64 0, i64 %57
...
68:                                               ; preds = %56
  ...
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %70, i32* dereferenceable(4) %72)
...
75:                                               ; preds = %68, %61
  %.18 = phi i64 [ %67, %61 ], [ %.07, %68 ]
  %.1 = phi i32 [ %62, %61 ], [ %.04, %68 ]
  br label %82

76:                                               ; preds = %53
  %77 = call i32 @_Z4findi(i32 %.010)
  %78 = sext i32 %77 to i64
  %79 = getelementptr inbounds [100010 x %"class.std::vector"], [100010 x %"class.std::vector"]* @v, i64 0, i64 %78
  %80 = sext i32 %.010 to i64
  %81 = getelementptr inbounds [100010 x i32], [100010 x i32]* @a, i64 0, i64 %80
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %79, i32* dereferenceable(4) %81)
  br label %82

82:                                               ; preds = %76, %75
  %.29 = phi i64 [ %.18, %75 ], [ %.07, %76 ]
  %.2 = phi i32 [ %.1, %75 ], [ %.04, %76 ]
  br label %83
...
85:                                               ; preds = %50
  ...
  %87 = sub nsw i32 %86, %.04
  %88 = load i32, i32* %4, align 4
  %89 = sub nsw i32 %88, 1
  %90 = mul nsw i32 2, %89
  %91 = sub nsw i32 %87, %90
  %92 = icmp sgt i32 %.04, %91
...
95:                                               ; preds = %85
  ...
  %97 = add nsw i32 %96, %.04
  %98 = icmp eq i32 %97, 1
  br i1 %98, label %99, label %101

99:                                               ; preds = %95
  %100 = call i32 @puts(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i32 0, i32 0))
  br label %188
...
101:                                              ; preds = %95
  ...
  %105 = add nsw i32 %.04, %104
  call void @_ZNSt6vectorIiSaIiEEC2Ev(%"class.std::vector"* %5) #3
  br label %106

106:                                              ; preds = %160, %101
  %.011 = phi i32 [ %105, %101 ], [ %.112, %160 ]
  %.3 = phi i64 [ %.07, %101 ], [ %.4, %160 ]
  %.03 = phi i32 [ 0, %101 ], [ %161, %160 ]
...
109:                                              ; preds = %106
  ...
  %111 = getelementptr inbounds [100010 x i32], [100010 x i32]* @f, i64 0, i64 %110
  %112 = load i32, i32* %111, align 4
  %113 = icmp eq i32 %112, %.03
  br i1 %113, label %114, label %159

114:                                              ; preds = %109
  %115 = sext i32 %.03 to i64
  %116 = getelementptr inbounds [100010 x i32], [100010 x i32]* @sz, i64 0, i64 %115
...
119:                                              ; preds = %114
  ...
  %121 = getelementptr inbounds [100010 x %"class.std::vector"], [100010 x %"class.std::vector"]* @v, i64 0, i64 %120
  ...
  %125 = getelementptr inbounds [100010 x %"class.std::vector"], [100010 x %"class.std::vector"]* @v, i64 0, i64 %124
...
132:                                              ; preds = %119
  ...
  %134 = getelementptr inbounds [100010 x %"class.std::vector"], [100010 x %"class.std::vector"]* @v, i64 0, i64 %133
  %135 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %134, i64 0) #3
  %136 = load i32, i32* %135, align 4
  %137 = sext i32 %136 to i64
  %138 = add nsw i64 %.3, %137
  %139 = add nsw i32 %.011, -1
  br label %140

140:                                              ; preds = %152, %132
  %.02 = phi i32 [ 1, %132 ], [ %153, %152 ]
  %141 = sext i32 %.03 to i64
  %142 = getelementptr inbounds [100010 x %"class.std::vector"], [100010 x %"class.std::vector"]* @v, i64 0, i64 %141
  %143 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* %142) #3
  %144 = trunc i64 %143 to i32
  %145 = icmp slt i32 %.02, %144
  br i1 %145, label %146, label %158

146:                                              ; preds = %140
  %147 = sext i32 %.03 to i64
  %148 = getelementptr inbounds [100010 x %"class.std::vector"], [100010 x %"class.std::vector"]* @v, i64 0, i64 %147
  %149 = sext i32 %.02 to i64
  %150 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %148, i64 %149) #3
  invoke void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %5, i32* dereferenceable(4) %150)
...
159:                                              ; preds = %158, %114, %109
  %.112 = phi i32 [ %139, %158 ], [ %.011, %114 ], [ %.011, %109 ]
  %.4 = phi i64 [ %138, %158 ], [ %.3, %114 ], [ %.3, %109 ]
  br label %160
...
162:                                              ; preds = %106
  %163 = icmp ne i32 %.011, 0
  br i1 %163, label %164, label %185

164:                                              ; preds = %162
  %165 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector"* %5) #3
  %166 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %8, i32 0, i32 0
  store i32* %165, i32** %166, align 8
  %167 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector"* %5) #3
...
174:                                              ; preds = %182, %173
  %.5 = phi i64 [ %.3, %173 ], [ %181, %182 ]
  %.01 = phi i32 [ 0, %173 ], [ %183, %182 ]
  %175 = icmp slt i32 %.01, %.011
...
185:                                              ; preds = %184, %162
  %.6 = phi i64 [ %.5, %184 ], [ %.3, %162 ]
  %186 = invoke i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.5, i32 0, i32 0), i64 %.6)
...
189:                                              ; preds = %154
  %190 = insertvalue { i8*, i32 } undef, i8* %156, 0
  %191 = insertvalue { i8*, i32 } %190, i32 %157, 1
  resume { i8*, i32 } %191
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s898846699.cpp() #0 section ".text.startup" {
