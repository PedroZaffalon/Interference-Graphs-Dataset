; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03970/s140716485.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03970/s140716485.cpp"
...
@.str = private unnamed_addr constant [17 x i8] c"CODEFESTIVAL2016\00", align 1
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s140716485.cpp, i8* null }]
...
5:                                                ; preds = %0
  ...
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1EPKcRKS3_(%"class.std::__cxx11::basic_string"* %2, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str, i32 0, i32 0), %"class.std::allocator"* dereferenceable(1) %3)
...
40:                                               ; preds = %7
  %41 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %.02)
...
45:                                               ; preds = %33, %29, %25
  %.01 = phi i32 [ %36, %33 ], [ %32, %29 ], [ %28, %25 ]
  %.0 = phi i8* [ %35, %33 ], [ %31, %29 ], [ %27, %25 ]
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED1Ev(%"class.std::__cxx11::basic_string"* %1) #3
  br label %46
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s140716485.cpp() #0 section ".text.startup" {
