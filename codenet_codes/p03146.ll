; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03146/s158899156.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03146/s158899156.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s158899156.cpp, i8* null }]
...
define i32 @main() #5 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %6 = invoke dereferenceable(4) i32* @_ZNSt3mapIiiSt4lessIiESaISt4pairIKiiEEEixERS3_(%"class.std::map"* %2, i32* dereferenceable(4) %1)
...
9:                                                ; preds = %8
  ...
  %12 = invoke i32 @_Z4funci(i32 %11)
          to label %13 unwind label %25

13:                                               ; preds = %9
  store i32 %12, i32* %1, align 4
  %14 = invoke %"struct.std::_Rb_tree_node_base"* @_ZNSt3mapIiiSt4lessIiESaISt4pairIKiiEEE4findERS3_(%"class.std::map"* %2, i32* dereferenceable(4) %1)
          to label %15 unwind label %25

15:                                               ; preds = %13
  %16 = getelementptr inbounds %"struct.std::_Rb_tree_iterator", %"struct.std::_Rb_tree_iterator"* %3, i32 0, i32 0
  store %"struct.std::_Rb_tree_node_base"* %14, %"struct.std::_Rb_tree_node_base"** %16, align 8
  %17 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt3mapIiiSt4lessIiESaISt4pairIKiiEEE3endEv(%"class.std::map"* %2) #3
  %18 = getelementptr inbounds %"struct.std::_Rb_tree_iterator", %"struct.std::_Rb_tree_iterator"* %4, i32 0, i32 0
  store %"struct.std::_Rb_tree_node_base"* %17, %"struct.std::_Rb_tree_node_base"** %18, align 8
  %19 = call zeroext i1 @_ZNKSt17_Rb_tree_iteratorISt4pairIKiiEEneERKS3_(%"struct.std::_Rb_tree_iterator"* %3, %"struct.std::_Rb_tree_iterator"* dereferenceable(8) %4) #3
  br i1 %19, label %20, label %29

20:                                               ; preds = %15
  %21 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %10)
...
29:                                               ; preds = %15
  %30 = invoke dereferenceable(4) i32* @_ZNSt3mapIiiSt4lessIiESaISt4pairIKiiEEEixERS3_(%"class.std::map"* %2, i32* dereferenceable(4) %1)
...
34:                                               ; preds = %25
  %35 = insertvalue { i8*, i32 } undef, i8* %27, 0
  %36 = insertvalue { i8*, i32 } %35, i32 %28, 1
  resume { i8*, i32 } %36
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s158899156.cpp() #0 section ".text.startup" {
