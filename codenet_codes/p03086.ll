; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03086/s621496275.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03086/s621496275.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s621496275.cpp, i8* null }]
...
33:                                               ; preds = %32
  %34 = call dereferenceable(8) %"class.__gnu_cxx::__normal_iterator"* @_ZN9__gnu_cxx17__normal_iteratorIPcNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEppEv(%"class.__gnu_cxx::__normal_iterator"* %2) #3
  br label %10

35:                                               ; preds = %10
  %36 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %.0)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s621496275.cpp() #0 section ".text.startup" {
