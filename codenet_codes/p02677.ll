; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02677/s667100990.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02677/s667100990.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s667100990.cpp, i8* null }]
...
19:                                               ; preds = %0
  %20 = fadd double %17, 3.600000e+02
  br label %21

21:                                               ; preds = %19, %0
  %.0 = phi double [ %20, %19 ], [ %17, %0 ]
  ...
  %43 = call double @pow(double %37, double 5.000000e-01) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s667100990.cpp() #0 section ".text.startup" {
