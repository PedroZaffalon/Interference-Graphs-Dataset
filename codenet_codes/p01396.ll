; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01396/s915566643.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01396/s915566643.cpp"
...
@table = global [2 x [1005 x [1005 x i32]]] zeroinitializer, align 16
@in_num = global [1005 x i32] zeroinitializer, align 16
@V = global i32 0, align 4
@G = global [2010 x %"class.std::vector"] zeroinitializer, align 16
@match = global [2010 x i32] zeroinitializer, align 16
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s915566643.cpp, i8* null }]
...
2:                                                ; preds = %2, %1
  ...
  %5 = icmp eq %"class.std::vector"* %4, getelementptr inbounds ([2010 x %"class.std::vector"], [2010 x %"class.std::vector"]* @G, i32 0, i32 0)
...
define void @_Z8add_edgeii(i32 %0, i32 %1) #0 {
  ...
  %6 = sext i32 %5 to i64
  %7 = getelementptr inbounds [2010 x %"class.std::vector"], [2010 x %"class.std::vector"]* @G, i64 0, i64 %6
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %7, i32* dereferenceable(4) %4)
  %8 = load i32, i32* %4, align 4
  %9 = sext i32 %8 to i64
  %10 = getelementptr inbounds [2010 x %"class.std::vector"], [2010 x %"class.std::vector"]* @G, i64 0, i64 %9
...
10:                                               ; preds = %4
  ...
  %12 = getelementptr inbounds [2010 x %"class.std::vector"], [2010 x %"class.std::vector"]* @G, i64 0, i64 %11
  %13 = sext i32 %.01 to i64
  %14 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %12, i64 %13) #3
  %15 = load i32, i32* %14, align 4
  %16 = sext i32 %15 to i64
  %17 = getelementptr inbounds [2010 x i32], [2010 x i32]* @match, i64 0, i64 %16
...
20:                                               ; preds = %10
  ...
  %22 = getelementptr inbounds [2010 x i8], [2010 x i8]* @used, i64 0, i64 %21
...
27:                                               ; preds = %20
  %28 = call i32 @_Z3dfsi(i32 %18)
  %29 = icmp eq i32 %28, 1
  br i1 %29, label %30, label %35

30:                                               ; preds = %27, %10
  %31 = sext i32 %0 to i64
  %32 = getelementptr inbounds [2010 x i32], [2010 x i32]* @match, i64 0, i64 %31
  store i32 %15, i32* %32, align 4
  %33 = sext i32 %15 to i64
  %34 = getelementptr inbounds [2010 x i32], [2010 x i32]* @match, i64 0, i64 %33
...
; Function Attrs: noinline uwtable
define i32 @_Z17bipartie_matchingv() #0 {
  br label %1
...
4:                                                ; preds = %1
  %5 = sext i32 %.01 to i64
  %6 = getelementptr inbounds [2010 x i32], [2010 x i32]* @match, i64 0, i64 %5
...
13:                                               ; preds = %10
  ...
  %15 = getelementptr inbounds [2010 x i32], [2010 x i32]* @match, i64 0, i64 %14
...
22:                                               ; preds = %19
  ...
  %24 = getelementptr inbounds [2010 x i8], [2010 x i8]* @used, i64 0, i64 %23
...
define i32 @main() #5 {
  %1 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i32 0, i32 0), i32* @H, i32* @W)
  br label %2
...
9:                                                ; preds = %6
  ...
  %11 = getelementptr inbounds [1005 x [1005 x i32]], [1005 x [1005 x i32]]* getelementptr inbounds ([2 x [1005 x [1005 x i32]]], [2 x [1005 x [1005 x i32]]]* @table, i64 0, i64 0), i64 0, i64 %10
  %12 = sext i32 %.02 to i64
  %13 = getelementptr inbounds [1005 x i32], [1005 x i32]* %11, i64 0, i64 %12
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i32 0, i32 0), i32* %13)
  %15 = sext i32 %.01 to i64
  %16 = getelementptr inbounds [1005 x [1005 x i32]], [1005 x [1005 x i32]]* getelementptr inbounds ([2 x [1005 x [1005 x i32]]], [2 x [1005 x [1005 x i32]]]* @table, i64 0, i64 0), i64 0, i64 %15
  %17 = sext i32 %.02 to i64
  %18 = getelementptr inbounds [1005 x i32], [1005 x i32]* %16, i64 0, i64 %17
  %19 = load i32, i32* %18, align 4
  %20 = sext i32 %.02 to i64
  %21 = getelementptr inbounds [1005 x [1005 x i32]], [1005 x [1005 x i32]]* getelementptr inbounds ([2 x [1005 x [1005 x i32]]], [2 x [1005 x [1005 x i32]]]* @table, i64 0, i64 1), i64 0, i64 %20
  %22 = sext i32 %.01 to i64
  %23 = getelementptr inbounds [1005 x i32], [1005 x i32]* %21, i64 0, i64 %22
...
30:                                               ; preds = %134, %29
  %.04 = phi i32 [ 0, %29 ], [ %135, %134 ]
  %31 = icmp slt i32 %.04, 2
...
42:                                               ; preds = %39
  ...
  %44 = getelementptr inbounds [1005 x i32], [1005 x i32]* @in_num, i64 0, i64 %43
...
62:                                               ; preds = %59
  ...
  %64 = getelementptr inbounds [2 x [1005 x [1005 x i32]]], [2 x [1005 x [1005 x i32]]]* @table, i64 0, i64 %63
  %65 = sext i32 %.06 to i64
  %66 = getelementptr inbounds [1005 x [1005 x i32]], [1005 x [1005 x i32]]* %64, i64 0, i64 %65
  %67 = sext i32 %.08 to i64
  %68 = getelementptr inbounds [1005 x i32], [1005 x i32]* %66, i64 0, i64 %67
  %69 = load i32, i32* %68, align 4
  %70 = sext i32 %.04 to i64
  %71 = getelementptr inbounds [2 x [1005 x [1005 x i32]]], [2 x [1005 x [1005 x i32]]]* @table, i64 0, i64 %70
...
85:                                               ; preds = %82
  ...
  %87 = add nsw i32 %.07, %86
  call void @_Z8add_edgeii(i32 %.06, i32 %87)
  %88 = sext i32 %.07 to i64
  %89 = getelementptr inbounds [1005 x i32], [1005 x i32]* @in_num, i64 0, i64 %88
...
98:                                               ; preds = %109, %97
  %.010 = phi i32 [ 0, %97 ], [ %110, %109 ]
  %.09 = phi i32 [ 0, %97 ], [ %.1, %109 ]
...
101:                                              ; preds = %98
  ...
  %103 = getelementptr inbounds [1005 x i32], [1005 x i32]* @in_num, i64 0, i64 %102
...
108:                                              ; preds = %106, %101
  %.1 = phi i32 [ %107, %106 ], [ %.09, %101 ]
  br label %109

109:                                              ; preds = %108
  %110 = add nsw i32 %.010, 1
  br label %98

111:                                              ; preds = %98
  %112 = load i32, i32* @H, align 4
  %113 = sub nsw i32 %112, 1
  %114 = icmp ne i32 %.09, %113
...
117:                                              ; preds = %111
  %118 = call i32 @_Z17bipartie_matchingv()
...
125:                                              ; preds = %131, %124
  %.011 = phi i32 [ 0, %124 ], [ %132, %131 ]
  %126 = load i32, i32* @V, align 4
  %127 = icmp slt i32 %.011, %126
  br i1 %127, label %128, label %133

128:                                              ; preds = %125
  %129 = sext i32 %.011 to i64
  %130 = getelementptr inbounds [2010 x %"class.std::vector"], [2010 x %"class.std::vector"]* @G, i64 0, i64 %129
  call void @_ZNSt6vectorIiSaIiEE5clearEv(%"class.std::vector"* %130) #3
  br label %131
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s915566643.cpp() #0 section ".text.startup" {
