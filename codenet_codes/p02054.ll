; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02054/s358055475.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02054/s358055475.cpp"
...
@.str = private unnamed_addr constant [4 x i8] c"Tem\00", align 1
@.str.1 = private unnamed_addr constant [4 x i8] c"Hom\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s358055475.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s358055475.cpp() #0 section ".text.startup" {
