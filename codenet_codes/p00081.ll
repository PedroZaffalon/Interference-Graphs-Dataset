; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00081/s189627435.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00081/s189627435.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s189627435.cpp, i8* null }]
...
8:                                                ; preds = %63, %0
  %9 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str, i32 0, i32 0), double* %1, double* %2, double* %3, double* %4, double* %5, double* %6)
  %10 = icmp ne i32 %9, -1
...
15:                                               ; preds = %11
  ...
  %51 = fmul double 2.000000e+00, %22
  %52 = fmul double %22, %22
...
63:                                               ; preds = %59, %15
  %.01 = phi double [ %43, %15 ], [ %62, %59 ]
  %.0 = phi double [ %58, %15 ], [ %60, %59 ]
  ...
  %65 = call i32 @_ZSt12setprecisioni(i32 6)
  ...
  %70 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEd(%"class.std::basic_ostream"* %69, double %.01)
  ...
  %72 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEd(%"class.std::basic_ostream"* %71, double %.0)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s189627435.cpp() #0 section ".text.startup" {
