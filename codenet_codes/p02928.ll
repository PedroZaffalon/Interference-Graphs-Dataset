; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02928/s256300692.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02928/s256300692.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s256300692.cpp, i8* null }]
...
define i32 @main() #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  invoke void @_ZNSt6vectorIxSaIxEEC2EmRKS0_(%"class.std::vector"* %3, i64 %7, %"class.std::allocator"* dereferenceable(1) %4)
...
13:                                               ; preds = %9
  ...
  %15 = invoke dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEE2atEm(%"class.std::vector"* %3, i64 %14)
          to label %16 unwind label %25

16:                                               ; preds = %13
  %17 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERx(%"class.std::basic_istream"* @_ZSt3cin, i64* dereferenceable(8) %15)
...
25:                                               ; preds = %102, %90, %75, %72, %44, %41, %16, %13
...
30:                                               ; preds = %57, %29
  %.010 = phi i32 [ 0, %29 ], [ %58, %57 ]
  %.07 = phi i64 [ 0, %29 ], [ %.18, %57 ]
  %31 = load i64, i64* %1, align 8
  %32 = sub nsw i64 %31, 1
  %33 = trunc i64 %32 to i32
  %34 = icmp slt i32 %.010, %33
...
37:                                               ; preds = %54, %35
  %.18 = phi i64 [ %.07, %35 ], [ %.29, %54 ]
  %.06 = phi i32 [ %36, %35 ], [ %55, %54 ]
...
59:                                               ; preds = %30
  ...
  %61 = mul nsw i64 %.07, %60
  %62 = srem i64 %61, 1000000007
  br label %63

63:                                               ; preds = %88, %59
  %.05 = phi i64 [ 0, %59 ], [ %.1, %88 ]
  %.03 = phi i32 [ 0, %59 ], [ %89, %88 ]
...
68:                                               ; preds = %85, %67
  %.1 = phi i64 [ %.05, %67 ], [ %.2, %85 ]
  %.0 = phi i32 [ 0, %67 ], [ %86, %85 ]
...
105:                                              ; preds = %25, %21
  ...
  %106 = insertvalue { i8*, i32 } undef, i8* %.01, 0
  %107 = insertvalue { i8*, i32 } %106, i32 %.02, 1
  resume { i8*, i32 } %107
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s256300692.cpp() #0 section ".text.startup" {
