; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00119/s763472338.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00119/s763472338.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s763472338.cpp, i8* null }]
...
19:                                               ; preds = %7
  %20 = bitcast [21 x i32]* %3 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %20, i8 0, i64 84, i1 false)
  br label %21

21:                                               ; preds = %27, %19
  %.01 = phi i32 [ 1, %19 ], [ %28, %27 ]
...
33:                                               ; preds = %30
  ...
  %44 = call dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* dereferenceable(4) %38, i32* dereferenceable(4) %6)
...
52:                                               ; preds = %71, %51
  %.04 = phi i32 [ 1, %51 ], [ %72, %71 ]
  %.03 = phi i32 [ 0, %51 ], [ %.1, %71 ]
...
56:                                               ; preds = %69, %55
  %.1 = phi i32 [ %.03, %55 ], [ %.2, %69 ]
  %.0 = phi i32 [ 1, %55 ], [ %70, %69 ]
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s763472338.cpp() #0 section ".text.startup" {
