; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00368/s998858843.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00368/s998858843.cpp"
...
@atu = global %"class.std::vector" zeroinitializer, align 8
@_ZSt3cin = external global %"class.std::basic_istream", align 8
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@.str = private unnamed_addr constant [3 x i8] c"no\00", align 1
@.str.2 = private unnamed_addr constant [4 x i8] c"yes\00", align 1
@.str.3 = private unnamed_addr constant [26 x i8] c"vector::_M_realloc_insert\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s998858843.cpp, i8* null }]
...
define internal void @__cxx_global_var_init.1() #0 section ".text.startup" {
  call void @_ZNSt6vectorIiSaIiEEC2Ev(%"class.std::vector"* @atu) #3
  %1 = call i32 @__cxa_atexit(void (i8*)* bitcast (void (%"class.std::vector"*)* @_ZNSt6vectorIiSaIiEED2Ev to void (i8*)*), i8* bitcast (%"class.std::vector"* @atu to i8*), i8* @__dso_handle) #3
  ret void
}
...
define i32 @_Z4scanv() #0 {
  ...
  call void @_ZNSt6vectorIiSaIiEE9push_backEOi(%"class.std::vector"* @atu, i32* dereferenceable(4) %3)
...
20:                                               ; preds = %32, %19
  %.05 = phi i32 [ 0, %19 ], [ %31, %32 ]
  %.02 = phi i32 [ 0, %19 ], [ %33, %32 ]
...
38:                                               ; preds = %110, %108, %105, %103, %83, %81, %70, %57, %50, %48, %23
...
42:                                               ; preds = %20
  ...
  %44 = sub nsw i32 %43, %.05
  %45 = sub nsw i32 %.05, %44
...
54:                                               ; preds = %97, %53
  %.08 = phi i32 [ 0, %53 ], [ %.19, %97 ]
  %.06 = phi i32 [ 1, %53 ], [ %.17, %97 ]
  %.01 = phi i32 [ 1, %53 ], [ %98, %97 ]
...
96:                                               ; preds = %94, %92
  %.19 = phi i32 [ %.08, %92 ], [ %95, %94 ]
  %.17 = phi i32 [ %93, %92 ], [ %.06, %94 ]
  br label %97
...
115:                                              ; preds = %38, %34
  %.04 = phi i32 [ %41, %38 ], [ %37, %34 ]
  %.03 = phi i8* [ %40, %38 ], [ %36, %34 ]
  %116 = insertvalue { i8*, i32 } undef, i8* %.03, 0
  %117 = insertvalue { i8*, i32 } %116, i32 %.04, 1
  resume { i8*, i32 } %117
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s998858843.cpp() #0 section ".text.startup" {
