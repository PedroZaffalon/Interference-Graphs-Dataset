; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02768/s718526327.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02768/s718526327.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s718526327.cpp, i8* null }]
...
define i64 @_Z1gxx(i64 %0, i64 %1) #4 {
  br label %3
...
; Function Attrs: noinline nounwind uwtable
define i64 @_Z6modinvxx(i64 %0, i64 %1) #4 {
...
; Function Attrs: noinline uwtable
define void @_Z5solvexxx(i64 %0, i64 %1, i64 %2) #0 {
  br label %4

4:                                                ; preds = %12, %3
  %.03 = phi i64 [ 1, %3 ], [ %11, %12 ]
...
6:                                                ; preds = %4
  %7 = sub nsw i64 %.01, 1
  %8 = sub nsw i64 %0, %7
  %9 = call i64 @_Z6modinvxx(i64 %.01, i64 1000000007)
  %10 = mul nsw i64 %8, %9
  %11 = mul nsw i64 %.03, %10
  br label %12
...
17:                                               ; preds = %15
  %18 = sub nsw i64 %.0, 1
  %19 = sub nsw i64 %0, %18
  %20 = call i64 @_Z6modinvxx(i64 %.0, i64 1000000007)
...
25:                                               ; preds = %15
  %26 = call i64 @_Z1gxx(i64 2, i64 %0)
  %27 = add nsw i64 %.03, %.02
  %28 = add nsw i64 %27, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s718526327.cpp() #0 section ".text.startup" {
