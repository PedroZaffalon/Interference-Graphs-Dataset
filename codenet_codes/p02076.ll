; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02076/s224078451.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02076/s224078451.cpp"
...
@match = global [100100 x i32] zeroinitializer, align 16
@used = global [100100 x i8] zeroinitializer, align 16
@_ZSt3cin = external global %"class.std::basic_istream", align 8
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@.str = private unnamed_addr constant [26 x i8] c"vector::_M_realloc_insert\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s224078451.cpp, i8* null }]
...
define void @_Z8add_edgeii(i32 %0, i32 %1) #0 {
  ...
  %6 = sext i32 %5 to i64
  %7 = getelementptr inbounds [100100 x %"class.std::vector"], [100100 x %"class.std::vector"]* @g, i64 0, i64 %6
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %7, i32* dereferenceable(4) %4)
  %8 = load i32, i32* %4, align 4
  %9 = sext i32 %8 to i64
  %10 = getelementptr inbounds [100100 x %"class.std::vector"], [100100 x %"class.std::vector"]* @g, i64 0, i64 %9
...
10:                                               ; preds = %4
  ...
  %12 = getelementptr inbounds [100100 x %"class.std::vector"], [100100 x %"class.std::vector"]* @g, i64 0, i64 %11
  %13 = sext i32 %.01 to i64
  %14 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %12, i64 %13) #3
  %15 = load i32, i32* %14, align 4
  %16 = sext i32 %15 to i64
  %17 = getelementptr inbounds [100100 x i32], [100100 x i32]* @match, i64 0, i64 %16
...
27:                                               ; preds = %25, %10
  ...
  %29 = getelementptr inbounds [100100 x i32], [100100 x i32]* @match, i64 0, i64 %28
  store i32 %15, i32* %29, align 4
  %30 = sext i32 %15 to i64
  %31 = getelementptr inbounds [100100 x i32], [100100 x i32]* @match, i64 0, i64 %30
...
; Function Attrs: noinline uwtable
define i32 @_Z9bipartitev() #0 {
  call void @llvm.memset.p0i8.i64(i8* align 16 bitcast ([100100 x i32]* @match to i8*), i8 -1, i64 400400, i1 false)
  br label %1
...
5:                                                ; preds = %1
  ...
  %7 = getelementptr inbounds [100100 x i32], [100100 x i32]* @match, i64 0, i64 %6
...
10:                                               ; preds = %5
  ...
  %11 = call zeroext i1 @_Z3dfsi(i32 %.01)
...
10:                                               ; preds = %4
  ...
  %15 = load i32, i32* %14, align 4
  %16 = sext i32 %15 to i64
  %17 = getelementptr inbounds [100100 x i8], [100100 x i8]* @used, i64 0, i64 %16
...
8:                                                ; preds = %5
  ...
  call void @_Z8add_edgeii(i32 %15, i32 %18)
  br label %19
...
26:                                               ; preds = %22
  ...
  %28 = getelementptr inbounds [100100 x i8], [100100 x i8]* @used, i64 0, i64 %27
...
31:                                               ; preds = %26
  ...
  %33 = getelementptr inbounds [100100 x %"class.std::vector"], [100100 x %"class.std::vector"]* @g, i64 0, i64 %32
...
37:                                               ; preds = %31
  call void @_Z3efsi(i32 %.0)
  %38 = add nsw i32 %.02, 1
  br label %39

39:                                               ; preds = %37, %26
  %.1 = phi i32 [ %.02, %26 ], [ %38, %37 ]
  br label %40

40:                                               ; preds = %39, %36
  %.2 = phi i32 [ %.1, %39 ], [ %.02, %36 ]
  %41 = add nsw i32 %.0, 1
  br label %22

42:                                               ; preds = %22
  %43 = load i32, i32* @M, align 4
  %44 = call i32 @_Z9bipartitev()
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s224078451.cpp() #0 section ".text.startup" {
