; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02558/s311831841.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02558/s311831841.cpp"
...
%struct.UnionFind = type { i32, %"class.std::vector", %"class.std::vector" }
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s311831841.cpp, i8* null }]
...
define i32 @main() #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  call void @_ZN9UnionFindC2Ei(%struct.UnionFind* %3, i32 %9)
  br label %10
...
16:                                               ; preds = %14
  %17 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* %15, i32* dereferenceable(4) %5)
          to label %18 unwind label %27

18:                                               ; preds = %16
  %19 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* %17, i32* dereferenceable(4) %6)
...
23:                                               ; preds = %20
  ...
  invoke void @_ZN9UnionFind5uniteEii(%struct.UnionFind* %3, i32 %24, i32 %25)
          to label %26 unwind label %27

26:                                               ; preds = %23
  br label %40

27:                                               ; preds = %37, %35, %31, %23, %18, %16, %14
...
31:                                               ; preds = %20
  ...
  %34 = invoke zeroext i1 @_ZN9UnionFind4sameEii(%struct.UnionFind* %3, i32 %32, i32 %33)
          to label %35 unwind label %27

35:                                               ; preds = %31
  %36 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEb(%"class.std::basic_ostream"* @_ZSt4cout, i1 zeroext %34)
...
42:                                               ; preds = %27
  %43 = insertvalue { i8*, i32 } undef, i8* %29, 0
  %44 = insertvalue { i8*, i32 } %43, i32 %30, 1
  resume { i8*, i32 } %44
}
...
define linkonce_odr void @_ZN9UnionFindC2Ei(%struct.UnionFind* %0, i32 %1) unnamed_addr #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %6 = getelementptr inbounds %struct.UnionFind, %struct.UnionFind* %0, i32 0, i32 0
  store i32 %1, i32* %6, align 8
  %7 = getelementptr inbounds %struct.UnionFind, %struct.UnionFind* %0, i32 0, i32 1
  %8 = sext i32 %1 to i64
...
17:                                               ; preds = %13
  %18 = getelementptr inbounds %struct.UnionFind, %struct.UnionFind* %0, i32 0, i32 1
...
32:                                               ; preds = %27, %23
  %.02 = phi i8* [ %29, %27 ], [ %25, %23 ]
  %.01 = phi i32 [ %30, %27 ], [ %26, %23 ]
  %33 = insertvalue { i8*, i32 } undef, i8* %.02, 0
  %34 = insertvalue { i8*, i32 } %33, i32 %.01, 1
  resume { i8*, i32 } %34
}
...
27:                                               ; preds = %26, %14
  ...
  %33 = getelementptr inbounds %struct.UnionFind, %struct.UnionFind* %0, i32 0, i32 2
...
8:                                                ; preds = %2
  %9 = getelementptr inbounds %struct.UnionFind, %struct.UnionFind* %0, i32 0, i32 1
  %10 = sext i32 %1 to i64
  %11 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %9, i64 %10) #3
  %12 = load i32, i32* %11, align 4
  %13 = call i32 @_ZN9UnionFind4rootEi(%struct.UnionFind* %0, i32 %12)
  %14 = getelementptr inbounds %struct.UnionFind, %struct.UnionFind* %0, i32 0, i32 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s311831841.cpp() #0 section ".text.startup" {
