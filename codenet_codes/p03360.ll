; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03360/s961302207.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03360/s961302207.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s961302207.cpp, i8* null }]
...
12:                                               ; preds = %4
  %13 = mul nsw i32 2, %0
  %14 = sub nsw i32 %3, 1
  %15 = call i32 @_Z5solveiiii(i32 %13, i32 %1, i32 %2, i32 %14)
  store i32 %15, i32* %5, align 4
  %16 = mul nsw i32 2, %1
  %17 = sub nsw i32 %3, 1
  %18 = call i32 @_Z5solveiiii(i32 %0, i32 %16, i32 %2, i32 %17)
  store i32 %18, i32* %6, align 4
  %19 = mul nsw i32 2, %2
  %20 = sub nsw i32 %3, 1
  %21 = call i32 @_Z5solveiiii(i32 %0, i32 %1, i32 %19, i32 %20)
  store i32 %21, i32* %7, align 4
  %22 = call dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* dereferenceable(4) %6, i32* dereferenceable(4) %7)
  %23 = call dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* dereferenceable(4) %5, i32* dereferenceable(4) %22)
  %24 = load i32, i32* %23, align 4
  br label %25

25:                                               ; preds = %12, %9
  %.0 = phi i32 [ %11, %9 ], [ %24, %12 ]
  ret i32 %.0
}
...
define i32 @main() #5 {
  ...
  %9 = call i32 @_Z5solveiiii(i32 %5, i32 %6, i32 %7, i32 %8)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s961302207.cpp() #0 section ".text.startup" {
