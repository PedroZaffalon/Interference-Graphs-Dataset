; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03612/s225113319.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03612/s225113319.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s225113319.cpp, i8* null }]
...
31:                                               ; preds = %48, %30
  %.04 = phi i32 [ 0, %30 ], [ %49, %48 ]
  %.03 = phi i32 [ 0, %30 ], [ %.1, %48 ]
...
40:                                               ; preds = %35
  ...
  call void @_ZSt4swapIiENSt9enable_ifIXsr6__and_ISt6__not_ISt15__is_tuple_likeIT_EESt21is_move_constructibleIS3_ESt18is_move_assignableIS3_EEE5valueEvE4typeERS3_SC_(i32* dereferenceable(4) %43, i32* dereferenceable(4) %46) #3
  br label %47

47:                                               ; preds = %40, %35
  %.1 = phi i32 [ %41, %40 ], [ %.03, %35 ]
  br label %48
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s225113319.cpp() #0 section ".text.startup" {
