; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01802/s825786353.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01802/s825786353.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s825786353.cpp, i8* null }]
...
23:                                               ; preds = %47, %22
  %.01 = phi i32 [ 0, %22 ], [ %48, %47 ]
  %24 = icmp slt i32 %.01, 110
...
32:                                               ; preds = %28
  ...
  %41 = call dereferenceable(8) double* @_ZSt3minIdERKT_S2_S2_(double* dereferenceable(8) %3, double* dereferenceable(8) %4)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s825786353.cpp() #0 section ".text.startup" {
