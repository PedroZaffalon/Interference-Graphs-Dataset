; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03388/s759663024.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03388/s759663024.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s759663024.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define i64 @_Z4combxx(i64 %0, i64 %1) #0 {
  %3 = icmp sgt i64 %1, %0
  br i1 %3, label %4, label %5
...
5:                                                ; preds = %2
  %6 = call i64 @_Z3kaix(i64 %0)
  %7 = sub nsw i64 %0, %1
  %8 = call i64 @_Z3kaix(i64 %7)
  %9 = call i64 @_Z7mod_powxxx(i64 %8, i64 1000000005, i64 1000000007)
  %10 = mul nsw i64 %6, %9
  %11 = srem i64 %10, 1000000007
  %12 = call i64 @_Z3kaix(i64 %1)
...
37:                                               ; preds = %35, %25
  %.0 = phi i64 [ %36, %35 ], [ %32, %25 ]
  %38 = load i64, i64* %2, align 8
  %39 = icmp sle i64 %38, %31
...
44:                                               ; preds = %37
  %45 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEx(%"class.std::basic_ostream"* @_ZSt4cout, i64 %.0)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s759663024.cpp() #0 section ".text.startup" {
