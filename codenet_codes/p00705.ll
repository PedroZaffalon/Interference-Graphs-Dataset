; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00705/s614237058.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00705/s614237058.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s614237058.cpp, i8* null }]
...
21:                                               ; preds = %16
  ...
  invoke void @_ZNSt6vectorIiSaIiEEC2EmRKiRKS0_(%"class.std::vector"* %3, i64 100, i32* dereferenceable(4) %4, %"class.std::allocator"* dereferenceable(1) %5)
...
56:                                               ; preds = %68, %53
  %.06 = phi i32 [ %55, %53 ], [ %.17, %68 ]
  %.05 = phi i32 [ 0, %53 ], [ %.1, %68 ]
  %.0 = phi i32 [ 1, %53 ], [ %69, %68 ]
  %57 = icmp slt i32 %.0, 100
...
67:                                               ; preds = %63, %58
  %.17 = phi i32 [ %66, %63 ], [ %.06, %58 ]
  %.1 = phi i32 [ %.0, %63 ], [ %.05, %58 ]
  br label %68
...
70:                                               ; preds = %56
  %71 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %.05)
...
76:                                               ; preds = %46, %42
  %.02 = phi i32 [ %49, %46 ], [ %45, %42 ]
  %.01 = phi i8* [ %48, %46 ], [ %44, %42 ]
  %77 = insertvalue { i8*, i32 } undef, i8* %.01, 0
  %78 = insertvalue { i8*, i32 } %77, i32 %.02, 1
  resume { i8*, i32 } %78
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s614237058.cpp() #0 section ".text.startup" {
