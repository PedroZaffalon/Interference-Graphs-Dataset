; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03498/s927995117.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03498/s927995117.cpp"
...
@a = global [80 x i32] zeroinitializer, align 16
@_ZSt3cin = external global %"class.std::basic_istream", align 8
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@.str = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@.str.1 = private unnamed_addr constant [2 x i8] c" \00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s927995117.cpp, i8* null }]
...
5:                                                ; preds = %2
  ...
  %7 = getelementptr inbounds [80 x i32], [80 x i32]* @a, i64 0, i64 %6
  ...
  %10 = getelementptr inbounds [80 x i32], [80 x i32]* @a, i64 0, i64 %9
  %11 = load i32, i32* %10, align 4
  %12 = call i32 @_Z4xabsi(i32 %11)
  %13 = icmp sgt i32 %12, %.01
  br i1 %13, label %14, label %19

14:                                               ; preds = %5
  %15 = sext i32 %.04 to i64
  %16 = getelementptr inbounds [80 x i32], [80 x i32]* @a, i64 0, i64 %15
  %17 = load i32, i32* %16, align 4
  %18 = call i32 @_Z4xabsi(i32 %17)
  br label %19

19:                                               ; preds = %14, %5
  %.13 = phi i32 [ %.04, %14 ], [ %.02, %5 ]
  %.1 = phi i32 [ %18, %14 ], [ %.01, %5 ]
  br label %20
...
22:                                               ; preds = %2
  ...
  %28 = getelementptr inbounds [80 x i32], [80 x i32]* @a, i64 0, i64 %27
  %29 = load i32, i32* %28, align 4
  %30 = icmp sgt i32 %29, 0
  br i1 %30, label %31, label %61

31:                                               ; preds = %22
  %32 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %.02)
...
43:                                               ; preds = %58, %31
  %.05 = phi i32 [ 2, %31 ], [ %59, %58 ]
  %44 = load i32, i32* @n, align 4
  %45 = icmp sle i32 %.05, %44
...
46:                                               ; preds = %43
  ...
  %56 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %55, i32 %.05)
...
61:                                               ; preds = %22
  %62 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %.02)
...
74:                                               ; preds = %70
  ...
  %77 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %76, i32 1)
  ...
  %81 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %80, i32 %.0)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s927995117.cpp() #0 section ".text.startup" {
