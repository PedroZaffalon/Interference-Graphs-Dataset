; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02502/s536417961.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02502/s536417961.cpp"
...
@y = global [20 x i8] zeroinitializer, align 16
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.2 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@.str.3 = private unnamed_addr constant [26 x i8] c"vector::_M_realloc_insert\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s536417961.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define void @_Z6subseti(i32 %0) #0 {
...
8:                                                ; preds = %5
  %9 = sext i32 %.0 to i64
  %10 = getelementptr inbounds [20 x i8], [20 x i8]* @y, i64 0, i64 %9
...
18:                                               ; preds = %8
  ...
  %20 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* @X, i64 %19) #3
  %21 = load i32, i32* %20, align 4
  %22 = add nsw i32 %.02, %21
  br label %23

23:                                               ; preds = %18, %13
  %.13 = phi i32 [ %.02, %13 ], [ %22, %18 ]
  %.1 = phi i32 [ %17, %13 ], [ %.01, %18 ]
  br label %24
...
35:                                               ; preds = %1
  ...
  %37 = getelementptr inbounds [20 x i8], [20 x i8]* @y, i64 0, i64 %36
  store i8 0, i8* %37, align 1
  %38 = add nsw i32 %0, 1
  call void @_Z6subseti(i32 %38)
  %39 = sext i32 %0 to i64
  %40 = getelementptr inbounds [20 x i8], [20 x i8]* @y, i64 0, i64 %39
  store i8 1, i8* %40, align 1
  %41 = add nsw i32 %0, 1
  call void @_Z6subseti(i32 %41)
  br label %42
...
11:                                               ; preds = %8
  ...
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* @X, i32* dereferenceable(4) %1)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s536417961.cpp() #0 section ".text.startup" {
