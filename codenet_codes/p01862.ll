; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01862/s551620250.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01862/s551620250.cpp"
...
@.str = private unnamed_addr constant [11 x i8] c"%.9f %.9f\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s551620250.cpp, i8* null }]
...
define i32 @main() #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %7 = call double @_ZSt4sqrtIiEN9__gnu_cxx11__enable_ifIXsr12__is_integerIT_EE7__valueEdE6__typeES2_(i32 5)
  %8 = fadd double 1.000000e+00, %7
  %9 = fdiv double %8, 2.000000e+00
  call void @_ZNSaIdEC2Ev(%"class.std::allocator"* %2) #3
  invoke void @_ZNSt6vectorIdSaIdEEC2EmRKS0_(%"class.std::vector"* %1, i64 10, %"class.std::allocator"* dereferenceable(1) %2)
...
20:                                               ; preds = %18, %17
  %21 = phi double [ 1.000000e+00, %17 ], [ %19, %18 ]
  %22 = sitofp i32 %.05 to double
...
47:                                               ; preds = %71, %46
  %.07 = phi double [ 0.000000e+00, %46 ], [ %70, %71 ]
  %.06 = phi i32 [ 0, %46 ], [ %72, %71 ]
  %48 = icmp slt i32 %.06, 10
  br i1 %48, label %49, label %73

49:                                               ; preds = %47
  %50 = sext i32 %.06 to i64
  %51 = call dereferenceable(8) double* @_ZNSt6vectorIdSaIdEEixEm(%"class.std::vector"* %1, i64 %50) #3
  ...
  %59 = call dereferenceable(8) double* @_ZNSt6vectorIdSaIdEEixEm(%"class.std::vector"* %1, i64 %58) #3
  %60 = load double, double* %59, align 8
  %61 = add nsw i32 %.06, 1
  %62 = srem i32 %61, 10
  %63 = sext i32 %62 to i64
  %64 = call dereferenceable(8) double* @_ZNSt6vectorIdSaIdEEixEm(%"class.std::vector"* %3, i64 %63) #3
  %65 = load double, double* %64, align 8
  %66 = fmul double %52, %65
  %67 = fmul double %60, %55
  %68 = fsub double %66, %67
  %69 = fdiv double %68, 2.000000e+00
  %70 = fadd double %.07, %69
  br label %71
...
76:                                               ; preds = %122, %75
  %.01 = phi i32 [ 0, %75 ], [ %123, %122 ]
  %77 = load i32, i32* %5, align 4
  %78 = icmp slt i32 %.01, %77
  br i1 %78, label %79, label %124

79:                                               ; preds = %76
  %80 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERd(%"class.std::basic_istream"* @_ZSt3cin, double* dereferenceable(8) %6)
...
81:                                               ; preds = %79
  ...
  %84 = srem i32 %.01, 10
  %85 = mul nsw i32 %84, 800
  %86 = add nsw i32 -3600, %85
  %87 = sitofp i32 %86 to double
  %88 = sdiv i32 %.01, 10
  %89 = mul nsw i32 %88, 800
  %90 = add nsw i32 -3600, %89
  %91 = sitofp i32 %90 to double
  %92 = load double, double* %6, align 8
  %93 = fdiv double %92, %.07
...
100:                                              ; preds = %115, %99
  ...
  %101 = icmp slt i32 %.0, 10
  br i1 %101, label %102, label %121

102:                                              ; preds = %100
  %103 = sext i32 %.0 to i64
  %104 = call dereferenceable(8) double* @_ZNSt6vectorIdSaIdEEixEm(%"class.std::vector"* %1, i64 %103) #3
  %105 = load double, double* %104, align 8
  %106 = fmul double %94, %105
  %107 = fadd double %87, %106
  %108 = sext i32 %.0 to i64
  %109 = call dereferenceable(8) double* @_ZNSt6vectorIdSaIdEEixEm(%"class.std::vector"* %3, i64 %108) #3
  %110 = load double, double* %109, align 8
  %111 = fmul double %94, %110
  %112 = fadd double %91, %111
  %113 = invoke i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0), double %107, double %112)
...
125:                                              ; preds = %117, %42
  %.03 = phi i32 [ %120, %117 ], [ %45, %42 ]
  %.02 = phi i8* [ %119, %117 ], [ %44, %42 ]
  call void @_ZNSt6vectorIdSaIdEED2Ev(%"class.std::vector"* %1) #3
  br label %126

126:                                              ; preds = %125, %38
  %.14 = phi i32 [ %.03, %125 ], [ %41, %38 ]
  %.1 = phi i8* [ %.02, %125 ], [ %40, %38 ]
  %127 = insertvalue { i8*, i32 } undef, i8* %.1, 0
  %128 = insertvalue { i8*, i32 } %127, i32 %.14, 1
  resume { i8*, i32 } %128
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s551620250.cpp() #0 section ".text.startup" {
