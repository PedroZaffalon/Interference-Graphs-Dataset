; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01333/s917895197.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01333/s917895197.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s917895197.cpp, i8* null }]
...
21:                                               ; preds = %15
  ...
  %34 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %33, i32 %28)
  ...
  %36 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %35, i32 %25)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s917895197.cpp() #0 section ".text.startup" {
