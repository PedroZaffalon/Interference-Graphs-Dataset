; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01327/s703583141.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01327/s703583141.cpp"
...
@.ref.tmp = private constant [4 x i32] [i32 4, i32 6, i32 9, i32 11], align 4
@_ZSt3cin = external global %"class.std::basic_istream", align 8
@.str = private unnamed_addr constant [6 x i8] c"%d/%d\00", align 1
@.str.1 = private unnamed_addr constant [6 x i8] c"%d:%d\00", align 1
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s703583141.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define double @_Z4calciiii(i32 %0, i32 %1, i32 %2, i32 %3) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
...
9:                                                ; preds = %4
  ...
  %10 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %5, i64 0) #3
  store i32 0, i32* %10, align 4
  %11 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %5, i64 2) #3
  store i32 29, i32* %11, align 4
  %12 = getelementptr inbounds %"class.std::initializer_list", %"class.std::initializer_list"* %8, i32 0, i32 0
  store i32* getelementptr inbounds ([4 x i32], [4 x i32]* @.ref.tmp, i64 0, i64 0), i32** %12, align 8
  %13 = getelementptr inbounds %"class.std::initializer_list", %"class.std::initializer_list"* %8, i32 0, i32 1
  store i64 4, i64* %13, align 8
  %14 = call i32* @_ZNKSt16initializer_listIiE5beginEv(%"class.std::initializer_list"* %8) #3
  %15 = call i32* @_ZNKSt16initializer_listIiE3endEv(%"class.std::initializer_list"* %8) #3
  br label %16

16:                                               ; preds = %22, %9
  %.01 = phi i32* [ %14, %9 ], [ %23, %22 ]
  %17 = icmp ne i32* %.01, %15
  br i1 %17, label %18, label %28

18:                                               ; preds = %16
  %19 = load i32, i32* %.01, align 4
  %20 = sext i32 %19 to i64
  %21 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %5, i64 %20) #3
  store i32 30, i32* %21, align 4
  br label %22

22:                                               ; preds = %18
  %23 = getelementptr inbounds i32, i32* %.01, i32 1
  br label %16
...
29:                                               ; preds = %40, %28
  %.0 = phi i32 [ 2, %28 ], [ %41, %40 ]
  %30 = icmp sle i32 %.0, 12
...
42:                                               ; preds = %29
  ...
  %51 = fdiv double %50, 2.400000e+01
  %52 = fadd double %49, %51
  %53 = sitofp i32 %3 to double
  %54 = fdiv double %53, 1.440000e+03
  %55 = fadd double %52, %54
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %5) #3
  ret double %55

56:                                               ; preds = %24
  %57 = insertvalue { i8*, i32 } undef, i8* %26, 0
  %58 = insertvalue { i8*, i32 } %57, i32 %27, 1
  resume { i8*, i32 } %58
}
...
; Function Attrs: noinline nounwind uwtable
define void @_Z6rotatedRdS_(double %0, double* dereferenceable(8) %1, double* dereferenceable(8) %2) #4 {
  %4 = call double @cos(double %0) #3
  %5 = load double, double* %1, align 8
  %6 = fmul double %4, %5
  %7 = call double @sin(double %0) #3
  %8 = fsub double -0.000000e+00, %7
  %9 = load double, double* %2, align 8
  %10 = fmul double %8, %9
  %11 = fadd double %6, %10
  %12 = call double @sin(double %0) #3
  %13 = load double, double* %1, align 8
  %14 = fmul double %12, %13
  %15 = call double @cos(double %0) #3
...
; Function Attrs: noinline nounwind uwtable
define double @_Z9to_radiand(double %0) #4 {
...
; Function Attrs: noinline nounwind uwtable
define void @_Z4makeddRdS_S_(double %0, double %1, double* dereferenceable(8) %2, double* dereferenceable(8) %3, double* dereferenceable(8) %4) #4 {
  %6 = call double @cos(double %0) #3
  store double %6, double* %2, align 8
  %7 = call double @sin(double %0) #3
  store double %7, double* %3, align 8
  %8 = call double @tan(double %1) #3
...
18:                                               ; preds = %15
  ...
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i32 0, i32 0), i32* %4, i32* %5)
  %21 = load i32, i32* %2, align 4
  %22 = load i32, i32* %3, align 4
  %23 = load i32, i32* %4, align 4
  %24 = load i32, i32* %5, align 4
  %25 = call double @_Z4calciiii(i32 %21, i32 %22, i32 %23, i32 %24)
  %26 = fmul double 0x40768FC53C5CBE89, %25
  %27 = call double @_Z9to_radiand(double %26)
  %28 = call double @_Z9to_radiand(double 4.320000e+01)
  %29 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* @_ZSt3cin, i32* dereferenceable(4) %6)
  br label %30

30:                                               ; preds = %75, %18
  %.03 = phi i32 [ 0, %18 ], [ %76, %75 ]
...
33:                                               ; preds = %30
  ...
  %34 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZStrsIcSt11char_traitsIcESaIcEERSt13basic_istreamIT_T0_ES7_RNSt7__cxx1112basic_stringIS4_S5_T1_EE(%"class.std::basic_istream"* dereferenceable(280) @_ZSt3cin, %"class.std::__cxx11::basic_string"* dereferenceable(32) %7)
...
38:                                               ; preds = %65, %37
  %.02 = phi i8 [ 1, %37 ], [ %.1, %65 ]
  %.0 = phi i32 [ 0, %37 ], [ %66, %65 ]
  %39 = load i32, i32* %8, align 4
  %40 = icmp slt i32 %.0, %39
  br i1 %40, label %41, label %67

41:                                               ; preds = %38
  %42 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERd(%"class.std::basic_istream"* @_ZSt3cin, double* dereferenceable(8) %9)
...
45:                                               ; preds = %43
  ...
  %47 = invoke double @_Z9to_radiand(double %46)
          to label %48 unwind label %60

48:                                               ; preds = %45
  %49 = load double, double* %10, align 8
  %50 = invoke double @_Z9to_radiand(double %49)
          to label %51 unwind label %60

51:                                               ; preds = %48
  invoke void @_Z4makeddRdS_S_(double %47, double %50, double* dereferenceable(8) %11, double* dereferenceable(8) %12, double* dereferenceable(8) %13)
          to label %52 unwind label %60

52:                                               ; preds = %51
  %53 = fsub double -0.000000e+00, %28
  invoke void @_Z6rotatedRdS_(double %53, double* dereferenceable(8) %11, double* dereferenceable(8) %13)
          to label %54 unwind label %60

54:                                               ; preds = %52
  invoke void @_Z6rotatedRdS_(double %27, double* dereferenceable(8) %12, double* dereferenceable(8) %13)
          to label %55 unwind label %60

55:                                               ; preds = %54
  invoke void @_Z6rotatedRdS_(double %28, double* dereferenceable(8) %11, double* dereferenceable(8) %13)
...
60:                                               ; preds = %71, %69, %55, %54, %52, %51, %48, %45, %43, %41, %35, %33
...
81:                                               ; preds = %60
  %82 = insertvalue { i8*, i32 } undef, i8* %62, 0
  %83 = insertvalue { i8*, i32 } %82, i32 %63, 1
  resume { i8*, i32 } %83
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s703583141.cpp() #0 section ".text.startup" {
