; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03957/s076037385.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03957/s076037385.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s076037385.cpp, i8* null }]
...
21:                                               ; preds = %13, %9
  %22 = invoke dereferenceable(1) i8* @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEixEm(%"class.std::__cxx11::basic_string"* %1, i64 %.0)
...
31:                                               ; preds = %29, %27, %23
  %.1 = phi i32 [ %30, %29 ], [ %.01, %27 ], [ %.01, %23 ]
  br label %32

32:                                               ; preds = %31, %15
  %.2 = phi i32 [ %16, %15 ], [ %.1, %31 ]
  br label %33
...
48:                                               ; preds = %17
  %49 = insertvalue { i8*, i32 } undef, i8* %19, 0
  %50 = insertvalue { i8*, i32 } %49, i32 %20, 1
  resume { i8*, i32 } %50
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s076037385.cpp() #0 section ".text.startup" {
