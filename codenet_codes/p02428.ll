; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02428/s336526590.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02428/s336526590.cpp"
...
$_ZNSt6bitsetILm18EE5resetEm = comdat any

$_ZNKSt6bitsetILm18EE3anyEv = comdat any
...
$_ZNSt6bitsetILm18EE16_Unchecked_resetEm = comdat any
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s336526590.cpp, i8* null }]
...
11:                                               ; preds = %0
  ...
  call void @_ZNSt6bitsetILm18EEC2Ey(%"class.std::bitset"* %5, i64 0) #3
  br label %12
...
19:                                               ; preds = %15
  ...
  %24 = invoke dereferenceable(8) %"class.std::bitset"* @_ZNSt6bitsetILm18EE3setEmb(%"class.std::bitset"* %5, i64 %23, i1 zeroext true)
...
32:                                               ; preds = %81, %75, %73, %63, %61, %51, %19, %15
...
41:                                               ; preds = %37
  %42 = bitcast %"class.std::bitset"* %6 to i8*
  %43 = bitcast %"class.std::bitset"* %5 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %42, i8* align 8 %43, i64 8, i1 false)
  br label %44

44:                                               ; preds = %56, %41
  %.05 = phi i32 [ 0, %41 ], [ %57, %56 ]
...
51:                                               ; preds = %47
  ...
  %53 = invoke dereferenceable(8) %"class.std::bitset"* @_ZNSt6bitsetILm18EE5resetEm(%"class.std::bitset"* %6, i64 %52)
...
58:                                               ; preds = %44
  %59 = call zeroext i1 @_ZNKSt6bitsetILm18EE3anyEv(%"class.std::bitset"* %6) #3
...
61:                                               ; preds = %58
  %62 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %.04)
...
75:                                               ; preds = %73
  %76 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %74, i32 %.0)
...
87:                                               ; preds = %32, %28
  ...
  %88 = insertvalue { i8*, i32 } undef, i8* %.01, 0
  %89 = insertvalue { i8*, i32 } %88, i32 %.02, 1
  resume { i8*, i32 } %89
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt6bitsetILm18EEC2Ey(%"class.std::bitset"* %0, i64 %1) unnamed_addr #5 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %3 = bitcast %"class.std::bitset"* %0 to %"struct.std::_Base_bitset"*
  %4 = invoke i64 @_ZNSt13_Sanitize_valILm18ELb1EE18_S_do_sanitize_valEy(i64 %1)
          to label %5 unwind label %6
...
; Function Attrs: noinline uwtable
define linkonce_odr dereferenceable(8) %"class.std::bitset"* @_ZNSt6bitsetILm18EE3setEmb(%"class.std::bitset"* %0, i64 %1, i1 zeroext %2) #0 comdat align 2 {
  %4 = zext i1 %2 to i8
  call void @_ZNKSt6bitsetILm18EE8_M_checkEmPKc(%"class.std::bitset"* %0, i64 %1, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.2, i32 0, i32 0))
  %5 = trunc i8 %4 to i1
  %6 = zext i1 %5 to i32
  %7 = call dereferenceable(8) %"class.std::bitset"* @_ZNSt6bitsetILm18EE14_Unchecked_setEmi(%"class.std::bitset"* %0, i64 %1, i32 %6) #3
  ret %"class.std::bitset"* %7
}

; Function Attrs: noinline uwtable
define linkonce_odr dereferenceable(8) %"class.std::bitset"* @_ZNSt6bitsetILm18EE5resetEm(%"class.std::bitset"* %0, i64 %1) #0 comdat align 2 {
  call void @_ZNKSt6bitsetILm18EE8_M_checkEmPKc(%"class.std::bitset"* %0, i64 %1, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.4, i32 0, i32 0))
  %3 = call dereferenceable(8) %"class.std::bitset"* @_ZNSt6bitsetILm18EE16_Unchecked_resetEm(%"class.std::bitset"* %0, i64 %1) #3
  ret %"class.std::bitset"* %3
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr zeroext i1 @_ZNKSt6bitsetILm18EE3anyEv(%"class.std::bitset"* %0) #5 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64 @_ZNSt13_Sanitize_valILm18ELb1EE18_S_do_sanitize_valEy(i64 %0) #5 comdat align 2 {
  %2 = and i64 %0, 262143
  ret i64 %2
}
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNKSt6bitsetILm18EE8_M_checkEmPKc(%"class.std::bitset"* %0, i64 %1, i8* %2) #0 comdat align 2 {
  %4 = icmp uge i64 %1, 18
  br i1 %4, label %5, label %6

5:                                                ; preds = %3
  call void (i8*, ...) @_ZSt24__throw_out_of_range_fmtPKcz(i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.3, i32 0, i32 0), i8* %2, i64 %1, i64 18) #12
  unreachable
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(8) %"class.std::bitset"* @_ZNSt6bitsetILm18EE14_Unchecked_setEmi(%"class.std::bitset"* %0, i64 %1, i32 %2) #5 comdat align 2 {
  %4 = icmp ne i32 %2, 0
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(8) %"class.std::bitset"* @_ZNSt6bitsetILm18EE16_Unchecked_resetEm(%"class.std::bitset"* %0, i64 %1) #5 comdat align 2 {
  %3 = call i64 @_ZNSt12_Base_bitsetILm1EE10_S_maskbitEm(i64 %1) #3
  %4 = xor i64 %3, -1
  %5 = bitcast %"class.std::bitset"* %0 to %"struct.std::_Base_bitset"*
  %6 = call dereferenceable(8) i64* @_ZNSt12_Base_bitsetILm1EE10_M_getwordEm(%"struct.std::_Base_bitset"* %5, i64 %1) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s336526590.cpp() #0 section ".text.startup" {
