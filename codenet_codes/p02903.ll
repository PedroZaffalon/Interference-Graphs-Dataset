; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02903/s586384115.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02903/s586384115.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s586384115.cpp, i8* null }]
...
13:                                               ; preds = %27, %12
  %.04 = phi i32 [ 0, %12 ], [ %.15, %27 ]
  %.0 = phi i32 [ 1, %12 ], [ %28, %27 ]
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s586384115.cpp() #0 section ".text.startup" {
