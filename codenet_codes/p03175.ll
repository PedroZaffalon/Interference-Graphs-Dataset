; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03175/s430110580.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03175/s430110580.cpp"
...
@dp = global [100005 x %"class.std::vector"] zeroinitializer, align 16
@_ZSt3cin = external global %"class.std::basic_istream", align 8
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@.str = private unnamed_addr constant [26 x i8] c"vector::_M_realloc_insert\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s430110580.cpp, i8* null }]
...
1:                                                ; preds = %1, %0
  %2 = phi %"class.std::vector"* [ getelementptr inbounds ([100005 x %"class.std::vector"], [100005 x %"class.std::vector"]* @dp, i32 0, i32 0), %0 ], [ %3, %1 ]
  call void @_ZNSt6vectorIiSaIiEEC2Ev(%"class.std::vector"* %2) #3
  %3 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %2, i64 1
  %4 = icmp eq %"class.std::vector"* %3, getelementptr inbounds ([100005 x %"class.std::vector"], [100005 x %"class.std::vector"]* @dp, i64 1, i64 0)
...
2:                                                ; preds = %2, %1
  %3 = phi %"class.std::vector"* [ getelementptr inbounds ([100005 x %"class.std::vector"], [100005 x %"class.std::vector"]* @dp, i64 1, i64 0), %1 ], [ %4, %2 ]
  %4 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %3, i64 -1
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %4) #3
  %5 = icmp eq %"class.std::vector"* %4, getelementptr inbounds ([100005 x %"class.std::vector"], [100005 x %"class.std::vector"]* @dp, i32 0, i32 0)
...
define i64 @_Z1fiii(i32 %0, i32 %1, i32 %2) #0 {
  ...
  %6 = sext i32 %0 to i64
  %7 = getelementptr inbounds [100005 x %"class.std::vector"], [100005 x %"class.std::vector"]* @dp, i64 0, i64 %6
...
20:                                               ; preds = %18
  %21 = call i64 @_Z1fiii(i32 %16, i32 %0, i32 0)
  %22 = mul nsw i64 %.0, %21
  %23 = srem i64 %22, 1000000007
  br label %30

24:                                               ; preds = %18
  %25 = call i64 @_Z1fiii(i32 %16, i32 %0, i32 1)
  %26 = call i64 @_Z1fiii(i32 %16, i32 %0, i32 0)
...
9:                                                ; preds = %5
  ...
  %18 = getelementptr inbounds [100005 x %"class.std::vector"], [100005 x %"class.std::vector"]* @dp, i64 0, i64 %17
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %18, i32* dereferenceable(4) %3)
  %19 = load i32, i32* %3, align 4
  %20 = sext i32 %19 to i64
  %21 = getelementptr inbounds [100005 x %"class.std::vector"], [100005 x %"class.std::vector"]* @dp, i64 0, i64 %20
...
24:                                               ; preds = %5
  %25 = call i64 @_Z1fiii(i32 0, i32 0, i32 0)
  %26 = call i64 @_Z1fiii(i32 0, i32 0, i32 1)
  %27 = add nsw i64 %25, %26
  %28 = srem i64 %27, 1000000007
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s430110580.cpp() #0 section ".text.startup" {
