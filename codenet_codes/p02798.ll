; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02798/s368804904.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02798/s368804904.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s368804904.cpp, i8* null }]
...
5:                                                ; preds = %2
  %6 = sdiv i64 %1, 2
  %7 = call i64 @_Z6powModxx(i64 %0, i64 %6)
  %8 = srem i64 %1, 2
  %9 = icmp eq i64 %8, 0
...
define i32 @main() #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  invoke void @_ZNSt6vectorISt4pairIiiESaIS1_EEC2EmRKS2_(%"class.std::vector"* %2, i64 %13, %"class.std::allocator"* dereferenceable(1) %3)
...
30:                                               ; preds = %249, %246, %243, %241, %78, %38, %18
...
38:                                               ; preds = %35
  ...
  %40 = call dereferenceable(8) %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EEixEm(%"class.std::vector"* %2, i64 %39) #3
...
50:                                               ; preds = %232, %46
  %.06 = phi i64 [ 0, %46 ], [ %233, %232 ]
  %51 = icmp slt i64 %.06, %49
...
53:                                               ; preds = %76, %52
  %.07 = phi i32 [ 0, %52 ], [ %77, %76 ]
  %54 = load i32, i32* %1, align 4
  %55 = icmp slt i32 %.07, %54
  br i1 %55, label %56, label %78

56:                                               ; preds = %53
  %57 = zext i32 %.07 to i64
  %58 = ashr i64 %.06, %57
  %59 = and i64 %58, 1
  %60 = icmp ne i64 %59, 0
...
78:                                               ; preds = %53
  ...
  %80 = getelementptr inbounds [30 x i32], [30 x i32]* %5, i32 0, i32 0
  %81 = load i32, i32* %1, align 4
  %82 = sext i32 %81 to i64
  %83 = getelementptr inbounds i32, i32* %80, i64 %82
  invoke void @_ZSt4sortIPiEvT_S1_(i32* %79, i32* %83)
...
84:                                               ; preds = %78
  ...
  invoke void @_ZNSt6vectorIiSaIiEEC2EmRKiRKS0_(%"class.std::vector.0"* %6, i64 %86, i32* dereferenceable(4) %7, %"class.std::allocator.2"* dereferenceable(1) %8)
          to label %87 unwind label %125

87:                                               ; preds = %84
  call void @_ZNSaIiED2Ev(%"class.std::allocator.2"* %8) #3
  %88 = bitcast [30 x i32]* %9 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %88, i8 0, i64 120, i1 false)
  br label %89

89:                                               ; preds = %166, %87
  %.08 = phi i32 [ 0, %87 ], [ %167, %166 ]
  %90 = load i32, i32* %1, align 4
  %91 = icmp slt i32 %.08, %90
  br i1 %91, label %92, label %168

92:                                               ; preds = %89
  %93 = zext i32 %.08 to i64
  %94 = ashr i64 %.06, %93
  %95 = and i64 %94, 1
  %96 = icmp ne i64 %95, 0
...
98:                                               ; preds = %130, %97
  %.09 = phi i32 [ 0, %97 ], [ %131, %130 ]
  %99 = load i32, i32* %1, align 4
  %100 = icmp slt i32 %.09, %99
  br i1 %100, label %101, label %132

101:                                              ; preds = %98
  %102 = sext i32 %.08 to i64
  %103 = call dereferenceable(8) %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EEixEm(%"class.std::vector"* %2, i64 %102) #3
...
110:                                              ; preds = %101
  %111 = sub nsw i32 %.09, %.08
  %112 = call i32 @abs(i32 %111) #15
  %113 = srem i32 %112, 2
...
137:                                              ; preds = %134
  ...
  %143 = getelementptr inbounds [30 x i32], [30 x i32]* %5, i64 0, i64 %142
  %144 = load i32, i32* %143, align 4
  %145 = icmp eq i32 %141, %144
  br i1 %145, label %146, label %161

146:                                              ; preds = %137
  %147 = sub nsw i32 %.010, %.08
  %148 = call i32 @abs(i32 %147) #15
  %149 = srem i32 %148, 2
...
169:                                              ; preds = %179, %168
  %.013 = phi i32 [ 0, %168 ], [ %180, %179 ]
  %.011 = phi i8 [ 0, %168 ], [ %.112, %179 ]
  %170 = load i32, i32* %1, align 4
  %171 = icmp slt i32 %.013, %170
  br i1 %171, label %172, label %181

172:                                              ; preds = %169
  %173 = sext i32 %.013 to i64
  %174 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.0"* %6, i64 %173) #3
...
185:                                              ; preds = %223, %184
  %.017 = phi i32 [ 0, %184 ], [ %224, %223 ]
  %.015 = phi i64 [ 0, %184 ], [ %.3, %223 ]
  %186 = load i32, i32* %1, align 4
  %187 = icmp slt i32 %.017, %186
...
189:                                              ; preds = %202, %188
  %.018 = phi i32 [ 0, %188 ], [ %203, %202 ]
  %.116 = phi i64 [ %.015, %188 ], [ %.2, %202 ]
  %190 = icmp slt i32 %.018, %.017
  br i1 %190, label %191, label %204

191:                                              ; preds = %189
  %192 = sext i32 %.017 to i64
  %193 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.0"* %6, i64 %192) #3
  %194 = load i32, i32* %193, align 4
  %195 = sext i32 %.018 to i64
  %196 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.0"* %6, i64 %195) #3
  %197 = load i32, i32* %196, align 4
  %198 = icmp slt i32 %194, %197
  br i1 %198, label %199, label %201

199:                                              ; preds = %191
  %200 = add nsw i64 %.116, 1
  br label %201

201:                                              ; preds = %199, %191
  %.2 = phi i64 [ %200, %199 ], [ %.116, %191 ]
  br label %202

202:                                              ; preds = %201
  %203 = add nsw i32 %.018, 1
  br label %189

204:                                              ; preds = %189
  %205 = add nsw i32 %.017, 1
  br label %206

206:                                              ; preds = %220, %204
  %.3 = phi i64 [ %.116, %204 ], [ %.4, %220 ]
  %.05 = phi i32 [ %205, %204 ], [ %221, %220 ]
  %207 = load i32, i32* %1, align 4
  %208 = icmp slt i32 %.05, %207
  br i1 %208, label %209, label %222

209:                                              ; preds = %206
  %210 = sext i32 %.017 to i64
  %211 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.0"* %6, i64 %210) #3
  %212 = load i32, i32* %211, align 4
  %213 = sext i32 %.05 to i64
  %214 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.0"* %6, i64 %213) #3
...
223:                                              ; preds = %222
  %224 = add nsw i32 %.017, 1
  br label %185

225:                                              ; preds = %185
  %226 = sdiv i64 %.015, 2
  store i64 %226, i64* %10, align 8
  %227 = invoke dereferenceable(8) i64* @_ZSt3minIxERKT_S2_S2_(i64* dereferenceable(8) %4, i64* dereferenceable(8) %10)
...
253:                                              ; preds = %234, %125, %30
  %.01 = phi i32 [ %33, %30 ], [ %237, %234 ], [ %128, %125 ]
  %.0 = phi i8* [ %32, %30 ], [ %236, %234 ], [ %127, %125 ]
  call void @_ZNSt6vectorISt4pairIiiESaIS1_EED2Ev(%"class.std::vector"* %2) #3
  br label %254

254:                                              ; preds = %253, %26
  %.12 = phi i32 [ %.01, %253 ], [ %29, %26 ]
  %.1 = phi i8* [ %.0, %253 ], [ %28, %26 ]
  %255 = insertvalue { i8*, i32 } undef, i8* %.1, 0
  %256 = insertvalue { i8*, i32 } %255, i32 %.12, 1
  resume { i8*, i32 } %256
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s368804904.cpp() #0 section ".text.startup" {
