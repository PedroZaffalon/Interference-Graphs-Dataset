; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03976/s891941638.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03976/s891941638.c"
...
@path = common global [200000 x %struct.struct_b] zeroinitializer, align 16
...
; Function Attrs: noinline nounwind uwtable
define i32 @pullrevcomp(i8* %0, i8* %1) #0 {
  %3 = bitcast i8* %0 to i64*
  %4 = load i64, i64* %3, align 8
  %5 = bitcast i8* %1 to i64*
  %6 = load i64, i64* %5, align 8
...
define i32 @phwllABcomp(i8* %0, i8* %1) #0 {
  ...
  %14 = load i64, i64* %13, align 8
  %15 = call i32 @sllcomp(i64 %12, i64 %14)
  %16 = icmp ne i32 %15, 0
...
18:                                               ; preds = %2
  %19 = getelementptr inbounds %struct.hwll, %struct.hwll* %3, i32 0, i32 1
  %20 = load i64, i64* %19, align 8
  %21 = getelementptr inbounds %struct.hwll, %struct.hwll* %4, i32 0, i32 1
  %22 = load i64, i64* %21, align 8
  %23 = call i32 @sllcomp(i64 %20, i64 %22)
  br label %24

24:                                               ; preds = %18, %17
  %.0 = phi i32 [ %15, %17 ], [ %23, %18 ]
  ret i32 %.0
}
...
; Function Attrs: noinline nounwind uwtable
define zeroext i1 @nextrouteint(i32* %0, i32 %1) #0 {
  %3 = sub nsw i32 %1, 1
  br label %4
...
; Function Attrs: noinline nounwind uwtable
define zeroext i1 @nextrouteull(i64* %0, i32 %1) #0 {
  %3 = sub nsw i32 %1, 1
  br label %4
...
49:                                               ; preds = %23
  ...
  %77 = sub nsw i32 %1, %.03
  %78 = sext i32 %77 to i64
  call void @qsort(i8* %76, i64 %78, i64 8, i32 (i8*, i8*)* @pintcomp)
  br label %79
...
4:                                                ; preds = %1
  %5 = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i32 0, i32 0), i8* @ch)
  %6 = load i8, i8* @ch, align 1
  %7 = sext i8 %6 to i32
  %8 = sub nsw i32 %7, 65
  %9 = sext i32 %8 to i64
  %10 = getelementptr inbounds [26 x i64], [26 x i64]* @alphabets, i64 0, i64 %9
...
16:                                               ; preds = %33, %15
  %.01 = phi i64 [ 0, %15 ], [ %34, %33 ]
  call void @qsort(i8* bitcast ([26 x i64]* @alphabets to i8*), i64 26, i64 8, i32 (i8*, i8*)* @pullrevcomp)
  %17 = load i64, i64* @k, align 8
  %18 = sub i64 %17, 1
  %19 = getelementptr inbounds [26 x i64], [26 x i64]* @alphabets, i64 0, i64 %18
  %20 = load i64, i64* %19, align 8
...
24:                                               ; preds = %31, %23
  %.1 = phi i64 [ 0, %23 ], [ %32, %31 ]
  %25 = load i64, i64* @k, align 8
  %26 = icmp ult i64 %.1, %25
  br i1 %26, label %27, label %33

27:                                               ; preds = %24
  %28 = getelementptr inbounds [26 x i64], [26 x i64]* @alphabets, i64 0, i64 %.1
...
35:                                               ; preds = %22
  %36 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.4, i32 0, i32 0), i64 %.01)
  br label %41

37:                                               ; No predecessors!
  %38 = call i32 @puts(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.5, i32 0, i32 0))
  store i64 0, i64* poison, align 8
  br label %41

39:                                               ; No predecessors!
  %40 = call i32 @puts(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.6, i32 0, i32 0))
...
; Function Attrs: noinline nounwind uwtable
define i32 @main() #0 {
  %1 = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.7, i32 0, i32 0), i64* @n, i64* @m)
  %2 = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.7, i32 0, i32 0), i64* @k, i64* @m, i64* @n)
  %3 = call i64 @solve()
  ret i32 0
}
