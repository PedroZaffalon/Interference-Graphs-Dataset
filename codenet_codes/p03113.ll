; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03113/s246552213.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03113/s246552213.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s246552213.cpp, i8* null }]
...
define i32 @main() #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  invoke void @_ZNSt6vectorISt4pairIiiESaIS1_EEC2EmRKS2_(%"class.std::vector"* %3, i64 %19, %"class.std::allocator"* dereferenceable(1) %4)
...
29:                                               ; preds = %24
  ...
  %32 = call dereferenceable(8) %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EEixEm(%"class.std::vector"* %3, i64 %31) #3
...
44:                                               ; preds = %21
  %45 = call %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EE5beginEv(%"class.std::vector"* %3) #3
  %46 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %5, i32 0, i32 0
  store %"struct.std::pair"* %45, %"struct.std::pair"** %46, align 8
  %47 = call %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EE3endEv(%"class.std::vector"* %3) #3
  ...
  invoke void @_ZSt4sortIN9__gnu_cxx17__normal_iteratorIPSt4pairIiiESt6vectorIS3_SaIS3_EEEESt7greaterIS3_EEvT_SB_T0_(%"struct.std::pair"* %50, %"struct.std::pair"* %52)
...
56:                                               ; preds = %112, %53
  %.08 = phi i8 [ 0, %53 ], [ %.19, %112 ]
  %.06 = phi i32 [ %55, %53 ], [ %.17, %112 ]
  br label %57
...
58:                                               ; preds = %105, %57
  %.014 = phi i32 [ 0, %57 ], [ %106, %105 ]
  %.012 = phi i8 [ 0, %57 ], [ %.113, %105 ]
  %.19 = phi i8 [ %.08, %57 ], [ %.311, %105 ]
  %.17 = phi i32 [ %.06, %57 ], [ %.4, %105 ]
...
75:                                               ; preds = %139, %133, %128, %123, %117, %113, %79, %72, %70
...
79:                                               ; preds = %61
  ...
  invoke void @_ZNSt6vectorIiSaIiEE12emplace_backIJRiEEEvDpOT_(%"class.std::vector.0"* %7, i32* dereferenceable(4) %87)
          to label %88 unwind label %75

88:                                               ; preds = %79
  %89 = icmp eq i32 %.014, %.17
  br i1 %89, label %90, label %100

90:                                               ; preds = %88
  %91 = icmp eq i32 %.014, 0
...
104:                                              ; preds = %103, %100
  %.210 = phi i8 [ 1, %103 ], [ %.19, %100 ]
  br label %105

105:                                              ; preds = %104, %69
  %.113 = phi i8 [ %.012, %69 ], [ 1, %104 ]
  %.311 = phi i8 [ %.19, %69 ], [ %.210, %104 ]
  %.4 = phi i32 [ %.17, %69 ], [ %.3, %104 ]
  %106 = add nsw i32 %.014, 1
  br label %58

107:                                              ; preds = %58
  %108 = trunc i8 %.19 to i1
  br i1 %108, label %109, label %112

109:                                              ; preds = %107
  %110 = trunc i8 %.012 to i1
...
113:                                              ; preds = %111
  %114 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector.0"* %7) #3
...
123:                                              ; preds = %120
  ...
  %125 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.0"* %7, i64 %124) #3
...
131:                                              ; preds = %130
  %132 = add nsw i32 %.05, 1
  br label %120

133:                                              ; preds = %120
  %134 = sub nsw i32 %115, 1
...
143:                                              ; preds = %75, %40
  %.02 = phi i32 [ %43, %40 ], [ %78, %75 ]
  %.01 = phi i8* [ %42, %40 ], [ %77, %75 ]
  call void @_ZNSt6vectorISt4pairIiiESaIS1_EED2Ev(%"class.std::vector"* %3) #3
  br label %144

144:                                              ; preds = %143, %36
  %.13 = phi i32 [ %.02, %143 ], [ %39, %36 ]
  %.1 = phi i8* [ %.01, %143 ], [ %38, %36 ]
  %145 = insertvalue { i8*, i32 } undef, i8* %.1, 0
  %146 = insertvalue { i8*, i32 } %145, i32 %.13, 1
  resume { i8*, i32 } %146
}
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt6vectorIiSaIiEE12emplace_backIJRiEEEvDpOT_(%"class.std::vector.0"* %0, i32* dereferenceable(4) %1) #0 comdat align 2 {
...
13:                                               ; preds = %2
  ...
  %21 = call dereferenceable(4) i32* @_ZSt7forwardIRiEOT_RNSt16remove_referenceIS1_E4typeE(i32* dereferenceable(4) %1) #3
  call void @_ZNSt16allocator_traitsISaIiEE9constructIiJRiEEEvRS0_PT_DpOT0_(%"class.std::allocator.2"* dereferenceable(1) %16, i32* %20, i32* dereferenceable(4) %21)
...
27:                                               ; preds = %2
  ...
  %30 = call dereferenceable(4) i32* @_ZSt7forwardIRiEOT_RNSt16remove_referenceIS1_E4typeE(i32* dereferenceable(4) %1) #3
  %31 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator.5", %"class.__gnu_cxx::__normal_iterator.5"* %3, i32 0, i32 0
  %32 = load i32*, i32** %31, align 8
  call void @_ZNSt6vectorIiSaIiEE17_M_realloc_insertIJRiEEEvN9__gnu_cxx17__normal_iteratorIPiS1_EEDpOT_(%"class.std::vector.0"* %0, i32* %32, i32* dereferenceable(4) %30)
  br label %33
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(1) %"struct.__gnu_cxx::__ops::_Iter_comp_iter"* @_ZSt4moveIRN9__gnu_cxx5__ops15_Iter_comp_iterISt7greaterISt4pairIiiEEEEEONSt16remove_referenceIT_E4typeEOSA_(%"struct.__gnu_cxx::__ops::_Iter_comp_iter"* dereferenceable(1) %0) #5 comdat {
  ret %"struct.__gnu_cxx::__ops::_Iter_comp_iter"* %0
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx5__ops14_Iter_comp_valISt7greaterISt4pairIiiEEEC2EONS0_15_Iter_comp_iterIS5_EE(%"struct.__gnu_cxx::__ops::_Iter_comp_val"* %0, %"struct.__gnu_cxx::__ops::_Iter_comp_iter"* dereferenceable(1) %1) unnamed_addr #5 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(1) %"struct.std::greater"* @_ZSt4moveIRSt7greaterISt4pairIiiEEEONSt16remove_referenceIT_E4typeEOS6_(%"struct.std::greater"* dereferenceable(1) %0) #5 comdat {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx5__ops14_Val_comp_iterISt7greaterISt4pairIiiEEEC2EONS0_15_Iter_comp_iterIS5_EE(%"struct.__gnu_cxx::__ops::_Val_comp_iter"* %0, %"struct.__gnu_cxx::__ops::_Iter_comp_iter"* dereferenceable(1) %1) unnamed_addr #5 comdat align 2 {
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt16allocator_traitsISaIiEE9constructIiJRiEEEvRS0_PT_DpOT0_(%"class.std::allocator.2"* dereferenceable(1) %0, i32* %1, i32* dereferenceable(4) %2) #0 comdat align 2 {
  %4 = bitcast %"class.std::allocator.2"* %0 to %"class.__gnu_cxx::new_allocator.3"*
  %5 = call dereferenceable(4) i32* @_ZSt7forwardIRiEOT_RNSt16remove_referenceIS1_E4typeE(i32* dereferenceable(4) %2) #3
  call void @_ZN9__gnu_cxx13new_allocatorIiE9constructIiJRiEEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator.3"* %4, i32* %1, i32* dereferenceable(4) %5)
  ret void
}
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt6vectorIiSaIiEE17_M_realloc_insertIJRiEEEvN9__gnu_cxx17__normal_iteratorIPiS1_EEDpOT_(%"class.std::vector.0"* %0, i32* %1, i32* dereferenceable(4) %2) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  invoke void @_ZNSt16allocator_traitsISaIiEE9constructIiJRiEEEvRS0_PT_DpOT0_(%"class.std::allocator.2"* dereferenceable(1) %23, i32* %24, i32* dereferenceable(4) %25)
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorIiE9constructIiJRiEEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator.3"* %0, i32* %1, i32* dereferenceable(4) %2) #5 comdat align 2 {
  %4 = bitcast i32* %1 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s246552213.cpp() #0 section ".text.startup" {
