; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02796/s214307518.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02796/s214307518.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s214307518.cpp, i8* null }]
...
42:                                               ; preds = %12
  %43 = call %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EE5beginEv(%"class.std::vector"* %2) #3
  %44 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %6, i32 0, i32 0
  store %"struct.std::pair"* %43, %"struct.std::pair"** %44, align 8
  %45 = call %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EE3endEv(%"class.std::vector"* %2) #3
...
52:                                               ; preds = %68, %51
  %.05 = phi i32 [ -1000000000, %51 ], [ %.16, %68 ]
  %.04 = phi i32 [ 0, %51 ], [ %.1, %68 ]
  %.0 = phi i32 [ 0, %51 ], [ %69, %68 ]
...
67:                                               ; preds = %61, %55
  %.16 = phi i32 [ %66, %61 ], [ %.05, %55 ]
  %.1 = phi i32 [ %62, %61 ], [ %.04, %55 ]
  br label %68
...
70:                                               ; preds = %52
  %71 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %.04)
...
75:                                               ; preds = %38, %34
  ...
  %76 = insertvalue { i8*, i32 } undef, i8* %.01, 0
  %77 = insertvalue { i8*, i32 } %76, i32 %.02, 1
  resume { i8*, i32 } %77
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s214307518.cpp() #0 section ".text.startup" {
