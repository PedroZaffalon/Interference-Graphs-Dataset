; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02862/s104667073.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02862/s104667073.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s104667073.cpp, i8* null }]
...
define i32 @_Z5powerxxx(i64 %0, i64 %1, i64 %2) #4 {
  %4 = srem i64 %0, %2
  br label %5
...
49:                                               ; preds = %28
  %50 = invoke i32 @_Z5powerxxx(i64 0, i64 1000000005, i64 1000000007)
...
62:                                               ; preds = %58, %45
  %.02 = phi i32 [ %61, %58 ], [ %48, %45 ]
  %.01 = phi i8* [ %60, %58 ], [ %47, %45 ]
  %63 = insertvalue { i8*, i32 } undef, i8* %.01, 0
  %64 = insertvalue { i8*, i32 } %63, i32 %.02, 1
  resume { i8*, i32 } %64
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s104667073.cpp() #0 section ".text.startup" {
