; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01415/s799983078.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01415/s799983078.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s799983078.cpp, i8* null }]
...
23:                                               ; preds = %21
  %24 = invoke { %"struct.std::_Rb_tree_node_base"*, i8 } @_ZNSt3setIiSt4lessIiESaIiEE6insertERKi(%"class.std::set"* %7, i32* dereferenceable(4) %8)
...
33:                                               ; preds = %93, %91, %89, %84, %82, %42, %23, %21
...
38:                                               ; preds = %79, %37
  %.03 = phi i32 [ 0, %37 ], [ %.36, %79 ]
  %.01 = phi i32 [ 0, %37 ], [ %.4, %79 ]
  %.0 = phi double [ 0.000000e+00, %37 ], [ %.1, %79 ]
...
42:                                               ; preds = %38
  %43 = invoke i64 @_ZNKSt3setIiSt4lessIiESaIiEE5countERKi(%"class.std::set"* %7, i32* dereferenceable(4) %10)
...
55:                                               ; preds = %51, %49
  %.14 = phi i32 [ %50, %49 ], [ %.03, %51 ]
  %.12 = phi i32 [ %.01, %49 ], [ %54, %51 ]
  br label %56

56:                                               ; preds = %55, %44
  %.25 = phi i32 [ %.14, %55 ], [ %.03, %44 ]
  %.2 = phi i32 [ %.12, %55 ], [ %.01, %44 ]
  %57 = icmp eq i32 %.2, 0
...
65:                                               ; preds = %60, %58, %56
  %.36 = phi i32 [ %61, %60 ], [ %.25, %58 ], [ %.25, %56 ]
  %.3 = phi i32 [ %64, %60 ], [ %.2, %58 ], [ %.2, %56 ]
  %66 = icmp sgt i32 %.3, 0
...
78:                                               ; preds = %73, %67
  %.4 = phi i32 [ %68, %67 ], [ %.3, %73 ]
  %.1 = phi double [ %72, %67 ], [ %77, %73 ]
  br label %79
...
82:                                               ; preds = %38
  %83 = invoke i32 @_ZSt12setprecisioni(i32 9)
...
84:                                               ; preds = %82
  ...
  %88 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_St13_Setprecision(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i32 %87)
          to label %89 unwind label %33

89:                                               ; preds = %84
  %90 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEPFRSt8ios_baseS0_E(%"class.std::basic_ostream"* %88, %"class.std::ios_base"* (%"class.std::ios_base"*)* @_ZSt5fixedRSt8ios_base)
          to label %91 unwind label %33

91:                                               ; preds = %89
  %92 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEd(%"class.std::basic_ostream"* %90, double %.0)
...
96:                                               ; preds = %33
  %97 = insertvalue { i8*, i32 } undef, i8* %35, 0
  %98 = insertvalue { i8*, i32 } %97, i32 %36, 1
  resume { i8*, i32 } %98
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr %"struct.std::_Rb_tree_node"* @_ZNKSt8_Rb_treeIiiSt9_IdentityIiESt4lessIiESaIiEE8_M_beginEv(%"class.std::_Rb_tree"* %0) #5 comdat align 2 {
  %2 = getelementptr inbounds %"class.std::_Rb_tree", %"class.std::_Rb_tree"* %0, i32 0, i32 0
  %3 = bitcast %"struct.std::_Rb_tree<int, int, std::_Identity<int>, std::less<int>, std::allocator<int> >::_Rb_tree_impl"* %2 to i8*
  %4 = getelementptr inbounds i8, i8* %3, i64 8
  %5 = bitcast i8* %4 to %"struct.std::_Rb_tree_header"*
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr %"struct.std::_Rb_tree_node_base"* @_ZNKSt8_Rb_treeIiiSt9_IdentityIiESt4lessIiESaIiEE6_M_endEv(%"class.std::_Rb_tree"* %0) #5 comdat align 2 {
  %2 = getelementptr inbounds %"class.std::_Rb_tree", %"class.std::_Rb_tree"* %0, i32 0, i32 0
  %3 = bitcast %"struct.std::_Rb_tree<int, int, std::_Identity<int>, std::less<int>, std::allocator<int> >::_Rb_tree_impl"* %2 to i8*
  %4 = getelementptr inbounds i8, i8* %3, i64 8
  %5 = bitcast i8* %4 to %"struct.std::_Rb_tree_header"*
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIiiSt9_IdentityIiESt4lessIiESaIiEE7_S_leftEPKSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %0) #5 comdat align 2 {
  %2 = getelementptr inbounds %"struct.std::_Rb_tree_node_base", %"struct.std::_Rb_tree_node_base"* %0, i32 0, i32 2
  %3 = load %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"** %2, align 8
  %4 = bitcast %"struct.std::_Rb_tree_node_base"* %3 to %"struct.std::_Rb_tree_node"*
  ret %"struct.std::_Rb_tree_node"* %4
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIiiSt9_IdentityIiESt4lessIiESaIiEE8_S_rightEPKSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %0) #5 comdat align 2 {
  %2 = getelementptr inbounds %"struct.std::_Rb_tree_node_base", %"struct.std::_Rb_tree_node_base"* %0, i32 0, i32 3
  %3 = load %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"** %2, align 8
  %4 = bitcast %"struct.std::_Rb_tree_node_base"* %3 to %"struct.std::_Rb_tree_node"*
  ret %"struct.std::_Rb_tree_node"* %4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s799983078.cpp() #0 section ".text.startup" {
