; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01106/s198527215.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01106/s198527215.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s198527215.cpp, i8* null }]
...
define i64 @_Z1pxx(i64 %0, i64 %1) #4 {
  %3 = shl i64 1, %1
  %4 = sub nsw i64 %3, 1
  %5 = sdiv i64 %4, 2
  %6 = icmp slt i64 %5, %0
...
; Function Attrs: noinline nounwind uwtable
define signext i8 @_Z1fxxx(i64 %0, i64 %1, i64 %2) #4 {
  %4 = shl i64 1, %2
  %5 = sub nsw i64 %4, 1
  %6 = mul nsw i64 %0, 2
  %7 = icmp sgt i64 %6, %5
  %8 = zext i1 %7 to i64
  %9 = call i64 @_Z1pxx(i64 %0, i64 %2)
  %10 = and i64 %9, 1
  %11 = xor i64 %8, %10
  %12 = and i64 %1, 1
  %13 = xor i64 %11, %12
...
25:                                               ; preds = %22
  ...
  %29 = invoke signext i8 @_Z1fxxx(i64 %26, i64 %27, i64 %28)
          to label %30 unwind label %41

30:                                               ; preds = %25
  %31 = invoke dereferenceable(32) %"class.std::__cxx11::basic_string"* @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEpLEc(%"class.std::__cxx11::basic_string"* %4, i8 signext %29)
          to label %32 unwind label %41

32:                                               ; preds = %30
  %33 = load i64, i64* %2, align 8
  %34 = load i64, i64* %1, align 8
  %35 = invoke i64 @_Z1pxx(i64 %33, i64 %34)
...
68:                                               ; preds = %41
  %69 = insertvalue { i8*, i32 } undef, i8* %43, 0
  %70 = insertvalue { i8*, i32 } %69, i32 %44, 1
  resume { i8*, i32 } %70
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s198527215.cpp() #0 section ".text.startup" {
