; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03072/s833171147.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03072/s833171147.c"
...
23:                                               ; preds = %18, %10
  %.13 = phi i32 [ %22, %18 ], [ %.02, %10 ]
  %.1 = phi i32 [ %21, %18 ], [ %.01, %10 ]
  br label %24
...
26:                                               ; preds = %7
  %27 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i32 0, i32 0), i32 %.02)
