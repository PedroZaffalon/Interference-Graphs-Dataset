; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03282/s698410284.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03282/s698410284.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s698410284.cpp, i8* null }]
...
8:                                                ; preds = %36, %7
  %.01 = phi i32 [ 0, %7 ], [ %37, %36 ]
  %9 = sext i32 %.01 to i64
  %10 = call i64 @_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE4sizeEv(%"class.std::__cxx11::basic_string"* %1) #3
  store i64 %10, i64* %3, align 8
  %11 = invoke dereferenceable(8) i64* @_ZSt3minIxERKT_S2_S2_(i64* dereferenceable(8) %3, i64* dereferenceable(8) %2)
...
25:                                               ; preds = %22
  ...
  %27 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8 signext %26)
...
31:                                               ; preds = %40, %38, %28, %25, %22, %15, %8, %5, %0
...
44:                                               ; preds = %31
  %45 = insertvalue { i8*, i32 } undef, i8* %33, 0
  %46 = insertvalue { i8*, i32 } %45, i32 %34, 1
  resume { i8*, i32 } %46
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s698410284.cpp() #0 section ".text.startup" {
