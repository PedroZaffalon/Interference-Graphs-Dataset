; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02390/s916498176.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02390/s916498176.c"
...
6:                                                ; preds = %4
  ...
  %12 = call i32 @strcmp(i8* %8, i8* %11) #3
  %13 = icmp ne i32 %12, 0
...
define i32 @main() #0 {
  ...
  %8 = srem i64 %7, 60
  %9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.3, i32 0, i32 0), i64 %3, i64 %6, i64 %8)
  ret i32 0
}
