; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01323/s414697060.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01323/s414697060.cpp"
...
@f = global [20 x [10 x i8]] zeroinitializer, align 16
@isCheck = global [20 x [10 x i8]] zeroinitializer, align 16
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s414697060.cpp, i8* null }]
...
6:                                                ; preds = %4
  %7 = sext i32 %.0 to i64
  %8 = getelementptr inbounds [20 x [10 x i8]], [20 x [10 x i8]]* @f, i64 0, i64 %7
...
define i32 @_Z5countii(i32 %0, i32 %1) #0 {
  %3 = sext i32 %0 to i64
  %4 = getelementptr inbounds [20 x [10 x i8]], [20 x [10 x i8]]* @isCheck, i64 0, i64 %3
  %5 = sext i32 %1 to i64
...
10:                                               ; preds = %2
  ...
  %12 = getelementptr inbounds [20 x [10 x i8]], [20 x [10 x i8]]* @isCheck, i64 0, i64 %11
  %13 = sext i32 %1 to i64
  %14 = getelementptr inbounds [10 x i8], [10 x i8]* %12, i64 0, i64 %13
  store i8 1, i8* %14, align 1
  %15 = sext i32 %0 to i64
  %16 = getelementptr inbounds [20 x [10 x i8]], [20 x [10 x i8]]* @f, i64 0, i64 %15
...
20:                                               ; preds = %53, %10
  %.02 = phi i32 [ 1, %10 ], [ %.2, %53 ]
  %.01 = phi i32 [ 0, %10 ], [ %54, %53 ]
  %21 = icmp slt i32 %.01, 4
  br i1 %21, label %22, label %55

22:                                               ; preds = %20
  %23 = sext i32 %.01 to i64
  %24 = getelementptr inbounds [4 x i32], [4 x i32]* @dx, i64 0, i64 %23
  %25 = load i32, i32* %24, align 4
  %26 = add nsw i32 %1, %25
  %27 = sext i32 %.01 to i64
  %28 = getelementptr inbounds [4 x i32], [4 x i32]* @dy, i64 0, i64 %27
...
40:                                               ; preds = %37
  ...
  %42 = getelementptr inbounds [20 x [10 x i8]], [20 x [10 x i8]]* @f, i64 0, i64 %41
  %43 = sext i32 %26 to i64
  %44 = getelementptr inbounds [10 x i8], [10 x i8]* %42, i64 0, i64 %43
  %45 = load i8, i8* %44, align 1
  %46 = sext i8 %45 to i32
  %47 = sext i8 %19 to i32
  %48 = icmp eq i32 %46, %47
  br i1 %48, label %49, label %52

49:                                               ; preds = %40
  %50 = call i32 @_Z5countii(i32 %30, i32 %26)
  %51 = add nsw i32 %.02, %50
  br label %52

52:                                               ; preds = %49, %40
  %.1 = phi i32 [ %51, %49 ], [ %.02, %40 ]
  br label %53

53:                                               ; preds = %52, %39, %34
  %.2 = phi i32 [ %.02, %34 ], [ %.02, %39 ], [ %.1, %52 ]
  %54 = add nsw i32 %.01, 1
  br label %20
...
; Function Attrs: noinline uwtable
define void @_Z5eraseii(i32 %0, i32 %1) #0 {
  %3 = sext i32 %0 to i64
  %4 = getelementptr inbounds [20 x [10 x i8]], [20 x [10 x i8]]* @f, i64 0, i64 %3
  %5 = sext i32 %1 to i64
  %6 = getelementptr inbounds [10 x i8], [10 x i8]* %4, i64 0, i64 %5
  %7 = load i8, i8* %6, align 1
  %8 = sext i32 %0 to i64
  %9 = getelementptr inbounds [20 x [10 x i8]], [20 x [10 x i8]]* @f, i64 0, i64 %8
...
14:                                               ; preds = %12
  %15 = sext i32 %.0 to i64
  %16 = getelementptr inbounds [4 x i32], [4 x i32]* @dx, i64 0, i64 %15
  %17 = load i32, i32* %16, align 4
  %18 = add nsw i32 %1, %17
  %19 = sext i32 %.0 to i64
  %20 = getelementptr inbounds [4 x i32], [4 x i32]* @dy, i64 0, i64 %19
...
32:                                               ; preds = %29
  ...
  %34 = getelementptr inbounds [20 x [10 x i8]], [20 x [10 x i8]]* @f, i64 0, i64 %33
  %35 = sext i32 %18 to i64
  %36 = getelementptr inbounds [10 x i8], [10 x i8]* %34, i64 0, i64 %35
...
45:                                               ; preds = %32
  ...
  %47 = getelementptr inbounds [20 x [10 x i8]], [20 x [10 x i8]]* @f, i64 0, i64 %46
...
54:                                               ; preds = %45
  call void @_Z5eraseii(i32 %22, i32 %18)
  br label %55
...
15:                                               ; preds = %23, %14
  ...
  %16 = icmp slt i32 %.02, 6
  br i1 %16, label %17, label %25

17:                                               ; preds = %15
  %18 = sext i32 %.01 to i64
  %19 = getelementptr inbounds [20 x [10 x i8]], [20 x [10 x i8]]* @f, i64 0, i64 %18
...
29:                                               ; preds = %176, %28
  %.03 = phi i32 [ 0, %28 ], [ %.1, %176 ]
  br label %30

30:                                               ; preds = %43, %29
  %.06 = phi i32 [ 0, %29 ], [ %44, %43 ]
  %31 = icmp slt i32 %.06, 12
...
33:                                               ; preds = %36, %32
  %.07 = phi i32 [ 0, %32 ], [ %39, %36 ]
  %34 = icmp slt i32 %.07, 6
...
36:                                               ; preds = %35
  ...
  %38 = getelementptr inbounds [20 x [10 x i8]], [20 x [10 x i8]]* @isCheck, i64 0, i64 %37
  %39 = add nsw i32 %.07, 1
...
53:                                               ; preds = %50
  ...
  %56 = getelementptr inbounds [20 x [10 x i8]], [20 x [10 x i8]]* @f, i64 0, i64 %55
...
63:                                               ; preds = %53
  ...
  %66 = getelementptr inbounds [20 x [10 x i8]], [20 x [10 x i8]]* @f, i64 0, i64 %65
...
73:                                               ; preds = %63
  ...
  %76 = getelementptr inbounds [20 x [10 x i8]], [20 x [10 x i8]]* @isCheck, i64 0, i64 %75
...
83:                                               ; preds = %73
  ...
  %86 = invoke i32 @_Z5countii(i32 %84, i32 %85)
          to label %87 unwind label %92

87:                                               ; preds = %83
  %88 = icmp sge i32 %86, 4
  br i1 %88, label %89, label %96

89:                                               ; preds = %87
  invoke void @_ZNSt4pairIiiEC2IRiS2_Lb1EEEOT_OT0_(%"struct.std::pair"* %5, i32* dereferenceable(4) %3, i32* dereferenceable(4) %4)
...
108:                                              ; preds = %122, %106
  %.010 = phi i32 [ 0, %106 ], [ %123, %122 ]
  %109 = call i64 @_ZNKSt6vectorISt4pairIiiESaIS1_EE4sizeEv(%"class.std::vector"* %2) #3
...
112:                                              ; preds = %108
  ...
  invoke void @_Z5eraseii(i32 %116, i32 %120)
...
125:                                              ; preds = %172, %124
  %.09 = phi i32 [ 0, %124 ], [ %173, %172 ]
  %126 = icmp slt i32 %.09, 6
...
128:                                              ; preds = %169, %127
  %.08 = phi i32 [ 11, %127 ], [ %170, %169 ]
  %129 = icmp sge i32 %.08, 0
  br i1 %129, label %130, label %171

130:                                              ; preds = %128
  %131 = sext i32 %.08 to i64
  %132 = getelementptr inbounds [20 x [10 x i8]], [20 x [10 x i8]]* @f, i64 0, i64 %131
...
138:                                              ; preds = %130
  %139 = sub nsw i32 %.08, 1
  br label %140

140:                                              ; preds = %165, %138
  %.0 = phi i32 [ %139, %138 ], [ %166, %165 ]
  %141 = icmp sge i32 %.0, 0
  br i1 %141, label %142, label %167

142:                                              ; preds = %140
  %143 = sext i32 %.0 to i64
  %144 = getelementptr inbounds [20 x [10 x i8]], [20 x [10 x i8]]* @f, i64 0, i64 %143
  %145 = sext i32 %.09 to i64
  %146 = getelementptr inbounds [10 x i8], [10 x i8]* %144, i64 0, i64 %145
...
150:                                              ; preds = %142
  ...
  %152 = getelementptr inbounds [20 x [10 x i8]], [20 x [10 x i8]]* @f, i64 0, i64 %151
  %153 = sext i32 %.09 to i64
  %154 = getelementptr inbounds [10 x i8], [10 x i8]* %152, i64 0, i64 %153
  %155 = load i8, i8* %154, align 1
  %156 = sext i32 %.08 to i64
  %157 = getelementptr inbounds [20 x [10 x i8]], [20 x [10 x i8]]* @f, i64 0, i64 %156
  %158 = sext i32 %.09 to i64
  %159 = getelementptr inbounds [10 x i8], [10 x i8]* %157, i64 0, i64 %158
  store i8 %155, i8* %159, align 1
  %160 = sext i32 %.0 to i64
  %161 = getelementptr inbounds [20 x [10 x i8]], [20 x [10 x i8]]* @f, i64 0, i64 %160
  %162 = sext i32 %.09 to i64
  %163 = getelementptr inbounds [10 x i8], [10 x i8]* %161, i64 0, i64 %162
...
175:                                              ; preds = %174, %104
  %.1 = phi i32 [ %107, %174 ], [ %.03, %104 ]
  call void @_ZNSt6vectorISt4pairIiiESaIS1_EED2Ev(%"class.std::vector"* %2) #3
  br label %176

176:                                              ; preds = %175
  %177 = trunc i8 %.04 to i1
  br i1 %177, label %29, label %178
...
182:                                              ; preds = %92
  %183 = insertvalue { i8*, i32 } undef, i8* %94, 0
  %184 = insertvalue { i8*, i32 } %183, i32 %95, 1
  resume { i8*, i32 } %184
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s414697060.cpp() #0 section ".text.startup" {
