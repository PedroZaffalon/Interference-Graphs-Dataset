; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03316/s574724016.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03316/s574724016.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s574724016.cpp, i8* null }]
...
22:                                               ; preds = %4
  %23 = call i8* @_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE5c_strEv(%"class.std::__cxx11::basic_string"* %1) #3
...
38:                                               ; preds = %18
  %39 = insertvalue { i8*, i32 } undef, i8* %20, 0
  %40 = insertvalue { i8*, i32 } %39, i32 %21, 1
  resume { i8*, i32 } %40
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s574724016.cpp() #0 section ".text.startup" {
