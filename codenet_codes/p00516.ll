; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00516/s258919503.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00516/s258919503.c"
...
48:                                               ; preds = %62, %47
  %.04 = phi i32 [ 0, %47 ], [ %.15, %62 ]
  %.2 = phi i32 [ 0, %47 ], [ %63, %62 ]
  %.0 = phi i32 [ undef, %47 ], [ %.1, %62 ]
...
61:                                               ; preds = %56, %51
  %.15 = phi i32 [ %59, %56 ], [ %.04, %51 ]
  %.1 = phi i32 [ %60, %56 ], [ %.0, %51 ]
  br label %62
...
64:                                               ; preds = %48
  %65 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i32 0, i32 0), i32 %.0)
  ret i32 0
}
