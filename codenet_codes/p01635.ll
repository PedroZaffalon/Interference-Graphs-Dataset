; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01635/s967503319.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01635/s967503319.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s967503319.cpp, i8* null }]
...
define i32 @main() #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %4 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* @_ZSt3cin, i32* dereferenceable(4) %1)
          to label %5 unwind label %36

5:                                                ; preds = %0
  %6 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* %4, i32* dereferenceable(4) %2)
...
36:                                               ; preds = %81, %79, %76, %74, %55, %53, %41, %28, %21, %14, %7, %5, %0
...
41:                                               ; preds = %59, %40
  %.06 = phi i32 [ 0, %40 ], [ %60, %59 ]
  %.13 = phi i32 [ 1, %40 ], [ %51, %59 ]
...
62:                                               ; preds = %61, %35
  %.2 = phi i32 [ 1, %35 ], [ %.13, %61 ]
  br label %63

63:                                               ; preds = %62, %24, %17
  %.15 = phi i32 [ 1, %62 ], [ 0, %24 ], [ 0, %17 ]
  %.3 = phi i32 [ %.2, %62 ], [ 1, %24 ], [ 1, %17 ]
  %64 = icmp eq i32 %.15, 1
...
70:                                               ; preds = %10
  ...
  %72 = mul nsw i32 %.01, %71
  %73 = icmp sle i32 %72, 1000000000
  br i1 %73, label %74, label %79

74:                                               ; preds = %70
  %75 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %72)
...
86:                                               ; preds = %36
  %87 = insertvalue { i8*, i32 } undef, i8* %38, 0
  %88 = insertvalue { i8*, i32 } %87, i32 %39, 1
  resume { i8*, i32 } %88
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s967503319.cpp() #0 section ".text.startup" {
