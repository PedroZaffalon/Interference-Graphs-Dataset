; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03951/s242960893.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03951/s242960893.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s242960893.cpp, i8* null }]
...
17:                                               ; preds = %41, %16
  %.01 = phi i32 [ 0, %16 ], [ %42, %41 ]
  %18 = add nsw i32 %.02, %.01
...
36:                                               ; preds = %65, %60, %54, %51, %45, %26, %22, %9, %7, %0
...
45:                                               ; preds = %43
  ...
  %50 = invoke dereferenceable(8) i64* @_ZSt3maxImERKT_S2_S2_(i64* dereferenceable(8) %4, i64* dereferenceable(8) %5)
...
69:                                               ; preds = %36
  %70 = insertvalue { i8*, i32 } undef, i8* %38, 0
  %71 = insertvalue { i8*, i32 } %70, i32 %39, 1
  resume { i8*, i32 } %71
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s242960893.cpp() #0 section ".text.startup" {
