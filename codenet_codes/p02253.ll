; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02253/s902019584.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02253/s902019584.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s902019584.cpp, i8* null }]
...
define i32 @main() #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  invoke void @_ZNSt6vectorISt4pairIiiESaIS1_EEC2EmRKS2_(%"class.std::vector"* %2, i64 %8, %"class.std::allocator"* dereferenceable(1) %3)
...
13:                                               ; preds = %10
  ...
  %15 = call dereferenceable(8) %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EEixEm(%"class.std::vector"* %2, i64 %14) #3
...
18:                                               ; preds = %13
  ...
  %20 = call dereferenceable(8) %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EEixEm(%"class.std::vector"* %2, i64 %19) #3
  %21 = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* %20, i32 0, i32 0
  %22 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* %17, i32* dereferenceable(4) %21)
...
34:                                               ; preds = %10
  %35 = call %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EE5beginEv(%"class.std::vector"* %2) #3
  %36 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %4, i32 0, i32 0
  store %"struct.std::pair"* %35, %"struct.std::pair"** %36, align 8
  %37 = call %"struct.std::pair"* @_ZNSt6vectorISt4pairIiiESaIS1_EE3endEv(%"class.std::vector"* %2) #3
...
44:                                               ; preds = %60, %43
  %.06 = phi i32 [ 0, %43 ], [ %61, %60 ]
  %.04 = phi i32 [ 0, %43 ], [ %.15, %60 ]
  %.03 = phi i32 [ 0, %43 ], [ %.1, %60 ]
...
59:                                               ; preds = %53, %47
  %.15 = phi i32 [ %57, %53 ], [ %.04, %47 ]
  %.1 = phi i32 [ %58, %53 ], [ %.03, %47 ]
  br label %60
...
62:                                               ; preds = %44
  %63 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %.03)
...
67:                                               ; preds = %30, %26
  ...
  %.0 = phi i8* [ %32, %30 ], [ %28, %26 ]
  %68 = insertvalue { i8*, i32 } undef, i8* %.0, 0
  %69 = insertvalue { i8*, i32 } %68, i32 %.01, 1
  resume { i8*, i32 } %69
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s902019584.cpp() #0 section ".text.startup" {
