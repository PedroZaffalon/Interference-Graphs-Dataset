; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03180/s757151937.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03180/s757151937.c"
...
define i32 @main() #0 {
  ...
  %2 = alloca [32 x [32 x i64]], align 16
  %3 = alloca [131072 x i64], align 16
  %4 = alloca [32 x i64], align 16
  %5 = alloca [32 x i64], align 16
  %6 = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i32 0, i32 0), i64* %1)
  br label %7

7:                                                ; preds = %11, %0
  %.02 = phi i64 [ 0, %0 ], [ %12, %11 ]
  %8 = icmp slt i64 %.02, 131072
  br i1 %8, label %9, label %13

9:                                                ; preds = %7
  %10 = getelementptr inbounds [131072 x i64], [131072 x i64]* %3, i64 0, i64 %.02
  store i64 -4154118101919364364, i64* %10, align 8
  br label %11
...
13:                                               ; preds = %7
  %14 = getelementptr inbounds [131072 x i64], [131072 x i64]* %3, i64 0, i64 0
  store i64 0, i64* %14, align 16
  br label %15

15:                                               ; preds = %29, %13
  %.13 = phi i64 [ 0, %13 ], [ %30, %29 ]
...
19:                                               ; preds = %26, %18
  %.04 = phi i64 [ 0, %18 ], [ %27, %26 ]
  %20 = load i64, i64* %1, align 8
  %21 = icmp slt i64 %.04, %20
  br i1 %21, label %22, label %28

22:                                               ; preds = %19
  %23 = getelementptr inbounds [32 x [32 x i64]], [32 x [32 x i64]]* %2, i64 0, i64 %.13
  %24 = getelementptr inbounds [32 x i64], [32 x i64]* %23, i64 0, i64 %.04
  %25 = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i32 0, i32 0), i64* %24)
  br label %26
...
31:                                               ; preds = %15
  ...
  %33 = call i64 @llpow(i64 2, i64 %32)
  br label %34

34:                                               ; preds = %108, %31
  %.2 = phi i64 [ 0, %31 ], [ %109, %108 ]
  %35 = icmp slt i64 %.2, %33
...
37:                                               ; preds = %48, %36
  %.013 = phi i64 [ 0, %36 ], [ %.114, %48 ]
  %.15 = phi i64 [ 0, %36 ], [ %49, %48 ]
...
44:                                               ; preds = %40
  %45 = getelementptr inbounds [32 x i64], [32 x i64]* %4, i64 0, i64 %.013
  store i64 %.15, i64* %45, align 8
  %46 = add nsw i64 %.013, 1
  br label %47

47:                                               ; preds = %44, %40
  %.114 = phi i64 [ %46, %44 ], [ %.013, %40 ]
  br label %48
...
50:                                               ; preds = %37
  %51 = call i64 @llpow(i64 2, i64 %.013)
  %52 = sub nsw i64 %51, 1
  br label %53

53:                                               ; preds = %105, %50
  %.26 = phi i64 [ %52, %50 ], [ %106, %105 ]
  %54 = icmp sge i64 %.26, 1
...
56:                                               ; preds = %74, %55
  %.09 = phi i64 [ 0, %55 ], [ %75, %74 ]
  %.07 = phi i64 [ %.2, %55 ], [ %.18, %74 ]
  %.0 = phi i64 [ 0, %55 ], [ %.1, %74 ]
  %57 = icmp slt i64 %.09, %.013
...
62:                                               ; preds = %58
  %63 = getelementptr inbounds [32 x i64], [32 x i64]* %4, i64 0, i64 %.09
  %64 = load i64, i64* %63, align 8
  %65 = trunc i64 %64 to i32
  %66 = shl i32 1, %65
  %67 = sext i32 %66 to i64
  %68 = or i64 %.07, %67
  %69 = getelementptr inbounds [32 x i64], [32 x i64]* %4, i64 0, i64 %.09
  %70 = load i64, i64* %69, align 8
  %71 = getelementptr inbounds [32 x i64], [32 x i64]* %5, i64 0, i64 %.0
  store i64 %70, i64* %71, align 8
  %72 = add nsw i64 %.0, 1
  br label %73

73:                                               ; preds = %62, %58
  %.18 = phi i64 [ %68, %62 ], [ %.07, %58 ]
  %.1 = phi i64 [ %72, %62 ], [ %.0, %58 ]
  br label %74
...
77:                                               ; preds = %95, %76
  %.011 = phi i64 [ 0, %76 ], [ %.112, %95 ]
  %.110 = phi i64 [ 0, %76 ], [ %96, %95 ]
  %78 = icmp slt i64 %.110, %.0
  br i1 %78, label %79, label %97

79:                                               ; preds = %77
  %80 = add nsw i64 %.110, 1
  br label %81

81:                                               ; preds = %92, %79
  %.112 = phi i64 [ %.011, %79 ], [ %91, %92 ]
  %.01 = phi i64 [ %80, %79 ], [ %93, %92 ]
  %82 = icmp slt i64 %.01, %.0
  br i1 %82, label %83, label %94

83:                                               ; preds = %81
  %84 = getelementptr inbounds [32 x i64], [32 x i64]* %5, i64 0, i64 %.110
  %85 = load i64, i64* %84, align 8
  %86 = getelementptr inbounds [32 x [32 x i64]], [32 x [32 x i64]]* %2, i64 0, i64 %85
  %87 = getelementptr inbounds [32 x i64], [32 x i64]* %5, i64 0, i64 %.01
  %88 = load i64, i64* %87, align 8
  %89 = getelementptr inbounds [32 x i64], [32 x i64]* %86, i64 0, i64 %88
  %90 = load i64, i64* %89, align 8
  %91 = add nsw i64 %.112, %90
  br label %92
...
95:                                               ; preds = %94
  %96 = add nsw i64 %.110, 1
  br label %77

97:                                               ; preds = %77
  %98 = getelementptr inbounds [131072 x i64], [131072 x i64]* %3, i64 0, i64 %.07
  %99 = load i64, i64* %98, align 8
  %100 = getelementptr inbounds [131072 x i64], [131072 x i64]* %3, i64 0, i64 %.2
  %101 = load i64, i64* %100, align 8
  %102 = add nsw i64 %101, %.011
  %103 = call i64 @llmax(i64 %99, i64 %102)
  %104 = getelementptr inbounds [131072 x i64], [131072 x i64]* %3, i64 0, i64 %.07
  store i64 %103, i64* %104, align 8
  br label %105

105:                                              ; preds = %97
  %106 = add nsw i64 %.26, -1
  br label %53
...
110:                                              ; preds = %34
  %111 = sub nsw i64 %33, 1
  %112 = getelementptr inbounds [131072 x i64], [131072 x i64]* %3, i64 0, i64 %111
  %113 = load i64, i64* %112, align 8
  %114 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.4, i32 0, i32 0), i64 %113)
  ret i32 0
}
