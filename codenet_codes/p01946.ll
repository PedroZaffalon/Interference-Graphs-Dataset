; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01946/s180814443.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01946/s180814443.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s180814443.cpp, i8* null }]
...
define i32 @main() #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  call void @_ZNSt14basic_ifstreamIcSt11char_traitsIcEEC1EPKcSt13_Ios_Openmode(%"class.std::basic_ifstream"* %1, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i32 0, i32 0), i32 8)
  ...
  %15 = invoke %"class.std::basic_filebuf"* @_ZNKSt14basic_ifstreamIcSt11char_traitsIcEE5rdbufEv(%"class.std::basic_ifstream"* %1)
          to label %16 unwind label %49

16:                                               ; preds = %0
  %17 = bitcast %"class.std::basic_filebuf"* %15 to %"class.std::basic_streambuf"*
  %18 = invoke %"class.std::basic_streambuf"* @_ZNSt9basic_iosIcSt11char_traitsIcEE5rdbufEPSt15basic_streambufIcS1_E(%"class.std::basic_ios"* %14, %"class.std::basic_streambuf"* %17)
...
19:                                               ; preds = %16
  ...
  %26 = invoke %"class.std::basic_ostream"* @_ZNSt9basic_iosIcSt11char_traitsIcEE3tieEPSo(%"class.std::basic_ios"* %25, %"class.std::basic_ostream"* null)
...
31:                                               ; preds = %29
  %32 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERx(%"class.std::basic_istream"* %30, i64* dereferenceable(8) %3)
...
57:                                               ; preds = %142, %135, %121, %117, %94, %92, %83, %80, %77, %42
...
83:                                               ; preds = %66
  %84 = invoke dereferenceable(8) i64* @_ZSt3minIxERKT_S2_S2_(i64* dereferenceable(8) %8, i64* dereferenceable(8) %7)
...
125:                                              ; preds = %146, %124
  %.07 = phi i32 [ 0, %124 ], [ %147, %146 ]
  %.06 = phi i64 [ %115, %124 ], [ %133, %146 ]
...
152:                                              ; preds = %57, %53, %49
  %.02 = phi i32 [ %60, %57 ], [ %56, %53 ], [ %52, %49 ]
  %.01 = phi i8* [ %59, %57 ], [ %55, %53 ], [ %51, %49 ]
  call void @_ZNSt14basic_ifstreamIcSt11char_traitsIcEED1Ev(%"class.std::basic_ifstream"* %1) #3
  br label %153

153:                                              ; preds = %152
  %154 = insertvalue { i8*, i32 } undef, i8* %.01, 0
  %155 = insertvalue { i8*, i32 } %154, i32 %.02, 1
  resume { i8*, i32 } %155
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s180814443.cpp() #0 section ".text.startup" {
