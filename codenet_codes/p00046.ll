; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00046/s768146586.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00046/s768146586.c"
...
2:                                                ; preds = %15, %0
  %.01 = phi float [ 0.000000e+00, %0 ], [ %.12, %15 ]
  %.0 = phi float [ 9.999990e+05, %0 ], [ %.1, %15 ]
...
10:                                               ; preds = %8, %5
  %.12 = phi float [ %9, %8 ], [ %.01, %5 ]
  %11 = load float, float* %1, align 4
  %12 = fcmp olt float %11, %.0
