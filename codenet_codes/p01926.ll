; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01926/s845594862.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01926/s845594862.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s845594862.cpp, i8* null }]
...
define i32 @_Z5checkiii(i32 %0, i32 %1, i32 %2) #0 {
  %4 = sub nsw i32 %0, %1
  %5 = call i32 @abs(i32 %4) #13
  %6 = sub nsw i32 %0, %2
  %7 = call i32 @abs(i32 %6) #13
  %8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str, i32 0, i32 0), i32 %1, i32 %2)
  %9 = icmp sgt i32 %1, %2
...
; Function Attrs: noinline uwtable
define i32 @_Z7levelUpiii(i32 %0, i32 %1, i32 %2) #0 {
...
; Function Attrs: noinline uwtable
define zeroext i1 @_Z4funci(i32 %0) #0 {
...
21:                                               ; preds = %12
  %22 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector"* @d) #3
  %23 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %4, i32 0, i32 0
  store i32* %22, i32** %23, align 8
  %24 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector"* @d) #3
  ...
  %30 = call i32* @_ZSt11lower_boundIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEiET_S7_S7_RKT0_(i32* %27, i32* %29, i32* dereferenceable(4) %2)
  %31 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %3, i32 0, i32 0
  store i32* %30, i32** %31, align 8
  %32 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector"* @d) #3
  %33 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %6, i32 0, i32 0
  store i32* %32, i32** %33, align 8
  %34 = call i64 @_ZN9__gnu_cxxmiIPiSt6vectorIiSaIiEEEENS_17__normal_iteratorIT_T0_E15difference_typeERKS8_SB_(%"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %3, %"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %6) #3
...
39:                                               ; preds = %21
  ...
  %41 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* @d, i64 %40) #3
...
60:                                               ; preds = %56, %55
  %.01 = phi i32 [ -1, %55 ], [ %59, %56 ]
  br label %61

61:                                               ; preds = %60, %47
  %.1 = phi i32 [ -1, %47 ], [ %.01, %60 ]
  %62 = icmp eq i32 %44, -1
...
82:                                               ; preds = %81, %80
  %.03 = phi i32 [ %44, %80 ], [ %.1, %81 ]
  br label %83

83:                                               ; preds = %82, %71
  %.14 = phi i32 [ %44, %71 ], [ %.03, %82 ]
  br label %84

84:                                               ; preds = %83, %68
  %.2 = phi i32 [ %.1, %68 ], [ %.14, %83 ]
...
define i32 @_Z5solvev() #0 {
  %1 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* @d, i64 0) #3
  %2 = load i32, i32* %1, align 4
  %3 = sub nsw i32 %2, 1
  br label %4

4:                                                ; preds = %13, %0
  %.02 = phi i32 [ %3, %0 ], [ %.13, %13 ]
  %.01 = phi i32 [ 1000000000, %0 ], [ %.1, %13 ]
  %5 = sub nsw i32 %.01, %.02
  %6 = icmp sgt i32 %5, 1
...
7:                                                ; preds = %4
  %8 = add nsw i32 %.02, %.01
  %9 = sdiv i32 %8, 2
  %10 = call zeroext i1 @_Z4funci(i32 %9)
...
13:                                               ; preds = %12, %11
  %.13 = phi i32 [ %9, %11 ], [ %.02, %12 ]
  %.1 = phi i32 [ %.01, %11 ], [ %9, %12 ]
  br label %4

14:                                               ; preds = %4
  %15 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* @d, i64 0) #3
...
8:                                                ; preds = %1
  ...
  call void @_ZNSt6vectorIiSaIiEE6resizeEm(%"class.std::vector"* @d, i64 %10)
  br label %11
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s845594862.cpp() #0 section ".text.startup" {
