; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p04037/s383224904.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p04037/s383224904.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s383224904.cpp, i8* null }]
...
define void @_Z4gmaxRii(i32* dereferenceable(4) %0, i32 %1) #4 {
...
; Function Attrs: noinline nounwind uwtable
define void @_Z4gminRii(i32* dereferenceable(4) %0, i32 %1) #4 {
  %3 = load i32, i32* %0, align 4
  %4 = icmp slt i32 %3, %1
  br i1 %4, label %5, label %7
...
5:                                                ; preds = %2
  ...
  %7 = getelementptr inbounds [100050 x i32], [100050 x i32]* @a, i64 0, i64 %6
...
11:                                               ; preds = %2
  ...
  %14 = getelementptr inbounds i32, i32* getelementptr inbounds ([100050 x i32], [100050 x i32]* @a, i32 0, i32 0), i64 %13
  %15 = getelementptr inbounds i32, i32* %14, i64 1
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([100050 x i32], [100050 x i32]* @a, i32 0, i64 1), i32* %15)
  %16 = load i32, i32* @n, align 4
  %17 = sext i32 %16 to i64
  %18 = getelementptr inbounds i32, i32* getelementptr inbounds ([100050 x i32], [100050 x i32]* @a, i32 0, i32 0), i64 %17
  %19 = getelementptr inbounds i32, i32* %18, i64 1
  call void @_ZSt7reverseIPiEvT_S1_(i32* getelementptr inbounds ([100050 x i32], [100050 x i32]* @a, i32 0, i64 1), i32* %19)
  br label %20

20:                                               ; preds = %59, %11
  %.02 = phi i32 [ 1, %11 ], [ %60, %59 ]
...
23:                                               ; preds = %20
  ...
  %27 = getelementptr inbounds [100050 x i32], [100050 x i32]* @a, i64 0, i64 %26
...
32:                                               ; preds = %40, %30
  %.03 = phi i32 [ %31, %30 ], [ %41, %40 ]
  %33 = sext i32 %.03 to i64
  %34 = getelementptr inbounds [100050 x i32], [100050 x i32]* @a, i64 0, i64 %33
...
42:                                               ; preds = %32
  ...
  %44 = getelementptr inbounds [100050 x i32], [100050 x i32]* @a, i64 0, i64 %43
  %45 = load i32, i32* %44, align 4
  %46 = sub nsw i32 %45, %.02
  %47 = add nsw i32 %46, 1
  %48 = and i32 %47, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s383224904.cpp() #0 section ".text.startup" {
