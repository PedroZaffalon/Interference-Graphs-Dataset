; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02699/s234059996.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02699/s234059996.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s234059996.cpp, i8* null }]
...
8:                                                ; preds = %0
  %9 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 1935763045)
...
11:                                               ; preds = %0
  %12 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 1935763045)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s234059996.cpp() #0 section ".text.startup" {
