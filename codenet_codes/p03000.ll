; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03000/s905893454.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03000/s905893454.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s905893454.cpp, i8* null }]
...
30:                                               ; preds = %44, %29
  %.05 = phi i32 [ 0, %29 ], [ %34, %44 ]
  %.04 = phi i32 [ 0, %29 ], [ %39, %44 ]
  %.0 = phi i32 [ 0, %29 ], [ %45, %44 ]
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s905893454.cpp() #0 section ".text.startup" {
