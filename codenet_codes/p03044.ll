; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03044/s836340355.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03044/s836340355.cpp"
...
@b = global [100005 x %"class.std::vector"] zeroinitializer, align 16
@_ZSt3cin = external global %"class.std::basic_istream", align 8
@.str = private unnamed_addr constant [9 x i8] c"%d %d %d\00", align 1
@.str.4 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@.str.5 = private unnamed_addr constant [26 x i8] c"vector::_M_realloc_insert\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s836340355.cpp, i8* null }]
...
2:                                                ; preds = %2, %1
  ...
  %5 = icmp eq %"class.std::vector"* %4, getelementptr inbounds ([100005 x %"class.std::vector"], [100005 x %"class.std::vector"]* @a, i32 0, i32 0)
...
1:                                                ; preds = %1, %0
  %2 = phi %"class.std::vector"* [ getelementptr inbounds ([100005 x %"class.std::vector"], [100005 x %"class.std::vector"]* @b, i32 0, i32 0), %0 ], [ %3, %1 ]
  call void @_ZNSt6vectorIiSaIiEEC2Ev(%"class.std::vector"* %2) #3
  %3 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %2, i64 1
  %4 = icmp eq %"class.std::vector"* %3, getelementptr inbounds ([100005 x %"class.std::vector"], [100005 x %"class.std::vector"]* @b, i64 1, i64 0)
  br i1 %4, label %5, label %1
...
2:                                                ; preds = %2, %1
  %3 = phi %"class.std::vector"* [ getelementptr inbounds ([100005 x %"class.std::vector"], [100005 x %"class.std::vector"]* @b, i64 1, i64 0), %1 ], [ %4, %2 ]
  %4 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %3, i64 -1
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %4) #3
  %5 = icmp eq %"class.std::vector"* %4, getelementptr inbounds ([100005 x %"class.std::vector"], [100005 x %"class.std::vector"]* @b, i32 0, i32 0)
  br i1 %5, label %6, label %2
...
8:                                                ; preds = %2
  %9 = sext i32 %0 to i64
  %10 = getelementptr inbounds [100005 x i32], [100005 x i32]* @ans, i64 0, i64 %9
...
26:                                               ; preds = %18
  ...
  %31 = getelementptr inbounds [100005 x %"class.std::vector"], [100005 x %"class.std::vector"]* @b, i64 0, i64 %30
  %32 = sext i32 %.0 to i64
  %33 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %31, i64 %32) #3
  %34 = load i32, i32* %33, align 4
  %35 = add nsw i32 %29, %34
  %36 = sext i32 %23 to i64
  %37 = getelementptr inbounds [100005 x i32], [100005 x i32]* @s, i64 0, i64 %36
  store i32 %35, i32* %37, align 4
  call void @_Z1fii(i32 %23, i32 %0)
  br label %38
...
9:                                                ; preds = %5
  %10 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i32 0, i32 0), i32* %1, i32* %2, i32* %3)
  ...
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %18, i32* dereferenceable(4) %1)
  %19 = load i32, i32* %1, align 4
  %20 = sext i32 %19 to i64
  %21 = getelementptr inbounds [100005 x %"class.std::vector"], [100005 x %"class.std::vector"]* @b, i64 0, i64 %20
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %21, i32* dereferenceable(4) %3)
  %22 = load i32, i32* %2, align 4
  %23 = sext i32 %22 to i64
  %24 = getelementptr inbounds [100005 x %"class.std::vector"], [100005 x %"class.std::vector"]* @b, i64 0, i64 %23
...
31:                                               ; preds = %28
  ...
  %33 = getelementptr inbounds [100005 x i32], [100005 x i32]* @ans, i64 0, i64 %32
  %34 = load i32, i32* %33, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s836340355.cpp() #0 section ".text.startup" {
