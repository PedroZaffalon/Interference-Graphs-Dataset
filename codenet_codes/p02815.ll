; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02815/s799884728.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02815/s799884728.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s799884728.cpp, i8* null }]
...
define i32 @main() #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  invoke void @_ZNSt6vectorIiSaIiEEC2EmRKiRKS0_(%"class.std::vector"* %3, i64 %9, i32* dereferenceable(4) %4, %"class.std::allocator"* dereferenceable(1) %5)
...
51:                                               ; preds = %67, %50
  %.02 = phi i32 [ 0, %50 ], [ %68, %67 ]
  %.01 = phi i64 [ 0, %50 ], [ %66, %67 ]
...
82:                                               ; preds = %81, %35
  %.2 = phi i64 [ %40, %35 ], [ %.1, %81 ]
  %83 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEx(%"class.std::basic_ostream"* @_ZSt4cout, i64 %.2)
...
87:                                               ; preds = %28, %24
  %.04 = phi i32 [ %31, %28 ], [ %27, %24 ]
  %.03 = phi i8* [ %30, %28 ], [ %26, %24 ]
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s799884728.cpp() #0 section ".text.startup" {
