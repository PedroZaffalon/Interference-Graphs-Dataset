; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03895/s735690615.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03895/s735690615.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s735690615.cpp, i8* null }]
...
18:                                               ; preds = %28, %17
  %.05 = phi i64 [ 0, %17 ], [ %29, %28 ]
  %19 = load i64, i64* %1, align 8
  %20 = icmp slt i64 %.05, %19
  br i1 %20, label %21, label %42

21:                                               ; preds = %18
  %22 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %2, i64 %.05) #3
...
24:                                               ; preds = %21
  %25 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %4, i64 %.05) #3
  %26 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERx(%"class.std::basic_istream"* %23, i64* dereferenceable(8) %25)
...
42:                                               ; preds = %18
  ...
  invoke void @_ZNSt6vectorIxSaIxEEC2EmRKxRKS0_(%"class.std::vector"* %6, i64 86400, i64* dereferenceable(8) %7, %"class.std::allocator"* dereferenceable(1) %8)
...
44:                                               ; preds = %58, %43
  %.08 = phi i64 [ 0, %43 ], [ %59, %58 ]
  %.07 = phi i64 [ 0, %43 ], [ %57, %58 ]
  %45 = load i64, i64* %1, align 8
  %46 = icmp slt i64 %.08, %45
  br i1 %46, label %47, label %64

47:                                               ; preds = %44
  %48 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %2, i64 %.08) #3
  %49 = load i64, i64* %48, align 8
  %50 = add nsw i64 %.07, %49
  %51 = srem i64 %50, 86400
  %52 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %6, i64 %51) #3
  %53 = load i64, i64* %52, align 8
  %54 = add nsw i64 %53, 1
  store i64 %54, i64* %52, align 8
  %55 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %4, i64 %.08) #3
...
64:                                               ; preds = %44
  ...
  invoke void @_ZNSt6vectorIxSaIxEEC2EmRKxRKS0_(%"class.std::vector"* %9, i64 86401, i64* dereferenceable(8) %10, %"class.std::allocator"* dereferenceable(1) %11)
...
66:                                               ; preds = %76, %65
  %.09 = phi i64 [ 0, %65 ], [ %77, %76 ]
  %67 = icmp slt i64 %.09, 86400
  br i1 %67, label %68, label %82

68:                                               ; preds = %66
  %69 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %9, i64 %.09) #3
  %70 = load i64, i64* %69, align 8
  %71 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %6, i64 %.09) #3
...
83:                                               ; preds = %94, %82
  %.06 = phi i64 [ 0, %82 ], [ %95, %94 ]
  %84 = add nsw i64 %.06, 10800
  %85 = icmp sle i64 %84, 86400
  br i1 %85, label %86, label %100

86:                                               ; preds = %83
  %87 = add nsw i64 %.06, 10800
  %88 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %9, i64 %87) #3
  %89 = load i64, i64* %88, align 8
  %90 = call dereferenceable(8) i64* @_ZNSt6vectorIxSaIxEEixEm(%"class.std::vector"* %9, i64 %.06) #3
  %91 = load i64, i64* %90, align 8
  %92 = sub nsw i64 %89, %91
  invoke void @_Z5chmaxIxxEvRT_T0_(i64* dereferenceable(8) %12, i64 %92)
...
106:                                              ; preds = %96, %78
  %.01 = phi i32 [ %99, %96 ], [ %81, %78 ]
  %.0 = phi i8* [ %98, %96 ], [ %80, %78 ]
  call void @_ZNSt6vectorIxSaIxEED2Ev(%"class.std::vector"* %6) #3
  br label %107

107:                                              ; preds = %106, %60, %38
  %.12 = phi i32 [ %41, %38 ], [ %.01, %106 ], [ %63, %60 ]
  %.1 = phi i8* [ %40, %38 ], [ %.0, %106 ], [ %62, %60 ]
  call void @_ZNSt6vectorIxSaIxEED2Ev(%"class.std::vector"* %4) #3
  br label %108

108:                                              ; preds = %107, %34
  %.23 = phi i32 [ %.12, %107 ], [ %37, %34 ]
  %.2 = phi i8* [ %.1, %107 ], [ %36, %34 ]
  call void @_ZNSt6vectorIxSaIxEED2Ev(%"class.std::vector"* %2) #3
  br label %109

109:                                              ; preds = %108, %30
  %.34 = phi i32 [ %.23, %108 ], [ %33, %30 ]
  %.3 = phi i8* [ %.2, %108 ], [ %32, %30 ]
  %110 = insertvalue { i8*, i32 } undef, i8* %.3, 0
  %111 = insertvalue { i8*, i32 } %110, i32 %.34, 1
  resume { i8*, i32 } %111
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_Z5chmaxIxxEvRT_T0_(i64* dereferenceable(8) %0, i64 %1) #5 comdat {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s735690615.cpp() #0 section ".text.startup" {
