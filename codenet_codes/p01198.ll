; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01198/s598290790.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01198/s598290790.cpp"
...
@.str.1 = private unnamed_addr constant [10 x i8] c"try again\00", align 1
@.str.2 = private unnamed_addr constant [6 x i8] c"good \00", align 1
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s598290790.cpp, i8* null }]
...
define i32 @main() #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %10 = alloca [201 x [101 x i8]], align 16
...
30:                                               ; preds = %196, %185, %183, %180, %175, %173, %171, %166, %164, %158, %156, %145, %71, %69, %51, %49, %43, %34, %26, %24
...
53:                                               ; preds = %51
  ...
  %56 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEE4backEv(%"class.std::vector"* %3) #3
  %57 = load i32, i32* %56, align 4
  %58 = sitofp i32 %57 to double
  %59 = fdiv double %55, %58
  %60 = load i32, i32* %8, align 4
  %61 = sitofp i32 %60 to double
  %62 = load double, double* @eps, align 8
...
69:                                               ; preds = %53
  %70 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i32 0, i32 0))
...
74:                                               ; preds = %53
  %75 = getelementptr inbounds [201 x [101 x i8]], [201 x [101 x i8]]* %10, i32 0, i32 0
  %76 = bitcast [101 x i8]* %75 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %76, i8 0, i64 20301, i1 false)
  %77 = load i32, i32* %8, align 4
  %78 = mul nsw i32 2, %77
  %79 = sext i32 %78 to i64
  %80 = getelementptr inbounds [201 x [101 x i8]], [201 x [101 x i8]]* %10, i64 0, i64 %79
...
86:                                               ; preds = %130, %74
  %.03 = phi i32 [ %85, %74 ], [ %131, %130 ]
  %87 = icmp sgt i32 %.03, 0
...
89:                                               ; preds = %127, %88
  %.02 = phi i32 [ 1, %88 ], [ %128, %127 ]
  %90 = load i32, i32* %9, align 4
  %91 = icmp sle i32 %.02, %90
  br i1 %91, label %92, label %129

92:                                               ; preds = %89
  %93 = sext i32 %.03 to i64
  %94 = getelementptr inbounds [201 x [101 x i8]], [201 x [101 x i8]]* %10, i64 0, i64 %93
  %95 = sext i32 %.02 to i64
  %96 = getelementptr inbounds [101 x i8], [101 x i8]* %94, i64 0, i64 %95
...
104:                                              ; preds = %100
  ...
  %108 = sub nsw i32 %.02, %107
  %109 = icmp sge i32 %108, 0
  br i1 %109, label %110, label %122

110:                                              ; preds = %104
  %111 = sub nsw i32 %.03, %.02
  %112 = sub nsw i32 %111, %108
  %113 = icmp sge i32 %112, 0
  br i1 %113, label %114, label %121

114:                                              ; preds = %110
  %115 = sub nsw i32 %.03, %.02
  %116 = sub nsw i32 %115, %108
  %117 = sext i32 %116 to i64
  %118 = getelementptr inbounds [201 x [101 x i8]], [201 x [101 x i8]]* %10, i64 0, i64 %117
  %119 = sext i32 %108 to i64
  %120 = getelementptr inbounds [101 x i8], [101 x i8]* %118, i64 0, i64 %119
...
138:                                              ; preds = %133
  ...
  %141 = getelementptr inbounds [201 x [101 x i8]], [201 x [101 x i8]]* %10, i64 0, i64 %140
...
153:                                              ; preds = %133
  ...
  %155 = icmp eq i32 %154, 9999
  br i1 %155, label %156, label %161

156:                                              ; preds = %153
  %157 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i32 0, i32 0))
...
164:                                              ; preds = %161
  %165 = invoke i32 @_ZSt12setprecisioni(i32 3)
...
166:                                              ; preds = %164
  ...
  %170 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_St13_Setprecision(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i32 %169)
          to label %171 unwind label %30

171:                                              ; preds = %166
  %172 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEPFRSt8ios_baseS0_E(%"class.std::basic_ostream"* %170, %"class.std::ios_base"* (%"class.std::ios_base"*)* @_ZSt5fixedRSt8ios_base)
          to label %173 unwind label %30

173:                                              ; preds = %171
  %174 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %172, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i32 0, i32 0))
...
175:                                              ; preds = %173
  ...
  %179 = invoke i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i32 0, i32 0), double %178)
...
183:                                              ; preds = %161
  %184 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.4, i32 0, i32 0))
          to label %185 unwind label %30
...
201:                                              ; preds = %30
  %202 = insertvalue { i8*, i32 } undef, i8* %32, 0
  %203 = insertvalue { i8*, i32 } %202, i32 %33, 1
  resume { i8*, i32 } %203
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s598290790.cpp() #0 section ".text.startup" {
