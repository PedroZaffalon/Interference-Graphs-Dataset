; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00795/s910222845.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00795/s910222845.cpp"
...
@valid = global [256 x i32] zeroinitializer, align 16
@cnt = global [256 x i32] zeroinitializer, align 16
@kind = global i32 0, align 4
@_ZSt3cin = external global %"class.std::basic_istream", align 8
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s910222845.cpp, i8* null }]
...
define void @_Z3addc(i8 signext %0) #4 {
  %2 = sext i8 %0 to i64
  %3 = getelementptr inbounds [256 x i32], [256 x i32]* @valid, i64 0, i64 %2
...
7:                                                ; preds = %1
  %8 = sext i8 %0 to i64
  %9 = getelementptr inbounds [256 x i32], [256 x i32]* @cnt, i64 0, i64 %8
...
; Function Attrs: noinline nounwind uwtable
define void @_Z3subc(i8 signext %0) #4 {
  %2 = sext i8 %0 to i64
  %3 = getelementptr inbounds [256 x i32], [256 x i32]* @valid, i64 0, i64 %2
  %4 = load i32, i32* %3, align 4
  %5 = icmp ne i32 %4, 0
...
10:                                               ; preds = %9
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE5clearEv(%"class.std::__cxx11::basic_string"* %1) #3
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE5clearEv(%"class.std::__cxx11::basic_string"* %2) #3
  br label %11
...
26:                                               ; preds = %164, %160, %151, %144, %141, %132, %128, %126, %123, %118, %96, %85, %80, %63, %47, %45, %35, %30, %16, %12
...
30:                                               ; preds = %24
  %31 = invoke dereferenceable(32) %"class.std::__cxx11::basic_string"* @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEpLERKS4_(%"class.std::__cxx11::basic_string"* %1, %"class.std::__cxx11::basic_string"* dereferenceable(32) %2)
...
33:                                               ; preds = %25
  %34 = call zeroext i1 @_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE5emptyEv(%"class.std::__cxx11::basic_string"* %1) #3
...
45:                                               ; preds = %43
  %46 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZSt7getlineIcSt11char_traitsIcESaIcEERSt13basic_istreamIT_T0_ES7_RNSt7__cxx1112basic_stringIS4_S5_T1_EE(%"class.std::basic_istream"* dereferenceable(280) @_ZSt3cin, %"class.std::__cxx11::basic_string"* dereferenceable(32) %2)
          to label %47 unwind label %26

47:                                               ; preds = %45
  %48 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSi6ignoreEv(%"class.std::basic_istream"* @_ZSt3cin)
          to label %49 unwind label %26

49:                                               ; preds = %47
  call void @llvm.memset.p0i8.i64(i8* align 16 bitcast ([256 x i32]* @cnt to i8*), i8 0, i64 1024, i1 false)
  call void @llvm.memset.p0i8.i64(i8* align 16 bitcast ([256 x i32]* @valid to i8*), i8 0, i64 1024, i1 false)
...
54:                                               ; preds = %61, %49
  %55 = call zeroext i1 @_ZN9__gnu_cxxneIPcNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEEbRKNS_17__normal_iteratorIT_T0_EESD_(%"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %3, %"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %4) #3
...
56:                                               ; preds = %54
  ...
  %60 = getelementptr inbounds [256 x i32], [256 x i32]* @valid, i64 0, i64 %59
...
63:                                               ; preds = %54
  ...
  %68 = add nsw i32 %65, 1
  invoke void @_ZNSt4pairIiiEC2IiiLb1EEEv(%"struct.std::pair"* %7)
...
70:                                               ; preds = %125, %69
  %.03 = phi i32 [ %68, %69 ], [ %.25, %125 ]
  %.02 = phi i32 [ 0, %69 ], [ %.3, %125 ]
  br label %71
...
85:                                               ; preds = %80
  ...
  invoke void @_Z3addc(i8 signext %86)
...
101:                                              ; preds = %96
  ...
  %103 = call dereferenceable(8) %"struct.std::pair"* @_ZNSt4pairIiiEaSEOS0_(%"struct.std::pair"* %7, %"struct.std::pair"* dereferenceable(8) %8) #3
  br label %112
...
111:                                              ; preds = %109, %104
  %.1 = phi i32 [ %110, %109 ], [ %.02, %104 ]
  br label %112

112:                                              ; preds = %111, %101
  %.14 = phi i32 [ %99, %101 ], [ %.03, %111 ]
  %.2 = phi i32 [ 1, %101 ], [ %.1, %111 ]
  br label %113

113:                                              ; preds = %112, %88
  %.25 = phi i32 [ %.14, %112 ], [ %.03, %88 ]
  %.3 = phi i32 [ %.2, %112 ], [ %.02, %88 ]
...
123:                                              ; preds = %118
  ...
  invoke void @_Z3subc(i8 signext %124)
...
137:                                              ; preds = %155, %134
  %.01 = phi i32 [ 0, %134 ], [ %148, %155 ]
  %.0 = phi i32 [ %136, %134 ], [ %156, %155 ]
  %138 = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* %7, i32 0, i32 1
...
168:                                              ; preds = %26
  %169 = insertvalue { i8*, i32 } undef, i8* %28, 0
  %170 = insertvalue { i8*, i32 } %169, i32 %29, 1
  resume { i8*, i32 } %170
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s910222845.cpp() #0 section ".text.startup" {
