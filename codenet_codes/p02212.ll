; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02212/s216761834.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02212/s216761834.cpp"
...
%"class.std::priority_queue.0" = type <{ %"class.std::vector.1", %"struct.std::less.6", [7 x i8] }>
...
%"class.std::priority_queue.11" = type <{ %"class.std::vector.1", %"struct.std::greater.12", [7 x i8] }>
...
@pqp = global %"class.std::priority_queue.0" zeroinitializer, align 8
...
@mod1 = global i64 2000000011, align 8
@mod2 = global i64 2000000033, align 8
...
@x = global [50005 x i64] zeroinitializer, align 16
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s216761834.cpp, i8* null }]
...
define internal void @__cxx_global_var_init.1() #0 section ".text.startup" {
  call void @_ZNSt14priority_queueIxSt6vectorIxSaIxEESt4lessIxEEC2IS2_vEEv(%"class.std::priority_queue"* @pql)
  %1 = call i32 @__cxa_atexit(void (i8*)* bitcast (void (%"class.std::priority_queue"*)* @_ZNSt14priority_queueIxSt6vectorIxSaIxEESt4lessIxEED2Ev to void (i8*)*), i8* bitcast (%"class.std::priority_queue"* @pql to i8*), i8* @__dso_handle) #3
  ret void
}
...
define internal void @__cxx_global_var_init.2() #0 section ".text.startup" {
  call void @_ZNSt14priority_queueISt4pairIxxESt6vectorIS1_SaIS1_EESt4lessIS1_EEC2IS4_vEEv(%"class.std::priority_queue.0"* @pqp)
  %1 = call i32 @__cxa_atexit(void (i8*)* bitcast (void (%"class.std::priority_queue.0"*)* @_ZNSt14priority_queueISt4pairIxxESt6vectorIS1_SaIS1_EESt4lessIS1_EED2Ev to void (i8*)*), i8* bitcast (%"class.std::priority_queue.0"* @pqp to i8*), i8* @__dso_handle) #3
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt14priority_queueISt4pairIxxESt6vectorIS1_SaIS1_EESt4lessIS1_EEC2IS4_vEEv(%"class.std::priority_queue.0"* %0) unnamed_addr #4 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt14priority_queueISt4pairIxxESt6vectorIS1_SaIS1_EESt4lessIS1_EED2Ev(%"class.std::priority_queue.0"* %0) unnamed_addr #4 comdat align 2 {
  %2 = getelementptr inbounds %"class.std::priority_queue.0", %"class.std::priority_queue.0"* %0, i32 0, i32 0
...
define internal void @__cxx_global_var_init.3() #0 section ".text.startup" {
  call void @_ZNSt14priority_queueIxSt6vectorIxSaIxEESt7greaterIxEEC2IS2_vEEv(%"class.std::priority_queue.9"* @pqls)
  %1 = call i32 @__cxa_atexit(void (i8*)* bitcast (void (%"class.std::priority_queue.9"*)* @_ZNSt14priority_queueIxSt6vectorIxSaIxEESt7greaterIxEED2Ev to void (i8*)*), i8* bitcast (%"class.std::priority_queue.9"* @pqls to i8*), i8* @__dso_handle) #3
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt14priority_queueIxSt6vectorIxSaIxEESt7greaterIxEEC2IS2_vEEv(%"class.std::priority_queue.9"* %0) unnamed_addr #4 comdat align 2 {
  %2 = getelementptr inbounds %"class.std::priority_queue.9", %"class.std::priority_queue.9"* %0, i32 0, i32 0
  call void @_ZNSt6vectorIxSaIxEEC2Ev(%"class.std::vector"* %2) #3
  %3 = getelementptr inbounds %"class.std::priority_queue.9", %"class.std::priority_queue.9"* %0, i32 0, i32 1
  ret void
}
...
define internal void @__cxx_global_var_init.4() #0 section ".text.startup" {
  call void @_ZNSt14priority_queueISt4pairIxxESt6vectorIS1_SaIS1_EESt7greaterIS1_EEC2IS4_vEEv(%"class.std::priority_queue.11"* @pqps)
  %1 = call i32 @__cxa_atexit(void (i8*)* bitcast (void (%"class.std::priority_queue.11"*)* @_ZNSt14priority_queueISt4pairIxxESt6vectorIS1_SaIS1_EESt7greaterIS1_EED2Ev to void (i8*)*), i8* bitcast (%"class.std::priority_queue.11"* @pqps to i8*), i8* @__dso_handle) #3
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt14priority_queueISt4pairIxxESt6vectorIS1_SaIS1_EESt7greaterIS1_EEC2IS4_vEEv(%"class.std::priority_queue.11"* %0) unnamed_addr #4 comdat align 2 {
  %2 = getelementptr inbounds %"class.std::priority_queue.11", %"class.std::priority_queue.11"* %0, i32 0, i32 0
  call void @_ZNSt6vectorISt4pairIxxESaIS1_EEC2Ev(%"class.std::vector.1"* %2) #3
  %3 = getelementptr inbounds %"class.std::priority_queue.11", %"class.std::priority_queue.11"* %0, i32 0, i32 1
  ret void
}
...
; Function Attrs: noinline uwtable
define i64 @_Z3ruixx(i64 %0, i64 %1) #0 {
  %3 = icmp eq i64 %1, 0
...
5:                                                ; preds = %2
  %6 = sdiv i64 %1, 2
  %7 = call i64 @_Z3ruixx(i64 %0, i64 %6)
  %8 = mul nsw i64 %7, %7
...
; Function Attrs: noinline uwtable
define i64 @_Z4rui1xx(i64 %0, i64 %1) #0 {
  %3 = icmp eq i64 %1, 0
  br i1 %3, label %4, label %5
...
5:                                                ; preds = %2
  %6 = sdiv i64 %1, 2
  %7 = call i64 @_Z4rui1xx(i64 %0, i64 %6)
  %8 = mul nsw i64 %7, %7
  %9 = load i64, i64* @mod1, align 8
  %10 = srem i64 %8, %9
  %11 = srem i64 %1, 2
  %12 = icmp eq i64 %11, 1
  br i1 %12, label %13, label %17
...
; Function Attrs: noinline uwtable
define i64 @_Z4rui2xx(i64 %0, i64 %1) #0 {
  %3 = icmp eq i64 %1, 0
  br i1 %3, label %4, label %5
...
5:                                                ; preds = %2
  %6 = sdiv i64 %1, 2
  %7 = call i64 @_Z4rui2xx(i64 %0, i64 %6)
  %8 = mul nsw i64 %7, %7
  %9 = load i64, i64* @mod2, align 8
  %10 = srem i64 %8, %9
  %11 = srem i64 %1, 2
  %12 = icmp eq i64 %11, 1
  br i1 %12, label %13, label %17
...
; Function Attrs: noinline uwtable
define void @_Z3YESb(i1 zeroext %0) #0 {
  %2 = zext i1 %0 to i8
  %3 = trunc i8 %2 to i1
...
4:                                                ; preds = %1
  ...
  %6 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %5, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.5, i32 0, i32 0))
  br label %10
...
4:                                                ; preds = %1
  %5 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.7, i32 0, i32 0))
  %6 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %5, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.5, i32 0, i32 0))
  br label %10

7:                                                ; preds = %1
  %8 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.8, i32 0, i32 0))
  %9 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %8, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.5, i32 0, i32 0))
  br label %10
...
6:                                                ; preds = %3
  %7 = getelementptr inbounds [50005 x i64], [50005 x i64]* @x, i64 0, i64 %.01
  %8 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERx(%"class.std::basic_istream"* @_ZSt3cin, i64* dereferenceable(8) %7)
  %9 = getelementptr inbounds [50005 x i64], [50005 x i64]* @x, i64 0, i64 %.01
...
16:                                               ; preds = %33, %14
  %.02 = phi i64 [ 1, %14 ], [ %34, %33 ]
  %17 = load i64, i64* @n, align 8
  %18 = icmp slt i64 %.02, %17
  br i1 %18, label %19, label %35

19:                                               ; preds = %16
  %20 = load i64, i64* getelementptr inbounds ([50005 x i64], [50005 x i64]* @x, i64 0, i64 0), align 16
  %21 = getelementptr inbounds [50005 x i64], [50005 x i64]* @x, i64 0, i64 %.02
  %22 = load i64, i64* %21, align 8
  %23 = add nsw i64 %20, %22
  %24 = load i64, i64* getelementptr inbounds ([50005 x i64], [50005 x i64]* @x, i64 0, i64 0), align 16
  %25 = sub nsw i64 %.0, %24
  %26 = getelementptr inbounds [50005 x i64], [50005 x i64]* @x, i64 0, i64 %.02
...
define linkonce_odr void @_ZNSt6vectorISt4pairIxxESaIS1_EED2Ev(%"class.std::vector.1"* %0) unnamed_addr #4 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %11 = call dereferenceable(1) %"class.std::allocator.3"* @_ZNSt12_Vector_baseISt4pairIxxESaIS1_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base.2"* %10) #3
  invoke void @_ZSt8_DestroyIPSt4pairIxxES1_EvT_S3_RSaIT0_E(%"struct.std::pair"* %5, %"struct.std::pair"* %9, %"class.std::allocator.3"* dereferenceable(1) %11)
          to label %12 unwind label %14

12:                                               ; preds = %1
  %13 = bitcast %"class.std::vector.1"* %0 to %"struct.std::_Vector_base.2"*
  call void @_ZNSt12_Vector_baseISt4pairIxxESaIS1_EED2Ev(%"struct.std::_Vector_base.2"* %13) #3
  ret void
...
14:                                               ; preds = %1
  ...
  call void @_ZNSt12_Vector_baseISt4pairIxxESaIS1_EED2Ev(%"struct.std::_Vector_base.2"* %18) #3
  br label %19
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZSt8_DestroyIPSt4pairIxxES1_EvT_S3_RSaIT0_E(%"struct.std::pair"* %0, %"struct.std::pair"* %1, %"class.std::allocator.3"* dereferenceable(1) %2) #0 comdat {
  call void @_ZSt8_DestroyIPSt4pairIxxEEvT_S3_(%"struct.std::pair"* %0, %"struct.std::pair"* %1)
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(1) %"class.std::allocator.3"* @_ZNSt12_Vector_baseISt4pairIxxESaIS1_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base.2"* %0) #4 comdat align 2 {
  %2 = getelementptr inbounds %"struct.std::_Vector_base.2", %"struct.std::_Vector_base.2"* %0, i32 0, i32 0
  %3 = bitcast %"struct.std::_Vector_base<std::pair<long long, long long>, std::allocator<std::pair<long long, long long> > >::_Vector_impl"* %2 to %"class.std::allocator.3"*
...
define linkonce_odr void @_ZNSt12_Vector_baseISt4pairIxxESaIS1_EED2Ev(%"struct.std::_Vector_base.2"* %0) unnamed_addr #4 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  invoke void @_ZNSt12_Vector_baseISt4pairIxxESaIS1_EE13_M_deallocateEPS1_m(%"struct.std::_Vector_base.2"* %0, %"struct.std::pair"* %4, i64 %14)
          to label %15 unwind label %17
...
; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt12_Vector_baseISt4pairIxxESaIS1_EE13_M_deallocateEPS1_m(%"struct.std::_Vector_base.2"* %0, %"struct.std::pair"* %1, i64 %2) #0 comdat align 2 {
...
5:                                                ; preds = %3
  ...
  %7 = bitcast %"struct.std::_Vector_base<std::pair<long long, long long>, std::allocator<std::pair<long long, long long> > >::_Vector_impl"* %6 to %"class.std::allocator.3"*
  call void @_ZNSt16allocator_traitsISaISt4pairIxxEEE10deallocateERS2_PS1_m(%"class.std::allocator.3"* dereferenceable(1) %7, %"struct.std::pair"* %1, i64 %2)
  br label %8
...
define linkonce_odr void @_ZNSt12_Vector_baseISt4pairIxxESaIS1_EE12_Vector_implD2Ev(%"struct.std::_Vector_base<std::pair<long long, long long>, std::allocator<std::pair<long long, long long> > >::_Vector_impl"* %0) unnamed_addr #4 comdat align 2 {
  ...
  call void @_ZNSaISt4pairIxxEED2Ev(%"class.std::allocator.3"* %2) #3
  ret void
}

; Function Attrs: noinline uwtable
define linkonce_odr void @_ZNSt16allocator_traitsISaISt4pairIxxEEE10deallocateERS2_PS1_m(%"class.std::allocator.3"* dereferenceable(1) %0, %"struct.std::pair"* %1, i64 %2) #0 comdat align 2 {
  %4 = bitcast %"class.std::allocator.3"* %0 to %"class.__gnu_cxx::new_allocator.4"*
  call void @_ZN9__gnu_cxx13new_allocatorISt4pairIxxEE10deallocateEPS2_m(%"class.__gnu_cxx::new_allocator.4"* %4, %"struct.std::pair"* %1, i64 %2)
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorISt4pairIxxEE10deallocateEPS2_m(%"class.__gnu_cxx::new_allocator.4"* %0, %"struct.std::pair"* %1, i64 %2) #4 comdat align 2 {
...
define linkonce_odr void @_ZNSaISt4pairIxxEED2Ev(%"class.std::allocator.3"* %0) unnamed_addr #4 comdat align 2 {
  ...
  call void @_ZN9__gnu_cxx13new_allocatorISt4pairIxxEED2Ev(%"class.__gnu_cxx::new_allocator.4"* %2) #3
  ret void
}
...
define linkonce_odr void @_ZNSt12_Vector_baseISt4pairIxxESaIS1_EE12_Vector_implC2Ev(%"struct.std::_Vector_base<std::pair<long long, long long>, std::allocator<std::pair<long long, long long> > >::_Vector_impl"* %0) unnamed_addr #4 comdat align 2 {
  %2 = bitcast %"struct.std::_Vector_base<std::pair<long long, long long>, std::allocator<std::pair<long long, long long> > >::_Vector_impl"* %0 to %"class.std::allocator.3"*
  call void @_ZNSaISt4pairIxxEEC2Ev(%"class.std::allocator.3"* %2) #3
...
define linkonce_odr void @_ZNSaISt4pairIxxEEC2Ev(%"class.std::allocator.3"* %0) unnamed_addr #4 comdat align 2 {
  %2 = bitcast %"class.std::allocator.3"* %0 to %"class.__gnu_cxx::new_allocator.4"*
  call void @_ZN9__gnu_cxx13new_allocatorISt4pairIxxEEC2Ev(%"class.__gnu_cxx::new_allocator.4"* %2) #3
  ret void
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s216761834.cpp() #0 section ".text.startup" {
