; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01891/s252303991.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01891/s252303991.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s252303991.cpp, i8* null }]
...
23:                                               ; preds = %0
  ...
  %24 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector"* %5) #3
  %25 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %7, i32 0, i32 0
  store i32* %24, i32** %25, align 8
  %26 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector"* %5) #3
...
44:                                               ; preds = %28
  ...
  %45 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector"* %5) #3
  %46 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %10, i32 0, i32 0
  store i32* %45, i32** %46, align 8
  %47 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector"* %5) #3
...
57:                                               ; preds = %51
  invoke void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %9, i32* dereferenceable(4) %12)
          to label %58 unwind label %59

58:                                               ; preds = %57
  br label %64

59:                                               ; preds = %108, %103, %75, %57
...
111:                                              ; preds = %59, %40
  %.01 = phi i32 [ %43, %40 ], [ %62, %59 ]
  %.0 = phi i8* [ %42, %40 ], [ %61, %59 ]
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %5) #3
  br label %112

112:                                              ; preds = %111, %36
  %.12 = phi i32 [ %.01, %111 ], [ %39, %36 ]
  %.1 = phi i8* [ %.0, %111 ], [ %38, %36 ]
  %113 = insertvalue { i8*, i32 } undef, i8* %.1, 0
  %114 = insertvalue { i8*, i32 } %113, i32 %.12, 1
  resume { i8*, i32 } %114
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s252303991.cpp() #0 section ".text.startup" {
