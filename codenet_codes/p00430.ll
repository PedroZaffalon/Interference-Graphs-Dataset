; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p00430/s475483386.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p00430/s475483386.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s475483386.cpp, i8* null }]
...
5:                                                ; preds = %2
  %6 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* @vec) #3
...
10:                                               ; preds = %8
  ...
  %12 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* @vec, i64 %11) #3
  %13 = load i32, i32* %12, align 4
  %14 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %13)
  %15 = sub nsw i32 %7, 1
  %16 = icmp ne i32 %.01, %15
  %17 = zext i1 %16 to i64
  %18 = select i1 %16, i8 32, i8 10
  %19 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(%"class.std::basic_ostream"* dereferenceable(272) %14, i8 signext %18)
  br label %20
...
30:                                               ; preds = %26
  ...
  call void @_ZNSt6vectorIiSaIiEE9push_backEOi(%"class.std::vector"* @vec, i32* dereferenceable(4) %3)
  %32 = sub nsw i32 %0, %1
  %33 = add nsw i32 %32, %.0
  %34 = sub nsw i32 %1, %.0
  call void @_Z3recii(i32 %33, i32 %34)
...
5:                                                ; preds = %1
  ...
  call void @_Z3recii(i32 %6, i32 %7)
  br label %1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s475483386.cpp() #0 section ".text.startup" {
