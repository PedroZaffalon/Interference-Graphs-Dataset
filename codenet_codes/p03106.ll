; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03106/s676318755.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03106/s676318755.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s676318755.cpp, i8* null }]
...
10:                                               ; preds = %34, %0
  ...
  %12 = invoke dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* dereferenceable(4) %1, i32* dereferenceable(4) %2)
...
37:                                               ; preds = %13
  ...
  invoke void @_ZSt7reverseIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEEvT_S7_(i32* %43, i32* %45)
...
58:                                               ; preds = %29
  %59 = insertvalue { i8*, i32 } undef, i8* %31, 0
  %60 = insertvalue { i8*, i32 } %59, i32 %32, 1
  resume { i8*, i32 } %60
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s676318755.cpp() #0 section ".text.startup" {
