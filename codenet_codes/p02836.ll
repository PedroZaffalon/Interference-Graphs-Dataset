; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p02836/s782986364.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p02836/s782986364.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s782986364.cpp, i8* null }]
...
49:                                               ; preds = %22
  %50 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEx(%"class.std::basic_ostream"* @_ZSt4cout, i64 %.0)
...
54:                                               ; preds = %42
  %55 = insertvalue { i8*, i32 } undef, i8* %44, 0
  %56 = insertvalue { i8*, i32 } %55, i32 %45, 1
  resume { i8*, i32 } %56
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s782986364.cpp() #0 section ".text.startup" {
