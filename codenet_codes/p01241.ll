; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p01241/s950009211.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p01241/s950009211.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s950009211.cpp, i8* null }]
...
92:                                               ; preds = %45
  %93 = invoke dereferenceable(24) %"class.std::vector"* @_ZNSt6vectorIiSaIiEEaSERKS1_(%"class.std::vector"* %3, %"class.std::vector"* dereferenceable(24) %6)
...
95:                                               ; preds = %94, %34
  %.07 = phi i32 [ 5, %34 ], [ 0, %94 ]
  %.1 = phi i64 [ %.02, %34 ], [ %44, %94 ]
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %6) #3
  switch i32 %.07, label %122 [
    i32 0, label %96
    i32 5, label %101
  ]
...
101:                                              ; preds = %95
  %102 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i32 0, i32 0))
          to label %103 unwind label %113

103:                                              ; preds = %101
  %104 = add nsw i32 %.01, 1
  %105 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %102, i32 %.01)
          to label %106 unwind label %113

106:                                              ; preds = %103
  %107 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %105, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i32 0, i32 0))
          to label %108 unwind label %113

108:                                              ; preds = %106
  %109 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEx(%"class.std::basic_ostream"* @_ZSt4cout, i64 %.1)
...
117:                                              ; preds = %113, %97, %39
  %.05 = phi i32 [ %116, %113 ], [ %100, %97 ], [ %42, %39 ]
  %.03 = phi i8* [ %115, %113 ], [ %99, %97 ], [ %41, %39 ]
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %3) #3
  br label %119
...
119:                                              ; preds = %117, %35
  %.16 = phi i32 [ %.05, %117 ], [ %38, %35 ]
  %.14 = phi i8* [ %.03, %117 ], [ %37, %35 ]
  %120 = insertvalue { i8*, i32 } undef, i8* %.14, 0
  %121 = insertvalue { i8*, i32 } %120, i32 %.16, 1
  resume { i8*, i32 } %121
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(8) i32** @_ZNK9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEE4baseEv(%"class.__gnu_cxx::__normal_iterator.0"* %0) #5 comdat align 2 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s950009211.cpp() #0 section ".text.startup" {
