; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03632/s436498302.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03632/s436498302.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s436498302.cpp, i8* null }]
...
define i32 @main() #4 {
  ...
  %9 = call dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* dereferenceable(4) %1, i32* dereferenceable(4) %3)
  %10 = load i32, i32* %9, align 4
  %11 = call dereferenceable(4) i32* @_ZSt3minIiERKT_S2_S2_(i32* dereferenceable(4) %2, i32* dereferenceable(4) %4)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s436498302.cpp() #0 section ".text.startup" {
