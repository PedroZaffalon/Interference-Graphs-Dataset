; ModuleID = '/home/pedro/tcc/exDataset/codenet/data/selection/p03013/s680355567.ll'
source_filename = "/home/pedro/tcc/exDataset/codenet/data/selection/p03013/s680355567.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s680355567.cpp, i8* null }]
...
34:                                               ; preds = %30
  ...
  %35 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %5, i64 0) #3
  store i32 1, i32* %35, align 4
  br label %36

36:                                               ; preds = %99, %34
  %.07 = phi i32 [ 1, %34 ], [ %100, %99 ]
  %.05 = phi i32 [ 0, %34 ], [ %.2, %99 ]
...
109:                                              ; preds = %58, %54, %26
  %.02 = phi i32 [ %29, %26 ], [ %61, %58 ], [ %57, %54 ]
  %.01 = phi i8* [ %28, %26 ], [ %60, %58 ], [ %56, %54 ]
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %3) #3
  br label %110

110:                                              ; preds = %109, %22
  %.13 = phi i32 [ %.02, %109 ], [ %25, %22 ]
  %.1 = phi i8* [ %.01, %109 ], [ %24, %22 ]
  %111 = insertvalue { i8*, i32 } undef, i8* %.1, 0
  %112 = insertvalue { i8*, i32 } %111, i32 %.13, 1
  resume { i8*, i32 } %112
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s680355567.cpp() #0 section ".text.startup" {
