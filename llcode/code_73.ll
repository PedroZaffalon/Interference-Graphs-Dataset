; ModuleID = '/home/pedro/tcc/exDataset/listasJandira-master/code_73.ll'
source_filename = "/home/pedro/tcc/exDataset/listasJandira-master/occurance_of_string.c"
...
12:                                               ; preds = %32, %10
  %.02 = phi i32 [ 1, %10 ], [ %.1, %32 ]
  %.01 = phi i32 [ %11, %10 ], [ %33, %32 ]
...
40:                                               ; preds = %34
  ...
  %45 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i32 0, i32 0), i32 %44, i32 %.02)
  br label %46
