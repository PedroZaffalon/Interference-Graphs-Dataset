; ModuleID = '/home/pedro/tcc/exDataset/listasJandira-master/code_699.ll'
source_filename = "/home/pedro/tcc/exDataset/listasJandira-master/matrix_subtraction.c"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

@main.A = private unnamed_addr constant [3 x [4 x i32]] [[4 x i32] [i32 2, i32 2, i32 2, i32 2], [4 x i32] [i32 2, i32 2, i32 2, i32 2], [4 x i32] [i32 2, i32 2, i32 2, i32 2]], align 16
@main.B = private unnamed_addr constant [3 x [4 x i32]] [[4 x i32] [i32 1, i32 1, i32 1, i32 1], [4 x i32] [i32 1, i32 1, i32 1, i32 1], [4 x i32] [i32 1, i32 1, i32 1, i32 1]], align 16
...
define i32 @main() #0 {
  ...
  call void @matrix_subtraction([4 x i32]* %6, [4 x i32]* %7, [4 x i32]* %8)
  br label %9
...
; Function Attrs: noinline nounwind uwtable
define void @matrix_subtraction([4 x i32]* %0, [4 x i32]* %1, [4 x i32]* %2) #0 {
  br label %4
