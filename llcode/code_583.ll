; ModuleID = '/home/pedro/tcc/exDataset/listasJandira-master/code_583.ll'
source_filename = "/home/pedro/tcc/exDataset/listasJandira-master/Fibonacci.c"
...
define i32 @main() #0 {
  ...
  %5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.2, i32 0, i32 0), i32 0, i32 1)
  br label %6

6:                                                ; preds = %12, %0
  %.02 = phi i32 [ 1, %0 ], [ %.0, %12 ]
  %.01 = phi i32 [ 3, %0 ], [ %13, %12 ]
  %.0 = phi i32 [ %2, %0 ], [ %11, %12 ]
...
9:                                                ; preds = %6
  %10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i32 0, i32 0), i32 %.0)
  %11 = add nsw i32 %.02, %.0
  br label %12
