; ModuleID = '/home/pedro/tcc/exDataset/listasJandira-master/code_675.ll'
source_filename = "/home/pedro/tcc/exDataset/listasJandira-master/second_highest.c"
...
@.str = private unnamed_addr constant [20 x i8] c"second highest: %d\0A\00", align 1
...
define i32 @main() #0 {
  ...
  %4 = call i32 @second_highest(i32* %3, i32 10)
  %5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str, i32 0, i32 0), i32 %4)
  ret i32 0
}

; Function Attrs: noinline nounwind uwtable
define i32 @second_highest(i32* %0, i32 %1) #0 {
