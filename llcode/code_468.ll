; ModuleID = '/home/pedro/tcc/exDataset/listasJandira-master/code_468.ll'
source_filename = "/home/pedro/tcc/exDataset/listasJandira-master/col_sum_avg_2darray.c"
...
@.str = private unnamed_addr constant [20 x i8] c"Column %d Sum = %f\0A\00", align 1
@.str.1 = private unnamed_addr constant [25 x i8] c"Column %d Average = %f\0A\0A\00", align 1
...
17:                                               ; preds = %6
  ...
  %19 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str, i32 0, i32 0), i32 %.02, double %18)
  %20 = fdiv float %.01, 5.000000e+00
  %21 = fpext float %20 to double
  %22 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.1, i32 0, i32 0), i32 %.02, double %21)
  br label %23
