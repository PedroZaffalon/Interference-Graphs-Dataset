; ModuleID = '/home/pedro/tcc/exDataset/listasJandira-master/code_707.ll'
source_filename = "/home/pedro/tcc/exDataset/listasJandira-master/memset.c"
...
define i32 @main() #0 {
  ...
  call void @llvm.memset.p0i8.i64(i8* align 1 %2, i8 99, i64 5, i1 false)
  %3 = getelementptr inbounds [10 x i8], [10 x i8]* %1, i32 0, i32 0
  %4 = getelementptr inbounds i8, i8* %3, i64 5
  call void @llvm.memset.p0i8.i64(i8* align 1 %4, i8 100, i64 5, i1 false)
  br label %5
