...
@.str.3 = private unnamed_addr constant [10 x i8] c"readmin.c\00", align 1
...
125:                                              ; preds = %120
  call void @__assert_fail(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.3, i32 0, i32 0), i32 84, i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__PRETTY_FUNCTION__.read_min, i32 0, i32 0)) #5
  unreachable
