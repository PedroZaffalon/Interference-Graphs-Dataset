; ModuleID = '/home/pedro/tcc/benchmark/SPEC_CPU2017/benchspec/CPU/557.xz_r/src/sha-2/specGraph_524.ll'
source_filename = "/home/pedro/tcc/benchmark/SPEC_CPU2017/benchspec/CPU/557.xz_r/src/sha-2/sha512.c"
...
@.str.1 = private unnamed_addr constant [81 x i8] c"/home/pedro/tcc/benchmark/SPEC_CPU2017/benchspec/CPU/557.xz_r/src/sha-2/sha512.c\00", align 1
...
7:                                                ; preds = %2
  ...
  %9 = sext i32 %1 to i64
  %10 = mul i64 1, %9
  %11 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %8, i8* getelementptr inbounds ([39 x i8], [39 x i8]* @.str, i32 0, i32 0), i64 %10, i8* getelementptr inbounds ([81 x i8], [81 x i8]* @.str.1, i32 0, i32 0), i32 129)
